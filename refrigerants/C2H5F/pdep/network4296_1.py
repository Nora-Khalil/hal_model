...
"""),
    E0 = (-214.731,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,375,552.5,462.5,1710,262,1290,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18707,0.0685205,-0.000117081,1.05165e-07,-3.7623e-11,-25731.3,23.4461], Tmin=(100,'K'), Tmax=(754.76,'K')), NASAPolynomial(coeffs=[8.82419,0.0220698,-1.28883e-05,2.64306e-09,-1.89501e-13,-26713.9,-10.1222], Tmin=(754.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-214.731,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cds-OdCsCs) + group(Cds-O2d(Cds-O2d)O2s) + group(CJ2_singlet-FCO)"""),
)

species(
    label = 'C=C(OF)C(=O)OF(13649)',
    structure = adjacencyList("""1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-168.088,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,990,1113,350,440,435,1725,2950,3100,1380,975,1025,1650,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.764574,0.080036,-0.00014137,1.28915e-07,-4.54759e-11,-20108.4,24.8878], Tmin=(100,'K'), Tmax=(823.627,'K')), NASAPolynomial(coeffs=[8.73258,0.0257129,-1.39777e-05,2.76594e-09,-1.93156e-13,-20890.9,-8.78966], Tmin=(823.627,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-168.088,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH)"""),
)

species(
    label = 'O=C=C(CF)OOF(13650)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-171.339,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,277,555,632,212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,2120,512.5,787.5],'cm^-1')),
        HinderedRotor(inertia=(1.37628,'amu*angstrom^2'), symmetry=1, barrier=(31.6433,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.78948,0.0774943,-0.000128478,1.11794e-07,-3.82485e-11,-20498.3,25.2689], Tmin=(100,'K'), Tmax=(807.449,'K')), NASAPolynomial(coeffs=[9.78238,0.0240378,-1.26251e-05,2.47927e-09,-1.73087e-13,-21660.2,-14.3953], Tmin=(807.449,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-171.339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2sFO) + missing(O2d-Cdd) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-(Cdd-O2d)CsOs) + missing(Cdd-CdO2d)"""),
)

species(
    label = 'O=C=C(OF)OCF(13651)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-421.36,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,548,1085,1183,1302,1466,1520,3060,3119,350,440,435,1725,2120,512.5,787.5,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.34091,'amu*angstrom^2'), symmetry=1, barrier=(30.8302,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34254,'amu*angstrom^2'), symmetry=1, barrier=(30.8677,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.3421,'amu*angstrom^2'), symmetry=1, barrier=(30.8574,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.32285,0.0827185,-9.50696e-05,4.71268e-08,-8.33331e-12,-50456.5,29.6226], Tmin=(100,'K'), Tmax=(1684.74,'K')), NASAPolynomial(coeffs=[26.5123,-0.00709266,6.01544e-06,-1.23162e-09,8.29159e-14,-56468.7,-109.193], Tmin=(1684.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-421.36,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + missing(O2d-Cdd) + group(CsFHHO) + group(Cds-(Cdd-O2d)OsOs) + missing(Cdd-CdO2d)"""),
)
...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (124.043,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3865.93,'J/mol'), sigma=(5.71309,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=603.85 K, Pc=47.04 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(CF)C(=O)OF(4856)'],
    products = ['HF(38)', 'CO2(14)', 'O=C=CF(1527)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(35.932,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'O=C(CF)OF(3836)'],
    products = ['O=C(CF)C(=O)OF(4856)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(0.000742267,'m^3/(mol*s)'), n=2.83796, Ea=(234.394,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.2632766423807829, var=145.9379134136138, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-1COCbCdCsCtHNOSSidSis->Cs',), comment="""Estimated from node Root_N-1COCbCdCsCtHNOSSidSis->Cs"""),
)

reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'O=C([C]F)C(=O)OF(13648)'],
    products = ['O=C(CF)C(=O)OF(4856)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O=C=C(CF)OOF(13650)'],
    products = ['O=C(CF)C(=O)OF(4856)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(4.62709e+20,'s^-1'), n=-1.9758, Ea=(79.3604,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.1791595854394145, var=100.97114496904264, Tref=1000.0, N=30, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction6',
    reactants = ['O=C=C(OF)OCF(13651)'],
    products = ['O=C(CF)C(=O)OF(4856)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.39365e+11,'s^-1'), n=0.324012, Ea=(94.9259,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.014478493324023197, var=15.997960675483611, Tref=1000.0, N=8, data_mean=0.0, correlation='Root_N-1R!H-inRing_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R!H-inRing_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH2]C(=O)C(=O)OF(3969)'],
    products = ['O=C(CF)C(=O)OF(4856)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C(=O)C(=O)CF(4174)'],
    products = ['O=C(CF)C(=O)OF(4856)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(357)', 'O=[C]C(=O)CF(4173)'],
    products = ['O=C(CF)C(=O)OF(4856)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2F(46)', 'O=[C]C(=O)OF(3968)'],
    products = ['O=C(CF)C(=O)OF(4856)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OF(3602)', 'O=[C]CF(505)'],
    products = ['O=C(CF)C(=O)OF(4856)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=C(CF)C(=O)OF(4856)'],
    products = ['F2(77)', 'CO2(14)', 'CH2CO(28)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(196.553,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)
