...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C(=C)[O](609)'],
    products = ['C=C([O])C[O](365)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][O](131)', '[CH2][C]=O(140)'],
    products = ['C=C([O])C[O](365)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(18)', '[O]C[C]=O(156)'],
    products = ['C=C([O])C[O](365)'],
