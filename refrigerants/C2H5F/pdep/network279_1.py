...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[C]=O(252)'],
    products = ['[CH2]OC([CH2])=O(368)'],
    transitionState = 'TS3',
