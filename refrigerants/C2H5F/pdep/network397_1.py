...
"""),
    E0 = (-505.975,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,364,474,579,619,655,1345,487,638,688,1119,1325,1387,3149,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1600],'cm^-1')),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00286249,0.0969168,-0.000138822,1.02131e-07,-2.79838e-11,-60718.8,28.6157], Tmin=(100,'K'), Tmax=(644.059,'K')), NASAPolynomial(coeffs=[12.0611,0.0333106,-1.70448e-05,3.36548e-09,-2.3787e-13,-62507.6,-26.1007], Tmin=(644.059,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-505.975,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Csj(Cs-F1sO2sO2s)(H)(H)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)

species(
    label = 'C[C](F)OC(C)([O])F(1051)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {8,S}
...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (124.086,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3728.95,'J/mol'), sigma=(6.37775,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=582.45 K, Pc=32.62 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    E0 = (-379.926,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,361,584,565,722,1474,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1685,370,192.514,192.515,192.515],'cm^-1')),
        HinderedRotor(inertia=(0.672286,'amu*angstrom^2'), symmetry=1, barrier=(17.6807,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.672196,'amu*angstrom^2'), symmetry=1, barrier=(17.6807,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.672319,'amu*angstrom^2'), symmetry=1, barrier=(17.6807,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.672324,'amu*angstrom^2'), symmetry=1, barrier=(17.6807,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.304622,0.073707,-7.77375e-05,4.03021e-08,-8.09555e-12,-45555,25.9928], Tmin=(100,'K'), Tmax=(1224.39,'K')), NASAPolynomial(coeffs=[18.3468,0.0147639,-5.52581e-06,9.83346e-10,-6.7267e-14,-49973.1,-64.7027], Tmin=(1224.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-379.926,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
"""),
    E0 = (-401.868,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,326,540,652,719,1357,2950,3100,1380,975,1025,1650,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.0479156,'amu*angstrom^2'), symmetry=1, barrier=(11.4769,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.820178,'amu*angstrom^2'), symmetry=1, barrier=(18.8575,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.819183,'amu*angstrom^2'), symmetry=1, barrier=(18.8346,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14255,0.0638931,-6.57975e-05,3.50515e-08,-7.55571e-12,-48231.4,21.3282], Tmin=(100,'K'), Tmax=(1111.61,'K')), NASAPolynomial(coeffs=[12.4478,0.0232125,-1.09035e-05,2.12987e-09,-1.51687e-13,-50744.9,-34.4093], Tmin=(1111.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-401.868,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(CdCFO) + group(Cds-CdsHH) + radical(CsCsF1sO2s)"""),
)
...
species(
    label = 'CC(O)(F)[O+]=[C-]CF(1381)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  O u0 p1 c+1 {5,S} {8,D}
4  O u0 p2 c0 {5,S} {14,S}
5  C u0 p0 c0 {1,S} {3,S} {4,S} {6,S}
6  C u0 p0 c0 {5,S} {9,S} {10,S} {11,S}
...
"""),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0271379,0.0981952,-0.000160586,1.46718e-07,-5.27376e-11,-52841.5,37.4817], Tmin=(100,'K'), Tmax=(817.981,'K')), NASAPolynomial(coeffs=[7.61528,0.0416595,-2.12835e-05,4.14662e-09,-2.88544e-13,-53432.9,6.37103], Tmin=(817.981,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-440.452,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsHHH) + group(CsCFHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)OC(C)(O)F(1382)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {5,S} {7,S}
4  O u0 p2 c0 {5,S} {14,S}
...
"""),
    E0 = (-482.145,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,361,584,565,722,1474,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.119425,0.0930573,-0.00013538,1.09112e-07,-3.58889e-11,-57856.1,26.1511], Tmin=(100,'K'), Tmax=(740.086,'K')), NASAPolynomial(coeffs=[10.8026,0.0353097,-1.8322e-05,3.65268e-09,-2.60017e-13,-59437.2,-22.1719], Tmin=(740.086,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-482.145,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsHHH) + group(CsCFHO) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = 'C=C(F)OC(C)=O(1049)',
...
"""),
    E0 = (-672.587,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,343.882,343.882,343.882,343.882,343.882,641.202],'cm^-1')),
        HinderedRotor(inertia=(0.373487,'amu*angstrom^2'), symmetry=1, barrier=(31.3417,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.18535,'amu*angstrom^2'), symmetry=1, barrier=(15.5539,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.373488,'amu*angstrom^2'), symmetry=1, barrier=(31.3417,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36628,0.0621657,-7.12906e-05,4.36932e-08,-1.10029e-11,-80802.3,19.6333], Tmin=(100,'K'), Tmax=(951.625,'K')), NASAPolynomial(coeffs=[10.2414,0.0248593,-1.24845e-05,2.4949e-09,-1.7946e-13,-82491.4,-22.7437], Tmin=(951.625,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-672.587,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsHHH) + group(CJ2_singlet-FO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=C(F)OC(C)(O)F(1055)'],
    products = ['CC(=O)F(253)', 'CC(=O)F(253)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(4.02942e+10,'s^-1'), n=0.375329, Ea=(108.294,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.06684469846581474, var=24.965000021544366, Tref=1000.0, N=36, data_mean=0.0, correlation='Root_N-1R!H->C_N-5R!H->N',), comment="""Estimated from node Root_N-1R!H->C_N-5R!H->N"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C=C(F)OC(O)F(1374)'],
    products = ['C=C(F)OC(C)(O)F(1055)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C=C(O)F(491)', 'C=C(O)F(491)'],
    products = ['C=C(F)OC(C)(O)F(1055)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H2O(3)', 'C=C(F)OC(=C)F(604)'],
    products = ['C=C(F)OC(C)(O)F(1055)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(5000,'cm^3/(mol*s)'), n=2.76, Ea=(202.924,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using an average for rate rule [Cd/unsub_Cd/disub;H_OH]
...
reaction(
    label = 'reaction5',
    reactants = ['C=C(F)OC(C)(O)F(1055)'],
    products = ['CC(O)(F)CC(=O)F(1375)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(9.39365e+11,'s^-1'), n=0.324012, Ea=(118.275,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.014478493324023197, var=15.997960675483611, Tref=1000.0, N=8, data_mean=0.0, correlation='Root_N-1R!H-inRing_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R!H-inRing_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)OC(C)([O])F(1138)'],
    products = ['C=C(F)OC(C)(O)F(1055)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)OC([CH2])(O)F(1376)'],
    products = ['C=C(F)OC(C)(O)F(1055)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(5.14222e+08,'s^-1'), n=0.311, Ea=(24.9733,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4;Y_rad;XH_Rrad] for rate rule [R4radExo;Y_rad;XH_Rrad]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(O)(F)O[C](C)F(1139)'],
    products = ['C=C(F)OC(C)(O)F(1055)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(6.37831e+09,'s^-1'), n=0.137, Ea=(24.9733,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5;Y_rad;XH_Rrad] for rate rule [R5radEndo;Y_rad;XH_Rrad]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)O[C](C)O(1377)'],
    products = ['C=C(F)OC(C)(O)F(1055)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=[C]OC(C)(O)F(1378)'],
    products = ['C=C(F)OC(C)(O)F(1055)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2CFO(78)', 'C[C](O)F(911)'],
    products = ['C=C(F)OC(C)(O)F(1055)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(5.05906,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)

reaction(
    label = 'reaction13',
    reactants = ['CH2CF(69)', 'CC([O])(O)F(1252)'],
    products = ['C=C(F)OC(C)(O)F(1055)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(5)', 'C=C(F)O[C](C)F(957)'],
    products = ['C=C(F)OC(C)(O)F(1055)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(6)', 'C=C(F)OC(C)([O])F(1137)'],
    products = ['C=C(F)OC(C)(O)F(1055)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(19)', 'C=C(F)O[C](O)F(1379)'],
    products = ['C=C(F)OC(C)(O)F(1055)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(6)', '[CH2]C(O)(F)OC(=C)F(1267)'],
    products = ['C=C(F)OC(C)(O)F(1055)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(6)', '[CH]=C(F)OC(C)(O)F(1380)'],
    products = ['C=C(F)OC(C)(O)F(1055)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]C(F)OC(C)(O)F(1382)'],
    products = ['C=C(F)OC(C)(O)F(1055)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'C=C(F)OC(C)=O(1049)'],
    products = ['C=C(F)OC(C)(O)F(1055)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(175.326,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'C=C(O)OC(=C)F(1048)'],
    products = ['C=C(F)OC(C)(O)F(1055)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'C#COC(C)(O)F(1045)'],
    products = ['C=C(F)OC(C)(O)F(1055)'],
