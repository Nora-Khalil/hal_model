...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(=C)O[O](6842)'],
    products = ['O=O(566)', 'C=C=C(6729)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'C=[C]O[O](275)'],
    products = ['[CH2]C(=C)O[O](6842)'],
    transitionState = 'TS4',
