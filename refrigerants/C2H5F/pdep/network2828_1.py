...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29421,0.0549355,-5.38513e-05,2.45717e-08,-4.36875e-12,-110516,23.0664], Tmin=(100,'K'), Tmax=(1360.82,'K')), NASAPolynomial(coeffs=[15.9472,0.0118646,-6.37541e-06,1.31332e-09,-9.59062e-14,-114504,-52.1404], Tmin=(1360.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-919.725,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(CsFFHO) + group(Cds-OdOsOs)"""),
)
...
"""),
    E0 = (-356.091,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([947,1033,1057,1169,295.24,295.24,295.241,295.242,295.243,295.244],'cm^-1')),
        HinderedRotor(inertia=(0.689867,'amu*angstrom^2'), symmetry=1, barrier=(42.6714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.689859,'amu*angstrom^2'), symmetry=1, barrier=(42.6715,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-453.022,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,493,600,700,1144,1293,180,180,1746.99,1748.1,1748.9],'cm^-1')),
        HinderedRotor(inertia=(0.196721,'amu*angstrom^2'), symmetry=1, barrier=(4.523,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.197589,'amu*angstrom^2'), symmetry=1, barrier=(4.54296,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19687,'amu*angstrom^2'), symmetry=1, barrier=(4.52642,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41055,0.0812547,-0.00019421,2.20113e-07,-8.81365e-11,-54416.2,26.6798], Tmin=(100,'K'), Tmax=(852.027,'K')), NASAPolynomial(coeffs=[-4.65518,0.0483401,-2.81838e-05,5.63937e-09,-3.92659e-13,-51154.2,68.0488], Tmin=(852.027,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-453.022,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFFHO) + radical(OCOJ) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = 'O[C](OF)O[C](F)F(7988)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {8,S}
2 F u0 p3 c0 {8,S}
3 F u0 p3 c0 {5,S}
...
"""),
    E0 = (-810.484,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,335.548,335.86,335.983,336.394,337.866,403.488,1495.61,1495.74],'cm^-1')),
        HinderedRotor(inertia=(7.5335e-05,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.377282,'amu*angstrom^2'), symmetry=1, barrier=(30.4861,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19712,0.0388593,-3.53082e-05,1.56908e-08,-2.80009e-12,-97413.3,20.1259], Tmin=(100,'K'), Tmax=(1326.2,'K')), NASAPolynomial(coeffs=[10.5593,0.0136375,-6.78077e-06,1.35019e-09,-9.67348e-14,-99631.3,-22.5777], Tmin=(1326.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-810.484,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(CsFFHO) + group(Cds-OdOsOs) + radical(OC=OOJ)"""),
)
...
"""),
    E0 = (-615.724,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,1855,455,950,180,314.109],'cm^-1')),
        HinderedRotor(inertia=(0.0174178,'amu*angstrom^2'), symmetry=1, barrier=(26.223,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.1405,'amu*angstrom^2'), symmetry=1, barrier=(26.2222,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17992,0.0633083,-8.44976e-05,5.32187e-08,-1.29755e-11,-84095.3,23.6944], Tmin=(100,'K'), Tmax=(1009.22,'K')), NASAPolynomial(coeffs=[14.5487,0.010321,-5.74138e-06,1.19347e-09,-8.78364e-14,-86793.6,-40.9247], Tmin=(1009.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-700.044,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(CsFFHO) + group(Cds-OdOsOs) + radical(Csj(F1s)(F1s)(O2s-CO))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'O=C(O)OF(1242)'],
    products = ['O=C(OF)OC(F)F(7499)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=C(OF)OF(3062)', 'CHF(40)'],
    products = ['O=C(OF)OC(F)F(7499)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(OF)O[CH]F(3065)'],
    products = ['O=C(OF)OC(F)F(7499)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(=O)OC(F)F(3294)'],
    products = ['O=C(OF)OC(F)F(7499)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)OF(1245)', 'CHF2(81)'],
    products = ['O=C(OF)OC(F)F(7499)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O=[C]OF(331)', '[O]C(F)F(1981)'],
    products = ['O=C(OF)OC(F)F(7499)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(160)', 'O=[C]OC(F)F(3293)'],
    products = ['O=C(OF)OC(F)F(7499)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C(OF)O[C](F)F(7989)'],
    products = ['O=C(OF)OC(F)F(7499)'],
