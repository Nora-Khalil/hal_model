...
reaction(
    label = 'reaction1',
    reactants = ['C=CCC(=O)OF(2536)'],
    products = ['HF(38)', 'CO2(14)', 'C=C=C(6729)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'C=CCOF(375)'],
    products = ['C=CCC(=O)OF(2536)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C[CH]C(=O)OF(7210)'],
    products = ['C=CCC(=O)OF(2536)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(357)', 'C=CC[C]=O(647)'],
    products = ['C=CCC(=O)OF(2536)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(=O)OF(2532)', 'C2H3(29)'],
    products = ['C=CCC(=O)OF(2536)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OF(3602)', '[CH2]C=C(2725)'],
    products = ['C=CCC(=O)OF(2536)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(6)', 'C=C[CH]C(=O)OF(7218)'],
    products = ['C=CCC(=O)OF(2536)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(6)', 'C=[C]CC(=O)OF(7219)'],
    products = ['C=CCC(=O)OF(2536)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(6)', '[CH]=CCC(=O)OF(7220)'],
    products = ['C=CCC(=O)OF(2536)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C=CCC(=O)OF(2536)'],
    products = ['C2H2(23)', 'C=C(O)OF(2527)'],
