...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC=[C]F(2541)'],
    products = ['[CH]=C(C)C=[C]F(6139)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(19)', 'C#CC=[C]F(2634)'],
    products = ['[CH]=C(C)C=[C]F(6139)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=C(C)C#CF(6359)'],
    products = ['[CH]=C(C)C=[C]F(6139)'],
    transitionState = 'TS7',
