...
reaction(
    label = 'reaction2',
    reactants = ['C[C]F-2(838)', '[CH2]C[O](144)'],
    products = ['[CH2]CO[C](C)F(5132)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[C](C)F(981)'],
    products = ['[CH2]CO[C](C)F(5132)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['C[C]F(124)', '[CH2]C[O](144)'],
    products = ['[CH2]CO[C](C)F(5132)'],
