...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(3442)', '[CH2]C[C](F)F(3564)'],
    products = ['F[C](F)CC[C](F)F(4476)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[C](F)CC=C(F)F(4658)'],
    products = ['F[C](F)CC[C](F)F(4476)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['CF2(43)', '[CH2]C[C](F)F(3564)'],
    products = ['F[C](F)CC[C](F)F(4476)'],
    transitionState = 'TS9',
