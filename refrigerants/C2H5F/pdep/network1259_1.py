...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(160)', '[CH2]C(O)F(531)'],
    products = ['OC(F)COF(2854)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[CH]F(1908)', '[CH2]OF(396)'],
    products = ['OC(F)COF(2854)'],
