...
"""),
    E0 = (-73.9394,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,326,540,652,719,1357,365.31,369.211,370.147,372.732,377.81],'cm^-1')),
        HinderedRotor(inertia=(0.00122097,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.51811,'amu*angstrom^2'), symmetry=1, barrier=(51.7018,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.52937,'amu*angstrom^2'), symmetry=1, barrier=(51.7823,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.752727,0.0798939,-0.000123571,1.12354e-07,-4.0925e-11,-8784.13,26.0688], Tmin=(100,'K'), Tmax=(806.065,'K')), NASAPolynomial(coeffs=[6.10501,0.0386792,-1.96045e-05,3.81205e-09,-2.65644e-13,-9170.9,4.35414], Tmin=(806.065,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-73.9394,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFO) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH]=CC([O])(F)F(7400)'],
    products = ['[CH]=C(CF)C([O])(F)F(9376)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH]=C(F)C([O])(F)F(7457)'],
    products = ['[CH]=C(CF)C([O])(F)F(9376)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH]C(CF)=C(F)F(11072)'],
    products = ['[CH]=C(CF)C([O])(F)F(9376)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=C(CF)C(=O)F(11073)'],
    products = ['[CH]=C(CF)C([O])(F)F(9376)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2F(46)', 'C#CC([O])(F)F(7758)'],
    products = ['[CH]=C(CF)C([O])(F)F(9376)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]C(CF)=C(F)OF(11313)'],
    products = ['[CH]=C(CF)C([O])(F)F(9376)'],
