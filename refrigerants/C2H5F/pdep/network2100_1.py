...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC[C]=C(6903)'],
    products = ['[CH2]CC([CH2])=C(6423)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]C([CH2])=C(6881)'],
    products = ['[CH2]CC([CH2])=C(6423)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[CH2]C[C]=C(435)'],
    products = ['[CH2]CC([CH2])=C(6423)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['C2H4(30)', '[CH2][C]=C(6819)'],
    products = ['[CH2]CC([CH2])=C(6423)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(6)', '[CH2]C(=C)C=C(6900)'],
    products = ['[CH2]CC([CH2])=C(6423)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][CH2](132)', 'C=C=C(6729)'],
    products = ['[CH2]CC([CH2])=C(6423)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH2](132)', '[CH2][C]=C(6819)'],
    products = ['[CH2]CC([CH2])=C(6423)'],
