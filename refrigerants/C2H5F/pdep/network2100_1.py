...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CO[O](512)'],
    products = ['O=O(150)', 'C2H4(30)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[O](153)'],
    products = ['[CH2]CO[O](512)'],
    transitionState = 'TS3',
