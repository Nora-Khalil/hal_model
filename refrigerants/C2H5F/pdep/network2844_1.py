...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'C=C(OF)OF(3014)'],
    products = ['C=C(OF)OC(F)F(4774)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(OF)O[C](F)F(7911)'],
    products = ['C=C(OF)OC(F)F(4774)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=C(OF)O[CH]F(3019)'],
    products = ['C=C(OF)OC(F)F(4774)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(=O)OC(F)F(3286)'],
    products = ['C=C(OF)OC(F)F(4774)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(F)F(1981)', 'C=[C]OF(491)'],
    products = ['C=C(OF)OC(F)F(4774)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(160)', 'C=[C]OC(F)F(3285)'],
    products = ['C=C(OF)OC(F)F(4774)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C(OF)O[C](F)F(7912)'],
    products = ['C=C(OF)OC(F)F(4774)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH]=C(OF)OC(F)F(7913)'],
    products = ['C=C(OF)OC(F)F(4774)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C=C(OF)OC(F)F(4774)'],
    products = ['F2(77)', 'CHFO(47)', 'CH2CO(28)'],
