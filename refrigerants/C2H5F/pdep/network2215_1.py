...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC=[C]C(6094)'],
    products = ['[CH]=C(C)C=[C]C(6155)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['H(5)', '[CH]=C(C)C=C=C(6501)'],
    products = ['[CH]=C(C)C=[C]C(6155)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(19)', 'C#CC=[C]C(6246)'],
    products = ['[CH]=C(C)C=[C]C(6155)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(C)C#CC(6502)'],
    products = ['[CH]=C(C)C=[C]C(6155)'],
    transitionState = 'TS8',
