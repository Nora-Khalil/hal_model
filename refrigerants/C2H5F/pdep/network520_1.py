...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[CH]F(978)'],
    products = ['[CH2]OC([CH2])F(968)'],
    transitionState = 'TS3',
