...
"""),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.849997,0.0757825,-9.43556e-05,7.20972e-08,-2.36262e-11,-112592,23.9203], Tmin=(100,'K'), Tmax=(730.443,'K')), NASAPolynomial(coeffs=[7.49645,0.0393846,-1.96086e-05,3.87447e-09,-2.75736e-13,-113563,-6.05709], Tmin=(730.443,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-937.035,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCsCsFF) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs)"""),
)

species(
    label = '[CH2]C([O])OC(C)(F)F(5888)',
...
"""),
    E0 = (-496.726,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,180,180,180,1800.78],'cm^-1')),
        HinderedRotor(inertia=(0.116122,'amu*angstrom^2'), symmetry=1, barrier=(2.66988,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116549,'amu*angstrom^2'), symmetry=1, barrier=(2.6797,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.20061,'amu*angstrom^2'), symmetry=1, barrier=(27.6043,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116132,'amu*angstrom^2'), symmetry=1, barrier=(2.67011,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14284,0.0744273,-6.78805e-05,-1.01366e-08,4.61964e-11,-59651.1,26.4213], Tmin=(100,'K'), Tmax=(496.612,'K')), NASAPolynomial(coeffs=[7.89264,0.0393449,-2.0163e-05,3.99998e-09,-2.83889e-13,-60559.3,-3.81234], Tmin=(496.612,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-496.726,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFFO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(O)OC([CH2])(F)F(5889)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-506.345,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,253,525,597,667,842,1178,1324,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1600],'cm^-1')),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.283999,0.087705,-0.000115887,8.19835e-08,-2.34465e-11,-60770.7,29.9549], Tmin=(100,'K'), Tmax=(849.95,'K')), NASAPolynomial(coeffs=[12.4093,0.0306414,-1.51811e-05,2.99385e-09,-2.12902e-13,-62831.9,-26.5716], Tmin=(849.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-506.345,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFFO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(Csj(Cs-F1sF1sO2s)(H)(H))"""),
)

species(
    label = '[CH2]C(F)(F)O[C](C)O(5890)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21384,0.0584797,-4.03507e-05,1.34424e-08,-1.81316e-12,-111018,24.2198], Tmin=(100,'K'), Tmax=(1683.78,'K')), NASAPolynomial(coeffs=[14.5311,0.026843,-1.2167e-05,2.28356e-09,-1.5634e-13,-115503,-46.9674], Tmin=(1683.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-923.903,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFFO) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs)"""),
)
...
"""),
    E0 = (-406.179,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1685,370,236.651,237.556,238.103],'cm^-1')),
        HinderedRotor(inertia=(0.478781,'amu*angstrom^2'), symmetry=1, barrier=(19.166,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.478639,'amu*angstrom^2'), symmetry=1, barrier=(19.1551,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.481073,'amu*angstrom^2'), symmetry=1, barrier=(19.1501,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.788689,0.0617026,-5.10469e-05,1.48163e-08,4.96075e-13,-48728.6,23.7169], Tmin=(100,'K'), Tmax=(1017.68,'K')), NASAPolynomial(coeffs=[17.1801,0.0139814,-5.33145e-06,9.98883e-10,-7.20399e-14,-52929.9,-59.8997], Tmin=(1017.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-406.179,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
"""),
    E0 = (-537.473,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,493,600,700,1144,1293,235.857,235.857,235.858],'cm^-1')),
        HinderedRotor(inertia=(0.465448,'amu*angstrom^2'), symmetry=1, barrier=(18.3738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.465449,'amu*angstrom^2'), symmetry=1, barrier=(18.3738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.465451,'amu*angstrom^2'), symmetry=1, barrier=(18.3738,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.510147,0.0648434,-7.33174e-05,3.83161e-08,-7.49363e-12,-64507.3,24.0029], Tmin=(100,'K'), Tmax=(1377.15,'K')), NASAPolynomial(coeffs=[19.7797,0.00328563,-1.81258e-07,-3.52244e-11,3.39439e-15,-69284.8,-73.2039], Tmin=(1377.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-537.473,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsFFHO) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Csj(F1s)(F1s)(O2s-Cd))"""),
)

species(
    label = '[CH2]C(F)(F)OC(=C)O(5893)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-555.963,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,223,363,546,575,694,1179,1410,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3120,650,792.5,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.874409,'amu*angstrom^2'), symmetry=1, barrier=(20.1044,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.876593,'amu*angstrom^2'), symmetry=1, barrier=(20.1546,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.875008,'amu*angstrom^2'), symmetry=1, barrier=(20.1182,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.876467,'amu*angstrom^2'), symmetry=1, barrier=(20.1517,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.479207,0.0903171,-0.000108154,6.12356e-08,-1.32013e-11,-66698.6,25.3286], Tmin=(100,'K'), Tmax=(1152.36,'K')), NASAPolynomial(coeffs=[22.7317,0.00974849,-3.27975e-06,5.62878e-10,-3.85282e-14,-72048,-89.9421], Tmin=(1152.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-555.963,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
"""),
    E0 = (-482.92,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,223,363,546,575,694,1179,1410,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.333966,0.087909,-0.000123805,9.75357e-08,-3.15188e-11,-57956.6,27.8356], Tmin=(100,'K'), Tmax=(751.45,'K')), NASAPolynomial(coeffs=[10.3035,0.0348409,-1.7874e-05,3.55745e-09,-2.53391e-13,-59454.9,-17.413], Tmin=(751.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-482.92,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFFO) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    ...
    products = ['C=C(O)OC(C)(F)F(5736)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(12.0443,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'C=C(O)OC(F)F(2872)'],
    products = ['C=C(O)OC(C)(F)F(5736)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2CF2(56)', 'C=C(O)O(3279)'],
    products = ['C=C(O)OC(C)(F)F(5736)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(0.000684105,'m^3/(mol*s)'), n=2.805, Ea=(189.117,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cd/unsub_Cd/disub;H_OR] for rate rule [Cd/unsub_Cd/disub;H_OCd]
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C([O])OC(C)(F)F(5888)'],
    products = ['C=C(O)OC(C)(F)F(5736)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(O)OC([CH2])(F)F(5889)'],
    products = ['C=C(O)OC(C)(F)F(5736)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)(F)O[C](C)O(5890)'],
    products = ['C=C(O)OC(C)(F)F(5736)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(O)O[C](C)F(3671)'],
    products = ['C=C(O)OC(C)(F)F(5736)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH3-CF2(64)', '[CH2]C(=O)O(166)'],
    products = ['C=C(O)OC(C)(F)F(5736)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(5.48564,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)

reaction(
    label = 'reaction13',
    reactants = ['C=[C]O(142)', 'CC([O])(F)F(1358)'],
    products = ['C=C(O)OC(C)(F)F(5736)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(7)', 'C=[C]OC(C)(F)F(4825)'],
    products = ['C=C(O)OC(C)(F)F(5736)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(=O)OC(C)(F)F(5892)'],
    products = ['C=C(O)OC(C)(F)F(5736)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(19)', 'C=C(O)O[C](F)F(3287)'],
    products = ['C=C(O)OC(C)(F)F(5736)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH2]C(F)(F)OC(=C)O(5893)'],
    products = ['C=C(O)OC(C)(F)F(5736)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH]=C(O)OC(C)(F)F(5894)'],
    products = ['C=C(O)OC(C)(F)F(5736)'],
