...
"""),
    E0 = (-473.341,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2782.5,750,1395,475,1775,1000,293.694,293.95,1368.93],'cm^-1')),
        HinderedRotor(inertia=(0.466934,'amu*angstrom^2'), symmetry=1, barrier=(28.6097,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0215084,'amu*angstrom^2'), symmetry=1, barrier=(28.6069,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.463672,'amu*angstrom^2'), symmetry=1, barrier=(28.6146,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132878,'amu*angstrom^2'), symmetry=1, barrier=(8.1158,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5239,0.0512654,-3.68935e-05,1.25977e-08,-1.72333e-12,-56838.5,23.7515], Tmin=(100,'K'), Tmax=(1680.87,'K')), NASAPolynomial(coeffs=[14.2397,0.0210054,-9.88973e-06,1.88753e-09,-1.30381e-13,-61113.2,-44.1984], Tmin=(1680.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-473.341,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH)"""),
)
...
"""),
    ...
    molecularWeight = (108.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26934,0.060511,-5.63301e-05,2.63745e-08,-5.01324e-12,-7222.04,25.3627], Tmin=(100,'K'), Tmax=(1242.98,'K')), NASAPolynomial(coeffs=[12.8515,0.0232387,-1.13508e-05,2.25014e-09,-1.61134e-13,-10101.3,-33.0341], Tmin=(1242.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-60.8607,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(Cs_P)"""),
)

species(
    label = 'C[C](OF)O[CH]O(1545)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (108.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.516997,0.0814101,-0.000118364,8.9023e-08,-2.64933e-11,-11821.8,27.385], Tmin=(100,'K'), Tmax=(824.856,'K')), NASAPolynomial(coeffs=[12.7169,0.0222524,-1.07925e-05,2.08626e-09,-1.45852e-13,-13834.6,-29.1241], Tmin=(824.856,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-99.2985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(Cs_P) + radical(OCJO)"""),
)

species(
    label = '[CH2]C(OF)OC[O](1546)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {5,S} {6,S}
3  O u0 p2 c0 {1,S} {5,S}
...
"""),
    ...
    molecularWeight = (108.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0704,0.0650527,-6.58624e-05,3.35787e-08,-6.88839e-12,-6452.03,26.0249], Tmin=(100,'K'), Tmax=(1166.34,'K')), NASAPolynomial(coeffs=[13.5289,0.0223256,-1.0912e-05,2.1695e-09,-1.55932e-13,-9358.2,-35.9973], Tmin=(1166.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-54.518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(OF)O[CH]O(1547)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {5,S} {7,S}
3  O u0 p2 c0 {1,S} {5,S}
...
"""),
    ...
    molecularWeight = (108.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.289401,0.0863433,-0.000129466,9.84547e-08,-2.93703e-11,-11050.7,28.1458], Tmin=(100,'K'), Tmax=(825.558,'K')), NASAPolynomial(coeffs=[13.8747,0.0205243,-9.88393e-06,1.89465e-09,-1.31442e-13,-13294,-34.792], Tmin=(825.558,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-92.9558,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CJCO) + radical(OCJO)"""),
)
...
"""),
    E0 = (-382.144,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2782.5,750,1395,475,1775,1000,386.497,386.562,386.581],'cm^-1')),
        HinderedRotor(inertia=(0.00112739,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00112767,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00112797,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.52315,0.034012,-1.40072e-05,6.95849e-10,4.07463e-13,-45909.5,20.8741], Tmin=(100,'K'), Tmax=(1809.57,'K')), NASAPolynomial(coeffs=[13.0454,0.0196791,-9.52558e-06,1.77073e-09,-1.17643e-13,-51179.2,-40.1685], Tmin=(1809.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-382.144,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-261.752,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2782.5,750,1395,475,1775,1000,291.939,1964.62,1964.67],'cm^-1')),
        HinderedRotor(inertia=(0.443831,'amu*angstrom^2'), symmetry=1, barrier=(26.8206,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16176,'amu*angstrom^2'), symmetry=1, barrier=(26.822,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.44295,'amu*angstrom^2'), symmetry=1, barrier=(26.8219,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.444147,'amu*angstrom^2'), symmetry=1, barrier=(26.8206,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61925,0.0536687,-4.76153e-05,2.11673e-08,-3.85681e-12,-31397.1,24.0359], Tmin=(100,'K'), Tmax=(1279.67,'K')), NASAPolynomial(coeffs=[11.5293,0.022692,-1.13051e-05,2.25084e-09,-1.61234e-13,-33933.4,-26.218], Tmin=(1279.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-261.752,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CJCO)"""),
)

species(
    label = 'CC(OF)O[C]=O(1552)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {5,S} {7,S}
3  O u0 p2 c0 {1,S} {5,S}
...
"""),
    E0 = (-276.893,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,1855,455,950,324.779,324.834,325.279],'cm^-1')),
        HinderedRotor(inertia=(0.336353,'amu*angstrom^2'), symmetry=1, barrier=(25.2481,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00159502,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.59871,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.59682,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59867,0.0557309,-5.3896e-05,2.73681e-08,-5.77213e-12,-33218.5,22.1103], Tmin=(100,'K'), Tmax=(1113.72,'K')), NASAPolynomial(coeffs=[10.2114,0.024798,-1.22348e-05,2.43014e-09,-1.74274e-13,-35136.9,-20.3688], Tmin=(1113.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-276.893,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'O=COCOF(551)'],
    products = ['CC(OF)OC=O(568)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(OF)O[CH]O(1547)'],
    products = ['CC(OF)OC=O(568)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C=O(147)', 'C[CH]OF(540)'],
    products = ['CC(OF)OC=O(568)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(160)', 'C[CH]OC=O(338)'],
    products = ['CC(OF)OC=O(568)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(19)', 'O=CO[CH]OF(1259)'],
    products = ['CC(OF)OC=O(568)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C[C](OF)OC=O(1550)'],
    products = ['CC(OF)OC=O(568)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH2]C(OF)OC=O(1551)'],
    products = ['CC(OF)OC=O(568)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'CC(OF)O[C]=O(1552)'],
    products = ['CC(OF)OC=O(568)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'CC(=O)OC=O(1093)'],
    products = ['CC(OF)OC=O(568)'],
