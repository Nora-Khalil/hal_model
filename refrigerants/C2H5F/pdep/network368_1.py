...
reaction(
    label = 'reaction2',
    reactants = ['[O]C[O](383)', 'C[C]F-2(182)'],
    products = ['C[C](F)OC[O](1027)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][O](318)', 'CC(=O)F(253)'],
    products = ['C[C](F)OC[O](1027)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][O](318)', 'C[C]([O])F(512)'],
    products = ['C[C](F)OC[O](1027)'],
