...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC(=[CH])F(2540)'],
    products = ['C2HF(57)', 'C2H2(23)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', '[CH]=CC#C(660)'],
    products = ['[CH]=CC(=[CH])F(2540)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=[C]F(1321)', '[CH]=[CH](135)'],
    products = ['[CH]=CC(=[CH])F(2540)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['HF(38)', '[CH]=C=C=[CH](2638)'],
    products = ['[CH]=CC(=[CH])F(2540)'],
    transitionState = 'TS8',
