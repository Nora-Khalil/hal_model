...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(134)', '[CH]=C[O](132)'],
    products = ['[CH]=CO[C]=C(419)'],
    transitionState = 'TS2',
