...
reaction(
    label = 'reaction3',
    reactants = ['C2HF(57)', '[CH]=[CH](272)'],
    products = ['[CH]=CC=[C]F(5455)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=[C]F(488)', '[CH]=[CH](272)'],
    products = ['[CH]=CC=[C]F(5455)'],
    transitionState = 'TS7',
