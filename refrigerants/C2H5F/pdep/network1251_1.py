...
"""),
    E0 = (-247.326,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,364.07,364.324,364.486],'cm^-1')),
        HinderedRotor(inertia=(0.165949,'amu*angstrom^2'), symmetry=1, barrier=(15.5637,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166251,'amu*angstrom^2'), symmetry=1, barrier=(15.5743,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166739,'amu*angstrom^2'), symmetry=1, barrier=(15.5803,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.165605,'amu*angstrom^2'), symmetry=1, barrier=(15.565,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (75.0865,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17842,0.0465301,-1.91797e-06,-4.77021e-08,2.68188e-11,-29630.3,20.64], Tmin=(100,'K'), Tmax=(909.087,'K')), NASAPolynomial(coeffs=[20.6464,0.00240632,2.35268e-06,-5.75493e-10,3.77723e-14,-34886.2,-80.8658], Tmin=(909.087,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-247.326,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCsJOCs)"""),
)
...
"""),
    E0 = (-440.791,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,487,638,688,1119,1325,1387,3149,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,353.072,353.134,353.305],'cm^-1')),
        HinderedRotor(inertia=(0.204584,'amu*angstrom^2'), symmetry=1, barrier=(18.123,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204777,'amu*angstrom^2'), symmetry=1, barrier=(18.1237,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.20472,'amu*angstrom^2'), symmetry=1, barrier=(18.1203,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204794,'amu*angstrom^2'), symmetry=1, barrier=(18.1252,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.0769,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.923324,0.0537139,-2.0373e-05,-2.56757e-08,1.74163e-11,-52891.3,23.976], Tmin=(100,'K'), Tmax=(939.213,'K')), NASAPolynomial(coeffs=[20.2452,0.00643638,-7.84103e-07,1.10642e-10,-1.242e-14,-58065,-76.2501], Tmin=(939.213,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-440.791,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.07008,'amu*angstrom^2'), symmetry=1, barrier=(24.6033,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06868,'amu*angstrom^2'), symmetry=1, barrier=(24.5712,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06874,'amu*angstrom^2'), symmetry=1, barrier=(24.5725,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction9',
    reactants = ['OH(7)', '[CH2]OC(C)F(1977)'],
    products = ['CC(F)OCO(2846)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(19)', 'OCO[CH]F(2775)'],
    products = ['CC(F)OCO(2846)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(F)OCO(3560)'],
    products = ['CC(F)OCO(2846)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'CC(F)O[CH]O(3378)'],
    products = ['CC(F)OCO(2846)'],
