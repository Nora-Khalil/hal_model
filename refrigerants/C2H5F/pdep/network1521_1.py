...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC[C](F)F(4433)'],
    products = ['C2H2(23)', 'CH2CF2(56)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(3442)', '[CH]C=C(341)'],
    products = ['[CH]=CC[C](F)F(4433)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=CC=C(F)F(4527)'],
    products = ['[CH]=CC[C](F)F(4433)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C2H2(23)', '[CH2][C](F)F(4220)'],
    products = ['[CH]=CC[C](F)F(4433)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=[CH](135)', '[CH2][C](F)F(4220)'],
    products = ['[CH]=CC[C](F)F(4433)'],
