...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F(502)', '[C]=C(271)'],
    products = ['[CH]=C(F)O[C]=C(5458)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(6)', '[CH]=C(F)OC#C(5514)'],
    products = ['[CH]=C(F)O[C]=C(5458)'],
    transitionState = 'TS7',
