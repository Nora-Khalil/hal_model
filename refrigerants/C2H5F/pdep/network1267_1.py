...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(160)', 'C=C=C(C)[O](3092)'],
    products = ['C=C(OF)C(C)=O(2862)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(19)', 'C=C([C]=O)OF(1373)'],
    products = ['C=C(OF)C(C)=O(2862)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH]=C(OF)C(C)=O(3094)'],
    products = ['C=C(OF)C(C)=O(2862)'],
