...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C]=O(145)', 'CH2(T)(18)'],
    products = ['[CH2]OO[C]=O(3618)'],
    transitionState = 'TS2',
