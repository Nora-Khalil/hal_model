...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH]C(F)=CF(2625)'],
    products = ['[CH]=C(F)C([CH2])F(2559)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=C(F)C=C(2581)'],
    products = ['[CH]=C(F)C([CH2])F(2559)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(F)C(=C)F(2626)'],
    products = ['[CH]=C(F)C([CH2])F(2559)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['F2(77)', '[CH]=C=C[CH2](662)'],
    products = ['[CH]=C(F)C([CH2])F(2559)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[CH]=C=C([CH2])F(2627)'],
    products = ['[CH]=C(F)C([CH2])F(2559)'],
