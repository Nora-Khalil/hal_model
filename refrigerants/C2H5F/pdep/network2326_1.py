...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'C=[C]C[CH]F(934)'],
    products = ['[CH2]C(F)C[C]=C(6669)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=C(134)', '[CH2]C([CH2])F(858)'],
    products = ['[CH2]C(F)C[C]=C(6669)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C#CCC([CH2])F(6721)'],
    products = ['[CH2]C(F)C[C]=C(6669)'],
