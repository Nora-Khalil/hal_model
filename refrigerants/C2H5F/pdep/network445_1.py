...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'CC([O])C[O](389)'],
    products = ['CC([O])C(C)[O](534)'],
    transitionState = 'TS2',
