...
"""),
    E0 = (-20.4545,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,261,493,600,1152,1365,1422,3097,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180,502.642],'cm^-1')),
        HinderedRotor(inertia=(0.935302,'amu*angstrom^2'), symmetry=1, barrier=(21.5044,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.935589,'amu*angstrom^2'), symmetry=1, barrier=(21.511,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.631667,'amu*angstrom^2'), symmetry=1, barrier=(14.5233,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23173,0.0607789,-5.80198e-05,2.83298e-08,-5.60522e-12,-2360.39,23.4643], Tmin=(100,'K'), Tmax=(1202.46,'K')), NASAPolynomial(coeffs=[12.6414,0.0228245,-1.06742e-05,2.08066e-09,-1.47878e-13,-5104.35,-33.6847], Tmin=(1202.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-20.4545,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsHH) + group(CsCFHO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
"""),
    E0 = (96.4933,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,323,467,575,827,1418,2995,3025,975,1000,1300,1375,400,500,1630,1680,3120,650,792.5,1650],'cm^-1')),
        HinderedRotor(inertia=(0.783978,'amu*angstrom^2'), symmetry=1, barrier=(18.0252,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.783802,'amu*angstrom^2'), symmetry=1, barrier=(18.0212,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0994,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35476,0.0515181,-3.90546e-05,1.20399e-08,-3.95128e-13,11706.4,19.797], Tmin=(100,'K'), Tmax=(1055.86,'K')), NASAPolynomial(coeffs=[12.9062,0.0183334,-6.93658e-06,1.2478e-09,-8.61286e-14,8677.52,-39.3518], Tmin=(1055.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(96.4933,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(CdCsCdF) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CCC(=C)F(9541)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
...
"""),
    E0 = (127.347,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,323,467,575,827,1418,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,3120,650,792.5,1650,259.052],'cm^-1')),
        HinderedRotor(inertia=(0.241334,'amu*angstrom^2'), symmetry=1, barrier=(11.5271,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.241565,'amu*angstrom^2'), symmetry=1, barrier=(11.5268,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0994,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55406,0.0470261,-3.1474e-05,8.27708e-09,-1.0359e-13,15410.1,22.1083], Tmin=(100,'K'), Tmax=(1147.85,'K')), NASAPolynomial(coeffs=[11.8278,0.0201726,-8.07552e-06,1.47885e-09,-1.0214e-13,12462.1,-31.4409], Tmin=(1147.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(127.347,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(CdCsCdF) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
"""),
    E0 = (235.989,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,333,384,448,608,1254,1480,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,206.9,206.9,206.901],'cm^-1')),
        HinderedRotor(inertia=(0.486604,'amu*angstrom^2'), symmetry=1, barrier=(14.7816,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.486602,'amu*angstrom^2'), symmetry=1, barrier=(14.7816,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.752692,'amu*angstrom^2'), symmetry=1, barrier=(22.8647,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.486599,'amu*angstrom^2'), symmetry=1, barrier=(14.7815,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.557003,0.0817403,-9.6913e-05,6.25469e-08,-1.6641e-11,28501.8,26.0053], Tmin=(100,'K'), Tmax=(902.502,'K')), NASAPolynomial(coeffs=[11.4376,0.0335156,-1.67601e-05,3.33799e-09,-2.39433e-13,26537.9,-25.3707], Tmin=(902.502,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(235.989,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CdCdJ2_triplet)"""),
)
...
"""),
    E0 = (184.984,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,212,367,445,1450,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,289.458],'cm^-1')),
        HinderedRotor(inertia=(0.126979,'amu*angstrom^2'), symmetry=1, barrier=(7.5409,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127727,'amu*angstrom^2'), symmetry=1, barrier=(7.55234,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126828,'amu*angstrom^2'), symmetry=1, barrier=(7.54347,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75529,0.0536039,-4.99805e-05,2.89533e-08,-7.52646e-12,22325.6,22.7068], Tmin=(100,'K'), Tmax=(887.52,'K')), NASAPolynomial(coeffs=[6.29426,0.033147,-1.54062e-05,2.98246e-09,-2.10891e-13,21520,1.35049], Tmin=(887.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(184.984,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsCsCsF1s) + radical(Cds_P)"""),
)
...
"""),
    E0 = (174.1,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,395,473,707,1436,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.442372,'amu*angstrom^2'), symmetry=1, barrier=(10.171,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.443339,'amu*angstrom^2'), symmetry=1, barrier=(10.1932,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.968789,'amu*angstrom^2'), symmetry=1, barrier=(22.2744,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07622,0.0694755,-9.87821e-05,7.70853e-08,-2.4396e-11,21039.9,24.8316], Tmin=(100,'K'), Tmax=(770.144,'K')), NASAPolynomial(coeffs=[9.59718,0.0252189,-1.25839e-05,2.46857e-09,-1.74204e-13,19727.4,-14.0516], Tmin=(770.144,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(174.1,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsHH) + group(CsCFHO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsCsF1sO2s) + radical(Cds_P)"""),
)
...
"""),
    E0 = (35.1918,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1066.67,1333.33,1600],'cm^-1')),
    ...
    molecularWeight = (120.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.662199,0.0783016,-7.54452e-05,4.03592e-08,-9.18567e-12,4348.73,25.2459], Tmin=(100,'K'), Tmax=(1027,'K')), NASAPolynomial(coeffs=[10.5879,0.0396423,-1.89803e-05,3.70529e-09,-2.63057e-13,2310,-22.9043], Tmin=(1027,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.1918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=CCC([CH2])(F)OF(13730)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {3,S}
3  O u0 p2 c0 {2,S} {4,S}
...
"""),
    E0 = (135.835,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,316,385,515,654,689,1295,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.443568,'amu*angstrom^2'), symmetry=1, barrier=(10.1985,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.443579,'amu*angstrom^2'), symmetry=1, barrier=(10.1987,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.38694,'amu*angstrom^2'), symmetry=1, barrier=(31.8884,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.850646,'amu*angstrom^2'), symmetry=1, barrier=(19.558,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.220348,0.0896641,-0.00011938,8.63121e-08,-2.53702e-11,16467.4,27.4866], Tmin=(100,'K'), Tmax=(826.019,'K')), NASAPolynomial(coeffs=[11.9231,0.032993,-1.64678e-05,3.25215e-09,-2.31259e-13,14534.1,-26.7354], Tmin=(826.019,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(135.835,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Csj(Cs-F1sO2sCs)(H)(H)) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]CC(C)(F)OF(11237)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {3,S}
3  O u0 p2 c0 {2,S} {4,S}
...
"""),
    E0 = (162.825,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,333,384,448,608,1254,1480,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.752358,'amu*angstrom^2'), symmetry=1, barrier=(17.2982,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.752603,'amu*angstrom^2'), symmetry=1, barrier=(17.3038,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.752617,'amu*angstrom^2'), symmetry=1, barrier=(17.3042,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.752469,'amu*angstrom^2'), symmetry=1, barrier=(17.3007,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.439175,0.0840734,-0.000103342,6.87782e-08,-1.87105e-11,19706.7,26.9254], Tmin=(100,'K'), Tmax=(887.388,'K')), NASAPolynomial(coeffs=[11.9021,0.0324042,-1.60041e-05,3.16512e-09,-2.25973e-13,17672.2,-27.007], Tmin=(887.388,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(162.825,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
"""),
    E0 = (99.0866,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,352.23],'cm^-1')),
        HinderedRotor(inertia=(0.583005,'amu*angstrom^2'), symmetry=1, barrier=(13.4044,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0209447,'amu*angstrom^2'), symmetry=1, barrier=(13.404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0209415,'amu*angstrom^2'), symmetry=1, barrier=(13.4033,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7643,0.0407162,-8.84459e-06,-1.17886e-08,5.35791e-12,12004.7,21.7015], Tmin=(100,'K'), Tmax=(1200.6,'K')), NASAPolynomial(coeffs=[11.6906,0.0254813,-1.20947e-05,2.38998e-09,-1.7109e-13,8335.72,-33.3557], Tmin=(1200.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(99.0866,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC=C(C)OF(13732)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {2,S}
...
"""),
    E0 = (248.239,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2995,3025,975,1000,1300,1375,400,500,1630,1680,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.678554,'amu*angstrom^2'), symmetry=1, barrier=(15.6013,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.679443,'amu*angstrom^2'), symmetry=1, barrier=(15.6217,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.677546,'amu*angstrom^2'), symmetry=1, barrier=(15.5781,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.879537,0.065954,-6.58094e-05,3.40215e-08,-7.02077e-12,29970.9,23.9299], Tmin=(100,'K'), Tmax=(1171.96,'K')), NASAPolynomial(coeffs=[13.9105,0.0214788,-8.88612e-06,1.64119e-09,-1.13562e-13,26916.5,-41.0047], Tmin=(1171.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(248.239,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CCC(C)(F)OF(7389)'],
    products = ['HF(38)', 'CC(=O)F(253)', '[CH]=C=C(5584)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(27.6807,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['C[C]F(124)', '[CH]=CCOF(8910)'],
    products = ['[CH]=CCC(C)(F)OF(7389)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.14358e+07,'m^3/(mol*s)'), n=-0.641018, Ea=(178.846,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.17570294811609, var=29.477358162589667, Tref=1000.0, N=2, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', '[CH]=CCC(F)OF(12762)'],
    products = ['[CH]=CCC(C)(F)OF(7389)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(174)', '[CH]=CC=C(C)F(13725)'],
    products = ['[CH]=CCC(C)(F)OF(7389)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OF(174)', '[CH]=CCC(=C)F(9541)'],
    products = ['[CH]=CCC(C)(F)OF(7389)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(6)', '[C]=CCC(C)(F)OF(13726)'],
    products = ['[CH]=CCC(C)(F)OF(7389)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH]=CC[C](C)OF(7309)'],
    products = ['[CH]=CCC(C)(F)OF(7389)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH]=CCC(C)([O])F(7126)'],
    products = ['[CH]=CCC(C)(F)OF(7389)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(357)', '[CH]=CC[C](C)F(13727)'],
    products = ['[CH]=CCC(C)(F)OF(7389)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C[C](F)OF(912)', '[CH]C=C(9020)'],
    products = ['[CH]=CCC(C)(F)OF(7389)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(2.63131e-11,'m^3/(mol*s)'), n=4.71246, Ea=(18.5648,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction14',
    reactants = ['CH3(19)', '[CH]=CC[C](F)OF(13728)'],
    products = ['[CH]=CCC(C)(F)OF(7389)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=[CH](272)', '[CH2]C(C)(F)OF(807)'],
    products = ['[CH]=CCC(C)(F)OF(7389)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(6)', '[CH]C=CC(C)(F)OF(13729)'],
    products = ['[CH]=CCC(C)(F)OF(7389)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(2.88633e+07,'m^3/(mol*s)'), n=0.213913, Ea=(6.95551,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=8.197906922440378e-05, var=0.01210657880115639, Tref=1000.0, N=9, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_Ext-2C-R_N-3C-inRing_Ext-3C-R_Ext-5R!H-R',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_Ext-2C-R_N-3C-inRing_Ext-3C-R_Ext-5R!H-R"""),
)

reaction(
    label = 'reaction17',
    reactants = ['H(6)', '[CH]=CCC([CH2])(F)OF(13730)'],
    products = ['[CH]=CCC(C)(F)OF(7389)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(6)', '[CH]=[C]CC(C)(F)OF(11237)'],
    products = ['[CH]=CCC(C)(F)OF(7389)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(77)', '[CH]=CCC(C)=O(13731)'],
    products = ['[CH]=CCC(C)(F)OF(7389)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', '[CH]=CC=C(C)OF(13732)'],
    products = ['[CH]=CCC(C)(F)OF(7389)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', '[CH]=CCC(=C)OF(7314)'],
    products = ['[CH]=CCC(C)(F)OF(7389)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C=C[CH]C(C)(F)OF(7386)'],
    products = ['[CH]=CCC(C)(F)OF(7389)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]=CCC(C)(F)OF(7389)'],
    products = ['CC([O])(F)CC=CF(10011)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(69.7148,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

reaction(
    label = 'reaction26',
    reactants = ['[CH]=CCC(C)(F)OF(7389)'],
    products = ['C[C](CC=CF)OF(12775)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(2.56499e-06,'s^-1'), n=5.16802, Ea=(220.466,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.010618623676007603, var=1.2440368903510177, Tref=1000.0, N=3, data_mean=0.0, correlation='R4F',), comment="""Estimated from node R4F"""),
)
