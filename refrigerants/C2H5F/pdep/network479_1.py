...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'CC(O)OF(1543)'],
    products = ['CC(OF)C(=O)O(567)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'O=C(O)COF(550)'],
    products = ['CC(OF)C(=O)O(567)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'CC(=C=O)OF(1591)'],
    products = ['CC(OF)C(=O)O(567)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3OH(26)', 'O=C=COF(1422)'],
    products = ['CC(OF)C(=O)O(567)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'CC([O])C(=O)O(1599)'],
    products = ['CC(OF)C(=O)O(567)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(160)', 'C[CH]C(=O)O(1600)'],
    products = ['CC(OF)C(=O)O(567)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'CC(OF)C([O])=O(1602)'],
    products = ['CC(OF)C(=O)O(567)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH3(19)', 'O=C(O)[CH]OF(1429)'],
    products = ['CC(OF)C(=O)O(567)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]O(146)', 'C[CH]OF(540)'],
    products = ['CC(OF)C(=O)O(567)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'C[C](OF)C(=O)O(1603)'],
    products = ['CC(OF)C(=O)O(567)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', '[CH2]C(OF)C(=O)O(1604)'],
    products = ['CC(OF)C(=O)O(567)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'CC(=O)C(=O)O(1105)'],
    products = ['CC(OF)C(=O)O(567)'],
