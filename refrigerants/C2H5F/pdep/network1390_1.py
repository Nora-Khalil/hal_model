...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.268128,0.0913976,-0.000150295,1.3464e-07,-4.73742e-11,-82449.1,26.9584], Tmin=(100,'K'), Tmax=(819.298,'K')), NASAPolynomial(coeffs=[8.71096,0.0345604,-1.76424e-05,3.43352e-09,-2.38615e-13,-83308.4,-8.89183], Tmin=(819.298,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-686.564,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(COCsFO) + radical(Csj(Cs-F1sO2sCs)(H)(H))"""),
)
...
"""),
    E0 = (-356.66,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,361,584,565,722,1474,326,540,652,719,1357,2950,3100,1380,975,1025,1650,200,800,1000,1200,1400,1600],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.219379,0.084216,-0.000105585,6.48004e-08,-1.55411e-11,-42761,25.5903], Tmin=(100,'K'), Tmax=(1022.31,'K')), NASAPolynomial(coeffs=[17.0549,0.0183429,-8.93083e-06,1.76988e-09,-1.27179e-13,-46203.2,-56.0028], Tmin=(1022.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-356.66,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsHHH) + group(CdCFO) + group(Cds-CdsHH) + radical(CCJ2_triplet)"""),
)

species(
    label = 'OC1(F)CC[C](F)O1(1412)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.491447,0.0631639,-5.51394e-05,2.54233e-08,-4.55061e-12,-79708.1,22.0046], Tmin=(100,'K'), Tmax=(1530.04,'K')), NASAPolynomial(coeffs=[15.0821,0.0183773,-4.72034e-06,6.17526e-10,-3.38784e-14,-83395.4,-52.0513], Tmin=(1530.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-663.88,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCFOO) + group(CsCFHO) + ring(Tetrahydrofuran) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[CH2]C1(F)CC(O)(F)O1(1413)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.868899,0.0723226,-7.86036e-05,4.50714e-08,-1.05519e-11,-73162.1,22.2657], Tmin=(100,'K'), Tmax=(1022.95,'K')), NASAPolynomial(coeffs=[12.2137,0.027962,-1.35563e-05,2.67987e-09,-1.91925e-13,-75483.1,-32.7238], Tmin=(1022.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-609.218,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCCFO) + group(Cs-CsCsHH) + group(CsCFOO) + group(Cs-CsHHH) + ring(O2s-Cs-Cs-Cs(F)) + radical(CJC(C)OC)"""),
)
...
"""),
    E0 = (-400.597,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([262,390,483,597,572,732,631,807,1275,1439,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,180,180,1014.38],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68833,0.0563022,-7.66948e-05,6.89057e-08,-2.62612e-11,-48102.8,21.4617], Tmin=(100,'K'), Tmax=(745.408,'K')), NASAPolynomial(coeffs=[4.74728,0.0332118,-1.67964e-05,3.32045e-09,-2.35401e-13,-48373.3,8.84683], Tmin=(745.408,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-400.597,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CdCFO) + group(CdCFO) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)

species(
    label = '[CH2][C](F)OC(=C)O(1200)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u0 p2 c0 {4,S} {12,S}
...
"""),
    E0 = (-161.099,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,395,473,707,1436,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.767977,'amu*angstrom^2'), symmetry=1, barrier=(17.6573,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.767838,'amu*angstrom^2'), symmetry=1, barrier=(17.6541,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.768187,'amu*angstrom^2'), symmetry=1, barrier=(17.6621,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.768121,'amu*angstrom^2'), symmetry=1, barrier=(17.6606,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.133463,0.0840862,-0.000111218,7.13603e-08,-1.76207e-11,-19235.5,25.7154], Tmin=(100,'K'), Tmax=(1002.42,'K')), NASAPolynomial(coeffs=[17.8579,0.0133593,-5.38319e-06,9.74068e-10,-6.65958e-14,-22789,-59.8377], Tmin=(1002.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-161.099,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)

species(
    label = '[CH2]C(O)(F)O[C]=C(1187)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-189.167,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([395,473,707,1436,326,540,652,719,1357,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,279.525,286.594,289.403],'cm^-1')),
        HinderedRotor(inertia=(0.518064,'amu*angstrom^2'), symmetry=1, barrier=(29.8191,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.119444,'amu*angstrom^2'), symmetry=1, barrier=(6.69526,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.258855,'amu*angstrom^2'), symmetry=1, barrier=(14.7768,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01434,0.0696815,-9.00174e-05,6.06845e-08,-1.63992e-11,-22647.5,23.4939], Tmin=(100,'K'), Tmax=(900.605,'K')), NASAPolynomial(coeffs=[11.7019,0.0222136,-1.09583e-05,2.16211e-09,-1.54071e-13,-24572.6,-26.9487], Tmin=(900.605,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-189.167,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(CdCFO) + group(Cds-CdsHH) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)

species(
    label = '[CH2]C([O])(F)OC(=C)F(541)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-331.632,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([373,336,502,477,708,1220,1477,326,540,652,719,1357,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,254.518,254.932,255.157],'cm^-1')),
        HinderedRotor(inertia=(0.448807,'amu*angstrom^2'), symmetry=1, barrier=(20.6409,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.232376,'amu*angstrom^2'), symmetry=1, barrier=(10.8146,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.645153,'amu*angstrom^2'), symmetry=1, barrier=(29.9157,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.528555,0.0808252,-0.000103872,6.85279e-08,-1.80535e-11,-39764.9,24.7487], Tmin=(100,'K'), Tmax=(924.056,'K')), NASAPolynomial(coeffs=[13.5635,0.0244002,-1.22787e-05,2.44666e-09,-1.75454e-13,-42173.9,-37.1077], Tmin=(924.056,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-331.632,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsHHH) + group(CdCFO) + group(Cds-CdsHH) + radical(O2sj(Cs-F1sO2sCs)) + radical(Csj(Cs-F1sO2sO2s)(H)(H))"""),
)

species(
    label = '[CH]=C(F)OC([CH2])(O)F(1414)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    E0 = (-327.854,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,364,474,579,619,655,1345,3000,3100,440,815,1455,1000,293,496,537,1218,3120,650,792.5,1650,234.356,238.113,239.66],'cm^-1')),
        HinderedRotor(inertia=(0.269799,'amu*angstrom^2'), symmetry=1, barrier=(10.8613,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.560342,'amu*angstrom^2'), symmetry=1, barrier=(22.1115,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.552104,'amu*angstrom^2'), symmetry=1, barrier=(22.0882,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.562082,'amu*angstrom^2'), symmetry=1, barrier=(22.0731,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0445683,0.0928076,-0.000129893,8.91485e-08,-2.3873e-11,-39289.4,26.0978], Tmin=(100,'K'), Tmax=(918.703,'K')), NASAPolynomial(coeffs=[16.8638,0.0191894,-9.69396e-06,1.92467e-09,-1.37462e-13,-42396.1,-54.0415], Tmin=(918.703,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-327.854,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsHHH) + group(CdCFO) + group(Cds-CdsHH) + radical(Csj(Cs-F1sO2sO2s)(H)(H)) + radical(Cdj(Cd-F1sO2s)(H))"""),
)

species(
    label = '[CH2]C(=O)OC(=C)F(640)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u0 p2 c0 {4,D}
...
"""),
    E0 = (-542.424,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,361,584,565,722,1474,2750,2800,2850,1350,1500,750,1050,1375,1000,293,496,537,1218,3120,650,792.5,1650,228.307,228.317,228.329],'cm^-1')),
        HinderedRotor(inertia=(0.484478,'amu*angstrom^2'), symmetry=1, barrier=(17.9207,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.48445,'amu*angstrom^2'), symmetry=1, barrier=(17.9207,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.484497,'amu*angstrom^2'), symmetry=1, barrier=(17.9208,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.48448,'amu*angstrom^2'), symmetry=1, barrier=(17.9207,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.115874,0.0862808,-0.000104828,6.30485e-08,-1.4882e-11,-65099.3,25.0693], Tmin=(100,'K'), Tmax=(1036.36,'K')), NASAPolynomial(coeffs=[17.122,0.020641,-9.81984e-06,1.9306e-09,-1.38196e-13,-68624.1,-57.5825], Tmin=(1036.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-542.424,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsHHH) + group(CdCFO) + group(Cds-CdsHH) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    E0 = (-554.089,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,361,584,565,722,1474,528,1116,1182,1331,1402,1494,3075,3110,2950,3100,1380,975,1025,1650,1685,370,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.947465,'amu*angstrom^2'), symmetry=1, barrier=(21.7841,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.94869,'amu*angstrom^2'), symmetry=1, barrier=(21.8123,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.947575,'amu*angstrom^2'), symmetry=1, barrier=(21.7866,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.949147,'amu*angstrom^2'), symmetry=1, barrier=(21.8228,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.000774826,0.0825284,-9.34812e-05,5.13645e-08,-1.09121e-11,-66492.8,28.391], Tmin=(100,'K'), Tmax=(1158.87,'K')), NASAPolynomial(coeffs=[19.5353,0.0151026,-6.20794e-06,1.1587e-09,-8.1373e-14,-71020.4,-68.732], Tmin=(1158.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-554.089,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(O)(F)OC(=C)F(1267)'],
    products = ['HF(38)', 'CH2CO(28)', 'CH2CFO(78)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(6.14547e+10,'s^-1'), n=0.631481, Ea=(84.9352,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R!H->C_5Br1sCl1sF1sH->F1s_Ext-2C-R_N-7R!H->C_Ext-2C-R',), comment="""Estimated from node Root_N-1R!H->C_5Br1sCl1sF1sH->F1s_Ext-2C-R_N-7R!H->C_Ext-2C-R"""),
)

reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(O)(F)OC(=C)F(1267)'],
    products = ['[CH2]C(O)(F)CC(=O)F(1410)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(9.39365e+11,'s^-1'), n=0.324012, Ea=(116.852,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.014478493324023197, var=15.997960675483611, Tref=1000.0, N=8, data_mean=0.0, correlation='Root_N-1R!H-inRing_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R!H-inRing_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=C(F)O[C](O)F(1379)'],
    products = ['[CH2]C(O)(F)OC(=C)F(1267)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(6)', '[CH]C(O)(F)OC(=C)F(1411)'],
    products = ['[CH2]C(O)(F)OC(=C)F(1267)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(O)(F)OC(=C)F(1267)'],
    products = ['[CH2]C1(F)CC(O)(F)O1(1413)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(3.66246e+06,'s^-1'), n=1.355, Ea=(60.8772,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R5_SS_D;doublebond_intra_2H;radadd_intra_cs2H]
Euclidian distance = 0
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH2]C(O)(F)O[C]=C(1187)'],
    products = ['[CH2]C(O)(F)OC(=C)F(1267)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2CFO(78)', '[CH2][C](O)F(508)'],
    products = ['[CH2]C(O)(F)OC(=C)F(1267)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(4.65251,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)

reaction(
    label = 'reaction13',
    reactants = ['CH2CF(69)', '[CH2]C([O])(O)F(517)'],
    products = ['[CH2]C(O)(F)OC(=C)F(1267)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(5)', '[CH2][C](F)OC(=C)F(600)'],
    products = ['[CH2]C(O)(F)OC(=C)F(1267)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(6)', '[CH2]C([O])(F)OC(=C)F(541)'],
    products = ['[CH2]C(O)(F)OC(=C)F(1267)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(6)', '[CH]=C(F)OC([CH2])(O)F(1414)'],
    products = ['[CH2]C(O)(F)OC(=C)F(1267)'],
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(O)(F)OC(=C)F(1267)'],
    products = ['CH2CFO(78)', 'CC(=O)F(253)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(4.02942e+10,'s^-1'), n=0.375329, Ea=(99.1265,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.06684469846581474, var=24.965000021544366, Tref=1000.0, N=36, data_mean=0.0, correlation='Root_N-1R!H->C_N-5R!H->N',), comment="""Estimated from node Root_N-1R!H->C_N-5R!H->N"""),
)

reaction(
    label = 'reaction17',
    reactants = ['HF(38)', '[CH2]C(=O)OC(=C)F(640)'],
    products = ['[CH2]C(O)(F)OC(=C)F(1267)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(176.932,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'C#COC([CH2])(O)F(635)'],
    products = ['[CH2]C(O)(F)OC(=C)F(1267)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]=C(F)OC(C)(O)F(1380)'],
    products = ['[CH2]C(O)(F)OC(=C)F(1267)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C=[C]OC(O)(F)CF(1416)'],
    products = ['[CH2]C(O)(F)OC(=C)F(1267)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(181.677,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

network(
    label = 'PDepNetwork #1390',
    isomers = [
        '[CH2]C(O)(F)OC(=C)F(1267)',
    ],
    reactants = [
        ('HF(38)', 'CH2CO(28)', 'CH2CFO(78)'),
        ('CH2CFO(78)', 'CC(=O)F(253)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
