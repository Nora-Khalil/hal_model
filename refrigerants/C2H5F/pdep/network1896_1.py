...
reaction(
    label = 'reaction15',
    reactants = ['C=C(F)OC(O)F(2865)'],
    products = ['CHFO(47)', 'CC(=O)F(499)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(F)O[C](O)F(3303)'],
    products = ['C=C(F)OC(O)F(2865)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)O[CH]O(3307)'],
    products = ['C=C(F)OC(O)F(2865)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=[C]OC(O)F(3308)'],
    products = ['C=C(F)OC(O)F(2865)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.52887e+10,'m^3/(mol*s)'), n=-0.421056, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.030895812897821735, var=3.1393582276389975, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_N-3R!H->F_N-3BrCClINOPSSi->Cl_Ext-1C-R_Ext-3BrCO-R_Ext-5R!H-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_N-3R!H->F_N-3BrCClINOPSSi->Cl_Ext-1C-R_Ext-3BrCO-R_Ext-5R!H-R"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['O[CH]F(1908)', 'CH2CFO(78)'],
    products = ['C=C(F)OC(O)F(2865)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(O)F(2025)', 'CH2CF(69)'],
    products = ['C=C(F)OC(O)F(2865)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', 'C=C(F)O[CH]F(2010)'],
    products = ['C=C(F)OC(O)F(2865)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C=C(F)OC([O])F(2055)'],
    products = ['C=C(F)OC(O)F(2865)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C(F)O[C](O)F(3309)'],
    products = ['C=C(F)OC(O)F(2865)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH]=C(F)OC(O)F(3310)'],
    products = ['C=C(F)OC(O)F(2865)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'C=C(F)OC=O(1276)'],
    products = ['C=C(F)OC(O)F(2865)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C#COC(O)F(2046)'],
    products = ['C=C(F)OC(O)F(2865)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(25)', 'OC(F)[O+]=[C-]F(3313)'],
    products = ['C=C(F)OC(O)F(2865)'],
