...
reaction(
    label = 'reaction3',
    reactants = ['[C]=CF(1334)', '[CH2]C(=C)[O](609)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C=C([O])CC#CF(8460)'],
    products = ['C=C([O])C[C]=CF(8480)'],
