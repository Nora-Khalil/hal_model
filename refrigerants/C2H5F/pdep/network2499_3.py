...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (76.0447,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(2761.53,'J/mol'), sigma=(4.65312,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=431.34 K, Pc=62.2 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
reaction(
    label = 'reaction1',
    reactants = ['CF2(43)', 'CH2CHF(55)'],
    products = ['FC=CC(F)F(2513)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['HF(38)', 'F[C]C=CF-2(5938)'],
    products = ['FC=CC(F)F(2513)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[CH]C=C(F)F(4388)'],
    products = ['FC=CC(F)F(2513)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', '[CH]C(F)F-2(4412)'],
    products = ['FC=CC(F)F(2513)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H2(8)', 'F[C]C=C(F)F-2(5936)'],
    products = ['FCC=C(F)F(4984)'],
...
reaction(
    label = 'reaction23',
    reactants = ['FCC=C(F)F(4984)'],
    products = ['C=CC(F)(F)F(7114)'],
...
reaction(
    label = 'reaction25',
    reactants = ['F(37)', '[CH2]C=C(F)F(3705)'],
    products = ['FCC=C(F)F(4984)'],
...
reaction(
    label = 'reaction31',
    reactants = ['HF(38)', 'C=C=C(F)F(11712)'],
    products = ['FCC=C(F)F(4984)'],
