...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CC[CH]F(967)'],
    products = ['CC([O])C[CH]F(1124)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(837)', '[CH2]C(C)[O](351)'],
    products = ['CC([O])C[CH]F(1124)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', 'O=CC[CH]F(986)'],
    products = ['CC([O])C[CH]F(1124)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'CC(=O)C[CH]F(1210)'],
    products = ['CC([O])C[CH]F(1124)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', '[CH2]C(C)[O](351)'],
    products = ['CC([O])C[CH]F(1124)'],
