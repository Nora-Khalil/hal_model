...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH]C(=O)F(408)'],
    products = ['[CH]=C(F)O[CH2](2538)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][O](131)', '[CH]=[C]F(1321)'],
    products = ['[CH]=C(F)O[CH2](2538)'],
    transitionState = 'TS7',
