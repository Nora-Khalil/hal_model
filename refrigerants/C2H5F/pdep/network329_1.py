...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH]C=C(341)'],
    products = ['[CH]=CC[CH2](423)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=[CH](135)', '[CH2][CH2](138)'],
    products = ['[CH]=CC[CH2](423)'],
    transitionState = 'TS9',
