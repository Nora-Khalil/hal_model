...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9251,0.0518493,-4.23771e-05,1.66467e-08,-2.73144e-12,-78719.5,20.6838], Tmin=(100,'K'), Tmax=(1357.8,'K')), NASAPolynomial(coeffs=[10.4733,0.026667,-1.45577e-05,2.98769e-09,-2.16533e-13,-81040.9,-23.1707], Tmin=(1357.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-655.085,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(CdCsCdF) + group(Cds-OdCsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F))"""),
)

species(
    label = 'O=C=CC(F)C(F)F(2617)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
4  O u0 p2 c0 {8,D}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32404,0.0639758,-7.8025e-05,5.21787e-08,-1.44197e-11,-82654.9,22.8056], Tmin=(100,'K'), Tmax=(869.499,'K')), NASAPolynomial(coeffs=[9.45678,0.0265642,-1.34881e-05,2.69897e-09,-1.93924e-13,-84069.3,-15.2933], Tmin=(869.499,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-687.996,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(CsCCFH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    E0 = (-495.124,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,323,467,575,827,1418,182,240,577,636,1210,1413,1855,455,950,269.723],'cm^-1')),
        HinderedRotor(inertia=(0.00231747,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73024,0.0559443,-6.02285e-05,3.34582e-08,-7.76076e-12,-59472.9,22.2261], Tmin=(100,'K'), Tmax=(1012.72,'K')), NASAPolynomial(coeffs=[9.67038,0.0245827,-1.37769e-05,2.87943e-09,-2.12065e-13,-61081.1,-16.1808], Tmin=(1012.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-495.124,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(CdCsCdF) + group(Cds-OdCsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F)) + radical(CCCJ=O)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.906021,'amu*angstrom^2'), symmetry=1, barrier=(20.8312,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83106,0.0574999,-6.37601e-05,-1.63003e-09,3.9908e-11,-23021.8,20.5868], Tmin=(100,'K'), Tmax=(484.62,'K')), NASAPolynomial(coeffs=[7.96508,0.0240926,-1.36639e-05,2.78629e-09,-1.99399e-13,-23818.5,-6.64948], Tmin=(484.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-191.98,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + radical(Csj(Cd-CdH)(F1s)(F1s)) + radical(C=CCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.735973,0.082258,-0.000146264,1.35825e-07,-4.8148e-11,-57551.4,28.2692], Tmin=(100,'K'), Tmax=(850.682,'K')), NASAPolynomial(coeffs=[7.2048,0.0299299,-1.53586e-05,2.9584e-09,-2.02882e-13,-57859.1,2.76682], Tmin=(850.682,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-479.403,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdCsH) + radical(CsCsCsF1s) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C=CC(F)[C](F)F(2622)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.00678,'amu*angstrom^2'), symmetry=1, barrier=(23.1479,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00649,'amu*angstrom^2'), symmetry=1, barrier=(23.1411,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.948124,0.0642727,-6.62182e-05,3.33262e-08,-6.60122e-12,-56551.2,25.9888], Tmin=(100,'K'), Tmax=(1223.88,'K')), NASAPolynomial(coeffs=[15.5076,0.0166874,-7.89646e-06,1.55704e-09,-1.11713e-13,-60115,-47.1936], Tmin=(1223.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-471.127,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Csj(Cs-F1sCdH)(F1s)(F1s))"""),
)

species(
    label = 'O=[C][CH]C(F)C(F)F(2623)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.975585,0.070262,-9.40642e-05,6.68895e-08,-1.90319e-11,-60312.9,25.1713], Tmin=(100,'K'), Tmax=(858.496,'K')), NASAPolynomial(coeffs=[11.2394,0.0224422,-1.0516e-05,2.01356e-09,-1.40592e-13,-62075.3,-22.7804], Tmin=(858.496,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-502.347,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdCsH) + radical(CCJCHO) + radical(CCCJ=O)"""),
)

species(
    label = 'O=CC[C](F)[C](F)F(2624)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-437.988,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,212,367,445,1450,2782.5,750,1395,475,1775,1000,190,488,555,1236,1407,180,1840.57],'cm^-1')),
        HinderedRotor(inertia=(0.301755,'amu*angstrom^2'), symmetry=1, barrier=(6.93794,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.301847,'amu*angstrom^2'), symmetry=1, barrier=(6.94006,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.301884,'amu*angstrom^2'), symmetry=1, barrier=(6.9409,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22205,0.0656904,-8.97651e-05,6.78687e-08,-2.08682e-11,-62991.5,27.2683], Tmin=(100,'K'), Tmax=(791.5,'K')), NASAPolynomial(coeffs=[9.34527,0.0246346,-1.19522e-05,2.32263e-09,-1.63289e-13,-64277.3,-10.0215], Tmin=(791.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-524.538,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFF) + group(Cds-OdCsH) + radical(CCJCC=O) + radical(CCCJ=O)"""),
)

species(
    label = 'O=C(F)C[CH][C](F)F(2626)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11225,0.071121,-0.000114741,1.04529e-07,-3.77261e-11,-58956.3,28.5066], Tmin=(100,'K'), Tmax=(807.67,'K')), NASAPolynomial(coeffs=[6.67404,0.0306993,-1.57547e-05,3.0845e-09,-2.15562e-13,-59434.7,5.46221], Tmin=(807.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-490.994,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + group(COCsFO) + radical(CCJCC=O) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(138)', 'O=[C]C[CH]F(2614)'],
    products = ['O=[C]CC(F)[C](F)F(2329)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(192)', '[CH2]C(F)[C](F)F(1037)'],
    products = ['O=[C]CC(F)[C](F)F(2329)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['CO(13)', '[CH2]C(F)[C](F)F(1037)'],
    products = ['O=[C]CC(F)[C](F)F(2329)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=[C]CC=C(F)F(1671)'],
    products = ['O=[C]CC(F)[C](F)F(2329)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=[C]CC(F)=C(F)F(2618)'],
    products = ['O=[C]CC(F)[C](F)F(2329)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C=CC(F)[C](F)F(2619)'],
    products = ['O=[C]CC(F)[C](F)F(2329)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=[C]C=C[C](F)F(2620)'],
    products = ['O=[C]CC(F)[C](F)F(2329)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CF2(43)', 'O=[C]C[CH]F(2614)'],
    products = ['O=[C]CC(F)[C](F)F(2329)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]CC(F)[C](F)F(2329)'],
    products = ['O=[C][CH]C(F)C(F)F(2623)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O=[C]CC(F)[C](F)F(2329)'],
    products = ['O=[C]C[CH]C(F)(F)F(2625)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O=[C]CC(F)[C](F)F(2329)'],
    products = ['O=C(F)C[CH][C](F)F(2626)'],
