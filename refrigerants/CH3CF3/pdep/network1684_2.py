...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[C]C(F)(F)F-2(6093)'],
    products = ['CF3-CHF(54)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'F[C]C(F)F-2(958)'],
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', 'F[C](F)[C](F)F(1586)'],
    products = ['CHF2-CF2(69)'],
