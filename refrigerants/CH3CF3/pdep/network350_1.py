...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)CC(F)[C](F)F(1031)'],
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(138)', '[CH2]C(F)[C](F)F(1052)'],
    products = ['F[C](F)CC(F)[C](F)F(1031)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[C](F)CC(F)=C(F)F(1056)'],
    products = ['F[C](F)CC(F)[C](F)F(1031)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'F[C](F)C(F)C=C(F)F(1057)'],
    products = ['F[C](F)CC(F)[C](F)F(1031)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'F[C](F)C=C[C](F)F(1058)'],
    products = ['F[C](F)CC(F)[C](F)F(1031)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CF2(43)', '[CH2]C(F)[C](F)F(1052)'],
    products = ['F[C](F)CC(F)[C](F)F(1031)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C](F)CC(F)[C](F)F(1031)'],
    products = ['F[C](F)C[C](F)C(F)F(1059)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C](F)C(F)[CH]C(F)F(1060)'],
    products = ['F[C](F)CC(F)[C](F)F(1031)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C](F)[CH]C(F)C(F)F(1061)'],
    products = ['F[C](F)CC(F)[C](F)F(1031)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[C](F)CC(F)[C](F)F(1031)'],
    products = ['F[C](F)[C](F)CC(F)F(1062)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C](F)CC(F)[C](F)F(1031)'],
    products = ['F[C](F)C[CH]C(F)(F)F(1063)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F[C](F)CC(F)[C](F)F(1031)'],
    products = ['F[C](F)[CH]CC(F)(F)F(1064)'],
