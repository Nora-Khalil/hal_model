...
reaction(
    label = 'reaction1',
    reactants = ['CF2(43)', 'CF2O(49)'],
    products = ['FC1(F)OC1(F)F(1013)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C]1OC1(F)F(7831)'],
    products = ['FC1(F)OC1(F)F(1013)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F2(78)', 'FC1=C(F)O1(7832)'],
    products = ['FC1(F)OC1(F)F(1013)'],
    transitionState = 'TS6',
