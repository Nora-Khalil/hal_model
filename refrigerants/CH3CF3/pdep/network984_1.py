...
"""),
    E0 = (-645.043,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,186.247,187.295],'cm^-1')),
        HinderedRotor(inertia=(0.207564,'amu*angstrom^2'), symmetry=1, barrier=(5.10776,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.212712,'amu*angstrom^2'), symmetry=1, barrier=(5.1129,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.64024,'amu*angstrom^2'), symmetry=1, barrier=(39.3889,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.65147,'amu*angstrom^2'), symmetry=1, barrier=(39.3727,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.276582,0.103935,-0.000171242,1.52169e-07,-5.37323e-11,-77436.3,33.796], Tmin=(100,'K'), Tmax=(784.944,'K')), NASAPolynomial(coeffs=[10.5299,0.0367816,-1.98204e-05,3.95122e-09,-2.78939e-13,-78760.5,-13.351], Tmin=(784.944,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-645.043,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.309443,0.104305,-0.000172852,1.51661e-07,-5.25117e-11,-120043,31.9558], Tmin=(100,'K'), Tmax=(798.186,'K')), NASAPolynomial(coeffs=[11.366,0.0338464,-1.79862e-05,3.5569e-09,-2.49579e-13,-121526,-19.355], Tmin=(798.186,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-999.309,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCsFFH) + group(Cds-OdCsH) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-255.43,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,90,150,250,247,323,377,431,433,1065,1274,249.514,862.057,1149.41,1498.38,1864.78],'cm^-1')),
        HinderedRotor(inertia=(0.117207,'amu*angstrom^2'), symmetry=1, barrier=(3.40327,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117207,'amu*angstrom^2'), symmetry=1, barrier=(3.40327,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117207,'amu*angstrom^2'), symmetry=1, barrier=(3.40327,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117207,'amu*angstrom^2'), symmetry=1, barrier=(3.40327,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.26681,0.0907458,-0.000146887,1.30828e-07,-4.66966e-11,-30595.1,29.8375], Tmin=(100,'K'), Tmax=(772.522,'K')), NASAPolynomial(coeffs=[9.25903,0.034418,-1.85508e-05,3.70995e-09,-2.62835e-13,-31693,-9.33748], Tmin=(772.522,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-255.43,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.221297,'amu*angstrom^2'), symmetry=1, barrier=(5.08805,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127279,'amu*angstrom^2'), symmetry=1, barrier=(51.701,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.24879,'amu*angstrom^2'), symmetry=1, barrier=(51.704,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69191,0.0559927,-6.7289e-05,4.66596e-08,-1.37488e-11,-24700.5,22.0546], Tmin=(100,'K'), Tmax=(808.727,'K')), NASAPolynomial(coeffs=[7.48742,0.0273299,-1.41304e-05,2.84202e-09,-2.04628e-13,-25638,-4.67548], Tmin=(808.727,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-206.024,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(CsJOOC)"""),
)

species(
    label = 'FC1(F)[CH]OOCC1(F)F(2756)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.309952,0.0857023,-9.59424e-05,5.43214e-08,-1.18073e-11,-98840.7,25.0754], Tmin=(100,'K'), Tmax=(1214.9,'K')), NASAPolynomial(coeffs=[19.1575,0.0165081,-4.2155e-06,5.3272e-10,-2.79782e-14,-103195,-71.0848], Tmin=(1214.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-823.164,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCsCsFF) + group(CsCsCsFF) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(12dioxane) + radical(CCsJOOC) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)2)"""),
)

species(
    label = 'F[C](F)C1OOCC1(F)F(2757)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0603644,0.0850035,-9.51619e-05,5.18764e-08,-1.02264e-11,-97698.6,27.1601], Tmin=(100,'K'), Tmax=(923.876,'K')), NASAPolynomial(coeffs=[17.8569,0.0188082,-6.16254e-06,9.86196e-10,-6.30435e-14,-101495,-60.4899], Tmin=(923.876,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-813.561,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(Cs-CsOsHH) + group(CsCsFFH) + ring(12dioxolane) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.524101,'amu*angstrom^2'), symmetry=1, barrier=(12.0501,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.015416,'amu*angstrom^2'), symmetry=1, barrier=(40.3008,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.75205,'amu*angstrom^2'), symmetry=1, barrier=(40.2832,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.700316,0.0826979,-0.000108442,6.53689e-08,-7.9305e-12,-78266.1,31.0163], Tmin=(100,'K'), Tmax=(564.537,'K')), NASAPolynomial(coeffs=[9.44385,0.0348562,-1.88156e-05,3.80218e-09,-2.72545e-13,-79478.1,-8.15854], Tmin=(564.537,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-651.648,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = 'F[C]=COOC[C](F)F(2758)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-458.602,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,190,488,555,1236,1407,182,240,577,636,1210,1413,180,2213.29],'cm^-1')),
        HinderedRotor(inertia=(0.327662,'amu*angstrom^2'), symmetry=1, barrier=(7.53359,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.77266,'amu*angstrom^2'), symmetry=1, barrier=(40.757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.7723,'amu*angstrom^2'), symmetry=1, barrier=(40.7488,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.77201,'amu*angstrom^2'), symmetry=1, barrier=(40.742,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.287268,0.106006,-0.000186168,1.70312e-07,-6.05714e-11,-55014,34.1284], Tmin=(100,'K'), Tmax=(814.331,'K')), NASAPolynomial(coeffs=[10.0386,0.0354028,-1.9494e-05,3.8803e-09,-2.72222e-13,-56036.6,-9.51953], Tmin=(814.331,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-458.602,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(CCsJOOC) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = 'F[C](F)COO[C]=C(F)F(2759)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-405.299,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,562,600,623,1070,1265,1685,370,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.158628,'amu*angstrom^2'), symmetry=1, barrier=(3.64717,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.158951,'amu*angstrom^2'), symmetry=1, barrier=(3.6546,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.158954,'amu*angstrom^2'), symmetry=1, barrier=(3.65466,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.35557,'amu*angstrom^2'), symmetry=1, barrier=(54.1592,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.122396,0.106378,-0.000200605,1.94169e-07,-7.12431e-11,-48612.9,36.3689], Tmin=(100,'K'), Tmax=(837.204,'K')), NASAPolynomial(coeffs=[6.67121,0.0404089,-2.23713e-05,4.43152e-09,-3.08645e-13,-48576.1,11.8145], Tmin=(837.204,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-405.299,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical(C=CJO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.853059,'amu*angstrom^2'), symmetry=1, barrier=(19.6135,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0924479,'amu*angstrom^2'), symmetry=1, barrier=(2.12556,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.72502,'amu*angstrom^2'), symmetry=1, barrier=(39.6616,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (139.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0676581,0.097536,-0.000173988,1.60406e-07,-5.74089e-11,-18618.9,29.951], Tmin=(100,'K'), Tmax=(810.351,'K')), NASAPolynomial(coeffs=[9.56492,0.0319625,-1.80055e-05,3.61336e-09,-2.54567e-13,-19544.4,-10.0835], Tmin=(810.351,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-155.895,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Ct-CtOs) + group(CtCF) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = 'F[C]COOC=C(F)F-2(2761)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.247717,'amu*angstrom^2'), symmetry=1, barrier=(5.69551,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.247468,'amu*angstrom^2'), symmetry=1, barrier=(5.68978,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.12005,'amu*angstrom^2'), symmetry=1, barrier=(48.7441,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.11969,'amu*angstrom^2'), symmetry=1, barrier=(48.7359,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.445278,0.0855721,-0.000131829,1.13643e-07,-3.97739e-11,-31091.6,30.8932], Tmin=(100,'K'), Tmax=(753.717,'K')), NASAPolynomial(coeffs=[9.35,0.0332036,-1.74371e-05,3.46656e-09,-2.45429e-13,-32288.8,-8.58622], Tmin=(753.717,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-259.516,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.192029,'amu*angstrom^2'), symmetry=1, barrier=(4.41513,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.192102,'amu*angstrom^2'), symmetry=1, barrier=(4.41681,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191999,'amu*angstrom^2'), symmetry=1, barrier=(4.41442,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.26692,'amu*angstrom^2'), symmetry=1, barrier=(52.121,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0697442,0.102682,-0.000180482,1.71232e-07,-6.29505e-11,-72963.5,35.342], Tmin=(100,'K'), Tmax=(818.22,'K')), NASAPolynomial(coeffs=[7.025,0.0423601,-2.28955e-05,4.53874e-09,-3.1803e-13,-73266.3,7.78178], Tmin=(818.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-607.766,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(C=CJO)"""),
)

species(
    label = 'F[C]=COOCC(F)(F)F(2764)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-631.174,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,3010,987.5,1337.5,450,1655,167,640,1190,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.237921,'amu*angstrom^2'), symmetry=1, barrier=(5.47028,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.238199,'amu*angstrom^2'), symmetry=1, barrier=(5.47667,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05826,'amu*angstrom^2'), symmetry=1, barrier=(24.3316,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.31445,'amu*angstrom^2'), symmetry=1, barrier=(53.2137,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.346861,0.105447,-0.000174546,1.54155e-07,-5.38884e-11,-75765.7,32.2999], Tmin=(100,'K'), Tmax=(791.912,'K')), NASAPolynomial(coeffs=[11.0619,0.0355966,-1.90869e-05,3.79131e-09,-2.66866e-13,-77189.4,-17.6592], Tmin=(791.912,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-631.174,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)COOC=C(F)F(2349)'],
    products = ['O=C[C](F)F(179)', 'FC1(F)CO1(165)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F[C](F)COOC=C(F)F(2349)'],
    products = ['O=CC(F)(F)OC[C](F)F(2754)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'F[C]COOC=C(F)F(2755)'],
    products = ['F[C](F)COOC=C(F)F(2349)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(138)', '[CH2]OOC=C(F)F(1224)'],
    products = ['F[C](F)COOC=C(F)F(2349)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C](F)COOC=C(F)F(2349)'],
    products = ['FC1(F)[CH]OOCC1(F)F(2756)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C](F)COOC=C(F)F(2349)'],
    products = ['F[C](F)C1OOCC1(F)F(2757)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['O=C[C](F)F(179)', '[O]C[C](F)F(174)'],
    products = ['F[C](F)COOC=C(F)F(2349)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(61.3774,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['[O]OC=C(F)F(177)', '[CH2][C](F)F(141)'],
    products = ['F[C](F)COOC=C(F)F(2349)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(8.14976e+13,'m^3/(mol*s)'), n=-2.27223, Ea=(2.27945,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.03642541003782715, var=3.51219038874387, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H"""),
)

reaction(
    label = 'reaction12',
    reactants = ['CF2CH(73)', '[O]OC[C](F)F(131)'],
    products = ['F[C](F)COOC=C(F)F(2349)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'F[C](F)[CH]OOC=C(F)F(1267)'],
    products = ['F[C](F)COOC=C(F)F(2349)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'F[C](F)COO[C]=C(F)F(2759)'],
    products = ['F[C](F)COOC=C(F)F(2349)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[C](F)COOC=C(F)F(2349)'],
    products = ['O=C[C](F)F(179)', 'O=CC(F)F(423)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(702.966,'s^-1'), n=2.72887, Ea=(33.7131,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'FC#COOC[C](F)F(2760)'],
    products = ['F[C](F)COOC=C(F)F(2349)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', 'F[C]COOC=C(F)F-2(2761)'],
    products = ['F[C](F)COOC=C(F)F(2349)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CF2(43)', '[CH2]OOC=C(F)F(1224)'],
    products = ['F[C](F)COOC=C(F)F(2349)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C](F)COOC=C(F)F(2349)'],
    products = ['FC(F)=COO[CH]C(F)F(2762)'],
...
reaction(
    label = 'reaction20',
    reactants = ['FC(F)=[C]OOCC(F)F(2763)'],
    products = ['F[C](F)COOC=C(F)F(2349)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[C]=COOCC(F)(F)F(2764)'],
    products = ['F[C](F)COOC=C(F)F(2349)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(4.94559e+07,'s^-1'), n=1.15307, Ea=(191.263,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF
...
network(
    ...
    isomers = [
        'F[C](F)COOC=C(F)F(2349)',
    ],
    reactants = [
        ('O=C[C](F)F(179)', 'FC1(F)CO1(165)'),
        ('O=C[C](F)F(179)', '[O]C[C](F)F(174)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
