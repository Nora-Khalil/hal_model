...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[O]C(F)C(F)(F)F(2765)'],
    products = ['[O]OC(F)C(F)(F)F(2753)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]OC(F)[C](F)F(975)'],
    products = ['[O]OC(F)C(F)(F)F(2753)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]O[C](F)C(F)(F)F(2766)'],
    products = ['[O]OC(F)C(F)(F)F(2753)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[O]OC(F)=C(F)F(1091)'],
    products = ['[O]OC(F)C(F)(F)F(2753)'],
