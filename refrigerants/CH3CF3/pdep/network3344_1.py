...
reaction(
    label = 'reaction2',
    reactants = ['O=C(O)O(2094)', 'C[C]F(325)'],
    products = ['CC(F)OC(=O)O(11072)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'COC(=O)O(11195)'],
    products = ['CC(F)OC(=O)O(11072)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'O=C(O)OCF(2053)'],
    products = ['CC(F)OC(=O)O(11072)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)OC([O])O(11199)'],
    products = ['CC(F)OC(=O)O(11072)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)O[C](O)O(11200)'],
    products = ['CC(F)OC(=O)O(11072)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[CH]OC(=O)O(11201)'],
    products = ['CC(F)OC(=O)O(11072)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(=O)O(1583)', 'CH3-CHF(63)'],
    products = ['CC(F)OC(=O)O(11072)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=[C]O(457)', 'CC([O])F(1798)'],
    products = ['CC(F)OC(=O)O(11072)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', 'CC(F)O[C]=O(10816)'],
    products = ['CC(F)OC(=O)O(11072)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'CC(F)OC([O])=O(11202)'],
    products = ['CC(F)OC(=O)O(11072)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(19)', 'O=C(O)O[CH]F(2101)'],
    products = ['CC(F)OC(=O)O(11072)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C[C](F)OC(=O)O(11203)'],
    products = ['CC(F)OC(=O)O(11072)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH2]C(F)OC(=O)O(11204)'],
    products = ['CC(F)OC(=O)O(11072)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CC(F)OC(=O)O(11072)'],
    products = ['O=C(O)O(2094)', 'CH2CHF(56)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C=COC(=O)O(2295)'],
    products = ['CC(F)OC(=O)O(11072)'],
