...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(790)', 'CH2(T)(18)'],
    products = ['[CH2]OC([O])=O(774)'],
    transitionState = 'TS2',
