...
"""),
    E0 = (-290.367,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,197,221,431,657,2120,512.5,787.5,180,1330.28,1331.64,1332.35,1333.1,1334.5],'cm^-1')),
        HinderedRotor(inertia=(0.00329035,'amu*angstrom^2'), symmetry=1, barrier=(4.13918,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.179371,'amu*angstrom^2'), symmetry=1, barrier=(4.1241,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79147,0.0730364,-0.000177128,2.10535e-07,-8.74435e-11,-34867.4,23.6402], Tmin=(100,'K'), Tmax=(842.942,'K')), NASAPolynomial(coeffs=[-7.70071,0.0547123,-3.17594e-05,6.38544e-09,-4.47428e-13,-31015.8,81.1664], Tmin=(842.942,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-290.367,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-CsH) + missing(O2d-Cdd) + group(Cs-OsOsOsH) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d) + radical(OCOJ) + radical(OCOJ)"""),
)

species(
    label = '[O]C(=O)OC(F)[C]=O(4963)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {6,S} {7,S}
3 O u1 p2 c0 {7,S}
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41984,0.0546222,-6.64468e-05,3.77456e-08,-8.23841e-12,-38290.7,23.1064], Tmin=(100,'K'), Tmax=(1129.44,'K')), NASAPolynomial(coeffs=[14.7311,0.00747954,-3.83746e-06,7.89793e-10,-5.83464e-14,-41297.6,-42.7331], Tmin=(1129.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-319.155,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-(Cds-O2d)H) + missing(O2d-Cdd) + group(Cds-OdOsOs) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(C=CJO)"""),
)
...
"""),
    E0 = (-313.274,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([197,221,431,657,2120,512.5,787.5,1855,455,950,180,180,917.403],'cm^-1')),
        HinderedRotor(inertia=(0.122463,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.59758,'amu*angstrom^2'), symmetry=1, barrier=(36.7316,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.029,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62481,0.057469,-9.80476e-05,8.61848e-08,-2.98335e-11,-37597.7,19.1862], Tmin=(100,'K'), Tmax=(784.988,'K')), NASAPolynomial(coeffs=[8.57415,0.0165439,-9.30917e-06,1.87371e-09,-1.326e-13,-38518.8,-11.5759], Tmin=(784.988,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-313.274,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + missing(O2d-Cdd) + group(Cd(Cdd-Od)FO) + group(Cds-OdOsH) + missing(Cdd-CdO2d) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (-201.126,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2782.5,750,1395,475,1775,1000,180,180,180,531.431,646.072,1600,1828.57,2971.43,3200],'cm^-1')),
    ...
    molecularWeight = (120.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31335,0.0751104,-0.000159895,1.63813e-07,-6.09291e-11,-24108.4,23.3398], Tmin=(100,'K'), Tmax=(871.309,'K')), NASAPolynomial(coeffs=[2.56525,0.030642,-1.66798e-05,3.23066e-09,-2.19813e-13,-22856.8,25.9071], Tmin=(871.309,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-201.126,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-O2d)H) + group(Cds-CdsCsCs) + group(COCFO) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['O=C1O[C](O)O[C]1F(5157)'],
    products = ['O=C=C(F)OC(=O)O(4305)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(=O)O[C](F)C=O(4298)'],
    products = ['O=C=C(F)OC(=O)O(4305)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=C=[C]OC(=O)O(5159)'],
    products = ['O=C=C(F)OC(=O)O(4305)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O=[C]O(457)', 'O=[C]C(=O)F(4240)'],
    products = ['O=C=C(F)OC(=O)O(4305)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(=O)O(1583)', 'O=C=[C]F(580)'],
    products = ['O=C=C(F)OC(=O)O(4305)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', 'O=[C]OC(F)=C=O(5160)'],
    products = ['O=C=C(F)OC(=O)O(4305)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(=O)OC(F)=C=O(4962)'],
    products = ['O=C=C(F)OC(=O)O(4305)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=C(F)[C-]=[O+]C(=O)O(5161)'],
    products = ['O=C=C(F)OC(=O)O(4305)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=C=C(F)OC(=O)O(4305)'],
    products = ['HF(38)', 'CO2(14)', 'O=C=C=O(4282)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C=C(F)OC(=O)O(4305)'],
    products = ['CO(13)', 'O=C(O)[O+]=[C-]F(5162)'],
