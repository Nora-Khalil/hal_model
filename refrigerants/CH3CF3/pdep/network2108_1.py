...
"""),
    E0 = (-688.229,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([197,221,431,657,2782.5,750,1395,475,1775,1000,94,120,354,641,825,1294,540,610,2055,485.769,485.784,485.789],'cm^-1')),
    ...
    molecularWeight = (138.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19479,0.0682946,-9.05111e-05,6.41475e-08,-1.86908e-11,-82679.6,24.4358], Tmin=(100,'K'), Tmax=(827.376,'K')), NASAPolynomial(coeffs=[9.84883,0.0264544,-1.46533e-05,3.02189e-09,-2.2028e-13,-84111.6,-15.6748], Tmin=(827.376,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-688.229,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CdCddFO) + group(Cds-OdOsH) + group(CdCddFF) + group(Cdd-CdsCds)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]OC(F)[C]=C(F)F(7184)'],
    products = ['CO2(14)', 'FC=C=C(F)F(1375)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(192)', '[O]C(F)[C]=C(F)F(7169)'],
    products = ['O=[C]OC(F)[C]=C(F)F(7184)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(F)F(1218)', 'O=[C]O[CH]F(1342)'],
    products = ['O=[C]OC(F)[C]=C(F)F(7184)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O=[C]OC(F)[C]=C(F)F(7184)'],
    products = ['O=C1OC(F)C1=C(F)F(7188)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[O]C(F)[C]=C(F)F(7169)'],
    products = ['O=[C]OC(F)[C]=C(F)F(7184)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CO2(14)', 'F[CH][C]=C(F)F(2138)'],
    products = ['O=[C]OC(F)[C]=C(F)F(7184)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=[C]OC=C=C(F)F(7791)'],
    products = ['O=[C]OC(F)[C]=C(F)F(7184)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O][C]=O(722)', 'FC=C=C(F)F(1375)'],
    products = ['O=[C]OC(F)[C]=C(F)F(7184)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=[C]OC(F)=C=C(F)F(7792)'],
    products = ['O=[C]OC(F)[C]=C(F)F(7184)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O=[C]OC(F)C#CF(7793)'],
    products = ['O=[C]OC(F)[C]=C(F)F(7184)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O][C]=O(722)', 'F[CH][C]=C(F)F(2138)'],
    products = ['O=[C]OC(F)[C]=C(F)F(7184)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]OC(F)[C]=C(F)F(7184)'],
    products = ['O=[C]OC(F)=C[C](F)F(7794)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]OC(F)[C]=C(F)F(7184)'],
    products = ['O=[C]O[CH]C(F)=C(F)F(7796)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OC(F)[C]=C(F)F(7184)'],
    products = ['O=C(F)O[CH][C]=C(F)F(7797)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=[C]OC(F)C(F)=[C]F(7798)'],
    products = ['O=[C]OC(F)[C]=C(F)F(7184)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=C(F)OC(F)[C]=[C]F(7799)'],
    products = ['O=[C]OC(F)[C]=C(F)F(7184)'],
...
network(
    ...
    isomers = [
        'O=[C]OC(F)[C]=C(F)F(7184)',
    ],
    reactants = [
        ('CO2(14)', 'FC=C=C(F)F(1375)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
