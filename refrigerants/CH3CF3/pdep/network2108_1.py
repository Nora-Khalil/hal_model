species(
    label = 'FOC(F)(F)C(F)(F)CC(F)F(6799)',
...
species(
    label = 'FOC(F)(CC(F)F)C(F)(F)F(7102)',
    structure = adjacencyList("""1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {11,S}
3  F u0 p3 c0 {11,S}
4  F u0 p3 c0 {11,S}
...
species(
    label = 'FOC(F)(F)C(F)(F)[CH]C(F)F(7107)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = 'FOC(F)(F)C(F)(F)C[C](F)F(7108)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {11,S}
...
reaction(
    label = 'reaction1',
    reactants = ['FOC(F)(F)C(F)(F)CC(F)F(6799)'],
...
reaction(
    ...
    products = ['FOC(F)(F)C(F)(F)CC(F)F(6799)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'FOC(F)(F)C(F)(F)C(F)F(2382)'],
    products = ['FOC(F)(F)C(F)(F)CC(F)F(6799)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['FOF(328)', 'F[C]C(F)(F)CC(F)F(7101)'],
    products = ['FOC(F)(F)C(F)(F)CC(F)F(6799)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['HF(38)', 'F[C]CC(F)(F)C(F)(F)OF(3697)'],
    products = ['FOC(F)(F)C(F)(F)CC(F)F(6799)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(40)', 'FCC(F)(F)C(F)(F)OF(1362)'],
    products = ['FOC(F)(F)C(F)(F)CC(F)F(6799)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['FOC(F)(F)C(F)(F)CC(F)F(6799)'],
    products = ['FOC(F)(CC(F)F)C(F)(F)F(7102)'],
...
reaction(
    label = 'reaction11',
    reactants = ['FOF(328)', 'FC(F)=C(F)CC(F)F(1039)'],
    products = ['FOC(F)(F)C(F)(F)CC(F)F(6799)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'FOC(F)(F)[C](F)CC(F)F(7103)'],
    products = ['FOC(F)(F)C(F)(F)CC(F)F(6799)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'FO[C](F)C(F)(F)CC(F)F(7104)'],
    products = ['FOC(F)(F)C(F)(F)CC(F)F(6799)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'F[CH]CC(F)(F)C(F)(F)OF(7105)'],
    products = ['FOC(F)(F)C(F)(F)CC(F)F(6799)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[O]C(F)(F)C(F)(F)CC(F)F(7106)'],
    products = ['FOC(F)(F)C(F)(F)CC(F)F(6799)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(127)', 'F[C](F)C(F)(F)CC(F)F(2363)'],
    products = ['FOC(F)(F)C(F)(F)CC(F)F(6799)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'FOC(F)(F)C(F)(F)[CH]C(F)F(7107)'],
    products = ['FOC(F)(F)C(F)(F)CC(F)F(6799)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'FOC(F)(F)C(F)(F)C[C](F)F(7108)'],
    products = ['FOC(F)(F)C(F)(F)CC(F)F(6799)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F2(78)', 'O=C(F)C(F)(F)CC(F)F(7109)'],
    products = ['FOC(F)(F)C(F)(F)CC(F)F(6799)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F2(78)', 'FOC(F)=C(F)CC(F)F(7110)'],
    products = ['FOC(F)(F)C(F)(F)CC(F)F(6799)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'FOC(F)(F)C(F)=CC(F)F(3688)'],
    products = ['FOC(F)(F)C(F)(F)CC(F)F(6799)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'FC=CC(F)(F)C(F)(F)OF(3078)'],
    products = ['FOC(F)(F)C(F)(F)CC(F)F(6799)'],
