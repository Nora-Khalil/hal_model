...
species(
    label = '[O]C(OC1(F)[CH]O1)C(=O)F(5396)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {10,S}
3  O u0 p2 c0 {7,S} {8,S}
...
species(
    label = 'O=C(F)C1OO[CH][C](F)O1(5319)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {10,S}
3  O u0 p2 c0 {7,S} {8,S}
...
species(
    label = '[O]C1(F)OC1O[C](F)C=O(5398)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  O u0 p2 c0 {7,S} {8,S}
...
species(
    label = '[O]C1OC(C(=O)F)O[C]1F(5399)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  O u0 p2 c0 {7,S} {8,S}
...
species(
    label = 'O=C[C](F)O[C](O)C(=O)F(5403)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  O u0 p2 c0 {7,S} {8,S}
...
species(
    label = '[O]C(C(=O)F)C([O])C(=O)F(5145)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  O u1 p2 c0 {7,S}
...
species(
    label = 'O=C(F)C(=O)O[C](F)[CH]O(5413)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {10,S}
3  O u0 p2 c0 {7,S} {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
...
reaction(
    label = 'reaction4',
    reactants = ['O=C[C]F(3808)', '[O]C([O])C(=O)F(4136)'],
    products = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
    products = ['O=CC(F)OC(=O)C(=O)F(5395)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
    products = ['O=C=C(F)OC(O)C(=O)F(5160)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
    products = ['[O]C(OC1(F)[CH]O1)C(=O)F(5396)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
    products = ['O=C[C](F)OC1OO[C]1F(5397)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
    products = ['O=C(F)C1OO[CH][C](F)O1(5319)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
    products = ['[O]C1(F)OC1O[C](F)C=O(5398)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
    products = ['[O]C1OC(C(=O)F)O[C]1F(5399)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=C[C](F)OC(=O)[C](O)F(5400)'],
    products = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CFO(51)', 'O=CO[C](F)C=O(4151)'],
    products = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'O=C[C](F)OC(=O)C(=O)F(5401)'],
    products = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', '[O]C(OC(F)=C=O)C(=O)F(5402)'],
    products = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O=C[C]F-2(1228)', '[O]C([O])C(=O)F(4136)'],
    products = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
    products = ['O=C[C](F)O[C](O)C(=O)F(5403)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C(OC(F)[C]=O)C(=O)F(5404)'],
    products = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
    products = ['[O][C](F)C(=O)OC(F)C=O(5405)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
    products = ['O=[C][C](F)OC(O)C(=O)F(5406)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O=[C]C(OF)O[C](F)C=O(5407)'],
    products = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[O]C([C]=O)OC(F)(F)C=O(5408)'],
    products = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
...
reaction(
    label = 'reaction30',
    reactants = ['O=[C]C=O(1495)', 'O=C[C](F)OF(3944)'],
    products = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[O]C(C(=O)F)C([O])C(=O)F(5145)'],
    products = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
...
reaction(
    label = 'reaction32',
    reactants = ['O(6)', '[CH]=C(F)OC([O])C(=O)F(5409)'],
    products = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
    products = ['O=C(F)C1OOC=C(F)O1(5324)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
    products = ['O=C(F)C(=O)OC(F)=CO(5410)'],
...
reaction(
    label = 'reaction38',
    reactants = ['HF(38)', '[O]C(O[C]=C=O)C(=O)F(5411)'],
    products = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[O]C(OC(F)=[C]O)C(=O)F(5412)'],
    products = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
    products = ['O=C(F)C(=O)O[C](F)[CH]O(5413)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[O]C=[C]OC(OF)C(=O)F(5414)'],
    products = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[O]C(O[C]=COF)C(=O)F(5415)'],
    products = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[O]C([C]=O)OC(F)=COF(5416)'],
    products = ['[O]C(O[C](F)C=O)C(=O)F(5148)'],
...
network(
    label = 'PDepNetwork #1592',
    isomers = [
        '[O]C(O[C](F)C=O)C(=O)F(5148)',
    ],
    reactants = [
