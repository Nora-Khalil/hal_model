...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'F[C]C=CF(869)'],
    products = ['[O]C(F)C=[C]F(5065)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[O]C=C=[C]F(5643)'],
    products = ['[O]C(F)C=[C]F(5065)'],
