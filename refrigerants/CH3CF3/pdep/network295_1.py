...
"""),
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3051.41,'J/mol'), sigma=(4.9,'angstroms'), dipoleMoment=(0,'De'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0.0, comment="""NIST_Fluorine"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'C=C(F)[C](F)F(2239)'],
    products = ['CH2CFCF3(83)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'C=[C]C(F)(F)F(7816)'],
    products = ['CH2CFCF3(83)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['F2(78)', 'C=C=C(F)F(3650)'],
    products = ['CH2CFCF3(83)'],
    transitionState = 'TS8',
