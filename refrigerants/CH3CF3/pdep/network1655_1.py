...
reaction(
    label = 'reaction1',
    reactants = ['[C-]=[O+]C(F)(F)C=C(F)F(5560)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', '[C-]=[O+]C=C(F)F(6068)'],
    products = ['[C-]=[O+]C(F)(F)C=C(F)F(5560)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C-]=[O+]F(6069)', 'F[C]C=C(F)F-2(1368)'],
    products = ['[C-]=[O+]C(F)(F)C=C(F)F(5560)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C-]=[O+]C(F)(F)C=C(F)F(5560)'],
    products = ['F[C-][O+]=C(F)C=C(F)F(6070)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C-]=[O+]C(F)(F)C=C(F)F(5560)'],
    products = ['FC(F)=C[C-][O+]=C(F)F(6071)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[C-]=[O+]C(F)=CC(F)(F)F(6072)'],
    products = ['[C-]=[O+]C(F)(F)C=C(F)F(5560)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['HF(38)', '[C-]=[O+]C(F)=C=C(F)F(6073)'],
    products = ['[C-]=[O+]C(F)(F)C=C(F)F(5560)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['HF(38)', '[C-]=[O+]C(F)(F)C#CF(6074)'],
    products = ['[C-]=[O+]C(F)(F)C=C(F)F(5560)'],
    transitionState = 'TS8',
