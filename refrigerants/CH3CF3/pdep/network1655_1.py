...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.114097,'amu*angstrom^2'), symmetry=1, barrier=(2.62332,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.461359,'amu*angstrom^2'), symmetry=1, barrier=(10.6075,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'OC(F)O[C](F)F(5869)'],
    products = ['OC(F)OC(F)(F)F(5765)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(7)', 'F[CH]OC(F)(F)F(5870)'],
    products = ['OC(F)OC(F)(F)F(5765)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)OC(F)(F)F(5871)'],
    products = ['OC(F)OC(F)(F)F(5765)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'O=COC(F)(F)F(1466)'],
    products = ['OC(F)OC(F)(F)F(5765)'],
