...
species(
    label = 'FC1(F)CC2(F)C1C2(F)F(11370)',
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.931363,0.0737863,-7.32044e-05,3.73564e-08,-7.94247e-12,-112517,18.9052], Tmin=(100,'K'), Tmax=(1098.77,'K')), NASAPolynomial(coeffs=[12.1251,0.0330363,-1.75739e-05,3.60319e-09,-2.62706e-13,-114977,-36.1525], Tmin=(1098.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-936.393,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(Cs-CsCsCsH) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(CsCsCsFF) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + polycyclic(s2_3_4_ane)"""),
)

species(
    label = 'FC(F)=CC1(F)CC1(F)F(11371)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
4  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.784471,0.0747065,-7.82576e-05,4.28853e-08,-9.64794e-12,-103731,26.0661], Tmin=(100,'K'), Tmax=(1057.26,'K')), NASAPolynomial(coeffs=[12.569,0.0301205,-1.49998e-05,2.99684e-09,-2.1578e-13,-106223,-31.4437], Tmin=(1057.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-863.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(CdCFF) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + ring(Cs-Cs(F)(F)-Cs)"""),
)
...
"""),
    E0 = (-705.353,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,323,467,575,827,1418,3010,987.5,1337.5,450,1655,190,488,555,1236,1407,161,297,490,584,780,1358,329.375,2115.22],'cm^-1')),
        HinderedRotor(inertia=(0.140916,'amu*angstrom^2'), symmetry=1, barrier=(10.8712,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141109,'amu*angstrom^2'), symmetry=1, barrier=(10.872,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.397363,'amu*angstrom^2'), symmetry=1, barrier=(30.5858,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
...
"""),
    E0 = (-432.746,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,1000,190,488,555,1236,1407,389.25,389.746,389.776,389.898,389.947,390.132,390.263],'cm^-1')),
        HinderedRotor(inertia=(0.269363,'amu*angstrom^2'), symmetry=1, barrier=(29.0306,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.269562,'amu*angstrom^2'), symmetry=1, barrier=(29.0301,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (139.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.756815,0.0671527,-6.42128e-05,2.99404e-08,-5.51718e-12,-51927.1,27.466], Tmin=(100,'K'), Tmax=(1306.5,'K')), NASAPolynomial(coeffs=[16.4647,0.0190612,-8.99867e-06,1.76637e-09,-1.26063e-13,-56031.6,-52.5151], Tmin=(1306.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-432.746,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCCFF) + group(CsCsFFH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cd-Cd-Cs(F)(F)) + radical(Csj(Cs-CdHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-377.211,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2950,1000,323,467,575,827,1418,190,488,555,1236,1407,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.371687,'amu*angstrom^2'), symmetry=1, barrier=(8.54581,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00625566,'amu*angstrom^2'), symmetry=1, barrier=(26.6363,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (139.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.514508,0.0855058,-0.00013993,1.2695e-07,-4.572e-11,-45251.1,26.3976], Tmin=(100,'K'), Tmax=(794.933,'K')), NASAPolynomial(coeffs=[8.01308,0.0343672,-1.81361e-05,3.59282e-09,-2.52829e-13,-46019.7,-5.39346], Tmin=(794.933,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-377.211,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(Cs-CsCsHH) + group(CsCsFFH) + group(Cds-CdsCsH) + group(CdCsCdF) + ring(Cs-Cd(F)-Cd) + radical(Csj(Cs-CsHH)(F1s)(F1s)) + longDistanceInteraction_cyclic(Cs(F)-Cds(F))"""),
)
...
"""),
    E0 = (-32.0117,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,271,519,563,612,1379,2950,1000,190,488,555,1236,1407,180,180,1471.11,1471.13,1471.33,1471.48],'cm^-1')),
        HinderedRotor(inertia=(2.55034,'amu*angstrom^2'), symmetry=1, barrier=(58.6373,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.090222,'amu*angstrom^2'), symmetry=1, barrier=(2.07438,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77272,0.0556733,-5.59785e-05,2.22284e-08,4.31767e-12,-3776.31,21.9136], Tmin=(100,'K'), Tmax=(554.25,'K')), NASAPolynomial(coeffs=[6.31002,0.0318872,-1.58521e-05,3.12879e-09,-2.22613e-13,-4416.89,1.45992], Tmin=(554.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-32.0117,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(CsCsFFH) + group(Cds-CdsCsH) + group(CdCsCdF) + ring(Cd-Cd(F)-Cs(C)) + radical(Allyl_T) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
species(
    label = 'F[C](F)[CH]C1(F)CC1(F)F(11378)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13776,0.0752972,-6.83022e-05,-1.92362e-08,5.75172e-11,-72478.8,29.1796], Tmin=(100,'K'), Tmax=(486.375,'K')), NASAPolynomial(coeffs=[8.1653,0.0386015,-2.02029e-05,4.02735e-09,-2.86059e-13,-73412,-2.22454], Tmin=(486.375,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-603.376,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCsFFH) + ring(Cs(F)(F)-Cs(C)-Cs) + radical(Cs_S) + radical(Csj(Cs-CsHH)(F1s)(F1s)) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
species(
    label = 'FC(F)(F)C[C]1[CH]C1(F)F(11379)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.443527,0.0851006,-0.000122505,1.02039e-07,-3.50449e-11,-75699.6,30.4223], Tmin=(100,'K'), Tmax=(737.554,'K')), NASAPolynomial(coeffs=[9.05907,0.0360977,-1.82129e-05,3.58244e-09,-2.52883e-13,-76908.5,-8.09995], Tmin=(737.554,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-630.413,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCsFFF) + ring(Cs(F)(F)-Cs(C)-Cs) + radical(Tertalkyl) + radical(Csj(Cs-CsCsH)(Cs-CsF1sF1s)(H)_ring)"""),
)

species(
    label = 'F[C](F)CC1(F)[C](F)C1F(11380)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-538.759,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([289,311,382,485,703,1397,259,529,569,1128,1321,1390,3140,2750,2850,1437.5,1250,1305,750,350,212,367,445,1450,190,488,555,1236,1407,251.875,2081.55],'cm^-1')),
        HinderedRotor(inertia=(1.09773,'amu*angstrom^2'), symmetry=1, barrier=(48.4318,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00380389,'amu*angstrom^2'), symmetry=1, barrier=(11.6603,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.308864,0.0880148,-0.000123548,9.64574e-08,-3.07611e-11,-64671.1,31.3171], Tmin=(100,'K'), Tmax=(762.523,'K')), NASAPolynomial(coeffs=[10.6256,0.033893,-1.70759e-05,3.36493e-09,-2.38203e-13,-66244.4,-15.6574], Tmin=(762.523,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-538.759,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(CsCsCsFH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(CsCsFFH) + ring(Cs(C)-Cs-Cs(F)) + radical(Csj(Cs-F1sCsCs)(Cs-CsF1sH)(F1s)_ring) + radical(Csj(Cs-CsHH)(F1s)(F1s)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'F[C]1[CH]C1(F)CC(F)(F)F(11381)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.428877,0.0852459,-0.000108252,7.43062e-08,-2.08913e-11,-70575.7,28.7756], Tmin=(100,'K'), Tmax=(858.623,'K')), NASAPolynomial(coeffs=[11.6517,0.0329637,-1.69171e-05,3.39115e-09,-2.43647e-13,-72503,-23.6574], Tmin=(858.623,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-587.821,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCsFFF) + ring(Cs(C)-Cs-Cs(F)) + radical(Csj(Cs-F1sCsCs)(Cs-CsHH)(F1s)_ring) + radical(Csj(Cs-F1sCsCs)(Cs-CsF1sH)(H)_ring) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)CC1(F)[CH]C1(F)F(11338)'],
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(138)', '[CH2]C1(F)[CH]C1(F)F(11369)'],
    products = ['F[C](F)CC1(F)[CH]C1(F)F(11338)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C](F)CC1(F)[CH]C1(F)F(11338)'],
    products = ['FC1(F)CC2(F)C1C2(F)F(11370)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C](F)CC1(F)[CH]C1(F)F(11338)'],
    products = ['FC(F)=CC1(F)CC1(F)F(11371)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[C](F)C=C(F)C[C](F)F(3110)'],
    products = ['F[C](F)CC1(F)[CH]C1(F)F(11338)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'F[C](F)CC1=CC1(F)F(11372)'],
    products = ['F[C](F)CC1(F)[CH]C1(F)F(11338)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(58.2843,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    ...
    products = ['F[C](F)CC1(F)[CH]C1(F)F(11338)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(14.2475,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'F[C](F)CC1(F)C=C1F(11373)'],
    products = ['F[C](F)CC1(F)[CH]C1(F)F(11338)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.000502707,'m^3/(mol*s)'), n=2.87982, Ea=(8.17084,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R-inRing_Ext-3R-R_Sp-4R!H-3R_N-4R!H->O_N-1R!H-inRing_Sp-2R!H=1R!H',), comment="""Estimated from node Root_3R-inRing_Ext-3R-R_Sp-4R!H-3R_N-4R!H->O_N-1R!H-inRing_Sp-2R!H=1R!H"""),
)

reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'FC(F)=CC1(F)[CH]C1(F)F(11374)'],
    products = ['F[C](F)CC1(F)[CH]C1(F)F(11338)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(78)', 'F[C](F)C[C]1C=C1F(11375)'],
    products = ['F[C](F)CC1(F)[CH]C1(F)F(11338)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(6.90055,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'F[C](F)C=C1[CH]C1(F)F(11376)'],
    products = ['F[C](F)CC1(F)[CH]C1(F)F(11338)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(288.599,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction16',
    reactants = ['CF2(43)', '[CH2]C1(F)[CH]C1(F)F(11369)'],
    products = ['F[C](F)CC1(F)[CH]C1(F)F(11338)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(0.00976185,'m^3/(mol*s)'), n=2.64543, Ea=(2.91981,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.24524072153041726, var=3.368891203868511, Tref=1000.0, N=3, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s"""),
)
...
reaction(
    label = 'reaction18',
    reactants = ['F[C](F)CC1(F)[CH]C1(F)F(11338)'],
    products = ['F[C](F)[CH]C1(F)CC1(F)F(11378)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C](F)CC1(F)[CH]C1(F)F(11338)'],
    products = ['FC(F)(F)C[C]1[CH]C1(F)F(11379)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(194.963,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction21',
    reactants = ['F[C](F)CC1(F)[C](F)C1F(11380)'],
    products = ['F[C](F)CC1(F)[CH]C1(F)F(11338)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C](F)CC1(F)[CH]C1(F)F(11338)'],
    products = ['F[C]1[CH]C1(F)CC(F)(F)F(11381)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(0.00110172,'s^-1'), n=4.50663, Ea=(229.718,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R4F_Ext-4R!H-R',), comment="""Estimated from node R4F_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

network(
    label = 'PDepNetwork #3419',
    isomers = [
        'F[C](F)CC1(F)[CH]C1(F)F(11338)',
    ],
    reactants = [
