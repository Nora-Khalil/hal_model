...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[O]C1O[C]1F(3588)'],
    products = ['[CH2]OC1O[C]1F(3478)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH2]OC1=C(F)O1(3591)'],
    products = ['[CH2]OC1O[C]1F(3478)'],
    transitionState = 'TS8',
