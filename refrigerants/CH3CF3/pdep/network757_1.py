...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C[CH]C[C](F)F(1207)'],
    products = ['CC([O])C[C](F)F(1801)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(138)', '[CH2]C(C)[O](1830)'],
    products = ['CC([O])C[C](F)F(1801)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'CC(=O)C[C](F)F(1833)'],
    products = ['CC([O])C[C](F)F(1801)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'CC([O])C=C(F)F(1834)'],
    products = ['CC([O])C[C](F)F(1801)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', '[CH2]C(C)[O](1830)'],
    products = ['CC([O])C[C](F)F(1801)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(O)C[C](F)F(1838)'],
    products = ['CC([O])C[C](F)F(1801)'],
