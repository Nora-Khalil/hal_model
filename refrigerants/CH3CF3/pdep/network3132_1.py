...
"""),
    ...
    molecularWeight = (140.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.810697,0.0763752,-9.5954e-05,6.87086e-08,-2.051e-11,-84656.4,25.5816], Tmin=(100,'K'), Tmax=(806.03,'K')), NASAPolynomial(coeffs=[9.36514,0.033921,-1.69443e-05,3.35684e-09,-2.39444e-13,-86035.4,-13.8436], Tmin=(806.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-704.782,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CdCFF)"""),
)

species(
    label = 'CC(F)C(F)=C=C(F)F(10527)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (140.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.766081,0.0773277,-9.89818e-05,7.217e-08,-2.18658e-11,-75105.1,25.5985], Tmin=(100,'K'), Tmax=(795.85,'K')), NASAPolynomial(coeffs=[9.44131,0.033723,-1.67924e-05,3.31798e-09,-2.36158e-13,-76485.9,-14.2731], Tmin=(795.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-625.381,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(Cs-CsHHH) + group(CdCddCF) + group(CdCddFF) + group(Cdd-CdsCds)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0132328,'amu*angstrom^2'), symmetry=1, barrier=(6.96424,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.569702,'amu*angstrom^2'), symmetry=1, barrier=(13.0986,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16478,0.0680798,-8.30948e-05,5.7304e-08,-1.65116e-11,-28516,25.2493], Tmin=(100,'K'), Tmax=(832.268,'K')), NASAPolynomial(coeffs=[8.98128,0.0305124,-1.53866e-05,3.06798e-09,-2.19888e-13,-29817.1,-11.0257], Tmin=(832.268,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-237.902,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCddFF) + group(Cdd-CdsCds) + radical(Csj(Cs-F1sCdH)(H)(H))"""),
)
...
species(
    label = '[CH2]C(F)C(F)=C=C(F)F(10529)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00537763,'amu*angstrom^2'), symmetry=1, barrier=(5.00011,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (139.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.680143,0.0804887,-0.000112505,8.28559e-08,-2.31237e-11,-50225.8,27.6952], Tmin=(100,'K'), Tmax=(641.045,'K')), NASAPolynomial(coeffs=[10.0909,0.0304138,-1.55652e-05,3.08222e-09,-2.18546e-13,-51610,-14.9074], Tmin=(641.045,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-418.537,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(Cs-CsHHH) + group(CdCddCF) + group(CdCddFF) + group(Cdd-CdsCds) + radical(Csj(Cs-F1sCdH)(H)(H))"""),
)

species(
    label = '[CH2]C(F)C(F)C#CF(10530)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-165.129,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,233,378,609,1068,1270,1314,3037,3000,3100,440,815,1455,1000,2175,525,239,401,1367,180,1041.17],'cm^-1')),
        HinderedRotor(inertia=(0.214154,'amu*angstrom^2'), symmetry=1, barrier=(4.92383,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.213381,'amu*angstrom^2'), symmetry=1, barrier=(4.90604,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.32812,'amu*angstrom^2'), symmetry=1, barrier=(53.528,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.7225,0.0789029,-0.00012119,1.04488e-07,-3.60373e-11,-19748.9,25.3814], Tmin=(100,'K'), Tmax=(805.446,'K')), NASAPolynomial(coeffs=[8.53224,0.0310912,-1.53383e-05,2.95978e-09,-2.05484e-13,-20714.2,-8.78875], Tmin=(805.446,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-165.129,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(Ct-CtCs) + group(CtCF) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)
...
"""),
    E0 = (-185.316,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,86,203,488,582,605,741,3000,3100,440,815,1455,1000,562,600,623,1070,1265,1685,370,318.282],'cm^-1')),
        HinderedRotor(inertia=(0.00164625,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00165146,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.072,'amu'),
...
"""),
    ...
    molecularWeight = (140.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09541,0.0707087,-7.43546e-05,4.33057e-08,-1.0768e-11,-51599.3,27.2256], Tmin=(100,'K'), Tmax=(942.643,'K')), NASAPolynomial(coeffs=[9.38478,0.0355337,-1.83817e-05,3.71986e-09,-2.69388e-13,-53162.1,-12.2762], Tmin=(942.643,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-429.843,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCFF) + radical(CsCdCsF1s) + radical(Cdj(Cs-F1sCsH)(Cd-F1sF1s))"""),
)

species(
    label = '[CH2][C](F)C(F)C=C(F)F(10534)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (140.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.284946,0.0913709,-0.000149368,1.35766e-07,-4.87965e-11,-52033,30.8819], Tmin=(100,'K'), Tmax=(805.584,'K')), NASAPolynomial(coeffs=[7.94771,0.0374641,-1.94644e-05,3.82669e-09,-2.67933e-13,-52753,-1.23611], Tmin=(805.584,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-433.661,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCFF) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)
...
species(
    label = '[CH2][CH]C(F)C(F)=C(F)F(10535)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (140.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.426623,0.0875675,-0.00014011,1.26644e-07,-4.55988e-11,-47058.7,31.0937], Tmin=(100,'K'), Tmax=(798.182,'K')), NASAPolynomial(coeffs=[7.70767,0.037148,-1.91775e-05,3.7709e-09,-2.64444e-13,-47777.3,0.388114], Tmin=(798.182,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-392.266,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(Cs-CsHHH) + group(CdCsCdF) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F)) + radical(Cs_S) + radical(RCCJ)"""),
)

species(
    label = 'FCC(F)[CH][C]=C(F)F(10536)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-300.441,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,164,312,561,654,898,1207,1299,3167,528,1116,1182,1331,1402,1494,3075,3110,1685,370,167,640,1190,267.886,268.342],'cm^-1')),
        HinderedRotor(inertia=(0.140472,'amu*angstrom^2'), symmetry=1, barrier=(7.15845,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140222,'amu*angstrom^2'), symmetry=1, barrier=(7.14876,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.663555,'amu*angstrom^2'), symmetry=1, barrier=(33.7941,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.346031,0.0878654,-0.00013242,1.13262e-07,-3.95971e-11,-36010.3,29.4208], Tmin=(100,'K'), Tmax=(742.986,'K')), NASAPolynomial(coeffs=[9.33719,0.0354269,-1.84108e-05,3.65829e-09,-2.5932e-13,-37235,-10.5361], Tmin=(742.986,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-300.441,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cs-F1sCsH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[CH2]C(F)C(F)C(F)=[C]F(10539)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.209933,'amu*angstrom^2'), symmetry=1, barrier=(4.82677,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.209751,'amu*angstrom^2'), symmetry=1, barrier=(4.82259,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.81156,'amu*angstrom^2'), symmetry=1, barrier=(41.6513,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0752349,0.0944542,-0.000149591,1.29208e-07,-4.44719e-11,-40246.8,29.8243], Tmin=(100,'K'), Tmax=(794.515,'K')), NASAPolynomial(coeffs=[10.3103,0.0336211,-1.71756e-05,3.35952e-09,-2.34884e-13,-41579.5,-15.3515], Tmin=(794.515,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-335.741,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(Cs-CsHHH) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Csj(Cs-F1sCsH)(H)(H)) + radical(Cdj(Cd-CsF1s)(F1s))"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'F[CH]C(F)[C]=C(F)F(3353)'],
    products = ['[CH2]C(F)C(F)[C]=C(F)F(10419)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=C(F)F(1205)', '[CH2]C(F)[CH]F(805)'],
    products = ['[CH2]C(F)C(F)[C]=C(F)F(10419)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.04495e+06,'m^3/(mol*s)'), n=0.382229, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_sec_rad;Birad]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)C(F)[C]=C(F)F(10419)'],
    products = ['C=C(F)C(F)C=C(F)F(10526)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)C(F)[C]=C(F)F(10419)'],
    products = ['CC(F)C(F)=C=C(F)F(10527)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=CC(F)[C]=C(F)F(6052)'],
    products = ['[CH2]C(F)C(F)[C]=C(F)F(10419)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C=C(F)C(F)[C]=C(F)F(3151)'],
    products = ['[CH2]C(F)C(F)[C]=C(F)F(10419)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(F)C=C=C(F)F(10528)'],
    products = ['[CH2]C(F)C(F)[C]=C(F)F(10419)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH2]C(F)C(F)=C=C(F)F(10529)'],
    products = ['[CH2]C(F)C(F)[C]=C(F)F(10419)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[CH2]C(F)C(F)C#CF(10530)'],
    products = ['[CH2]C(F)C(F)[C]=C(F)F(10419)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(78)', '[CH2]C=C[C]=C(F)F(6056)'],
    products = ['[CH2]C(F)C(F)[C]=C(F)F(10419)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', '[CH2]C(F)=C[C]=C(F)F(3155)'],
    products = ['[CH2]C(F)C(F)[C]=C(F)F(10419)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', '[CH2]C=C(F)[C]=C(F)F(8590)'],
    products = ['[CH2]C(F)C(F)[C]=C(F)F(10419)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C[C](F)C(F)[C]=C(F)F(10531)'],
    products = ['[CH2]C(F)C(F)[C]=C(F)F(10419)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(F)C(F)[C]=C(F)F(10419)'],
    products = ['[CH2]C(F)[C](F)C=C(F)F(10532)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(F)C(F)[C]=C(F)F(10419)'],
    products = ['CC(F)[C](F)[C]=C(F)F(10533)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(F)C(F)[C]=C(F)F(10419)'],
    products = ['[CH2][C](F)C(F)C=C(F)F(10534)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(F)C(F)[C]=C(F)F(10419)'],
    products = ['[CH2][CH]C(F)C(F)=C(F)F(10535)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(F)C(F)[C]=C(F)F(10419)'],
    products = ['FCC(F)[CH][C]=C(F)F(10536)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(F)C(F)[C]=C(F)F(10419)'],
    products = ['[CH2]C(F)[CH]C(F)=C(F)F(10537)'],
...
reaction(
    label = 'reaction28',
    reactants = ['F[C]=[C]C(F)C(F)CF(10538)'],
    products = ['[CH2]C(F)C(F)[C]=C(F)F(10419)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(F)C(F)C(F)=[C]F(10539)'],
    products = ['[CH2]C(F)C(F)[C]=C(F)F(10419)'],
