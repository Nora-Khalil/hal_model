...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(138)', '[CH2]C[O](300)'],
    products = ['[CH2]CO[C](F)F(1785)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[C](F)F(261)'],
    products = ['[CH2]CO[C](F)F(1785)'],
    transitionState = 'TS3',
