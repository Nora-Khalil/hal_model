...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.224758,0.0900611,-0.000124516,8.84935e-08,-2.52195e-11,-129982,29.12], Tmin=(100,'K'), Tmax=(854.26,'K')), NASAPolynomial(coeffs=[13.5409,0.027714,-1.50486e-05,3.07089e-09,-2.22336e-13,-132258,-33.0261], Tmin=(854.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1081.81,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-(Cds-O2d)OsHH) + group(CsFFOO) + group(COCsFO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.17298,'amu*angstrom^2'), symmetry=1, barrier=(26.9692,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.1734,'amu*angstrom^2'), symmetry=1, barrier=(26.9787,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.458343,'amu*angstrom^2'), symmetry=1, barrier=(10.5382,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.9765,'amu*angstrom^2'), symmetry=1, barrier=(45.4437,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.9759,'amu*angstrom^2'), symmetry=1, barrier=(45.4298,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.458401,'amu*angstrom^2'), symmetry=1, barrier=(10.5395,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.113673,0.0993825,-0.000161129,1.40317e-07,-4.9219e-11,-90405.7,30.9494], Tmin=(100,'K'), Tmax=(735.546,'K')), NASAPolynomial(coeffs=[11.2238,0.0336634,-1.882e-05,3.8224e-09,-2.7346e-13,-91963.6,-19.5179], Tmin=(735.546,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-752.837,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2sCF) + group(CsFFOO) + group(CdCFO) + group(Cds-CdsHH)"""),
)

species(
    label = '[O]C(F)[CH]OC(F)(F)OF(8023)',
...
"""),
    ...
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.542867,0.108527,-0.000173105,1.33709e-07,-3.89556e-11,-88814.5,31.9627], Tmin=(100,'K'), Tmax=(685.993,'K')), NASAPolynomial(coeffs=[16.0559,0.0234169,-1.25374e-05,2.47893e-09,-1.73915e-13,-91366.5,-43.8636], Tmin=(685.993,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-739.739,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCFHO) + group(CsFFOO) + radical(O2sj(Cs-CsF1sH)) + radical(CCsJOCs)"""),
)

species(
    label = 'OC(F)=COC(F)(F)OF(8024)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
4  F u0 p3 c0 {6,S}
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.796544,0.0765194,-0.000102598,7.18858e-08,-2.03514e-11,-77285.7,28.59], Tmin=(100,'K'), Tmax=(857.229,'K')), NASAPolynomial(coeffs=[11.6781,0.0257452,-1.37538e-05,2.79324e-09,-2.01875e-13,-79151.3,-22.2309], Tmin=(857.229,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-643.505,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-(Cds-O2d)OsHH) + group(CsFHOO) + group(COCsFO) + radical(CsF1sO2sO2s)"""),
)

species(
    label = 'O=[C]COC(F)(F)OF(8026)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-673.15,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,435,565,619,662,854,1178,1396,1855,455,950,305.99,306.15,306.152,306.176],'cm^-1')),
        HinderedRotor(inertia=(0.379641,'amu*angstrom^2'), symmetry=1, barrier=(25.2333,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.530387,'amu*angstrom^2'), symmetry=1, barrier=(35.253,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120721,'amu*angstrom^2'), symmetry=1, barrier=(8.02078,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120589,'amu*angstrom^2'), symmetry=1, barrier=(8.02049,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.639011,0.0803121,-0.000111262,7.95087e-08,-2.2817e-11,-80845.8,27.3849], Tmin=(100,'K'), Tmax=(848.133,'K')), NASAPolynomial(coeffs=[12.3394,0.0251284,-1.3662e-05,2.78848e-09,-2.01875e-13,-82830.4,-27.1351], Tmin=(848.133,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-673.15,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-(Cds-O2d)OsHH) + group(CsFFOO) + group(Cds-OdCsH) + radical(CsCJ=O)"""),
)

species(
    label = '[O]C(F)(F)OCC(=O)F(8027)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-949.809,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,375,486,586,623,710,938,1161,1294,486,617,768,1157,1926,185.857,185.896,185.905,1678.6],'cm^-1')),
        HinderedRotor(inertia=(0.00489228,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.670468,'amu*angstrom^2'), symmetry=1, barrier=(16.4264,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02882,'amu*angstrom^2'), symmetry=1, barrier=(25.1614,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00445,0.0685617,-7.78535e-05,4.44965e-08,-1.01953e-11,-114130,27.0367], Tmin=(100,'K'), Tmax=(1052.7,'K')), NASAPolynomial(coeffs=[13.3229,0.0217537,-1.11548e-05,2.25578e-09,-1.63572e-13,-116723,-33.0248], Tmin=(1052.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-949.809,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-O2d)OsHH) + group(CsFFOO) + group(COCsFO) + radical(O2sj(Cs-F1sF1sO2s))"""),
)
...
"""),
    E0 = (-791.377,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,486,617,768,1157,1926,493,600,700,1144,1293,180,180,180,554.894],'cm^-1')),
        HinderedRotor(inertia=(0.13948,'amu*angstrom^2'), symmetry=1, barrier=(3.20691,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140368,'amu*angstrom^2'), symmetry=1, barrier=(3.22734,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141377,'amu*angstrom^2'), symmetry=1, barrier=(3.25054,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23594,0.0666148,-0.000103211,8.93808e-08,-3.13866e-11,-95086.7,25.9279], Tmin=(100,'K'), Tmax=(754.639,'K')), NASAPolynomial(coeffs=[8.13625,0.0257771,-1.35657e-05,2.70103e-09,-1.91383e-13,-96006.7,-4.61545], Tmin=(754.639,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-791.377,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)OsHH) + group(CsFFHO) + group(COCsFO) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.200172,0.0986259,-0.000149502,1.10292e-07,-3.17747e-11,-108263,30.0847], Tmin=(100,'K'), Tmax=(854.459,'K')), NASAPolynomial(coeffs=[16.6473,0.0197532,-1.10347e-05,2.25115e-09,-1.62155e-13,-111142,-48.5441], Tmin=(854.459,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-901.358,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-(Cds-O2d)OsHH) + group(CsFFOO) + group(COCsFO) + radical(CCsJOCs)"""),
)
...
"""),
    E0 = (-950.802,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,486,617,768,1157,1926,482,664,788,1296,1923,180,180,180,998.862],'cm^-1')),
        HinderedRotor(inertia=(0.0832594,'amu*angstrom^2'), symmetry=1, barrier=(1.9143,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17188,'amu*angstrom^2'), symmetry=1, barrier=(26.9437,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0380972,'amu*angstrom^2'), symmetry=1, barrier=(26.9391,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60629,0.0514848,-4.69514e-05,2.09285e-08,-3.74215e-12,-114268,23.9407], Tmin=(100,'K'), Tmax=(1325.03,'K')), NASAPolynomial(coeffs=[12.752,0.0178384,-8.86226e-06,1.76478e-09,-1.26465e-13,-117222,-32.9678], Tmin=(1325.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-950.802,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)OsHH) + group(COCsFO) + group(COFOO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)COC(F)(F)OF(7913)'],
...
reaction(
    ...
    products = ['O=C(F)COC(F)(F)OF(7913)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['FOC(F)(F)OF(662)', 'CH2CO(28)'],
    products = ['O=C(F)COC(F)(F)OF(7913)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C=C(F)OOC(F)(F)OF(8022)'],
    products = ['O=C(F)COC(F)(F)OF(7913)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)[CH]OC(F)(F)OF(8023)'],
    products = ['O=C(F)COC(F)(F)OF(7913)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OC(F)=COC(F)(F)OF(8024)'],
    products = ['O=C(F)COC(F)(F)OF(7913)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=C(F)CO[C](F)OF(8025)'],
    products = ['O=C(F)COC(F)(F)OF(7913)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=[C]COC(F)(F)OF(8026)'],
    products = ['O=C(F)COC(F)(F)OF(7913)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(F)(F)OCC(=O)F(8027)'],
    products = ['O=C(F)COC(F)(F)OF(7913)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)(F)OF(666)', 'CH2CFO(79)'],
    products = ['O=C(F)COC(F)(F)OF(7913)'],
...
reaction(
    label = 'reaction11',
    reactants = ['FO[C](F)F(236)', '[O]CC(=O)F(396)'],
    products = ['O=C(F)COC(F)(F)OF(7913)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(127)', 'O=C(F)CO[C](F)F(8028)'],
    products = ['O=C(F)COC(F)(F)OF(7913)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CFO(51)', '[CH2]OC(F)(F)OF(673)'],
    products = ['O=C(F)COC(F)(F)OF(7913)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C(F)[CH]OC(F)(F)OF(8029)'],
    products = ['O=C(F)COC(F)(F)OF(7913)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F2(78)', 'O=C(F)COC(=O)F(8030)'],
    products = ['O=C(F)COC(F)(F)OF(7913)'],
