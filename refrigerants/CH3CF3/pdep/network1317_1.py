...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C1O[C]1F(4033)'],
    products = ['[O]CC1O[C]1F(3987)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]CC1=C(F)O1(4098)'],
    products = ['[O]CC1O[C]1F(3987)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=CC1O[C]1F(4099)'],
    products = ['[O]CC1O[C]1F(3987)'],
