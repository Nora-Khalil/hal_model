...
reaction(
    label = 'reaction3',
    reactants = ['O=C1[CH][C](F)OO1(4141)'],
    products = ['[O]C(=O)C1O[C]1F(3980)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'O=[C]C1O[C]1F(4142)'],
    products = ['[O]C(=O)C1O[C]1F(3980)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['O=C(O)[C]1O[C]1F(4147)'],
    products = ['[O]C(=O)C1O[C]1F(3980)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]C(=O)C1=C(F)O1(4148)'],
    products = ['[O]C(=O)C1O[C]1F(3980)'],
