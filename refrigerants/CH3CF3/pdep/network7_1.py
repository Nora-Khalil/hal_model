...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C[C](F)F(134)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C[C](F)F(134)'],
    products = ['[CH2]C(F)(F)C([CH2])(F)F(133)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction2',
    reactants = ['F[C](F)CC[C](F)F(135)'],
    products = ['[CH2]C(F)(F)C[C](F)F(134)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(138)', '[CH2]C([CH2])(F)F(145)'],
    products = ['[CH2]C(F)(F)C[C](F)F(134)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'F[C](F)C[C](F)F(146)'],
    products = ['[CH2]C(F)(F)C[C](F)F(134)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2CF2(57)', '[CH2][C](F)F(141)'],
    products = ['[CH2]C(F)(F)C[C](F)F(134)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)C=C(F)F(149)'],
    products = ['[CH2]C(F)(F)C[C](F)F(134)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)C[C](F)F(150)'],
    products = ['[CH2]C(F)(F)C[C](F)F(134)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C](F)F(141)', '[CH2][C](F)F(141)'],
    products = ['[CH2]C(F)(F)C[C](F)F(134)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CF2(43)', '[CH2]C([CH2])(F)F(145)'],
    products = ['[CH2]C(F)(F)C[C](F)F(134)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(F)(F)[CH]C(F)F(152)'],
    products = ['[CH2]C(F)(F)C[C](F)F(134)'],
