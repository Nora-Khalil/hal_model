...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C([O])F(4472)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)C[C](F)F(4412)'],
    products = ['[CH2]C(F)(F)C([O])F(4472)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]C(F)[C](F)F(1072)'],
    products = ['[CH2]C(F)(F)C([O])F(4472)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)C([O])F(5631)'],
    products = ['[CH2]C(F)(F)C([O])F(4472)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][CH]F(2815)', 'CH2CF2(57)'],
    products = ['[CH2]C(F)(F)C([O])F(4472)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(F)(F)C=O(311)'],
    products = ['[CH2]C(F)(F)C([O])F(4472)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CHFO(47)', '[CH2][C](F)F(141)'],
    products = ['[CH2]C(F)(F)C([O])F(4472)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]C(F)(F)C(=O)F(286)'],
    products = ['[CH2]C(F)(F)C([O])F(4472)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O][CH]F(2815)', '[CH2][C](F)F(141)'],
    products = ['[CH2]C(F)(F)C([O])F(4472)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', '[CH2]C(F)=C[O](312)'],
    products = ['[CH2]C(F)(F)C([O])F(4472)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(F)(F)[CH]OF(5636)'],
    products = ['[CH2]C(F)(F)C([O])F(4472)'],
...
network(
    label = 'PDepNetwork #1575',
    isomers = [
        '[CH2]C(F)(F)C([O])F(4472)',
    ],
    reactants = [
        ('CHFO(47)', 'CH2CF2(57)'),
    ],
