...
reaction(
    label = 'reaction3',
    reactants = ['[CH2][C](F)C(=O)OF(738)'],
    products = ['[CH2]C(F)(F)C([O])=O(628)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[O]C(=O)[C](F)F(739)'],
    products = ['[CH2]C(F)(F)C([O])=O(628)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[CH2]C(F)(F)[C]=O(740)'],
    products = ['[CH2]C(F)(F)C([O])=O(628)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)C([O])=O(743)'],
    products = ['[CH2]C(F)(F)C([O])=O(628)'],
