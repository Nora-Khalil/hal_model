...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', '[O]O[CH]F(893)'],
    products = ['[O]OC(F)[C](F)F(965)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]OC(F)=C(F)F(1076)'],
    products = ['[O]OC(F)[C](F)F(965)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['[O]OC(F)[C](F)F(965)'],
    products = ['OH(7)', 'O=C(F)[C](F)F(1077)'],
