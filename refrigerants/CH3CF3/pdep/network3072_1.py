...
"""),
    ...
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0121921,0.0960249,-0.000160808,1.39006e-07,-4.68654e-11,-66859.5,26.7837], Tmin=(100,'K'), Tmax=(819.59,'K')), NASAPolynomial(coeffs=[11.876,0.0269004,-1.37572e-05,2.68456e-09,-1.86573e-13,-68427.2,-25.7923], Tmin=(819.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-557.029,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(F1s)(H)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.59709,0.0495654,-3.9298e-05,1.56962e-08,-2.53902e-12,-97070.3,12.7172], Tmin=(10,'K'), Tmax=(1356.59,'K')), NASAPolynomial(coeffs=[10.6157,0.0288706,-1.64153e-05,4.45099e-09,-4.6668e-13,-98974.6,-23.2838], Tmin=(1356.59,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-807.073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), label="""FCDCC(F)C(F)F""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'FCCC(F)=C(F)F(10250)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.69671,0.0373795,0.000335935,-2.68191e-06,5.82587e-09,-92722.6,11.9646], Tmin=(10,'K'), Tmax=(169.263,'K')), NASAPolynomial(coeffs=[4.99478,0.04263,-2.89718e-05,9.30499e-09,-1.13322e-12,-92818,6.48772], Tmin=(169.263,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-770.942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), label="""FCCC(F)DC(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-409.014,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,182,240,577,636,1210,1413,180,1308.95],'cm^-1')),
        HinderedRotor(inertia=(0.19119,'amu*angstrom^2'), symmetry=1, barrier=(4.39584,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191445,'amu*angstrom^2'), symmetry=1, barrier=(4.4017,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.480266,0.0867416,-0.000145426,1.32479e-07,-4.72964e-11,-66812.4,27.183], Tmin=(100,'K'), Tmax=(811.794,'K')), NASAPolynomial(coeffs=[8.24257,0.0328789,-1.70481e-05,3.35742e-09,-2.3508e-13,-67558.2,-5.47812], Tmin=(811.794,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-556.489,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sF1sH)(F1s)) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)

species(
    label = 'FCC[C](F)[C](F)F(2880)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.150891,'amu*angstrom^2'), symmetry=1, barrier=(3.46928,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151361,'amu*angstrom^2'), symmetry=1, barrier=(3.48008,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.758481,'amu*angstrom^2'), symmetry=1, barrier=(17.439,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.567191,0.0862229,-0.000149221,1.40281e-07,-5.11014e-11,-65702.1,27.033], Tmin=(100,'K'), Tmax=(822.178,'K')), NASAPolynomial(coeffs=[6.81685,0.0351585,-1.83673e-05,3.61643e-09,-2.52702e-13,-66031.5,2.35208], Tmin=(822.178,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-547.22,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sF1sH)(F1s)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = 'F[CH][CH]C(F)C(F)F(892)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.469593,0.0874177,-0.00014876,1.3584e-07,-4.81713e-11,-65688,28.6727], Tmin=(100,'K'), Tmax=(827.42,'K')), NASAPolynomial(coeffs=[8.17181,0.0323309,-1.6532e-05,3.2255e-09,-2.24145e-13,-66351.5,-3.3341], Tmin=(827.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-547.139,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-F1sHH)(H)) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]CC(F)[C](F)F(10228)'],
...
reaction(
    label = 'reaction3',
    reactants = ['F[CH]CC(F)[C](F)F(10228)'],
    products = ['F[CH]CC(F)(F)[CH]F(10226)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(804)', '[CH2]C(F)[C](F)F(1037)'],
    products = ['F[CH]CC(F)[C](F)F(10228)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(138)', 'F[CH]C[CH]F(10247)'],
    products = ['F[CH]CC(F)[C](F)F(10228)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['F[CH]CC(F)[C](F)F(10228)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(9.79432,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)

reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'FC=CC(F)[C](F)F(1121)'],
    products = ['F[CH]CC(F)[C](F)F(10228)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'F[CH]CC=C(F)F(10152)'],
    products = ['F[CH]CC(F)[C](F)F(10228)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(55.5848,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'F[CH]C=C[C](F)F(495)'],
    products = ['F[CH]CC(F)[C](F)F(10228)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(292.707,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', '[CH2]C(F)[C](F)F(1037)'],
    products = ['F[CH]CC(F)[C](F)F(10228)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CF2(43)', 'F[CH]C[CH]F(10247)'],
    products = ['F[CH]CC(F)[C](F)F(10228)'],
...
reaction(
    label = 'reaction18',
    reactants = ['FC[CH]C(F)[C](F)F(10251)'],
    products = ['F[CH]CC(F)[C](F)F(10228)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]CC(F)[C](F)F(10228)'],
    products = ['F[CH]C[C](F)C(F)F(10252)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[CH]CC(F)[C](F)F(10228)'],
    products = ['F[CH][CH]C(F)C(F)F(892)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[CH]CC(F)[C](F)F(10228)'],
    products = ['F[C](F)[CH]CC(F)F(144)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(210.029,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction23',
    reactants = ['F[CH]CC(F)[C](F)F(10228)'],
    products = ['F[CH]C[CH]C(F)(F)F(10253)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(1.00763e+12,'s^-1'), n=0.18834, Ea=(152.718,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C"""),
)

network(
    label = 'PDepNetwork #3072',
    isomers = [
        'F[CH]CC(F)[C](F)F(10228)',
    ],
    reactants = [
        ('CHFCF2(55)', 'CH2CHF(56)'),
    ],
