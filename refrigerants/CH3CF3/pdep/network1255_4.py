...
"""),
    E0 = (-413.689,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([271,519,563,612,1379,161,297,490,584,780,1358,2950,3100,1380,975,1025,1650],'cm^-1')),
        HinderedRotor(inertia=(0.062334,'amu*angstrom^2'), symmetry=1, barrier=(20.5904,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.0431,'amu'),
...
"""),
    E0 = (-395.86,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([131,334,551,600,680,832,1063,1162,1194,2950,3100,1380,975,1025,1650,1685,370],'cm^-1')),
        HinderedRotor(inertia=(0.655752,'amu*angstrom^2'), symmetry=1, barrier=(15.077,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.0431,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.83652,0.0121524,0.000100649,-2.74989e-07,2.13676e-10,-47609.7,11.2034], Tmin=(10,'K'), Tmax=(448.247,'K')), NASAPolynomial(coeffs=[4.48824,0.0271024,-1.88688e-05,6.11645e-09,-7.45807e-13,-47876.7,6.25514], Tmin=(448.247,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-395.86,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), label="""CD[C]C(F)(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-181.789,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,94,120,354,641,825,1294,540,610,2055],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (76.0447,'amu'),
...
"""),
    E0 = (-112.467,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([319,1023,1071,1259,1317,1409,3054,3019,2175,525,239,401,1367,180],'cm^-1')),
        HinderedRotor(inertia=(0.0552161,'amu*angstrom^2'), symmetry=1, barrier=(1.26953,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (76.0447,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.95331,0.00495808,0.000153917,-6.80184e-07,1.01361e-09,-13526.9,9.43805], Tmin=(10,'K'), Tmax=(196.669,'K')), NASAPolynomial(coeffs=[3.29605,0.0226985,-1.47395e-05,4.5747e-09,-5.43678e-13,-13509.5,11.3251], Tmin=(196.669,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-112.467,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), label="""FC#CCF""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'C=[C][C](F)F(7783)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 F u0 p3 c0 {3,S}
...
"""),
    E0 = (-2.81388,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([161,297,490,584,780,1358,2950,3100,1380,975,1025,1650,1685,370],'cm^-1')),
        HinderedRotor(inertia=(0.0224137,'amu*angstrom^2'), symmetry=1, barrier=(17.3508,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0447,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.8463,0.0271994,-2.35083e-05,1.10489e-08,-2.2029e-12,-298.453,15.084], Tmin=(100,'K'), Tmax=(1154.4,'K')), NASAPolynomial(coeffs=[6.59198,0.0142206,-6.64392e-06,1.30977e-09,-9.37537e-14,-1163.25,-3.52452], Tmin=(1154.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-2.81388,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cd-CdH)(F1s)(F1s)) + radical(Cds_S)"""),
)
...
"""),
    E0 = (124.166,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([122,584,932,1043,1247,1392,1461,2986,3039,1685,370,167,640,1190],'cm^-1')),
        HinderedRotor(inertia=(0.134059,'amu*angstrom^2'), symmetry=1, barrier=(3.08227,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0447,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.62281,0.0356539,-6.0427e-05,6.0739e-08,-2.36581e-11,14978.1,16.0967], Tmin=(100,'K'), Tmax=(809.939,'K')), NASAPolynomial(coeffs=[3.44411,0.0201189,-1.03974e-05,2.06103e-09,-1.45157e-13,15221.6,14.6318], Tmin=(809.939,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(124.166,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cds_S) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'F[C]=C(F)CF(7785)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {4,S}
2 F u0 p3 c0 {5,S}
3 F u0 p3 c0 {6,S}
...
"""),
    E0 = (-281.205,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([212,931,1104,1251,1325,1474,3102,3155,246,474,533,1155,167,640,1190,180,1538.58],'cm^-1')),
        HinderedRotor(inertia=(0.113135,'amu*angstrom^2'), symmetry=1, barrier=(2.60119,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.0431,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.80748,0.0184997,0.000109138,-4.91926e-07,6.16619e-10,-33823.2,11.957], Tmin=(10,'K'), Tmax=(279.833,'K')), NASAPolynomial(coeffs=[4.25041,0.0272794,-1.89255e-05,6.14365e-09,-7.52596e-13,-33907.2,9.32702], Tmin=(279.833,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-281.205,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), label="""F[C]DC(F)CF""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'C=C(F)[C]F(7813)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 F u0 p3 c0 {5,S}
...
"""),
    E0 = (-1.78467,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([323,467,575,827,1418,2950,3100,1380,975,1025,1650,180,180,1311.56],'cm^-1')),
        HinderedRotor(inertia=(0.203119,'amu*angstrom^2'), symmetry=1, barrier=(4.67011,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0447,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.71479,0.0322818,-3.71432e-05,1.99463e-08,-1.02768e-12,-172.222,13.3042], Tmin=(100,'K'), Tmax=(554.058,'K')), NASAPolynomial(coeffs=[5.56004,0.0167221,-8.50498e-06,1.71503e-09,-1.23591e-13,-563.971,0.56754], Tmin=(554.058,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1.78467,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
"""),
    E0 = (-33.0749,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([405,756,886,1212,2950,3100,1380,975,1025,1650,315,622,1128,180],'cm^-1')),
        HinderedRotor(inertia=(1.8287,'amu*angstrom^2'), symmetry=1, barrier=(42.0454,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (76.0447,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.9216,0.00464309,8.56542e-05,-1.7375e-07,1.04322e-10,-3975.9,9.49423], Tmin=(10,'K'), Tmax=(561.26,'K')), NASAPolynomial(coeffs=[3.40711,0.0259693,-1.85375e-05,6.06956e-09,-7.44307e-13,-4196.29,9.20128], Tmin=(561.26,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-33.0749,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), label="""CDC(F)[C]F""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = '[CH]=C(F)C(F)F(1422)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {4,S}
2 F u0 p3 c0 {4,S}
3 F u0 p3 c0 {5,S}
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', 'F[C]C=C(F)F(5917)'],
    products = ['F[CH]C=C(F)F(1320)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[CH]C=C(F)F(1320)'],
    products = ['FC1[CH]C1(F)F(5918)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[CH][C]=C(F)F(2842)'],
    products = ['F[CH]C=C(F)F(1320)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['HF(38)', 'FC#C[CH]F(1591)'],
    products = ['F[CH]C=C(F)F(1320)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.64483e+40,'m^3/(mol*s)'), n=-10.004, Ea=(279.186,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[C]C=C(F)F-2(1319)'],
    products = ['F[CH]C=C(F)F(1320)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C]=CC(F)F(1321)'],
    products = ['F[CH]C=C(F)F(1320)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(187.01,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction13',
    reactants = ['F[C]F(138)', 'CHFCH[Z](71)'],
    products = ['F[CH]C=C(F)F(1320)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'C#C[C](F)F(2238)'],
    products = ['F[CH]C=C(F)F(1320)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(1.64483e+40,'m^3/(mol*s)'), n=-10.004, Ea=(309.693,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd"""),
)

reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'F[C]C=CF-2(3685)'],
    products = ['F[CH]C=C(F)F(1320)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=CC(F)(F)F(5919)'],
    products = ['F[CH]C=C(F)F(1320)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(0.0279241,'s^-1'), n=4.16824, Ea=(216.236,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction19',
    reactants = ['CH2F(46)', '[C]=C(F)F(1205)'],
    products = ['FC[C]=C(F)F(2955)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F(37)', 'C=C=C(F)F(3650)'],
    products = ['FC[C]=C(F)F(2955)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(58.3329,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(11.0863,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_3R!H->F_Ext-2C-R_4R!H->C_Ext-4C-R_N-5R!H->Cl_N-5BrCFINOPSSi->Br_5CF->C',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_3R!H->F_Ext-2C-R_4R!H->C_Ext-4C-R_N-5R!H->Cl_N-5BrCFINOPSSi->Br_5CF->C"""),
)

reaction(
    label = 'reaction26',
    reactants = ['FC[C]=C(F)F(2955)'],
    products = ['C=C(F)[C](F)F(2239)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(3.36622e+11,'s^-1'), n=0.48217, Ea=(107.51,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-2R!H-R',), comment="""Estimated from node R2F_Ext-2R!H-R"""),
)

reaction(
    label = 'reaction27',
    reactants = ['F[C]=C(F)CF(7785)'],
    products = ['FC[C]=C(F)F(2955)'],
    transitionState = 'TS27',
    kinetics = Arrhenius(A=(1.00763e+12,'s^-1'), n=0.18834, Ea=(167.317,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C"""),
)

reaction(
    label = 'reaction28',
    reactants = ['F(37)', 'C=C(F)[C]F(7813)'],
    products = ['C=C(F)[C](F)F(2239)'],
...
reaction(
    label = 'reaction30',
    reactants = ['C=C(F)[C](F)F(2239)'],
    products = ['F[C]1CC1(F)F(7814)'],
    transitionState = 'TS30',
    kinetics = Arrhenius(A=(2.61353e+11,'s^-1'), n=0.395207, Ea=(195.485,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R3_D;doublebond_intra;radadd_intra_cs]
Euclidian distance = 0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(33.3483,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.56721e+32,'m^3/(mol*s)'), n=-7.40875, Ea=(300.96,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_3COCdCddCtO2d->Ct',), comment="""Estimated from node HF_3COCdCddCtO2d->Ct"""),
)

reaction(
    label = 'reaction35',
    reactants = ['F(37)', 'C=C(F)[C]F-2(7815)'],
    products = ['C=C(F)[C](F)F(2239)'],
...
reaction(
    label = 'reaction38',
    reactants = ['C=[C]C(F)(F)F(7816)'],
    products = ['C=C(F)[C](F)F(2239)'],
    transitionState = 'TS37',
    kinetics = Arrhenius(A=(2.37801e+16,'s^-1'), n=-0.733083, Ea=(182.383,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0717849990446407, var=47.27832310158784, Tref=1000.0, N=3, data_mean=0.0, correlation='R2F_Ext-1R!H-R_N-4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_N-4R!H->C
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction39',
    reactants = ['CH2(T)(18)', 'F[C]=C(F)F(984)'],
    products = ['C=C(F)[C](F)F(2239)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(166.73,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction41',
    reactants = ['CF3(45)', '[C]=C(976)'],
    products = ['C=[C]C(F)(F)F(7816)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(36.9523,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction43',
    reactants = ['H(5)', 'CF3CCH(84)'],
    products = ['C=[C]C(F)(F)F(7816)'],
    transitionState = 'TS43',
    kinetics = Arrhenius(A=(1.97234e+09,'cm^3/(mol*s)'), n=1.64652, Ea=(8.61616,'kJ/mol'), T0=(1,'K'), Tmin=(298,'K'), Tmax=(2500,'K'), comment="""Fitted to 50 data points; dA = *|/ 1.05452, dn = +|- 0.00697497, dEa = +|- 0.0379575 kJ/molMatched reaction 2970 H + C3HF3 <=> C3H2F3 in R_Addition_MultipleBond/training
This reaction matched rate rule [Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_N-2CS-inRing_N-1COS->O_N-Sp-2CS=1CCSS_Ext-2CS-R_4R!H->C_Ext-4C-R_N-5R!H-inRing_N-Sp-5R!H=4C_Ext-4C-R]
...
reaction(
    label = 'reaction45',
    reactants = ['H(5)', '[CH]=[C]C(F)(F)F(2841)'],
    products = ['C=[C]C(F)(F)F(7816)'],
