...
"""),
    E0 = (-204.093,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([551,1088,1226,1380,1420,1481,3057,3119,3025,407.5,1350,352.5,1855,455,950,318.263,318.471,318.553],'cm^-1')),
        HinderedRotor(inertia=(0.22743,'amu*angstrom^2'), symmetry=1, barrier=(16.3777,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.227424,'amu*angstrom^2'), symmetry=1, barrier=(16.3738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.227001,'amu*angstrom^2'), symmetry=1, barrier=(16.3756,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44163,0.0542,-6.54554e-05,3.84076e-08,-8.7045e-12,-24452.8,20.833], Tmin=(100,'K'), Tmax=(1088.41,'K')), NASAPolynomial(coeffs=[13.5858,0.00956968,-3.94875e-06,7.34474e-10,-5.13755e-14,-27096.4,-38.7846], Tmin=(1088.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-204.093,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-OdOsH) + radical(CCsJOC(O)H) + radical((O)CJOCC)"""),
)

species(
    label = 'O=CO[CH][CH]F(10197)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 O u0 p2 c0 {4,S} {6,S}
3 O u0 p2 c0 {6,D}
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(192)', '[O]C[CH]F(856)'],
    products = ['O=[C]OC[CH]F(10135)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', '[CH2]O[C]=O(721)'],
    products = ['O=[C]OC[CH]F(10135)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[O]C[CH]F(856)'],
    products = ['O=[C]OC[CH]F(10135)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(34.1,'m^3/(mol*s)'), n=8.73864e-09, Ea=(10.8831,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->O',), comment="""Estimated from node Root_3R->O"""),
)
...
reaction(
    ...
    products = ['O=[C]OC[CH]F(10135)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(105.981,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', '[CH2]O[C]=O(721)'],
    products = ['O=[C]OC[CH]F(10135)'],
