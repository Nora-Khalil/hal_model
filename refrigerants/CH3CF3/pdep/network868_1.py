...
reaction(
    label = 'reaction2',
    reactants = ['O=C=C(O)OOF(2199)'],
    products = ['O=C(O)C(=O)OF(2168)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(=O)C(=O)O(2204)'],
    products = ['O=C(O)C(=O)OF(2168)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(7)', 'O=[C]C(=O)OF(2205)'],
    products = ['O=C(O)C(=O)OF(2168)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(=O)C(=O)OF(2206)'],
    products = ['O=C(O)C(=O)OF(2168)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(127)', 'O=[C]C(=O)O(2207)'],
    products = ['O=C(O)C(=O)OF(2168)'],
