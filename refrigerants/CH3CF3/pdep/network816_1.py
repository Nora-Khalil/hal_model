...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O=CO[C](F)OF(1982)'],
    products = ['O=COC(F)(F)OF(1976)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[O]C(F)(F)OC=O(1983)'],
    products = ['O=COC(F)(F)OF(1976)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['FO[C](F)F(236)', '[O]C=O(322)'],
    products = ['O=COC(F)(F)OF(1976)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)(F)OF(666)', 'HCO(15)'],
    products = ['O=COC(F)(F)OF(1976)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(127)', 'O=CO[C](F)F(392)'],
    products = ['O=COC(F)(F)OF(1976)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OC(F)(F)OF(1984)'],
    products = ['O=COC(F)(F)OF(1976)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F2(78)', 'O=COC(=O)F(1985)'],
    products = ['O=COC(F)(F)OF(1976)'],
