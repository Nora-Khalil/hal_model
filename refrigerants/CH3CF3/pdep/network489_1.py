...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[O]C(O)[C](F)F(1506)'],
    products = ['[O]OC(O)[C](F)F(1391)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(138)', '[O]O[CH]O(321)'],
    products = ['[O]OC(O)[C](F)F(1391)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]OC(O)=C(F)F(1510)'],
    products = ['[O]OC(O)[C](F)F(1391)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]OC(O)[C](F)F(1391)'],
    products = ['OH(7)', 'O=C(O)[C](F)F(1512)'],
