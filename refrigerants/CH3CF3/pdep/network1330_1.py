...
species(
    label = '[CH2]C(F)(F)C1=C(F)O1(4068)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(3999)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(3999)'],
    products = ['[CH2]C1(F)O[C](F)C1F(4064)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'F[C](F)C1O[C]1F(4065)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(3999)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(3999)'],
    products = ['CC(F)(F)C1=C(F)O1(4066)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)(F)[CH]C(=O)F(4067)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(3999)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)(F)C1=C(F)O1(4068)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(3999)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(F)C1O[C]1F(4069)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(3999)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'C=C(F)[C]1O[C]1F(4070)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(3999)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(3999)'],
    products = ['CC(F)(F)[C]1O[C]1F(4071)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(3999)'],
    products = ['[CH2][C](F)C1OC1(F)F(4072)'],
...
reaction(
    label = 'reaction18',
    reactants = ['FC[C](F)C1O[C]1F(4073)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(3999)'],
