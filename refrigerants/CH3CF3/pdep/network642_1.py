...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C([O])=C=O(1699)'],
    products = ['[O]C(=O)C([O])=O(1617)'],
    transitionState = 'TS2',
