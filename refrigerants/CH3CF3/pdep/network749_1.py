...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(276)', '[C]=C(976)'],
    products = ['C=[C]OC([O])(F)F(1775)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'C=[C]O[C](F)F(1702)'],
    products = ['C=[C]OC([O])(F)F(1775)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[O][C](F)F(263)', 'CH2CO(28)'],
    products = ['C=[C]OC([O])(F)F(1775)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=[C]OC(=O)F(2020)'],
    products = ['C=[C]OC([O])(F)F(1775)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#COC([O])(F)F(2021)'],
    products = ['C=[C]OC([O])(F)F(1775)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O][C](F)F(263)', '[CH2][C]=O(981)'],
    products = ['C=[C]OC([O])(F)F(1775)'],
    transitionState = 'TS9',
