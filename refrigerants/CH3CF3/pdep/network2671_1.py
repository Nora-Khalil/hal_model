...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]C=C(F)F(12353)'],
    products = ['[CH]=CC(F)F(10633)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=CC(F)F(10633)'],
    products = ['C=[C]C(F)F(13253)'],
