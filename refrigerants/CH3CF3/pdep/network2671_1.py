...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(976)', 'C=[C]O[O](2005)'],
    products = ['C=[C]OO[C]=C(9139)'],
    transitionState = 'TS2',
