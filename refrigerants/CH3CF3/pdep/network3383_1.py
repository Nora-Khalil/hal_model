...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'O=[C]O(457)'],
    products = ['[O]C(=O)O(1583)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(=O)O(1583)'],
    products = ['O[C]1OO1(9299)'],
    transitionState = 'TS2',
