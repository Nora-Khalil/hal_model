...
"""),
    E0 = (-294.148,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,334,575,1197,1424,3202,180,180,486.573,487.193],'cm^-1')),
        HinderedRotor(inertia=(0.134767,'amu*angstrom^2'), symmetry=1, barrier=(12.93,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0769411,'amu*angstrom^2'), symmetry=1, barrier=(12.9181,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.562104,'amu*angstrom^2'), symmetry=1, barrier=(12.9239,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.43787,'amu*angstrom^2'), symmetry=1, barrier=(33.0595,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.624999,0.0776791,-9.50339e-05,6.14447e-08,-1.59686e-11,-35259.2,24.388], Tmin=(100,'K'), Tmax=(934.858,'K')), NASAPolynomial(coeffs=[12.6949,0.026035,-1.21695e-05,2.35209e-09,-1.65974e-13,-37516,-33.0293], Tmin=(934.858,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-294.148,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CCsJOCs) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
"""),
    E0 = (-156.577,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.863385,'amu*angstrom^2'), symmetry=1, barrier=(19.8509,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.863114,'amu*angstrom^2'), symmetry=1, barrier=(19.8447,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.864564,'amu*angstrom^2'), symmetry=1, barrier=(19.878,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0882,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.857267,0.0596171,-4.47996e-05,6.28664e-09,4.2949e-12,-18710.2,20.8985], Tmin=(100,'K'), Tmax=(971.524,'K')), NASAPolynomial(coeffs=[17.5906,0.0119312,-3.92079e-06,7.06157e-10,-5.14718e-14,-22962.4,-64.498], Tmin=(971.524,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-156.577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CCsJOC(O))"""),
)
...
"""),
    E0 = (-343.656,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,326,540,652,719,1357,194,682,905,1196,1383,3221,308.881,309.827,309.864],'cm^-1')),
        HinderedRotor(inertia=(0.214222,'amu*angstrom^2'), symmetry=1, barrier=(14.6495,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214401,'amu*angstrom^2'), symmetry=1, barrier=(14.6274,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214079,'amu*angstrom^2'), symmetry=1, barrier=(14.631,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.666171,0.0724213,-8.33365e-05,4.79629e-08,-1.08454e-11,-41211.3,22.3081], Tmin=(100,'K'), Tmax=(1080.86,'K')), NASAPolynomial(coeffs=[15.3186,0.0181957,-8.08224e-06,1.54614e-09,-1.0923e-13,-44378.7,-49.5204], Tmin=(1080.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-343.656,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CCsJOC(O))"""),
)

species(
    label = 'C=COC(F)[CH]F(11301)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-386.738,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,2950,3100,1380,975,1025,1650,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.24683,'amu*angstrom^2'), symmetry=1, barrier=(28.667,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.24618,'amu*angstrom^2'), symmetry=1, barrier=(28.652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.24562,'amu*angstrom^2'), symmetry=1, barrier=(28.6392,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.48786,0.0640285,-4.05498e-05,-7.65525e-09,1.12979e-11,-46375.4,23.1196], Tmin=(100,'K'), Tmax=(952.08,'K')), NASAPolynomial(coeffs=[21.5309,0.007495,-1.70054e-06,3.06137e-10,-2.62404e-14,-51827,-84.9543], Tmin=(952.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-386.738,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
"""),
    E0 = (-263.015,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,334,575,1197,1424,3202,272.068,272.243,272.258,272.35],'cm^-1')),
        HinderedRotor(inertia=(0.00227655,'amu*angstrom^2'), symmetry=1, barrier=(0.11963,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120383,'amu*angstrom^2'), symmetry=1, barrier=(6.33211,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.345959,'amu*angstrom^2'), symmetry=1, barrier=(18.2215,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.785093,'amu*angstrom^2'), symmetry=1, barrier=(41.28,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.798652,0.0755044,-9.4163e-05,6.47347e-08,-1.82338e-11,-31522.6,24.9566], Tmin=(100,'K'), Tmax=(858.194,'K')), NASAPolynomial(coeffs=[10.5804,0.0299123,-1.44746e-05,2.83077e-09,-2.00611e-13,-33201.5,-20.7388], Tmin=(858.194,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-263.015,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CJCO) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = 'CCO[C](F)[CH]F(11303)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {4,S} {6,S}
...
"""),
    E0 = (-279.723,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,334,575,1197,1424,3202,260.304,260.304,260.304,260.304],'cm^-1')),
        HinderedRotor(inertia=(0.139779,'amu*angstrom^2'), symmetry=1, barrier=(6.72094,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13978,'amu*angstrom^2'), symmetry=1, barrier=(6.72094,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139779,'amu*angstrom^2'), symmetry=1, barrier=(6.72094,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.453814,'amu*angstrom^2'), symmetry=1, barrier=(21.8206,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.475875,0.0846224,-0.000131145,1.11999e-07,-3.78546e-11,-33522.8,25.4408], Tmin=(100,'K'), Tmax=(828.544,'K')), NASAPolynomial(coeffs=[9.32578,0.031158,-1.49107e-05,2.83028e-09,-1.94208e-13,-34620.7,-13.3659], Tmin=(828.544,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-279.723,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = '[CH2][CH]OC(F)CF(11304)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {4,S} {6,S}
...
"""),
    E0 = (-281.2,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,269.486,269.578,269.687,269.742],'cm^-1')),
        HinderedRotor(inertia=(0.445071,'amu*angstrom^2'), symmetry=1, barrier=(22.9419,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00231548,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.444159,'amu*angstrom^2'), symmetry=1, barrier=(22.9488,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.444709,'amu*angstrom^2'), symmetry=1, barrier=(22.9452,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.647742,0.0754447,-8.6216e-05,5.10225e-08,-1.20851e-11,-33701.2,24.5844], Tmin=(100,'K'), Tmax=(1023.68,'K')), NASAPolynomial(coeffs=[13.7501,0.0242472,-1.11958e-05,2.16566e-09,-1.53379e-13,-36383.7,-38.9336], Tmin=(1023.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-281.2,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CJCO)"""),
)

species(
    label = 'CC(F)O[CH][CH]F(11305)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {4,S} {6,S}
...
"""),
    ...
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.62553,0.0819059,-0.000111177,7.68673e-08,-1.85532e-11,-37563.5,24.712], Tmin=(100,'K'), Tmax=(630.446,'K')), NASAPolynomial(coeffs=[10.452,0.0305491,-1.51329e-05,2.95461e-09,-2.07762e-13,-39020.9,-19.8941], Tmin=(630.446,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-313.272,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsCsFHH) + radical(Csj(Cs-F1sHH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]OC(F)[CH]F(11297)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)[CH]F(834)', '[CH]C-2(978)'],
    products = ['C[CH]OC(F)[CH]F(11297)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', 'C[CH]O[CH]F(6484)'],
    products = ['C[CH]OC(F)[CH]F(11297)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['C[CH]OC(F)[CH]F(11297)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.81516e-05,'m^3/(mol*s)'), n=3.04336, Ea=(43.4265,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C[CH]OC=CF(10843)'],
    products = ['C[CH]OC(F)[CH]F(11297)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C[CH]OC(F)=CF(6496)'],
    products = ['C[CH]OC(F)[CH]F(11297)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C=COC(F)[CH]F(11301)'],
    products = ['C[CH]OC(F)[CH]F(11297)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', 'C[CH]O[CH]F(6484)'],
    products = ['C[CH]OC(F)[CH]F(11297)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]COC(F)[CH]F(11302)'],
    products = ['C[CH]OC(F)[CH]F(11297)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][CH]OC(F)CF(11304)'],
    products = ['C[CH]OC(F)[CH]F(11297)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C[CH]OC(F)[CH]F(11297)'],
    products = ['CC(F)O[CH][CH]F(11305)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(218.476,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction19',
    reactants = ['C[CH]OC(F)[CH]F(11297)'],
    products = ['C[CH]O[CH]C(F)F(1873)'],
...
network(
    label = 'PDepNetwork #3392',
    isomers = [
        'C[CH]OC(F)[CH]F(11297)',
    ],
    reactants = [
