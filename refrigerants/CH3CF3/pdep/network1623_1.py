...
reaction(
    label = 'reaction3',
    reactants = ['F[C]1CC=[C]O1(12026)'],
    products = ['C#COC(=C)F(5742)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(S)(25)', 'C#C[O+]=[C-]F(12034)'],
    products = ['C#COC(=C)F(5742)'],
