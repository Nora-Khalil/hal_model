...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F(6106)', '[CH]C-2(978)'],
    products = ['[CH]=C(F)O[CH]C(9088)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', '[CH]=C(F)OC=C(9102)'],
    products = ['[CH]=C(F)O[CH]C(9088)'],
    transitionState = 'TS6',
