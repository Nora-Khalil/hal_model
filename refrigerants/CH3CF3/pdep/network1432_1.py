...
"""),
    E0 = (-49.0472,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3010,987.5,1337.5,450,1655,422.882,422.929,422.947,2131.8],'cm^-1')),
        HinderedRotor(inertia=(0.075397,'amu*angstrom^2'), symmetry=1, barrier=(9.56917,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0753774,'amu*angstrom^2'), symmetry=1, barrier=(9.569,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31262,0.0624622,-8.96185e-05,6.93854e-08,-2.14131e-11,-5805.41,25.314], Tmin=(100,'K'), Tmax=(806.456,'K')), NASAPolynomial(coeffs=[9.81272,0.0196696,-8.84867e-06,1.64379e-09,-1.11936e-13,-7155.84,-13.7381], Tmin=(806.456,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.0472,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(O2sCF) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(CCOJ) + radical(C=C(C)OJ)"""),
)
...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55184,0.0579819,-7.25611e-05,4.90467e-08,-1.35402e-11,-81207.5,20.5461], Tmin=(100,'K'), Tmax=(875.19,'K')), NASAPolynomial(coeffs=[9.40396,0.0220946,-1.10539e-05,2.19461e-09,-1.56922e-13,-82581.9,-16.2892], Tmin=(875.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-675.9,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsH) + group(Cds-OdCsH)"""),
)

species(
    label = '[O]CC1(F)[CH]OO1(4813)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {3,S} {5,S}
...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81163,0.0544813,-8.14795e-05,7.72949e-08,-2.98053e-11,-4707.28,21.8521], Tmin=(100,'K'), Tmax=(783.76,'K')), NASAPolynomial(coeffs=[3.99242,0.0318934,-1.63206e-05,3.2179e-09,-2.26808e-13,-4697.2,14.1074], Tmin=(783.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-39.7423,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(CsCCFO) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Cs-Cs(F)-O2s-O2s) + radical(CCOJ) + radical(CCsJOO)"""),
)

species(
    label = '[O]C1(F)[CH]OOC1(4622)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03635,0.0521513,-4.98973e-05,2.48814e-08,-4.67759e-12,-14356.5,21.0868], Tmin=(100,'K'), Tmax=(1536.36,'K')), NASAPolynomial(coeffs=[12.7791,0.0122441,-1.82119e-06,6.53737e-11,4.00974e-15,-16863.1,-37.0223], Tmin=(1536.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-120.347,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(CsCCFO) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(12dioxolane) + radical(O2sj(Cs-F1sCsCs)) + radical(CCsJOOC)"""),
)

species(
    label = '[O]CC1(F)OC1[O](4814)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {5,S} {6,S}
3  O u1 p2 c0 {6,S}
...
"""),
    E0 = (-187.419,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,375,552.5,462.5,1710,2782.5,750,1395,475,1775,1000,317.601,2929.48],'cm^-1')),
        HinderedRotor(inertia=(0.156482,'amu*angstrom^2'), symmetry=1, barrier=(11.3267,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.427751,'amu*angstrom^2'), symmetry=1, barrier=(31.4982,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.25621,0.0416513,-4.45782e-05,2.75717e-08,-7.28111e-12,-22481.3,19.5119], Tmin=(100,'K'), Tmax=(894.93,'K')), NASAPolynomial(coeffs=[6.83355,0.0211919,-1.02851e-05,2.02489e-09,-1.44413e-13,-23300.5,-2.06284], Tmin=(894.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-187.419,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)H) + radical(C=OCOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.657797,'amu*angstrom^2'), symmetry=1, barrier=(15.124,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.658274,'amu*angstrom^2'), symmetry=1, barrier=(15.135,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.793186,0.0784417,-0.000136841,1.20524e-07,-4.06153e-11,-41045.4,24.8184], Tmin=(100,'K'), Tmax=(860.323,'K')), NASAPolynomial(coeffs=[9.70905,0.0215776,-1.08273e-05,2.05519e-09,-1.3934e-13,-42009.2,-13.5396], Tmin=(860.323,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-342.168,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CCsJOH)"""),
)

species(
    label = '[O][CH]C(O)(F)C=O(4820)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {5,S} {10,S}
3  O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.929392,0.0784623,-0.000144891,1.3711e-07,-4.91296e-11,-43221.5,24.4086], Tmin=(100,'K'), Tmax=(851.477,'K')), NASAPolynomial(coeffs=[6.62571,0.0281859,-1.48938e-05,2.89205e-09,-1.98839e-13,-43339,2.84897], Tmin=(851.477,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-360.196,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = '[O]CC(O)(F)[C]=O(4821)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {5,S} {10,S}
3  O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09898,0.0729961,-0.000129749,1.20281e-07,-4.26002e-11,-45671.9,25.0699], Tmin=(100,'K'), Tmax=(849.261,'K')), NASAPolynomial(coeffs=[6.97466,0.0262564,-1.35213e-05,2.60888e-09,-1.79112e-13,-45982.4,1.73101], Tmin=(849.261,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-380.533,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCOJ) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C(F)([C]=O)CO(4822)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {6,S} {10,S}
3  O u1 p2 c0 {5,S}
...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.961875,0.0729869,-0.000121742,1.03756e-07,-3.4114e-11,-43495.8,25.4829], Tmin=(100,'K'), Tmax=(859.504,'K')), NASAPolynomial(coeffs=[10.0609,0.0196429,-9.4517e-06,1.77129e-09,-1.19552e-13,-44653.6,-14.6735], Tmin=(859.504,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-362.505,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C=C(C[O])OF(4823)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
...
"""),
    E0 = (-45.3894,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3010,987.5,1337.5,450,1655,344.993,345.105,345.142,345.16],'cm^-1')),
        HinderedRotor(inertia=(0.00141546,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00141374,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55026,0.0570663,-6.9661e-05,4.57933e-08,-1.2221e-11,-5373.59,24.3789], Tmin=(100,'K'), Tmax=(907.247,'K')), NASAPolynomial(coeffs=[9.73597,0.0209753,-9.98843e-06,1.94356e-09,-1.37542e-13,-6858.85,-14.3155], Tmin=(907.247,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-45.3894,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(CCOJ) + radical(C=COJ)"""),
)

species(
    label = '[O]C=C([O])COF(4824)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
...
"""),
    E0 = (-156.588,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3010,987.5,1337.5,450,1655,346.414,346.497,346.512,346.552],'cm^-1')),
        HinderedRotor(inertia=(0.19331,'amu*angstrom^2'), symmetry=1, barrier=(16.4681,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193182,'amu*angstrom^2'), symmetry=1, barrier=(16.4681,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.598106,0.063753,-7.2356e-05,3.86561e-08,-7.73381e-12,-18701.2,26.13], Tmin=(100,'K'), Tmax=(1360.76,'K')), NASAPolynomial(coeffs=[18.5285,0.00471843,-3.05693e-07,-6.02544e-11,7.01555e-15,-22995.2,-63.7445], Tmin=(1360.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-156.588,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=C(C)OJ) + radical(C=COJ)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[O]C=C(F)C[O](4115)'],
    products = ['[O]CC([O])(F)C=O(4307)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[CH2]C([O])(F)C=O(4414)'],
    products = ['[O]CC([O])(F)C=O(4307)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]CC(=O)C=O(4815)'],
    products = ['[O]CC([O])(F)C=O(4307)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[O]C(F)(C=O)C=O(4816)'],
    products = ['[O]CC([O])(F)C=O(4307)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', '[O]C=C([O])C=O(4817)'],
    products = ['[O]CC([O])(F)C=O(4307)'],
