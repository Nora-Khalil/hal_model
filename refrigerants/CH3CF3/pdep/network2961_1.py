...
"""),
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.58581,0.0209521,2.70072e-05,-4.30315e-08,1.53576e-11,-11142.5,16.7495], Tmin=(100,'K'), Tmax=(1082.68,'K')), NASAPolynomial(coeffs=[9.18559,0.0223584,-1.0671e-05,2.16979e-09,-1.59917e-13,-14083.1,-22.5954], Tmin=(1082.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-93.1387,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.24367,0.0334187,-1.32664e-05,-1.87722e-09,1.89782e-12,-12162.2,17.1242], Tmin=(100,'K'), Tmax=(1185.58,'K')), NASAPolynomial(coeffs=[8.37002,0.0212601,-8.65132e-06,1.58276e-09,-1.08605e-13,-14213,-15.9974], Tmin=(1185.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-101.683,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02045,0.0379613,-2.55997e-05,9.29987e-09,-1.39601e-12,12149.6,19.3286], Tmin=(100,'K'), Tmax=(1546.97,'K')), NASAPolynomial(coeffs=[9.61092,0.018335,-6.56952e-06,1.09894e-09,-7.07099e-14,9801.15,-20.6028], Tmin=(1546.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(100.387,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCHO) + radical(CCCJ=O)"""),
)

species(
    label = '[CH2][CH]CC=O(9997)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {4,D}
2  C u0 p0 c0 {3,S} {4,S} {6,S} {7,S}
...
"""),
    E0 = (178.045,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,2782.5,750,1395,475,1775,1000,3000,3100,440,815,1455,1000,2109.6],'cm^-1')),
        HinderedRotor(inertia=(0.00191998,'amu*angstrom^2'), symmetry=1, barrier=(6.06313,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.254742,'amu*angstrom^2'), symmetry=1, barrier=(28.3766,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0544385,'amu*angstrom^2'), symmetry=1, barrier=(6.0641,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.45448,0.0334513,-1.78476e-05,4.44217e-09,-4.38457e-13,21469.5,21.4697], Tmin=(100,'K'), Tmax=(2242.17,'K')), NASAPolynomial(coeffs=[11.6168,0.0171053,-6.91196e-06,1.19058e-09,-7.58981e-14,17360.9,-30.1313], Tmin=(2242.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(178.045,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCC=O) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(192)', '[CH2]C[CH2](1185)'],
    products = ['[CH2]CC[C]=O(9955)'],
    transitionState = 'TS4',
