...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C[CH]F(10142)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', '[CH2]C([O])(F)F(162)'],
    products = ['[O]C(F)(F)C[CH]F(10142)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[CH]C[C](F)F(803)'],
    products = ['[O]C(F)(F)C[CH]F(10142)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)(F)C=CF(842)'],
    products = ['[O]C(F)(F)C[CH]F(10142)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C(F)C[CH]F(2889)'],
    products = ['[O]C(F)(F)C[CH]F(10142)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'O=C(F)[CH][CH]F(845)'],
    products = ['[O]C(F)(F)C[CH]F(10142)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', '[CH2]C([O])(F)F(162)'],
    products = ['[O]C(F)(F)C[CH]F(10142)'],
...
network(
    label = 'PDepNetwork #3040',
    isomers = [
        '[O]C(F)(F)C[CH]F(10142)',
    ],
    reactants = [
        ('CF2O(49)', 'CH2CHF(56)'),
    ],
