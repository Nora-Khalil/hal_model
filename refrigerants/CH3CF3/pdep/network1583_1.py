...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(F)(F)[CH]F(841)'],
    products = ['[O]C(F)C([O])(F)F(4733)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[O]C(F)[C](F)F(1072)'],
    products = ['[O]C(F)C([O])(F)F(4733)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(F)C(=O)F(4320)'],
    products = ['[O]C(F)C([O])(F)F(4733)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O][C](F)F(263)', '[O][CH]F(2815)'],
    products = ['[O]C(F)C([O])(F)F(4733)'],
