...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)[CH]OO[CH]F(5139)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[CH]F(877)', '[CH]C(=O)F(3804)'],
    products = ['O=C(F)[CH]OO[CH]F(5139)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', '[O]O[CH]C(=O)F(3833)'],
    products = ['O=C(F)[CH]OO[CH]F(5139)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['O=C(F)[CH]OO[CH]F(5139)'],
    products = ['F[C]1[CH]OOC(F)O1(5175)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=C=COO[CH]F(5177)'],
    products = ['O=C(F)[CH]OO[CH]F(5139)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', '[O]O[CH]C(=O)F(3833)'],
    products = ['O=C(F)[CH]OO[CH]F(5139)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C(F)[CH]OO[CH]F(5139)'],
    products = ['[O]C(F)(C=O)O[CH]F(5138)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O(6)', 'F[C]=COO[CH]F(5179)'],
    products = ['O=C(F)[CH]OO[CH]F(5139)'],
