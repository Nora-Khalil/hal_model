...
"""),
    E0 = (-567.433,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([219,296,586,564,718,793,1177,1228,246,474,533,1155,3120,650,792.5,1650,1292.41],'cm^-1')),
        HinderedRotor(inertia=(0.431192,'amu*angstrom^2'), symmetry=1, barrier=(9.91396,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.7996,0.0135463,0.000133918,-3.67551e-07,2.79806e-10,-68239,12.3019], Tmin=(10,'K'), Tmax=(474.257,'K')), NASAPolynomial(coeffs=[6.46731,0.0266086,-1.98741e-05,6.74713e-09,-8.4901e-13,-68892,-2.79461], Tmin=(474.257,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-567.433,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), label="""[CH]DC(F)C(F)(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    ...
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(7.00938e+53,'m^3/(mol*s)'), n=-13.541, Ea=(217.9,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['FCC(F)=C(F)F(432)'],
    products = ['CH2CFCF3(83)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.11883e+10,'s^-1'), n=0.811585, Ea=(262.426,'kJ/mol'), T0=(1,'K'), Tmin=(298,'K'), Tmax=(2500,'K'), comment="""Fitted to 50 data points; dA = *|/ 1.30388, dn = +|- 0.0348607, dEa = +|- 0.18971 kJ/molMatched reaction 13 C3H2F4 <=> C3H2F4-2 in 1,3_sigmatropic_rearrangement/training
This reaction matched rate rule [F_Ext-2R!H-R]
family: 1,3_sigmatropic_rearrangement"""),
)

reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'C=C(F)[C](F)F(2143)'],
    products = ['CH2CFCF3(83)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'C=[C]C(F)(F)F(10558)'],
    products = ['CH2CFCF3(83)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(5e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'cal/mol'), T0=(1,'K'), comment="""Matched reaction 205 C3H2F3 + F <=> C3H2F4-2 in R_Recombination/training
This reaction matched rate rule [Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_N-3R!H->F_N-3BrCClINOPSSi->Cl_Ext-1C-R_Ext-3BrCO-R_N-2CF->C]
family: R_Recombination"""),
)

reaction(
    label = 'reaction5',
    reactants = ['H(5)', 'E-CHCFCF3(85)'],
    products = ['CH2CFCF3(83)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(5e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'cal/mol'), T0=(1,'K'), comment="""Matched reaction 206 C3HF4-3 + H <=> C3H2F4-2 in R_Recombination/training
This reaction matched rate rule [Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_N-3C-inRing_Ext-3C-R_4R!H->C_N-Sp-3C-2C_Ext-3C-R]
family: R_Recombination"""),
)
...
reaction(
    ...
    products = ['CH2CFCF3(83)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.20443e+17,'s^-1'), n=-1.43042, Ea=(13.0942,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.514991623114097, var=15.884634944160005, Tref=1000.0, N=7, data_mean=0.0, correlation='CCH',), comment="""Estimated from node CCH"""),
)

reaction(
    label = 'reaction8',
    reactants = ['F2(78)', 'C=C=C(F)F(8036)'],
    products = ['CH2CFCF3(83)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2(S)(25)', 'F[C]C(F)(F)F(767)'],
    products = ['CH2CFCF3(83)'],
    transitionState = 'TS9',
