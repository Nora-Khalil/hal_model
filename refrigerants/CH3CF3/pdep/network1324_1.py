...
"""),
    E0 = (575.97,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,1685,370,3120,650,792.5,1650,530.84,530.846,3321.13],'cm^-1')),
        HinderedRotor(inertia=(0.111261,'amu*angstrom^2'), symmetry=1, barrier=(22.2474,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12901,'amu*angstrom^2'), symmetry=1, barrier=(2.9662,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.174894,'amu*angstrom^2'), symmetry=1, barrier=(34.9734,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09115,0.0416783,-5.21716e-05,3.17082e-08,-7.4786e-12,69342.2,25.144], Tmin=(100,'K'), Tmax=(1043.24,'K')), NASAPolynomial(coeffs=[10.8905,0.00794039,-3.66346e-06,7.1056e-10,-5.05797e-14,67506.2,-17.6807], Tmin=(1043.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(575.97,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2sFO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]=C(F)O[O](474)'],
    products = ['[CH]=C(F)OO[O](3993)'],
    transitionState = 'TS2',
