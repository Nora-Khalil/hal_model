...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[CH]F(850)'],
    products = ['[CH2]CO[CH]F(8986)'],
    transitionState = 'TS3',
