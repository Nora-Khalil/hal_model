...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(192)', '[CH2]C(=C)[O](1709)'],
    products = ['C=C([O])C[C]=O(9138)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['CO(13)', '[CH2]C(=C)[O](1709)'],
    products = ['C=C([O])C[C]=O(9138)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C=C([O])C=C=O(9169)'],
    products = ['C=C([O])C[C]=O(9138)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(18)', 'O=[C]C[C]=O(2723)'],
    products = ['C=C([O])C[C]=O(9138)'],
