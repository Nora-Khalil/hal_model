...
"""),
    E0 = (-337.248,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,180,180,1868.48],'cm^-1')),
        HinderedRotor(inertia=(0.538356,'amu*angstrom^2'), symmetry=1, barrier=(12.3779,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.287574,'amu*angstrom^2'), symmetry=1, barrier=(12.391,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0695417,'amu*angstrom^2'), symmetry=1, barrier=(12.3816,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05059,'amu*angstrom^2'), symmetry=1, barrier=(24.155,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.725104,0.0756715,-9.22295e-05,6.00192e-08,-1.57655e-11,-40446.7,24.0194], Tmin=(100,'K'), Tmax=(923.696,'K')), NASAPolynomial(coeffs=[12.0783,0.0265066,-1.23885e-05,2.39389e-09,-1.68853e-13,-42544,-29.8517], Tmin=(923.696,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-337.248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(Csj(Cs-F1sF1sO2s)(H)(H))"""),
)
...
"""),
    ...
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.607564,0.0596241,-2.31483e-05,-2.50942e-08,1.70963e-11,-77550.8,21.2375], Tmin=(100,'K'), Tmax=(954.812,'K')), NASAPolynomial(coeffs=[21.0536,0.0103007,-2.73782e-06,5.06399e-10,-4.11918e-14,-83111.3,-85.1298], Tmin=(954.812,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-645.923,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
"""),
    E0 = (-429.838,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.05652,'amu*angstrom^2'), symmetry=1, barrier=(24.2914,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05845,'amu*angstrom^2'), symmetry=1, barrier=(24.3359,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06006,'amu*angstrom^2'), symmetry=1, barrier=(24.373,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.589717,0.0620056,-3.77154e-05,-9.09154e-09,1.14958e-11,-51562.9,22.7444], Tmin=(100,'K'), Tmax=(952.898,'K')), NASAPolynomial(coeffs=[20.9319,0.00793387,-1.89962e-06,3.4301e-10,-2.8698e-14,-56861.6,-81.8746], Tmin=(952.898,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-429.838,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Csj(Cs-F1sF1sO2s)(H)(H))"""),
)

species(
    label = '[CH2]COC([CH2])(F)F(1880)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (-306.114,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,305.182,309.479,1637.87],'cm^-1')),
        HinderedRotor(inertia=(0.125615,'amu*angstrom^2'), symmetry=1, barrier=(8.56806,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126313,'amu*angstrom^2'), symmetry=1, barrier=(8.51055,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127327,'amu*angstrom^2'), symmetry=1, barrier=(8.54947,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.480227,'amu*angstrom^2'), symmetry=1, barrier=(32.2379,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.886047,0.0736565,-9.19647e-05,6.41702e-08,-1.84354e-11,-36709.5,24.6329], Tmin=(100,'K'), Tmax=(840.566,'K')), NASAPolynomial(coeffs=[9.98876,0.0303404,-1.46683e-05,2.86652e-09,-2.02986e-13,-38239.8,-17.7017], Tmin=(840.566,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-306.114,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(Csj(Cs-F1sF1sO2s)(H)(H))"""),
)

species(
    label = '[CH2][CH]OC(C)(F)F(1881)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {4,S} {6,S}
...
"""),
    ...
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.575241,0.0786756,-9.81672e-05,6.42522e-08,-1.68226e-11,-40981.8,23.7473], Tmin=(100,'K'), Tmax=(930.194,'K')), NASAPolynomial(coeffs=[13.0524,0.0250226,-1.16501e-05,2.24699e-09,-1.58328e-13,-43303.1,-35.5453], Tmin=(930.194,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-341.744,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CJCO)"""),
)

species(
    label = '[CH2][C](F)OC(C)F(1882)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {4,S} {6,S}
...
"""),
    E0 = (-317.566,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,3000,3100,440,815,1455,1000,245.548,248.216,2100.99],'cm^-1')),
        HinderedRotor(inertia=(0.234066,'amu*angstrom^2'), symmetry=1, barrier=(10.2968,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.253515,'amu*angstrom^2'), symmetry=1, barrier=(10.3015,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.654708,'amu*angstrom^2'), symmetry=1, barrier=(28.5932,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.684228,'amu*angstrom^2'), symmetry=1, barrier=(28.5912,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02467,0.0715571,-8.82026e-05,6.31395e-08,-1.90472e-11,-38092.7,24.8364], Tmin=(100,'K'), Tmax=(794.538,'K')), NASAPolynomial(coeffs=[8.51883,0.033828,-1.69725e-05,3.37181e-09,-2.40978e-13,-39283.6,-9.5948], Tmin=(794.538,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-317.566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[CH]C(1793)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C([O])(F)F(162)', '[CH]C-2(978)'],
    products = ['[CH2]C(F)(F)O[CH]C(1793)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C[CH]O[C](F)F(1877)'],
    products = ['[CH2]C(F)(F)O[CH]C(1793)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)OC=C(1879)'],
    products = ['[CH2]C(F)(F)O[CH]C(1793)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]COC([CH2])(F)F(1880)'],
    products = ['[CH2]C(F)(F)O[CH]C(1793)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C](F)OC(C)F(1882)'],
    products = ['[CH2]C(F)(F)O[CH]C(1793)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(218.188,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction14',
    reactants = ['C[CH]O[C](F)CF(1883)'],
    products = ['[CH2]C(F)(F)O[CH]C(1793)'],
