...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[O]C(F)C(=O)F(4320)'],
    products = ['[O]C(F)C([O])F(5760)'],
    transitionState = 'TS7',
