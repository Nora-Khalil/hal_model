...
"""),
    ...
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.135672,0.0968747,-0.000173076,1.60302e-07,-5.68372e-11,-92805,30.0601], Tmin=(100,'K'), Tmax=(840.499,'K')), NASAPolynomial(coeffs=[8.56493,0.0331794,-1.73202e-05,3.38042e-09,-2.33921e-13,-93389.1,-4.18683], Tmin=(840.499,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-772.687,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sF1sH)(F1s)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = 'F[C](F)C[CH]C(F)(F)F(1048)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.615058,0.0827085,-0.000133047,1.19867e-07,-4.30679e-11,-99445.5,30.5336], Tmin=(100,'K'), Tmax=(787.654,'K')), NASAPolynomial(coeffs=[8.05947,0.0334273,-1.73425e-05,3.43745e-09,-2.4245e-13,-100262,-1.34474], Tmin=(787.654,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-827.784,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sF1sF1s)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = 'F[C](F)[CH]CC(F)(F)F(1049)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.403579,0.0876904,-0.000144584,1.28688e-07,-4.5024e-11,-99883.2,30.7974], Tmin=(100,'K'), Tmax=(811.563,'K')), NASAPolynomial(coeffs=[9.21164,0.0311809,-1.59317e-05,3.12076e-09,-2.17938e-13,-100882,-7.20018], Tmin=(811.563,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-831.484,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(138)', 'F[CH]C[C](F)F(803)'],
    products = ['F[C](F)CC(F)[C](F)F(1012)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[C](F)CC=C(F)F(142)'],
    products = ['F[C](F)CC(F)[C](F)F(1012)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[C](F)CC(F)=C(F)F(1041)'],
    products = ['F[C](F)CC(F)[C](F)F(1012)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'F[C](F)C(F)C=C(F)F(1042)'],
    products = ['F[C](F)CC(F)[C](F)F(1012)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'F[C](F)C=C[C](F)F(1043)'],
    products = ['F[C](F)CC(F)[C](F)F(1012)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(43)', 'F[CH]C[C](F)F(803)'],
    products = ['F[C](F)CC(F)[C](F)F(1012)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C](F)C(F)[CH]C(F)F(1045)'],
    products = ['F[C](F)CC(F)[C](F)F(1012)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C](F)[CH]C(F)C(F)F(1046)'],
    products = ['F[C](F)CC(F)[C](F)F(1012)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[C](F)CC(F)[C](F)F(1012)'],
    products = ['F[C](F)[C](F)CC(F)F(1047)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C](F)CC(F)[C](F)F(1012)'],
    products = ['F[C](F)C[CH]C(F)(F)F(1048)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F[C](F)CC(F)[C](F)F(1012)'],
    products = ['F[C](F)[CH]CC(F)(F)F(1049)'],
