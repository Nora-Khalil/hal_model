...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.285882,'amu*angstrom^2'), symmetry=1, barrier=(6.57298,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.24163,'amu*angstrom^2'), symmetry=1, barrier=(28.5476,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.286408,'amu*angstrom^2'), symmetry=1, barrier=(6.58507,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.157538,0.103936,-0.000197629,1.80174e-07,-6.18688e-11,-67749,28.8659], Tmin=(100,'K'), Tmax=(859.352,'K')), NASAPolynomial(coeffs=[11.6231,0.023658,-1.30929e-05,2.56251e-09,-1.75587e-13,-68834.3,-20.7173], Tmin=(859.352,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-564.443,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C(F)(F)[CH]F(1014)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)(F)C(F)[C](F)F(1015)'],
    products = ['[O]C(F)(F)C(F)(F)[CH]F(1014)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', '[O]C(F)(F)[C](F)F(284)'],
    products = ['[O]C(F)(F)C(F)(F)[CH]F(1014)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(F)(F)C(F)=CF(843)'],
    products = ['[O]C(F)(F)C(F)(F)[CH]F(1014)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=C(F)C(F)(F)[CH]F(1179)'],
    products = ['[O]C(F)(F)C(F)(F)[CH]F(1014)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['F2(78)', 'O=C(F)[C](F)[CH]F(554)'],
    products = ['[O]C(F)(F)C(F)(F)[CH]F(1014)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', '[O]C(F)(F)[C](F)F(284)'],
    products = ['[O]C(F)(F)C(F)(F)[CH]F(1014)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[CH][C](F)C(F)(F)OF(1180)'],
    products = ['[O]C(F)(F)C(F)(F)[CH]F(1014)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C(F)(F)C(F)(F)[CH]F(1014)'],
    products = ['[O]C(F)(F)[C](F)C(F)F(1173)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[CH]C(F)(F)[C](F)OF(1181)'],
    products = ['[O]C(F)(F)C(F)(F)[CH]F(1014)'],
