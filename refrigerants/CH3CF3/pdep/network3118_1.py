...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)O[O](1328)'],
    products = ['O=O(161)', 'CH2CHF(56)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C([O])F(5619)'],
    products = ['[CH2]C(F)O[O](1328)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[CH]F(893)', 'CH2(T)(18)'],
    products = ['[CH2]C(F)O[O](1328)'],
    transitionState = 'TS3',
