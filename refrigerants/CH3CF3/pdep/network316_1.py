...
"""),
    E0 = (40.3029,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,284.797,284.854,284.909,781.589],'cm^-1')),
        HinderedRotor(inertia=(0.0020769,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00207775,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (62.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.18111,0.0216331,-1.36477e-05,3.79135e-09,-4.11688e-13,4872.81,10.9876], Tmin=(100,'K'), Tmax=(2025.05,'K')), NASAPolynomial(coeffs=[8.88508,0.0103662,-5.30212e-06,1.04389e-09,-7.25028e-14,2562.64,-20.5555], Tmin=(2025.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(40.3029,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CH2_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.61868,'amu*angstrom^2'), symmetry=1, barrier=(14.2247,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (62.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.16713,0.009241,2.17422e-05,-3.70578e-08,1.4725e-11,-18546,-21.1669], Tmin=(100,'K'), Tmax=(1009.69,'K')), NASAPolynomial(coeffs=[10.5958,0.00236913,-1.56061e-06,4.55008e-10,-4.1816e-14,-21196,-62.7717], Tmin=(1009.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-154.516,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsCs) + group(CJ2_singlet-FO)"""),
)
