...
"""),
    E0 = (-688.592,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,493,600,700,1144,1293,270.455,270.455,270.455,2431.81],'cm^-1')),
        HinderedRotor(inertia=(0.142995,'amu*angstrom^2'), symmetry=1, barrier=(7.42224,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142994,'amu*angstrom^2'), symmetry=1, barrier=(7.42224,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.591526,'amu*angstrom^2'), symmetry=1, barrier=(30.7036,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.920737,0.07491,-0.000124985,1.11472e-07,-3.93368e-11,-82714.6,26.8986], Tmin=(100,'K'), Tmax=(784.139,'K')), NASAPolynomial(coeffs=[8.95905,0.0252832,-1.35589e-05,2.71635e-09,-1.92396e-13,-83710.1,-8.23663], Tmin=(784.139,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-688.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
species(
    label = 'F[C](F)OC(F)C(F)[C](F)F(6937)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-1106.97,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,261,493,600,1152,1365,1422,3097,190,488,555,1236,1407,493,600,700,1144,1293,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.641982,0.113873,-0.000197621,1.78293e-07,-6.27666e-11,-132982,35.7091], Tmin=(100,'K'), Tmax=(809.191,'K')), NASAPolynomial(coeffs=[11.3469,0.0363162,-1.9944e-05,3.97291e-09,-2.79058e-13,-134323,-15.8911], Tmin=(809.191,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1106.97,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFFHO) + radical(Csj(Cs-CsF1sH)(F1s)(F1s)) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = 'F[C](F)O[CH]C(F)(F)C(F)F(6938)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.16391,0.126843,-0.000229281,2.04321e-07,-6.95348e-11,-136556,35.3405], Tmin=(100,'K'), Tmax=(848.349,'K')), NASAPolynomial(coeffs=[13.8681,0.0313697,-1.69806e-05,3.31027e-09,-2.27579e-13,-138222,-29.4916], Tmin=(848.349,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1136.83,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsOsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsFFHO) + radical(CCsJOCs) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
"""),
    E0 = (-705.038,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,493,600,700,1144,1293,180,180,180,2228.1],'cm^-1')),
        HinderedRotor(inertia=(0.411743,'amu*angstrom^2'), symmetry=1, barrier=(9.46678,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.411518,'amu*angstrom^2'), symmetry=1, barrier=(9.46162,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.47643,'amu*angstrom^2'), symmetry=1, barrier=(33.9461,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
...
species(
    label = 'FC(F)=C(OC(F)F)C(F)F(6939)',
...
"""),
    ...
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.398115,0.106863,-0.000177209,1.57524e-07,-5.56464e-11,-164262,31.4955], Tmin=(100,'K'), Tmax=(779.745,'K')), NASAPolynomial(coeffs=[10.9764,0.0368548,-2.01062e-05,4.02847e-09,-2.85206e-13,-165682,-18.2774], Tmin=(779.745,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1366.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(CsFFHO) + group(Cds-CdsCsOs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)
...
"""),
    E0 = (-726.812,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,493,600,700,1144,1293,180,180,408.81],'cm^-1')),
        HinderedRotor(inertia=(0.145872,'amu*angstrom^2'), symmetry=1, barrier=(3.35388,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137719,'amu*angstrom^2'), symmetry=1, barrier=(3.16643,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'F[C](F)OC(=C(F)F)C(F)F(6940)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-1152.59,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,182,240,577,636,1210,1413,493,600,700,1144,1293,180,180,180,928.731],'cm^-1')),
        HinderedRotor(inertia=(0.00676852,'amu*angstrom^2'), symmetry=1, barrier=(4.14482,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.88508,'amu*angstrom^2'), symmetry=1, barrier=(43.3417,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180222,'amu*angstrom^2'), symmetry=1, barrier=(4.14366,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (179.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.123537,0.100013,-0.00016468,1.45893e-07,-5.18689e-11,-138485,32.7853], Tmin=(100,'K'), Tmax=(749.97,'K')), NASAPolynomial(coeffs=[10.7966,0.0345696,-1.93876e-05,3.9377e-09,-2.81441e-13,-139920,-15.4063], Tmin=(749.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1152.59,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(CsFFHO) + group(Cds-CdsCsOs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(Csj(F1s)(F1s)(O2s-Cd))"""),
)
...
species(
    label = 'F[C](F)O[C](C(F)F)C(F)F(6941)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.915129,0.126405,-0.00024383,2.31648e-07,-8.26196e-11,-137565,35.1139], Tmin=(100,'K'), Tmax=(855.602,'K')), NASAPolynomial(coeffs=[9.14932,0.0395506,-2.17831e-05,4.26384e-09,-2.9321e-13,-137830,-3.35808], Tmin=(855.602,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1145.1,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(CsCsFFH) + group(CsCsFFH) + group(CsFFHO) + radical(C2CsJOCs) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = 'F[C](F)[C](OC(F)F)C(F)F(6942)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.976777,0.127974,-0.000247668,2.34998e-07,-8.36285e-11,-138758,35.9162], Tmin=(100,'K'), Tmax=(857.015,'K')), NASAPolynomial(coeffs=[9.41252,0.0391485,-2.1603e-05,4.22656e-09,-2.90358e-13,-139058,-3.96119], Tmin=(857.015,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1155.05,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(CsCsFFH) + group(CsCsFFH) + group(CsFFHO) + radical(C2CsJOCs) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)

species(
    label = 'F[C](F)C(OC(F)F)[C](F)F(6943)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.865338,0.120409,-0.000216851,1.97355e-07,-6.91e-11,-136212,35.9248], Tmin=(100,'K'), Tmax=(829.298,'K')), NASAPolynomial(coeffs=[11.8251,0.0352445,-1.94815e-05,3.86086e-09,-2.69185e-13,-137493,-17.9576], Tmin=(829.298,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1133.88,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(CsCsFFH) + group(CsCsFFH) + group(CsFFHO) + radical(Csj(Cs-O2sCsH)(F1s)(F1s)) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'F[C](F)CO[C](F)F(244)'],
    products = ['F[C](F)OC([C](F)F)C(F)F(6684)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.33604e-10,'m^3/(mol*s)'), n=4.72997, Ea=(129.187,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'F[C](F)OC(F)[C](F)F(1017)'],
    products = ['F[C](F)OC([C](F)F)C(F)F(6684)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(4.96165e-06,'m^3/(mol*s)'), n=3.30609, Ea=(145.244,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['F[C](F)OC(F)C(F)[C](F)F(6937)'],
    products = ['F[C](F)OC([C](F)F)C(F)F(6684)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C](F)OC([C](F)F)C(F)F(6684)'],
    products = ['F[C](F)O[CH]C(F)(F)C(F)F(6938)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C]F(138)', '[O]C([C](F)F)C(F)F(1458)'],
    products = ['F[C](F)OC([C](F)F)C(F)F(6684)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[C]F(138)', 'F[C](F)O[CH]C(F)F(265)'],
    products = ['F[C](F)OC([C](F)F)C(F)F(6684)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F[C](F)OC([C](F)F)C(F)F(6684)'],
    products = ['FC(F)=C(OC(F)F)C(F)F(6939)'],
    transitionState = 'TS9',
...
reaction(
    ...
    kinetics = Arrhenius(A=(9.07578e-06,'m^3/(mol*s)'), n=3.04336, Ea=(90.3678,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(199.608,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction16',
    reactants = ['CF2(43)', 'F[C](F)O[CH]C(F)F(265)'],
    products = ['F[C](F)OC([C](F)F)C(F)F(6684)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(0.00976185,'m^3/(mol*s)'), n=2.64543, Ea=(3.24222,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.24524072153041726, var=3.368891203868511, Tref=1000.0, N=3, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s"""),
)

reaction(
    label = 'reaction17',
    reactants = ['CF2(43)', '[O]C([C](F)F)C(F)F(1458)'],
    products = ['F[C](F)OC([C](F)F)C(F)F(6684)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(128827,'m^3/(mol*s)'), n=0.469398, Ea=(5.15927,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R"""),
)

reaction(
    label = 'reaction18',
    reactants = ['F[C](F)OC([C](F)F)C(F)F(6684)'],
    products = ['F[C](F)O[C](C(F)F)C(F)F(6941)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C](F)OC([C](F)F)C(F)F(6684)'],
    products = ['F[C](F)[C](OC(F)F)C(F)F(6942)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C](F)OC([C](F)F)C(F)F(6684)'],
    products = ['F[C](F)C(OC(F)F)[C](F)F(6943)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(3.29706e+07,'s^-1'), n=1.15307, Ea=(184.025,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF
Multiplied by reaction path degeneracy 2.0"""),
)

network(
    label = 'PDepNetwork #2004',
    isomers = [
        'F[C](F)OC([C](F)F)C(F)F(6684)',
    ],
    reactants = [
