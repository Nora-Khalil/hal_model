...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=O)O[C](F)F(1774)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'O=[C]O[C](F)F(726)'],
    products = ['[CH2]C(=O)O[C](F)F(1774)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=O)O[C](F)F(1774)'],
    products = ['[CH2][C]1OC(F)(F)O1(2026)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(=O)O[C](F)F(1774)'],
    products = ['[CH2]C1([O])OC1(F)F(2027)'],
    transitionState = 'TS7',
