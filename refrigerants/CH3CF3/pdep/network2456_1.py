...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH2]C(=O)OC=O(9153)'],
    products = ['C=C(OF)OC=O(8703)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C=O(322)', 'C=[C]OF(1651)'],
    products = ['C=C(OF)OC=O(8703)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HCO(15)', '[CH2]C(=O)OF(1450)'],
    products = ['C=C(OF)OC=O(8703)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(127)', 'C=[C]OC=O(2285)'],
    products = ['C=C(OF)OC=O(8703)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH]=C(OF)OC=O(9154)'],
    products = ['C=C(OF)OC=O(8703)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C=C(OF)O[C]=O(9155)'],
    products = ['C=C(OF)OC=O(8703)'],
