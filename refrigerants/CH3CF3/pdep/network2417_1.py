...
reaction(
    label = 'reaction3',
    reactants = ['[C]=CF-2(1206)', '[CH]C=C(F)F(2883)'],
    products = ['[CH]=CC(F)(F)[C]=CF(8571)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH]=CC(F)=C=CF(8575)'],
    products = ['[CH]=CC(F)(F)[C]=CF(8571)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#CC(F)(F)[C]=CF(3446)'],
    products = ['[CH]=CC(F)(F)[C]=CF(8571)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]=CC(F)(F)C#C(8576)'],
    products = ['[CH]=CC(F)(F)[C]=CF(8571)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH]=CC(F)(F)C#CF(8577)'],
    products = ['[CH]=CC(F)(F)[C]=CF(8571)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH]=C=C(F)[C]=CF(3449)'],
    products = ['[CH]=CC(F)(F)[C]=CF(8571)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=CC(F)(F)C=[C]F(8578)'],
    products = ['[CH]=CC(F)(F)[C]=CF(8571)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=[C]C(F)(F)C=CF(8579)'],
    products = ['[CH]=CC(F)(F)[C]=CF(8571)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=CC(F)(F)C(=[CH])F(8582)'],
    products = ['[CH]=CC(F)(F)[C]=CF(8571)'],
