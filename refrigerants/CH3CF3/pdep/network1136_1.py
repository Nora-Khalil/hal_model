...
reaction(
    label = 'reaction3',
    reactants = ['[C]=CF-2(1206)', '[O]C[C](F)F(174)'],
    products = ['[O]CC(F)(F)[C]=CF(2984)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C(F)(F)[C]=CF(508)'],
    products = ['[O]CC(F)(F)[C]=CF(2984)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]CC(F)=C=CF(3293)'],
    products = ['[O]CC(F)(F)[C]=CF(2984)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=CC(F)(F)[C]=CF(3294)'],
    products = ['[O]CC(F)(F)[C]=CF(2984)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C#CC(F)(F)C[O](3295)'],
    products = ['[O]CC(F)(F)[C]=CF(2984)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]CC(F)(F)C#CF(3296)'],
    products = ['[O]CC(F)(F)[C]=CF(2984)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'O=CC(F)=[C][CH]F(3297)'],
    products = ['[O]CC(F)(F)[C]=CF(2984)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O[CH]C(F)(F)[C]=CF(3298)'],
    products = ['[O]CC(F)(F)[C]=CF(2984)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=C(F)C(F)(F)C[O](3305)'],
    products = ['[O]CC(F)(F)[C]=CF(2984)'],
