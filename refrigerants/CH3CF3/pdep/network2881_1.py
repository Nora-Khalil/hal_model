...
"""),
    E0 = (464.006,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,3115,3125,620,680,785,800,1600,1700,180],'cm^-1')),
        HinderedRotor(inertia=(1.16883,'amu*angstrom^2'), symmetry=1, barrier=(26.8736,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.16857,'amu*angstrom^2'), symmetry=1, barrier=(26.8677,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.0738,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87023,0.0366543,-9.50833e-06,-2.46825e-08,1.5312e-11,55893.2,18.7976], Tmin=(100,'K'), Tmax=(918.693,'K')), NASAPolynomial(coeffs=[15.5467,0.00385991,3.55574e-07,-1.4233e-10,8.1352e-15,52251.3,-52.1681], Tmin=(918.693,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(464.006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P)"""),
)

species(
    label = 'C#CO[CH][CH2](9598)',
    structure = adjacencyList("""multiplicity 3
1 O u0 p2 c0 {2,S} {4,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(976)', '[CH]=C[O](623)'],
    products = ['[CH]=CO[C]=C(9587)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH]=CO[C]=C(9587)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(102.041,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction6',
    reactants = ['H(5)', 'C#CO[C]=C(5895)'],
    products = ['[CH]=CO[C]=C(9587)'],
    transitionState = 'TS6',
