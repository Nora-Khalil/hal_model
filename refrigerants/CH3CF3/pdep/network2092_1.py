...
"""),
    E0 = (-445.091,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,182,240,577,636,1210,1413,2084.98],'cm^-1')),
        HinderedRotor(inertia=(0.313648,'amu*angstrom^2'), symmetry=1, barrier=(7.2114,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.31215,'amu*angstrom^2'), symmetry=1, barrier=(7.17694,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25586,0.0730354,-0.0001386,1.39595e-07,-5.27876e-11,-53445.6,25.5462], Tmin=(100,'K'), Tmax=(841.754,'K')), NASAPolynomial(coeffs=[3.20115,0.0347707,-1.86979e-05,3.67484e-09,-2.55105e-13,-52744.9,22.6034], Tmin=(841.754,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-445.091,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(ROOJ)"""),
)
...
"""),
    ...
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8412,0.0528515,-5.69608e-05,3.48687e-08,-9.20003e-12,-61503.9,20.654], Tmin=(100,'K'), Tmax=(888.888,'K')), NASAPolynomial(coeffs=[7.4536,0.027596,-1.43426e-05,2.90547e-09,-2.10458e-13,-62501.7,-5.76156], Tmin=(888.888,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-511.981,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFHH) + ring(O2s-Cs(F)(F)-Cs-O2s) + radical(C2CsJOO)"""),
)

species(
    label = 'FCC1([C](F)F)OO1(8566)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.788899,0.0541061,-1.84615e-05,-3.5115e-08,2.29143e-11,-57320.7,24.4237], Tmin=(100,'K'), Tmax=(924.663,'K')), NASAPolynomial(coeffs=[23.7143,-0.00218923,3.30485e-06,-6.5895e-10,3.97187e-14,-63393.3,-94.2943], Tmin=(924.663,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-477.68,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsOs) + group(CsCsFHH) + group(CsCsFFH) + ring(O2s-O2s-Cs(C-FF)) + radical(CsCsF1sF1s)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.270051,'amu*angstrom^2'), symmetry=1, barrier=(6.20901,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00136317,'amu*angstrom^2'), symmetry=1, barrier=(6.22241,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59267,0.0619753,-0.000111959,1.0653e-07,-3.82905e-11,-15607.3,23.8922], Tmin=(100,'K'), Tmax=(861.844,'K')), NASAPolynomial(coeffs=[5.13695,0.0252314,-1.26872e-05,2.41709e-09,-1.6444e-13,-15464.5,11.6927], Tmin=(861.844,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-130.415,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(ROOJ) + radical(C=C(O)CJ)"""),
)

species(
    label = '[O]OC(=[C]F)CF(8568)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.346172,'amu*angstrom^2'), symmetry=1, barrier=(7.95917,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00210155,'amu*angstrom^2'), symmetry=1, barrier=(7.95106,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61586,0.0650028,-0.000128484,1.31532e-07,-4.98311e-11,1097.29,24.1745], Tmin=(100,'K'), Tmax=(852.419,'K')), NASAPolynomial(coeffs=[2.48436,0.0312218,-1.67667e-05,3.27763e-09,-2.26159e-13,2028.46,26.4536], Tmin=(852.419,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(8.51035,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(ROOJ) + radical(Cdj(Cd-CsO2s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.980864,0.0759339,-0.000132609,1.26213e-07,-4.68988e-11,-53646.5,26.3357], Tmin=(100,'K'), Tmax=(803.851,'K')), NASAPolynomial(coeffs=[6.27249,0.031954,-1.76098e-05,3.52669e-09,-2.48951e-13,-53927.1,5.50872], Tmin=(803.851,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-446.87,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(Csj(Cd-O2sCd)(F1s)(H))"""),
)

species(
    label = '[CH2]C(OOF)=C(F)F(8569)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-187.119,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,350,440,435,1725,3000,3100,440,815,1455,1000,182,240,577,636,1210,1413,837.713,838.022],'cm^-1')),
        HinderedRotor(inertia=(0.0899794,'amu*angstrom^2'), symmetry=1, barrier=(2.0688,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0832626,'amu*angstrom^2'), symmetry=1, barrier=(1.91437,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0829364,'amu*angstrom^2'), symmetry=1, barrier=(1.90687,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.979126,0.0751328,-0.000129794,1.19526e-07,-4.27253e-11,-22404.9,26.7161], Tmin=(100,'K'), Tmax=(825.089,'K')), NASAPolynomial(coeffs=[7.36112,0.0280431,-1.48249e-05,2.90919e-09,-2.02547e-13,-22908.3,0.484935], Tmin=(825.089,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-187.119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2sFO) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(C=C(O)CJ)"""),
)

species(
    label = 'F[C]=C(CF)OOF(8570)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.996614,'amu*angstrom^2'), symmetry=1, barrier=(22.9141,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.994965,0.0782586,-0.000146725,1.45169e-07,-5.46011e-11,-5699.96,27.024], Tmin=(100,'K'), Tmax=(827.113,'K')), NASAPolynomial(coeffs=[4.71408,0.0340229,-1.88978e-05,3.76808e-09,-2.64124e-13,-5417.29,15.2152], Tmin=(827.113,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-48.1937,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2sFO) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-CsO2s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(CF)=C(F)F(7175)'],
    products = ['HO2(11)', 'FC=C=C(F)F(1375)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[O]OC(F)=C(F)F(1091)'],
    products = ['[O]OC(CF)=C(F)F(7175)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'O=C(CF)[C](F)F(7091)'],
    products = ['[O]OC(CF)=C(F)F(7175)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2]C(O[O])=C(F)F(8567)'],
    products = ['[O]OC(CF)=C(F)F(7175)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]OC(=[C]F)CF(8568)'],
    products = ['[O]OC(CF)=C(F)F(7175)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['O2(2)', 'FC[C]=C(F)F(7168)'],
    products = ['[O]OC(CF)=C(F)F(7175)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2F(46)', '[O]O[C]=C(F)F(1222)'],
    products = ['[O]OC(CF)=C(F)F(7175)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]OC([CH]F)=C(F)F(5712)'],
    products = ['[O]OC(CF)=C(F)F(7175)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(OOF)=C(F)F(8569)'],
    products = ['[O]OC(CF)=C(F)F(7175)'],
