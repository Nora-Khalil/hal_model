...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(F)(F)[CH]C(F)F(6669)'],
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(F)(F)[CH]C(F)F(271)'],
    products = ['[O]OC(F)(F)[CH]C(F)F(6669)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[C](F)F(163)', '[CH]C(F)F-2(957)'],
    products = ['[O]OC(F)(F)[CH]C(F)F(6669)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]OC(F)=CC(F)F(7042)'],
    products = ['[O]OC(F)(F)[CH]C(F)F(6669)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]OC(F)(F)C=CF(2957)'],
    products = ['[O]OC(F)(F)[CH]C(F)F(6669)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]OC(F)(F)C=C(F)F(7043)'],
    products = ['[O]OC(F)(F)[CH]C(F)F(6669)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]OC(F)(F)C[C](F)F(7044)'],
    products = ['[O]OC(F)(F)[CH]C(F)F(6669)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OOC(F)(F)[CH][C](F)F(7045)'],
    products = ['[O]OC(F)(F)[CH]C(F)F(6669)'],
...
reaction(
    label = 'reaction14',
    reactants = ['FOO[C](F)[CH]C(F)F(7046)'],
    products = ['[O]OC(F)(F)[CH]C(F)F(6669)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]O[C](F)C(F)C(F)F(7047)'],
    products = ['[O]OC(F)(F)[CH]C(F)F(6669)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH][CH]C(F)(F)OOF(7048)'],
    products = ['[O]OC(F)(F)[CH]C(F)F(6669)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]OC(F)(F)C(F)[CH]F(7049)'],
    products = ['[O]OC(F)(F)[CH]C(F)F(6669)'],
...
network(
    label = 'PDepNetwork #1998',
    isomers = [
        '[O]OC(F)(F)[CH]C(F)F(6669)',
    ],
    reactants = [
