...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC(F)(F)[C](F)F(2321)'],
...
reaction(
    ...
    products = ['[CH2]OC(F)(F)[C](F)F(2321)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2]OC(F)=C(F)F(1096)'],
    products = ['[CH2]OC(F)(F)[C](F)F(2321)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]OC(F)(F)[C](F)F(2321)'],
    products = ['[CH2]O[C](F)C(F)(F)F(2434)'],
