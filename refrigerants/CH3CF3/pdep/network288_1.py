...
reaction(
    label = 'reaction7',
    reactants = ['CH3(19)', '[CH2][C](F)F(141)'],
    products = ['CC[C](F)F(970)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C[CH][C](F)F(10951)'],
    products = ['CC[C](F)F(970)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['CC[C](F)F(970)'],
    products = ['C[CH]C(F)F(10952)'],
