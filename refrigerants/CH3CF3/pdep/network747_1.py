...
"""),
    E0 = (-382.713,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,493,600,700,1144,1293,1855,455,950,255.555,257.368,2380.26],'cm^-1')),
        HinderedRotor(inertia=(0.141067,'amu*angstrom^2'), symmetry=1, barrier=(6.78795,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.67733,'amu*angstrom^2'), symmetry=1, barrier=(31.5203,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142158,'amu*angstrom^2'), symmetry=1, barrier=(6.65659,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66716,0.056649,-8.91002e-05,7.90845e-08,-2.83002e-11,-45950.9,24.1329], Tmin=(100,'K'), Tmax=(773.48,'K')), NASAPolynomial(coeffs=[6.94023,0.0231801,-1.21715e-05,2.41664e-09,-1.70745e-13,-46581.1,1.24666], Tmin=(773.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-382.713,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)OsHH) + group(CsFFHO) + group(Cds-OdCsH) + radical(Csj(F1s)(F1s)(O2s-Cs)) + radical(CsCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16071,0.0434053,4.45496e-06,-5.90643e-08,3.18495e-11,-53721.9,23.1471], Tmin=(100,'K'), Tmax=(919.475,'K')), NASAPolynomial(coeffs=[24.2689,-0.00728722,5.85371e-06,-1.13229e-09,7.09791e-14,-60078,-97.8519], Tmin=(919.475,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-447.667,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsFFHO) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Csj(F1s)(F1s)(O2s-Cd))"""),
)

species(
    label = '[O][C]=COC(F)F(1855)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.241855,0.0618543,-6.84754e-05,3.39184e-08,-6.09639e-12,-50640.7,27.3144], Tmin=(100,'K'), Tmax=(1619.9,'K')), NASAPolynomial(coeffs=[20.1049,-0.0010164,2.54165e-06,-5.76264e-10,4.01754e-14,-55262.3,-72.4967], Tmin=(1619.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-422.324,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsFFHO) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['CF2O(49)', '[CH2][C]=O(1002)'],
    products = ['O=[C]CO[C](F)F(1794)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C=CO[C](F)F(1853)'],
    products = ['O=[C]CO[C](F)F(1794)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][C](F)F(263)', '[CH2][C]=O(1002)'],
    products = ['O=[C]CO[C](F)F(1794)'],
