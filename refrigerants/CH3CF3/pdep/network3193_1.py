...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00635286,'amu*angstrom^2'), symmetry=1, barrier=(1.9293,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (66.9966,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.97115,0.0165468,-1.94484e-05,1.02773e-08,-1.93124e-12,16380.1,14.443], Tmin=(100,'K'), Tmax=(1607.91,'K')), NASAPolynomial(coeffs=[7.78644,-0.000556916,1.2882e-06,-3.02605e-10,2.19181e-14,15494,-9.01493], Tmin=(1607.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(135.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(78.9875,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsOs) + group(O2sFO) + group(O2s-OsH) + radical(ROOJ)"""),
)
...
"""),
    ...
    molecularWeight = (95.0066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.45046,-0.0144652,0.00012715,-1.66876e-07,6.58808e-11,-6088.94,18.217], Tmin=(100,'K'), Tmax=(929.618,'K')), NASAPolynomial(coeffs=[17.7223,-0.00764339,6.04706e-06,-1.07428e-09,5.94123e-14,-11690.6,-65.4518], Tmin=(929.618,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-50.9951,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(CsFHOO) + ring(Cyclopentane) + radical(CsF1sO2sO2s)"""),
)

species(
    label = '[O]C1(F)OOO1(10784)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {4,S} {6,S}
...
"""),
    ...
    molecularWeight = (95.0066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.15503,0.0168419,4.76641e-06,-1.21945e-08,3.69854e-12,-25628,13.8359], Tmin=(100,'K'), Tmax=(1401.71,'K')), NASAPolynomial(coeffs=[8.54209,0.0158966,-9.66142e-06,2.01071e-09,-1.4469e-13,-28555.5,-19.0285], Tmin=(1401.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-213.346,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsOs) + group(CsFOOO) + ring(Cyclobutane) + radical(OCOJ)"""),
)
...
"""),
    E0 = (7.09814,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,528.204,528.276,528.326,528.509],'cm^-1')),
        HinderedRotor(inertia=(0.225138,'amu*angstrom^2'), symmetry=1, barrier=(44.6395,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.225206,'amu*angstrom^2'), symmetry=1, barrier=(44.6402,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0082,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3715.28,'J/mol'), sigma=(5.81185,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=580.32 K, Pc=42.94 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.79692,0.0134046,2.85322e-05,-5.97575e-08,2.76157e-11,909.252,17.1082], Tmin=(100,'K'), Tmax=(909.975,'K')), NASAPolynomial(coeffs=[15.1765,-0.00664688,4.93666e-06,-9.69072e-10,6.26965e-14,-2766.6,-49.2661], Tmin=(909.975,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(7.09814,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(99.7737,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-OsOs) + group(O2s-OsH) + group(Cds-OdOsH) + radical(ROOJ) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (-49.6059,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,1855,455,950,476.701,476.89,477.301],'cm^-1')),
        HinderedRotor(inertia=(0.266714,'amu*angstrom^2'), symmetry=1, barrier=(42.9887,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.267,'amu*angstrom^2'), symmetry=1, barrier=(42.992,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.267271,'amu*angstrom^2'), symmetry=1, barrier=(42.989,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.0066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.14423,0.0270082,9.27038e-06,-4.52475e-08,2.2766e-11,-5886.65,20.0729], Tmin=(100,'K'), Tmax=(934.593,'K')), NASAPolynomial(coeffs=[17.6912,-0.00433708,3.09178e-06,-5.46732e-10,3.04131e-14,-10329.8,-62.104], Tmin=(934.593,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.6059,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(120.56,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-OsOs) + group(O2sFO) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[O]C(=O)F(459)'],
    products = ['[O]OOC(=O)F(1598)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OOC(=O)F(1598)'],
    products = ['F[C]1OOOO1(10783)'],
    transitionState = 'TS4',
