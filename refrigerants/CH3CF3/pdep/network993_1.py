...
species(
    label = 'F[CH]C(F)(F)C(F)(F)[C](F)F(2357)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'FC1C(F)(F)C(F)(F)C1(F)F(2461)',
...
species(
    label = 'F[C](F)C(F)(F)C(F)=C(F)F(2463)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C](F)C(F)=C(F)[C](F)F(2464)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.311189,'amu*angstrom^2'), symmetry=1, barrier=(7.15485,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.310083,'amu*angstrom^2'), symmetry=1, barrier=(7.12942,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.322514,0.109449,-0.000211372,1.94802e-07,-6.70845e-11,-99385.2,30.3244], Tmin=(100,'K'), Tmax=(872.104,'K')), NASAPolynomial(coeffs=[10.9886,0.0261646,-1.41085e-05,2.71583e-09,-1.83659e-13,-100164,-15.8501], Tmin=(872.104,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-827.516,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cd-F1sCd)(F1s)(F1s)) + radical(Csj(Cd-F1sCd)(F1s)(F1s))"""),
)
...
species(
    label = 'F[C](F)C(F)(F)[C](F)C(F)F(2465)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C](F)[C](F)C(F)(F)C(F)F(2466)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C](F)C(F)[C](F)C(F)(F)F(2467)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (182.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.31202,0.10804,-0.000196094,1.8324e-07,-6.58962e-11,-140608,34.7541], Tmin=(100,'K'), Tmax=(821.062,'K')), NASAPolynomial(coeffs=[9.44167,0.0360829,-1.99862e-05,3.99523e-09,-2.80584e-13,-141386,-5.36221], Tmin=(821.062,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1170.27,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-F1sF1sF1s)(F1s)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = 'F[C](F)[C](F)C(F)C(F)(F)F(2468)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (182.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.408398,0.115145,-0.000225951,2.18591e-07,-7.88693e-11,-140041,34.6386], Tmin=(100,'K'), Tmax=(858.103,'K')), NASAPolynomial(coeffs=[7.286,0.0385892,-2.10015e-05,4.10662e-09,-2.8224e-13,-139863,7.42391], Tmin=(858.103,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1165.54,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-F1sF1sH)(F1s)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = 'F[C](F)[CH]C(F)(F)C(F)(F)F(2469)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (182.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.277093,0.10784,-0.000197536,1.86326e-07,-6.74397e-11,-144970,34.5222], Tmin=(100,'K'), Tmax=(823.282,'K')), NASAPolynomial(coeffs=[8.85096,0.0371067,-2.05911e-05,4.11616e-09,-2.88959e-13,-145579,-2.31003], Tmin=(823.282,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1206.52,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(2358)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(2358)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C](F)F(2357)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', 'F[C](F)C(F)[C](F)F(1057)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(2358)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(138)', 'F[CH]C(F)(F)[C](F)F(1067)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(2358)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(2358)'],
    products = ['FC1C(F)(F)C(F)(F)C1(F)F(2461)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(2358)'],
    products = ['FC(F)=C(F)C(F)(F)C(F)F(2462)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[C](F)C(F)C(F)=C(F)F(1136)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(2358)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CF2CF2(61)', 'F[CH][C](F)F(588)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(2358)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[C](F)C(F)(F)C=C(F)F(2359)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(2358)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[C](F)[C](F)F(1586)', 'CHFCF2(55)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(2358)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[C](F)C(F)(F)C(F)=C(F)F(2463)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(2358)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C](F)[C](F)F(1586)', 'F[CH][C](F)F(588)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(2358)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', 'F[C](F)C=C(F)[C](F)F(1137)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(2358)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'F[C](F)C(F)=C(F)[C](F)F(2464)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(2358)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', 'F[C](F)C(F)[C](F)F(1057)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(2358)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(43)', 'F[CH]C(F)(F)[C](F)F(1067)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(2358)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(2358)'],
    products = ['F[C](F)C(F)(F)[C](F)C(F)F(2465)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(2358)'],
    products = ['F[C](F)[C](F)C(F)(F)C(F)F(2466)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(2358)'],
    products = ['F[C](F)C(F)[C](F)C(F)(F)F(2467)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(2358)'],
    products = ['F[C](F)[C](F)C(F)C(F)(F)F(2468)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(2358)'],
    products = ['F[C](F)[CH]C(F)(F)C(F)(F)F(2469)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(2358)'],
    products = ['F[C](F)C(F)(F)[CH]C(F)(F)F(2470)'],
...
network(
    label = 'PDepNetwork #993',
    isomers = [
        'F[C](F)C(F)C(F)(F)[C](F)F(2358)',
    ],
    reactants = [
        ('CF2CF2(61)', 'CHFCF2(55)'),
    ],
