...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])F(5649)', '[C]=C(976)'],
    products = ['C=[C]OC([O])F(6189)'],
    transitionState = 'TS2',
