...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[C]=C(F)C(F)F(2139)'],
    products = ['[CH]=C(F)C(F)F(1497)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]=[C]C(F)F(2141)'],
    products = ['[CH]=C(F)C(F)F(1497)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(F)C(F)F(1497)'],
    products = ['C=C(F)[C](F)F(2143)'],
