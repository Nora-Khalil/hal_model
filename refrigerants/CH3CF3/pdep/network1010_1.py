...
"""),
    E0 = (121.543,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,3010,987.5,1337.5,450,1655,326,540,652,719,1357,400.738,404.093,405.148,407.315],'cm^-1')),
        HinderedRotor(inertia=(0.460587,'amu*angstrom^2'), symmetry=1, barrier=(51.2297,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.458865,'amu*angstrom^2'), symmetry=1, barrier=(51.3335,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0441,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06611,0.0417305,-3.31757e-05,1.35176e-08,-2.26925e-12,14688.3,19.1387], Tmin=(100,'K'), Tmax=(1378.09,'K')), NASAPolynomial(coeffs=[9.83824,0.0191712,-8.62069e-06,1.6388e-09,-1.14289e-13,12546.1,-20.8498], Tmin=(1378.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(121.543,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(AllylJ2_triplet)"""),
)

species(
    label = 'O=C(F)[CH][CH]F(850)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {6,D}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC([O])(F)F(2652)'],
    products = ['CF2O(49)', 'C2H2(23)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C=C(F)F(1863)'],
    products = ['[CH]=CC([O])(F)F(2652)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C](F)F(263)', '[CH]=[CH](1000)'],
    products = ['[CH]=CC([O])(F)F(2652)'],
    transitionState = 'TS8',
