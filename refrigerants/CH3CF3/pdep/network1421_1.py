...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(=O)O[CH]C(=O)F(4297)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(790)', '[CH]C(=O)F(537)'],
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'O=[C]O[CH]C(=O)F(4134)'],
    products = ['[O]C(=O)O[CH]C(=O)F(4297)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)O[CH]C(=O)F(4297)'],
    products = ['O=C(F)[CH]O[C]1OO1(4972)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)O[CH]C(=O)F(4297)'],
    products = ['[O][C]1OC(C(=O)F)O1(4973)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)O[CH]C(=O)F(4297)'],
    products = ['O=C1O[CH][C](F)OO1(4880)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C(=O)OC=C=O(4975)'],
    products = ['[O]C(=O)O[CH]C(=O)F(4297)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O(6)', '[O]C(=O)OC=[C]F(4977)'],
    products = ['[O]C(=O)O[CH]C(=O)F(4297)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(=O)O[C]=C(O)F(4978)'],
    products = ['[O]C(=O)O[CH]C(=O)F(4297)'],
