...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C=C=C(11063)'],
    products = ['[CH]=CC(=C)[O](11377)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(T)(18)', '[CH]C=C=O(3261)'],
    products = ['[CH]=CC(=C)[O](11377)'],
