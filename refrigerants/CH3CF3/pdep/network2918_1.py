...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(192)', '[CH]C=C(1856)'],
    products = ['[CH]=CC[C]=O(11379)'],
    transitionState = 'TS3',
