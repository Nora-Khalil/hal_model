...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C]=O(785)', 'O[C]F(2847)'],
    products = ['O=[C]OO[C](O)F(8760)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(192)', '[O]O[C](O)F(446)'],
    products = ['O=[C]OO[C](O)F(8760)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['[O][C]=O(722)', 'O=C(O)F(635)'],
    products = ['O=[C]OO[C](O)F(8760)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OOC(=O)F(8799)'],
    products = ['O=[C]OO[C](O)F(8760)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][C]=O(722)', '[O][C](O)F(8770)'],
    products = ['O=[C]OO[C](O)F(8760)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[C]=O(785)', '[OH+]=[C-]F(2848)'],
    products = ['O=[C]OO[C](O)F(8760)'],
