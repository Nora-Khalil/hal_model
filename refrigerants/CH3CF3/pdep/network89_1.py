...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(127)', '[CH2]CC(F)F(373)'],
    products = ['FOCCC(F)F(253)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]OF(222)', 'CHF2-CH2(64)'],
    products = ['FOCCC(F)F(253)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'FOC[CH]C(F)F(375)'],
    products = ['FOCCC(F)F(253)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'FO[CH]CC(F)F(376)'],
    products = ['FOCCC(F)F(253)'],
