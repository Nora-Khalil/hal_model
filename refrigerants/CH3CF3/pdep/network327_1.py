...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', '[CH2]O[CH]F(850)'],
    products = ['[CH2]OC(F)[C](F)F(997)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]OC=C(F)F(294)'],
    products = ['[CH2]OC(F)[C](F)F(997)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]OC(F)=C(F)F(1096)'],
    products = ['[CH2]OC(F)[C](F)F(997)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[CH2]O[CH]F(850)'],
    products = ['[CH2]OC(F)[C](F)F(997)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]OC(F)[C](F)F(997)'],
    products = ['[CH2]O[CH]C(F)(F)F(1099)'],
