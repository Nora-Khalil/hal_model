...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[C](F)F(163)', '[CH]F(804)'],
    products = ['[O]OC(F)(F)[CH]F(613)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]O[C](F)F(163)', 'CHF(40)'],
    products = ['[O]OC(F)(F)[CH]F(613)'],
    transitionState = 'TS9',
