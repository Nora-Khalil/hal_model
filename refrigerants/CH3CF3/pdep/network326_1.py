...
"""),
    E0 = (-499.588,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,334,575,1197,1424,3202,3000,3100,440,815,1455,1000,180,180,840.586],'cm^-1')),
        HinderedRotor(inertia=(0.00284455,'amu*angstrom^2'), symmetry=1, barrier=(13.4087,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.21511,'amu*angstrom^2'), symmetry=1, barrier=(27.9378,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.22093,'amu*angstrom^2'), symmetry=1, barrier=(28.0717,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37882,0.0598781,-6.9703e-05,4.10083e-08,-9.61126e-12,-59993.9,22.7], Tmin=(100,'K'), Tmax=(1034.12,'K')), NASAPolynomial(coeffs=[12.222,0.0179365,-8.86633e-06,1.78872e-09,-1.2987e-13,-62236.5,-29.9757], Tmin=(1034.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-499.588,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sO2s)(F1s)(H)) + radical(CsJOCH3)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.176351,'amu*angstrom^2'), symmetry=1, barrier=(4.05466,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.176396,'amu*angstrom^2'), symmetry=1, barrier=(4.0557,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', '[CH2]O[C](F)F(261)'],
    products = ['[CH2]OC(F)(F)[CH]F(996)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2]OC(F)=CF(853)'],
    products = ['[CH2]OC(F)(F)[CH]F(996)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(40)', '[CH2]O[C](F)F(261)'],
    products = ['[CH2]OC(F)(F)[CH]F(996)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]O[C](F)C(F)F(1097)'],
    products = ['[CH2]OC(F)(F)[CH]F(996)'],
