...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'CFO(51)'],
    products = ['[O]C(=O)F(459)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(=O)F(459)'],
    products = ['F[C]1OO1(1579)'],
    transitionState = 'TS2',
