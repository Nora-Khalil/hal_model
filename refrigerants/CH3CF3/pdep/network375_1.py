species(
    label = 'F[C](F)C(F)C(F)[C](F)F(1051)',
...
species(
    label = 'F[C](F)C(F)C(F)=C(F)F(1151)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C](F)C(F)[C](F)C(F)F(1153)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[C](F)[C](F)C(F)C(F)F(1154)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[C](F)C(F)[CH]C(F)(F)F(1155)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0383731,0.0960055,-0.000159624,1.40814e-07,-4.908e-11,-120719,30.6518], Tmin=(100,'K'), Tmax=(788.751,'K')), NASAPolynomial(coeffs=[10.7978,0.031113,-1.65741e-05,3.30391e-09,-2.33212e-13,-122095,-16.6662], Tmin=(788.751,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1004.83,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-F1sF1sF1s)(H)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = 'F[C](F)[CH]C(F)C(F)(F)F(1156)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0805224,0.0956945,-0.000161053,1.44455e-07,-5.10078e-11,-119511,32.0243], Tmin=(100,'K'), Tmax=(796.703,'K')), NASAPolynomial(coeffs=[10.0213,0.0325914,-1.74046e-05,3.46738e-09,-2.44457e-13,-120676,-11.0474], Tmin=(796.703,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-994.766,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(1051)'],
...
reaction(
    ...
    products = ['F[C](F)C(F)C(F)[C](F)F(1051)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(1051)'],
    products = ['FC(F)=C(F)C(F)C(F)F(1150)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[C](F)C(F)C=C(F)F(1057)'],
    products = ['F[C](F)C(F)C(F)[C](F)F(1051)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C](F)C(F)C(F)=C(F)F(1151)'],
    products = ['F[C](F)C(F)C(F)[C](F)F(1051)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F2(78)', 'F[C](F)C=C[C](F)F(1058)'],
    products = ['F[C](F)C(F)C(F)[C](F)F(1051)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', 'F[C](F)C=C(F)[C](F)F(1152)'],
    products = ['F[C](F)C(F)C(F)[C](F)F(1051)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(1051)'],
    products = ['F[C](F)C(F)[C](F)C(F)F(1153)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(1051)'],
    products = ['F[C](F)[C](F)C(F)C(F)F(1154)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(1051)'],
    products = ['F[C](F)C(F)[CH]C(F)(F)F(1155)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(1051)'],
    products = ['F[C](F)[CH]C(F)C(F)(F)F(1156)'],
...
network(
    label = 'PDepNetwork #375',
    isomers = [
        'F[C](F)C(F)C(F)[C](F)F(1051)',
    ],
    reactants = [
        ('CHFCF2(55)', 'CHFCF2(55)'),
    ],
