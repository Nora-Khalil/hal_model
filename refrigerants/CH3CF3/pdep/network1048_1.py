...
reaction(
    label = 'reaction2',
    reactants = ['CH3F(39)', 'F[C]COF(356)'],
    products = ['FCC(F)COF(2852)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'FCC(F)OF(1825)'],
    products = ['FCC(F)COF(2852)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H2(8)', 'F[C]C(F)COF(1395)'],
    products = ['FCC(F)COF(2852)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2(S)(25)', 'FOCC(F)F(340)'],
    products = ['FCC(F)COF(2852)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(F)COF(2857)'],
    products = ['FCC(F)COF(2852)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(127)', '[CH2]C(F)CF(2859)'],
    products = ['FCC(F)COF(2852)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]OF(222)', 'CH2F-CHF(66)'],
    products = ['FCC(F)COF(2852)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2F(46)', 'F[CH]COF(1400)'],
    products = ['FCC(F)COF(2852)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'FCC(F)[CH]OF(2860)'],
    products = ['FCC(F)COF(2852)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'F[CH]C(F)COF(1398)'],
    products = ['FCC(F)COF(2852)'],
