...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'O=C=C(F)OO(4404)'],
    products = ['COOC(F)=C=O(3941)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3O(27)', 'O=[C]C(=O)F(3886)'],
    products = ['COOC(F)=C=O(3941)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(19)', '[O]OC(F)=C=O(1388)'],
    products = ['COOC(F)=C=O(3941)'],
    transitionState = 'TS9',
