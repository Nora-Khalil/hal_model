...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[C]CF-2(587)'],
    products = ['CH2F-CF2(68)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction13',
    reactants = ['CH2F-CF2(68)'],
    products = ['CHF2-CHF(67)'],
    transitionState = 'TS8',
...
This reaction matched rate rule [R2F_Ext-1R!H-R_N-4R!H->C]
family: intra_halogen_migration"""),
)

reaction(
    label = 'reaction1',
    reactants = ['CF3(45)', 'CH2(T)(18)'],
    products = ['[CH2]C(F)(F)F(125)'],
