...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]OC(F)(F)[C]=CF(2975)'],
...
reaction(
    label = 'reaction3',
    reactants = ['O=[C]O[C](F)F(726)', '[C]=CF-2(1206)'],
    products = ['O=[C]OC(F)(F)[C]=CF(2975)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC(F)=C=CF(3467)'],
    products = ['O=[C]OC(F)(F)[C]=CF(2975)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C#CC(F)(F)O[C]=O(3468)'],
    products = ['O=[C]OC(F)(F)[C]=CF(2975)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['O=[C]OC(F)(F)[C]=CF(2975)'],
    products = ['O=[C]OC(F)(F)C=[C]F(3470)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=COC(F)(F)[C]=[C]F(3471)'],
    products = ['O=[C]OC(F)(F)[C]=CF(2975)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=[C]OC(F)(F)[C]=CF(2975)'],
    products = ['O=[C]OC(F)=C(F)[CH]F(3472)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]OC(F)(F)[C]=CF(2975)'],
    products = ['O=C(F)OC(F)=[C][CH]F(3473)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OC(F)(F)[C]=CF(2975)'],
    products = ['[CH]=C(F)C(F)(F)O[C]=O(3474)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=[C]C(F)(F)OC(=O)F(3475)'],
    products = ['O=[C]OC(F)(F)[C]=CF(2975)'],
