...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[O]C(O)[C](F)F(1412)'],
    products = ['[O]OC(O)[C](F)F(1341)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]OC(O)=C(F)F(1416)'],
    products = ['[O]OC(O)[C](F)F(1341)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]OC(O)[C](F)F(1341)'],
    products = ['OH(7)', 'O=C(O)[C](F)F(1418)'],
