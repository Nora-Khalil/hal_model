...
reaction(
    label = 'reaction8',
    reactants = ['OH(7)', '[CH2]C(=C)OF(7158)'],
    products = ['C=C(CO)OF(10017)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=C(C[O])OF(10121)'],
    products = ['C=C(CO)OF(10017)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(127)', 'C=[C]CO(10122)'],
    products = ['C=C(CO)OF(10017)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2OH(33)', 'C=[C]OF(1651)'],
    products = ['C=C(CO)OF(10017)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(=CO)OF(10123)'],
    products = ['C=C(CO)OF(10017)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH]=C(CO)OF(10124)'],
    products = ['C=C(CO)OF(10017)'],
