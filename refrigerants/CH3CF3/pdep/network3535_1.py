...
reaction(
    label = 'reaction2',
    reactants = ['H(5)', '[C]=C(F)OC(=O)O(13185)'],
    products = ['[CH]=C(F)OC(=O)O(9892)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]=C(F)OC(=O)O(9892)'],
    products = ['[O]C1(O)C=C(F)O1(13187)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)O(1570)', 'C2HF(58)'],
    products = ['[CH]=C(F)OC(=O)O(9892)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]=[C]OC(=O)O(2568)'],
    products = ['[CH]=C(F)OC(=O)O(9892)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O=[C]O(457)', '[CH]C(=O)F(3804)'],
    products = ['[CH]=C(F)OC(=O)O(9892)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(=O)O(1570)', '[CH]=[C]F(489)'],
    products = ['[CH]=C(F)OC(=O)O(9892)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', '[CH]=C(F)O[C]=O(921)'],
    products = ['[CH]=C(F)OC(=O)O(9892)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH]=C(F)OC([O])=O(4366)'],
    products = ['[CH]=C(F)OC(=O)O(9892)'],
