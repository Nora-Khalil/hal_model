...
"""),
    E0 = (-244.174,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,277,555,632,2750,2850,1437.5,1250,1305,750,350,401.669,402.734],'cm^-1')),
        HinderedRotor(inertia=(0.188329,'amu*angstrom^2'), symmetry=1, barrier=(21.5403,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.187628,'amu*angstrom^2'), symmetry=1, barrier=(21.5459,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188712,'amu*angstrom^2'), symmetry=1, barrier=(21.5564,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.0312,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80032,0.0347569,-9.89427e-07,-3.98278e-08,2.23076e-11,-29275.5,17.9374], Tmin=(100,'K'), Tmax=(917.177,'K')), NASAPolynomial(coeffs=[18.9223,-0.00407397,3.8995e-06,-7.74519e-10,4.90271e-14,-33923.8,-71.4041], Tmin=(917.177,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-244.174,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(Cs-OsOsHH)"""),
)
...
"""),
    E0 = (-16.7763,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,2750,2850,1437.5,1250,1305,750,350,464.421,464.823,464.928],'cm^-1')),
        HinderedRotor(inertia=(0.000781821,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.297488,'amu*angstrom^2'), symmetry=1, barrier=(45.4456,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
