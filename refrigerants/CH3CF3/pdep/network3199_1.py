...
"""),
    E0 = (-531.354,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,182,240,577,636,1210,1413,308.823,308.833],'cm^-1')),
    ...
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07811,0.0679038,-9.45587e-05,6.89859e-08,-2.00013e-11,-63805.2,22.6279], Tmin=(100,'K'), Tmax=(845.11,'K')), NASAPolynomial(coeffs=[11.2175,0.0199136,-9.38098e-06,1.79405e-09,-1.24914e-13,-65519,-24.5825], Tmin=(845.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-531.354,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + group(CdCFH) + radical(C=C(C)OJ)"""),
)

species(
    label = 'O=[C]C(F)=CC(F)F(12777)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49874,0.0614576,-7.92015e-05,5.63482e-08,-1.67757e-11,-66721.3,22.4516], Tmin=(100,'K'), Tmax=(804.593,'K')), NASAPolynomial(coeffs=[8.43539,0.0269729,-1.49128e-05,3.08101e-09,-2.24975e-13,-67837.6,-9.50574], Tmin=(804.593,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-555.454,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + group(Cds-CdsCsH) + group(CdCCF) + longDistanceInteraction_noncyclic(Cd(F)-CO) + group(Cds-O2d(Cds-Cds)H) + radical(COj(Cd-F1sCd)(O2d))"""),
)
...
"""),
    ...
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72702,0.0426409,-2.59298e-05,3.55846e-09,1.2483e-12,-58867,24.1597], Tmin=(100,'K'), Tmax=(1164.31,'K')), NASAPolynomial(coeffs=[12.4543,0.0171392,-7.70046e-06,1.49454e-09,-1.06572e-13,-62134.4,-32.5295], Tmin=(1164.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-490.179,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFF) + group(CsCCFH) + group(Cds-OdCsCs) + ring(Cyclobutanone) + radical(CCJCC=O) + longDistanceInteraction_cyclic(Cs(F)-CO) + longDistanceInteraction_cyclic(Cs(F)2-CO)"""),
)

species(
    label = 'O=C1C([CH]F)C1(F)F(12779)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.21535,'amu*angstrom^2'), symmetry=1, barrier=(27.9432,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.21557,'amu*angstrom^2'), symmetry=1, barrier=(27.9482,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92608,0.0505904,-5.50751e-05,3.11476e-08,-7.334e-12,-24673,19.2664], Tmin=(100,'K'), Tmax=(1001.8,'K')), NASAPolynomial(coeffs=[9.129,0.0218305,-1.20127e-05,2.49086e-09,-1.82693e-13,-26116.2,-15.4965], Tmin=(1001.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-205.73,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-CdsCsH) + group(CdCCF) + longDistanceInteraction_noncyclic(Cd(F)-CO) + group(Cds-O2d(Cds-Cds)H) + radical(Csj(Cd-CdH)(F1s)(H)) + radical(COj(Cd-F1sCd)(O2d))"""),
)

species(
    label = '[CH]=CC(F)(F)[C]=O(12781)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 F u0 p3 c0 {4,S}
3 O u0 p2 c0 {6,D}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.23203,'amu*angstrom^2'), symmetry=1, barrier=(28.3268,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23049,'amu*angstrom^2'), symmetry=1, barrier=(28.2914,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38738,0.0621428,-9.86193e-05,8.25369e-08,-2.73485e-11,-11299.3,23.0125], Tmin=(100,'K'), Tmax=(796.796,'K')), NASAPolynomial(coeffs=[9.30169,0.018574,-9.37418e-06,1.82174e-09,-1.26794e-13,-12438.7,-12.6072], Tmin=(796.796,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-94.6926,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCCJ=O) + radical(Cds_P)"""),
)

species(
    label = 'O=[C][C](F)F(1227)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 F u0 p3 c0 {4,S}
3 O u0 p2 c0 {5,D}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.16543,'amu*angstrom^2'), symmetry=1, barrier=(26.7954,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.16239,'amu*angstrom^2'), symmetry=1, barrier=(26.7256,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.998661,0.0731671,-0.000127645,1.12546e-07,-3.82384e-11,-33991.4,25.3483], Tmin=(100,'K'), Tmax=(840.215,'K')), NASAPolynomial(coeffs=[9.58962,0.0198945,-1.04488e-05,2.02914e-09,-1.39803e-13,-34998.2,-12.0033], Tmin=(840.215,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-283.462,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(CdCFH) + radical(CCCJ=O) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.5741,'amu*angstrom^2'), symmetry=1, barrier=(36.1916,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.047,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.364,0.0430412,-4.18408e-05,-5.62881e-09,2.92673e-11,-17453.6,18.4674], Tmin=(100,'K'), Tmax=(487.07,'K')), NASAPolynomial(coeffs=[6.41344,0.0215007,-1.15822e-05,2.33652e-09,-1.67089e-13,-17987,0.417558], Tmin=(487.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-145.548,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CdCddCF) + longDistanceInteraction_noncyclic(Cd(F)-CO) + group(Cds-O2d(Cds-Cds)H) + group(CdCddFH) + group(Cdd-CdsCds) + radical(CsCJ=O)"""),
)

species(
    label = 'C#CC(F)(F)[C]=O(12784)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {4,S}
2 F u0 p3 c0 {4,S}
3 O u0 p2 c0 {6,D}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.28606,'amu*angstrom^2'), symmetry=1, barrier=(29.5691,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27496,'amu*angstrom^2'), symmetry=1, barrier=(29.3139,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10868,0.0697752,-0.000111241,9.69072e-08,-3.37109e-11,-53233.2,24.1347], Tmin=(100,'K'), Tmax=(785.772,'K')), NASAPolynomial(coeffs=[8.52386,0.0251976,-1.31057e-05,2.58433e-09,-1.81588e-13,-54187.7,-8.50975], Tmin=(785.772,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-443.422,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(CdCFH) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'O=C(F)C(F)=C[CH]F(12357)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64067,0.0529168,-5.12381e-05,2.54038e-08,-5.13493e-12,-71801.4,21.8341], Tmin=(100,'K'), Tmax=(1172.78,'K')), NASAPolynomial(coeffs=[11.0871,0.020698,-1.00297e-05,1.9789e-09,-1.41458e-13,-74017.1,-25.2449], Tmin=(1172.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-597.69,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-CdsCsH) + group(CdCCF) + longDistanceInteraction_noncyclic(Cd(F)-CO) + group(COCFO) + radical(Csj(Cd-CdH)(F1s)(H))"""),
)

species(
    label = '[CH]=CC(F)(F)C(=O)F(12785)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.35438,'amu*angstrom^2'), symmetry=1, barrier=(31.1398,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.35351,'amu*angstrom^2'), symmetry=1, barrier=(31.1199,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29855,0.0663691,-9.29098e-05,6.47316e-08,-1.51988e-11,-61085.3,23.4703], Tmin=(100,'K'), Tmax=(607.965,'K')), NASAPolynomial(coeffs=[9.11537,0.0244225,-1.28135e-05,2.55707e-09,-1.81844e-13,-62211,-11.7927], Tmin=(607.965,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-508.646,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-CdsCsH) + group(COCsFO) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CO(13)', 'F[CH]C=C(F)F(1369)'],
    products = ['O=[C]C(F)(F)C=CF(9543)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(C=CF)=C(F)F(12776)'],
    products = ['O=[C]C(F)(F)C=CF(9543)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=[C]C(F)(F)C=CF(9543)'],
    products = ['O=[C]C(F)=CC(F)F(12777)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(192)', 'F[CH]C=C(F)F(1369)'],
    products = ['O=[C]C(F)(F)C=CF(9543)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O=[C]C(F)(F)C=CF(9543)'],
    products = ['O=C1C(F)[CH]C1(F)F(12778)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O=[C]C(F)(F)C=CF(9543)'],
    products = ['O=C1C([CH]F)C1(F)F(12779)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=C=C(F)C=CF(9533)'],
    products = ['O=[C]C(F)(F)C=CF(9543)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=[C]C(F)=C[CH]F(12780)'],
    products = ['O=[C]C(F)(F)C=CF(9543)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH]=CC(F)(F)[C]=O(12781)'],
    products = ['O=[C]C(F)(F)C=CF(9543)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C][C](F)F(1227)', 'CHFCH[Z](71)'],
    products = ['O=[C]C(F)(F)C=CF(9543)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=[C]C(F)(F)[C]=CF(7891)'],
    products = ['O=[C]C(F)(F)C=CF(9543)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=[C]C(F)(F)C=[C]F(12782)'],
    products = ['O=[C]C(F)(F)C=CF(9543)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'O=[C]C(F)=C=CF(12783)'],
    products = ['O=[C]C(F)(F)C=CF(9543)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'C#CC(F)(F)[C]=O(12784)'],
    products = ['O=[C]C(F)(F)C=CF(9543)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=[C]C(F)(F)C=CF(9543)'],
    products = ['O=C(F)C(F)=C[CH]F(12357)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=CC(F)(F)C(=O)F(12785)'],
    products = ['O=[C]C(F)(F)C=CF(9543)'],
