...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)OC1(F)[CH]O1(4005)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(138)', '[O]C1(F)[CH]O1(4091)'],
    products = ['F[C](F)OC1(F)[CH]O1(4005)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O=C[C](F)O[C](F)F(4092)'],
    products = ['F[C](F)OC1(F)[CH]O1(4005)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[C](F)OC1=CO1(4093)'],
    products = ['F[C](F)OC1(F)[CH]O1(4005)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CF2(43)', '[O]C1(F)[CH]O1(4091)'],
    products = ['F[C](F)OC1(F)[CH]O1(4005)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F[C](F)OC1(F)[CH]O1(4005)'],
    products = ['FC(F)(F)O[C]1[CH]O1(4094)'],
