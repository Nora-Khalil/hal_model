...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(790)', '[C]=C(976)'],
    products = ['C=[C]OC([O])=O(2269)'],
    transitionState = 'TS2',
