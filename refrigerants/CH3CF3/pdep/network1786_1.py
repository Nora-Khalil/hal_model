...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=CC(F)[C](F)F(6394)'],
    products = ['[CH]=CC(F)(F)[CH]F(6393)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', '[CH]C=C(F)F(2883)'],
    products = ['[CH]=CC(F)(F)[CH]F(6393)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH]=CC(F)=CF(6403)'],
    products = ['[CH]=CC(F)(F)[CH]F(6393)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#CC(F)(F)[CH]F(1114)'],
    products = ['[CH]=CC(F)(F)[CH]F(6393)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F[CH][C](F)F(588)', '[CH]=[CH](977)'],
    products = ['[CH]=CC(F)(F)[CH]F(6393)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', '[CH]C=C(F)F(2883)'],
    products = ['[CH]=CC(F)(F)[CH]F(6393)'],
