...
species(
    label = 'FC=C1C(F)C(F)(F)C1(F)F(3386)',
...
species(
    label = 'F[CH]C(F)(F)C(F)=C=CF(3394)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = 'C#CC(F)(F)C(F)(F)[CH]F(3395)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = 'FC#CC(F)(F)C(F)(F)[CH]F(3396)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[C]=CC(F)(F)C(F)(F)[CH]F(3398)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = 'F[C]=[C]C(F)(F)C(F)(F)CF(3399)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[CH][C](F)C(F)(F)C(F)=CF(3400)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = '[CH]=[C]C(F)(F)C(F)(F)C(F)F(3403)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = '[CH]=C(F)C(F)(F)C(F)(F)[CH]F(3404)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(804)', 'FC=[C]C(F)(F)[C](F)F(2512)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C]=CF(3040)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=CF-2(1206)', 'F[CH]C(F)(F)[C](F)F(1067)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C]=CF(3040)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.04495e+06,'m^3/(mol*s)'), n=0.382229, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_ter_rad;Birad]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction6',
    reactants = ['F[CH]C(F)(F)C(F)(F)[C]=CF(3040)'],
    products = ['FC=C1C(F)C(F)(F)C1(F)F(3386)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'FC=[C]C(F)(F)C(F)=CF(3393)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C]=CF(3040)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[CH]C(F)(F)C(F)=C=CF(3394)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C]=CF(3040)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C#CC(F)(F)C(F)(F)[CH]F(3395)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C]=CF(3040)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'FC#CC(F)(F)C(F)(F)[CH]F(3396)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C]=CF(3040)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(78)', 'F[CH]C(F)=C(F)[C]=CF(3397)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C]=CF(3040)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', 'FC=[C]C(F)(F)[C](F)F(2512)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C]=CF(3040)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)(F)C(F)(F)[C]=CF(3040)'],
    products = ['F[C]=CC(F)(F)C(F)(F)[CH]F(3398)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[C]=[C]C(F)(F)C(F)(F)CF(3399)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C]=CF(3040)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(F)(F)C(F)(F)[C]=CF(3040)'],
    products = ['F[CH][C](F)C(F)(F)C(F)=CF(3400)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH]C(F)(F)C(F)(F)[C]=CF(3040)'],
    products = ['F[CH][C]=C(F)C(F)(F)C(F)F(3401)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[CH]C(F)(F)C(F)(F)[C]=CF(3040)'],
    products = ['F[CH]C(F)(F)[C](F)C(F)=CF(3402)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=[C]C(F)(F)C(F)(F)C(F)F(3403)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C]=CF(3040)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]=C(F)C(F)(F)C(F)(F)[CH]F(3404)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C]=CF(3040)'],
