...
species(
    label = 'O[CH]C(F)(F)[CH]C(F)F(6921)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]CC(F)(F)[CH]C(F)F(6655)'],
...
reaction(
    ...
    products = ['[O]CC(F)(F)[CH]C(F)F(6655)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]C(F)F-2(957)', '[O]C[C](F)F(174)'],
    products = ['[O]CC(F)(F)[CH]C(F)F(6655)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]CC(F)=CC(F)F(6918)'],
    products = ['[O]CC(F)(F)[CH]C(F)F(6655)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=CC(F)(F)[CH]C(F)F(6652)'],
    products = ['[O]CC(F)(F)[CH]C(F)F(6655)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]CC(F)(F)C=C(F)F(6919)'],
    products = ['[O]CC(F)(F)[CH]C(F)F(6655)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[O]C=C(F)[CH]C(F)F(6920)'],
    products = ['[O]CC(F)(F)[CH]C(F)F(6655)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O[CH]C(F)(F)[CH]C(F)F(6921)'],
    products = ['[O]CC(F)(F)[CH]C(F)F(6655)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]CC(F)(F)[CH]C(F)F(6655)'],
    products = ['[O]CC(F)(F)C[C](F)F(6922)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]CC(F)(F)[CH]C(F)F(6655)'],
    products = ['[O][CH]C(F)(F)CC(F)F(6923)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]CC(F)(F)[CH]C(F)F(6655)'],
    products = ['OCC(F)(F)[CH][C](F)F(6924)'],
...
reaction(
    label = 'reaction20',
    reactants = ['FOC[C](F)[CH]C(F)F(6925)'],
    products = ['[O]CC(F)(F)[CH]C(F)F(6655)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C[C](F)C(F)C(F)F(6926)'],
    products = ['[O]CC(F)(F)[CH]C(F)F(6655)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[CH][CH]C(F)(F)COF(6927)'],
    products = ['[O]CC(F)(F)[CH]C(F)F(6655)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]CC(F)(F)C(F)[CH]F(6928)'],
    products = ['[O]CC(F)(F)[CH]C(F)F(6655)'],
