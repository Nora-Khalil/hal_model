...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(192)', '[O]C[C](F)F(174)'],
    products = ['O=[C]OC[C](F)F(631)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', '[CH2]O[C]=O(721)'],
    products = ['O=[C]OC[C](F)F(631)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OC=C(F)F(723)'],
    products = ['O=[C]OC[C](F)F(631)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[CH2]O[C]=O(721)'],
    products = ['O=[C]OC[C](F)F(631)'],
