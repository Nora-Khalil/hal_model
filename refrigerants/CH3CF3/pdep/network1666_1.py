...
"""),
    E0 = (-316.484,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([175,287,726,856,280,518,736,852,873,3010,987.5,1337.5,450,1655,350,440,435,1725,194,682,905,1196,1383,3221,180,180,2026.51],'cm^-1')),
        HinderedRotor(inertia=(0.248094,'amu*angstrom^2'), symmetry=1, barrier=(5.70417,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.05732,'amu*angstrom^2'), symmetry=1, barrier=(47.3018,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.247819,'amu*angstrom^2'), symmetry=1, barrier=(5.69785,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.231341,0.107284,-0.000198067,1.87149e-07,-6.74922e-11,-37925.6,29.7889], Tmin=(100,'K'), Tmax=(834.522,'K')), NASAPolynomial(coeffs=[8.38142,0.0372616,-2.05473e-05,4.06792e-09,-2.83376e-13,-38362.4,-4.20864], Tmin=(834.522,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-316.484,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(CdCCF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsCsCs) + group(CdCFH)"""),
)

species(
    label = 'FC=COC(OF)=C(F)F(6008)',
...
"""),
    E0 = (-551.911,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,194,682,905,1196,1383,3221,180,180,734.258,734.448],'cm^-1')),
        HinderedRotor(inertia=(0.140621,'amu*angstrom^2'), symmetry=1, barrier=(3.23316,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140565,'amu*angstrom^2'), symmetry=1, barrier=(3.23187,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14074,'amu*angstrom^2'), symmetry=1, barrier=(3.23588,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0639512,0.101971,-0.000191023,1.85876e-07,-6.853e-11,-66252.7,31.4154], Tmin=(100,'K'), Tmax=(838.706,'K')), NASAPolynomial(coeffs=[5.84743,0.0410346,-2.23874e-05,4.41619e-09,-3.07036e-13,-66049.7,11.5242], Tmin=(838.706,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-551.911,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2sCF) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)

species(
    label = 'FO[C]1OC(F)[CH]C1(F)F(6009)',
...
"""),
    E0 = (-529.091,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,487,638,688,1119,1325,1387,3149,2950,1000,347.118,1047.05,1047.05,1047.05,1047.05,1047.05,1047.05,1047.05,1047.05,1047.05,2287.96],'cm^-1')),
    ...
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0251015,0.0744524,-7.47749e-05,3.69117e-08,-6.95869e-12,-63478,28.3102], Tmin=(100,'K'), Tmax=(1418.77,'K')), NASAPolynomial(coeffs=[19.8224,0.012688,-3.33413e-06,4.57188e-10,-2.66726e-14,-68525.3,-72.3251], Tmin=(1418.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-529.091,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(CsCFHO) + ring(Tetrahydrofuran) + radical(CCJCO) + radical(Cs_P)"""),
)

species(
    label = '[O]C(OF)C(F)(F)[C]=CF(6010)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-376.507,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,136,307,446,511,682,757,1180,1185,1380,1390,370,380,2900,435,615,860,1140,1343,3152,1685,370,180,180,180,954.808],'cm^-1')),
        HinderedRotor(inertia=(0.208694,'amu*angstrom^2'), symmetry=1, barrier=(4.79827,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.208826,'amu*angstrom^2'), symmetry=1, barrier=(4.80133,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.209032,'amu*angstrom^2'), symmetry=1, barrier=(4.80606,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.161989,0.105125,-0.000192507,1.82339e-07,-6.63824e-11,-45146.6,34.0765], Tmin=(100,'K'), Tmax=(820.873,'K')), NASAPolynomial(coeffs=[8.34733,0.0374718,-2.10285e-05,4.20848e-09,-2.95634e-13,-45661.3,0.0779565], Tmin=(820.873,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-376.507,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCCFF) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(CdCFH) + radical(CCOJ) + radical(Cdj(Cs-F1sF1sCs)(Cd-F1sH))"""),
)

species(
    label = 'O[C](OF)C(F)(F)[C]=CF(6011)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.13685,'amu*angstrom^2'), symmetry=1, barrier=(3.14644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136864,'amu*angstrom^2'), symmetry=1, barrier=(3.14678,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136857,'amu*angstrom^2'), symmetry=1, barrier=(3.14662,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.705384,'amu*angstrom^2'), symmetry=1, barrier=(16.2182,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.455307,0.10819,-0.000188992,1.66949e-07,-5.74151e-11,-47593.3,34.9593], Tmin=(100,'K'), Tmax=(807.53,'K')), NASAPolynomial(coeffs=[12.806,0.0288089,-1.61047e-05,3.22169e-09,-2.26502e-13,-49288.6,-23.4197], Tmin=(807.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-396.965,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCCFF) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cs_P) + radical(Cdj(Cs-F1sF1sCs)(Cd-F1sH))"""),
)

species(
    label = '[O]C(OF)C(F)(F)C=[C]F(6012)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.220011,'amu*angstrom^2'), symmetry=1, barrier=(5.05849,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.220096,'amu*angstrom^2'), symmetry=1, barrier=(5.06044,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.234379,0.106999,-0.00019735,1.86164e-07,-6.72198e-11,-46240.5,33.2825], Tmin=(100,'K'), Tmax=(828.322,'K')), NASAPolynomial(coeffs=[8.72811,0.0364976,-2.03852e-05,4.06149e-09,-2.8415e-13,-46791.4,-2.63122], Tmin=(828.322,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-385.621,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCCFF) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(CdCFH) + radical(CCOJ) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'O[C](OF)C(F)(F)C=[C]F(6013)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-406.08,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,248,333,466,604,684,796,1061,1199,360,370,350,3010,987.5,1337.5,450,1655,167,640,1190,294.553,294.553],'cm^-1')),
        HinderedRotor(inertia=(0.128115,'amu*angstrom^2'), symmetry=1, barrier=(7.88779,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128115,'amu*angstrom^2'), symmetry=1, barrier=(7.88779,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128116,'amu*angstrom^2'), symmetry=1, barrier=(7.88779,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128115,'amu*angstrom^2'), symmetry=1, barrier=(7.88779,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.532868,0.110131,-0.00019409,1.71139e-07,-5.8421e-11,-48687,34.1835], Tmin=(100,'K'), Tmax=(819.62,'K')), NASAPolynomial(coeffs=[13.203,0.0278057,-1.5444e-05,3.07047e-09,-2.14659e-13,-50425,-26.2188], Tmin=(819.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-406.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCCFF) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cs_P) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.6997,'amu*angstrom^2'), symmetry=1, barrier=(39.0795,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.70159,'amu*angstrom^2'), symmetry=1, barrier=(39.123,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.70123,'amu*angstrom^2'), symmetry=1, barrier=(39.1147,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (139.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.743526,0.0785445,-0.000110968,8.48192e-08,-2.64593e-11,-46293.9,26.0006], Tmin=(100,'K'), Tmax=(778.161,'K')), NASAPolynomial(coeffs=[10.3585,0.0291169,-1.56832e-05,3.17999e-09,-2.2898e-13,-47790.1,-17.9735], Tmin=(778.161,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-385.832,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[O]C(=O)C(F)(F)C=CF(6016)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-733.522,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,364.331,364.331,364.331,364.332,364.332,364.332,364.332],'cm^-1')),
        HinderedRotor(inertia=(0.521165,'amu*angstrom^2'), symmetry=1, barrier=(49.0903,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.521165,'amu*angstrom^2'), symmetry=1, barrier=(49.0903,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (139.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01737,0.0742312,-0.000119515,1.13007e-07,-4.28192e-11,-88123.3,25.4432], Tmin=(100,'K'), Tmax=(781.889,'K')), NASAPolynomial(coeffs=[5.45471,0.0368712,-1.97194e-05,3.93872e-09,-2.79005e-13,-88369.1,7.99284], Tmin=(781.889,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-733.522,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(CdCFH) + radical(CCOJ)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.140793,0.0939673,-0.00015861,1.4153e-07,-4.98817e-11,-70454.8,29.0686], Tmin=(100,'K'), Tmax=(788.653,'K')), NASAPolynomial(coeffs=[10.2733,0.0310745,-1.71144e-05,3.42817e-09,-2.42257e-13,-71695.3,-15.1415], Tmin=(788.653,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-586.877,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(CdCFH) + radical(Cds_S)"""),
)

species(
    label = 'O=C(OF)C(F)(F)C=[C]F(6019)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (157.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.189295,0.0917849,-0.000149153,1.29127e-07,-4.47556e-11,-68978.9,28.9142], Tmin=(100,'K'), Tmax=(754.534,'K')), NASAPolynomial(coeffs=[10.9482,0.0298831,-1.64205e-05,3.30457e-09,-2.34918e-13,-70464,-19.043], Tmin=(754.534,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-574.601,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(CdCFH) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.138844,0.101306,-0.000168402,1.52444e-07,-5.48724e-11,-60768.2,39.8837], Tmin=(100,'K'), Tmax=(783.338,'K')), NASAPolynomial(coeffs=[9.47211,0.0382654,-2.09482e-05,4.19596e-09,-2.96963e-13,-61845.5,-1.4021], Tmin=(783.338,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-506.412,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCFHH) + group(Cds-OdCsOs) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)C(F)(F)C(=O)OF(6022)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0546476,0.0981448,-0.00015918,1.39733e-07,-4.94828e-11,-58504.9,29.5976], Tmin=(100,'K'), Tmax=(737.657,'K')), NASAPolynomial(coeffs=[10.7576,0.0344225,-1.92491e-05,3.91138e-09,-2.79932e-13,-59961.5,-18.3366], Tmin=(737.657,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-487.58,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCCFH) + group(Cds-OdCsOs) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    E0 = (-338.217,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,3010,987.5,1337.5,450,1655,113,247,382,1207,3490,540,610,2055,206.034,206.504,207.186,208.566,1583.54,1585.52,1585.85],'cm^-1')),
        HinderedRotor(inertia=(0.342895,'amu*angstrom^2'), symmetry=1, barrier=(10.8401,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44233,'amu*angstrom^2'), symmetry=1, barrier=(44.468,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (138.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.896582,0.0780736,-0.000139082,1.29491e-07,-4.6211e-11,-40575.8,26.6689], Tmin=(100,'K'), Tmax=(840.546,'K')), NASAPolynomial(coeffs=[7.16872,0.0283643,-1.49289e-05,2.90935e-09,-2.01102e-13,-40928.6,1.67252], Tmin=(840.546,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-338.217,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CdCddCF) + longDistanceInteraction_noncyclic(Cd(F)-CO) + group(Cds-O2d(Cds-Cds)O2s) + group(CdCddFH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'C#CC(F)(F)C(=O)OF(6025)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {4,S}
4  O u0 p2 c0 {3,S} {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.89141,'amu*angstrom^2'), symmetry=1, barrier=(43.4873,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.89145,'amu*angstrom^2'), symmetry=1, barrier=(43.4881,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.89158,'amu*angstrom^2'), symmetry=1, barrier=(43.4912,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (138.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.593052,0.080428,-0.000122954,9.80007e-08,-3.10339e-11,-56046.9,23.7425], Tmin=(100,'K'), Tmax=(775.04,'K')), NASAPolynomial(coeffs=[11.738,0.0229144,-1.16543e-05,2.27416e-09,-1.59119e-13,-57774.7,-27.1865], Tmin=(775.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-466.978,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsOs) + group(Ct-CtCs) + group(Ct-CtH)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.981747,0.0737182,-0.000124845,1.12804e-07,-4.05417e-11,-34139.3,22.8123], Tmin=(100,'K'), Tmax=(768.555,'K')), NASAPolynomial(coeffs=[8.64145,0.0255096,-1.44728e-05,2.93938e-09,-2.09635e-13,-35070.3,-10.5219], Tmin=(768.555,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-284.695,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsOs) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(OF)C(F)(F)C=CF(5927)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'FC=CC(F)(F)OF(354)'],
...
reaction(
    label = 'reaction3',
    reactants = ['O=C([C]F)OF(1478)', 'CHFCHF[Z](59)'],
    products = ['O=C(OF)C(F)(F)C=CF(5927)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FOF(328)', 'O=C=C(F)C=CF(6005)'],
    products = ['O=C(OF)C(F)(F)C=CF(5927)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O=C(OF)C(F)=CC(F)F(6006)'],
    products = ['O=C(OF)C(F)(F)C=CF(5927)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['FC=CC(F)=C(OF)OF(6007)'],
    products = ['O=C(OF)C(F)(F)C=CF(5927)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['FC=COC(OF)=C(F)F(6008)'],
    products = ['O=C(OF)C(F)(F)C=CF(5927)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['FO[C]1OC(F)[CH]C1(F)F(6009)'],
    products = ['O=C(OF)C(F)(F)C=CF(5927)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(OF)C(F)(F)[C]=CF(6010)'],
    products = ['O=C(OF)C(F)(F)C=CF(5927)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O[C](OF)C(F)(F)[C]=CF(6011)'],
    products = ['O=C(OF)C(F)(F)C=CF(5927)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(OF)C(F)(F)C=[C]F(6012)'],
    products = ['O=C(OF)C(F)(F)C=CF(5927)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[C](OF)C(F)(F)C=[C]F(6013)'],
    products = ['O=C(OF)C(F)(F)C=CF(5927)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'O=C(OF)[C](F)C=CF(6014)'],
    products = ['O=C(OF)C(F)(F)C=CF(5927)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[CH]=CC(F)(F)C(=O)OF(6015)'],
    products = ['O=C(OF)C(F)(F)C=CF(5927)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[O]C(=O)C(F)(F)C=CF(6016)'],
    products = ['O=C(OF)C(F)(F)C=CF(5927)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]F(127)', 'O=[C]C(F)(F)C=CF(6017)'],
    products = ['O=C(OF)C(F)(F)C=CF(5927)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=C(OF)[C](F)F(1487)', 'CHFCH[Z](71)'],
    products = ['O=C(OF)C(F)(F)C=CF(5927)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O=C(OF)C(F)(F)[C]=CF(6018)'],
    products = ['O=C(OF)C(F)(F)C=CF(5927)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C(OF)C(F)(F)C=[C]F(6019)'],
    products = ['O=C(OF)C(F)(F)C=CF(5927)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O=C(OF)C(F)(F)C=CF(5927)'],
    products = ['C2HF(58)', 'OC(OF)=C(F)F(6020)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O=C(OF)C(F)(F)[C]CF(6021)'],
    products = ['O=C(OF)C(F)(F)C=CF(5927)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]C(F)C(F)(F)C(=O)OF(6022)'],
    products = ['O=C(OF)C(F)(F)C=CF(5927)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O=C(OF)C(F)(F)C[C]F(6023)'],
    products = ['O=C(OF)C(F)(F)C=CF(5927)'],
...
reaction(
    label = 'reaction26',
    reactants = ['HF(38)', 'O=C(OF)C(F)=C=CF(6024)'],
    products = ['O=C(OF)C(F)(F)C=CF(5927)'],
...
reaction(
    label = 'reaction27',
    reactants = ['HF(38)', 'C#CC(F)(F)C(=O)OF(6025)'],
    products = ['O=C(OF)C(F)(F)C=CF(5927)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CHF(40)', '[CH]C(F)(F)C(=O)OF(6026)'],
    products = ['O=C(OF)C(F)(F)C=CF(5927)'],
...
network(
    label = 'PDepNetwork #1666',
    isomers = [
        'O=C(OF)C(F)(F)C=CF(5927)',
    ],
    reactants = [
