...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C[C]=O(1647)'],
...
reaction(
    label = 'reaction2',
    reactants = ['O=[C]CC[C](F)F(1648)'],
    products = ['[CH2]C(F)(F)C[C]=O(1647)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(F)(F)C(=C)[O](1643)'],
    products = ['[CH2]C(F)(F)C[C]=O(1647)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'O=[C]C[C](F)F(731)'],
    products = ['[CH2]C(F)(F)C[C]=O(1647)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(192)', '[CH2]C([CH2])(F)F(145)'],
    products = ['[CH2]C(F)(F)C[C]=O(1647)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CO(13)', '[CH2]C([CH2])(F)F(145)'],
    products = ['[CH2]C(F)(F)C[C]=O(1647)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=C(F)C[C]=O(1688)'],
    products = ['[CH2]C(F)(F)C[C]=O(1647)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2CF2(57)', '[CH2][C]=O(1002)'],
    products = ['[CH2]C(F)(F)C[C]=O(1647)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C](F)F(141)', 'CH2CO(28)'],
    products = ['[CH2]C(F)(F)C[C]=O(1647)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(F)(F)C=C=O(1689)'],
    products = ['[CH2]C(F)(F)C[C]=O(1647)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C](F)F(141)', '[CH2][C]=O(1002)'],
    products = ['[CH2]C(F)(F)C[C]=O(1647)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH2]C(F)=C[C]=O(1690)'],
    products = ['[CH2]C(F)(F)C[C]=O(1647)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)C=C[O](1691)'],
    products = ['[CH2]C(F)(F)C[C]=O(1647)'],
