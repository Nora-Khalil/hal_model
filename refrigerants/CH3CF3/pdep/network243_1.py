...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(804)', '[O]C[CH]F(861)'],
    products = ['[O]CC(F)[CH]F(833)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C(F)[CH]F(805)'],
    products = ['[O]CC(F)[CH]F(833)'],
    transitionState = 'TS3',
