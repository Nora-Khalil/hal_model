...
"""),
    ...
    molecularWeight = (127.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.437357,0.0564113,-5.73205e-05,2.76242e-08,-4.85023e-12,-40376.6,25.9569], Tmin=(100,'K'), Tmax=(1694.59,'K')), NASAPolynomial(coeffs=[15.9914,0.00512357,9.77582e-07,-3.85619e-10,3.06961e-14,-43555.7,-51.1125], Tmin=(1694.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-336.935,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2sCF) + group(Cs-OsOsOsH) + group(CsFHOO) + ring(124trioxolane) + radical(Cs_P)"""),
)

species(
    label = '[O]C1(OF)OC(F)O1(11253)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {8,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (127.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.3167,0.0542053,-0.000118072,1.41373e-07,-5.95575e-11,-58619.8,21.3216], Tmin=(100,'K'), Tmax=(842.296,'K')), NASAPolynomial(coeffs=[-5.63707,0.0471555,-2.56971e-05,5.08225e-09,-3.54229e-13,-55690,67.7671], Tmin=(842.296,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-487.758,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-OsOsOsOs) + group(CsFHOO) + ring(O2s-Cs-O2s-Cs(F)) + radical(OCOJ)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17142,0.0607566,-7.7163e-05,4.44646e-08,-9.7958e-12,-97337.2,25.0688], Tmin=(100,'K'), Tmax=(1120.08,'K')), NASAPolynomial(coeffs=[16.4827,0.0060766,-3.93533e-06,8.79295e-10,-6.75355e-14,-100767,-50.5356], Tmin=(1120.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-810.166,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(O2sCF) + group(Cds-OdOsOs) + group(COFOO)"""),
)
...
"""),
    ...
    molecularWeight = (126.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46123,0.0468006,-3.5789e-05,6.7572e-09,1.69317e-12,-52702.8,26.0555], Tmin=(100,'K'), Tmax=(1084.03,'K')), NASAPolynomial(coeffs=[16.143,0.0084226,-4.54279e-06,9.83839e-10,-7.55707e-14,-56814,-50.241], Tmin=(1084.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-439.02,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2sCF) + group(CsFHOO) + group(Cds-OdOsOs) + radical(O2sj(Cs-F1sO2sH)) + radical(CsF1sO2sO2s)"""),
)
...
"""),
    ...
    molecularWeight = (127.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36989,0.0591357,-6.85222e-05,3.85494e-08,-8.56816e-12,-78923.9,23.1435], Tmin=(100,'K'), Tmax=(1091.36,'K')), NASAPolynomial(coeffs=[13.3503,0.0152262,-8.17197e-06,1.68426e-09,-1.23446e-13,-81538.9,-35.7023], Tmin=(1091.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-656.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(O2s-(Cds-O2d)H) + group(CsFHOO) + group(Cds-OdOsOs) + radical(OC=OOJ)"""),
)

species(
    label = 'O=C(OF)O[CH]OF(11258)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {4,S}
3 O u0 p2 c0 {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (127.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.640092,0.0708997,-8.63966e-05,4.8398e-08,-1.03926e-11,-40941.4,24.7261], Tmin=(100,'K'), Tmax=(1148.03,'K')), NASAPolynomial(coeffs=[18.5575,0.00847064,-4.82704e-06,1.02983e-09,-7.73853e-14,-45055.4,-64.1886], Tmin=(1148.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-341.434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(O2sCF) + group(Cs-OsOsHH) + group(Cds-OdOsOs) + radical(OCJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'O=C(OF)O[CH]F(1864)'],
    products = ['[O]C(F)OC(=O)OF(9943)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C(F)OC(=O)OF(9943)'],
    products = ['[O]C1(OF)OC(F)O1(11253)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)OF(1866)', 'CHFO(47)'],
    products = ['[O]C(F)OC(=O)OF(9943)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'O=C(F)OC(=O)OF(11254)'],
    products = ['[O]C(F)OC(=O)OF(9943)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(=O)OC([O])F(2210)'],
    products = ['[O]C(F)OC(=O)OF(9943)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(=O)OF(1866)', '[O][CH]F(2815)'],
    products = ['[O]C(F)OC(=O)OF(9943)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]OF(458)', '[O]C([O])F(5649)'],
    products = ['[O]C(F)OC(=O)OF(9943)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(127)', '[O]C(F)O[C]=O(4933)'],
    products = ['[O]C(F)OC(=O)OF(9943)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O][C](F)OC(=O)OF(11256)'],
    products = ['[O]C(F)OC(=O)OF(9943)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C(F)OC(=O)OF(9943)'],
    products = ['F2(78)', 'CO2(14)', '[O]C=O(322)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=C(OF)O[CH]OF(11258)'],
    products = ['[O]C(F)OC(=O)OF(9943)'],
