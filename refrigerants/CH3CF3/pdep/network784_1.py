...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48428,0.0611929,-7.87938e-05,5.46555e-08,-1.3942e-11,-98967,21.5279], Tmin=(100,'K'), Tmax=(625.685,'K')), NASAPolynomial(coeffs=[7.89731,0.0270752,-1.34966e-05,2.65753e-09,-1.88334e-13,-99904.2,-7.48036], Tmin=(625.685,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-823.567,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(CsCFFO) + group(Cds-OdCsH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.06704,'amu*angstrom^2'), symmetry=1, barrier=(24.5334,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06721,'amu*angstrom^2'), symmetry=1, barrier=(24.5372,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06488,'amu*angstrom^2'), symmetry=1, barrier=(24.4838,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38193,0.0437449,-8.46214e-06,-3.49084e-08,2.05987e-11,-44341.3,20.8621], Tmin=(100,'K'), Tmax=(926.318,'K')), NASAPolynomial(coeffs=[19.3345,0.00196298,1.32112e-06,-2.97055e-10,1.62098e-14,-49200.6,-72.6515], Tmin=(926.318,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-369.565,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFHOO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CsF1sO2sO2s)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.09894,'amu*angstrom^2'), symmetry=1, barrier=(25.2668,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.1056,'amu*angstrom^2'), symmetry=1, barrier=(25.4199,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.066342,0.0701465,-7.91525e-05,4.00665e-08,-7.42191e-12,-67283,24.9491], Tmin=(100,'K'), Tmax=(1537.09,'K')), NASAPolynomial(coeffs=[22.4123,-0.000809522,2.25008e-06,-5.12907e-10,3.5844e-14,-72721.5,-88.373], Tmin=(1537.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-560.778,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFFOO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = 'C[C-]=[O+]C(O)(F)F(11228)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.77451,'amu*angstrom^2'), symmetry=1, barrier=(40.7995,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.7719,'amu*angstrom^2'), symmetry=1, barrier=(40.7395,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.77249,'amu*angstrom^2'), symmetry=1, barrier=(40.7531,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.956,0.0747214,-0.000120191,1.08115e-07,-3.83675e-11,-54399.9,32.8422], Tmin=(100,'K'), Tmax=(820.508,'K')), NASAPolynomial(coeffs=[7.12026,0.0311053,-1.5656e-05,3.0303e-09,-2.10118e-13,-54954.8,7.10522], Tmin=(820.508,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-453.155,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsFFOO) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]COC(O)(F)F(11229)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {5,S} {6,S}
4  O u0 p2 c0 {5,S} {11,S}
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.912631,0.0744136,-0.000118316,1.02647e-07,-3.54895e-11,-53372.9,23.4642], Tmin=(100,'K'), Tmax=(792.586,'K')), NASAPolynomial(coeffs=[8.89081,0.0266391,-1.36866e-05,2.68443e-09,-1.87988e-13,-54401.7,-11.6831], Tmin=(792.586,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-444.64,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsFFOO) + group(Cs-CsOsHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'C=CO[C](O)F(11226)'],
    products = ['C=COC(O)(F)F(1808)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O[C](F)F(206)', 'CH2CHO(35)'],
    products = ['C=COC(O)(F)F(1808)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(O)(F)F(445)', 'C2H3(29)'],
    products = ['C=COC(O)(F)F(1808)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(7)', 'C=CO[C](F)F(1925)'],
    products = ['C=COC(O)(F)F(1808)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=[C]OC(O)(F)F(8478)'],
    products = ['C=COC(O)(F)F(1808)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH]=COC(O)(F)F(11227)'],
    products = ['C=COC(O)(F)F(1808)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'C=COC(=O)F(6216)'],
    products = ['C=COC(O)(F)F(1808)'],
...
network(
    ...
    reactants = [
        ('CF2O(49)', 'CH3CHO(36)'),
        ('O[C](F)F(206)', 'CH2CHO(35)'),
        ('[O]C(O)(F)F(445)', 'C2H3(29)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
