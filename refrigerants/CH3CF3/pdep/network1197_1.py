...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'C=C=C[C]F(2783)'],
    products = ['C=C([O])C=[C]F(3140)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(T)(18)', 'O=C=C[C]F(931)'],
    products = ['C=C([O])C=[C]F(3140)'],
