...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', '[C-]=[O+]C#CF(3630)'],
    products = ['[C-]=[O+]C(F)(F)C#CF(2966)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C-]=[O+]F(3632)', 'F[C]C#CF(3631)'],
    products = ['[C-]=[O+]C(F)(F)C#CF(2966)'],
    transitionState = 'TS3',
