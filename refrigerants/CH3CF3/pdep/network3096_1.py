...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'FCC(F)(F)OF(343)'],
    products = ['FCCC(F)(F)OF(10244)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['FOF(328)', 'F[C]CCF(9059)'],
    products = ['FCCC(F)(F)OF(10244)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H2(8)', 'F[C]CC(F)(F)OF(342)'],
    products = ['FCCC(F)(F)OF(10244)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'FCC[C](F)OF(10350)'],
    products = ['FCCC(F)(F)OF(10244)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]CC(F)(F)OF(8946)'],
    products = ['FCCC(F)(F)OF(10244)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(F)(F)CCF(9062)'],
    products = ['FCCC(F)(F)OF(10244)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(127)', 'FCC[C](F)F(7766)'],
    products = ['FCCC(F)(F)OF(10244)'],
...
reaction(
    label = 'reaction12',
    reactants = ['FO[C](F)F(236)', 'CH2F-CH2(62)'],
    products = ['FCCC(F)(F)OF(10244)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH2F(46)', '[CH2]C(F)(F)OF(349)'],
    products = ['FCCC(F)(F)OF(10244)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'FC[CH]C(F)(F)OF(1829)'],
    products = ['FCCC(F)(F)OF(10244)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'F[CH]CC(F)(F)OF(346)'],
    products = ['FCCC(F)(F)OF(10244)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(78)', 'O=C(F)CCF(9065)'],
    products = ['FCCC(F)(F)OF(10244)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'FCC=C(F)OF(1835)'],
    products = ['FCCC(F)(F)OF(10244)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'C=CC(F)(F)OF(1836)'],
    products = ['FCCC(F)(F)OF(10244)'],
