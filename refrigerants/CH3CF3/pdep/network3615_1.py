...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH2]CC[O](2385)'],
    products = ['[CH2]CC(C)[O](13383)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C[CH]C(11937)'],
    products = ['[CH2]CC(C)[O](13383)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[CH2]C(C)[O](1830)'],
    products = ['[CH2]CC(C)[O](13383)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(19)', '[CH2]CC=O(2486)'],
    products = ['[CH2]CC(C)[O](13383)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]CC(C)=O(13454)'],
    products = ['[CH2]CC(C)[O](13383)'],
