...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.23702,'amu*angstrom^2'), symmetry=1, barrier=(28.4416,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'CC(F)(F)OF(323)'],
    products = ['O=CCC(F)(F)OF(8300)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['FOF(328)', 'O=CC[C]F(8461)'],
    products = ['O=CCC(F)(F)OF(8300)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(195)', 'O=CC=C(F)F(215)'],
    products = ['O=CCC(F)(F)OF(8300)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C[CH]C(F)(F)OF(8462)'],
    products = ['O=CCC(F)(F)OF(8300)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=CC[C](F)OF(8464)'],
    products = ['O=CCC(F)(F)OF(8300)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(F)(F)CC=O(8465)'],
    products = ['O=CCC(F)(F)OF(8300)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(127)', 'O=CC[C](F)F(304)'],
    products = ['O=CCC(F)(F)OF(8300)'],
...
reaction(
    label = 'reaction12',
    reactants = ['FO[C](F)F(236)', 'CH2CHO(35)'],
    products = ['O=CCC(F)(F)OF(8300)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HCO(15)', '[CH2]C(F)(F)OF(349)'],
    products = ['O=CCC(F)(F)OF(8300)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C=CC(F)(F)OF(8466)'],
    products = ['O=CCC(F)(F)OF(8300)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'O=[C]CC(F)(F)OF(8467)'],
    products = ['O=CCC(F)(F)OF(8300)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(78)', 'O=CCC(=O)F(6205)'],
    products = ['O=CCC(F)(F)OF(8300)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=CC=C(F)OF(8468)'],
    products = ['O=CCC(F)(F)OF(8300)'],
