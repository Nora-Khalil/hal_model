...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(F)F(1205)', '[CH]C(F)=CF(878)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(3022)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]=C(F)C(F)[C]=C(F)F(3022)'],
    products = ['C=C(F)C(F)=C=C(F)F(3455)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=C(F)C=C=C(F)F(3456)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(3022)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(F)C(F)=C=C(F)F(3457)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(3022)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C#CC(F)[C]=C(F)F(3458)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(3022)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH]=C(F)C(F)C#CF(3459)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(3022)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', '[CH]=C=C[C]=C(F)F(3460)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(3022)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH]=C=C(F)[C]=C(F)F(3461)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(3022)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=C(F)C(F)[C]=C(F)F(3022)'],
    products = ['[CH]C(F)=C(F)C=C(F)F(3462)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C(F)C(F)[C]=C(F)F(3022)'],
    products = ['[CH2]C(F)=C(F)[C]=C(F)F(3156)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=C(F)C(F)[C]=C(F)F(3022)'],
    products = ['[CH]C(F)=CC(F)=C(F)F(3463)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=C(F)C(F)[C]=C(F)F(3022)'],
    products = ['FC=C(F)[CH][C]=C(F)F(3410)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=[C]C(F)C(F)=C(F)F(3464)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(3022)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]=C(F)C(F)C(F)=[C]F(3465)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(3022)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C]=[C]C(F)C(F)=CF(3466)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(3022)'],
