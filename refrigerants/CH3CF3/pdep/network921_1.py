...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(=O)O(1583)', 'C2H3(29)'],
    products = ['C=COC(=O)O(2295)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH]=COC(=O)O(10124)'],
    products = ['C=COC(=O)O(2295)'],
