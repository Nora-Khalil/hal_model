...
"""),
    ...
    molecularWeight = (127.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31961,0.0603015,-0.000148966,1.89073e-07,-8.22684e-11,-65124,21.5549], Tmin=(100,'K'), Tmax=(832.878,'K')), NASAPolynomial(coeffs=[-10.4907,0.0591939,-3.4174e-05,6.90218e-09,-4.86564e-13,-60817.8,94.0558], Tmin=(832.878,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-541.785,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(CsFOOO) + group(Cs-OsOsOsH) + ring(O2s-Cs-O2s-Cs(F)) + radical(OCOJ)"""),
)
...
"""),
    E0 = (-707.29,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,482,664,788,1296,1923,249.126,4000],'cm^-1')),
        HinderedRotor(inertia=(0.296985,'amu*angstrom^2'), symmetry=1, barrier=(13.1976,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.301007,'amu*angstrom^2'), symmetry=1, barrier=(13.2037,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.52887,0.0335237,-3.63659e-05,1.95717e-08,-4.22048e-12,-85015.4,19.1009], Tmin=(100,'K'), Tmax=(1113.58,'K')), NASAPolynomial(coeffs=[8.89041,0.010673,-5.58602e-06,1.14479e-09,-8.36435e-14,-86432.2,-12.2743], Tmin=(1113.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-707.29,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(Cds-OdOsH) + group(COFOO)"""),
)

species(
    label = '[O][CH]OC(=O)OF(13018)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {6,S} {7,S}
3 O u0 p2 c0 {1,S} {6,S}
...
"""),
    E0 = (-572.418,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2782.5,750,1395,475,1775,1000,453.571,454.093,454.26,454.844],'cm^-1')),
        HinderedRotor(inertia=(0.000813162,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000815449,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.48893,0.0548424,-0.000136072,1.74638e-07,-7.66739e-11,-68812.7,19.0273], Tmin=(100,'K'), Tmax=(829.624,'K')), NASAPolynomial(coeffs=[-9.85872,0.0559769,-3.25342e-05,6.58861e-09,-4.65401e-13,-64754.2,88.4037], Tmin=(829.624,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-572.418,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2s-CsH) + group(CsFOOO) + group(Cds-OdOsH) + radical(OCOJ) + radical(OCOJ)"""),
)
...
"""),
    E0 = (-286.863,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,354.697,354.894,355.64],'cm^-1')),
        HinderedRotor(inertia=(0.00133195,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.48764,0.0583672,-0.000163523,2.0222e-07,-8.46655e-11,-34471.5,15.4996], Tmin=(100,'K'), Tmax=(852.406,'K')), NASAPolynomial(coeffs=[-9.27006,0.047557,-2.83855e-05,5.71628e-09,-3.99108e-13,-30069.9,84.4075], Tmin=(852.406,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-286.863,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(O2s-CsH) + group(CsFOOO) + radical(OCOJ) + radical(OCOJ)"""),
)
...
"""),
    E0 = (-368.271,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,482,664,788,1296,1923,497.099,497.124,497.273,497.36],'cm^-1')),
        HinderedRotor(inertia=(0.00981981,'amu*angstrom^2'), symmetry=1, barrier=(1.72018,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00980112,'amu*angstrom^2'), symmetry=1, barrier=(1.71912,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.34417,0.0440027,-8.09904e-05,8.40492e-08,-3.32784e-11,-44240.6,18.4979], Tmin=(100,'K'), Tmax=(811.049,'K')), NASAPolynomial(coeffs=[2.76147,0.0248094,-1.38022e-05,2.77253e-09,-1.95918e-13,-43744.7,20.0465], Tmin=(811.049,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-368.271,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(COFOO) + radical(OCOJ) + radical(OCJO)"""),
)
...
"""),
    E0 = (-468.86,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,1855,455,950,315.874,316.219,316.903,317.181],'cm^-1')),
        HinderedRotor(inertia=(0.693823,'amu*angstrom^2'), symmetry=1, barrier=(49.5996,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.698829,'amu*angstrom^2'), symmetry=1, barrier=(49.6008,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.692334,'amu*angstrom^2'), symmetry=1, barrier=(49.5969,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22632,0.0780008,-0.00016663,1.77844e-07,-6.96997e-11,-56307.4,22.5816], Tmin=(100,'K'), Tmax=(834.567,'K')), NASAPolynomial(coeffs=[0.954421,0.0386521,-2.2842e-05,4.61728e-09,-3.24683e-13,-54846.3,32.3259], Tmin=(834.567,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-468.86,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(O2s-CsH) + group(CsFOOO) + group(Cds-OdOsH) + radical(OCOJ) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (-478.323,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,180,180,180,897.583,897.642,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0589541,'amu*angstrom^2'), symmetry=1, barrier=(18.2187,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0318629,'amu*angstrom^2'), symmetry=1, barrier=(18.2189,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0268,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.47932,0.0325023,-3.32199e-05,1.64079e-08,-3.195e-12,-57473.4,19.9889], Tmin=(100,'K'), Tmax=(1239.84,'K')), NASAPolynomial(coeffs=[9.87762,0.0086336,-4.34259e-06,8.80426e-10,-6.40333e-14,-59308,-17.2941], Tmin=(1239.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-478.323,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(Cds-OdOsOs) + group(Cds-OdOsH) + radical(OC=OOJ)"""),
)
...
"""),
    E0 = (-277.489,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([504,610,1067,1155,360,370,350,2782.5,750,1395,475,1775,1000,180,180,180,1813.83],'cm^-1')),
        HinderedRotor(inertia=(0.190139,'amu*angstrom^2'), symmetry=1, barrier=(4.37167,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0136978,'amu*angstrom^2'), symmetry=1, barrier=(31.9804,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.3909,'amu*angstrom^2'), symmetry=1, barrier=(31.9796,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0136958,'amu*angstrom^2'), symmetry=1, barrier=(31.9776,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27026,0.0691027,-0.000123646,1.20974e-07,-4.64464e-11,-33284.7,25.5281], Tmin=(100,'K'), Tmax=(780.042,'K')), NASAPolynomial(coeffs=[5.67233,0.0302506,-1.76316e-05,3.61436e-09,-2.58832e-13,-33476.3,8.55868], Tmin=(780.042,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-277.489,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(O2sCF) + group(Cs-OsOsOsH) + group(Cds-OdOsH) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CO2(14)', '[O]C(F)OF(3080)'],
    products = ['[O]C(F)(OF)OC=O(12092)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'O=CO[C](F)OF(1982)'],
    products = ['[O]C(F)(OF)OC=O(12092)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)(OF)OC=O(12092)'],
    products = ['FOC1(F)O[CH]OO1(13022)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=COC(=O)OF(2160)'],
    products = ['[O]C(F)(OF)OC=O(12092)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O=C(F)OF(11661)', '[O]C=O(322)'],
    products = ['[O]C(F)(OF)OC=O(12092)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(127)', 'O=COC(=O)F(1985)'],
    products = ['[O]C(F)(OF)OC=O(12092)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O][CH]OC(=O)OF(13018)'],
    products = ['[O]C(F)(OF)OC=O(12092)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C([O])(F)OC=O(11187)'],
    products = ['[O]C(F)(OF)OC=O(12092)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O][C](F)OF(1580)', '[O]C=O(322)'],
    products = ['[O]C(F)(OF)OC=O(12092)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C([O])(F)OF(13024)', 'HCO(15)'],
    products = ['[O]C(F)(OF)OC=O(12092)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(127)', '[O][CH]OC(=O)F(3011)'],
    products = ['[O]C(F)(OF)OC=O(12092)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)(OF)O[C]=O(13025)'],
    products = ['[O]C(F)(OF)OC=O(12092)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(78)', '[O]C(=O)OC=O(2166)'],
    products = ['[O]C(F)(OF)OC=O(12092)'],
