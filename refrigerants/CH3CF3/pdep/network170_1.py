...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C([O])=O(628)'],
    products = ['[O]C(=O)C[C](F)F(629)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', '[CH2]C([O])=O(730)'],
    products = ['[O]C(=O)C[C](F)F(629)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(=O)C=C(F)F(736)'],
    products = ['[O]C(=O)C[C](F)F(629)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CO2(14)', '[CH2][C](F)F(141)'],
    products = ['[O]C(=O)C[C](F)F(629)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O][C]=O(722)', '[CH2][C](F)F(141)'],
    products = ['[O]C(=O)C[C](F)F(629)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', '[CH2]C([O])=O(730)'],
    products = ['[O]C(=O)C[C](F)F(629)'],
