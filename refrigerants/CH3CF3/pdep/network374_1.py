...
species(
    label = 'F[C](F)C(F)[C](F)C(F)F(1138)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[C](F)[CH]C(F)C(F)(F)F(1141)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0804911,0.095695,-0.000161054,1.44458e-07,-5.10092e-11,-119511,32.0244], Tmin=(100,'K'), Tmax=(796.693,'K')), NASAPolynomial(coeffs=[10.0214,0.0325913,-1.74045e-05,3.46736e-09,-2.44456e-13,-120676,-11.0477], Tmin=(796.693,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-994.766,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(1036)'],
...
reaction(
    ...
    products = ['F[C](F)C(F)C(F)[C](F)F(1036)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(1036)'],
    products = ['FC(F)=C(F)C(F)C(F)F(1135)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[C](F)C(F)C=C(F)F(1042)'],
    products = ['F[C](F)C(F)C(F)[C](F)F(1036)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C](F)C(F)C(F)=C(F)F(1136)'],
    products = ['F[C](F)C(F)C(F)[C](F)F(1036)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F2(78)', 'F[C](F)C=C[C](F)F(1043)'],
    products = ['F[C](F)C(F)C(F)[C](F)F(1036)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', 'F[C](F)C=C(F)[C](F)F(1137)'],
    products = ['F[C](F)C(F)C(F)[C](F)F(1036)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(1036)'],
    products = ['F[C](F)C(F)[C](F)C(F)F(1138)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(1036)'],
    products = ['F[C](F)C(F)[CH]C(F)(F)F(1140)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(1036)'],
    products = ['F[C](F)[CH]C(F)C(F)(F)F(1141)'],
