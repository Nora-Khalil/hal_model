...
"""),
    E0 = (-359.073,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,90,150,250,247,323,377,431,433,1065,1274,1691.58,1691.61,1691.61,1691.66,1691.66,1691.68],'cm^-1')),
        HinderedRotor(inertia=(5.89091e-05,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67619,0.0508439,-4.54639e-05,2.03314e-08,-3.67341e-12,-43102.9,20.9741], Tmin=(100,'K'), Tmax=(1305.77,'K')), NASAPolynomial(coeffs=[11.9744,0.0192974,-9.22529e-06,1.82974e-09,-1.31157e-13,-45792.3,-31.4565], Tmin=(1305.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-359.073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F))"""),
)
...
species(
    label = 'F[C](F)[C]1C(F)C1(F)F(9902)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = 'FC(F)(F)C1[CH]C1(F)F(9912)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (145.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.58119,0.0364492,4.5871e-05,-1.55125e-07,1.05377e-10,-107900,16.3094], Tmin=(10,'K'), Tmax=(569.238,'K')), NASAPolynomial(coeffs=[6.90513,0.0385578,-2.67899e-05,8.5626e-09,-1.02664e-12,-108691,-1.4778], Tmin=(569.238,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-897.172,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), label="""F[CH]C(F)DCC(F)(F)F""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = '[CH]C(F)(F)C=C(F)F(11233)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-391.065,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([274,345,380,539,705,1166,1213,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,426.502,426.716,1631.44,1631.44],'cm^-1')),
        HinderedRotor(inertia=(0.000926492,'amu*angstrom^2'), symmetry=1, barrier=(0.11964,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.074048,'amu*angstrom^2'), symmetry=1, barrier=(9.5607,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34324,0.0599777,-6.79961e-05,3.90815e-08,-8.94748e-12,-46939.8,23.0856], Tmin=(100,'K'), Tmax=(1058.23,'K')), NASAPolynomial(coeffs=[12.4062,0.0181606,-8.72161e-06,1.73929e-09,-1.25574e-13,-49281.2,-30.9128], Tmin=(1058.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-391.065,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCJ2_triplet)"""),
)
...
species(
    label = 'F[C]C(F)(F)C=C(F)F-2(11234)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-648.977,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,90,150,250,247,323,377,431,433,1065,1274,921.143],'cm^-1')),
        HinderedRotor(inertia=(0.00929972,'amu*angstrom^2'), symmetry=1, barrier=(29.0095,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00937071,'amu*angstrom^2'), symmetry=1, barrier=(29.0665,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.951012,0.0742678,-0.000113948,9.59441e-08,-3.3025e-11,-77950.9,19.3075], Tmin=(100,'K'), Tmax=(706.904,'K')), NASAPolynomial(coeffs=[9.13886,0.0279363,-1.56344e-05,3.22508e-09,-2.33991e-13,-79108.5,-17.354], Tmin=(706.904,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-648.977,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)

species(
    label = 'FC=C(F)C=C(F)F(3887)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-658.324,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([280,518,736,852,873,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,182,240,577,636,1210,1413,180],'cm^-1')),
        HinderedRotor(inertia=(0.546846,'amu*angstrom^2'), symmetry=1, barrier=(12.5731,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.73985,0.0183371,0.000166086,-4.71307e-07,3.72651e-10,-79175.2,12.8687], Tmin=(10,'K'), Tmax=(452.746,'K')), NASAPolynomial(coeffs=[6.29105,0.0361181,-2.64113e-05,8.85054e-09,-1.10361e-12,-79819.4,-1.98151], Tmin=(452.746,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-658.324,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), label="""FCDC(F)CDC(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (126.052,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(2993.78,'J/mol'), sigma=(5.18141,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=467.62 K, Pc=48.83 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06853,0.0718022,-0.000119141,1.0768e-07,-3.84219e-11,-42960.2,26.5695], Tmin=(100,'K'), Tmax=(796.87,'K')), NASAPolynomial(coeffs=[7.90697,0.0267145,-1.40128e-05,2.78214e-09,-1.96024e-13,-43708.4,-2.72542], Tmin=(796.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-358.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCd)(F1s)(H)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'F[CH]C(F)(F)[C]=C(F)F(3420)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-550.781,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([136,307,446,511,682,757,1180,1185,334,575,1197,1424,3202,562,600,623,1070,1265,1685,370,180,807.383],'cm^-1')),
        HinderedRotor(inertia=(0.185376,'amu*angstrom^2'), symmetry=1, barrier=(4.26215,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.179486,'amu*angstrom^2'), symmetry=1, barrier=(4.12674,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.888718,0.0769434,-0.000130693,1.2226e-07,-4.55176e-11,-66139.9,25.2488], Tmin=(100,'K'), Tmax=(767.175,'K')), NASAPolynomial(coeffs=[7.46265,0.0307978,-1.72601e-05,3.52112e-09,-2.52221e-13,-66799.3,-2.44773], Tmin=(767.175,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-550.781,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCd)(F1s)(H)) + radical(Cdj(Cs-F1sF1sCs)(Cd-F1sF1s))"""),
)

species(
    label = 'FC=C(F)[C]=C(F)F(11235)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {7,S}
...
"""),
    E0 = (-435.521,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([86,203,488,582,605,741,194,682,905,1196,1383,3221,562,600,623,1070,1265,1685,370,612.119],'cm^-1')),
        HinderedRotor(inertia=(0.148052,'amu*angstrom^2'), symmetry=1, barrier=(3.40401,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.62264,0.0449676,-4.44455e-05,2.24203e-08,-4.64137e-12,-52382.2,13.6041], Tmin=(10,'K'), Tmax=(1073.7,'K')), NASAPolynomial(coeffs=[9.05959,0.0247126,-1.61487e-05,4.85069e-09,-5.5048e-13,-53549.7,-13.0127], Tmin=(1073.7,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-435.521,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), label="""FCDC(F)[C]DC(F)F""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'FC#CC(F)(F)[CH]F(1091)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 F u0 p3 c0 {6,S}
...
"""),
    E0 = (-748.946,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([136,307,446,511,682,757,1180,1185,528,1116,1182,1331,1402,1494,3075,3110,562,600,623,1070,1265,1685,370,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.268069,'amu*angstrom^2'), symmetry=1, barrier=(6.16344,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.724247,'amu*angstrom^2'), symmetry=1, barrier=(16.6519,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.61036,0.0498181,0.00033836,-3.38771e-06,8.25937e-09,-90077.7,13.2424], Tmin=(10,'K'), Tmax=(158.644,'K')), NASAPolynomial(coeffs=[5.73883,0.0425506,-3.16378e-05,1.0734e-08,-1.35374e-12,-90203.6,5.05225], Tmin=(158.644,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-748.946,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), label="""FCC(F)(F)[C]DC(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    ...
    products = ['F[C](F)C(F)C=C(F)F(1042)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F[C](F)C(F)C=C(F)F(1042)'],
    products = ['F[CH]C(F)(F)C=C(F)F(1052)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C](F)C(F)C=C(F)F(1042)'],
    products = ['F[C](F)C=CC(F)(F)F(9347)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'F[C]C(F)C=C(F)F-2(9887)'],
    products = ['F[C](F)C(F)C=C(F)F(1042)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F[C](F)C(F)C=C(F)F(1042)'],
    products = ['F[C](F)C1C(F)C1(F)F(9346)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'FC(F)=CC=C(F)F(1582)'],
    products = ['F[C](F)C(F)C=C(F)F(1042)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'FC(F)=CC(F)=C(F)F(3655)'],
    products = ['F[C](F)C(F)C=C(F)F(1042)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'F[C](F)C=C[C](F)F(1043)'],
    products = ['F[C](F)C(F)C=C(F)F(1042)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'F[C]=CC(F)[C](F)F(1025)'],
    products = ['F[C](F)C(F)C=C(F)F(1042)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CF2CH(73)', 'F[CH][C](F)F(588)'],
    products = ['F[C](F)C(F)C=C(F)F(1042)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'F[C](F)C=C(F)[C](F)F(1137)'],
    products = ['F[C](F)C(F)C=C(F)F(1042)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'F[C](F)C(F)[C]=C(F)F(3149)'],
    products = ['F[C](F)C(F)C=C(F)F(1042)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'FC(F)=[C]C=C(F)F(9888)'],
    products = ['F[C](F)C(F)C=C(F)F(1042)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'FC#CC(F)[C](F)F(1083)'],
    products = ['F[C](F)C(F)C=C(F)F(1042)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F(37)', 'F[C]C(F)C=C(F)F(3653)'],
    products = ['F[C](F)C(F)C=C(F)F(1042)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C](F)C(F)C=C(F)F(1042)'],
    products = ['F[C](F)C=C(F)C(F)F(6623)'],
...
reaction(
    label = 'reaction20',
    reactants = ['FC(F)=[C]C(F)C(F)F(3060)'],
    products = ['F[C](F)C(F)C=C(F)F(1042)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[C]=CC(F)C(F)(F)F(6127)'],
    products = ['F[C](F)C(F)C=C(F)F(1042)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CHF(40)', 'F[C](F)C=C(F)F(1278)'],
    products = ['F[C](F)C1C(F)C1(F)F(9346)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F[C](F)C1C(F)C1(F)F(9346)'],
    products = ['FC1[CH]C(F)(F)C1(F)F(9608)'],
...
reaction(
    label = 'reaction25',
    reactants = ['F[C](F)C1C(F)C1(F)F(9346)'],
    products = ['FC1C(F)(F)[CH]C1(F)F(9898)'],
...
reaction(
    label = 'reaction26',
    reactants = ['F(37)', 'F[C]C1C(F)C1(F)F(9899)'],
    products = ['F[C](F)C1C(F)C1(F)F(9346)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F[C]F(138)', 'FC1[CH]C1(F)F(5918)'],
    products = ['F[C](F)C1C(F)C1(F)F(9346)'],
...
reaction(
    label = 'reaction28',
    reactants = ['F[CH]C(F)(F)C=C(F)F(1052)'],
    products = ['F[C](F)C1C(F)C1(F)F(9346)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(5)', 'FC(F)=C1C(F)C1(F)F(3033)'],
    products = ['F[C](F)C1C(F)C1(F)F(9346)'],
...
reaction(
    label = 'reaction30',
    reactants = ['F(37)', 'F[C](F)C1[C](F)C1F(9900)'],
    products = ['F[C](F)C1C(F)C1(F)F(9346)'],
...
reaction(
    label = 'reaction31',
    reactants = ['F(37)', 'F[C](F)C1[CH]C1(F)F(9901)'],
    products = ['F[C](F)C1C(F)C1(F)F(9346)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(5)', 'F[C](F)[C]1C(F)C1(F)F(9902)'],
    products = ['F[C](F)C1C(F)C1(F)F(9346)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(5)', 'F[C](F)C1[C](F)C1(F)F(9903)'],
    products = ['F[C](F)C1C(F)C1(F)F(9346)'],
...
reaction(
    label = 'reaction34',
    reactants = ['HF(38)', 'F[C](F)C1=C(F)C1F(9904)'],
    products = ['F[C](F)C1C(F)C1(F)F(9346)'],
...
reaction(
    label = 'reaction35',
    reactants = ['HF(38)', 'F[C](F)C1=CC1(F)F(9905)'],
    products = ['F[C](F)C1C(F)C1(F)F(9346)'],
...
reaction(
    label = 'reaction36',
    reactants = ['F2(78)', 'F[C](F)C1C=C1F(9906)'],
    products = ['F[C](F)C1C(F)C1(F)F(9346)'],
...
reaction(
    label = 'reaction37',
    reactants = ['HF(38)', 'F[C](F)C1C(F)=C1F(9907)'],
    products = ['F[C](F)C1C(F)C1(F)F(9346)'],
...
reaction(
    label = 'reaction38',
    reactants = ['F(37)', 'F[C]C1C(F)C1(F)F-2(9908)'],
    products = ['F[C](F)C1C(F)C1(F)F(9346)'],
...
reaction(
    label = 'reaction39',
    reactants = ['CF2(43)', 'FC1[CH]C1(F)F(5918)'],
    products = ['F[C](F)C1C(F)C1(F)F(9346)'],
...
reaction(
    label = 'reaction40',
    reactants = ['FC(F)[C]1C(F)C1(F)F(9909)'],
    products = ['F[C](F)C1C(F)C1(F)F(9346)'],
...
reaction(
    label = 'reaction42',
    reactants = ['F[C](F)C1C(F)C1(F)F(9346)'],
    products = ['F[C]1C(F)C1C(F)(F)F(9911)'],
...
reaction(
    label = 'reaction43',
    reactants = ['F[C](F)C1C(F)C1(F)F(9346)'],
    products = ['FC(F)(F)C1[CH]C1(F)F(9912)'],
...
reaction(
    label = 'reaction44',
    reactants = ['F[CH]C(F)(F)C=C(F)F(1052)'],
    products = ['F[CH]C(F)=CC(F)(F)F(11232)'],
    transitionState = 'TS44',
    kinetics = Arrhenius(A=(7.45932e+11,'s^-1'), n=0.63878, Ea=(267.457,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='F_Ext-2R!H-R',), comment="""Estimated from node F_Ext-2R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction45',
    reactants = ['F(37)', '[CH]C(F)(F)C=C(F)F(11233)'],
    products = ['F[CH]C(F)(F)C=C(F)F(1052)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH]F(804)', 'F[C](F)C=C(F)F(1278)'],
    products = ['F[CH]C(F)(F)C=C(F)F(1052)'],
...
reaction(
    label = 'reaction47',
    reactants = ['H(5)', 'F[C]C(F)(F)C=C(F)F-2(11234)'],
    products = ['F[CH]C(F)(F)C=C(F)F(1052)'],
...
reaction(
    label = 'reaction49',
    reactants = ['F(37)', 'FC=C(F)C=C(F)F(3887)'],
    products = ['F[CH]C(F)(F)C=C(F)F(1052)'],
    transitionState = 'TS49',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(51.4586,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(2.71972,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction51',
    reactants = ['F(37)', 'F[CH]C(F)=C[C](F)F(1053)'],
    products = ['F[CH]C(F)(F)C=C(F)F(1052)'],
...
reaction(
    label = 'reaction52',
    reactants = ['F(37)', 'F[C]=CC(F)(F)[CH]F(1024)'],
    products = ['F[CH]C(F)(F)C=C(F)F(1052)'],
...
reaction(
    label = 'reaction54',
    reactants = ['H(5)', 'F[CH]C(F)(F)[C]=C(F)F(3420)'],
    products = ['F[CH]C(F)(F)C=C(F)F(1052)'],
...
reaction(
    label = 'reaction55',
    reactants = ['HF(38)', 'FC=C(F)[C]=C(F)F(11235)'],
    products = ['F[CH]C(F)(F)C=C(F)F(1052)'],
    transitionState = 'TS55',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(218.808,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction56',
    reactants = ['HF(38)', 'FC#CC(F)(F)[CH]F(1091)'],
    products = ['F[CH]C(F)(F)C=C(F)F(1052)'],
    transitionState = 'TS56',
    kinetics = Arrhenius(A=(1.64483e+40,'m^3/(mol*s)'), n=-10.004, Ea=(279.138,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd"""),
)
...
reaction(
    label = 'reaction58',
    reactants = ['H(5)', 'F[C]C(F)(F)C=C(F)F(7534)'],
    products = ['F[CH]C(F)(F)C=C(F)F(1052)'],
    transitionState = 'TS58',
    kinetics = Arrhenius(A=(2.75,'m^3/(mol*s)'), n=-0.32, Ea=(7.90442,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->H_2Br1sCl1sF1s->F1s',), comment="""Estimated from node Root_3R->H_2Br1sCl1sF1s->F1s"""),
)

reaction(
    label = 'reaction59',
    reactants = ['FCC(F)(F)[C]=C(F)F(11236)'],
    products = ['F[CH]C(F)(F)C=C(F)F(1052)'],
    transitionState = 'TS59',
    kinetics = Arrhenius(A=(3.32e+09,'s^-1'), n=0.99, Ea=(141.419,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using an average for rate rule [R3H_SS_Cs;Cd_rad_out_Cd;Cs_H_out_1H]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.01526e+12,'s^-1'), n=0.18834, Ea=(159.047,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.00110172,'s^-1'), n=4.50663, Ea=(224.567,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R4F_Ext-4R!H-R',), comment="""Estimated from node R4F_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)
...
network(
    ...
    isomers = [
        'F[C](F)C(F)C=C(F)F(1042)',
        'F[C](F)C1C(F)C1(F)F(9346)',
        'F[CH]C(F)(F)C=C(F)F(1052)',
    ],
    reactants = [
