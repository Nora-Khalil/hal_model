...
reaction(
    label = 'reaction2',
    reactants = ['[O][C](F)C(=O)OF(794)'],
    products = ['[O]C(=O)C([O])(F)F(778)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(=O)C(=O)F(798)'],
    products = ['[O]C(=O)C([O])(F)F(778)'],
    transitionState = 'TS9',
