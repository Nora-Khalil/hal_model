...
"""),
    E0 = (-138.266,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,271,519,563,612,1379,234,589,736,816,1240,3237,3000,3100,440,815,1455,1000],'cm^-1')),
        HinderedRotor(inertia=(1.23077,'amu*angstrom^2'), symmetry=1, barrier=(28.2979,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0313573,'amu*angstrom^2'), symmetry=1, barrier=(56.3715,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0713,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83051,0.0450237,-3.73591e-05,1.5692e-08,-2.65542e-12,-16549.4,19.266], Tmin=(100,'K'), Tmax=(1395.88,'K')), NASAPolynomial(coeffs=[11.5347,0.0172155,-7.47655e-06,1.42017e-09,-9.93469e-14,-19258.6,-30.7878], Tmin=(1395.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-138.266,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cd-F1sCd)(H)(H)) + radical(Csj(Cd-CdH)(F1s)(H))"""),
)

species(
    label = '[CH2]C=C(F)[CH]F(3955)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {6,S}
3  C u0 p0 c0 {4,D} {5,S} {7,S}
...
"""),
    E0 = (-110.49,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,271,519,563,612,1379,3000,3100,440,815,1455,1000,234,589,736,816,1240,3237],'cm^-1')),
        HinderedRotor(inertia=(1.18679,'amu*angstrom^2'), symmetry=1, barrier=(41.9373,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00918823,'amu*angstrom^2'), symmetry=1, barrier=(41.9373,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0713,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87865,0.0434328,-3.47429e-05,1.40777e-08,-2.29918e-12,-13210,18.9196], Tmin=(100,'K'), Tmax=(1442.42,'K')), NASAPolynomial(coeffs=[11.4239,0.0169623,-7.21541e-06,1.35472e-09,-9.40236e-14,-15963.7,-30.6275], Tmin=(1442.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-110.49,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Allyl_P) + radical(Csj(Cd-CdF1s)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.218605,'amu*angstrom^2'), symmetry=1, barrier=(5.02616,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.218532,'amu*angstrom^2'), symmetry=1, barrier=(5.02448,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.220142,'amu*angstrom^2'), symmetry=1, barrier=(5.06149,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.895704,0.0797646,-0.000140276,1.36413e-07,-5.08949e-11,-42100.7,24.2377], Tmin=(100,'K'), Tmax=(829.841,'K')), NASAPolynomial(coeffs=[4.65743,0.0372317,-1.92882e-05,3.7826e-09,-2.63551e-13,-41884.9,11.8533], Tmin=(829.841,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-350.882,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-HHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = '[CH2]C(F)[C](F)CF(10173)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (110.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00483,0.051942,-3.61499e-05,-2.02401e-08,3.75056e-11,-42638.7,24.4041], Tmin=(100,'K'), Tmax=(488.27,'K')), NASAPolynomial(coeffs=[5.69929,0.0336362,-1.66547e-05,3.3074e-09,-2.36355e-13,-43142.1,7.76906], Tmin=(488.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-355.048,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-HHH)(H)) + radical(RCCJ)"""),
)

species(
    label = 'F[CH][CH]C(F)CF(10274)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)C(F)[CH]F(10223)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[CH]CC(F)[CH]F(10224)'],
    products = ['[CH2]C(F)C(F)[CH]F(10223)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[CH]C(F)[CH]F(885)'],
    products = ['[CH2]C(F)C(F)[CH]F(10223)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(804)', '[CH2]C(F)[CH]F(805)'],
    products = ['[CH2]C(F)C(F)[CH]F(10223)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=CC(F)[CH]F(5230)'],
    products = ['[CH2]C(F)C(F)[CH]F(10223)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F[CH][CH]F(811)', 'CH2CHF(56)'],
    products = ['[CH2]C(F)C(F)[CH]F(10223)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=C(F)C(F)[CH]F(822)'],
    products = ['[CH2]C(F)C(F)[CH]F(10223)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH2]C(F)C=CF(10290)'],
    products = ['[CH2]C(F)C(F)[CH]F(10223)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHFCHF[Z](59)', '[CH2][CH]F(1279)'],
    products = ['[CH2]C(F)C(F)[CH]F(10223)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(F)C(F)=CF(10291)'],
    products = ['[CH2]C(F)C(F)[CH]F(10223)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH][CH]F(811)', '[CH2][CH]F(1279)'],
    products = ['[CH2]C(F)C(F)[CH]F(10223)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F2(78)', '[CH2]C=C[CH]F(2946)'],
    products = ['[CH2]C(F)C(F)[CH]F(10223)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[CH2]C(F)=C[CH]F(823)'],
    products = ['[CH2]C(F)C(F)[CH]F(10223)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', '[CH2]C=C(F)[CH]F(3955)'],
    products = ['[CH2]C(F)C(F)[CH]F(10223)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CHF(40)', '[CH2]C(F)[CH]F(805)'],
    products = ['[CH2]C(F)C(F)[CH]F(10223)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C[C](F)C(F)[CH]F(10292)'],
    products = ['[CH2]C(F)C(F)[CH]F(10223)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F[CH]C(F)[CH]CF(10273)'],
    products = ['[CH2]C(F)C(F)[CH]F(10223)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(F)C(F)[CH]F(10223)'],
    products = ['[CH2][CH]C(F)C(F)F(3948)'],
...
reaction(
    label = 'reaction25',
    reactants = ['F[CH][CH]C(F)CF(10274)'],
    products = ['[CH2]C(F)C(F)[CH]F(10223)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(F)C(F)[CH]F(10223)'],
    products = ['[CH2]C(F)[CH]C(F)F(10159)'],
