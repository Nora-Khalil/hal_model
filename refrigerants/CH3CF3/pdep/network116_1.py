...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH]C(=O)F(537)'],
    products = ['[CH]=C(F)O[CH2](471)'],
    transitionState = 'TS2',
