...
species(
    label = '[O]C(CF)=C(F)[CH]C(F)F(7677)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {6,S}
4  F u0 p3 c0 {10,S}
5  O u1 p2 c0 {9,S}
6  C u0 p0 c0 {3,S} {9,S} {11,S} {12,S}
...
"""),
    E0 = (-735.994,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([212,931,1104,1251,1325,1474,3102,3155,522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,350,440,435,1725,271,519,563,612,1379,210.378,210.381,210.381,1489.61],'cm^-1')),
        HinderedRotor(inertia=(0.139226,'amu*angstrom^2'), symmetry=1, barrier=(4.37289,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139227,'amu*angstrom^2'), symmetry=1, barrier=(4.37289,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44966,'amu*angstrom^2'), symmetry=1, barrier=(45.5312,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (156.078,'amu'),
...
species(
    label = 'C=C(O)C(F)(F)C=C(F)F(7599)',
...
species(
    label = 'FC(F)[CH]C(F)(F)[C]1CO1(7679)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = '[O][C]1CC(C(F)F)C1(F)F(7680)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-588.877,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,194,682,905,1196,1383,3221,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.25682,'amu*angstrom^2'), symmetry=1, barrier=(28.8969,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25744,'amu*angstrom^2'), symmetry=1, barrier=(28.9111,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (137.08,'amu'),
...
species(
    label = 'C=C([O])C(F)(F)C=C(F)F(7683)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-789.908,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,182,240,577,636,1210,1413,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.26538,'amu*angstrom^2'), symmetry=1, barrier=(29.0937,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25941,'amu*angstrom^2'), symmetry=1, barrier=(28.9564,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'C=C([O])C(F)(F)C[C](F)F(7684)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = '[CH]=C(O)C(F)(F)[CH]C(F)F(7685)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = '[CH]=C([O])C(F)(F)CC(F)F(7686)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'C=C(O)C(F)(F)[CH][C](F)F(7687)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = '[CH2]C(OF)=C(F)[CH]C(F)F(7688)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'C=C([O])[C](F)C(F)C(F)F(7689)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = 'C=C(OF)C(F)(F)[CH][CH]F(7690)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = 'C=C([O])C(F)(F)C(F)[CH]F(7691)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
species(
    label = 'O=[C]CC(F)(F)[CH]C(F)F(7591)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'O=C1CC(C(F)F)C1(F)F(7605)',
...
species(
    label = '[CH2][C]1OC(C(F)F)C1(F)F(7692)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'CC(=O)C(F)(F)[CH][C](F)F(7693)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = 'O=C(CF)C(F)(F)[CH][CH]F(7694)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(CF)=C(F)[CH]C(F)F(7677)'],
    products = ['C=C([O])C(F)(F)[CH]C(F)F(7587)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]C(F)F-2(957)', '[CH2]C(=O)[C](F)F(1724)'],
    products = ['C=C([O])C(F)(F)[CH]C(F)F(7587)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'C=[C]C(F)(F)[CH]C(F)F(7678)'],
    products = ['C=C([O])C(F)(F)[CH]C(F)F(7587)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['C=C([O])C(F)(F)[CH]C(F)F(7587)'],
    products = ['C=C(O)C(F)(F)C=C(F)F(7599)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C=C([O])C(F)(F)[CH]C(F)F(7587)'],
    products = ['FC(F)[CH]C(F)(F)[C]1CO1(7679)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C=C([O])C(F)(F)[CH]C(F)F(7587)'],
    products = ['[O][C]1CC(C(F)F)C1(F)F(7680)'],
    transitionState = 'TS9',
...
reaction(
    ...
    kinetics = Arrhenius(A=(6.73316e+11,'s^-1'), n=0.231216, Ea=(182.685,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_csHNd]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 181.5 to 182.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C([O])C(F)=CC(F)F(7681)'],
    products = ['C=C([O])C(F)(F)[CH]C(F)F(7587)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'C=C([O])C(F)(F)C=CF(7682)'],
    products = ['C=C([O])C(F)(F)[CH]C(F)F(7587)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C=C([O])C(F)(F)C=C(F)F(7683)'],
    products = ['C=C([O])C(F)(F)[CH]C(F)F(7587)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C=C([O])C(F)(F)C[C](F)F(7684)'],
    products = ['C=C([O])C(F)(F)[CH]C(F)F(7587)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=C(O)C(F)(F)[CH]C(F)F(7685)'],
    products = ['C=C([O])C(F)(F)[CH]C(F)F(7587)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=C([O])C(F)(F)CC(F)F(7686)'],
    products = ['C=C([O])C(F)(F)[CH]C(F)F(7587)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C=C(O)C(F)(F)[CH][C](F)F(7687)'],
    products = ['C=C([O])C(F)(F)[CH]C(F)F(7587)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(OF)=C(F)[CH]C(F)F(7688)'],
    products = ['C=C([O])C(F)(F)[CH]C(F)F(7587)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C=C([O])C(F)(F)[CH]C(F)F(7587)'],
    products = ['C=C([O])[C](F)C(F)C(F)F(7689)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C=C(OF)C(F)(F)[CH][CH]F(7690)'],
    products = ['C=C([O])C(F)(F)[CH]C(F)F(7587)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C=C([O])C(F)(F)C(F)[CH]F(7691)'],
    products = ['C=C([O])C(F)(F)[CH]C(F)F(7587)'],
...
reaction(
    label = 'reaction3',
    reactants = ['C=C([O])C(F)(F)[CH]C(F)F(7587)'],
    products = ['O=[C]CC(F)(F)[CH]C(F)F(7591)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(T)(18)', 'O=[C]C(F)(F)[CH]C(F)F(7091)'],
    products = ['C=C([O])C(F)(F)[CH]C(F)F(7587)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C=C([O])C(F)(F)[CH]C(F)F(7587)'],
    products = ['O=C1CC(C(F)F)C1(F)F(7605)'],
...
reaction(
    label = 'reaction28',
    reactants = ['C=C([O])C(F)(F)[CH]C(F)F(7587)'],
    products = ['CC(=O)C(F)(F)C=C(F)F(7600)'],
...
reaction(
    label = 'reaction29',
    reactants = ['C=C([O])C(F)(F)[CH]C(F)F(7587)'],
    products = ['[CH2][C]1OC(C(F)F)C1(F)F(7692)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CC(=O)C(F)(F)[CH][C](F)F(7693)'],
    products = ['C=C([O])C(F)(F)[CH]C(F)F(7587)'],
...
reaction(
    label = 'reaction31',
    reactants = ['O=C(CF)C(F)(F)[CH][CH]F(7694)'],
    products = ['C=C([O])C(F)(F)[CH]C(F)F(7587)'],
...
network(
    label = 'PDepNetwork #2129',
    isomers = [
        'C=C([O])C(F)(F)[CH]C(F)F(7587)',
    ],
    reactants = [
