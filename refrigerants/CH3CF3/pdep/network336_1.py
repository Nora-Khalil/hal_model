...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', '[CH2]C[CH2](1185)'],
    products = ['[CH2]CC[C](F)F(1006)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]CC=C(F)F(1189)'],
    products = ['[CH2]CC[C](F)F(1006)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['CF2(43)', '[CH2]C[CH2](1185)'],
    products = ['[CH2]CC[C](F)F(1006)'],
