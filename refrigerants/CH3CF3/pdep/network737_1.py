...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH2]C[O](300)'],
    products = ['[CH2]CC[O](1765)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][O](194)', '[CH2][CH2](979)'],
    products = ['[CH2]CC[O](1765)'],
