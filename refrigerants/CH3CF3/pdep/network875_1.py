...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'OOOC[C]F(2230)'],
    products = ['OOOC[C](F)F(2223)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', '[CH2]OOO(199)'],
    products = ['OOOC[C](F)F(2223)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['HO2(11)', '[O]C[C](F)F(174)'],
    products = ['OOOC[C](F)F(2223)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'OOO[CH][C](F)F(657)'],
    products = ['OOOC[C](F)F(2223)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'OOOC[C]F-2(2231)'],
    products = ['OOOC[C](F)F(2223)'],
