...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)C(F)[CH]F(876)'],
    products = ['CHFCHF[Z](59)', 'CHFCHF[Z](59)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(804)', 'F[CH]C(F)[CH]F(899)'],
    products = ['F[CH]C(F)C(F)[CH]F(876)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[CH]C(F)C=CF(902)'],
    products = ['F[CH]C(F)C(F)[CH]F(876)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHFCHF[Z](59)', 'F[CH][CH]F(811)'],
    products = ['F[CH]C(F)C(F)[CH]F(876)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[CH]C(F)C(F)=CF(903)'],
    products = ['F[CH]C(F)C(F)[CH]F(876)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[CH][CH]F(811)', 'F[CH][CH]F(811)'],
    products = ['F[CH]C(F)C(F)[CH]F(876)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F2(78)', 'F[CH]C=C[CH]F(904)'],
    products = ['F[CH]C(F)C(F)[CH]F(876)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'F[CH]C=C(F)[CH]F(891)'],
    products = ['F[CH]C(F)C(F)[CH]F(876)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', 'F[CH]C(F)[CH]F(899)'],
    products = ['F[CH]C(F)C(F)[CH]F(876)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]C(F)C(F)[CH]F(876)'],
    products = ['F[CH]C(F)[CH]C(F)F(813)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[CH]C(F)C(F)[CH]F(876)'],
    products = ['F[CH][CH]C(F)C(F)F(906)'],
...
network(
    ...
    isomers = [
        'F[CH]C(F)C(F)[CH]F(876)',
    ],
    reactants = [
        ('CHFCHF[Z](59)', 'CHFCHF[Z](59)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
