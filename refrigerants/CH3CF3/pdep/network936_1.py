...
species(
    label = '[O]C1([O])C(F)(F)C1(F)F(2527)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(=O)C(F)(F)[C](F)F(2307)'],
...
reaction(
    label = 'reaction2',
    reactants = ['O=C(OF)[C](F)[C](F)F(2524)'],
    products = ['[O]C(=O)C(F)(F)[C](F)F(2307)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', '[O]C(=O)[C](F)F(739)'],
    products = ['[O]C(=O)C(F)(F)[C](F)F(2307)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'O=[C]C(F)(F)[C](F)F(1744)'],
    products = ['[O]C(=O)C(F)(F)[C](F)F(2307)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(=O)C(F)(F)[C](F)F(2307)'],
    products = ['O=C1OC(F)(F)C1(F)F(2309)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)C(F)(F)[C](F)F(2307)'],
    products = ['F[C](F)C(F)(F)[C]1OO1(2525)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)C(F)(F)[C](F)F(2307)'],
    products = ['[O][C]1OC(F)(F)C1(F)F(2526)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)C(F)(F)[C](F)F(2307)'],
    products = ['[O]C1([O])C(F)(F)C1(F)F(2527)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(=O)C(F)=C(F)F(1307)'],
    products = ['[O]C(=O)C(F)(F)[C](F)F(2307)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CO2(14)', 'F[C](F)[C](F)F(1586)'],
    products = ['[O]C(=O)C(F)(F)[C](F)F(2307)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O][C]=O(722)', 'F[C](F)[C](F)F(1586)'],
    products = ['[O]C(=O)C(F)(F)[C](F)F(2307)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CF2(43)', '[O]C(=O)[C](F)F(739)'],
    products = ['[O]C(=O)C(F)(F)[C](F)F(2307)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C(=O)C(F)(F)[C](F)F(2307)'],
    products = ['[O]C(=O)[C](F)C(F)(F)F(2528)'],
