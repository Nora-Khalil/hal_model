...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(192)', '[CH2]C([O])=O(730)'],
    products = ['[O]C(=O)C[C]=O(2270)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]C(=O)C=C=O(2727)'],
    products = ['[O]C(=O)C[C]=O(2270)'],
