...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.5581,'amu*angstrom^2'), symmetry=1, barrier=(35.8237,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.55783,'amu*angstrom^2'), symmetry=1, barrier=(35.8176,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15765,0.0709012,-0.000130225,1.18592e-07,-4.10115e-11,-23992.1,22.2369], Tmin=(100,'K'), Tmax=(855.089,'K')), NASAPolynomial(coeffs=[8.47131,0.0196883,-1.0565e-05,2.04858e-09,-1.40277e-13,-24621.3,-8.2681], Tmin=(855.089,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-200.266,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Ct-CtCs) + group(CJ2_singlet-FCs) + group(CtCF)"""),
)

species(
    label = 'OC(F)(C#CF)C(F)(F)F(3865)',
...
"""),
    ...
    molecularWeight = (160.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.143083,0.098509,-0.000164853,1.3836e-07,-4.51487e-11,-119801,27.2649], Tmin=(100,'K'), Tmax=(825.522,'K')), NASAPolynomial(coeffs=[13.7223,0.0228103,-1.1834e-05,2.292e-09,-1.58073e-13,-121800,-35.2118], Tmin=(825.522,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-997.261,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + group(Ct-CtCs) + group(CtCF)"""),
)

species(
    label = 'FC#CC(F)=C(F)F(3866)',
    structure = adjacencyList("""1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {6,S}
4 F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.152094,'amu*angstrom^2'), symmetry=1, barrier=(3.49694,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.486815,'amu*angstrom^2'), symmetry=1, barrier=(11.1928,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.270358,0.0935573,-0.00017486,1.59653e-07,-5.49412e-11,-65907.3,27.317], Tmin=(100,'K'), Tmax=(866.255,'K')), NASAPolynomial(coeffs=[9.8917,0.024634,-1.30959e-05,2.51583e-09,-1.70695e-13,-66655.1,-12.4141], Tmin=(866.255,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-549.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + group(Ct-CtCs) + group(CtCF) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'OC(F)(F)C(F)=C=[C]F(3868)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-613.87,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,275,321,533,585,746,850,1103,145,326,398,834,1303,540,610,2055,137,207,812,1544.47],'cm^-1')),
        HinderedRotor(inertia=(0.324254,'amu*angstrom^2'), symmetry=1, barrier=(7.45524,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.321868,'amu*angstrom^2'), symmetry=1, barrier=(7.40037,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.366302,0.0878142,-0.000151912,1.31644e-07,-4.39761e-11,-73708.2,26.6956], Tmin=(100,'K'), Tmax=(842.605,'K')), NASAPolynomial(coeffs=[11.5293,0.0218521,-1.13984e-05,2.20273e-09,-1.51222e-13,-75129,-22.5156], Tmin=(842.605,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-613.87,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(CdCddCF) + group(CdCddFH) + group(Cdd-CdsCds) + radical(Cdj(Cdd-Cd)(F1s))"""),
)

species(
    label = '[C]#CC(F)(F)C(O)(F)F(3869)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.319539,'amu*angstrom^2'), symmetry=1, barrier=(7.34683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.6484,'amu*angstrom^2'), symmetry=1, barrier=(60.8919,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.31938,'amu*angstrom^2'), symmetry=1, barrier=(7.34318,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.142355,0.0931256,-0.00016382,1.39558e-07,-4.48863e-11,-63538.8,25.9991], Tmin=(100,'K'), Tmax=(897.989,'K')), NASAPolynomial(coeffs=[12.6949,0.0187604,-8.7802e-06,1.57502e-09,-1.01699e-13,-65049.3,-29.067], Tmin=(897.989,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-529.382,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Ct-CtCs) + group(Ct-CtH) + radical(Acetyl)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.522384,'amu*angstrom^2'), symmetry=1, barrier=(12.0106,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0159467,'amu*angstrom^2'), symmetry=1, barrier=(44.291,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[C]=C(F)C(F)(F)C(O)(F)F(3870)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.03755,'amu*angstrom^2'), symmetry=1, barrier=(23.8554,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03887,'amu*angstrom^2'), symmetry=1, barrier=(23.8856,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.553538,0.110194,-0.000196312,1.71372e-07,-5.76153e-11,-103300,28.3237], Tmin=(100,'K'), Tmax=(828.212,'K')), NASAPolynomial(coeffs=[14.2149,0.0240742,-1.35452e-05,2.68789e-09,-1.87107e-13,-105239,-37.0787], Tmin=(828.212,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-860.168,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CdCCF) + group(CdJ2_singlet-Cds)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.57773,'amu*angstrom^2'), symmetry=1, barrier=(36.2752,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.56328,'amu*angstrom^2'), symmetry=1, barrier=(35.9428,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (140.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.83225,0.0787846,-0.000142302,1.29439e-07,-4.49497e-11,-82829.3,24.6445], Tmin=(100,'K'), Tmax=(848.527,'K')), NASAPolynomial(coeffs=[8.79095,0.0232861,-1.24079e-05,2.41104e-09,-1.65748e-13,-83532.6,-8.63006], Tmin=(848.527,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-689.558,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(COCsFO) + group(Ct-CtCs) + group(CtCF)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)C(F)(F)C#CF(3017)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'OC(F)(F)C#CF(3826)'],
    products = ['OC(F)(F)C(F)(F)C#CF(3017)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C2F2(60)', 'OC(F)(F)[C]F(426)'],
    products = ['OC(F)(F)C(F)(F)C#CF(3017)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['OC(F)(F)F(248)', 'F[C]C#CF(3631)'],
    products = ['OC(F)(F)C(F)(F)C#CF(3017)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(195)', 'F[C]C(F)(F)C#CF(3864)'],
    products = ['OC(F)(F)C(F)(F)C#CF(3017)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OC(F)(F)C(F)(F)C#CF(3017)'],
    products = ['OC(F)(C#CF)C(F)(F)F(3865)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OF(195)', 'FC#CC(F)=C(F)F(3866)'],
    products = ['OC(F)(F)C(F)(F)C#CF(3017)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O[C](F)C(F)(F)C#CF(3867)'],
    products = ['OC(F)(F)C(F)(F)C#CF(3017)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'OC(F)(F)C(F)=C=[C]F(3868)'],
    products = ['OC(F)(F)C(F)(F)C#CF(3017)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[C]#CC(F)(F)C(O)(F)F(3869)'],
    products = ['OC(F)(F)C(F)(F)C#CF(3017)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', 'FC#CC(F)(F)[C](F)F(2510)'],
    products = ['OC(F)(F)C(F)(F)C#CF(3017)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[C](F)F(206)', 'F[C]=C=C(F)F(2804)'],
    products = ['OC(F)(F)C(F)(F)C#CF(3017)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[C]#CF(467)', 'OC(F)(F)[C](F)F(438)'],
    products = ['OC(F)(F)C(F)(F)C#CF(3017)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[C]=C(F)C(F)(F)C(O)(F)F(3870)'],
    products = ['OC(F)(F)C(F)(F)C#CF(3017)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=C(F)C(F)(F)C#CF(3871)'],
    products = ['OC(F)(F)C(F)(F)C#CF(3017)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(78)', 'OC(F)=C(F)C#CF(3872)'],
    products = ['OC(F)(F)C(F)(F)C#CF(3017)'],
