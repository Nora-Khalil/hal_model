...
species(
    label = 'FC1C(F)(F)C(F)C1(F)F(1153)',
...
species(
    label = 'F[CH][C](F)C(F)C(F)(F)F(1161)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(138)', 'F[CH]C(F)(F)[CH]F(1129)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(1035)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(804)', 'F[C](F)C(F)[C](F)F(1057)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(1035)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(1035)'],
    products = ['FC1C(F)(F)C(F)C1(F)F(1153)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(1035)'],
    products = ['FCC(F)(F)C(F)=C(F)F(1154)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'F[CH]C(F)(F)C=C(F)F(1052)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(1035)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[CH]C(F)(F)C(F)=C(F)F(1155)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(1035)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FC=C(F)C(F)[C](F)F(1122)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(1035)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', 'F[CH]C(F)=C[C](F)F(1053)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(1035)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', 'F[CH]C(F)(F)[CH]F(1129)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(1035)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', 'F[C](F)C(F)[C](F)F(1057)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(1035)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(1035)'],
    products = ['FCC(F)(F)[C](F)[C](F)F(1158)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(1035)'],
    products = ['F[CH]C(F)(F)[CH]C(F)(F)F(1159)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(1035)'],
    products = ['F[C](F)[CH]C(F)(F)C(F)F(1160)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(1035)'],
    products = ['F[CH][C](F)C(F)C(F)(F)F(1161)'],
