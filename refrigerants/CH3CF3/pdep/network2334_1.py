...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'F[C]OC(F)(F)F(8751)'],
    products = ['F[C](F)OC(F)(F)F(747)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C](F)O[C](F)F(280)'],
    products = ['F[C](F)OC(F)(F)F(747)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[C-]=[O+]C(F)(F)F(8752)'],
    products = ['F[C](F)OC(F)(F)F(747)'],
    transitionState = 'TS7',
