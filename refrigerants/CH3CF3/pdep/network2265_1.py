...
"""),
    E0 = (-1056.47,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,232,360,932,1127,1349,1365,3045,435,565,619,662,854,1178,1396,2782.5,750,1395,475,1775,1000,243.335,243.516,243.846,244.257],'cm^-1')),
        HinderedRotor(inertia=(0.880495,'amu*angstrom^2'), symmetry=1, barrier=(36.781,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.343249,'amu*angstrom^2'), symmetry=1, barrier=(14.4505,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.238451,'amu*angstrom^2'), symmetry=1, barrier=(9.91892,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.877796,'amu*angstrom^2'), symmetry=1, barrier=(36.7871,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.169371,0.0918755,-0.000129134,9.39631e-08,-2.75001e-11,-126933,28.518], Tmin=(100,'K'), Tmax=(831.597,'K')), NASAPolynomial(coeffs=[13.2084,0.0291584,-1.60094e-05,3.27521e-09,-2.37236e-13,-129101,-31.9833], Tmin=(831.597,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1056.47,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFFOO) + group(Cds-OdCsH)"""),
)
...
"""),
    E0 = (-929.217,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,435,565,619,662,854,1178,1396,548,1085,1183,1302,1466,1520,3060,3119,216.839,216.839,216.839,216.839],'cm^-1')),
        HinderedRotor(inertia=(0.306674,'amu*angstrom^2'), symmetry=1, barrier=(10.2324,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.347847,'amu*angstrom^2'), symmetry=1, barrier=(11.6062,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.982292,'amu*angstrom^2'), symmetry=1, barrier=(32.7747,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.34376,0.103228,-0.000128259,7.18209e-08,-1.50224e-11,-86914.8,31.6182], Tmin=(100,'K'), Tmax=(1252.41,'K')), NASAPolynomial(coeffs=[29.1844,0.000561317,8.88293e-07,-2.17668e-10,1.47911e-14,-94156.6,-120.917], Tmin=(1252.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-724.353,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(O2sCF) + group(CsFFOO) + group(Cds-CdsOsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'FC=COOC(F)(F)OF(8048)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
4  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.886875,'amu*angstrom^2'), symmetry=1, barrier=(20.391,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.664471,'amu*angstrom^2'), symmetry=1, barrier=(15.2775,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.84619,'amu*angstrom^2'), symmetry=1, barrier=(42.4476,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.84543,'amu*angstrom^2'), symmetry=1, barrier=(42.4301,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.107608,0.0937581,-0.000132808,9.77171e-08,-2.89914e-11,-87981.9,30.2312], Tmin=(100,'K'), Tmax=(819.773,'K')), NASAPolynomial(coeffs=[13.0884,0.0304216,-1.69199e-05,3.47597e-09,-2.5226e-13,-90110.2,-29.8143], Tmin=(819.773,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-732.629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2sCF) + group(CsFFOO) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)

species(
    label = '[O]C[C](F)OC(F)(F)OF(8049)',
...
"""),
    ...
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.426295,0.1136,-0.000216649,2.07166e-07,-7.49001e-11,-87235.2,32.833], Tmin=(100,'K'), Tmax=(842.111,'K')), NASAPolynomial(coeffs=[8.19762,0.0383244,-2.14485e-05,4.24825e-09,-2.95173e-13,-87471,-0.0667626], Tmin=(842.111,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-726.509,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2sCF) + group(CsCFHO) + group(Cs-CsOsHH) + group(CsFFOO) + radical(CCOJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'OC=C(F)OC(F)(F)OF(8050)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.34609,'amu*angstrom^2'), symmetry=1, barrier=(30.9493,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34724,'amu*angstrom^2'), symmetry=1, barrier=(30.9756,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34555,'amu*angstrom^2'), symmetry=1, barrier=(30.9368,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.54263,0.0929309,-0.00010776,5.45161e-08,-9.98582e-12,-88860.7,31.2937], Tmin=(100,'K'), Tmax=(1576.35,'K')), NASAPolynomial(coeffs=[29.7171,-0.0059432,4.93055e-06,-1.01105e-09,6.83421e-14,-96286.7,-126.038], Tmin=(1576.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-740.696,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(O2s-(Cds-Cd)H) + group(CsFFOO) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ)"""),
)

species(
    label = 'O=CC(F)O[C](F)OF(8052)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-618.161,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,232,360,932,1127,1349,1365,3045,2782.5,750,1395,475,1775,1000,482,586,761,1411,230.194,230.62,231.865,232.445],'cm^-1')),
        HinderedRotor(inertia=(0.00957486,'amu*angstrom^2'), symmetry=1, barrier=(18.8136,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.342392,'amu*angstrom^2'), symmetry=1, barrier=(12.8728,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08721,'amu*angstrom^2'), symmetry=1, barrier=(41.3617,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08654,'amu*angstrom^2'), symmetry=1, barrier=(41.3523,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.73991,0.0783476,-0.00010726,7.74078e-08,-2.26529e-11,-74236.1,27.9925], Tmin=(100,'K'), Tmax=(829.109,'K')), NASAPolynomial(coeffs=[11.343,0.0271947,-1.47179e-05,2.99837e-09,-2.16847e-13,-75994.4,-21.1744], Tmin=(829.109,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-618.161,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFHOO) + group(Cds-OdCsH) + radical(CsF1sO2sO2s)"""),
)

species(
    label = '[O]C(F)(F)OC(F)C=O(8053)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-924.466,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([232,360,932,1127,1349,1365,3045,375,486,586,623,710,938,1161,1294,2782.5,750,1395,475,1775,1000,188.841,188.85,1191.25],'cm^-1')),
        HinderedRotor(inertia=(1.46271,'amu*angstrom^2'), symmetry=1, barrier=(36.9831,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.4065,'amu*angstrom^2'), symmetry=1, barrier=(10.3023,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.724517,'amu*angstrom^2'), symmetry=1, barrier=(18.3224,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0009,0.0697342,-8.00859e-05,4.66635e-08,-1.09673e-11,-111083,26.2509], Tmin=(100,'K'), Tmax=(1023.77,'K')), NASAPolynomial(coeffs=[12.8504,0.0234373,-1.22539e-05,2.49278e-09,-1.81184e-13,-113509,-31.1947], Tmin=(1023.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-924.466,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFFOO) + group(Cds-OdCsH) + radical(O2sj(Cs-F1sF1sO2s))"""),
)

species(
    label = '[O]C(F)(F)OF(666)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {4,S}
...
"""),
    E0 = (-766.033,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([232,360,932,1127,1349,1365,3045,2782.5,750,1395,475,1775,1000,493,600,700,1144,1293,180,180,1684.03],'cm^-1')),
        HinderedRotor(inertia=(0.39667,'amu*angstrom^2'), symmetry=1, barrier=(9.12023,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.39534,'amu*angstrom^2'), symmetry=1, barrier=(9.08964,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.75416,'amu*angstrom^2'), symmetry=1, barrier=(40.3315,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70719,0.0599947,-6.31703e-05,3.96262e-10,3.51707e-11,-92059.7,23.5536], Tmin=(100,'K'), Tmax=(497.021,'K')), NASAPolynomial(coeffs=[7.87751,0.0270943,-1.44526e-05,2.8878e-09,-2.04824e-13,-92880,-3.98306], Tmin=(497.021,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-766.033,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFFHO) + group(Cds-OdCsH) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
"""),
    E0 = (-917.244,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,435,565,619,662,854,1178,1396,280,501,1494,1531,2782.5,750,1395,475,1775,1000,180,180,180,293.45],'cm^-1')),
        HinderedRotor(inertia=(0.111042,'amu*angstrom^2'), symmetry=1, barrier=(2.55306,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.95426,'amu*angstrom^2'), symmetry=1, barrier=(44.9323,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.95393,'amu*angstrom^2'), symmetry=1, barrier=(44.9248,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.95302,'amu*angstrom^2'), symmetry=1, barrier=(44.9037,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.220179,0.0909484,-0.000145754,1.2512e-07,-4.32125e-11,-110190,28.5309], Tmin=(100,'K'), Tmax=(739.524,'K')), NASAPolynomial(coeffs=[10.9103,0.0302015,-1.66057e-05,3.34759e-09,-2.38475e-13,-111691,-19.2764], Tmin=(739.524,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-917.244,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFFOO) + group(Cds-OdCsH) + radical(CsCOF1sO2s)"""),
)

species(
    label = 'O=[C]C(F)OC(F)(F)OF(8056)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.481708,'amu*angstrom^2'), symmetry=1, barrier=(11.0754,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.481902,'amu*angstrom^2'), symmetry=1, barrier=(11.0799,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.793619,'amu*angstrom^2'), symmetry=1, barrier=(18.2469,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.93017,'amu*angstrom^2'), symmetry=1, barrier=(44.3785,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.429704,0.106719,-0.00018672,1.6167e-07,-5.41754e-11,-107845,30.3206], Tmin=(100,'K'), Tmax=(821.41,'K')), NASAPolynomial(coeffs=[13.9576,0.0242511,-1.3467e-05,2.6678e-09,-1.85933e-13,-109790,-33.7115], Tmin=(821.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-897.929,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFFOO) + group(Cds-OdCsH) + radical(COj(Cs-F1sO2sH)(O2d))"""),
)
...
"""),
    E0 = (-925.459,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([232,360,932,1127,1349,1365,3045,2782.5,750,1395,475,1775,1000,482,664,788,1296,1923,285.398,285.794,285.929],'cm^-1')),
        HinderedRotor(inertia=(0.537092,'amu*angstrom^2'), symmetry=1, barrier=(31.1637,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.353272,'amu*angstrom^2'), symmetry=1, barrier=(20.4341,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0193254,'amu*angstrom^2'), symmetry=1, barrier=(31.1649,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.19307,'amu*angstrom^2'), symmetry=1, barrier=(27.4311,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19673,'amu*angstrom^2'), symmetry=1, barrier=(27.5151,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19727,'amu*angstrom^2'), symmetry=1, barrier=(27.5275,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.177492,0.0842303,-0.000105712,5.90523e-08,-1.20813e-11,-84115.5,25.7685], Tmin=(100,'K'), Tmax=(1019.74,'K')), NASAPolynomial(coeffs=[23.1168,0.00290405,-8.628e-07,1.68038e-10,-1.3927e-14,-89388.8,-89.6298], Tmin=(1019.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-700.683,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + missing(O2d-Cdd) + group(CsFFOO) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.21142,0.012097,9.7814e-06,-1.9424e-08,7.43517e-12,-27169,10.3065], Tmin=(100,'K'), Tmax=(1055.82,'K')), NASAPolynomial(coeffs=[7.25796,0.00942887,-4.41735e-06,9.0029e-10,-6.68823e-14,-28729.3,-12.7778], Tmin=(1055.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-226.17,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), label="""glyoxal""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=CC(F)OC(F)(F)OF(7914)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'FCOC(F)(F)OF(5767)'],
    products = ['O=CC(F)OC(F)(F)OF(7914)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C[C](F)OC(F)(F)OF(8049)'],
    products = ['O=CC(F)OC(F)(F)OF(7914)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OC=C(F)OC(F)(F)OF(8050)'],
    products = ['O=CC(F)OC(F)(F)OF(7914)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C=COC(F)(F)OF(8051)'],
    products = ['O=CC(F)OC(F)(F)OF(7914)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=CC(F)O[C](F)OF(8052)'],
    products = ['O=CC(F)OC(F)(F)OF(7914)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C(F)(F)OC(F)C=O(8053)'],
    products = ['O=CC(F)OC(F)(F)OF(7914)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(F)(F)OF(666)', 'O=C[CH]F(1410)'],
    products = ['O=CC(F)OC(F)(F)OF(7914)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FO[C](F)F(236)', '[O]C(F)C=O(4285)'],
    products = ['O=CC(F)OC(F)(F)OF(7914)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(127)', 'O=CC(F)O[C](F)F(8054)'],
    products = ['O=CC(F)OC(F)(F)OF(7914)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HCO(15)', 'F[CH]OC(F)(F)OF(664)'],
    products = ['O=CC(F)OC(F)(F)OF(7914)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'O=C[C](F)OC(F)(F)OF(8055)'],
    products = ['O=CC(F)OC(F)(F)OF(7914)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'O=[C]C(F)OC(F)(F)OF(8056)'],
    products = ['O=CC(F)OC(F)(F)OF(7914)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F2(78)', 'O=CC(F)OC(=O)F(8057)'],
    products = ['O=CC(F)OC(F)(F)OF(7914)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=C=COC(F)(F)OF(8031)'],
    products = ['O=CC(F)OC(F)(F)OF(7914)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=CC(F)OC(F)(F)OF(7914)'],
    products = ['F2(78)', 'CF2O(49)', 'O=CC=O(211)'],
