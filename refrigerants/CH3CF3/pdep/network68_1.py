...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(276)', 'CH2(T)(18)'],
    products = ['[CH2]OC([O])(F)F(235)'],
    transitionState = 'TS2',
