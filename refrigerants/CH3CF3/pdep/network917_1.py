...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CO[C]=O(775)'],
    products = ['CC([O])O[C]=O(2291)'],
    transitionState = 'TS2',
