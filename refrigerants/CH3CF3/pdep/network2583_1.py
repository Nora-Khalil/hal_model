...
"""),
    E0 = (-948.256,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,223,363,546,575,694,1179,1410,528,1116,1182,1331,1402,1494,3075,3110,296.361,302.651],'cm^-1')),
        HinderedRotor(inertia=(0.124873,'amu*angstrom^2'), symmetry=1, barrier=(7.88275,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120174,'amu*angstrom^2'), symmetry=1, barrier=(7.89165,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.392726,'amu*angstrom^2'), symmetry=1, barrier=(25.1115,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-563.115,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,223,363,546,575,694,1179,1410,617,898,1187,186.061],'cm^-1')),
        HinderedRotor(inertia=(0.269921,'amu*angstrom^2'), symmetry=1, barrier=(6.65659,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.27091,'amu*angstrom^2'), symmetry=1, barrier=(6.66477,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.702785,'amu*angstrom^2'), symmetry=1, barrier=(16.1584,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41606,0.0606388,-7.91829e-05,5.46628e-08,-1.51904e-11,-67637.3,21.9749], Tmin=(100,'K'), Tmax=(875.278,'K')), NASAPolynomial(coeffs=[10.249,0.0202718,-1.00036e-05,1.97083e-09,-1.40185e-13,-69183.5,-19.4623], Tmin=(875.278,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-563.115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCFFO) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-564.896,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,223,363,546,575,694,1179,1410,3000,3100,440,815,1455,1000,276.751],'cm^-1')),
        HinderedRotor(inertia=(0.127166,'amu*angstrom^2'), symmetry=1, barrier=(6.90068,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126849,'amu*angstrom^2'), symmetry=1, barrier=(6.89941,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127466,'amu*angstrom^2'), symmetry=1, barrier=(6.89833,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.068,'amu'),
...
"""),
    E0 = (-692.606,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,351,323,533,609,664,892,1120,1201,528,1116,1182,1331,1402,1494,3075,3110,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.359698,'amu*angstrom^2'), symmetry=1, barrier=(8.27016,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.359693,'amu*angstrom^2'), symmetry=1, barrier=(8.27005,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction5',
    reactants = ['H2(8)', 'OC(F)(F)C[C]F(6606)'],
    products = ['OC(F)(F)CCF(8941)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['H2O(3)', 'FCC=C(F)F(1828)'],
    products = ['OC(F)(F)CCF(8941)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]CC(O)(F)F(9061)'],
    products = ['OC(F)(F)CCF(8941)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(F)(F)CCF(9062)'],
    products = ['OC(F)(F)CCF(8941)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[C](F)F(206)', 'CH2F-CH2(62)'],
    products = ['OC(F)(F)CCF(8941)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2F(46)', '[CH2]C(O)(F)F(197)'],
    products = ['OC(F)(F)CCF(8941)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'OC(F)(F)[CH]CF(9063)'],
    products = ['OC(F)(F)CCF(8941)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'OC(F)(F)C[CH]F(9064)'],
    products = ['OC(F)(F)CCF(8941)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=C(F)CCF(9065)'],
    products = ['OC(F)(F)CCF(8941)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C=CC(O)(F)F(1971)'],
    products = ['OC(F)(F)CCF(8941)'],
