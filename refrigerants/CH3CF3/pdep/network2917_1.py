...
"""),
    ...
    molecularWeight = (68.0738,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.56847,0.0141059,5.58406e-05,-9.16697e-08,3.87597e-11,11764.5,11.7635], Tmin=(100,'K'), Tmax=(926.067,'K')), NASAPolynomial(coeffs=[15.4919,0.00301175,1.36421e-06,-2.9934e-10,1.41784e-14,7452.99,-59.9471], Tmin=(926.067,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(97.253,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclobutene)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.16945,'amu*angstrom^2'), symmetry=1, barrier=(26.8879,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.16845,'amu*angstrom^2'), symmetry=1, barrier=(26.865,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.0738,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87028,0.0366536,-9.50587e-06,-2.46859e-08,1.53136e-11,55893.2,18.7974], Tmin=(100,'K'), Tmax=(918.682,'K')), NASAPolynomial(coeffs=[15.5465,0.00386018,3.55418e-07,-1.42292e-10,8.13207e-15,52251.4,-52.1672], Tmin=(918.682,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(464.006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P)"""),
)

species(
    label = 'C#CO[CH][CH2](11423)',
    structure = adjacencyList("""multiplicity 3
1 O u0 p2 c0 {2,S} {4,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(999)', '[CH]=C[O](623)'],
    products = ['[CH]=CO[C]=C(11378)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H2(23)', '[CH2][C]=O(1002)'],
    products = ['[CH]=CO[C]=C(11378)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=[CH](1000)', '[CH2][C]=O(1002)'],
    products = ['[CH]=CO[C]=C(11378)'],
    transitionState = 'TS8',
