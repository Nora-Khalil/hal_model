...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.646832,0.0677335,-6.45784e-05,2.87193e-08,-4.98633e-12,-96781.6,26.9973], Tmin=(100,'K'), Tmax=(1389.79,'K')), NASAPolynomial(coeffs=[18.7941,0.0155025,-8.20462e-06,1.67694e-09,-1.21795e-13,-101826,-66.5255], Tmin=(1389.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-805.732,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsH) + group(Cds-OdOsOs)"""),
)
...
"""),
    ...
    molecularWeight = (140.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.762408,0.0880112,-0.000101583,5.24795e-08,-1.01126e-11,-53703.6,29.6513], Tmin=(100,'K'), Tmax=(1379.61,'K')), NASAPolynomial(coeffs=[27.3133,0.000396742,4.31617e-07,-8.09476e-11,3.41068e-15,-60859.1,-112.69], Tmin=(1379.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-448.061,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2sCF) + group(O2sCF) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-OdOsOs)"""),
)

species(
    label = 'O=C(OF)OOC=CF(9738)',
...
"""),
    ...
    molecularWeight = (140.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.291607,0.0662072,-4.08468e-05,-6.31696e-09,9.31139e-12,-64789.3,29.9254], Tmin=(100,'K'), Tmax=(1020.68,'K')), NASAPolynomial(coeffs=[23.041,0.0093348,-4.70724e-06,1.06424e-09,-8.60584e-14,-71114.8,-88.5301], Tmin=(1020.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-539.911,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + group(O2sCF) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-OdOsOs)"""),
)

species(
    label = 'FO[C]1OO[CH]C(F)O1(9739)',
...
"""),
    ...
    molecularWeight = (140.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.187905,0.0711156,-7.71812e-05,4.19864e-08,-8.56291e-12,-20403.6,26.2311], Tmin=(100,'K'), Tmax=(1392.85,'K')), NASAPolynomial(coeffs=[16.989,0.0117484,-1.2741e-06,-7.60007e-11,1.53672e-14,-24005.5,-56.5203], Tmin=(1392.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-170.878,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2sCF) + group(CsCFHO) + group(Cs-CsOsHH) + group(Cs-OsOsOsH) + ring(124trioxane) + radical(CCsJOOC) + radical(Cs_P)"""),
)

species(
    label = '[O]C[C](F)OC(=O)OF(9740)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (140.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.82323,0.0792495,-0.000110281,7.61571e-08,-1.69679e-11,-57116.6,28.6097], Tmin=(100,'K'), Tmax=(578.043,'K')), NASAPolynomial(coeffs=[9.22182,0.032436,-1.81354e-05,3.71405e-09,-2.68219e-13,-58276.4,-8.9389], Tmin=(578.043,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-475.771,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2sCF) + group(CsCFHO) + group(Cs-CsOsHH) + group(Cds-OdOsOs) + radical(CCOJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]C(OF)O[C](F)C=O(9741)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (140.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05604,0.08755,-0.000190195,2.13013e-07,-8.60121e-11,-49421.7,28.6132], Tmin=(100,'K'), Tmax=(840.124,'K')), NASAPolynomial(coeffs=[-4.26607,0.0558145,-3.1628e-05,6.3207e-09,-4.42188e-13,-46513.2,65.3496], Tmin=(840.124,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-411.612,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsH) + radical(OCOJ) + radical(CsCOF1sO2s)"""),
)

species(
    label = 'O=C[C](F)O[C](O)OF(9742)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {7,S} {8,S}
...
"""),
    E0 = (-433.764,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,280,501,1494,1531,360,370,350,2782.5,750,1395,475,1775,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (140.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.542927,0.0910356,-0.00017563,1.74767e-07,-6.54713e-11,-52059.8,30.6719], Tmin=(100,'K'), Tmax=(836.679,'K')), NASAPolynomial(coeffs=[4.60103,0.0383117,-2.13654e-05,4.24631e-09,-2.96333e-13,-51572.5,18.7877], Tmin=(836.679,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-433.764,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(236.962,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-OsOsOsH) + group(Cds-OdCsH) + radical(CsCOF1sO2s) + radical(Cs_P)"""),
)

species(
    label = '[O]C(OF)OC(F)[C]=O(9743)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (140.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.484234,0.10233,-0.00022739,2.44321e-07,-9.46462e-11,-47079.9,30.1276], Tmin=(100,'K'), Tmax=(855.151,'K')), NASAPolynomial(coeffs=[-1.51105,0.0503893,-2.88044e-05,5.71748e-09,-3.96134e-13,-44498.2,52.5409], Tmin=(855.151,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-392.297,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-OsOsOsH) + group(Cds-OdCsH) + radical(OCOJ) + radical(COj(Cs-F1sO2sH)(O2d))"""),
)

species(
    label = 'O=[C]C(F)O[C](O)OF(9744)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (140.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0360235,0.105909,-0.000213201,2.06643e-07,-7.43908e-11,-49717.7,32.2114], Tmin=(100,'K'), Tmax=(860.438,'K')), NASAPolynomial(coeffs=[7.36767,0.0328653,-1.8529e-05,3.63998e-09,-2.50014e-13,-49562,5.91438], Tmin=(860.438,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-414.448,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(236.962,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-OsOsOsH) + group(Cds-OdCsH) + radical(Cs_P) + radical(COj(Cs-F1sO2sH)(O2d))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.305382,0.0632079,-3.22304e-05,-2.5724e-08,1.99167e-11,-55705.4,24.7523], Tmin=(100,'K'), Tmax=(945.786,'K')), NASAPolynomial(coeffs=[26.705,-0.0037004,2.92309e-06,-4.8342e-10,2.31605e-14,-62700.3,-111.718], Tmin=(945.786,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-464.405,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2sCF) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-OdOsOs) + radical(C=COJ)"""),
)

species(
    label = '[O]C(=O)OC(F)C=O(9747)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-506.408,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([232,360,932,1127,1349,1365,3045,2782.5,750,1395,475,1775,1000,1855,455,950,399.288,404.133],'cm^-1')),
        HinderedRotor(inertia=(0.947868,'amu*angstrom^2'), symmetry=1, barrier=(48.3213,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.250345,'amu*angstrom^2'), symmetry=1, barrier=(29.3459,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.471895,'amu*angstrom^2'), symmetry=1, barrier=(48.3185,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05859,0.0452389,-4.17817e-05,1.98084e-08,-3.90569e-12,-60839.1,19.4579], Tmin=(100,'K'), Tmax=(1179.6,'K')), NASAPolynomial(coeffs=[9.33052,0.0205805,-1.04264e-05,2.08802e-09,-1.50176e-13,-62554.7,-16.8263], Tmin=(1179.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-506.408,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['FO[C]1OO[CH]C(F)O1(9739)'],
    products = ['O=CC(F)OC(=O)OF(9655)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C[C](F)OC(=O)OF(9740)'],
    products = ['O=CC(F)OC(=O)OF(9655)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(OF)O[C](F)C=O(9741)'],
    products = ['O=CC(F)OC(=O)OF(9655)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O=C[C](F)O[C](O)OF(9742)'],
    products = ['O=CC(F)OC(=O)OF(9655)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(OF)OC(F)[C]=O(9743)'],
    products = ['O=CC(F)OC(=O)OF(9655)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]C(F)O[C](O)OF(9744)'],
    products = ['O=CC(F)OC(=O)OF(9655)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C=COC(=O)OF(9746)'],
    products = ['O=CC(F)OC(=O)OF(9655)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(=O)OC(F)C=O(9747)'],
    products = ['O=CC(F)OC(=O)OF(9655)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C(=O)OF(1866)', 'O=C[CH]F(1410)'],
    products = ['O=CC(F)OC(=O)OF(9655)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OF(458)', '[O]C(F)C=O(4285)'],
    products = ['O=CC(F)OC(=O)OF(9655)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]F(127)', 'O=[C]OC(F)C=O(9748)'],
    products = ['O=CC(F)OC(=O)OF(9655)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HCO(15)', 'O=C(OF)O[CH]F(1864)'],
    products = ['O=CC(F)OC(=O)OF(9655)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'O=C[C](F)OC(=O)OF(9749)'],
    products = ['O=CC(F)OC(=O)OF(9655)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O=[C]C(F)OC(=O)OF(9750)'],
    products = ['O=CC(F)OC(=O)OF(9655)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O=CC(F)OC(=O)OF(9655)'],
    products = ['O=C(O)OF(1860)', 'O=C=CF(1411)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O=CC(F)OC(=O)OF(9655)'],
    products = ['F2(78)', 'CO2(14)', 'O=CC=O(211)'],
