...
"""),
    E0 = (256.274,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3010,987.5,1337.5,450,1655,2175,525,239,401,1367,180,180,310.38,4000,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.837129,'amu*angstrom^2'), symmetry=1, barrier=(19.2472,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.838871,'amu*angstrom^2'), symmetry=1, barrier=(19.2873,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60395,0.0646163,-0.000130213,1.34623e-07,-5.20445e-11,30897.3,20.5272], Tmin=(100,'K'), Tmax=(824.77,'K')), NASAPolynomial(coeffs=[3.27853,0.0294634,-1.71185e-05,3.4702e-09,-2.45164e-13,31540.5,18.3446], Tmin=(824.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(256.274,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CdCCF) + group(CsJ2_singlet-CsH) + group(Ct-Ct(Cds-Cds)) + group(CtCF)"""),
)

species(
    label = 'FC#C[OH+][C-]=C(F)F(3577)',
    structure = adjacencyList("""1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.404116,'amu*angstrom^2'), symmetry=1, barrier=(9.29142,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.32978,'amu*angstrom^2'), symmetry=1, barrier=(53.5663,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11179,0.0802527,-0.000169886,1.71855e-07,-6.30485e-11,6412.7,32.4357], Tmin=(100,'K'), Tmax=(879.944,'K')), NASAPolynomial(coeffs=[3.04374,0.0308526,-1.64365e-05,3.14054e-09,-2.11368e-13,7645.22,32.2977], Tmin=(879.944,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(52.5859,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CdCFF) + group(CsJ2_singlet-CsH) + group(Ct-CtCs) + group(CtCF)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[OH+]=[C-]C(F)(F)C#CF(2967)'],
    products = ['CO(13)', 'FC=C=C(F)F(1325)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['FC#CC(F)=[C-][OH+]F(3576)'],
    products = ['[OH+]=[C-]C(F)(F)C#CF(2967)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['FC#C[OH+][C-]=C(F)F(3577)'],
    products = ['[OH+]=[C-]C(F)(F)C#CF(2967)'],
    transitionState = 'TS3',
...
network(
    ...
    isomers = [
        '[OH+]=[C-]C(F)(F)C#CF(2967)',
    ],
    reactants = [
        ('CO(13)', 'FC=C=C(F)F(1325)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
