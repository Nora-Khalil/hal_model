...
reaction(
    label = 'reaction2',
    reactants = ['[O]C[C](F)F(174)', '[CH]C-2(978)'],
    products = ['C[CH]OC[C](F)F(1794)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', '[CH2]O[CH]C(1868)'],
    products = ['C[CH]OC[C](F)F(1794)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C[CH]OC=C(F)F(1871)'],
    products = ['C[CH]OC[C](F)F(1794)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=COC[C](F)F(1872)'],
    products = ['C[CH]OC[C](F)F(1794)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(43)', '[CH2]O[CH]C(1868)'],
    products = ['C[CH]OC[C](F)F(1794)'],
