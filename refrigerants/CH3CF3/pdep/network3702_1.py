...
reaction(
    label = 'reaction41',
    reactants = ['CH2F(46)', '[C]=C(999)'],
    products = ['C=[C]CF(12790)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction19',
    reactants = ['C=[C]CF(12790)'],
    products = ['C=C[CH]F(11697)'],
    transitionState = 'TS8',
