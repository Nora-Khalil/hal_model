...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=C(F)C([O])F(5631)'],
    products = ['[CH2]C(F)C([O])F(10230)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH2]C(F)C=O(10282)'],
    products = ['[CH2]C(F)C([O])F(10230)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(F)C(=O)F(1439)'],
    products = ['[CH2]C(F)C([O])F(10230)'],
