...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(F)O[CH]O(10365)'],
    products = ['C=C(F)OCO(10013)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C=C(F)OC[O](10370)'],
    products = ['C=C(F)OCO(10013)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C=C(F)O[CH]O(10371)'],
    products = ['C=C(F)OCO(10013)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH]=C(F)OCO(10372)'],
    products = ['C=C(F)OCO(10013)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(25)', 'OC[O+]=[C-]F(8403)'],
    products = ['C=C(F)OCO(10013)'],
