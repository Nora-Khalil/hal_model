species(
    label = 'OC(F)(F)C(C(F)F)C(F)(F)F(6364)',
...
"""),
    E0 = (-1816.81,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,235,523,627,1123,1142,1372,1406,3097,193,295,551,588,656,1146,1192,1350,375.739,375.792,376.31],'cm^-1')),
        HinderedRotor(inertia=(0.0971696,'amu*angstrom^2'), symmetry=1, barrier=(9.7175,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0968953,'amu*angstrom^2'), symmetry=1, barrier=(9.71194,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.097034,'amu*angstrom^2'), symmetry=1, barrier=(9.717,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.250736,'amu*angstrom^2'), symmetry=1, barrier=(25.1012,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (200.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.854374,0.112256,-0.000147355,9.71239e-08,-2.5326e-11,-218342,33.8371], Tmin=(100,'K'), Tmax=(936.907,'K')), NASAPolynomial(coeffs=[18.4925,0.0296579,-1.51146e-05,3.02692e-09,-2.17697e-13,-221967,-58.2395], Tmin=(936.907,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1816.81,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(CsCFFO) + group(CsCsFFH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-R-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)3-R-Cs(F)2)"""),
)
...
species(
    label = 'F[C]C(C(F)F)C(F)(F)F(6926)',
...
"""),
    E0 = (-1031.12,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,193,295,551,588,656,1146,1192,1350,617,898,1187,233.841,233.846],'cm^-1')),
        HinderedRotor(inertia=(0.14459,'amu*angstrom^2'), symmetry=1, barrier=(5.61168,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144596,'amu*angstrom^2'), symmetry=1, barrier=(5.61178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.759437,'amu*angstrom^2'), symmetry=1, barrier=(29.4743,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.391165,0.0841564,-0.000109368,7.28545e-08,-1.93691e-11,-123890,28.5673], Tmin=(100,'K'), Tmax=(916.138,'K')), NASAPolynomial(coeffs=[13.9086,0.0251386,-1.27406e-05,2.54146e-09,-1.82248e-13,-126366,-35.4631], Tmin=(916.138,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1031.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCsFFH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-R-Cs(F)2) + group(CJ2_singlet-FCs)"""),
)

species(
    label = 'OC(F)(F)CC(F)(F)F(258)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1410.7,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,223,363,546,575,694,1179,1410,193,295,551,588,656,1146,1192,1350,209.331,209.332],'cm^-1')),
        HinderedRotor(inertia=(0.184457,'amu*angstrom^2'), symmetry=1, barrier=(5.73564,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.184453,'amu*angstrom^2'), symmetry=1, barrier=(5.73564,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.18446,'amu*angstrom^2'), symmetry=1, barrier=(5.7357,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (150.047,'amu'),
...
species(
    label = 'OC(F)(F)C([C]F)C(F)(F)F(6927)',
    structure = adjacencyList("""1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
4  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-1241.03,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,193,295,551,588,656,1146,1192,1350,617,898,1187,293.464,293.601],'cm^-1')),
        HinderedRotor(inertia=(0.1072,'amu*angstrom^2'), symmetry=1, barrier=(6.54624,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107032,'amu*angstrom^2'), symmetry=1, barrier=(6.54657,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.414237,'amu*angstrom^2'), symmetry=1, barrier=(25.3283,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107243,'amu*angstrom^2'), symmetry=1, barrier=(6.54795,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.328003,0.101053,-0.000142082,1.00491e-07,-2.80485e-11,-149110,32.505], Tmin=(100,'K'), Tmax=(878.169,'K')), NASAPolynomial(coeffs=[16.2404,0.0255841,-1.31711e-05,2.6267e-09,-1.87692e-13,-152020,-45.275], Tmin=(878.169,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1241.03,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(CsCFFO) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-R-Cs(F)2) + group(CJ2_singlet-FCs)"""),
)
...
species(
    label = 'FC(F)=C(C(F)F)C(F)(F)F(6928)',
    structure = adjacencyList("""1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1450.16,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([171,205,598,1104,1143,1317,1411,3153,219,296,586,564,718,793,1177,1228,350,440,435,1725,182,240,577,636,1210,1413,180,1107.17],'cm^-1')),
        HinderedRotor(inertia=(0.00625816,'amu*angstrom^2'), symmetry=1, barrier=(5.42486,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235303,'amu*angstrom^2'), symmetry=1, barrier=(5.41007,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = 'O[C](F)C(C(F)F)C(F)(F)F(6929)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-1399.76,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,193,295,551,588,656,1146,1192,1350,395,473,707,1436,258.589,258.589,258.589],'cm^-1')),
        HinderedRotor(inertia=(0.129797,'amu*angstrom^2'), symmetry=1, barrier=(6.15904,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129798,'amu*angstrom^2'), symmetry=1, barrier=(6.15904,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129798,'amu*angstrom^2'), symmetry=1, barrier=(6.15904,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.440484,'amu*angstrom^2'), symmetry=1, barrier=(20.9015,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'OC(F)(F)C([C](F)F)C(F)F(6930)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = 'OC(F)(F)C([CH]F)C(F)(F)F(6931)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-1414.61,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,193,295,551,588,656,1146,1192,1350,334,575,1197,1424,3202,210.341,210.366,210.374],'cm^-1')),
        HinderedRotor(inertia=(0.00380941,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160755,'amu*angstrom^2'), symmetry=1, barrier=(5.04832,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00380948,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.904402,'amu*angstrom^2'), symmetry=1, barrier=(28.3997,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (181.056,'amu'),
...
species(
    label = 'F[C](F)C(C(F)F)C(F)(F)F(6932)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = '[O]C(F)(F)C(C(F)F)C(F)(F)F(6933)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {12,S}
...
"""),
    E0 = (-1556.84,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,351,323,533,609,664,892,1120,1201,235,523,627,1123,1142,1372,1406,3097,193,295,551,588,656,1146,1192,1350,306.839,306.841,306.981],'cm^-1')),
        HinderedRotor(inertia=(0.0919008,'amu*angstrom^2'), symmetry=1, barrier=(6.13178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.091714,'amu*angstrom^2'), symmetry=1, barrier=(6.13088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240237,'amu*angstrom^2'), symmetry=1, barrier=(16.0632,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (199.047,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.642046,0.108271,-0.000146055,9.91909e-08,-2.66822e-11,-187083,33.6653], Tmin=(100,'K'), Tmax=(908.526,'K')), NASAPolynomial(coeffs=[17.3888,0.0288857,-1.49868e-05,3.01364e-09,-2.16876e-13,-190359,-51.5931], Tmin=(908.526,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1556.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(CsCFFO) + group(CsCsFFH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-R-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)3-R-Cs(F)2) + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.110045,'amu*angstrom^2'), symmetry=1, barrier=(2.53016,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109752,'amu*angstrom^2'), symmetry=1, barrier=(2.52342,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'OC(F)(F)[C](C(F)F)C(F)(F)F(6934)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-1664.24,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,253,525,597,667,842,1178,1324,522,611,926,1093,1137,1374,1416,3112,253,522,585,610,849,1160,1215,1402,360,370,350,235.023,236.035,236.639],'cm^-1')),
        HinderedRotor(inertia=(1.29252,'amu*angstrom^2'), symmetry=1, barrier=(50.6454,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.198092,'amu*angstrom^2'), symmetry=1, barrier=(7.81136,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.468963,'amu*angstrom^2'), symmetry=1, barrier=(18.4535,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.196916,'amu*angstrom^2'), symmetry=1, barrier=(7.7994,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (199.047,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.569744,0.105475,-0.000135637,8.70389e-08,-2.21086e-11,-200001,33.0095], Tmin=(100,'K'), Tmax=(960.374,'K')), NASAPolynomial(coeffs=[18.0581,0.0278891,-1.44573e-05,2.91935e-09,-2.11094e-13,-203579,-56.1058], Tmin=(960.374,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1664.24,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(CsCFFO) + group(CsCsFFH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-R-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)3-R-Cs(F)2) + radical(CCJ(C)CO)"""),
)

species(
    label = 'OC(F)(F)C([C](F)F)C(F)(F)F(6935)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {11,S}
...
"""),
    E0 = (-1617.82,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,193,295,551,588,656,1146,1192,1350,190,488,555,1236,1407,240.409,240.601,242.002],'cm^-1')),
        HinderedRotor(inertia=(0.00290693,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00288265,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.243796,'amu*angstrom^2'), symmetry=1, barrier=(10.1009,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.524499,'amu*angstrom^2'), symmetry=1, barrier=(21.6268,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (199.047,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.866381,0.11401,-0.000164131,1.18509e-07,-3.37231e-11,-194410,35.3399], Tmin=(100,'K'), Tmax=(862.177,'K')), NASAPolynomial(coeffs=[17.6511,0.0280986,-1.46616e-05,2.9324e-09,-2.09563e-13,-197603,-51.2498], Tmin=(862.177,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1617.82,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(CsCFFO) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-R-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)3-R-Cs(F)2) + group(CsCsFFH) + radical(Csj(Cs-CsCsH)(F1s)(F1s))"""),
)

species(
    label = 'O=C(F)C(C(F)F)C(F)(F)F(6936)',
    structure = adjacencyList("""1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-1535.68,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,193,295,551,588,656,1146,1192,1350,486,617,768,1157,1926,213.137,213.138,213.138],'cm^-1')),
        HinderedRotor(inertia=(0.676185,'amu*angstrom^2'), symmetry=1, barrier=(21.798,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180846,'amu*angstrom^2'), symmetry=1, barrier=(5.82988,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180845,'amu*angstrom^2'), symmetry=1, barrier=(5.82988,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.256826,0.101009,-0.000148642,1.13723e-07,-3.47046e-11,-184553,31.1871], Tmin=(100,'K'), Tmax=(801.93,'K')), NASAPolynomial(coeffs=[14.0076,0.0298621,-1.55703e-05,3.10225e-09,-2.20682e-13,-186841,-34.4825], Tmin=(801.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1535.68,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(CsCsFFH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-R-CO) + longDistanceInteraction_noncyclic(Cs(F)3-R-Cs(F)2) + group(COCsFO)"""),
)

species(
    label = 'OC(F)=C(C(F)F)C(F)(F)F(6937)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1457.38,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,171,205,598,1104,1143,1317,1411,3153,219,296,586,564,718,793,1177,1228,350,440,435,1725,326,540,652,719,1357,228.857,2560.48],'cm^-1')),
        HinderedRotor(inertia=(0.368144,'amu*angstrom^2'), symmetry=1, barrier=(13.706,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.367884,'amu*angstrom^2'), symmetry=1, barrier=(13.7103,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.827891,'amu*angstrom^2'), symmetry=1, barrier=(30.8427,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.167142,0.0966249,-0.000127381,8.42826e-08,-2.20744e-11,-175137,30.1685], Tmin=(100,'K'), Tmax=(932.538,'K')), NASAPolynomial(coeffs=[16.3853,0.0256286,-1.31879e-05,2.65023e-09,-1.90917e-13,-178224,-48.5321], Tmin=(932.538,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1457.38,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCFFH) + group(CsCdFFF) + longDistanceInteraction_noncyclic(Cs(F)3-R-Cds(F)) + group(Cds-CdsCsCs) + group(CdCFO)"""),
)

species(
    label = 'OC(F)(F)C(=CF)C(F)(F)F(6938)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.171385,'amu*angstrom^2'), symmetry=1, barrier=(3.94049,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.17057,'amu*angstrom^2'), symmetry=1, barrier=(3.92173,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.169876,'amu*angstrom^2'), symmetry=1, barrier=(3.90578,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.453784,0.105722,-0.000162629,1.28959e-07,-4.05788e-11,-178766,30.2229], Tmin=(100,'K'), Tmax=(779.83,'K')), NASAPolynomial(coeffs=[14.4738,0.0291538,-1.53521e-05,3.05449e-09,-2.16418e-13,-181094,-38.0822], Tmin=(779.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1487.62,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + group(CsCdFFF) + group(Cds-CdsCsCs) + group(CdCFH)"""),
)

species(
    label = 'OC(F)(F)C(=C(F)F)C(F)F(5808)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)C(C(F)F)C(F)(F)F(6364)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'OC(C(F)F)C(F)(F)F(3444)'],
    products = ['OC(F)(F)C(C(F)F)C(F)(F)F(6364)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OF(195)', 'F[C]C(C(F)F)C(F)(F)F(6926)'],
    products = ['OC(F)(F)C(C(F)F)C(F)(F)F(6364)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CF2(43)', 'OC(F)(F)CC(F)(F)F(258)'],
    products = ['OC(F)(F)C(C(F)F)C(F)(F)F(6364)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['HF(38)', 'OC(F)(F)C([C]F)C(F)(F)F(6927)'],
    products = ['OC(F)(F)C(C(F)F)C(F)(F)F(6364)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF(40)', 'OC(F)(F)C(F)C(F)(F)F(1416)'],
    products = ['OC(F)(F)C(C(F)F)C(F)(F)F(6364)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H2O(3)', 'FC(F)=C(C(F)F)C(F)(F)F(6928)'],
    products = ['OC(F)(F)C(C(F)F)C(F)(F)F(6364)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OC(F)(F)F(248)', 'FC(F)=CC(F)F(344)'],
    products = ['OC(F)(F)C(C(F)F)C(F)(F)F(6364)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OC(F)F(1026)', 'FC(F)=CC(F)(F)F(597)'],
    products = ['OC(F)(F)C(C(F)F)C(F)(F)F(6364)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O[C](F)C(C(F)F)C(F)(F)F(6929)'],
    products = ['OC(F)(F)C(C(F)F)C(F)(F)F(6364)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'OC(F)(F)C([C](F)F)C(F)F(6930)'],
    products = ['OC(F)(F)C(C(F)F)C(F)(F)F(6364)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'OC(F)(F)C([CH]F)C(F)(F)F(6931)'],
    products = ['OC(F)(F)C(C(F)F)C(F)(F)F(6364)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(7)', 'F[C](F)C(C(F)F)C(F)(F)F(6932)'],
    products = ['OC(F)(F)C(C(F)F)C(F)(F)F(6364)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)(F)C(C(F)F)C(F)(F)F(6933)'],
    products = ['OC(F)(F)C(C(F)F)C(F)(F)F(6364)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O[C](F)F(206)', 'FC(F)[CH]C(F)(F)F(5582)'],
    products = ['OC(F)(F)C(C(F)F)C(F)(F)F(6364)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHF2(82)', 'OC(F)(F)[CH]C(F)(F)F(601)'],
    products = ['OC(F)(F)C(C(F)F)C(F)(F)F(6364)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CF3(45)', 'OC(F)(F)[CH]C(F)F(3445)'],
    products = ['OC(F)(F)C(C(F)F)C(F)(F)F(6364)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'OC(F)(F)[C](C(F)F)C(F)(F)F(6934)'],
    products = ['OC(F)(F)C(C(F)F)C(F)(F)F(6364)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'OC(F)(F)C([C](F)F)C(F)(F)F(6935)'],
    products = ['OC(F)(F)C(C(F)F)C(F)(F)F(6364)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'O=C(F)C(C(F)F)C(F)(F)F(6936)'],
    products = ['OC(F)(F)C(C(F)F)C(F)(F)F(6364)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'OC(F)=C(C(F)F)C(F)(F)F(6937)'],
    products = ['OC(F)(F)C(C(F)F)C(F)(F)F(6364)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'OC(F)(F)C(=CF)C(F)(F)F(6938)'],
    products = ['OC(F)(F)C(C(F)F)C(F)(F)F(6364)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'OC(F)(F)C(=C(F)F)C(F)F(5808)'],
    products = ['OC(F)(F)C(C(F)F)C(F)(F)F(6364)'],
...
reaction(
    label = 'reaction25',
    reactants = ['OC(F)(F)C(C(F)F)C(F)(F)F(6364)'],
    products = ['HF(38)', 'CF2O(49)', 'FC=CC(F)(F)F(997)'],
