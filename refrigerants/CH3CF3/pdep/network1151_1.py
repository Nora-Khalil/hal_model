...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[O]C(F)C(=O)F(2920)'],
    products = ['[O]C(F)C([O])F(2964)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][CH]F(2623)', '[O][CH]F(2623)'],
    products = ['[O]C(F)C([O])F(2964)'],
    transitionState = 'TS8',
