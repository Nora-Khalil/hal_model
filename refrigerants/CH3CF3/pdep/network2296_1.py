...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.198919,'amu*angstrom^2'), symmetry=1, barrier=(4.57355,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.198716,'amu*angstrom^2'), symmetry=1, barrier=(4.56886,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.499818,'amu*angstrom^2'), symmetry=1, barrier=(11.4918,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.188422,'amu*angstrom^2'), symmetry=1, barrier=(4.33218,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188672,'amu*angstrom^2'), symmetry=1, barrier=(4.33795,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188802,'amu*angstrom^2'), symmetry=1, barrier=(4.34092,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03175,0.0687358,-8.72167e-05,5.70744e-08,-1.49118e-11,-84065.9,27.379], Tmin=(100,'K'), Tmax=(931.91,'K')), NASAPolynomial(coeffs=[12.1697,0.0209291,-1.02679e-05,2.02742e-09,-1.44746e-13,-86141.8,-25.57], Tmin=(931.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-699.828,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCFFO) + group(CsCFHO) + radical(O2sj(Cs-CsF1sH)) + radical(CCJCO)"""),
)

species(
    label = '[O]C(F)CC([O])(F)F(9616)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04174,0.0700517,-9.48405e-05,6.90553e-08,-2.03376e-11,-76843.6,25.4372], Tmin=(100,'K'), Tmax=(826.058,'K')), NASAPolynomial(coeffs=[10.4323,0.0245809,-1.22741e-05,2.422e-09,-1.72055e-13,-78395,-18.0728], Tmin=(826.058,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-639.762,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCFFO) + group(CsCFHO) + radical(O2sj(Cs-CsF1sF1s)) + radical(O2sj(Cs-CsF1sH))"""),
)

species(
    label = '[O]C(F)(F)C[C](O)F(9617)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-680.292,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,351,323,533,609,664,892,1120,1201,395,473,707,1436,180,747.018],'cm^-1')),
        HinderedRotor(inertia=(0.660949,'amu*angstrom^2'), symmetry=1, barrier=(15.1965,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.268345,'amu*angstrom^2'), symmetry=1, barrier=(6.16979,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00467,'amu*angstrom^2'), symmetry=1, barrier=(23.0994,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0859,0.0685668,-8.05852e-05,4.82549e-08,-1.16828e-11,-81719,25.3264], Tmin=(100,'K'), Tmax=(993.886,'K')), NASAPolynomial(coeffs=[12.3043,0.0234173,-1.24444e-05,2.54819e-09,-1.85794e-13,-83948.9,-28.7269], Tmin=(993.886,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-680.292,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCFFO) + group(CsCFHO) + radical(O2sj(Cs-CsF1sF1s)) + radical(Csj(Cs-CsHH)(F1s)(O2s-H))"""),
)

species(
    label = 'OC(F)=CC(O)(F)F(9618)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.563831,'amu*angstrom^2'), symmetry=1, barrier=(12.9636,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.564304,'amu*angstrom^2'), symmetry=1, barrier=(12.9745,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.647279,0.0765135,-0.000102387,6.81722e-08,-1.77972e-11,-121130,23.5594], Tmin=(100,'K'), Tmax=(940.133,'K')), NASAPolynomial(coeffs=[14.457,0.0177581,-8.64389e-06,1.69839e-09,-1.20892e-13,-123727,-42.2124], Tmin=(940.133,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1008.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(CsCFFO) + group(Cds-CdsCsH) + group(CdCFO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.25173,'amu*angstrom^2'), symmetry=1, barrier=(5.78777,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251676,'amu*angstrom^2'), symmetry=1, barrier=(5.78653,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25258,0.0695384,-0.000123047,1.15429e-07,-4.1423e-11,-77882.1,23.8517], Tmin=(100,'K'), Tmax=(845.405,'K')), NASAPolynomial(coeffs=[6.16971,0.0271735,-1.39906e-05,2.70634e-09,-1.86336e-13,-78031,4.99193], Tmin=(845.405,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-648.299,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(CsCFHO) + group(COCsFO) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'O=[C]CC(O)(F)F(9620)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.326224,'amu*angstrom^2'), symmetry=1, barrier=(7.50054,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.326137,'amu*angstrom^2'), symmetry=1, barrier=(7.49853,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.326076,'amu*angstrom^2'), symmetry=1, barrier=(7.49713,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18679,0.0672419,-0.000107086,9.07612e-08,-3.03424e-11,-79717.2,23.3885], Tmin=(100,'K'), Tmax=(816.413,'K')), NASAPolynomial(coeffs=[9.21865,0.021293,-1.05439e-05,2.02897e-09,-1.40237e-13,-80808.8,-12.3849], Tmin=(816.413,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-663.606,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(CsCFFO) + group(Cds-OdCsH) + radical(CCCJ=O)"""),
)
...
"""),
    E0 = (-840.663,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,351,323,533,609,664,892,1120,1201,486,617,768,1157,1926,180,1879.97],'cm^-1')),
        HinderedRotor(inertia=(1.05673,'amu*angstrom^2'), symmetry=1, barrier=(24.2964,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.80771,'amu*angstrom^2'), symmetry=1, barrier=(64.5548,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.147684,'amu*angstrom^2'), symmetry=1, barrier=(3.39555,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149742,'amu*angstrom^2'), symmetry=1, barrier=(3.44286,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.12528,0.0451306,-5.17955e-05,3.41021e-08,-9.51914e-12,-93849.3,20.24], Tmin=(100,'K'), Tmax=(852.075,'K')), NASAPolynomial(coeffs=[7.06023,0.0219641,-1.10131e-05,2.19406e-09,-1.57342e-13,-94690.3,-2.77831], Tmin=(852.075,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-780.841,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-O2d)HH) + group(COCsFO) + group(COCsFO)"""),
)

species(
    label = 'O=C(F)C=C(O)F(8133)',
    structure = adjacencyList("""1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction4',
    reactants = ['OF(195)', 'O=C(F)C[C]F(9614)'],
    products = ['O=C(F)CC(O)(F)F(8301)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'O=C(F)C=C(F)F(986)'],
    products = ['O=C(F)CC(O)(F)F(8301)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)[CH]C(O)(F)F(9615)'],
    products = ['O=C(F)CC(O)(F)F(8301)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)(F)C[C](O)F(9617)'],
    products = ['O=C(F)CC(O)(F)F(8301)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O=C(F)C[C](O)F(9619)'],
    products = ['O=C(F)CC(O)(F)F(8301)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=[C]CC(O)(F)F(9620)'],
    products = ['O=C(F)CC(O)(F)F(8301)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', 'O=C(F)C[C](F)F(269)'],
    products = ['O=C(F)CC(O)(F)F(8301)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(F)(F)CC(=O)F(8895)'],
    products = ['O=C(F)CC(O)(F)F(8301)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CFO(51)', '[CH2]C(O)(F)F(197)'],
    products = ['O=C(F)CC(O)(F)F(8301)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'O=C(F)[CH]C(O)(F)F(8144)'],
    products = ['O=C(F)CC(O)(F)F(8301)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=C(F)CC(=O)F(9621)'],
    products = ['O=C(F)CC(O)(F)F(8301)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C(F)C=C(O)F(8133)'],
    products = ['O=C(F)CC(O)(F)F(8301)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'O=C=CC(O)(F)F(1990)'],
    products = ['O=C(F)CC(O)(F)F(8301)'],
...
network(
    label = 'PDepNetwork #2296',
    isomers = [
        'O=C(F)CC(O)(F)F(8301)',
    ],
    reactants = [
        ('HF(38)', 'CF2O(49)', 'CH2CO(28)'),
        ('O[C](F)F(206)', 'CH2CFO(79)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
