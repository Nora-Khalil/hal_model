...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CC[C](F)F(227)'],
    products = ['CC([O])C[C](F)F(1792)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C[CH]C[C](F)F(1192)'],
    products = ['CC([O])C[C](F)F(1792)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(138)', '[CH2]C(C)[O](1890)'],
    products = ['CC([O])C[C](F)F(1792)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', 'O=CC[C](F)F(304)'],
    products = ['CC([O])C[C](F)F(1792)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'CC(=O)C[C](F)F(1893)'],
    products = ['CC([O])C[C](F)F(1792)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'CC([O])C=C(F)F(1894)'],
    products = ['CC([O])C[C](F)F(1792)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', '[CH2]C(C)[O](1890)'],
    products = ['CC([O])C[C](F)F(1792)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(O)C[C](F)F(1898)'],
    products = ['CC([O])C[C](F)F(1792)'],
