...
"""),
    ...
    molecularWeight = (61.0599,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.44847,0.0313149,-2.37472e-05,9.50341e-09,-1.55883e-12,4191.03,17.4641], Tmin=(100,'K'), Tmax=(1426.95,'K')), NASAPolynomial(coeffs=[8.63689,0.0139676,-5.51185e-06,9.8389e-10,-6.62177e-14,2424.92,-14.5917], Tmin=(1426.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(34.3631,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), label="""CH2CH2OOH""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CCO[O](8936)'],
    products = ['HO2(11)', 'C2H4(30)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'CO[O](412)'],
    products = ['CCO[O](8936)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.26474e-05,'m^3/(mol*s)'), n=2.95311, Ea=(60.0803,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_N-2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CCO[O](8936)'],
    products = ['O(6)', 'CC[O](989)'],
    transitionState = 'TS3',
...
This reaction matched rate rule [Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Sp-4R!H-2C]
family: R_Recombination"""),
)

reaction(
    label = 'reaction5',
    reactants = ['[CH2]O[O](175)', 'CH3(19)'],
    products = ['CCO[O](8936)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['CCO[O](8936)'],
    products = ['[CH2]COO(8937)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.989e+11,'s^-1'), n=0.15, Ea=(143.135,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Matched reaction 246 C2H5O2-3 <=> C2H5O2-4 in intra_H_migration/training
This reaction matched rate rule [R4H_SSS_OCs;O_rad_out;Cs_H_out_2H]
family: intra_H_migration"""),
)

network(
    label = 'PDepNetwork #2569',
    isomers = [
        'CCO[O](8936)',
    ],
    reactants = [
