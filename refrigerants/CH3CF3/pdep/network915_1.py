...
reaction(
    label = 'reaction5',
    reactants = ['H(5)', '[O]OC(F)(F)OF(2237)'],
    products = ['OOC(F)(F)OF(2232)'],
    transitionState = 'TS5',
