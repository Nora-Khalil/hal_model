...
species(
    label = 'CC(F)(F)C1=C(F)C1(F)F(11382)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
4  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.581706,0.0802394,-9.19041e-05,5.5529e-08,-1.37107e-11,-98814.3,26.4663], Tmin=(100,'K'), Tmax=(971.894,'K')), NASAPolynomial(coeffs=[12.6155,0.0307119,-1.54635e-05,3.09433e-09,-2.22797e-13,-101153,-31.2465], Tmin=(971.894,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-822.578,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(CsCCFF) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(CdCsCdF) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cds(F)) + ring(Cd-Cd(C)-Cs(F)(F))"""),
)
...
"""),
    E0 = (-693.314,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,3025,407.5,1350,352.5,271,519,563,612,1379,3000,3100,440,815,1455,1000,182,240,577,636,1210,1413,231.484,1801],'cm^-1')),
        HinderedRotor(inertia=(0.146558,'amu*angstrom^2'), symmetry=1, barrier=(5.58666,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00334613,'amu*angstrom^2'), symmetry=1, barrier=(0.119734,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03551,'amu*angstrom^2'), symmetry=1, barrier=(39.4528,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
...
species(
    label = '[CH2]C(F)(F)C1=C(F)C1(F)F(11383)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.41844,'amu*angstrom^2'), symmetry=1, barrier=(32.6128,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.40576,'amu*angstrom^2'), symmetry=1, barrier=(32.3213,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (157.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00711753,0.0972847,-0.00016204,1.45079e-07,-5.15742e-11,-70536.7,28.7478], Tmin=(100,'K'), Tmax=(781.562,'K')), NASAPolynomial(coeffs=[10.0437,0.0342645,-1.87244e-05,3.75399e-09,-2.65829e-13,-71749.6,-14.9224], Tmin=(781.562,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-587.595,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(CsCCFF) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(CdCsCdF) + ring(Cs-Cd(C)-Cd(F)) + radical(Csj(Cs-F1sF1sCd)(H)(H)) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cds(F))"""),
)
...
species(
    label = '[CH2]C(F)(F)C1C(F)=C1F(11384)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-348.495,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,215,315,519,588,595,1205,1248,260,386,409,525,515,635,761,893,1354,1482,3000,3100,440,815,1455,1000,180,180,1855.11],'cm^-1')),
        HinderedRotor(inertia=(0.252682,'amu*angstrom^2'), symmetry=1, barrier=(5.80965,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.25266,'amu*angstrom^2'), symmetry=1, barrier=(5.80915,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (139.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.148535,0.0920035,-0.000146554,1.24079e-07,-4.17292e-11,-41782.5,24.6531], Tmin=(100,'K'), Tmax=(788.861,'K')), NASAPolynomial(coeffs=[11.3896,0.0288688,-1.48376e-05,2.90635e-09,-2.03285e-13,-43365.1,-25.7024], Tmin=(788.861,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-348.495,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(CsCsCsFF) + group(Cs-CsHHH) + group(CdCsCdF) + group(CdCsCdF) + ring(Cs-Cd(F)-Cd) + radical(Csj(Cs-CsF1sF1s)(H)(H)) + longDistanceInteraction_cyclic(Cds(F)=Cds(F)) + longDistanceInteraction_cyclic(Cds(F)=Cds(F))"""),
)
...
species(
    label = '[CH2]C(F)(F)[C]1C(F)=C1F(11386)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-216.514,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,206,336,431,607,515,611,528,696,1312,1446,3000,3100,440,815,1455,1000,180,1213.76],'cm^-1')),
        HinderedRotor(inertia=(0.160115,'amu*angstrom^2'), symmetry=1, barrier=(3.68135,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161961,'amu*angstrom^2'), symmetry=1, barrier=(3.72381,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (138.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.385095,0.0870968,-0.00014278,1.23358e-07,-4.18172e-11,-25917.7,22.0565], Tmin=(100,'K'), Tmax=(820.658,'K')), NASAPolynomial(coeffs=[10.4239,0.02739,-1.39507e-05,2.70228e-09,-1.87076e-13,-27202.5,-22.1801], Tmin=(820.658,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.514,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(CsCsCsFF) + group(Cs-CsHHH) + group(CdCsCdF) + group(CdCsCdF) + ring(Cs-Cd(F)-Cd) + radical(Allyl_T) + radical(Csj(Cs-CsF1sF1s)(H)(H)) + longDistanceInteraction_cyclic(Cds(F)=Cds(F)) + longDistanceInteraction_cyclic(Cds(F)=Cds(F))"""),
)
...
species(
    label = 'CC(F)(F)[C]1[C](F)C1(F)F(11388)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-538.395,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,222,329,445,522,589,1214,1475,528,1116,1182,1331,1402,1494,3075,3110,165,259,333,401,397,493,1395,1505,494.74,494.798,494.837,494.854,495.067,495.11],'cm^-1')),
        HinderedRotor(inertia=(0.197758,'amu*angstrom^2'), symmetry=1, barrier=(34.3884,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00678354,'amu*angstrom^2'), symmetry=1, barrier=(34.4701,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.386693,0.0848031,-0.000100576,6.23019e-08,-1.56683e-11,-64628.3,28.2052], Tmin=(100,'K'), Tmax=(958.094,'K')), NASAPolynomial(coeffs=[13.3997,0.0304744,-1.55186e-05,3.1163e-09,-2.24719e-13,-67121.8,-34.0177], Tmin=(958.094,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-538.395,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCsCsFH) + group(CsCsCsFH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + ring(Cs(C)-Cs-Cs(F)) + radical(Csj(Cs-CsCsH)(Cs-CsF1sH)(F1s)_ring) + radical(Csj(Cs-CsCsH)(Cs-CsF1sH)(F1s)_ring) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = '[CH2][C](F)C1C(F)(F)C1(F)F(11390)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C1[C](F)C1(F)F(11337)'],
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'F[C](F)C1[C](F)C1(F)F(9903)'],
    products = ['[CH2]C(F)(F)C1[C](F)C1(F)F(11337)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)(F)C1[C](F)C1(F)F(11337)'],
    products = ['CC(F)(F)C1=C(F)C1(F)F(11382)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)[CH]C(F)=C(F)F(3162)'],
    products = ['[CH2]C(F)(F)C1[C](F)C1(F)F(11337)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)C1=C(F)C1(F)F(11383)'],
    products = ['[CH2]C(F)(F)C1[C](F)C1(F)F(11337)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(2.97324,'m^3/(mol*s)'), n=2.12322, Ea=(1.30039,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0984061311673169, var=1.772613507237397, Tref=1000.0, N=8, data_mean=0.0, correlation='Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_2CS-inRing_N-Sp-2CS-=1CCOSS_1COS-inRing_Ext-2CS-R_Ext-4R!H-R_Ext-1COS-R',), comment="""Estimated from node Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_2CS-inRing_N-Sp-2CS-=1CCOSS_1COS-inRing_Ext-2CS-R_Ext-4R!H-R_Ext-1COS-R"""),
)

reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(F)(F)C1C(F)=C1F(11384)'],
    products = ['[CH2]C(F)(F)C1[C](F)C1(F)F(11337)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(F)C1[C](F)C1(F)F(11385)'],
    products = ['[CH2]C(F)(F)C1[C](F)C1(F)F(11337)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH2]C(F)(F)[C]1C(F)=C1F(11386)'],
    products = ['[CH2]C(F)(F)C1[C](F)C1(F)F(11337)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'C=C(F)[C]1[C](F)C1(F)F(11387)'],
    products = ['[CH2]C(F)(F)C1[C](F)C1(F)F(11337)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(247.726,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(F)(F)C1[C](F)C1(F)F(11337)'],
    products = ['CC(F)(F)[C]1[C](F)C1(F)F(11388)'],
...
reaction(
    label = 'reaction18',
    reactants = ['FCC(F)(F)C1[C](F)[C]1F(11389)'],
    products = ['[CH2]C(F)(F)C1[C](F)C1(F)F(11337)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(F)(F)C1[C](F)C1(F)F(11337)'],
    products = ['[CH2][C](F)C1C(F)(F)C1(F)F(11390)'],
...
reaction(
    label = 'reaction20',
    reactants = ['FC[C](F)C1[C](F)C1(F)F(11391)'],
    products = ['[CH2]C(F)(F)C1[C](F)C1(F)F(11337)'],
...
network(
    label = 'PDepNetwork #3418',
    isomers = [
        '[CH2]C(F)(F)C1[C](F)C1(F)F(11337)',
    ],
    reactants = [
