...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(192)', 'O=C[C]F(523)'],
    products = ['O=[C]OC=[C]F(922)'],
    transitionState = 'TS2',
