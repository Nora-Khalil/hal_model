...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C(F)=CF(892)'],
    products = ['[CH]=C(F)C([O])F(2944)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=C(F)C(=O)F(550)'],
    products = ['[CH]=C(F)C([O])F(2944)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][CH]F(2623)', '[CH]=[C]F(489)'],
    products = ['[CH]=C(F)C([O])F(2944)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH]=C=C([O])F(552)'],
    products = ['[CH]=C(F)C([O])F(2944)'],
