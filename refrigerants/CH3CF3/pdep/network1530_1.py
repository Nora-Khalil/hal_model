...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(C=O)C=[C]F(4587)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[O]C(F)C=[C]F(2946)'],
    products = ['[O]C(F)(C=O)C=[C]F(4587)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'O=CC(F)=C[C]F(3723)'],
    products = ['[O]C(F)(C=O)C=[C]F(4587)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)(C=O)C=[C]F(4587)'],
    products = ['F[C]=CC1(F)[CH]OO1(4671)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)(C=O)C=[C]F(4587)'],
    products = ['[O]C1(F)[CH]OC(F)=C1(4672)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O=CC(=O)C=[C]F(4675)'],
    products = ['[O]C(F)(C=O)C=[C]F(4587)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)(C#CF)C=O(4676)'],
    products = ['[O]C(F)(C=O)C=[C]F(4587)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', '[O]C=C([O])C#CF(4677)'],
    products = ['[O]C(F)(C=O)C=[C]F(4587)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'O=[C]C(=O)C=[C]F(4678)'],
    products = ['[O]C(F)(C=O)C=[C]F(4587)'],
