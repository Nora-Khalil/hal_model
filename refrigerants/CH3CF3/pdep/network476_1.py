...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(192)', '[O]C(F)[C](F)F(1087)'],
    products = ['O=[C]OC(F)[C](F)F(1337)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', 'O=[C]O[CH]F(1342)'],
    products = ['O=[C]OC(F)[C](F)F(1337)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[O]C(F)[C](F)F(1087)'],
    products = ['O=[C]OC(F)[C](F)F(1337)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=[C]OC(F)=C(F)F(1343)'],
    products = ['O=[C]OC(F)[C](F)F(1337)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(43)', 'O=[C]O[CH]F(1342)'],
    products = ['O=[C]OC(F)[C](F)F(1337)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]OC(F)[C](F)F(1337)'],
    products = ['O=[C]O[CH]C(F)(F)F(1346)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OC(F)[C](F)F(1337)'],
    products = ['O=C(F)O[CH][C](F)F(1347)'],
