...
reaction(
    label = 'reaction3',
    reactants = ['O=C(OF)[C](F)[CH]F(1310)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(1282)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'O=[C]C(F)(F)[CH]F(1311)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(1282)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)C(F)(F)[CH]F(1282)'],
    products = ['F[CH]C(F)(F)[C]1OO1(1312)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)C(F)(F)[CH]F(1282)'],
    products = ['[O][C]1OC(F)C1(F)F(1313)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(=O)C(F)=CF(1314)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(1282)'],
