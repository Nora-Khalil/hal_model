...
species(
    label = '[CH2][CH]C(F)(F)CC(F)F(7716)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = '[CH2]C[C](F)C(F)C(F)F(7718)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = '[CH2]CC(F)(F)C(F)[CH]F(7720)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC(F)(F)[CH]C(F)F(7601)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]C(F)F-2(957)', '[CH2]C[C](F)F(137)'],
    products = ['[CH2]CC(F)(F)[CH]C(F)F(7601)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2]CC(F)=CC(F)F(7709)'],
    products = ['[CH2]CC(F)(F)[CH]C(F)F(7601)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C=CC(F)(F)[CH]C(F)F(7710)'],
    products = ['[CH2]CC(F)(F)[CH]C(F)F(7601)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]CC(F)(F)C=CF(7711)'],
    products = ['[CH2]CC(F)(F)[CH]C(F)F(7601)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]CC(F)(F)C=C(F)F(7712)'],
    products = ['[CH2]CC(F)(F)[CH]C(F)F(7601)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[CH2]C=C(F)[CH]C(F)F(7713)'],
    products = ['[CH2]CC(F)(F)[CH]C(F)F(7601)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CC(F)(F)[CH]C(F)F(7601)'],
    products = ['C[CH]C(F)(F)[CH]C(F)F(7714)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC(F)(F)[CH]C(F)F(7601)'],
    products = ['[CH2]CC(F)(F)C[C](F)F(7715)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CC(F)(F)[CH]C(F)F(7601)'],
    products = ['[CH2][CH]C(F)(F)CC(F)F(7716)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]CC(F)(F)[CH]C(F)F(7601)'],
    products = ['CCC(F)(F)[CH][C](F)F(7717)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C[C](F)C(F)C(F)F(7718)'],
    products = ['[CH2]CC(F)(F)[CH]C(F)F(7601)'],
...
reaction(
    label = 'reaction21',
    reactants = ['FCC[C](F)[CH]C(F)F(7719)'],
    products = ['[CH2]CC(F)(F)[CH]C(F)F(7601)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]CC(F)(F)C(F)[CH]F(7720)'],
    products = ['[CH2]CC(F)(F)[CH]C(F)F(7601)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F[CH][CH]C(F)(F)CCF(7721)'],
    products = ['[CH2]CC(F)(F)[CH]C(F)F(7601)'],
...
network(
    label = 'PDepNetwork #2143',
    isomers = [
        '[CH2]CC(F)(F)[CH]C(F)F(7601)',
    ],
    reactants = [
