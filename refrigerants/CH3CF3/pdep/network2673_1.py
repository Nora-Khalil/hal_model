...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(F)F(1218)', '[CH]C=CF(4557)'],
    products = ['[CH]=CC(F)[C]=C(F)F(10635)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=CC=C=C(F)F(10670)'],
    products = ['[CH]=CC(F)[C]=C(F)F(10635)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=CC(F)=C=C(F)F(10671)'],
    products = ['[CH]=CC(F)[C]=C(F)F(10635)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C#CC(F)[C]=C(F)F(7477)'],
    products = ['[CH]=CC(F)[C]=C(F)F(10635)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH]=CC(F)C#CF(10672)'],
    products = ['[CH]=CC(F)[C]=C(F)F(10635)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[CH]=C=C[C]=C(F)F(7479)'],
    products = ['[CH]=CC(F)[C]=C(F)F(10635)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=CC(F)[C]=C(F)F(10635)'],
    products = ['[CH]C=C(F)C=C(F)F(10673)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=[C]C(F)C=C(F)F(10674)'],
    products = ['[CH]=CC(F)[C]=C(F)F(10635)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=CC(F)[C]=C(F)F(10635)'],
    products = ['[CH2]C=C(F)[C]=C(F)F(10675)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=CC(F)[C]=C(F)F(10635)'],
    products = ['[CH]=C[CH]C(F)=C(F)F(10676)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=CC(F)C(F)=[C]F(10677)'],
    products = ['[CH]=CC(F)[C]=C(F)F(10635)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[C]=[C]C(F)C=CF(10678)'],
    products = ['[CH]=CC(F)[C]=C(F)F(10635)'],
