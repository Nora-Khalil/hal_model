...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(192)', '[CH2]C[C]=O(1667)'],
    products = ['O=[C]CC[C]=O(9141)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[CH2]C[C]=O(1667)'],
    products = ['O=[C]CC[C]=O(9141)'],
    transitionState = 'TS6',
