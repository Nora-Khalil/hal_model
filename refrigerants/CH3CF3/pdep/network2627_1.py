...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'CC(=O)OF(1490)'],
    products = ['CCC(=O)OF(8828)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C[CH]C(=O)OF(9048)'],
    products = ['CCC(=O)OF(8828)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]CC(=O)OF(9049)'],
    products = ['CCC(=O)OF(8828)'],
