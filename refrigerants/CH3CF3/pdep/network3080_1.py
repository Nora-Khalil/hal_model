...
"""),
    ...
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40516,0.0619096,-8.37944e-05,6.02392e-08,-1.74698e-11,-38643.3,20.5527], Tmin=(100,'K'), Tmax=(838.554,'K')), NASAPolynomial(coeffs=[9.96605,0.0210732,-1.07467e-05,2.16494e-09,-1.55977e-13,-40079.1,-19.2413], Tmin=(838.554,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-322.04,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(F1s)(O2s-H)) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23221,0.0689042,-0.000119257,1.09704e-07,-3.89594e-11,-36354.7,23.3361], Tmin=(100,'K'), Tmax=(832.632,'K')), NASAPolynomial(coeffs=[7.19126,0.0250445,-1.28019e-05,2.49708e-09,-1.73311e-13,-36819,-1.15077], Tmin=(832.632,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-303.034,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(Cs-F1sHH)(H)) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)

species(
    label = 'F[CH]C[CH]OF(10324)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {3,S}
...
"""),
    E0 = (24.3273,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,334,575,1197,1424,3202,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.50184,'amu*angstrom^2'), symmetry=1, barrier=(11.5383,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.720639,'amu*angstrom^2'), symmetry=1, barrier=(16.5689,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0451452,'amu*angstrom^2'), symmetry=1, barrier=(16.4545,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.868903,0.0748901,-0.000123439,1.05209e-07,-3.5217e-11,3032.88,21.9619], Tmin=(100,'K'), Tmax=(797.077,'K')), NASAPolynomial(coeffs=[10.6298,0.0203919,-1.05018e-05,2.0692e-09,-1.4502e-13,1652.04,-21.8158], Tmin=(797.077,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.3273,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJO) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)

species(
    label = '[O][CH]CC(F)F(307)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41479,0.0662512,-0.000116845,1.13346e-07,-4.22381e-11,-34547,19.3669], Tmin=(100,'K'), Tmax=(826.868,'K')), NASAPolynomial(coeffs=[4.81029,0.0301754,-1.57544e-05,3.10094e-09,-2.16539e-13,-34436.8,7.69305], Tmin=(826.868,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-287.938,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(CCsJOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)C([O])F(10230)'],
    products = ['[O]C(F)C[CH]F(10231)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[CH]C[CH]F(10247)'],
    products = ['[O]C(F)C[CH]F(10231)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=CC[CH]F(10277)'],
    products = ['[O]C(F)C[CH]F(10231)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)C[CH]F(2889)'],
    products = ['[O]C(F)C[CH]F(10231)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[O]C=C[CH]F(569)'],
    products = ['[O]C(F)C[CH]F(10231)'],
