...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'C#CO[C](O)F(3095)'],
    products = ['C#COC(O)(F)F(1797)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', 'C#COC([O])(F)F(1886)'],
    products = ['C#COC(O)(F)F(1797)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[C]#COC(O)(F)F(3096)'],
    products = ['C#COC(O)(F)F(1797)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['HF(38)', 'C#COC(=O)F(3098)'],
    products = ['C#COC(O)(F)F(1797)'],
    transitionState = 'TS9',
