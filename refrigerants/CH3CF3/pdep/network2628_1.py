...
reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'O=C(O)C[C]F(9450)'],
    products = ['O=C(O)CCF(8881)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'O=C(O)CF(2137)'],
    products = ['O=C(O)CCF(8881)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[CH2]CC(=O)O(9456)'],
    products = ['O=C(O)CCF(8881)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O=C(O)[CH]CF(9459)'],
    products = ['O=C(O)CCF(8881)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C(O)C[CH]F(9460)'],
    products = ['O=C(O)CCF(8881)'],
