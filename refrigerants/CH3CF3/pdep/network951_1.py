...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH2]C([O])=O(730)'],
    products = ['[CH2]CC([O])=O(2378)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['[O][C]=O(722)', '[CH2][CH2](981)'],
    products = ['[CH2]CC([O])=O(2378)'],
