...
"""),
    E0 = (-375.38,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,562,600,623,1070,1265,1685,370,180,180,1194.4],'cm^-1')),
        HinderedRotor(inertia=(0.145346,'amu*angstrom^2'), symmetry=1, barrier=(3.34178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145977,'amu*angstrom^2'), symmetry=1, barrier=(3.35629,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64719,0.0575532,-7.45745e-05,5.63219e-08,-1.79951e-11,-45068.3,26.0923], Tmin=(100,'K'), Tmax=(750.274,'K')), NASAPolynomial(coeffs=[7.28023,0.0275201,-1.45279e-05,2.96449e-09,-2.15107e-13,-45913.6,0.534784], Tmin=(750.274,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-375.38,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CdHH)(F1s)(F1s)) + radical(Cdj(Cs-CsHH)(Cd-F1sF1s))"""),
)

species(
    label = 'FC(F)=C1CC(F)(F)C1F(3119)',
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.314698,0.0842758,-0.000100419,6.14802e-08,-1.50577e-11,-108694,27.2079], Tmin=(100,'K'), Tmax=(990.7,'K')), NASAPolynomial(coeffs=[14.6459,0.0264128,-1.2809e-05,2.52525e-09,-1.80508e-13,-111533,-41.7976], Tmin=(990.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-904.814,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(CdCFF) + group(CdCFF)"""),
)
...
species(
    label = 'F[CH][C]1CC(F)(F)C1(F)F(3122)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[CH]C(C=C(F)F)=C(F)F(3124)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.363936,0.0860406,-0.000113899,8.20601e-08,-2.40453e-11,-84779.8,29.5512], Tmin=(100,'K'), Tmax=(828.512,'K')), NASAPolynomial(coeffs=[11.5921,0.0318338,-1.57632e-05,3.09737e-09,-2.19579e-13,-86640.4,-22.5065], Tmin=(828.512,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-705.943,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(CsCsFHH) + group(CsCsFFH) + group(Cds-CdsCsH) + group(CdCFF) + radical(Allyl_T) + radical(CsCsF1sF1s)"""),
)

species(
    label = 'F[C]C(=CF)CC(F)(F)F(3127)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.187793,0.091149,-0.000131022,1.0217e-07,-3.2308e-11,-85213.5,28.9884], Tmin=(100,'K'), Tmax=(770.293,'K')), NASAPolynomial(coeffs=[11.4791,0.0325162,-1.68486e-05,3.35817e-09,-2.39183e-13,-86953.1,-22.5392], Tmin=(770.293,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-709.591,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFF) + group(CsCFHH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(CsCCl_triplet)"""),
)

species(
    label = 'F[C]=C(C[C](F)F)C(F)F(3128)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-599.956,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,190,488,555,1236,1407,167,640,1190,247.133,249.424,1837.69],'cm^-1')),
        HinderedRotor(inertia=(0.00276189,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.307299,'amu*angstrom^2'), symmetry=1, barrier=(13.213,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.465384,'amu*angstrom^2'), symmetry=1, barrier=(19.9776,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.115515,0.0928997,-0.00013458,1.04997e-07,-3.31385e-11,-72025,32.5577], Tmin=(100,'K'), Tmax=(772.424,'K')), NASAPolynomial(coeffs=[11.8201,0.0322791,-1.68421e-05,3.36491e-09,-2.39929e-13,-73832.9,-20.886], Tmin=(772.424,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-599.956,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(CsCFFH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(Csj(Cs-CdHH)(F1s)(F1s)) + radical(Cdj(Cd-CsCs)(F1s))"""),
)
...
"""),
    E0 = (-178.119,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,615,860,1140,1343,3152,1685,370,288.539,292.388,1337.85],'cm^-1')),
        HinderedRotor(inertia=(0.0900494,'amu*angstrom^2'), symmetry=1, barrier=(5.4938,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0919288,'amu*angstrom^2'), symmetry=1, barrier=(5.51822,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.925,0.0506399,-6.06771e-05,4.38925e-08,-1.36835e-11,-21352.6,23.6183], Tmin=(100,'K'), Tmax=(762.848,'K')), NASAPolynomial(coeffs=[6.49195,0.0266932,-1.35907e-05,2.74312e-09,-1.98194e-13,-22049.3,2.82161], Tmin=(762.848,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-178.119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CdHH)(F1s)(F1s)) + radical(Cdj(Cs-CsHH)(Cd-F1sH))"""),
)
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.28385,0.0846265,-0.000100673,6.12364e-08,-1.48663e-11,-110789,27.4252], Tmin=(100,'K'), Tmax=(1000.23,'K')), NASAPolynomial(coeffs=[14.9887,0.0258217,-1.24871e-05,2.4605e-09,-1.75894e-13,-113731,-43.5206], Tmin=(1000.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-922.248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + group(CdCFF)"""),
)

species(
    label = 'F[C](F)[C]1CC(F)(F)C1F(3131)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.432296,0.0862127,-0.000115844,8.68143e-08,-2.69293e-11,-87423.5,31.0286], Tmin=(100,'K'), Tmax=(778.389,'K')), NASAPolynomial(coeffs=[10.2176,0.0359286,-1.89453e-05,3.82417e-09,-2.75159e-13,-88946.9,-13.7284], Tmin=(778.389,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-727.89,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + group(CsCFHH) + group(CsCFFH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Csj(Cd-CsCd)(F1s)(H)) + radical(Csj(Cd-CdH)(F1s)(F1s))"""),
)

species(
    label = 'F[C]C(CC(F)F)=C(F)F(3133)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-663.666,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,350,440,435,1725,182,240,577,636,1210,1413,313.886,313.934,313.945,313.952,313.953],'cm^-1')),
        HinderedRotor(inertia=(0.141152,'amu*angstrom^2'), symmetry=1, barrier=(9.86885,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00171109,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00869092,'amu*angstrom^2'), symmetry=1, barrier=(30.9934,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.233018,0.0921839,-0.000130271,9.36878e-08,-2.41265e-11,-79693.8,29.2472], Tmin=(100,'K'), Tmax=(618.488,'K')), NASAPolynomial(coeffs=[11.0755,0.0339439,-1.78419e-05,3.56435e-09,-2.53709e-13,-81262.2,-19.6893], Tmin=(618.488,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-663.666,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(CdCFF) + radical(CsCCl_triplet)"""),
)

species(
    label = '[CH]C(CC(F)(F)F)=C(F)F(3134)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.31592,0.0859932,-9.7486e-05,6.05192e-08,-1.55146e-11,-88273,29.3832], Tmin=(100,'K'), Tmax=(935.239,'K')), NASAPolynomial(coeffs=[12.0027,0.0360093,-1.73185e-05,3.37352e-09,-2.38921e-13,-90458.9,-26.2161], Tmin=(935.239,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-735.011,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFF) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFF) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=C(C[C](F)F)C(F)(F)F(3135)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-660.202,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,219,296,586,564,718,793,1177,1228,350,440,435,1725,190,488,555,1236,1407,3120,650,792.5,1650,316.96,1907.54],'cm^-1')),
        HinderedRotor(inertia=(0.14845,'amu*angstrom^2'), symmetry=1, barrier=(10.9229,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148473,'amu*angstrom^2'), symmetry=1, barrier=(10.9232,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.320112,'amu*angstrom^2'), symmetry=1, barrier=(22.6939,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.287327,0.0868942,-0.000109287,7.12345e-08,-1.86649e-11,-79274.7,30.6098], Tmin=(100,'K'), Tmax=(925.969,'K')), NASAPolynomial(coeffs=[13.8578,0.0282724,-1.4324e-05,2.86463e-09,-2.059e-13,-81787.9,-33.8164], Tmin=(925.969,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-660.202,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(CsCdFFF) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Csj(Cs-CdHH)(F1s)(F1s)) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(3001)'],
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(138)', '[CH2]C([CH]F)=C(F)F(3117)'],
    products = ['F[CH]C(C[C](F)F)=C(F)F(3001)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(804)', 'F[C](F)C[C]=C(F)F(3118)'],
    products = ['F[CH]C(C[C](F)F)=C(F)F(3001)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(3001)'],
    products = ['FC(F)=C1CC(F)(F)C1F(3119)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(3001)'],
    products = ['FCC(C=C(F)F)=C(F)F(3120)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(3001)'],
    products = ['F[CH][C]1CC(F)(F)C1(F)F(3122)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(3001)'],
    products = ['F[CH]C1([C](F)F)CC1(F)F(3123)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'F[CH]C(C=C(F)F)=C(F)F(3124)'],
    products = ['F[CH]C(C[C](F)F)=C(F)F(3001)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', '[CH2]C([CH]F)=C(F)F(3117)'],
    products = ['F[CH]C(C[C](F)F)=C(F)F(3001)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', 'F[C](F)C[C]=C(F)F(3118)'],
    products = ['F[CH]C(C[C](F)F)=C(F)F(3001)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(3001)'],
    products = ['FC[C](C=C(F)F)[C](F)F(3126)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(3001)'],
    products = ['F[C]C(=CF)CC(F)(F)F(3127)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C]=C(C[C](F)F)C(F)F(3128)'],
    products = ['F[CH]C(C[C](F)F)=C(F)F(3001)'],
...
reaction(
    label = 'reaction3',
    reactants = ['FC=[C]C(F)(F)C[C](F)F(3003)'],
    products = ['F[CH]C(C[C](F)F)=C(F)F(3001)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C]F(138)', 'FC=[C]C[C](F)F(493)'],
    products = ['F[CH]C(C[C](F)F)=C(F)F(3001)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(3001)'],
    products = ['FC=C(C=C(F)F)C(F)F(3130)'],
...
reaction(
    label = 'reaction25',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(3001)'],
    products = ['F[C](F)[C]1CC(F)(F)C1F(3131)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CF2(43)', 'FC=[C]C[C](F)F(493)'],
    products = ['F[CH]C(C[C](F)F)=C(F)F(3001)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(3001)'],
    products = ['F[CH]C(=C[C](F)F)C(F)F(3132)'],
...
reaction(
    label = 'reaction28',
    reactants = ['F[C]C(CC(F)F)=C(F)F(3133)'],
    products = ['F[CH]C(C[C](F)F)=C(F)F(3001)'],
...
reaction(
    label = 'reaction29',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(3001)'],
    products = ['[CH]C(CC(F)(F)F)=C(F)F(3134)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]=C(C[C](F)F)C(F)(F)F(3135)'],
    products = ['F[CH]C(C[C](F)F)=C(F)F(3001)'],
