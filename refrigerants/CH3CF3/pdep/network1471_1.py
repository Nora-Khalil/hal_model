...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C](F)F(163)', '[CH]C(=O)F(537)'],
    products = ['O=C(F)[CH]OO[C](F)F(4274)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', '[O]O[CH]C(=O)F(4228)'],
    products = ['O=C(F)[CH]OO[C](F)F(4274)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction5',
    reactants = ['O=C(F)[CH]OO[C](F)F(4274)'],
    products = ['F[C](F)OOC1O[C]1F(4644)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=C=COO[C](F)F(4647)'],
    products = ['O=C(F)[CH]OO[C](F)F(4274)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(43)', '[O]O[CH]C(=O)F(4228)'],
    products = ['O=C(F)[CH]OO[C](F)F(4274)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=C(F)[CH]OO[C](F)F(4274)'],
    products = ['O=[C][CH]OOC(F)(F)F(4648)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O(6)', 'F[C]=COO[C](F)F(4649)'],
    products = ['O=C(F)[CH]OO[C](F)F(4274)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=C(F)[CH]OO[C](F)F(4274)'],
    products = ['[O][C](F)C1OOC1(F)F(4651)'],
...
reaction(
    label = 'reaction21',
    reactants = ['OC(F)=[C]OO[C](F)F(4652)'],
    products = ['O=C(F)[CH]OO[C](F)F(4274)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O=C(F)[C]OOC(F)F(4653)'],
    products = ['O=C(F)[CH]OO[C](F)F(4274)'],
...
network(
    ...
    isomers = [
        'O=C(F)[CH]OO[C](F)F(4274)',
    ],
    reactants = [
        ('CF2O(49)', 'O=CC(=O)F(4234)'),
        ('CF2(43)', '[O]O[CH]C(=O)F(4228)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
