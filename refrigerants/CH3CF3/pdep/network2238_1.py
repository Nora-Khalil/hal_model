...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.226169,'amu*angstrom^2'), symmetry=1, barrier=(5.20008,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.225464,'amu*angstrom^2'), symmetry=1, barrier=(5.18385,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.55899,'amu*angstrom^2'), symmetry=1, barrier=(35.8442,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.399467,0.0860557,-0.000137704,1.16429e-07,-3.92348e-11,-60194.7,28.9444], Tmin=(100,'K'), Tmax=(766.598,'K')), NASAPolynomial(coeffs=[11.1554,0.026376,-1.39696e-05,2.77161e-09,-1.95426e-13,-61739.3,-19.4062], Tmin=(766.598,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-501.511,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(CsFHHO) + group(Cds-CdsCsH) + group(CdCFF) + radical(Csj(F1s)(O2s-Cs)(H)) + radical(Cdj(Cs-F1sO2sH)(Cd-F1sF1s))"""),
)
...
"""),
    ...
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.794844,0.0716829,-8.31712e-05,4.7783e-08,-1.08589e-11,-90851,25.1879], Tmin=(100,'K'), Tmax=(1069.39,'K')), NASAPolynomial(coeffs=[14.8134,0.019247,-9.62083e-06,1.93092e-09,-1.39671e-13,-93849.3,-43.3841], Tmin=(1069.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-756.33,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsFHHO) + group(CdCddFO) + group(CdCddFF) + group(Cdd-CdsCds)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.06991,'amu*angstrom^2'), symmetry=1, barrier=(24.5994,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.275425,0.0705242,-8.18473e-05,4.38781e-08,-8.8231e-12,-47087.7,26.0887], Tmin=(100,'K'), Tmax=(1321.22,'K')), NASAPolynomial(coeffs=[20.8228,0.00351562,-3.20677e-07,-9.42069e-12,1.68014e-15,-52098.1,-77.1785], Tmin=(1321.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-392.705,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsFHHO) + group(Cds-CdsOsH) + group(CdCddFF) + group(Cdd-CdsCds) + radical(Csj(F1s)(O2s-Cd)(H))"""),
)
...
"""),
    E0 = (-558.64,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([197,221,431,657,580,1155,1237,1373,3147,94,120,354,641,825,1294,540,610,2055,399.939,401.299,417.452,1122.89],'cm^-1')),
        HinderedRotor(inertia=(0.13559,'amu*angstrom^2'), symmetry=1, barrier=(16.927,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.010078,'amu*angstrom^2'), symmetry=1, barrier=(16.905,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.703513,0.0759109,-0.000102513,6.80038e-08,-1.76964e-11,-67073,26.2676], Tmin=(100,'K'), Tmax=(941.984,'K')), NASAPolynomial(coeffs=[14.5349,0.0171793,-8.99214e-06,1.81845e-09,-1.31448e-13,-69678.9,-39.6347], Tmin=(941.984,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-558.64,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsFHHO) + group(CdCddFO) + group(CdCddFF) + group(Cdd-CdsCds) + radical(Csj(F1s)(O2s-Cd)(H))"""),
)

species(
    label = 'FC#CC(F)O[CH]F(7980)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-308.134,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([242,464,653,889,1056,1342,3790,580,1155,1237,1373,3147,2175,525,239,401,1367,180,180,180,864.456],'cm^-1')),
        HinderedRotor(inertia=(0.0955958,'amu*angstrom^2'), symmetry=1, barrier=(2.19794,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0954951,'amu*angstrom^2'), symmetry=1, barrier=(2.19562,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.3607,'amu*angstrom^2'), symmetry=1, barrier=(54.277,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.921968,0.076454,-0.000132672,1.21064e-07,-4.26232e-11,-36957.5,24.2217], Tmin=(100,'K'), Tmax=(838.72,'K')), NASAPolynomial(coeffs=[7.75058,0.0269918,-1.39956e-05,2.71464e-09,-1.87346e-13,-37508.8,-3.97879], Tmin=(838.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-308.134,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(CsFHHO) + group(Ct-CtCs) + group(CtCF) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    ...
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.645439,0.0787197,-0.000104403,7.02873e-08,-1.88558e-11,-74581.9,27.3876], Tmin=(100,'K'), Tmax=(908.352,'K')), NASAPolynomial(coeffs=[13.3629,0.0227162,-1.192e-05,2.40995e-09,-1.74003e-13,-76892.3,-32.7441], Tmin=(908.352,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-621.079,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFH) + group(CsFHHO) + group(Cds-CdsCsH) + group(CdCFO) + radical(Csj(Cd-CdH)(F1s)(F1s)) + radical(Csj(F1s)(O2s-Cd)(H))"""),
)

species(
    label = 'FCOC(F)=[C][C](F)F(7982)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0859,0.071487,-0.000111418,1.01722e-07,-3.75592e-11,-71609.4,30.3486], Tmin=(100,'K'), Tmax=(777.091,'K')), NASAPolynomial(coeffs=[6.36038,0.0336154,-1.76196e-05,3.49712e-09,-2.47118e-13,-72105.4,8.31543], Tmin=(777.091,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-596.207,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(CsFFHO) + group(Cds-CdsCsH) + group(CdCFF) + radical(C=CCJ(O)C) + radical(Cdj(Cs-O2sHH)(Cd-F1sF1s))"""),
)

species(
    label = 'F[CH]O[CH]C(F)=C(F)F(7984)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.54605,0.0886502,-0.000162684,1.56032e-07,-5.69042e-11,-71200.2,29.0249], Tmin=(100,'K'), Tmax=(841.496,'K')), NASAPolynomial(coeffs=[6.11787,0.0350298,-1.87341e-05,3.66868e-09,-2.54085e-13,-71177.2,8.81416], Tmin=(841.496,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-592.924,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(CsFHHO) + group(CdCsCdF) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F)) + radical(C=CCJ(O)C) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)

species(
    label = 'F[C]=[C]C(F)OC(F)F(7985)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-484.374,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([162,485,641,721,926,1292,1380,3063,519,593,830,1115,1166,1389,1413,3114,1685,370,167,640,1190,180,180,1933.46],'cm^-1')),
        HinderedRotor(inertia=(0.434246,'amu*angstrom^2'), symmetry=1, barrier=(9.98418,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.435107,'amu*angstrom^2'), symmetry=1, barrier=(10.004,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.68873,'amu*angstrom^2'), symmetry=1, barrier=(38.8271,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.593878,0.0824899,-0.000133945,1.17997e-07,-4.14974e-11,-58141.4,29.4662], Tmin=(100,'K'), Tmax=(777.315,'K')), NASAPolynomial(coeffs=[9.33324,0.029375,-1.57349e-05,3.13659e-09,-2.21674e-13,-59254,-8.91228], Tmin=(777.315,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-484.374,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(CsFFHO) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cs-F1sO2sH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'F[C]=C(F)C(F)O[CH]F(7986)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-478.746,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([236,527,855,1015,1182,1348,3236,246,474,533,1155,580,1155,1237,1373,3147,167,640,1190,180,180,180,180,2057.81],'cm^-1')),
        HinderedRotor(inertia=(0.178454,'amu*angstrom^2'), symmetry=1, barrier=(4.10301,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.98822,'amu*angstrom^2'), symmetry=1, barrier=(45.713,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.174539,'amu*angstrom^2'), symmetry=1, barrier=(4.013,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.267958,0.0920899,-0.000161389,1.46209e-07,-5.12379e-11,-57455.1,28.6884], Tmin=(100,'K'), Tmax=(828.006,'K')), NASAPolynomial(coeffs=[9.55671,0.0294714,-1.58028e-05,3.10705e-09,-2.16126e-13,-58385,-10.6979], Tmin=(828.006,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-478.746,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CsFHHO) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Csj(F1s)(O2s-Cs)(H)) + radical(Cdj(Cd-CsF1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]OC(F)[C]=C(F)F(7288)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(804)', '[O]C(F)[C]=C(F)F(7169)'],
    products = ['F[CH]OC(F)[C]=C(F)F(7288)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(F)F(1218)', 'F[CH]O[CH]F(2975)'],
    products = ['F[CH]OC(F)[C]=C(F)F(7288)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[CH]OC=C=C(F)F(7978)'],
    products = ['F[CH]OC(F)[C]=C(F)F(7288)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[CH]OC(F)=C=C(F)F(7979)'],
    products = ['F[CH]OC(F)[C]=C(F)F(7288)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'FC#CC(F)O[CH]F(7980)'],
    products = ['F[CH]OC(F)[C]=C(F)F(7288)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', '[O]C(F)[C]=C(F)F(7169)'],
    products = ['F[CH]OC(F)[C]=C(F)F(7288)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[CH]OC(F)[C]=C(F)F(7288)'],
    products = ['F[CH]OC(F)=C[C](F)F(7981)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[CH]OC(F)[C]=C(F)F(7288)'],
    products = ['FC(F)=[C][CH]OC(F)F(7983)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]OC(F)[C]=C(F)F(7288)'],
    products = ['F[CH]O[CH]C(F)=C(F)F(7984)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[C]=[C]C(F)OC(F)F(7985)'],
    products = ['F[CH]OC(F)[C]=C(F)F(7288)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C]=C(F)C(F)O[CH]F(7986)'],
    products = ['F[CH]OC(F)[C]=C(F)F(7288)'],
...
network(
    label = 'PDepNetwork #2238',
    isomers = [
        'F[CH]OC(F)[C]=C(F)F(7288)',
    ],
    reactants = [
