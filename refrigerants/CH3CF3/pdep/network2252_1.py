...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'OC(F)OF(5774)'],
    products = ['OCC(F)OF(7901)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', '[CH2]C(F)OF(5950)'],
    products = ['OCC(F)OF(7901)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(127)', 'OC[CH]F(7927)'],
    products = ['OCC(F)OF(7901)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]OF(3905)', 'CH2OH(33)'],
    products = ['OCC(F)OF(7901)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'O[CH]C(F)OF(7928)'],
    products = ['OCC(F)OF(7901)'],
