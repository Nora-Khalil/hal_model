...
reaction(
    label = 'reaction5',
    reactants = ['O=C(F)C=C[C]F(5082)'],
    products = ['F[C]=CC1O[C]1F(4014)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[C]=CC1=C(F)O1(6414)'],
    products = ['F[C]=CC1O[C]1F(4014)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'FC#CC1O[C]1F(6415)'],
    products = ['F[C]=CC1O[C]1F(4014)'],
    transitionState = 'TS9',
