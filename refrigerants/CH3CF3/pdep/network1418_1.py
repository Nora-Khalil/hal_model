...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.34764,'amu*angstrom^2'), symmetry=1, barrier=(53.9769,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.34072,'amu*angstrom^2'), symmetry=1, barrier=(53.8179,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45082,0.0728392,-0.000157636,1.63854e-07,-6.13797e-11,-6564.67,33.2504], Tmin=(100,'K'), Tmax=(875.718,'K')), NASAPolynomial(coeffs=[1.36053,0.0320789,-1.72944e-05,3.32677e-09,-2.25219e-13,-4970.12,42.688], Tmin=(875.718,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-55.2119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + missing(O2d-Cdd) + group(Cd(Cdd-Od)FO) + group(CsJ2_singlet-CsH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    ...
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.63075,0.0350501,-6.19848e-05,6.01734e-08,-2.24423e-11,-21878.3,13.9844], Tmin=(100,'K'), Tmax=(823.674,'K')), NASAPolynomial(coeffs=[4.51981,0.015692,-8.18489e-06,1.61741e-09,-1.13281e-13,-21844,7.33438], Tmin=(823.674,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + missing(O2d-Cdd) + group(CJ2_singlet-FO) + group(Cdd-CdsCds) + missing(Cdd-CddO2d)"""),
)

species(
    label = 'O=C=C(F)[OH+][C-]=O(4994)',
    structure = adjacencyList("""1 F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.10798,0.0531455,-0.000111819,1.17103e-07,-4.47428e-11,13663.1,18.6479], Tmin=(100,'K'), Tmax=(854.729,'K')), NASAPolynomial(coeffs=[2.18963,0.0250378,-1.38351e-05,2.72751e-09,-1.88617e-13,14661.9,24.1913], Tmin=(854.729,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.127,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + missing(O2d-C2dc) + missing(O2d-Cdd) + group(Cd(Cdd-Od)FO) + group(CsJ2_singlet-CsH) + missing(Cdd-CdO2d)"""),
)

species(
    label = 'O=C(F)C(=O)[C-]=[OH+](4995)',
...
"""),
    ...
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78433,0.0590802,-0.000115446,1.16592e-07,-4.41097e-11,-25078.2,22.5922], Tmin=(100,'K'), Tmax=(837.741,'K')), NASAPolynomial(coeffs=[3.74746,0.0262356,-1.46109e-05,2.90485e-09,-2.02755e-13,-24583.5,18.3844], Tmin=(837.741,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-209.092,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cds-OdCsCs) + group(COCFO) + group(CsJ2_singlet-CsH)"""),
)
