...
"""),
    ...
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.486468,0.106468,-0.000155563,1.15718e-07,-3.41909e-11,-134638,29.6042], Tmin=(100,'K'), Tmax=(828.39,'K')), NASAPolynomial(coeffs=[15.5101,0.02923,-1.57113e-05,3.17474e-09,-2.27918e-13,-137288,-44.559], Tmin=(828.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1120.73,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + group(Cds-CdsCsH) + group(CdCFH)"""),
)
...
species(
    label = 'F[CH]C=C(F)C(F)(F)OF(3689)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.09811,'amu*angstrom^2'), symmetry=1, barrier=(25.2478,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.476167,'amu*angstrom^2'), symmetry=1, barrier=(10.948,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.477175,'amu*angstrom^2'), symmetry=1, barrier=(10.9712,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.186426,0.0998355,-0.000155276,1.23771e-07,-3.91627e-11,-78138.2,29.4062], Tmin=(100,'K'), Tmax=(775.256,'K')), NASAPolynomial(coeffs=[13.8849,0.0272352,-1.48099e-05,2.98375e-09,-2.12886e-13,-80320,-34.8984], Tmin=(775.256,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-650.871,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    label = 'FC=[C]C(F)(F)C(F)(F)OF(3693)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.269735,'amu*angstrom^2'), symmetry=1, barrier=(6.20174,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.269849,'amu*angstrom^2'), symmetry=1, barrier=(6.20437,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.38351,'amu*angstrom^2'), symmetry=1, barrier=(31.8095,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (179.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.599281,0.11028,-0.000184821,1.58339e-07,-5.35633e-11,-99732.3,32.8728], Tmin=(100,'K'), Tmax=(768.425,'K')), NASAPolynomial(coeffs=[13.9701,0.0292025,-1.63283e-05,3.28914e-09,-2.33194e-13,-101817,-32.572], Tmin=(768.425,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-830.526,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cs-F1sF1sCs)(Cd-F1sH))"""),
)

species(
    label = 'F[C]=CC(F)(F)C(F)(F)OF(3694)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.244541,'amu*angstrom^2'), symmetry=1, barrier=(5.62249,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244484,'amu*angstrom^2'), symmetry=1, barrier=(5.62118,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (179.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.688126,0.112367,-0.000190491,1.63354e-07,-5.49529e-11,-100825,32.1366], Tmin=(100,'K'), Tmax=(787.884,'K')), NASAPolynomial(coeffs=[14.404,0.0281321,-1.5627e-05,3.12799e-09,-2.20507e-13,-102967,-35.5764], Tmin=(787.884,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-839.641,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'FC[C]C(F)(F)C(F)(F)OF(3695)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.00227,0.121704,-0.000209002,1.85576e-07,-6.45409e-11,-92615.3,43.0571], Tmin=(100,'K'), Tmax=(802.149,'K')), NASAPolynomial(coeffs=[12.8889,0.0365859,-2.01981e-05,4.03004e-09,-2.83461e-13,-94334,-17.7189], Tmin=(802.149,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-771.452,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)C(F)(F)C(F)(F)OF(3696)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-770.418,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,222,329,445,522,589,1214,1475,223,363,546,575,694,1179,1410,353,444,1253,3145,180,180,180,310.076,851.362,1600,1828.57,2971.43,3200],'cm^-1')),
        HinderedRotor(inertia=(0.151987,'amu*angstrom^2'), symmetry=1, barrier=(3.49448,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151987,'amu*angstrom^2'), symmetry=1, barrier=(3.49448,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151987,'amu*angstrom^2'), symmetry=1, barrier=(3.49448,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151987,'amu*angstrom^2'), symmetry=1, barrier=(3.49448,'kJ/mol'), semiclassical=False),
    ],
...
"""),
    E0 = (-864.761,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,222,329,445,522,589,1214,1475,223,363,546,575,694,1179,1410,2750,2850,1437.5,1250,1305,750,350,617,898,1187,245.791,245.791,245.791],'cm^-1')),
        HinderedRotor(inertia=(0.208344,'amu*angstrom^2'), symmetry=1, barrier=(8.93183,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.871563,'amu*angstrom^2'), symmetry=1, barrier=(37.3643,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.208344,'amu*angstrom^2'), symmetry=1, barrier=(8.93182,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.208345,'amu*angstrom^2'), symmetry=1, barrier=(8.93183,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.908211,0.117214,-0.000194989,1.65403e-07,-5.51731e-11,-103839,33.2403], Tmin=(100,'K'), Tmax=(787.794,'K')), NASAPolynomial(coeffs=[14.8837,0.030213,-1.63529e-05,3.24701e-09,-2.28117e-13,-106115,-37.8368], Tmin=(787.794,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-864.761,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsCsHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0682575,'amu*angstrom^2'), symmetry=1, barrier=(1.57884,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.633657,'amu*angstrom^2'), symmetry=1, barrier=(14.569,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.522559,0.0834053,-0.000130311,1.1014e-07,-3.75553e-11,-60526.5,25.5555], Tmin=(100,'K'), Tmax=(736.313,'K')), NASAPolynomial(coeffs=[10.3503,0.028458,-1.51982e-05,3.04083e-09,-2.16013e-13,-61931.5,-18.5623], Tmin=(736.313,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-504.233,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CdCCF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-Cds(Cds-Cds)H) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH)"""),
)

species(
    label = 'FC=C=C(F)C(F)(F)OF(3700)',
...
"""),
    E0 = (-687.112,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,275,321,533,585,746,850,1103,145,326,398,834,1303,113,247,382,1207,3490,540,610,2055,180,812.304,812.439],'cm^-1')),
        HinderedRotor(inertia=(0.151286,'amu*angstrom^2'), symmetry=1, barrier=(3.47835,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151415,'amu*angstrom^2'), symmetry=1, barrier=(3.48133,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.289975,0.0927118,-0.000136302,8.41775e-08,-9.40798e-12,-82517.7,26.5647], Tmin=(100,'K'), Tmax=(576.025,'K')), NASAPolynomial(coeffs=[12.8059,0.0257667,-1.39688e-05,2.77143e-09,-1.94474e-13,-84290.8,-29.7888], Tmin=(576.025,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-687.112,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(CdCddCF) + group(CdCddFH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'C#CC(F)(F)C(F)(F)OF(3701)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.39311,'amu*angstrom^2'), symmetry=1, barrier=(32.0304,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.690408,'amu*angstrom^2'), symmetry=1, barrier=(15.8738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.20893,'amu*angstrom^2'), symmetry=1, barrier=(50.7877,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.318658,0.101474,-0.000166248,1.35368e-07,-4.29149e-11,-87892,27.0844], Tmin=(100,'K'), Tmax=(814.094,'K')), NASAPolynomial(coeffs=[15.2317,0.0210931,-1.08177e-05,2.08695e-09,-1.43797e-13,-90292.2,-43.9299], Tmin=(814.094,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-732.018,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Ct-CtCs) + group(Ct-CtH)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.116939,0.094132,-0.000165495,1.45975e-07,-5.02059e-11,-65986.4,25.9907], Tmin=(100,'K'), Tmax=(797.357,'K')), NASAPolynomial(coeffs=[12.0692,0.0238102,-1.37108e-05,2.77053e-09,-1.95884e-13,-67563.1,-26.8998], Tmin=(797.357,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-549.735,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['FC=CC(F)(F)C(F)(F)OF(3078)'],
...
reaction(
    ...
    products = ['FC=CC(F)(F)C(F)(F)OF(3078)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]C(F)(F)OF(324)', 'CHFCHF[Z](59)'],
    products = ['FC=CC(F)(F)C(F)(F)OF(3078)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FOC(F)(F)F(326)', 'F[C]C=CF-2(3685)'],
    products = ['FC=CC(F)(F)C(F)(F)OF(3078)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(328)', 'F[C]C(F)(F)C=CF(3686)'],
    products = ['FC=CC(F)(F)C(F)(F)OF(3078)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['FC=CC(F)(F)C(F)(F)OF(3078)'],
    products = ['FC=CC(F)(OF)C(F)(F)F(3687)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FOF(328)', 'FC=CC(F)=C(F)F(1081)'],
    products = ['FC=CC(F)(F)C(F)(F)OF(3078)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['FC=CC(F)(F)C(F)(F)OF(3078)'],
    products = ['FOC(F)(F)C(F)=CC(F)F(3688)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['FOC(F)(F)C(F)C=C(F)F(3077)'],
    products = ['FC=CC(F)(F)C(F)(F)OF(3078)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'F[CH]C=C(F)C(F)(F)OF(3689)'],
    products = ['FC=CC(F)(F)C(F)(F)OF(3078)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FC=CC(F)(F)[C](F)OF(3690)'],
    products = ['FC=CC(F)(F)C(F)(F)OF(3078)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH]=CC(F)(F)C(F)(F)OF(3691)'],
    products = ['FC=CC(F)(F)C(F)(F)OF(3078)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(127)', 'FC=CC(F)(F)[C](F)F(2519)'],
    products = ['FC=CC(F)(F)C(F)(F)OF(3078)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FO[C](F)F(236)', 'F[CH]C=C(F)F(1320)'],
    products = ['FC=CC(F)(F)C(F)(F)OF(3078)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FOC(F)(F)[C](F)F(336)', 'CHFCH[Z](71)'],
    products = ['FC=CC(F)(F)C(F)(F)OF(3078)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'FC=[C]C(F)(F)C(F)(F)OF(3693)'],
    products = ['FC=CC(F)(F)C(F)(F)OF(3078)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'F[C]=CC(F)(F)C(F)(F)OF(3694)'],
    products = ['FC=CC(F)(F)C(F)(F)OF(3078)'],
...
reaction(
    label = 'reaction19',
    reactants = ['FC[C]C(F)(F)C(F)(F)OF(3695)'],
    products = ['FC=CC(F)(F)C(F)(F)OF(3078)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]C(F)C(F)(F)C(F)(F)OF(3696)'],
    products = ['FC=CC(F)(F)C(F)(F)OF(3078)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[C]CC(F)(F)C(F)(F)OF(3697)'],
    products = ['FC=CC(F)(F)C(F)(F)OF(3078)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F2(78)', 'O=C(F)C(F)(F)C=CF(3698)'],
    products = ['FC=CC(F)(F)C(F)(F)OF(3078)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F2(78)', 'FC=CC(F)=C(F)OF(3699)'],
    products = ['FC=CC(F)(F)C(F)(F)OF(3078)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'FC=C=C(F)C(F)(F)OF(3700)'],
    products = ['FC=CC(F)(F)C(F)(F)OF(3078)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'C#CC(F)(F)C(F)(F)OF(3701)'],
    products = ['FC=CC(F)(F)C(F)(F)OF(3078)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CHF(40)', '[CH]C(F)(F)C(F)(F)OF(3702)'],
    products = ['FC=CC(F)(F)C(F)(F)OF(3078)'],
