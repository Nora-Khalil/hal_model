species(
    label = 'F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)',
...
species(
    label = 'FC(F)=C1C(F)C(F)(F)C1(F)F(3590)',
...
species(
    label = 'FC(F)=C=C(F)C(F)(F)C(F)F(3591)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (194.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.824922,0.115552,-0.000191445,1.63615e-07,-5.50177e-11,-147167,33.6554], Tmin=(100,'K'), Tmax=(796.189,'K')), NASAPolynomial(coeffs=[14.0138,0.031991,-1.70398e-05,3.36471e-09,-2.35685e-13,-149245,-32.7568], Tmin=(796.189,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1224.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CdCddCF) + group(CdCddFF) + group(Cdd-CdsCds)"""),
)
...
species(
    label = 'F[C](F)C(F)(F)C=C=C(F)F(3592)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.297767,'amu*angstrom^2'), symmetry=1, barrier=(6.84625,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (175.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.328867,0.104536,-0.000176114,1.53662e-07,-5.26402e-11,-101658,32.6195], Tmin=(100,'K'), Tmax=(800.994,'K')), NASAPolynomial(coeffs=[12.2374,0.0305358,-1.64765e-05,3.26738e-09,-2.2925e-13,-103310,-22.9652], Tmin=(800.994,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-846.453,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cds-CdsCsH) + group(CdCddFF) + group(Cdd-CdsCds) + radical(Csj(Cs-F1sF1sCd)(F1s)(F1s))"""),
)
...
species(
    label = 'F[C](F)C(F)(F)C(F)=C=C(F)F(3593)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.106515,'amu*angstrom^2'), symmetry=1, barrier=(2.44898,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.106157,'amu*angstrom^2'), symmetry=1, barrier=(2.44075,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (193.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.846072,0.11848,-0.000211015,1.87464e-07,-6.40842e-11,-122608,34.8617], Tmin=(100,'K'), Tmax=(834.205,'K')), NASAPolynomial(coeffs=[13.2984,0.0305435,-1.67268e-05,3.29237e-09,-2.28349e-13,-124268,-26.6184], Tmin=(834.205,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1020.77,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CdCddCF) + group(CdCddFF) + group(Cdd-CdsCds) + radical(Csj(Cs-F1sF1sCd)(F1s)(F1s))"""),
)

species(
    label = 'FC#CC(F)C(F)(F)[C](F)F(3594)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.13639,'amu*angstrom^2'), symmetry=1, barrier=(3.13588,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136507,'amu*angstrom^2'), symmetry=1, barrier=(3.13857,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (175.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.72084,0.118114,-0.000218848,2.00011e-07,-6.92456e-11,-92982.5,32.1719], Tmin=(100,'K'), Tmax=(856.979,'K')), NASAPolynomial(coeffs=[11.3622,0.0323794,-1.74358e-05,3.38166e-09,-2.31376e-13,-93976.2,-17.9715], Tmin=(856.979,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-774.4,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCCFH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Ct-CtCs) + group(CtCF) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s))"""),
)
...
species(
    label = 'F[C](F)C(F)=C(F)[C]=C(F)F(3595)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-690.459,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([271,519,563,612,1379,86,203,488,582,605,741,161,297,490,584,780,1358,562,600,623,1070,1265,1685,370,649.971],'cm^-1')),
        HinderedRotor(inertia=(2.19322,'amu*angstrom^2'), symmetry=1, barrier=(50.4264,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00994649,'amu*angstrom^2'), symmetry=1, barrier=(50.2301,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (174.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.10118,0.0932054,-0.000136992,1.03117e-07,-3.0983e-11,-82909.3,33.4949], Tmin=(100,'K'), Tmax=(813.279,'K')), NASAPolynomial(coeffs=[13.5605,0.0270086,-1.49012e-05,3.03733e-09,-2.19017e-13,-85098.6,-28.6568], Tmin=(813.279,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-690.459,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCCF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-Cds(Cds-Cds)H) + group(CdCFF) + radical(Csj(Cd-F1sCd)(F1s)(F1s)) + radical(Cdj(Cd-F1sCd)(Cd-F1sF1s))"""),
)
...
species(
    label = 'F[C]([C]=C(F)F)C(F)(F)C(F)F(3597)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (194.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.630914,0.111444,-0.000176471,1.47653e-07,-4.96358e-11,-124331,35.8495], Tmin=(100,'K'), Tmax=(727.8,'K')), NASAPolynomial(coeffs=[13.2156,0.0353432,-1.96276e-05,3.98374e-09,-2.85257e-13,-126346,-26.5522], Tmin=(727.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1035.06,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCCFH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cds-CdsCsH) + group(CdCFF) + radical(CsCdCsF1s) + radical(Cdj(Cs-F1sCsH)(Cd-F1sF1s))"""),
)

species(
    label = 'F[C](C(F)[C]=C(F)F)C(F)(F)F(3598)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C]=[C]C(F)C(F)(F)C(F)(F)F(3602)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.138777,'amu*angstrom^2'), symmetry=1, barrier=(3.19076,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136807,'amu*angstrom^2'), symmetry=1, barrier=(3.14545,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.305223,'amu*angstrom^2'), symmetry=1, barrier=(7.01767,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (194.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.01976,0.122993,-0.000217334,1.94938e-07,-6.77467e-11,-116217,35.6037], Tmin=(100,'K'), Tmax=(818.844,'K')), NASAPolynomial(coeffs=[12.8823,0.035013,-1.94023e-05,3.85937e-09,-2.70136e-13,-117821,-24.5787], Tmin=(818.844,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-967.685,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCCFH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)2) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cs-F1sCsH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'F[C]=C(F)C(F)C(F)(F)[C](F)F(3603)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.164116,'amu*angstrom^2'), symmetry=1, barrier=(3.77336,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.164282,'amu*angstrom^2'), symmetry=1, barrier=(3.77717,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.164096,'amu*angstrom^2'), symmetry=1, barrier=(3.77288,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (194.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.37745,0.13378,-0.00024766,2.25252e-07,-7.78801e-11,-113480,36.6479], Tmin=(100,'K'), Tmax=(848.886,'K')), NASAPolynomial(coeffs=[13.1875,0.0348252,-1.92231e-05,3.76927e-09,-2.59753e-13,-114860,-24.7978], Tmin=(848.886,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-945.012,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s)) + radical(Cdj(Cd-CsF1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)'],
    products = ['CF2CF2(61)', 'FC=C=C(F)F(1325)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)'],
    products = ['F[CH]C(=C(F)F)C(F)(F)[C](F)F(3063)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', 'F[C](F)C(F)[C]=C(F)F(3149)'],
    products = ['F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=C(F)F(1205)', 'F[CH]C(F)(F)[C](F)F(1067)'],
    products = ['F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)'],
    products = ['FC(F)=C1C(F)C(F)(F)C1(F)F(3590)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)'],
    products = ['FC(F)=C=C(F)C(F)(F)C(F)F(3591)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'FC(F)=[C]C(F)C(F)=C(F)F(3357)'],
    products = ['F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CF2CF2(61)', 'F[CH][C]=C(F)F(2842)'],
    products = ['F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[C](F)C(F)(F)C=C=C(F)F(3592)'],
    products = ['F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[C](F)[C](F)F(1586)', 'FC=C=C(F)F(1325)'],
    products = ['F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[C](F)C(F)(F)C(F)=C=C(F)F(3593)'],
    products = ['F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'FC#CC(F)C(F)(F)[C](F)F(3594)'],
    products = ['F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[C](F)[C](F)F(1586)', 'F[CH][C]=C(F)F(2842)'],
    products = ['F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(78)', 'FC(F)=[C][CH]C(F)=C(F)F(3361)'],
    products = ['F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'F[C](F)C(F)=C(F)[C]=C(F)F(3595)'],
    products = ['F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(43)', 'F[C](F)C(F)[C]=C(F)F(3149)'],
    products = ['F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)'],
    products = ['F[C](F)C(F)(F)[C](F)C=C(F)F(3596)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)'],
    products = ['F[C]([C]=C(F)F)C(F)(F)C(F)F(3597)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)'],
    products = ['F[C](C(F)[C]=C(F)F)C(F)(F)F(3598)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)'],
    products = ['F[C](F)[C](F)C(F)C(F)=C(F)F(3599)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)'],
    products = ['FC(F)=[C][CH]C(F)(F)C(F)(F)F(3600)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)'],
    products = ['F[C](F)C(F)(F)[CH]C(F)=C(F)F(3601)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F[C]=[C]C(F)C(F)(F)C(F)(F)F(3602)'],
    products = ['F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F[C]=C(F)C(F)C(F)(F)[C](F)F(3603)'],
    products = ['F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)'],
...
network(
    ...
    isomers = [
        'F[C](F)C(F)(F)C(F)[C]=C(F)F(3064)',
    ],
    reactants = [
        ('CF2CF2(61)', 'FC=C=C(F)F(1325)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
