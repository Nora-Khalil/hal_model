...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]OC(F)(F)[C](F)F(2308)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(192)', '[O]C(F)(F)[C](F)F(284)'],
    products = ['O=[C]OC(F)(F)[C](F)F(2308)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', 'O=[C]O[C](F)F(726)'],
    products = ['O=[C]OC(F)(F)[C](F)F(2308)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(13)', '[O]C(F)(F)[C](F)F(284)'],
    products = ['O=[C]OC(F)(F)[C](F)F(2308)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC(F)=C(F)F(1293)'],
    products = ['O=[C]OC(F)(F)[C](F)F(2308)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(43)', 'O=[C]O[C](F)F(726)'],
    products = ['O=[C]OC(F)(F)[C](F)F(2308)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]OC(F)(F)[C](F)F(2308)'],
    products = ['O=[C]O[C](F)C(F)(F)F(2522)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=[C]OC(F)(F)[C](F)F(2308)'],
    products = ['O=C(F)O[C](F)[C](F)F(2523)'],
...
network(
    label = 'PDepNetwork #937',
    isomers = [
        'O=[C]OC(F)(F)[C](F)F(2308)',
    ],
    reactants = [
        ('CO2(14)', 'CF2CF2(61)'),
    ],
