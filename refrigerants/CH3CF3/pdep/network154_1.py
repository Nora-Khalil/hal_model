...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(=O)C(F)(F)F(3415)'],
    products = ['O=[C]CC(F)(F)F(606)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', 'O=C=CC(F)(F)F(2085)'],
    products = ['O=[C]CC(F)(F)F(606)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C][CH]C(F)(F)F(3416)'],
    products = ['O=[C]CC(F)(F)F(606)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'O=[C]C=C(F)F(1491)'],
    products = ['O=[C]CC(F)(F)F(606)'],
