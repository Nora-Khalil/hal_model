...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC(F)(F)[C](F)F(8540)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(138)', '[CH]C=C(F)F(2883)'],
    products = ['[CH]=CC(F)(F)[C](F)F(8540)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', '[CH]=CC(F)=C(F)F(6400)'],
    products = ['[CH]=CC(F)(F)[C](F)F(8540)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C](F)[C](F)F(1586)', 'C2H2(23)'],
    products = ['[CH]=CC(F)(F)[C](F)F(8540)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'C#CC(F)(F)[C](F)F(2515)'],
    products = ['[CH]=CC(F)(F)[C](F)F(8540)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[C](F)[C](F)F(1586)', '[CH]=[CH](977)'],
    products = ['[CH]=CC(F)(F)[C](F)F(8540)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(43)', '[CH]C=C(F)F(2883)'],
    products = ['[CH]=CC(F)(F)[C](F)F(8540)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=CC(F)(F)[C](F)F(8540)'],
    products = ['[CH]C=C(F)C(F)(F)F(8546)'],
...
network(
    label = 'PDepNetwork #2389',
    isomers = [
        '[CH]=CC(F)(F)[C](F)F(8540)',
    ],
    reactants = [
        ('CF2CF2(61)', 'C2H2(23)'),
    ],
