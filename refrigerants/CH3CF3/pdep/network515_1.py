...
reaction(
    label = 'reaction6',
    reactants = ['H2(8)', 'F[C]C(F)(F)COF(1385)'],
    products = ['FCC(F)(F)COF(1358)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(S)(25)', 'FOCC(F)(F)F(1386)'],
    products = ['FCC(F)(F)COF(1358)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(328)', 'C=C(F)CF(1388)'],
    products = ['FCC(F)(F)COF(1358)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FC[C](F)COF(1389)'],
    products = ['FCC(F)(F)COF(1358)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(F)(F)COF(365)'],
    products = ['FCC(F)(F)COF(1358)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]CC(F)(F)CF(637)'],
    products = ['FCC(F)(F)COF(1358)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(127)', '[CH2]C(F)(F)CF(1390)'],
    products = ['FCC(F)(F)COF(1358)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]OF(222)', 'CH2F-CF2(68)'],
    products = ['FCC(F)(F)COF(1358)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2F(46)', 'FOC[C](F)F(363)'],
    products = ['FCC(F)(F)COF(1358)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'FCC(F)(F)[CH]OF(1391)'],
    products = ['FCC(F)(F)COF(1358)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'F[CH]C(F)(F)COF(1392)'],
    products = ['FCC(F)(F)COF(1358)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'FCC(F)=COF(1393)'],
    products = ['FCC(F)(F)COF(1358)'],
