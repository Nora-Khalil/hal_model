...
"""),
    E0 = (-813.542,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,348,427,405,1245,1236,1280,528,1116,1182,1331,1402,1494,3075,3110,180,180,180,180,755.409,763.958,765.357],'cm^-1')),
        HinderedRotor(inertia=(0.00460895,'amu*angstrom^2'), symmetry=1, barrier=(1.90714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129015,'amu*angstrom^2'), symmetry=1, barrier=(53.5349,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48304,0.0615405,-9.07889e-05,8.28383e-08,-3.15498e-11,-97761.8,22.2747], Tmin=(100,'K'), Tmax=(734.839,'K')), NASAPolynomial(coeffs=[5.59683,0.032325,-1.72255e-05,3.46477e-09,-2.47624e-13,-98182.2,4.9489], Tmin=(734.839,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-813.542,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCsFHH) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2F2(41)', 'O=C(O)[C]F(1598)'],
    products = ['O=C(O)C(F)(F)CF(1409)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H2(8)', 'O=C(O)C(F)(F)[C]F(1599)'],
    products = ['O=C(O)C(F)(F)CF(1409)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CHF(40)', 'O=C(O)C(F)F(1600)'],
    products = ['O=C(O)C(F)(F)CF(1409)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(25)', 'O=C(O)C(F)(F)F(1520)'],
    products = ['O=C(O)C(F)(F)CF(1409)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(195)', 'O=C=C(F)CF(1601)'],
    products = ['O=C(O)C(F)(F)CF(1409)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C(O)C(F)(F)[CH]F(1605)'],
    products = ['O=C(O)C(F)(F)CF(1409)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[C](O)C(F)(F)[CH]F(1606)'],
    products = ['O=C(O)C(F)(F)CF(1409)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'O=C(O)[C](F)CF(1607)'],
    products = ['O=C(O)C(F)(F)CF(1409)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[CH2]C(F)(F)C(=O)O(1608)'],
    products = ['O=C(O)C(F)(F)CF(1409)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(7)', 'O=[C]C(F)(F)CF(1573)'],
    products = ['O=C(O)C(F)(F)CF(1409)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C(=O)C(F)(F)CF(1609)'],
    products = ['O=C(O)C(F)(F)CF(1409)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2F(46)', 'O=C(O)[C](F)F(1512)'],
    products = ['O=C(O)C(F)(F)CF(1409)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]O(457)', 'CH2F-CF2(68)'],
    products = ['O=C(O)C(F)(F)CF(1409)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C(O)C(F)(F)[CH]F(1610)'],
    products = ['O=C(O)C(F)(F)CF(1409)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F2(78)', 'C=C(F)C(=O)O(1611)'],
    products = ['O=C(O)C(F)(F)CF(1409)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'O=C(O)C(F)=CF(1612)'],
    products = ['O=C(O)C(F)(F)CF(1409)'],
