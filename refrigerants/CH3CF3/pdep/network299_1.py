...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C]1OC1(F)F(11275)'],
    products = ['FC1(F)OC1(F)F(990)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F2(78)', 'FC1=C(F)O1(11276)'],
    products = ['FC1(F)OC1(F)F(990)'],
    transitionState = 'TS6',
