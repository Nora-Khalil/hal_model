...
"""),
    ...
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51497,0.0594011,-8.12743e-05,5.87634e-08,-1.71901e-11,-84481.5,20.4549], Tmin=(100,'K'), Tmax=(830.527,'K')), NASAPolynomial(coeffs=[9.61959,0.0203678,-1.07775e-05,2.17576e-09,-1.5655e-13,-85827.7,-17.1402], Tmin=(830.527,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-703.128,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.294506,'amu*angstrom^2'), symmetry=1, barrier=(6.77128,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.295045,'amu*angstrom^2'), symmetry=1, barrier=(6.78366,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.294854,'amu*angstrom^2'), symmetry=1, barrier=(6.77929,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.882205,0.0842596,-0.000176166,1.7232e-07,-6.13524e-11,-57144.9,24.0217], Tmin=(100,'K'), Tmax=(889.38,'K')), NASAPolynomial(coeffs=[5.46349,0.0257648,-1.36056e-05,2.5644e-09,-1.70118e-13,-56461.2,10.8815], Tmin=(889.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-475.94,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsCFFO) + group(Cs-CsOsHH) + radical(ROOJ) + radical(Csj(Cs-F1sF1sO2s)(O2s-H)(H))"""),
)

species(
    label = '[O][CH]C(F)(F)OO(1346)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {4,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.225378,'amu*angstrom^2'), symmetry=1, barrier=(5.18189,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.225366,'amu*angstrom^2'), symmetry=1, barrier=(5.1816,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.960776,0.08536,-0.000184786,1.89718e-07,-7.05636e-11,-48286.4,23.84], Tmin=(100,'K'), Tmax=(871.376,'K')), NASAPolynomial(coeffs=[2.46371,0.0336622,-1.86757e-05,3.63118e-09,-2.47259e-13,-46847.6,26.5552], Tmin=(871.376,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-402.239,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsCFFO) + group(Cs-CsOsHH) + radical(CCOJ) + radical(Csj(Cs-F1sF1sO2s)(O2s-H)(H))"""),
)

species(
    label = '[O]O[C](F)COF(1456)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {3,S}
...
"""),
    E0 = (-89.5361,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,395,473,707,1436,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.45235,'amu*angstrom^2'), symmetry=1, barrier=(10.4004,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.452334,'amu*angstrom^2'), symmetry=1, barrier=(10.4,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.452315,'amu*angstrom^2'), symmetry=1, barrier=(10.3996,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.9488,0.0779526,-0.00014824,1.3878e-07,-4.8729e-11,-10669.2,24.1366], Tmin=(100,'K'), Tmax=(866.144,'K')), NASAPolynomial(coeffs=[7.5668,0.0234729,-1.24725e-05,2.40012e-09,-1.63133e-13,-10918.5,-1.66155], Tmin=(866.144,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-89.5361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sCF) + group(O2s-OsH) + group(CsCFHO) + group(Cs-CsOsHH) + radical(ROOJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]C[C](F)OOF(1457)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {4,S}
...
"""),
    E0 = (-55.0427,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,277,555,632,2750,2850,1437.5,1250,1305,750,350,395,473,707,1436],'cm^-1')),
        HinderedRotor(inertia=(1.84249,'amu*angstrom^2'), symmetry=1, barrier=(42.3626,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.828621,'amu*angstrom^2'), symmetry=1, barrier=(19.0516,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16198,0.0761526,-0.000152243,1.52776e-07,-5.69246e-11,-6531.15,24.6817], Tmin=(100,'K'), Tmax=(851.579,'K')), NASAPolynomial(coeffs=[3.96848,0.0312571,-1.73021e-05,3.40606e-09,-2.35482e-13,-5859.25,18.3444], Tmin=(851.579,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-55.0427,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(CsCFHO) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CsCsF1sO2s)"""),
)
...
reaction(
    ...
    products = ['[O]CC(F)(F)O[O](1344)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.40908e-07,'m^3/(mol*s)'), n=3.45227, Ea=(198.362,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[O]CC([O])(F)F(184)'],
    products = ['[O]CC(F)(F)O[O](1344)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C(F)(F)O[O](132)'],
    products = ['[O]CC(F)(F)O[O](1344)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]CC(F)(F)O[O](1344)'],
    products = ['O(6)', 'FC1(F)COO1(164)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(3.11355e+11,'s^-1'), n=0, Ea=(199.661,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3OO_SS;Y_rad_intra;OO] for rate rule [R3OO_SS;Y_rad_intra;OOJ]
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[C](F)F(163)', '[CH2][O](194)'],
    products = ['[O]CC(F)(F)O[O](1344)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[O]O[C](F)C=O(1336)'],
    products = ['[O]CC(F)(F)O[O](1344)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(246.53,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)

reaction(
    label = 'reaction13',
    reactants = ['[O]OC(F)(F)[CH]O(1441)'],
    products = ['[O]CC(F)(F)O[O](1344)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]O[C](F)COF(1456)'],
    products = ['[O]CC(F)(F)O[O](1344)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(93.5114,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction16',
    reactants = ['[O]C[C](F)OOF(1457)'],
    products = ['[O]CC(F)(F)O[O](1344)'],
