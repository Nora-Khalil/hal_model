...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH]C(F)=C=C(3897)'],
    products = ['[CH]=C(F)C(=C)[O](5735)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(T)(18)', '[CH]=C(F)[C]=O(940)'],
    products = ['[CH]=C(F)C(=C)[O](5735)'],
