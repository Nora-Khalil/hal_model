...
species(
    label = 'FC=[C]C(F)(F)C(F)=C=CF(3704)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = 'C#CC(F)(F)C(F)(F)[C]=CF(3705)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = 'FC#CC(F)(F)C(F)(F)[C]=CF(3706)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[CH][C]=C(F)C(F)=C=CF(3707)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[C]=CC(F)(F)C(F)(F)[C]=CF(3708)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[C]=[C]C(F)(F)C(F)(F)C=CF(3709)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[CH]C(F)=C(F)C(F)(F)[C]=CF(3710)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[CH][C]=C(F)C(F)(F)C(F)=CF(3711)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = '[CH]=C(F)C(F)(F)C(F)(F)[C]=CF(3712)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (188.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.35095,0.130459,-0.000228088,2.02215e-07,-6.94435e-11,-75440.6,37.211], Tmin=(100,'K'), Tmax=(824.08,'K')), NASAPolynomial(coeffs=[13.9475,0.0360531,-1.95759e-05,3.863e-09,-2.6911e-13,-77277.8,-29.484], Tmin=(824.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-628.748,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsCsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsHH) + radical(Cdj(Cs-F1sF1sCs)(Cd-HH)) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=CF-2(1206)', 'FC=[C]C(F)(F)[C](F)F(2512)'],
    products = ['FC=[C]C(F)(F)C(F)(F)[C]=CF(3072)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'FC=[C]C(F)(F)C(F)=C=CF(3704)'],
    products = ['FC=[C]C(F)(F)C(F)(F)[C]=CF(3072)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C#CC(F)(F)C(F)(F)[C]=CF(3705)'],
    products = ['FC=[C]C(F)(F)C(F)(F)[C]=CF(3072)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'FC#CC(F)(F)C(F)(F)[C]=CF(3706)'],
    products = ['FC=[C]C(F)(F)C(F)(F)[C]=CF(3072)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F2(78)', 'F[CH][C]=C(F)C(F)=C=CF(3707)'],
    products = ['FC=[C]C(F)(F)C(F)(F)[C]=CF(3072)'],
...
reaction(
    label = 'reaction11',
    reactants = ['FC=[C]C(F)(F)C(F)(F)[C]=CF(3072)'],
    products = ['F[C]=CC(F)(F)C(F)(F)[C]=CF(3708)'],
...
reaction(
    label = 'reaction12',
    reactants = ['FC=[C]C(F)(F)C(F)(F)[C]=CF(3072)'],
    products = ['F[C]=[C]C(F)(F)C(F)(F)C=CF(3709)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FC=[C]C(F)(F)C(F)(F)[C]=CF(3072)'],
    products = ['F[CH]C(F)=C(F)C(F)(F)[C]=CF(3710)'],
...
reaction(
    label = 'reaction14',
    reactants = ['FC=[C]C(F)(F)C(F)(F)[C]=CF(3072)'],
    products = ['F[CH][C]=C(F)C(F)(F)C(F)=CF(3711)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=C(F)C(F)(F)C(F)(F)[C]=CF(3712)'],
    products = ['FC=[C]C(F)(F)C(F)(F)[C]=CF(3072)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FC=[C]C(F)(F)C(F)(F)[C]=CF(3072)'],
    products = ['[CH]=[C]C(F)(F)C(F)(F)C(F)=CF(3713)'],
