...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)O[O](474)'],
    products = ['O=O(161)', 'C2HF(58)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C(=O)F(537)'],
    products = ['[CH]=C(F)O[O](474)'],
    transitionState = 'TS2',
