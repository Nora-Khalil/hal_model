species(
    label = 'F[CH]C(F)(F)C(F)(F)[CH]F(1034)',
...
"""),
    E0 = (-935.007,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([181,249,286,344,486,552,511,665,553,637,1169,1241,1190,1306,262,406,528,622,1148,1246,1368,1480,3164,3240,180,180,1832.23],'cm^-1')),
        HinderedRotor(inertia=(0.245233,'amu*angstrom^2'), symmetry=1, barrier=(5.63839,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.245368,'amu*angstrom^2'), symmetry=1, barrier=(5.64149,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.245365,'amu*angstrom^2'), symmetry=1, barrier=(5.64143,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = 'F[CH]C(F)(F)C(F)[C](F)F(1035)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[CH]C(F)(F)[C](F)C(F)F(1157)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)(F)C(F)(F)[CH]F(1034)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(1035)'],
    products = ['F[CH]C(F)(F)C(F)(F)[CH]F(1034)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[CH]C(F)(F)C(F)=CF(1132)'],
    products = ['F[CH]C(F)(F)C(F)(F)[CH]F(1034)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHFCF2(55)', 'F[CH][C](F)F(588)'],
    products = ['F[CH]C(F)(F)C(F)(F)[CH]F(1034)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[CH][C](F)F(588)', 'F[CH][C](F)F(588)'],
    products = ['F[CH]C(F)(F)C(F)(F)[CH]F(1034)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F2(78)', 'F[CH]C(F)=C(F)[CH]F(1115)'],
    products = ['F[CH]C(F)(F)C(F)(F)[CH]F(1034)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F[CH]C(F)(F)C(F)(F)[CH]F(1034)'],
    products = ['F[CH]C(F)(F)[C](F)C(F)F(1157)'],
