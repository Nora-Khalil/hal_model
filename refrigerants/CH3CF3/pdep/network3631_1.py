...
species(
    label = '[CH2]C(F)(F)[CH]C(F)(F)F(1064)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-822.133,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,253,522,585,610,849,1160,1215,1402,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,180,1010.28],'cm^-1')),
        HinderedRotor(inertia=(0.129447,'amu*angstrom^2'), symmetry=1, barrier=(2.97625,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134346,'amu*angstrom^2'), symmetry=1, barrier=(3.08888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132438,'amu*angstrom^2'), symmetry=1, barrier=(3.04501,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = 'CC(F)(F)C(=CF)C(F)(F)F(12155)',
...
"""),
    ...
    molecularWeight = (178.076,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.32093,0.10325,-0.000141645,1.05554e-07,-3.20214e-11,-158323,29.3593], Tmin=(100,'K'), Tmax=(800.562,'K')), NASAPolynomial(coeffs=[12.7167,0.0381069,-1.95868e-05,3.90825e-09,-2.7921e-13,-160410,-30.6394], Tmin=(800.562,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1317.6,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cs-CsHHH) + group(CsCdFFF) + group(Cds-CdsCsCs) + group(CdCFH)"""),
)
...
species(
    label = '[CH2]C(F)(F)C(=CF)C(F)(F)F(12156)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-1106.22,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([248,333,466,604,684,796,1061,1199,219,296,586,564,718,793,1177,1228,350,440,435,1725,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,180],'cm^-1')),
        HinderedRotor(inertia=(0.220577,'amu*angstrom^2'), symmetry=1, barrier=(5.0715,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221146,'amu*angstrom^2'), symmetry=1, barrier=(5.08458,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.673022,0.111868,-0.000177936,1.50919e-07,-5.12057e-11,-132888,31.9007], Tmin=(100,'K'), Tmax=(759.402,'K')), NASAPolynomial(coeffs=[12.9453,0.0357609,-1.89635e-05,3.77254e-09,-2.66647e-13,-134830,-29.221], Tmin=(759.402,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1106.22,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cs-CsHHH) + group(CsCdFFF) + group(Cds-CdsCsCs) + group(CdCFH) + radical(Csj(Cs-F1sF1sCd)(H)(H))"""),
)
...
species(
    label = '[CH2]C(F)(F)[C](CF)C(F)(F)F(12158)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (178.076,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.988562,0.122233,-0.00020785,1.86004e-07,-6.48189e-11,-127057,35.1349], Tmin=(100,'K'), Tmax=(824.914,'K')), NASAPolynomial(coeffs=[11.4425,0.0408012,-2.13116e-05,4.16426e-09,-2.89263e-13,-128388,-18.0827], Tmin=(824.914,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1057.81,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCsCsFF) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-R-Cs(F)2) + group(CsCsFHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = 'CC(F)(F)[C]([CH]F)C(F)(F)F(12159)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (178.076,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.88544,0.122905,-0.000218505,2.03876e-07,-7.30281e-11,-129369,33.8512], Tmin=(100,'K'), Tmax=(837.106,'K')), NASAPolynomial(coeffs=[8.86057,0.0453291,-2.39401e-05,4.67883e-09,-3.24167e-13,-129914,-4.94605], Tmin=(837.106,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1076.97,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCsCsFF) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-R-Cs(F)2) + group(CsCsFHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Csj(Cs-CsCsH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C([CH]F)C(F)(F)F(6839)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', '[CH2]C(F)(F)C(F)[CH]F(801)'],
    products = ['[CH2]C(F)(F)C([CH]F)C(F)(F)F(6839)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.33582e-06,'m^3/(mol*s)'), n=3.3552, Ea=(240.149,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R',), comment="""Estimated from node CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]F(804)', '[CH2]C(F)(F)[CH]C(F)(F)F(1064)'],
    products = ['[CH2]C(F)(F)C([CH]F)C(F)(F)F(6839)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2(T)(18)', 'F[CH]C([C](F)F)C(F)(F)F(9896)'],
    products = ['[CH2]C(F)(F)C([CH]F)C(F)(F)F(6839)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)(F)C([CH]F)C(F)(F)F(6839)'],
    products = ['CC(F)(F)C(=CF)C(F)(F)F(12155)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CF3(45)', '[CH2]C(F)(F)C=CF(820)'],
    products = ['[CH2]C(F)(F)C([CH]F)C(F)(F)F(6839)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(13.2491,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)

reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(F)(F)C(=CF)C(F)(F)F(12156)'],
    products = ['[CH2]C(F)(F)C([CH]F)C(F)(F)F(6839)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'C=C(F)C([CH]F)C(F)(F)F(12157)'],
    products = ['[CH2]C(F)(F)C([CH]F)C(F)(F)F(6839)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(53.1497,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(10.3947,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[CH2]C(F)=C([CH]F)C(F)(F)F(3165)'],
    products = ['[CH2]C(F)(F)C([CH]F)C(F)(F)F(6839)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(241.667,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(F)(F)C([CH]F)C(F)(F)F(6839)'],
    products = ['[CH2]C(F)(F)[C](CF)C(F)(F)F(12158)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(F)(F)C([CH]F)C(F)(F)F(6839)'],
    products = ['CC(F)(F)[C]([CH]F)C(F)(F)F(12159)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(228.777,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction22',
    reactants = ['F[CH]C([C](F)CF)C(F)(F)F(12160)'],
    products = ['[CH2]C(F)(F)C([CH]F)C(F)(F)F(6839)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.000550858,'s^-1'), n=4.50663, Ea=(216.282,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R4F_Ext-4R!H-R',), comment="""Estimated from node R4F_Ext-4R!H-R"""),
)

network(
    label = 'PDepNetwork #3631',
    isomers = [
        '[CH2]C(F)(F)C([CH]F)C(F)(F)F(6839)',
    ],
    reactants = [
