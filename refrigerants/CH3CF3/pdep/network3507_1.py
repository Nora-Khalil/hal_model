...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CO[O](1768)'],
    products = ['O=O(161)', 'C2H2(23)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]=C[O](623)'],
    products = ['[CH]=CO[O](1768)'],
    transitionState = 'TS2',
