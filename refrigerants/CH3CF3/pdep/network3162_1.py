...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.796209,'amu*angstrom^2'), symmetry=1, barrier=(18.3064,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.796925,'amu*angstrom^2'), symmetry=1, barrier=(18.3229,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.796342,'amu*angstrom^2'), symmetry=1, barrier=(18.3095,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.507593,0.0715567,-8.74136e-05,5.11157e-08,-1.14071e-11,-90527.4,22.1092], Tmin=(100,'K'), Tmax=(1112.95,'K')), NASAPolynomial(coeffs=[17.9597,0.00883179,-2.87343e-06,4.74431e-10,-3.14402e-14,-94412,-63.9545], Tmin=(1112.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-753.771,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsCFFH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'OCC(F)F(240)'],
    products = ['O=C(O)CC(F)F(10447)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['HF(38)', 'O=C(O)C[C]F(9450)'],
    products = ['O=C(O)CC(F)F(10447)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['H2O(3)', 'O=C=CC(F)F(1493)'],
    products = ['O=C(O)CC(F)F(10447)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OC(F)F(1007)', 'CH2CO(28)'],
    products = ['O=C(O)CC(F)F(10447)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(O)[CH]C(F)F(10795)'],
    products = ['O=C(O)CC(F)F(10447)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'O=C(O)C[CH]F(9460)'],
    products = ['O=C(O)CC(F)F(10447)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(7)', 'O=[C]CC(F)F(1440)'],
    products = ['O=C(O)CC(F)F(10447)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[O]C(=O)CC(F)F(1500)'],
    products = ['O=C(O)CC(F)F(10447)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CHF2(82)', '[CH2]C(=O)O(2073)'],
    products = ['O=C(O)CC(F)F(10447)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=[C]O(457)', 'CHF2-CH2(64)'],
    products = ['O=C(O)CC(F)F(10447)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O=C(O)[CH]C(F)F(9506)'],
    products = ['O=C(O)CC(F)F(10447)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C(O)C[C](F)F(1763)'],
    products = ['O=C(O)CC(F)F(10447)'],
