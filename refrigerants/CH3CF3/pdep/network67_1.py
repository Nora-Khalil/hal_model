...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(138)', '[O]C[O](318)'],
    products = ['[O]CO[C](F)F(234)'],
    transitionState = 'TS2',
