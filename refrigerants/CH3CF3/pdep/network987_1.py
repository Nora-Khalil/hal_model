...
species(
    label = 'FC1C(F)C(F)(F)C1(F)F(1134)',
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.582477,0.0720531,-7.34827e-05,3.74311e-08,-7.54511e-12,-142687,24.9602], Tmin=(100,'K'), Tmax=(1201.72,'K')), NASAPolynomial(coeffs=[16.0582,0.020541,-9.18453e-06,1.76083e-09,-1.24406e-13,-146406,-52.5448], Tmin=(1201.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1187.41,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(CsCsCsFH) + group(CsCsCsFF) + group(CsCsCsFF) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + ring(Cs-Cs-Cs(F)(F)-Cs)"""),
)

species(
    label = 'FC=C(F)C(F)(F)C(F)F(2518)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {8,S}
...
species(
    label = 'F[CH][C](F)C(F)(F)C(F)F(1183)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.230748,0.10269,-0.000175264,1.5466e-07,-5.33167e-11,-113363,32.4195], Tmin=(100,'K'), Tmax=(807.905,'K')), NASAPolynomial(coeffs=[11.7876,0.0300645,-1.60622e-05,3.18617e-09,-2.23529e-13,-114877,-20.3481], Tmin=(807.905,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-943.742,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = 'F[CH]C(F)[C](F)C(F)(F)F(2520)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.203206,0.102761,-0.000175961,1.59129e-07,-5.68261e-11,-116765,31.32], Tmin=(100,'K'), Tmax=(778.595,'K')), NASAPolynomial(coeffs=[10.7445,0.0338859,-1.89346e-05,3.83913e-09,-2.73437e-13,-118087,-16.2979], Tmin=(778.595,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-972.013,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-F1sF1sF1s)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = 'F[C](F)[C](F)C(F)C(F)F(1139)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[CH][CH]C(F)(F)C(F)(F)F(2521)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0756503,0.0978416,-0.000172041,1.59723e-07,-5.74501e-11,-120058,32.0719], Tmin=(100,'K'), Tmax=(818.359,'K')), NASAPolynomial(coeffs=[8.60896,0.0352175,-1.89197e-05,3.75497e-09,-2.63252e-13,-120754,-3.10691], Tmin=(818.359,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-999.298,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sHH)(H)) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)C(F)(F)[C](F)F(2352)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(138)', 'F[CH]C(F)[C](F)F(818)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(2352)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', 'F[CH]C(F)(F)[C](F)F(1067)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(2352)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[CH]C(F)C(F)(F)[C](F)F(2352)'],
    products = ['FC1C(F)C(F)(F)C1(F)F(1134)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[CH]C(F)C(F)(F)[C](F)F(2352)'],
    products = ['FC=C(F)C(F)(F)C(F)F(2518)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]C(F)C(F)=C(F)F(1120)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(2352)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CF2CF2(61)', 'F[CH][CH]F(811)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(2352)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'FC=CC(F)(F)[C](F)F(2519)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(2352)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F[C](F)[C](F)F(1586)', 'CHFCHF[Z](59)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(2352)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'FC=C(F)C(F)(F)[C](F)F(2471)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(2352)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F[C](F)[C](F)F(1586)', 'F[CH][CH]F(811)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(2352)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(78)', 'F[CH]C=C(F)[C](F)F(1088)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(2352)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'F[CH]C(F)=C(F)[C](F)F(1156)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(2352)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(43)', 'F[CH]C(F)[C](F)F(818)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(2352)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', 'F[CH]C(F)(F)[C](F)F(1067)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(2352)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)C(F)(F)[C](F)F(2352)'],
    products = ['FC[C](F)C(F)(F)[C](F)F(2393)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]C(F)C(F)(F)[C](F)F(2352)'],
    products = ['F[CH][C](F)C(F)(F)C(F)F(1183)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)C(F)(F)[C](F)F(2352)'],
    products = ['F[CH]C(F)[C](F)C(F)(F)F(2520)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(F)C(F)(F)[C](F)F(2352)'],
    products = ['F[C](F)[C](F)C(F)C(F)F(1139)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH]C(F)C(F)(F)[C](F)F(2352)'],
    products = ['F[CH][CH]C(F)(F)C(F)(F)F(2521)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[CH]C(F)C(F)(F)[C](F)F(2352)'],
    products = ['F[C](F)C(F)(F)[CH]C(F)F(2386)'],
