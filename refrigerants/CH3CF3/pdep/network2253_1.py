...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(127)', '[CH2]C(O)F(6095)'],
    products = ['OC(F)COF(7902)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[CH]F(2849)', '[CH2]OF(222)'],
    products = ['OC(F)COF(7902)'],
