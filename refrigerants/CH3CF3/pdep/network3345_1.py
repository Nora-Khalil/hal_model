...
"""),
    E0 = (-454.339,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,990,1113,2750,2850,1437.5,1250,1305,750,350,366.402,366.554,366.607,366.877,1269.43,2586.62],'cm^-1')),
        HinderedRotor(inertia=(0.313724,'amu*angstrom^2'), symmetry=1, barrier=(29.9345,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.314064,'amu*angstrom^2'), symmetry=1, barrier=(29.924,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.444,'amu*angstrom^2'), symmetry=1, barrier=(42.3451,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.840182,'amu*angstrom^2'), symmetry=1, barrier=(19.3174,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.841552,'amu*angstrom^2'), symmetry=1, barrier=(19.3489,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26457,0.0472667,-4.99918e-05,2.52589e-08,-4.707e-12,-28218,17.0415], Tmin=(100,'K'), Tmax=(1547.12,'K')), NASAPolynomial(coeffs=[14.4286,0.00423674,4.48737e-07,-2.34262e-10,1.97183e-14,-31214.8,-48.7329], Tmin=(1547.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-235.529,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)HHH) + group(Cds-(Cdd-O2d)CsOs) + missing(Cdd-CdO2d)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.230602,'amu*angstrom^2'), symmetry=1, barrier=(5.302,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.230737,'amu*angstrom^2'), symmetry=1, barrier=(5.3051,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.230809,'amu*angstrom^2'), symmetry=1, barrier=(5.30676,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.904403,'amu*angstrom^2'), symmetry=1, barrier=(20.794,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.936982,0.077244,-0.000130701,1.22772e-07,-4.46236e-11,-9220.91,24.313], Tmin=(100,'K'), Tmax=(836.387,'K')), NASAPolynomial(coeffs=[5.63141,0.034433,-1.74086e-05,3.36428e-09,-2.32374e-13,-9294.04,6.76104], Tmin=(836.387,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-77.5047,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2sCF) + group(O2s-OsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs)"""),
)

species(
    label = 'COC(=CO)OF(11148)',
    structure = adjacencyList("""1  F u0 p3 c0 {3,S}
...
"""),
    E0 = (-116.212,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,252.814,252.814,1294.25],'cm^-1')),
        HinderedRotor(inertia=(0.134633,'amu*angstrom^2'), symmetry=1, barrier=(6.10634,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134633,'amu*angstrom^2'), symmetry=1, barrier=(6.10633,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134633,'amu*angstrom^2'), symmetry=1, barrier=(6.10634,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134633,'amu*angstrom^2'), symmetry=1, barrier=(6.10634,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (108.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.730981,0.0822696,-0.000142519,1.32701e-07,-4.74982e-11,-13869.3,27.768], Tmin=(100,'K'), Tmax=(843.714,'K')), NASAPolynomial(coeffs=[6.62538,0.0329167,-1.6716e-05,3.22347e-09,-2.21844e-13,-14102,4.84815], Tmin=(843.714,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-116.212,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJOH)"""),
)

species(
    label = 'CC([O])C([O])OF(11150)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
...
"""),
    E0 = (-62.479,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2800,2850,1350,1500,750,1050,1375,1000,293.965,294.252,294.319,294.509],'cm^-1')),
        HinderedRotor(inertia=(0.121528,'amu*angstrom^2'), symmetry=1, barrier=(7.47483,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.458536,'amu*angstrom^2'), symmetry=1, barrier=(28.1992,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.13738e-05,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52812,0.0624692,-6.59348e-05,2.23803e-08,1.04578e-11,-7433.36,25.3688], Tmin=(100,'K'), Tmax=(539.695,'K')), NASAPolynomial(coeffs=[7.26241,0.0322738,-1.62103e-05,3.20232e-09,-2.27349e-13,-8231.52,-0.41935], Tmin=(539.695,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.479,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C(O)C([O])OF(11151)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {5,S} {12,S}
3  O u0 p2 c0 {1,S} {6,S}
...
"""),
    E0 = (-81.2507,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,3000,3100,440,815,1455,1000,280.746,286.824,2135.53],'cm^-1')),
...
"""),
    E0 = (-82.9378,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,180,180,617.844],'cm^-1')),
        HinderedRotor(inertia=(0.0430559,'amu*angstrom^2'), symmetry=1, barrier=(11.4979,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00939873,'amu*angstrom^2'), symmetry=1, barrier=(2.51452,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0426556,'amu*angstrom^2'), symmetry=1, barrier=(11.5038,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.499759,'amu*angstrom^2'), symmetry=1, barrier=(11.4904,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.974473,0.0698484,-8.55582e-05,5.5093e-08,-1.4257e-11,-9868.93,27.1187], Tmin=(100,'K'), Tmax=(938.344,'K')), NASAPolynomial(coeffs=[11.9096,0.0232347,-1.10443e-05,2.15371e-09,-1.52788e-13,-11921.1,-24.941], Tmin=(938.344,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-82.9378,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(Cs_P)"""),
)

species(
    label = '[CH2]C(O)[C](O)OF(11153)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
...
"""),
    E0 = (-101.709,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,557,1111,1380,1390,370,380,2900,435,360,370,350,3000,3100,440,815,1455,1000,180,659.827],'cm^-1')),
        HinderedRotor(inertia=(0.149017,'amu*angstrom^2'), symmetry=1, barrier=(3.4262,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0390871,'amu*angstrom^2'), symmetry=1, barrier=(12.0768,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149026,'amu*angstrom^2'), symmetry=1, barrier=(3.42641,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.03909,'amu*angstrom^2'), symmetry=1, barrier=(12.0768,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.525263,'amu*angstrom^2'), symmetry=1, barrier=(12.0768,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.52926,0.080621,-0.000117044,8.72768e-08,-2.56403e-11,-12111.7,29.5385], Tmin=(100,'K'), Tmax=(836.918,'K')), NASAPolynomial(coeffs=[13.0431,0.0208104,-9.84281e-06,1.8813e-09,-1.30652e-13,-14206.3,-28.6053], Tmin=(836.918,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-101.709,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CJCO)"""),
)

species(
    label = 'CC(O)=C(O)OF(11154)',
    structure = adjacencyList("""1  F u0 p3 c0 {3,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.659113,'amu*angstrom^2'), symmetry=1, barrier=(15.1543,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.659551,'amu*angstrom^2'), symmetry=1, barrier=(15.1644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.659581,'amu*angstrom^2'), symmetry=1, barrier=(15.1651,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.659643,'amu*angstrom^2'), symmetry=1, barrier=(15.1665,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.068,'amu'),
...
"""),
    E0 = (-413.186,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,180,917.265,917.342,917.407,917.488,917.527],'cm^-1')),
        HinderedRotor(inertia=(0.00677246,'amu*angstrom^2'), symmetry=1, barrier=(4.04638,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175991,'amu*angstrom^2'), symmetry=1, barrier=(4.04638,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.20323,'amu*angstrom^2'), symmetry=1, barrier=(50.6565,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.14856,0.0350318,-1.21761e-05,-3.54034e-09,2.19804e-12,-49623.6,22.3424], Tmin=(100,'K'), Tmax=(1285.01,'K')), NASAPolynomial(coeffs=[9.61386,0.0225529,-1.01687e-05,1.93396e-09,-1.34637e-13,-52430.5,-19.0018], Tmin=(1285.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-413.186,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44884,0.0484895,-3.51824e-05,1.11335e-08,-1.06329e-12,-31250.8,25.6333], Tmin=(100,'K'), Tmax=(1262.4,'K')), NASAPolynomial(coeffs=[13.5656,0.0177631,-7.78217e-06,1.47409e-09,-1.03015e-13,-34920.9,-38.0657], Tmin=(1262.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-260.65,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(C=OCOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00163292,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146152,'amu*angstrom^2'), symmetry=1, barrier=(10.693,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147083,'amu*angstrom^2'), symmetry=1, barrier=(10.7027,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.26173,0.030126,-1.7577e-06,-2.18085e-08,1.12307e-11,-25577.5,21.2627], Tmin=(100,'K'), Tmax=(963.865,'K')), NASAPolynomial(coeffs=[11.3006,0.0120966,-4.01742e-06,7.23936e-10,-5.24584e-14,-28224.8,-26.7061], Tmin=(963.865,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-213.244,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (107.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48671,0.0552048,-5.18843e-05,2.47769e-08,-4.80003e-12,-39329.4,24.1312], Tmin=(100,'K'), Tmax=(1224.24,'K')), NASAPolynomial(coeffs=[11.9571,0.0209946,-9.96833e-06,1.95141e-09,-1.38884e-13,-41893.1,-28.5009], Tmin=(1224.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-327.756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C(O)C(=O)OF(11159)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {5,S} {11,S}
3  O u0 p2 c0 {1,S} {6,S}
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'O=C(CO)OF(2054)'],
    products = ['CC(O)C(=O)OF(11073)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['OF(195)', 'CC(O)=C=O(11146)'],
    products = ['CC(O)C(=O)OF(11073)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'C=CC(=O)OF(2495)'],
    products = ['CC(O)C(=O)OF(11073)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(O)C([O])OF(11151)'],
    products = ['CC(O)C(=O)OF(11073)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(O)[C](O)OF(11153)'],
    products = ['CC(O)C(=O)OF(11073)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'CC(O)C([O])=O(11155)'],
    products = ['CC(O)C(=O)OF(11073)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'C[CH]C(=O)OF(9048)'],
    products = ['CC(O)C(=O)OF(11073)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'CC([O])C(=O)OF(11156)'],
    products = ['CC(O)C(=O)OF(11073)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]F(127)', 'CC(O)[C]=O(11157)'],
    products = ['CC(O)C(=O)OF(11073)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH3(19)', 'O=C([CH]O)OF(2086)'],
    products = ['CC(O)C(=O)OF(11073)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=[C]OF(458)', 'C[CH]O(1790)'],
    products = ['CC(O)C(=O)OF(11073)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'C[C](O)C(=O)OF(11158)'],
    products = ['CC(O)C(=O)OF(11073)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', '[CH2]C(O)C(=O)OF(11159)'],
    products = ['CC(O)C(=O)OF(11073)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CC(O)C(=O)OF(11073)'],
    products = ['HF(38)', 'CO2(14)', 'C=CO(715)'],
