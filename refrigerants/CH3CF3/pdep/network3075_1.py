...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH]CC(F)F(11238)'],
    products = ['F[CH]CC(F)F(5949)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]F(804)', 'CHF2-CH2(64)'],
    products = ['F[CH]CC(F)F(5949)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[C]CC(F)F-2(1425)'],
    products = ['F[CH]CC(F)F(5949)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[CH]C[CH]F(10247)'],
    products = ['F[CH]CC(F)F(5949)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF2(82)', '[CH2][CH]F(1279)'],
    products = ['F[CH]CC(F)F(5949)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[CH][CH]C(F)F(9318)'],
    products = ['F[CH]CC(F)F(5949)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'F[CH]C[C](F)F(803)'],
    products = ['F[CH]CC(F)F(5949)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'F[CH]C=CF(9425)'],
    products = ['F[CH]CC(F)F(5949)'],
