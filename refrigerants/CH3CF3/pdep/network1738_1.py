...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', 'O=[C]C[CH]F(2614)'],
    products = ['O=[C]CC(F)[CH]F(6122)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(192)', '[CH2]C(F)[CH]F(805)'],
    products = ['O=[C]CC(F)[CH]F(6122)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['CO(13)', '[CH2]C(F)[CH]F(805)'],
    products = ['O=[C]CC(F)[CH]F(6122)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=[C]CC(F)=CF(2629)'],
    products = ['O=[C]CC(F)[CH]F(6122)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C=CC(F)[CH]F(6133)'],
    products = ['O=[C]CC(F)[CH]F(6122)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'O=[C]C=C[CH]F(5879)'],
    products = ['O=[C]CC(F)[CH]F(6122)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', 'O=[C]C[CH]F(2614)'],
    products = ['O=[C]CC(F)[CH]F(6122)'],
