...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(192)', '[CH2]O[CH2](292)'],
    products = ['[CH2]OC[C]=O(2315)'],
    transitionState = 'TS3',
