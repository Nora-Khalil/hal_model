...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'FOOC(F)F(2910)'],
    products = ['O=C(F)OOC(F)F(8769)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(43)', 'O=C(F)OO(2257)'],
    products = ['O=C(F)OOC(F)F(8769)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O=C(F)OOF(2260)', 'CHF(40)'],
    products = ['O=C(F)OOC(F)F(8769)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=C(F)OO[CH]F(9052)'],
    products = ['O=C(F)OOC(F)F(8769)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=[C]OOC(F)F(1935)'],
    products = ['O=C(F)OOC(F)F(8769)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(=O)F(459)', '[O]C(F)F(207)'],
    products = ['O=C(F)OOC(F)F(8769)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]OC(=O)F(277)', 'CHF2(82)'],
    products = ['O=C(F)OOC(F)F(8769)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)OO[C](F)F(8771)'],
    products = ['O=C(F)OOC(F)F(8769)'],
