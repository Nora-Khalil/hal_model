...
species(
    label = '[CH2][C](F)C(F)C(F)(F)F(1065)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    ...
    products = ['[CH2]C(F)(F)C(F)[C](F)F(1010)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'F[C](F)C(F)[C](F)F(1057)'],
    products = ['[CH2]C(F)(F)C(F)[C](F)F(1010)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)C(F)[C](F)F(1010)'],
    products = ['CC(F)(F)C(F)=C(F)F(1058)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)(F)C(F)=C(F)F(1059)'],
    products = ['[CH2]C(F)(F)C(F)[C](F)F(1010)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(F)C(F)[C](F)F(1060)'],
    products = ['[CH2]C(F)(F)C(F)[C](F)F(1010)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(F)(F)C(F)[C](F)F(1010)'],
    products = ['CC(F)(F)[C](F)[C](F)F(1063)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(F)(F)C(F)[C](F)F(1010)'],
    products = ['[CH2]C(F)(F)[CH]C(F)(F)F(1064)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(F)(F)C(F)[C](F)F(1010)'],
    products = ['FCC(F)(F)[CH][C](F)F(1055)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(F)(F)C(F)[C](F)F(1010)'],
    products = ['[CH2][C](F)C(F)C(F)(F)F(1065)'],
...
reaction(
    label = 'reaction22',
    reactants = ['FC[C](F)C(F)[C](F)F(1066)'],
    products = ['[CH2]C(F)(F)C(F)[C](F)F(1010)'],
