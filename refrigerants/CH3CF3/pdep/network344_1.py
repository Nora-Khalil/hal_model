...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)(F)C[C](F)F(1011)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(804)', 'F[C](F)C[C](F)F(146)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1011)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F[CH]C(F)(F)C[C](F)F(1011)'],
    products = ['FC1C(F)(F)CC1(F)F(1050)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'FC=C(F)C[C](F)F(810)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1011)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[CH]C(F)(F)C=C(F)F(1052)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1011)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', 'F[C](F)C[C](F)F(146)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1011)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)(F)[CH]C(F)F(1054)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1011)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FCC(F)(F)[CH][C](F)F(1055)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1011)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)(F)C[C](F)F(1011)'],
    products = ['F[C](F)C[C](F)C(F)F(1044)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(F)(F)C[C](F)F(1011)'],
    products = ['F[CH][C](F)CC(F)(F)F(1056)'],
