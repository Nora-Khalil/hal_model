...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', '[CH2]C(=O)OF(1501)'],
    products = ['O=C(CO)OF(2054)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C([CH]O)OF(2086)'],
    products = ['O=C(CO)OF(2054)'],
