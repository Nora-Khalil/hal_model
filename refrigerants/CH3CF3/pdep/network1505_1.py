...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'O=CC(F)=C[C]F(5067)'],
    products = ['[O]C(F)(C=O)C=[C]F(5026)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)(C=O)C=[C]F(5026)'],
    products = ['F[C]=CC1(F)[CH]OO1(5069)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O=CC(=O)C=[C]F(5073)'],
    products = ['[O]C(F)(C=O)C=[C]F(5026)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HCO(15)', 'O=C(F)C=[C]F(544)'],
    products = ['[O]C(F)(C=O)C=[C]F(5026)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)(C#CF)C=O(5074)'],
    products = ['[O]C(F)(C=O)C=[C]F(5026)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', '[O]C=C([O])C#CF(5075)'],
    products = ['[O]C(F)(C=O)C=[C]F(5026)'],
...
network(
    label = 'PDepNetwork #1505',
    isomers = [
        '[O]C(F)(C=O)C=[C]F(5026)',
    ],
    reactants = [
