...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C#COC(F)F(6580)'],
    products = ['C#COCC(F)F(1644)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['HF(38)', 'C#COC[C]F(7770)'],
    products = ['C#COCC(F)F(1644)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C#COC[CH]F(7772)'],
    products = ['C#COCC(F)F(1644)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C#CO[CH]C(F)F(7773)'],
    products = ['C#COCC(F)F(1644)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C#COC[C](F)F(1694)'],
    products = ['C#COCC(F)F(1644)'],
