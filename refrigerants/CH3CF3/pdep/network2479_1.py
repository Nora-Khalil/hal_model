...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'O[C-]=[O+]F(8875)'],
    products = ['O=C(F)[O+]=[C-]O(8757)'],
    transitionState = 'TS2',
