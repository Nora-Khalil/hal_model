...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.372327,'amu*angstrom^2'), symmetry=1, barrier=(74.193,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.046,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54484,0.0618996,-0.000110675,1.05466e-07,-3.89181e-11,-2521.5,22.1154], Tmin=(100,'K'), Tmax=(808.79,'K')), NASAPolynomial(coeffs=[6.21783,0.0240757,-1.32393e-05,2.66015e-09,-1.87991e-13,-2796.18,3.53751], Tmin=(808.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-21.6362,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cd-F1sCdd)(F1s)(H)) + radical(Cdj(Cdd-Cd)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.30271,'amu*angstrom^2'), symmetry=1, barrier=(6.95991,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.670951,'amu*angstrom^2'), symmetry=1, barrier=(15.4265,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.981153,0.075052,-0.000129719,1.2048e-07,-4.36544e-11,-35967.4,25.3953], Tmin=(100,'K'), Tmax=(808.013,'K')), NASAPolynomial(coeffs=[7.39278,0.0283297,-1.51703e-05,3.02261e-09,-2.12851e-13,-36514.4,-1.1439], Tmin=(808.013,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-299.884,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cdj(Cs-F1sF1sCs)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C]=CC(F)(F)[CH]F(1024)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', 'F[C]C=C(F)F(504)'],
    products = ['F[C]=CC(F)(F)[CH]F(1024)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C]=CC(F)=CF(873)'],
    products = ['F[C]=CC(F)(F)[CH]F(1024)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'FC#CC(F)(F)[CH]F(1091)'],
    products = ['F[C]=CC(F)(F)[CH]F(1024)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'F[C]=C=C(F)[CH]F(1092)'],
    products = ['F[C]=CC(F)(F)[CH]F(1024)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', 'F[C]C=C(F)F(504)'],
    products = ['F[C]=CC(F)(F)[CH]F(1024)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH]C(F)(F)[C]=CF(1093)'],
    products = ['F[C]=CC(F)(F)[CH]F(1024)'],
