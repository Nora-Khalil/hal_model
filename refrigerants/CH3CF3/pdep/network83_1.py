...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC([O])(F)F(238)'],
    products = ['O=O(161)', 'CF2O(49)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C([O])(F)F(276)'],
    products = ['[O]OC([O])(F)F(238)'],
    transitionState = 'TS2',
