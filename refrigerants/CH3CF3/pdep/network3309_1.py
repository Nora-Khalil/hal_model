...
"""),
    E0 = (-725.626,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,190,488,555,1236,1407,244.418,244.421,244.421,244.423],'cm^-1')),
        HinderedRotor(inertia=(0.245308,'amu*angstrom^2'), symmetry=1, barrier=(10.3992,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.568976,'amu*angstrom^2'), symmetry=1, barrier=(24.1224,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.24529,'amu*angstrom^2'), symmetry=1, barrier=(10.3988,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.245297,'amu*angstrom^2'), symmetry=1, barrier=(10.3993,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.175562,0.101607,-0.000150101,1.03655e-07,-2.29234e-11,-87131.5,28.1041], Tmin=(100,'K'), Tmax=(626.449,'K')), NASAPolynomial(coeffs=[14.1397,0.0274635,-1.39003e-05,2.69731e-09,-1.87501e-13,-89263.8,-36.9671], Tmin=(626.449,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-725.626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + radical(CCsJOCs) + radical(Csj(Cs-F1sF1sO2s)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.12075,'amu*angstrom^2'), symmetry=1, barrier=(25.7683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.12364,'amu*angstrom^2'), symmetry=1, barrier=(25.8347,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.12061,'amu*angstrom^2'), symmetry=1, barrier=(25.7651,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-694.493,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,190,488,555,1236,1407,186.491,186.54,186.561,186.616],'cm^-1')),
        HinderedRotor(inertia=(0.330432,'amu*angstrom^2'), symmetry=1, barrier=(8.14961,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.330567,'amu*angstrom^2'), symmetry=1, barrier=(8.15024,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27555,'amu*angstrom^2'), symmetry=1, barrier=(31.5041,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00485416,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.348074,0.104454,-0.000172363,1.48093e-07,-4.98787e-11,-83380.1,29.8612], Tmin=(100,'K'), Tmax=(816.378,'K')), NASAPolynomial(coeffs=[12.3736,0.030682,-1.57965e-05,3.07414e-09,-2.13355e-13,-85076.1,-26.598], Tmin=(816.378,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-694.493,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + radical(CJCO) + radical(Csj(Cs-F1sF1sO2s)(F1s)(F1s))"""),
)

species(
    label = '[CH2][CH]OC(F)(F)C(F)F(11009)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-720.214,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,235,523,627,1123,1142,1372,1406,3097,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,310.086,310.087,310.096,310.102],'cm^-1')),
        HinderedRotor(inertia=(0.167816,'amu*angstrom^2'), symmetry=1, barrier=(11.4512,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00175321,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167818,'amu*angstrom^2'), symmetry=1, barrier=(11.4513,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.461105,'amu*angstrom^2'), symmetry=1, barrier=(31.4623,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.296966,0.100303,-0.000147979,1.10869e-07,-3.26946e-11,-86472.2,29.4667], Tmin=(100,'K'), Tmax=(833.67,'K')), NASAPolynomial(coeffs=[15.4181,0.0249052,-1.23261e-05,2.39751e-09,-1.68093e-13,-89092.6,-43.4914], Tmin=(833.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-720.214,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsOsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CJCO)"""),
)

species(
    label = 'CC(F)O[C](F)[C](F)F(11010)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-703.926,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,190,488,555,1236,1407,323.417,323.422,323.429,1467.55],'cm^-1')),
        HinderedRotor(inertia=(0.11545,'amu*angstrom^2'), symmetry=1, barrier=(8.56859,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115438,'amu*angstrom^2'), symmetry=1, barrier=(8.56876,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.433469,'amu*angstrom^2'), symmetry=1, barrier=(32.1532,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.433323,'amu*angstrom^2'), symmetry=1, barrier=(32.1534,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.660433,0.0814072,-0.000106045,7.84478e-08,-2.43717e-11,-84549.6,29.3233], Tmin=(100,'K'), Tmax=(772.62,'K')), NASAPolynomial(coeffs=[9.23954,0.0369896,-1.98072e-05,4.03295e-09,-2.91902e-13,-85875.2,-9.85238], Tmin=(772.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-703.926,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(CsCFHO) + group(Cs-CsHHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(Csj(Cs-F1sF1sH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'C[CH]O[C](F)C(F)(F)F(11011)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]OC(F)(F)[C](F)F(11004)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)(F)[C](F)F(284)', '[CH]C-2(978)'],
    products = ['C[CH]OC(F)(F)[C](F)F(11004)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', 'C[CH]O[C](F)F(1877)'],
    products = ['C[CH]OC(F)(F)[C](F)F(11004)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['C[CH]OC(F)(F)[C](F)F(11004)'],
    products = ['C=COC(F)(F)C(F)F(11006)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C[CH]OC(F)=C(F)F(6486)'],
    products = ['C[CH]OC(F)(F)[C](F)F(11004)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=COC(F)(F)[C](F)F(11007)'],
    products = ['C[CH]OC(F)(F)[C](F)F(11004)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', 'C[CH]O[C](F)F(1877)'],
    products = ['C[CH]OC(F)(F)[C](F)F(11004)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]COC(F)(F)[C](F)F(11008)'],
    products = ['C[CH]OC(F)(F)[C](F)F(11004)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH]OC(F)(F)C(F)F(11009)'],
    products = ['C[CH]OC(F)(F)[C](F)F(11004)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CC(F)O[C](F)[C](F)F(11010)'],
    products = ['C[CH]OC(F)(F)[C](F)F(11004)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C[CH]OC(F)(F)[C](F)F(11004)'],
    products = ['C[CH]O[C](F)C(F)(F)F(11011)'],
...
network(
    label = 'PDepNetwork #3309',
    isomers = [
        'C[CH]OC(F)(F)[C](F)F(11004)',
    ],
    reactants = [
        ('CF2CF2(61)', 'CH3CHO(36)'),
    ],
