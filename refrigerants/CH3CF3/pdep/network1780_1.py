...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'C#COO(2132)'],
    products = ['C#COOCF(6196)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'C#COOF(2133)'],
    products = ['C#COOCF(6196)'],
    transitionState = 'TS3',
