...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.306833,0.0757829,-7.93372e-05,3.99764e-08,-7.84902e-12,-100668,26.8139], Tmin=(100,'K'), Tmax=(1242.77,'K')), NASAPolynomial(coeffs=[18.7748,0.0163413,-7.59201e-06,1.48953e-09,-1.06821e-13,-105258,-66.2972], Tmin=(1242.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-838.142,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = 'O=C=C(F)OCC(F)F(4337)',
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.102671,0.0814854,-0.000100001,6.24823e-08,-1.43806e-11,-78033.4,22.885], Tmin=(100,'K'), Tmax=(1284.83,'K')), NASAPolynomial(coeffs=[15.4966,0.0144445,-1.61401e-07,-5.14412e-10,5.50461e-14,-80516.8,-50.3473], Tmin=(1284.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-650.099,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFFO) + group(CsCFHO) + group(Cs-CsOsHH) + ring(1,4-Dioxane) + radical(CsCsF1sO2s) + radical(CCsJOCs)"""),
)

species(
    label = '[O]C1[C](F)OCC1(F)F(4379)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-608.905,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,197,221,431,657,2120,512.5,787.5,300.754,442.279,442.508,443.942,444.076],'cm^-1')),
        HinderedRotor(inertia=(0.000868708,'amu*angstrom^2'), symmetry=1, barrier=(0.12088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0847842,'amu*angstrom^2'), symmetry=1, barrier=(11.7665,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217466,'amu*angstrom^2'), symmetry=1, barrier=(30.5404,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (139.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.361285,0.0852978,-0.000122535,8.85697e-08,-2.52593e-11,-73107.9,27.2303], Tmin=(100,'K'), Tmax=(859.929,'K')), NASAPolynomial(coeffs=[14.0883,0.021448,-1.11634e-05,2.23014e-09,-1.59269e-13,-75468.8,-36.9234], Tmin=(859.929,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-608.905,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-617.944,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,355,410,600,1181,1341,1420,3056,190,488,555,1236,1407,1855,455,950,245.287,245.308,245.31,245.322],'cm^-1')),
        HinderedRotor(inertia=(0.169144,'amu*angstrom^2'), symmetry=1, barrier=(7.22236,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.169152,'amu*angstrom^2'), symmetry=1, barrier=(7.22224,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.607869,'amu*angstrom^2'), symmetry=1, barrier=(25.9545,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.169112,'amu*angstrom^2'), symmetry=1, barrier=(7.2223,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.133562,0.102243,-0.000181994,1.64018e-07,-5.65578e-11,-74183.5,30.3928], Tmin=(100,'K'), Tmax=(849.583,'K')), NASAPolynomial(coeffs=[10.5093,0.030107,-1.57414e-05,3.04275e-09,-2.08706e-13,-75196.9,-14.5394], Tmin=(849.583,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-617.944,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFFH) + group(Cds-OdCsH) + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical(COj(Cs-F1sO2sH)(O2d))"""),
)

species(
    label = 'O=CC(F)O[CH][C](F)F(4384)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-590.464,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([232,360,932,1127,1349,1365,3045,3025,407.5,1350,352.5,2782.5,750,1395,475,1775,1000,190,488,555,1236,1407,268.51,268.552,268.579,2381.94],'cm^-1')),
        HinderedRotor(inertia=(0.223185,'amu*angstrom^2'), symmetry=1, barrier=(11.4179,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.223094,'amu*angstrom^2'), symmetry=1, barrier=(11.4179,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.622445,'amu*angstrom^2'), symmetry=1, barrier=(31.863,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.622536,'amu*angstrom^2'), symmetry=1, barrier=(31.8632,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00190647,0.0969427,-0.000162791,1.43153e-07,-4.93833e-11,-70881.1,30.8442], Tmin=(100,'K'), Tmax=(808.773,'K')), NASAPolynomial(coeffs=[10.9523,0.0303164,-1.60974e-05,3.17267e-09,-2.21822e-13,-72244.6,-17.1399], Tmin=(808.773,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-590.464,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFFH) + group(Cds-OdCsH) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = 'O=[C][C](F)OCC(F)F(4385)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.229667,0.094205,-0.000164666,1.51061e-07,-5.31767e-11,-81802.7,28.4684], Tmin=(100,'K'), Tmax=(848.078,'K')), NASAPolynomial(coeffs=[8.1717,0.0338139,-1.72914e-05,3.32709e-09,-2.28225e-13,-82325.1,-3.67652], Tmin=(848.078,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-681.185,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFFH) + group(Cds-OdCsH) + radical(CsCOF1sO2s) + radical(COj(Cs-F1sO2sH)(O2d))"""),
)
...
"""),
    E0 = (-316.136,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,293,496,537,1218,3120,650,792.5,1650,341.842,344.197,344.859,347.24],'cm^-1')),
        HinderedRotor(inertia=(0.145339,'amu*angstrom^2'), symmetry=1, barrier=(12.3646,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.213983,'amu*angstrom^2'), symmetry=1, barrier=(17.9699,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.264164,'amu*angstrom^2'), symmetry=1, barrier=(22.2296,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.494684,0.0812539,-0.000111985,7.71242e-08,-2.09093e-11,-37899.7,25.3638], Tmin=(100,'K'), Tmax=(904.298,'K')), NASAPolynomial(coeffs=[14.3808,0.0198311,-1.01004e-05,2.01234e-09,-1.4397e-13,-40411.1,-40.2316], Tmin=(904.298,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-316.136,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CdCFO) + group(Cds-CdsHH) + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical(Cdj(Cd-F1sO2s)(H))"""),
)

species(
    label = 'FC1=COC(F)(F)CO1(4387)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  O u0 p2 c0 {6,S} {8,S}
...
"""),
    E0 = (-180.954,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,1685,370,2120,512.5,787.5,302.164,302.195,302.244,302.332],'cm^-1')),
        HinderedRotor(inertia=(0.242324,'amu*angstrom^2'), symmetry=1, barrier=(15.7088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.242248,'amu*angstrom^2'), symmetry=1, barrier=(15.7099,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.24244,'amu*angstrom^2'), symmetry=1, barrier=(15.7108,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.583968,0.0783903,-0.0001165,8.49457e-08,-2.40365e-11,-21643.6,27.3076], Tmin=(100,'K'), Tmax=(872.858,'K')), NASAPolynomial(coeffs=[14.4848,0.0146909,-7.03821e-06,1.346e-09,-9.34134e-14,-24070.4,-37.8662], Tmin=(872.858,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-180.954,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical(C=CJO)"""),
)

species(
    label = 'O[C]=C(F)OC[C](F)F(4391)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.924498,'amu*angstrom^2'), symmetry=1, barrier=(21.256,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.924981,'amu*angstrom^2'), symmetry=1, barrier=(21.2671,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.923721,'amu*angstrom^2'), symmetry=1, barrier=(21.2382,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.923654,'amu*angstrom^2'), symmetry=1, barrier=(21.2366,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.81793,0.104506,-0.000145562,9.38829e-08,-2.30324e-11,-67978.3,30.5865], Tmin=(100,'K'), Tmax=(1012.75,'K')), NASAPolynomial(coeffs=[23.3506,0.0090489,-4.18058e-06,8.15387e-10,-5.8532e-14,-72873.7,-86.3189], Tmin=(1012.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-566.658,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsOsH) + radical(CCsJOC(O)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = 'FOC=[C]OC[C](F)F(4393)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.267696,0.0937368,-0.000126562,8.19135e-08,-2.03957e-11,-24456.6,32.0249], Tmin=(100,'K'), Tmax=(993.616,'K')), NASAPolynomial(coeffs=[19.5315,0.0140313,-6.23507e-06,1.1802e-09,-8.26805e-14,-28391.1,-63.3678], Tmin=(993.616,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-204.623,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical(C=CJO)"""),
)

species(
    label = '[O]C=[C]OCC(F)(F)F(4394)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=C[C](F)OC[C](F)F(4332)'],
...
reaction(
    label = 'reaction2',
    reactants = ['O=C[C]F(4375)', '[O]C[C](F)F(174)'],
    products = ['O=C[C](F)OC[C](F)F(4332)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', '[CH2]O[C](F)C=O(4131)'],
    products = ['O=C[C](F)OC[C](F)F(4332)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['O=C[C](F)OC[C](F)F(4332)'],
    products = ['F[C](F)COC1(F)[CH]O1(4377)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O=C[C](F)OC[C](F)F(4332)'],
    products = ['F[C]1[CH]OC(F)(F)CO1(4378)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O=C[C](F)OC[C](F)F(4332)'],
    products = ['[O]C1[C](F)OCC1(F)F(4379)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C[C](F)OC=C(F)F(4380)'],
    products = ['O=C[C](F)OC[C](F)F(4332)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C=C(F)OC[C](F)F(4381)'],
    products = ['O=C[C](F)OC[C](F)F(4332)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C[C]F-2(1215)', '[O]C[C](F)F(174)'],
    products = ['O=C[C](F)OC[C](F)F(4332)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(43)', '[CH2]O[C](F)C=O(4131)'],
    products = ['O=C[C](F)OC[C](F)F(4332)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=C[C](F)OC[C](F)F(4332)'],
    products = ['O=C[C](F)O[CH]C(F)F(4382)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=[C]C(F)OC[C](F)F(4383)'],
    products = ['O=C[C](F)OC[C](F)F(4332)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=CC(F)O[CH][C](F)F(4384)'],
    products = ['O=C[C](F)OC[C](F)F(4332)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C(C[C](F)F)C(=O)F(4329)'],
    products = ['O=C[C](F)OC[C](F)F(4332)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O(6)', '[CH]=C(F)OC[C](F)F(4386)'],
    products = ['O=C[C](F)OC[C](F)F(4332)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O=C[C](F)OC[C](F)F(4332)'],
    products = ['[O][CH]C1(F)OCC1(F)F(4389)'],
...
reaction(
    label = 'reaction26',
    reactants = ['HF(38)', 'O=C=[C]OC[C](F)F(4390)'],
    products = ['O=C[C](F)OC[C](F)F(4332)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O[C]=C(F)OC[C](F)F(4391)'],
    products = ['O=C[C](F)OC[C](F)F(4332)'],
...
reaction(
    label = 'reaction28',
    reactants = ['OC=C(F)O[CH][C](F)F(4392)'],
    products = ['O=C[C](F)OC[C](F)F(4332)'],
