...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C=C(F)F(2883)'],
    products = ['[CH]=CC([O])(F)F(2870)'],
    transitionState = 'TS2',
