...
species(
    label = '[CH]=C(F)C([CH]F)=C(F)F(5880)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = '[CH]=C(F)C(F)(F)C(=[CH])F(7472)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)C(F)(F)[C]=CF(7247)'],
    products = ['C2HF(58)', 'FC=C=C(F)F(1375)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C(F)C(F)(F)[C]=CF(7247)'],
    products = ['[CH]=C(F)C([CH]F)=C(F)F(5880)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=CF-2(1219)', '[CH]C(F)=C(F)F(516)'],
    products = ['[CH]=C(F)C(F)(F)[C]=CF(7247)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]=C(F)C(F)(F)[C]=CF(7247)'],
    products = ['FC=C1C=C(F)C1(F)F(7462)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH]=C(F)C(F)=C=CF(7463)'],
    products = ['[CH]=C(F)C(F)(F)[C]=CF(7247)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=[C]F(489)', 'FC=C=C(F)F(1375)'],
    products = ['[CH]=C(F)C(F)(F)[C]=CF(7247)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C#CC(F)(F)[C]=CF(7464)'],
    products = ['[CH]=C(F)C(F)(F)[C]=CF(7247)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C2HF(58)', 'F[CH][C]=C(F)F(2138)'],
    products = ['[CH]=C(F)C(F)(F)[C]=CF(7247)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]=C(F)C(F)(F)C#C(7465)'],
    products = ['[CH]=C(F)C(F)(F)[C]=CF(7247)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH]=C(F)C(F)(F)C#CF(7466)'],
    products = ['[CH]=C(F)C(F)(F)[C]=CF(7247)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=[C]F(489)', 'F[CH][C]=C(F)F(2138)'],
    products = ['[CH]=C(F)C(F)(F)[C]=CF(7247)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(78)', '[CH]=C=C(F)[C]=CF(7467)'],
    products = ['[CH]=C(F)C(F)(F)[C]=CF(7247)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=C(F)C(F)(F)C=[C]F(7447)'],
    products = ['[CH]=C(F)C(F)(F)[C]=CF(7247)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(F)C(F)(F)[C]=CF(7247)'],
    products = ['C=C(F)C(F)(F)[C]=[C]F(7468)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=C(F)C(F)(F)[C]=CF(7247)'],
    products = ['[CH]C(F)=C(F)C(F)=CF(7469)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C(F)C(F)(F)[C]=CF(7247)'],
    products = ['F[CH]C(F)=C(F)[C]=CF(7470)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=[C]C(F)(F)C(F)=CF(7471)'],
    products = ['[CH]=C(F)C(F)(F)[C]=CF(7247)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=C(F)C(F)(F)C(=[CH])F(7472)'],
    products = ['[CH]=C(F)C(F)(F)[C]=CF(7247)'],
...
network(
    ...
    isomers = [
        '[CH]=C(F)C(F)(F)[C]=CF(7247)',
    ],
    reactants = [
        ('C2HF(58)', 'FC=C=C(F)F(1375)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
