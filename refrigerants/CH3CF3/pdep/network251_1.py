...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', '[O]O[CH]F(893)'],
    products = ['[O]OC(F)[CH]F(800)'],
    transitionState = 'TS3',
