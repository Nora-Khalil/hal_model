...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(804)', 'F[C]C=CF(883)'],
    products = ['F[C]=CC(F)[CH]F(875)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'FC#CC(F)[CH]F(888)'],
    products = ['F[C]=CC(F)[CH]F(875)'],
    transitionState = 'TS9',
