...
reaction(
    label = 'reaction2',
    reactants = ['CH4(4)', 'F[C]C(F)(F)OF(324)'],
    products = ['CC(F)C(F)(F)OF(10245)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['FOF(328)', 'CC(F)[C]F(10298)'],
    products = ['CC(F)C(F)(F)OF(10245)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['OF(195)', 'CC(F)=C(F)F(331)'],
    products = ['CC(F)C(F)(F)OF(10245)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(328)', 'CC=C(F)F(3883)'],
    products = ['CC(F)C(F)(F)OF(10245)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C[CH]C(F)(F)OF(8945)'],
    products = ['CC(F)C(F)(F)OF(10245)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'CC(F)[C](F)OF(10300)'],
    products = ['CC(F)C(F)(F)OF(10245)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'CC(F)C([O])(F)F(10301)'],
    products = ['CC(F)C(F)(F)OF(10245)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(127)', 'CC(F)[C](F)F(992)'],
    products = ['CC(F)C(F)(F)OF(10245)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FO[C](F)F(236)', 'CH3-CHF(63)'],
    products = ['CC(F)C(F)(F)OF(10245)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(19)', 'F[CH]C(F)(F)OF(1379)'],
    products = ['CC(F)C(F)(F)OF(10245)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'C[C](F)C(F)(F)OF(332)'],
    products = ['CC(F)C(F)(F)OF(10245)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH2]C(F)C(F)(F)OF(1831)'],
    products = ['CC(F)C(F)(F)OF(10245)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(78)', 'CC(F)C(=O)F(10302)'],
    products = ['CC(F)C(F)(F)OF(10245)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(78)', 'CC=C(F)OF(8948)'],
    products = ['CC(F)C(F)(F)OF(10245)'],
