...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH2]C(=O)OC=O(8677)'],
    products = ['C=C(OF)OC=O(8636)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C=O(322)', 'C=[C]OF(1642)'],
    products = ['C=C(OF)OC=O(8636)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(127)', 'C=[C]OC=O(2591)'],
    products = ['C=C(OF)OC=O(8636)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH]=C(OF)OC=O(8678)'],
    products = ['C=C(OF)OC=O(8636)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C=C(OF)O[C]=O(8679)'],
    products = ['C=C(OF)OC=O(8636)'],
