...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'O=C(F)C=C[C]F(3709)'],
    products = ['[O]C(C=[C]F)C(=O)F(4586)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(C=[C]F)C(=O)F(4586)'],
    products = ['O=C(F)C1C=C(F)O1(4684)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(C=[C]F)C(=O)F(4586)'],
    products = ['[O]C1C=C(F)C1([O])F(4689)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=C(C=[C]F)[C](O)F(4690)'],
    products = ['[O]C(C=[C]F)C(=O)F(4586)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C(F)C(=O)C=[C]F(4691)'],
    products = ['[O]C(C=[C]F)C(=O)F(4586)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(C#CF)C(=O)F(4692)'],
    products = ['[O]C(C=[C]F)C(=O)F(4586)'],
