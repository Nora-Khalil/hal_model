...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)C(F)C(F)F(1824)'],
...
reaction(
    ...
    products = ['OC(F)(F)C(F)C(F)F(1824)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OC(F)F(1007)', 'F[C]C(F)F(169)'],
    products = ['OC(F)(F)C(F)C(F)F(1824)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CF2(43)', 'OC(F)C(F)F(1008)'],
    products = ['OC(F)(F)C(F)C(F)F(1824)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['HF(38)', 'OC(F)(F)C(F)[C]F(5235)'],
    products = ['OC(F)(F)C(F)C(F)F(1824)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OC(F)(F)C(F)C(F)F(1824)'],
    products = ['OC(C(F)F)C(F)(F)F(5236)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H2O(3)', 'FC(F)=C(F)C(F)F(1033)'],
    products = ['OC(F)(F)C(F)C(F)F(1824)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OC(F)F(1007)', 'CHFCF2(55)'],
    products = ['OC(F)(F)C(F)C(F)F(1824)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'OC(F)(F)[CH]C(F)F(5237)'],
    products = ['OC(F)(F)C(F)C(F)F(1824)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'O[C](F)C(F)C(F)F(5238)'],
    products = ['OC(F)(F)C(F)C(F)F(1824)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'OC(F)(F)C(F)[CH]F(5239)'],
    products = ['OC(F)(F)C(F)C(F)F(1824)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(7)', 'F[C](F)C(F)C(F)F(1378)'],
    products = ['OC(F)(F)C(F)C(F)F(1824)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[O]C(F)(F)C(F)C(F)F(1353)'],
    products = ['OC(F)(F)C(F)C(F)F(1824)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CHF2(82)', 'OC(F)(F)[CH]F(1419)'],
    products = ['OC(F)(F)C(F)C(F)F(1824)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'OC(F)(F)[C](F)C(F)F(2864)'],
    products = ['OC(F)(F)C(F)C(F)F(1824)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'OC(F)(F)C(F)[C](F)F(3877)'],
    products = ['OC(F)(F)C(F)C(F)F(1824)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F2(78)', 'OC(F)=CC(F)F(5240)'],
    products = ['OC(F)(F)C(F)C(F)F(1824)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'OC(F)=C(F)C(F)F(2867)'],
    products = ['OC(F)(F)C(F)C(F)F(1824)'],
...
reaction(
    label = 'reaction25',
    reactants = ['F2(78)', 'OC(F)(F)C=CF(5241)'],
    products = ['OC(F)(F)C(F)C(F)F(1824)'],
