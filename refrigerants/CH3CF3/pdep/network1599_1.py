...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]OC(F)(F)[CH]F(5612)'],
...
reaction(
    ...
    products = ['F[CH]OC(F)(F)[CH]F(5612)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', 'F[CH]O[C](F)F(835)'],
    products = ['F[CH]OC(F)(F)[CH]F(5612)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]OC(F)=CF(5674)'],
    products = ['F[CH]OC(F)(F)[CH]F(5612)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(40)', 'F[CH]O[C](F)F(835)'],
    products = ['F[CH]OC(F)(F)[CH]F(5612)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F[CH]O[C](F)C(F)F(5662)'],
    products = ['F[CH]OC(F)(F)[CH]F(5612)'],
