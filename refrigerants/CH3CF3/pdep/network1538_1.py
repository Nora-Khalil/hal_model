...
"""),
    E0 = (-630.617,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,280,501,1494,1531,334,575,1197,1424,3202,2782.5,750,1395,475,1775,1000,204.679,204.924,204.96,1256.95],'cm^-1')),
        HinderedRotor(inertia=(1.5497,'amu*angstrom^2'), symmetry=1, barrier=(46.1935,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.55499,'amu*angstrom^2'), symmetry=1, barrier=(46.1949,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.452945,'amu*angstrom^2'), symmetry=1, barrier=(13.4422,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.54862,'amu*angstrom^2'), symmetry=1, barrier=(46.1956,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.531246,0.0833325,-0.000121522,9.97756e-08,-3.3657e-11,-75727.4,27.8236], Tmin=(100,'K'), Tmax=(720.557,'K')), NASAPolynomial(coeffs=[9.53837,0.033333,-1.74393e-05,3.47999e-09,-2.47724e-13,-77025.4,-12.6789], Tmin=(720.557,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-630.617,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsH) + radical(CsCOF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
species(
    label = 'F[C]1[CH]OC(F)C(F)O1(4635)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-506.517,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([280,501,1494,1531,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,2782.5,750,1395,475,1775,1000,201.008,203.448,204.681],'cm^-1')),
        HinderedRotor(inertia=(1.30425,'amu*angstrom^2'), symmetry=1, barrier=(37.2603,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.28226,'amu*angstrom^2'), symmetry=1, barrier=(37.3043,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.3276,'amu*angstrom^2'), symmetry=1, barrier=(37.2514,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.901666,0.0618554,-5.88299e-05,2.73027e-08,-4.97403e-12,-60803.1,23.8206], Tmin=(100,'K'), Tmax=(1330.29,'K')), NASAPolynomial(coeffs=[16.186,0.0158979,-7.00956e-06,1.33335e-09,-9.36528e-14,-64869.6,-54.2794], Tmin=(1330.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-506.517,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CsCOF1sO2s)"""),
)
...
"""),
    E0 = (-602.262,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,334,575,1197,1424,3202,197,221,431,657,2120,512.5,787.5,180,286.586,615.022,615.282,615.399],'cm^-1')),
        HinderedRotor(inertia=(0.929237,'amu*angstrom^2'), symmetry=1, barrier=(21.365,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140259,'amu*angstrom^2'), symmetry=1, barrier=(37.6689,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.929277,'amu*angstrom^2'), symmetry=1, barrier=(21.3659,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (139.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.326166,0.0829174,-0.000106495,6.65288e-08,-1.62536e-11,-72304.7,26.6193], Tmin=(100,'K'), Tmax=(1003.01,'K')), NASAPolynomial(coeffs=[16.6405,0.0178564,-9.19725e-06,1.85893e-09,-1.3478e-13,-75577.4,-52.1373], Tmin=(1003.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-602.262,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
"""),
    E0 = (-634.376,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([551,1088,1226,1380,1420,1481,3057,3119,395,473,707,1436,280,501,1494,1531,2782.5,750,1395,475,1775,1000,182.961,192.457,194.275,197.268],'cm^-1')),
        HinderedRotor(inertia=(0.209047,'amu*angstrom^2'), symmetry=1, barrier=(4.9529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.05499,'amu*angstrom^2'), symmetry=1, barrier=(55.0061,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03578,'amu*angstrom^2'), symmetry=1, barrier=(25.4161,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.07228,'amu*angstrom^2'), symmetry=1, barrier=(55.016,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.35926,0.0885435,-0.000143031,1.26708e-07,-4.45159e-11,-76174.9,28.0554], Tmin=(100,'K'), Tmax=(803.657,'K')), NASAPolynomial(coeffs=[8.95654,0.0334672,-1.73028e-05,3.38974e-09,-2.36867e-13,-77160,-9.07398], Tmin=(803.657,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-634.376,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsH) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(CsCOF1sO2s)"""),
)

species(
    label = 'O=[C]C(F)OC(F)[CH]F(4639)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-574.961,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([232,360,932,1127,1349,1365,3045,395,473,707,1436,2782.5,750,1395,475,1775,1000,334,575,1197,1424,3202,243.068,244.941,245.5,246.604],'cm^-1')),
        HinderedRotor(inertia=(0.203465,'amu*angstrom^2'), symmetry=1, barrier=(8.62158,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.506401,'amu*angstrom^2'), symmetry=1, barrier=(22.3571,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.200144,'amu*angstrom^2'), symmetry=1, barrier=(8.60341,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02492,'amu*angstrom^2'), symmetry=1, barrier=(42.1481,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.172849,0.1009,-0.000170973,1.49036e-07,-5.06384e-11,-69010.3,30.1002], Tmin=(100,'K'), Tmax=(821.222,'K')), NASAPolynomial(coeffs=[11.9102,0.0288285,-1.51883e-05,2.97173e-09,-2.06456e-13,-70549.2,-23.0998], Tmin=(821.222,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-574.961,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsH) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = 'O=[C][C](F)OC(F)CF(4641)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.366919,0.0873837,-0.000137251,1.18333e-07,-4.07997e-11,-80544.9,27.7303], Tmin=(100,'K'), Tmax=(790.047,'K')), NASAPolynomial(coeffs=[9.72068,0.0318559,-1.63135e-05,3.19306e-09,-2.23434e-13,-81767.9,-13.5783], Tmin=(790.047,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-670.716,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsH) + radical(CsCOF1sO2s) + radical(COj(Cs-F1sO2sH)(O2d))"""),
)

species(
    label = 'O=CC(F)(F)O[CH][CH]F(4642)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-605.625,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([251,367,519,700,855,1175,1303,3025,407.5,1350,352.5,2782.5,750,1395,475,1775,1000,334,575,1197,1424,3202,277.29,277.29,277.29,277.29],'cm^-1')),
        HinderedRotor(inertia=(0.145391,'amu*angstrom^2'), symmetry=1, barrier=(7.93294,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145391,'amu*angstrom^2'), symmetry=1, barrier=(7.93293,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145391,'amu*angstrom^2'), symmetry=1, barrier=(7.93294,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.547492,'amu*angstrom^2'), symmetry=1, barrier=(29.8726,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.377978,0.107136,-0.000189796,1.68331e-07,-5.73075e-11,-72692.6,31.0472], Tmin=(100,'K'), Tmax=(843.676,'K')), NASAPolynomial(coeffs=[12.1551,0.0282765,-1.50301e-05,2.92349e-09,-2.01264e-13,-74115.6,-23.1873], Tmin=(843.676,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-605.625,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCsFHH) + group(Cds-OdCsH) + radical(Csj(Cs-F1sHH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    E0 = (-601.435,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,259,529,569,1128,1321,1390,3140,334,575,1197,1424,3202,486,617,768,1157,1926,180,615.112,615.135,615.145],'cm^-1')),
        HinderedRotor(inertia=(0.0150169,'amu*angstrom^2'), symmetry=1, barrier=(4.03223,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.441388,'amu*angstrom^2'), symmetry=1, barrier=(10.1484,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.44139,'amu*angstrom^2'), symmetry=1, barrier=(10.1484,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.657753,0.079001,-0.000104547,7.27329e-08,-2.03833e-11,-72220.3,31.9005], Tmin=(100,'K'), Tmax=(867.449,'K')), NASAPolynomial(coeffs=[12.0894,0.0262859,-1.33897e-05,2.6731e-09,-1.91495e-13,-74203.6,-21.6248], Tmin=(867.449,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-601.435,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(COCsFO) + radical(C=OCOJ) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.01061,'amu*angstrom^2'), symmetry=1, barrier=(23.2359,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01039,'amu*angstrom^2'), symmetry=1, barrier=(23.2309,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01151,'amu*angstrom^2'), symmetry=1, barrier=(23.2565,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01097,'amu*angstrom^2'), symmetry=1, barrier=(23.2442,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.508805,0.0998364,-0.000137603,8.9817e-08,-2.25237e-11,-67117,29.3832], Tmin=(100,'K'), Tmax=(986.574,'K')), NASAPolynomial(coeffs=[20.7411,0.0136797,-6.60888e-06,1.29858e-09,-9.28104e-14,-71309.9,-72.848], Tmin=(986.574,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-559.389,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsOsH) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = 'FC=CO[C](F)[CH]OF(4650)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.333157,0.0977244,-0.000133834,8.78528e-08,-2.23379e-11,-26697.5,29.7592], Tmin=(100,'K'), Tmax=(969.218,'K')), NASAPolynomial(coeffs=[19.2706,0.0168215,-8.62911e-06,1.73445e-09,-1.25188e-13,-30497.6,-64.205], Tmin=(969.218,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-223.257,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(CsCFHO) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CsCsF1sO2s) + radical(CCsJO)"""),
)

species(
    label = 'F[CH]C(F)O[C]=COF(4651)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.2974,'amu*angstrom^2'), symmetry=1, barrier=(29.8297,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29761,'amu*angstrom^2'), symmetry=1, barrier=(29.8347,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29804,'amu*angstrom^2'), symmetry=1, barrier=(29.8445,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['O=C[C](F)OC(F)[CH]F(4595)'],
...
reaction(
    label = 'reaction2',
    reactants = ['O=C[C]F(3808)', '[O]C(F)[CH]F(839)'],
    products = ['O=C[C](F)OC(F)[CH]F(4595)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', 'O=C[C](F)O[CH]F(3765)'],
    products = ['O=C[C](F)OC(F)[CH]F(4595)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['O=C[C](F)OC(F)[CH]F(4595)'],
    products = ['F[CH]C(F)OC1(F)[CH]O1(4634)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O=C[C](F)OC(F)[CH]F(4595)'],
    products = ['F[C]1[CH]OC(F)C(F)O1(4635)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O=C[C](F)OC(F)[CH]F(4595)'],
    products = ['[O]C1[C](F)OC(F)C1F(4636)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O=C[C](F)OC=CF(4637)'],
    products = ['O=C[C](F)OC(F)[CH]F(4595)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C[C](F)OC(F)=CF(4507)'],
    products = ['O=C[C](F)OC(F)[CH]F(4595)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C=C(F)OC(F)[CH]F(4638)'],
    products = ['O=C[C](F)OC(F)[CH]F(4595)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=C[C]F-2(1228)', '[O]C(F)[CH]F(839)'],
    products = ['O=C[C](F)OC(F)[CH]F(4595)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHF(40)', 'O=C[C](F)O[CH]F(3765)'],
    products = ['O=C[C](F)OC(F)[CH]F(4595)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=C[C](F)OC(F)[CH]F(4595)'],
    products = ['O=C[C](F)O[C](F)CF(4051)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=[C]C(F)OC(F)[CH]F(4639)'],
    products = ['O=C[C](F)OC(F)[CH]F(4595)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=CC(F)O[C](F)[CH]F(4640)'],
    products = ['O=C[C](F)OC(F)[CH]F(4595)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O=CC(F)(F)O[CH][CH]F(4642)'],
    products = ['O=C[C](F)OC(F)[CH]F(4595)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O=C[C](F)OC(F)[CH]F(4595)'],
    products = ['O=C[C](F)O[CH]C(F)F(3982)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O]C(C(=O)F)C(F)[CH]F(4592)'],
    products = ['O=C[C](F)OC(F)[CH]F(4595)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O(6)', '[CH]=C(F)OC(F)[CH]F(4643)'],
    products = ['O=C[C](F)OC(F)[CH]F(4595)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O=C[C](F)OC(F)[CH]F(4595)'],
    products = ['FC1=COC(F)C(F)O1(4644)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O=C[C](F)OC(F)[CH]F(4595)'],
    products = ['[O][CH]C1(F)OC(F)C1F(4646)'],
...
reaction(
    label = 'reaction29',
    reactants = ['HF(38)', 'O=C=[C]OC(F)[CH]F(4647)'],
    products = ['O=C[C](F)OC(F)[CH]F(4595)'],
...
reaction(
    label = 'reaction30',
    reactants = ['O[C]=C(F)OC(F)[CH]F(4648)'],
    products = ['O=C[C](F)OC(F)[CH]F(4595)'],
...
reaction(
    label = 'reaction31',
    reactants = ['OC=C(F)O[C](F)[CH]F(4649)'],
    products = ['O=C[C](F)OC(F)[CH]F(4595)'],
...
reaction(
    label = 'reaction32',
    reactants = ['FC=CO[C](F)[CH]OF(4650)'],
    products = ['O=C[C](F)OC(F)[CH]F(4595)'],
...
reaction(
    label = 'reaction33',
    reactants = ['F[CH]C(F)O[C]=COF(4651)'],
    products = ['O=C[C](F)OC(F)[CH]F(4595)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[O]C=[C]OC(F)C(F)F(4652)'],
    products = ['O=C[C](F)OC(F)[CH]F(4595)'],
...
network(
    label = 'PDepNetwork #1538',
    isomers = [
        'O=C[C](F)OC(F)[CH]F(4595)',
    ],
    reactants = [
