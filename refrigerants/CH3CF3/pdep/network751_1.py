...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'C#COO(2067)'],
    products = ['C#COOC(F)F(1796)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'C#COO[CH]F(2069)'],
    products = ['C#COOC(F)F(1796)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#COO[C](F)F(1881)'],
    products = ['C#COOC(F)F(1796)'],
    transitionState = 'TS8',
