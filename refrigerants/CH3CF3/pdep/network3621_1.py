...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.271036,'amu*angstrom^2'), symmetry=1, barrier=(6.23164,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.270741,'amu*angstrom^2'), symmetry=1, barrier=(6.22486,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.666548,0.078459,-0.000101339,7.2007e-08,-2.08455e-11,-122624,26.8793], Tmin=(100,'K'), Tmax=(838.105,'K')), NASAPolynomial(coeffs=[10.8558,0.0298301,-1.43075e-05,2.77952e-09,-1.95946e-13,-124332,-20.4786], Tmin=(838.105,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1020.51,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(CsCdFFF) + group(Cds-CdsCsCs) + group(CdCFH)"""),
)
...
"""),
    E0 = (-794.805,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([219,296,586,564,718,793,1177,1228,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,194,682,905,1196,1383,3221,180,1874.91,1876.6],'cm^-1')),
        HinderedRotor(inertia=(0.205947,'amu*angstrom^2'), symmetry=1, barrier=(4.73512,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205421,'amu*angstrom^2'), symmetry=1, barrier=(4.72303,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.813204,0.0785134,-0.000124775,1.13776e-07,-4.12297e-11,-95486.3,27.1969], Tmin=(100,'K'), Tmax=(807.784,'K')), NASAPolynomial(coeffs=[6.57729,0.0355041,-1.80464e-05,3.5225e-09,-2.45897e-13,-95945.6,3.54041], Tmin=(807.784,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-794.805,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(CsCdFFF) + group(Cds-CdsCsCs) + group(CdCFH) + radical(CCOJ)"""),
)
...
8  C u0 p0 c0 {4,S} {9,S} {10,S} {13,S}
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43613,0.0671498,-5.32992e-05,-2.50229e-08,5.31486e-11,-93854.4,25.7119], Tmin=(100,'K'), Tmax=(487.074,'K')), NASAPolynomial(coeffs=[7.12073,0.0383101,-1.94364e-05,3.84287e-09,-2.72465e-13,-94619.8,0.203346], Tmin=(487.074,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-781.026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(CsCsFFF) + group(CsCsFHH) + radical(CCOJ) + radical(CCJ(C)CO)"""),
)

species(
    label = 'O[CH]C([CH]F)C(F)(F)F(12224)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.146572,0.0995941,-0.000162953,1.39669e-07,-4.68562e-11,-94405.6,30.4576], Tmin=(100,'K'), Tmax=(826.822,'K')), NASAPolynomial(coeffs=[11.7442,0.0300783,-1.5086e-05,2.90376e-09,-2.00197e-13,-95962.1,-22.1686], Tmin=(826.822,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-786.107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(CsCsFFF) + group(CsCsFHH) + radical(CCsJOH) + radical(Csj(Cs-CsCsH)(F1s)(H))"""),
)

species(
    label = '[O][CH]C(CF)C(F)(F)F(12225)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.176567,0.0938591,-0.000154641,1.39136e-07,-4.91293e-11,-90473.1,29.4341], Tmin=(100,'K'), Tmax=(820.72,'K')), NASAPolynomial(coeffs=[8.57728,0.0361298,-1.84524e-05,3.58957e-09,-2.49346e-13,-91286.7,-5.99058], Tmin=(820.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-753.302,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(CsCsFFF) + group(CsCsFHH) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = 'OC[C]([CH]F)C(F)(F)F(12226)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.547909,0.0821988,-0.000112426,8.58798e-08,-2.68641e-11,-97762.8,28.6241], Tmin=(100,'K'), Tmax=(776.275,'K')), NASAPolynomial(coeffs=[10.2172,0.0323692,-1.61293e-05,3.17016e-09,-2.24343e-13,-99263.8,-15.5747], Tmin=(776.275,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-813.831,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(CsCsFFF) + group(CsCsFHH) + radical(CCJ(C)CO) + radical(Csj(Cs-CsCsH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', '[O]CC(F)[CH]F(828)'],
    products = ['[O]CC([CH]F)C(F)(F)F(6916)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.33582e-06,'m^3/(mol*s)'), n=3.3552, Ea=(236.972,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R',), comment="""Estimated from node CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(804)', '[O]C[CH]C(F)(F)F(1152)'],
    products = ['[O]CC([CH]F)C(F)(F)F(6916)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[CH2]C([CH]F)C(F)(F)F(12133)'],
    products = ['[O]CC([CH]F)C(F)(F)F(6916)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]CC([CH]F)C(F)(F)F(6916)'],
    products = ['O=CC(CF)C(F)(F)F(12220)'],
    transitionState = 'TS9',
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(20.9321,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)

reaction(
    label = 'reaction11',
    reactants = ['CF3(45)', '[O]CC=CF(859)'],
    products = ['[O]CC([CH]F)C(F)(F)F(6916)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(12.0396,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)

reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]CC(=CF)C(F)(F)F(12221)'],
    products = ['[O]CC([CH]F)C(F)(F)F(6916)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]CC([CH]F)C(F)(F)F(6916)'],
    products = ['[O]C[C](CF)C(F)(F)F(12223)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]CC([CH]F)C(F)(F)F(6916)'],
    products = ['O[CH]C([CH]F)C(F)(F)F(12224)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]CC([CH]F)C(F)(F)F(6916)'],
    products = ['[O][CH]C(CF)C(F)(F)F(12225)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]CC([CH]F)C(F)(F)F(6916)'],
    products = ['OC[C]([CH]F)C(F)(F)F(12226)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(65.7473,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

reaction(
    label = 'reaction25',
    reactants = ['[O]CC([C](F)F)C(F)F(6656)'],
    products = ['[O]CC([CH]F)C(F)(F)F(6916)'],
