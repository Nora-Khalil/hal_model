...
reaction(
    label = 'reaction1',
    reactants = ['F[C]=CC(F)(F)[C](F)F(2348)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(138)', 'F[C]C=C(F)F(504)'],
    products = ['F[C]=CC(F)(F)[C](F)F(2348)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'F[C]=CC(F)=C(F)F(1082)'],
    products = ['F[C]=CC(F)(F)[C](F)F(2348)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'FC#CC(F)(F)[C](F)F(2510)'],
    products = ['F[C]=CC(F)(F)[C](F)F(2348)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['HF(38)', 'F[C]=C=C(F)[C](F)F(2511)'],
    products = ['F[C]=CC(F)(F)[C](F)F(2348)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(43)', 'F[C]C=C(F)F(504)'],
    products = ['F[C]=CC(F)(F)[C](F)F(2348)'],
...
reaction(
    label = 'reaction11',
    reactants = ['FC=[C]C(F)(F)[C](F)F(2512)'],
    products = ['F[C]=CC(F)(F)[C](F)F(2348)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C]=[C]C(F)(F)C(F)F(2513)'],
    products = ['F[C]=CC(F)(F)[C](F)F(2348)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[C]=CC(F)(F)[C](F)F(2348)'],
    products = ['F[C]C=C(F)C(F)(F)F(2514)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[C]=CC(F)(F)[C](F)F(2348)'],
    products = ['F[C](F)C=C(F)[C](F)F(1137)'],
