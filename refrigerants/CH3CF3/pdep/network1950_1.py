...
reaction(
    label = 'reaction1',
    reactants = ['[C-]=[O+]C(F)(F)C=C(F)F(6636)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', '[C-]=[O+]C=C(F)F(7223)'],
    products = ['[C-]=[O+]C(F)(F)C=C(F)F(6636)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C-]=[O+]F(3632)', 'F[C]C=C(F)F-2(1319)'],
    products = ['[C-]=[O+]C(F)(F)C=C(F)F(6636)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C-]=[O+]C(F)(F)C=C(F)F(6636)'],
    products = ['F[C-][O+]=C(F)C=C(F)F(7224)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C-]=[O+]C(F)(F)C=C(F)F(6636)'],
    products = ['FC(F)=C[C-][O+]=C(F)F(7225)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[C-]=[O+]C(F)=CC(F)(F)F(7226)'],
    products = ['[C-]=[O+]C(F)(F)C=C(F)F(6636)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['HF(38)', '[C-]=[O+]C(F)=C=C(F)F(7227)'],
    products = ['[C-]=[O+]C(F)(F)C=C(F)F(6636)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['HF(38)', '[C-]=[O+]C(F)(F)C#CF(2966)'],
    products = ['[C-]=[O+]C(F)(F)C=C(F)F(6636)'],
    transitionState = 'TS8',
...
network(
    label = 'PDepNetwork #1950',
    isomers = [
        '[C-]=[O+]C(F)(F)C=C(F)F(6636)',
    ],
    reactants = [
