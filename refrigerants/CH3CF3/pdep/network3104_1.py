...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=O)O[O](1575)'],
    products = ['O=O(161)', 'CH2CO(28)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[C]=O(785)', 'CH2(T)(18)'],
    products = ['[CH2]C(=O)O[O](1575)'],
    transitionState = 'TS3',
