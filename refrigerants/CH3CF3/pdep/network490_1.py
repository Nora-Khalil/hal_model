...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.000342537,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00530874,'amu*angstrom^2'), symmetry=1, barrier=(7.15689,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06658,0.0469801,-5.97786e-05,4.45955e-08,-1.40372e-11,-44537.9,16.5826], Tmin=(100,'K'), Tmax=(762.19,'K')), NASAPolynomial(coeffs=[6.74809,0.0224117,-1.14287e-05,2.30599e-09,-1.66402e-13,-45251.6,-4.73179], Tmin=(762.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-370.855,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
"""),
    E0 = (-337.169,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,212,367,445,1450,190,488,555,1236,1407,2920.79],'cm^-1')),
        HinderedRotor(inertia=(0.262948,'amu*angstrom^2'), symmetry=1, barrier=(6.0457,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.263023,'amu*angstrom^2'), symmetry=1, barrier=(6.04741,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01007,0.0513415,-8.83704e-05,8.63716e-08,-3.23636e-11,-40487.7,21.4514], Tmin=(100,'K'), Tmax=(834.956,'K')), NASAPolynomial(coeffs=[3.88553,0.0258662,-1.29785e-05,2.52114e-09,-1.7488e-13,-40226.1,16.1839], Tmin=(834.956,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-337.169,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsCsF1s) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'CC(F)(F)[C]F-2(9297)'],
    products = ['CC(F)(F)[C](F)F(335)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C[C](F)[C](F)F(9298)'],
    products = ['CC(F)(F)[C](F)F(335)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(19)', 'F[C](F)[C](F)F(1586)'],
    products = ['CC(F)(F)[C](F)F(335)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'C=C(F)[C](F)F(2239)'],
    products = ['CC(F)(F)[C](F)F(335)'],
