...
species(
    label = 'F[CH]C(F)(F)C(F)=C(F)F(1155)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[CH]C(F)(F)[C](F)C(F)(F)F(2472)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[CH][C](F)C(F)(F)C(F)(F)F(2473)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)(F)C(F)(F)[C](F)F(2357)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(804)', 'F[C](F)C(F)(F)[C](F)F(2389)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C](F)F(2357)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]C(F)(F)C(F)=C(F)F(1155)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C](F)F(2357)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'FC=C(F)C(F)(F)[C](F)F(2471)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C](F)F(2357)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['F2(78)', 'F[CH]C(F)=C(F)[C](F)F(1156)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C](F)F(2357)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', 'F[C](F)C(F)(F)[C](F)F(2389)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C](F)F(2357)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]C(F)(F)C(F)(F)[C](F)F(2357)'],
    products = ['F[CH]C(F)(F)[C](F)C(F)(F)F(2472)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)(F)C(F)(F)[C](F)F(2357)'],
    products = ['F[CH][C](F)C(F)(F)C(F)(F)F(2473)'],
...
network(
    label = 'PDepNetwork #992',
    isomers = [
        'F[CH]C(F)(F)C(F)(F)[C](F)F(2357)',
    ],
    reactants = [
        ('CF2CF2(61)', 'CHFCF2(55)'),
    ],
