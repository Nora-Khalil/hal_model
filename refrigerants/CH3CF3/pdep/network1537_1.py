...
"""),
    E0 = (-477.159,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,611,648,830,1210,1753,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.974274,'amu*angstrom^2'), symmetry=1, barrier=(22.4005,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.972671,'amu*angstrom^2'), symmetry=1, barrier=(22.3636,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.972433,'amu*angstrom^2'), symmetry=1, barrier=(22.3581,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'O=C(F)C(F)O[CH][CH]F(4659)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)[CH]OC(F)[CH]F(4594)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F(3804)', '[O]C(F)[CH]F(839)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', 'O=C(F)[CH]O[CH]F(3761)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4594)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O=C(F)[CH]OC(F)[CH]F(4594)'],
    products = ['O=C(F)C1OC(F)C1F(4596)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['O=C(F)[CH]OC(F)[CH]F(4594)'],
    products = ['F[CH]C(F)OC1O[C]1F(4654)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=C(F)[CH]OC=CF(4656)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4594)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)[CH]OC(F)=CF(4520)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4594)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O=C=COC(F)[CH]F(4657)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4594)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', 'O=C(F)[CH]O[CH]F(3761)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4594)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=C(F)[CH]OC(F)[CH]F(4594)'],
    products = ['O=C(F)[CH]O[C](F)CF(4063)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=C(F)CO[C](F)[CH]F(4658)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4594)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=C(F)[CH]OC(F)[CH]F(4594)'],
    products = ['O=C(F)C(F)O[CH][CH]F(4659)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O(6)', 'F[C]=COC(F)[CH]F(4661)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4594)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O=C(F)[CH]OC(F)[CH]F(4594)'],
    products = ['[O][C](F)C1OC(F)C1F(4663)'],
...
reaction(
    label = 'reaction28',
    reactants = ['OC(F)=[C]OC(F)[CH]F(4664)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4594)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[O]C(F)=[C]OC(F)CF(4665)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4594)'],
...
reaction(
    label = 'reaction30',
    reactants = ['OC(F)=CO[C](F)[CH]F(4666)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4594)'],
...
reaction(
    label = 'reaction31',
    reactants = ['FC=CO[CH][C](F)OF(4667)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4594)'],
...
reaction(
    label = 'reaction32',
    reactants = ['F[CH]C(F)OC=[C]OF(4668)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4594)'],
