...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C(=C)F(496)'],
    products = ['[CH]=C(F)C[O](469)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][O](194)', '[CH]=[C]F(489)'],
    products = ['[CH]=C(F)C[O](469)'],
    transitionState = 'TS9',
