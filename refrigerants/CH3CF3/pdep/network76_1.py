...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[C](F)F(242)'],
...
reaction(
    ...
    products = ['[CH2]C(F)(F)O[C](F)F(242)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[C](F)O[C](F)F(280)'],
    products = ['[CH2]C(F)(F)O[C](F)F(242)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(F)O[C](F)F(281)'],
    products = ['[CH2]C(F)(F)O[C](F)F(242)'],
    transitionState = 'TS6',
