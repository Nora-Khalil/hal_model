...
species(
    label = '[O]C1([O])C(F)(F)C1(F)F(3361)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(=O)C(F)(F)[C](F)F(3268)'],
...
reaction(
    label = 'reaction2',
    reactants = ['O=C(OF)[C](F)[C](F)F(3358)'],
    products = ['[O]C(=O)C(F)(F)[C](F)F(3268)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'O=[C]C(F)(F)[C](F)F(1631)'],
    products = ['[O]C(=O)C(F)(F)[C](F)F(3268)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)C(F)(F)[C](F)F(3268)'],
    products = ['F[C](F)C(F)(F)[C]1OO1(3359)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)C(F)(F)[C](F)F(3268)'],
    products = ['[O][C]1OC(F)(F)C1(F)F(3360)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)C(F)(F)[C](F)F(3268)'],
    products = ['[O]C1([O])C(F)(F)C1(F)F(3361)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(=O)C(F)=C(F)F(1357)'],
    products = ['[O]C(=O)C(F)(F)[C](F)F(3268)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C(=O)C(F)(F)[C](F)F(3268)'],
    products = ['[O]C(=O)[C](F)C(F)(F)F(3362)'],
