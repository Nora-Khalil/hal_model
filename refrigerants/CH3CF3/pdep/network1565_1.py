...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(192)', '[O]C([O])F(5649)'],
    products = ['[O]C(F)O[C]=O(4933)'],
    transitionState = 'TS2',
