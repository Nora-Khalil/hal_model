...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]OC(F)(F)[CH]F(2952)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(804)', '[O]C(F)(F)[CH]F(846)'],
    products = ['F[CH]OC(F)(F)[CH]F(2952)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', 'F[CH]O[C](F)F(840)'],
    products = ['F[CH]OC(F)(F)[CH]F(2952)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]OC(F)=CF(2996)'],
    products = ['F[CH]OC(F)(F)[CH]F(2952)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(40)', 'F[CH]O[C](F)F(840)'],
    products = ['F[CH]OC(F)(F)[CH]F(2952)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF(40)', '[O]C(F)(F)[CH]F(846)'],
    products = ['F[CH]OC(F)(F)[CH]F(2952)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F[CH]O[C](F)C(F)F(2978)'],
    products = ['F[CH]OC(F)(F)[CH]F(2952)'],
