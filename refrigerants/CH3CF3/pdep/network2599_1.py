...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH2]C([O])F(5619)'],
    products = ['[CH2]CC([O])F(8985)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['[O][CH]F(2815)', '[CH2][CH2](979)'],
    products = ['[CH2]CC([O])F(8985)'],
