...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', 'C=C[C]F(486)'],
    products = ['F[C]=CC[CH]F(10148)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'FC#CC[CH]F(10178)'],
    products = ['F[C]=CC[CH]F(10148)'],
    transitionState = 'TS9',
