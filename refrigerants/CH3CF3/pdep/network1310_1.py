...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]OC1(F)[CH]O1(3981)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(192)', '[O]C1(F)[CH]O1(4091)'],
    products = ['O=[C]OC1(F)[CH]O1(3981)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(13)', '[O]C1(F)[CH]O1(4091)'],
    products = ['O=[C]OC1(F)[CH]O1(3981)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC1=CO1(4139)'],
    products = ['O=[C]OC1(F)[CH]O1(3981)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]OC1(F)[CH]O1(3981)'],
    products = ['O=C(F)O[C]1[CH]O1(4140)'],
