...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=CO[CH]OF(2065)'],
    products = ['O=COC(F)OF(7844)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(F)OC=O(7854)'],
    products = ['O=COC(F)OF(7844)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[CH]OF(3905)', '[O]C=O(322)'],
    products = ['O=COC(F)OF(7844)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['HCO(15)', '[O]C(F)OF(5778)'],
    products = ['O=COC(F)OF(7844)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(127)', 'O=CO[CH]F(5665)'],
    products = ['O=COC(F)OF(7844)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=CO[C](F)OF(1837)'],
    products = ['O=COC(F)OF(7844)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=[C]OC(F)OF(7855)'],
    products = ['O=COC(F)OF(7844)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'O=COC(=O)F(1840)'],
    products = ['O=COC(F)OF(7844)'],
