...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', '[CH]C=CF(6397)'],
    products = ['[CH]=CC(F)[C](F)F(6394)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=CC=C(F)F(2932)'],
    products = ['[CH]=CC(F)[C](F)F(6394)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=CC(F)=C(F)F(6400)'],
    products = ['[CH]=CC(F)[C](F)F(6394)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C#CC(F)[C](F)F(1109)'],
    products = ['[CH]=CC(F)[C](F)F(6394)'],
