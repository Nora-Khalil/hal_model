...
"""),
    E0 = (-244.174,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,277,555,632,2750,2850,1437.5,1250,1305,750,350,401.728,402.024],'cm^-1')),
        HinderedRotor(inertia=(0.187791,'amu*angstrom^2'), symmetry=1, barrier=(21.5461,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188079,'amu*angstrom^2'), symmetry=1, barrier=(21.5472,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188189,'amu*angstrom^2'), symmetry=1, barrier=(21.5494,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.0312,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80038,0.0347561,-9.86488e-07,-3.9832e-08,2.23095e-11,-29275.5,17.9372], Tmin=(100,'K'), Tmax=(917.167,'K')), NASAPolynomial(coeffs=[18.9221,-0.00407365,3.89932e-06,-7.74475e-10,4.90234e-14,-33923.7,-71.4031], Tmin=(917.167,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-244.174,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(Cs-OsOsHH)"""),
)
...
"""),
    E0 = (-16.7763,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,2750,2850,1437.5,1250,1305,750,350,464.49,464.505,464.508],'cm^-1')),
        HinderedRotor(inertia=(0.000781357,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.296814,'amu*angstrom^2'), symmetry=1, barrier=(45.4424,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.0232,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23333,0.0331039,-2.83822e-05,1.13529e-08,-1.76475e-12,-1949.31,16.8716], Tmin=(100,'K'), Tmax=(1553.41,'K')), NASAPolynomial(coeffs=[12.2269,0.00737032,-3.53315e-06,6.88446e-10,-4.84352e-14,-5054.1,-35.7432], Tmin=(1553.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-16.7763,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(Cs-OsOsHH) + radical(OCOJ)"""),
)
