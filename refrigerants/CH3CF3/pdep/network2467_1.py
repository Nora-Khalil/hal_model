...
reaction(
    label = 'reaction3',
    reactants = ['C2H2(23)', '[CH]=[CH](977)'],
    products = ['[CH]=CC=[CH](8753)'],
    transitionState = 'TS3',
