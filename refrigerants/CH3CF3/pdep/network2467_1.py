...
"""),
    E0 = (-727.577,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([230,274,587,678,790,1206,1241,1314,375,552.5,462.5,1710,1855,455,950,268.717],'cm^-1')),
        HinderedRotor(inertia=(0.171466,'amu*angstrom^2'), symmetry=1, barrier=(8.78629,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.70271,'amu*angstrom^2'), symmetry=1, barrier=(87.0403,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.026,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48042,0.058137,-8.08537e-05,5.59693e-08,-1.51774e-11,-87419,21.9451], Tmin=(100,'K'), Tmax=(906.087,'K')), NASAPolynomial(coeffs=[11.6485,0.0132497,-6.54485e-06,1.296e-09,-9.25047e-14,-89261.6,-26.1072], Tmin=(906.087,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-727.577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo library: 2-BTP_G4 + radical(CCCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02351,0.0709501,-9.13304e-05,6.2488e-08,-1.73934e-11,-84619.2,23.8651], Tmin=(100,'K'), Tmax=(869.132,'K')), NASAPolynomial(coeffs=[10.8372,0.025784,-1.33792e-05,2.69507e-09,-1.94167e-13,-86325.1,-22.1039], Tmin=(869.132,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-704.416,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(CsCsFFF) + ring(12dioxetane) + radical(Cs_P)"""),
)

species(
    label = '[O]C1(O)OC1C(F)(F)F(10598)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19863,0.0665145,-9.46189e-05,7.79005e-08,-2.61639e-11,-105538,27.9766], Tmin=(100,'K'), Tmax=(786.489,'K')), NASAPolynomial(coeffs=[8.03401,0.0277983,-1.32414e-05,2.5316e-09,-1.7551e-13,-106491,-2.58131], Tmin=(786.489,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-878.293,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsOs) + group(CsCsFFF) + ring(O2s-Cs-Cs(C-FFF)) + radical(CCOJ)"""),
)

species(
    label = '[O]C(=C(O)O)C(F)(F)F(10599)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.652572,'amu*angstrom^2'), symmetry=1, barrier=(15.0039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.652136,'amu*angstrom^2'), symmetry=1, barrier=(14.9939,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.65175,'amu*angstrom^2'), symmetry=1, barrier=(14.985,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.653243,0.0971331,-0.00013934,9.0988e-08,-2.21885e-11,-126941,27.1399], Tmin=(100,'K'), Tmax=(1081.85,'K')), NASAPolynomial(coeffs=[23.6953,0.00148168,1.08193e-06,-3.51109e-10,2.94353e-14,-131880,-90.7215], Tmin=(1081.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1056.88,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsCdFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + radical(C=C(C)OJ)"""),
)
...
"""),
    E0 = (-1142.48,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,230,274,587,678,790,1206,1241,1314,375,552.5,462.5,1710,392.847,392.855,392.874,392.878,392.936,392.975],'cm^-1')),
        HinderedRotor(inertia=(0.0023666,'amu*angstrom^2'), symmetry=1, barrier=(5.03156,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.367171,'amu*angstrom^2'), symmetry=1, barrier=(40.2284,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.367158,'amu*angstrom^2'), symmetry=1, barrier=(40.2285,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-780.501,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,193,295,551,588,656,1146,1192,1350,1855,455,950,338.626],'cm^-1')),
        HinderedRotor(inertia=(0.280588,'amu*angstrom^2'), symmetry=1, barrier=(22.5376,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118319,'amu*angstrom^2'), symmetry=1, barrier=(9.64651,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.239175,'amu*angstrom^2'), symmetry=1, barrier=(19.3695,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.275418,'amu*angstrom^2'), symmetry=1, barrier=(22.5482,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(C(=O)O)C(F)(F)F(8714)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[O]C(O)C(F)(F)F(2602)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(43)', '[O]C(F)C(=O)O(6982)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(8714)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'O=[C]C(=O)C(F)(F)F(10596)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(8714)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OC(F)(F)F(248)', 'O=[C]C=O(1495)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(8714)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(C(=O)O)C(F)(F)F(8714)'],
    products = ['[O]C=C(O)OC(F)(F)F(5098)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O(6)', 'O=C(O)[CH]C(F)(F)F(2090)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(8714)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(C(=O)O)C(F)(F)F(8714)'],
    products = ['O[C]1OOC1C(F)(F)F(10597)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(C(=O)O)C(F)(F)F(8714)'],
    products = ['[O]C1(O)OC1C(F)(F)F(10598)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(=C(O)O)C(F)(F)F(10599)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(8714)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C(O)C(=O)C(F)(F)F(10600)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(8714)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(7)', '[O]C([C]=O)C(F)(F)F(10601)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(8714)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[O]C(=O)C([O])C(F)(F)F(10602)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(8714)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=[C]O(457)', '[O][CH]C(F)(F)F(1243)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(8714)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', '[O]C(O)=C([O])C(F)(F)F(10603)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(8714)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(C(=O)O)C(F)(F)F(8714)'],
    products = ['O=C(O)[C](O)C(F)(F)F(10604)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O=[C]C(OO)C(F)(F)F(10605)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(8714)'],
