...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.974786,'amu*angstrom^2'), symmetry=1, barrier=(22.4123,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.974572,'amu*angstrom^2'), symmetry=1, barrier=(22.4073,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.975359,'amu*angstrom^2'), symmetry=1, barrier=(22.4254,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.057,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.621398,'amu*angstrom^2'), symmetry=1, barrier=(14.2872,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.621482,'amu*angstrom^2'), symmetry=1, barrier=(14.2891,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'CC(F)OF(5938)'],
    products = ['CC(F)(F)C(F)OF(5936)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH3F(39)', 'F[C]C(F)OF(5785)'],
    products = ['CC(F)(F)C(F)OF(5936)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FOC(F)F(247)', 'C[C]F(325)'],
    products = ['CC(F)(F)C(F)OF(5936)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(195)', 'CC(F)(F)[C]F(327)'],
    products = ['CC(F)(F)C(F)OF(5936)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF(40)', 'CC(F)(F)OF(323)'],
    products = ['CC(F)(F)C(F)OF(5936)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['FOF(328)', 'CC(F)=CF(5940)'],
    products = ['CC(F)(F)C(F)OF(5936)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[C](F)C(F)OF(5941)'],
    products = ['CC(F)(F)C(F)OF(5936)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC(F)(F)[CH]OF(364)'],
    products = ['CC(F)(F)C(F)OF(5936)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'CC(F)(F)C([O])F(5942)'],
    products = ['CC(F)(F)C(F)OF(5936)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(127)', 'CC(F)(F)[CH]F(993)'],
    products = ['CC(F)(F)C(F)OF(5936)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]OF(3905)', 'CH3-CF2(65)'],
    products = ['CC(F)(F)C(F)OF(5936)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(19)', 'FOC(F)[C](F)F(1506)'],
    products = ['CC(F)(F)C(F)OF(5936)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'CC(F)(F)[C](F)OF(333)'],
    products = ['CC(F)(F)C(F)OF(5936)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH2]C(F)(F)C(F)OF(5943)'],
    products = ['CC(F)(F)C(F)OF(5936)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F2(78)', 'CC(F)(F)C=O(309)'],
    products = ['CC(F)(F)C(F)OF(5936)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'CC(F)(F)C(=O)F(214)'],
    products = ['CC(F)(F)C(F)OF(5936)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'CC(F)=C(F)OF(338)'],
    products = ['CC(F)(F)C(F)OF(5936)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'C=C(F)C(F)OF(5944)'],
    products = ['CC(F)(F)C(F)OF(5936)'],
