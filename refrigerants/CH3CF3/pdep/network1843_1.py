...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH]=C[O](623)'],
    products = ['[CH]=CO[CH2](6450)'],
    transitionState = 'TS2',
