...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(976)', '[O]C[C]=O(907)'],
    products = ['C=[C]OC[C]=O(9140)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(192)', '[CH2]O[C]=C(1691)'],
    products = ['C=[C]OC[C]=O(9140)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[CH2]O[C]=C(1691)'],
    products = ['C=[C]OC[C]=O(9140)'],
    transitionState = 'TS6',
