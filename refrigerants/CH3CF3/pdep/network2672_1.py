...
"""),
    E0 = (150.891,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,94,120,354,641,825,1294,540,610,2055,371.513,373.12,376.708],'cm^-1')),
        HinderedRotor(inertia=(0.513935,'amu*angstrom^2'), symmetry=1, barrier=(51.1644,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0553,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.26809,0.0390862,-3.04903e-05,1.28448e-08,-2.30486e-12,18209.3,17.867], Tmin=(100,'K'), Tmax=(1266.93,'K')), NASAPolynomial(coeffs=[7.88261,0.0213597,-9.5027e-06,1.80092e-09,-1.256e-13,16786.7,-10.5481], Tmin=(1266.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(150.891,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(AllylJ2_triplet)"""),
)

species(
    label = 'FC(F)=C1C=CC1F(10668)',
    structure = adjacencyList("""1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[CH]C1=C[CH]C1(F)F(10681)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (120.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.486024,0.0839063,-0.000136582,1.1381e-07,-3.62448e-11,-17322.9,26.2056], Tmin=(100,'K'), Tmax=(903.323,'K')), NASAPolynomial(coeffs=[10.9445,0.0225372,-9.67142e-06,1.69442e-09,-1.08978e-13,-18598,-19.7863], Tmin=(903.323,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-145.031,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(CsCsFHH) + group(CsCsFFH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Tert_Propargyl) + radical(CsCsF1sF1s)"""),
)

species(
    label = '[CH]=CC(=[C]F)C(F)F(10684)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.792889,'amu*angstrom^2'), symmetry=1, barrier=(18.2301,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.792621,'amu*angstrom^2'), symmetry=1, barrier=(18.2239,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.838664,0.0721836,-9.21704e-05,5.99836e-08,-1.54551e-11,-2985.8,24.6272], Tmin=(100,'K'), Tmax=(948.557,'K')), NASAPolynomial(coeffs=[13.2458,0.019864,-9.43589e-06,1.83678e-09,-1.30164e-13,-5339.61,-34.5752], Tmin=(948.557,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-25.7535,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + group(Cds-CdsHH) + radical(CdCdF1s) + radical(Cds_P)"""),
)

species(
    label = 'F[C]C(C=CF)=CF(10685)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (344.912,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,113,247,382,1207,3490,540,610,2055,388.425,392.221,397.353,399.039],'cm^-1')),
        HinderedRotor(inertia=(0.00104288,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0649,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.43928,0.0318872,-1.81679e-05,5.00048e-09,-5.54696e-13,41541.4,16.1445], Tmin=(100,'K'), Tmax=(2008.49,'K')), NASAPolynomial(coeffs=[10.2724,0.0162872,-6.51749e-06,1.13344e-09,-7.3364e-14,38394.8,-27.1087], Tmin=(2008.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(344.912,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(AllylJ2_triplet)"""),
)

species(
    label = 'FC=C1C=CC1(F)F(10659)',
    structure = adjacencyList("""1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  F u0 p3 c0 {8,S}
4  C u0 p0 c0 {1,S} {2,S} {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (120.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48969,0.0476836,-3.15207e-05,8.01358e-09,-1.87394e-13,-20550.8,22.2972], Tmin=(100,'K'), Tmax=(1231.28,'K')), NASAPolynomial(coeffs=[12.9072,0.0197271,-8.59138e-06,1.62411e-09,-1.13475e-13,-24054.9,-37.973], Tmin=(1231.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-171.672,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(CsCCFH) + group(CsCsFFH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cs(F)-Cs-Cd-Cd) + radical(Allyl_T) + radical(CsCsF1sF1s)"""),
)
...
"""),
    ...
    molecularWeight = (120.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.872264,0.0735506,-0.000102772,7.7719e-08,-2.36635e-11,-19962.5,24.8588], Tmin=(100,'K'), Tmax=(801.992,'K')), NASAPolynomial(coeffs=[10.5933,0.025065,-1.20852e-05,2.33225e-09,-1.63075e-13,-21521.7,-19.8943], Tmin=(801.992,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-166.878,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CsCdF1sH) + radical(C=C=CJ)"""),
)

species(
    label = 'C=CC([C]F)=C(F)F(10688)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (120.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06204,0.0663405,-7.65066e-05,4.50638e-08,-1.05983e-11,-16904.2,22.2757], Tmin=(100,'K'), Tmax=(1030.97,'K')), NASAPolynomial(coeffs=[12.8809,0.0204857,-9.79155e-06,1.92379e-09,-1.37431e-13,-19341.2,-35.1043], Tmin=(1030.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-141.418,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(CdCFF) + group(Cds-CdsHH) + radical(CsCCl_triplet)"""),
)

species(
    label = '[CH]=CC(=[CH])C(F)(F)F(10689)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.886144,'amu*angstrom^2'), symmetry=1, barrier=(20.3742,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.883459,'amu*angstrom^2'), symmetry=1, barrier=(20.3125,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.646152,0.0709167,-8.3002e-05,4.75294e-08,-1.05588e-11,-10957.3,23.8103], Tmin=(100,'K'), Tmax=(1107.34,'K')), NASAPolynomial(coeffs=[16.4057,0.013989,-5.88809e-06,1.10347e-09,-7.73977e-14,-14447.5,-53.8275], Tmin=(1107.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-92.1291,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCdFFF) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(C=CF)=C(F)F(10690)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (120.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.705718,0.0682642,-6.69072e-05,3.37437e-08,-6.78625e-12,-18832.5,24.2457], Tmin=(100,'K'), Tmax=(1202.85,'K')), NASAPolynomial(coeffs=[14.6791,0.0217967,-8.96054e-06,1.62743e-09,-1.11231e-13,-22194.1,-45.7487], Tmin=(1202.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-157.598,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(CdCFF) + group(CdCFH) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC([CH]F)=C(F)F(10634)'],
    products = ['C2H2(23)', 'FC=C=C(F)F(1375)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=CC(F)[C]=C(F)F(10635)'],
    products = ['[CH]=CC([CH]F)=C(F)F(10634)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', '[CH]C=C=C(F)F(10679)'],
    products = ['[CH]=CC([CH]F)=C(F)F(10634)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=CC([CH]F)=C(F)F(10634)'],
    products = ['F[CH]C1=C[CH]C1(F)F(10681)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=CC([CH]F)=C(F)F(10634)'],
    products = ['F[CH]C1([C](F)F)C=C1(10682)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=[CH](1000)', 'FC=C=C(F)F(1375)'],
    products = ['[CH]=CC([CH]F)=C(F)F(10634)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C2H2(23)', 'F[CH][C]=C(F)F(2138)'],
    products = ['[CH]=CC([CH]F)=C(F)F(10634)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C#CC([CH]F)=C(F)F(7530)'],
    products = ['[CH]=CC([CH]F)=C(F)F(10634)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=[CH](1000)', 'F[CH][C]=C(F)F(2138)'],
    products = ['[CH]=CC([CH]F)=C(F)F(10634)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', '[CH]C=C=C(F)F(10679)'],
    products = ['[CH]=CC([CH]F)=C(F)F(10634)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=CC([CH]F)=C(F)F(10634)'],
    products = ['C=[C]C([CH]F)=C(F)F(8369)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=CC(=[C]F)C(F)F(10684)'],
    products = ['[CH]=CC([CH]F)=C(F)F(10634)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=CC(F)(F)[C]=CF(10636)'],
    products = ['[CH]=CC([CH]F)=C(F)F(10634)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C]F(138)', '[CH]C=C=CF(2782)'],
    products = ['[CH]=CC([CH]F)=C(F)F(10634)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=CC([CH]F)=C(F)F(10634)'],
    products = ['F[C](F)[C]1C=CC1F(10686)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CF2(43)', '[CH]C=C=CF(2782)'],
    products = ['[CH]=CC([CH]F)=C(F)F(10634)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=CC([CH]F)=C(F)F(10634)'],
    products = ['[CH]=C=C([CH]F)C(F)F(10687)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]=CC(=[CH])C(F)(F)F(10689)'],
    products = ['[CH]=CC([CH]F)=C(F)F(10634)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]=CC([CH]F)=C(F)F(10634)'],
    products = ['[CH]C(C=CF)=C(F)F(10690)'],
...
network(
    label = 'PDepNetwork #2672',
    isomers = [
        '[CH]=CC([CH]F)=C(F)F(10634)',
    ],
    reactants = [
        ('C2H2(23)', 'FC=C=C(F)F(1375)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
