...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[CH]CC=CF(10271)'],
    products = ['F[CH]CC[CH]F(10243)'],
    transitionState = 'TS7',
