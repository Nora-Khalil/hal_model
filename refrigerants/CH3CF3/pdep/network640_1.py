...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]OC([O])(F)F(238)'],
    products = ['[O]OOC([O])(F)F(1595)'],
    transitionState = 'TS2',
