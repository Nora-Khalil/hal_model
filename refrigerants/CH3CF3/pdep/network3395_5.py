...
"""),
    E0 = (-117.472,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([347,453,1141,1468,353,444,1253,3145,623.911,623.961,624.002,624.088,624.167,624.37,624.417],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-98.8496,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([405,756,886,1212,182,240,577,636,1210,1413,225.96,226.364,1988.81,1989.21],'cm^-1')),
        HinderedRotor(inertia=(0.173284,'amu*angstrom^2'), symmetry=1, barrier=(6.29739,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.0351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94721,0.0507424,-8.8168e-05,8.12889e-08,-2.93934e-11,-11820.4,16.1122], Tmin=(100,'K'), Tmax=(796.056,'K')), NASAPolynomial(coeffs=[6.69037,0.0181121,-1.0107e-05,2.03395e-09,-1.43962e-13,-12296.8,-3.93819], Tmin=(796.056,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-98.8496,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CdCCF) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F)) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.220017,'amu*angstrom^2'), symmetry=1, barrier=(5.05863,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.0351,'amu'),
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'FC1=C(F)[CH]1(2242)'],
    products = ['FC1=CC1(F)F(974)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'FC1(F)[C]=C1(2243)'],
    products = ['FC1=CC1(F)F(974)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'FC1=[C]C1(F)F(2244)'],
    products = ['FC1=CC1(F)F(974)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'FC1=C=C1F(2247)'],
    products = ['FC1=CC1(F)F(974)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', 'FC1(F)C#C1(2248)'],
    products = ['FC1=CC1(F)F(974)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'F[C]=C=[C]F(2868)'],
    products = ['F[C]C=C(F)F(5917)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C]F(138)', '[CH]=[C]F(489)'],
    products = ['F[C]C=C(F)F(5917)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'F[C]=C=C(F)F(2804)'],
    products = ['F[C]C=C(F)F(5917)'],
