...
"""),
    E0 = (-394.637,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,347,453,1141,1468,2750,2850,1437.5,1250,1305,750,350,617,898,1187,217.13,217.152,217.175,217.199,2048.27],'cm^-1')),
        HinderedRotor(inertia=(0.349879,'amu*angstrom^2'), symmetry=1, barrier=(11.7087,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.350067,'amu*angstrom^2'), symmetry=1, barrier=(11.709,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.88649,'amu*angstrom^2'), symmetry=1, barrier=(29.6644,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.70594,0.0792254,-0.000131241,1.13446e-07,-3.87281e-11,-47351.8,24.7436], Tmin=(100,'K'), Tmax=(788.714,'K')), NASAPolynomial(coeffs=[10.3798,0.0235148,-1.26428e-05,2.51127e-09,-1.76674e-13,-48670.9,-18.3198], Tmin=(788.714,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-394.637,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + group(Cs-CsOsHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-774.097,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.52901,'amu*angstrom^2'), symmetry=1, barrier=(12.163,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00640829,'amu*angstrom^2'), symmetry=1, barrier=(25.5941,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.484536,'amu*angstrom^2'), symmetry=1, barrier=(11.1404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.48455,'amu*angstrom^2'), symmetry=1, barrier=(11.1408,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.484556,'amu*angstrom^2'), symmetry=1, barrier=(11.1409,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
...
"""),
    E0 = (-872.679,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,235,523,627,1123,1142,1372,1406,3097,2750,2850,1437.5,1250,1305,750,350,415.137,1446.94,1446.94],'cm^-1')),
        HinderedRotor(inertia=(0.000978124,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0444211,'amu*angstrom^2'), symmetry=1, barrier=(5.43249,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.04953,'amu*angstrom^2'), symmetry=1, barrier=(24.1308,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05017,'amu*angstrom^2'), symmetry=1, barrier=(24.1454,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04951,'amu*angstrom^2'), symmetry=1, barrier=(24.1302,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (149.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0776556,0.09394,-0.000132791,9.01188e-08,-2.37722e-11,-94311,26.2685], Tmin=(100,'K'), Tmax=(932.94,'K')), NASAPolynomial(coeffs=[17.8247,0.0171838,-9.38155e-06,1.93252e-09,-1.41011e-13,-97651.4,-58.8572], Tmin=(932.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-785.338,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJO)"""),
)

species(
    label = 'FOCC(F)(F)[C](F)F(2600)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.396066,'amu*angstrom^2'), symmetry=1, barrier=(9.10633,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00011,'amu*angstrom^2'), symmetry=1, barrier=(22.9945,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.394453,'amu*angstrom^2'), symmetry=1, barrier=(9.06925,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (149.039,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'FOCC(F)F(340)'],
    products = ['FOCC(F)(F)C(F)F(2370)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['HF(38)', 'F[C]C(F)(F)COF(1385)'],
    products = ['FOCC(F)(F)C(F)F(2370)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF(40)', 'FOCC(F)(F)F(1386)'],
    products = ['FOCC(F)(F)C(F)F(2370)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['FOF(328)', 'C=C(F)C(F)F(1397)'],
    products = ['FOCC(F)(F)C(F)F(2370)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'FOC[C](F)C(F)F(1401)'],
    products = ['FOCC(F)(F)C(F)F(2370)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'F[CH]C(F)(F)COF(1392)'],
    products = ['FOCC(F)(F)C(F)F(2370)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]CC(F)(F)C(F)F(2598)'],
    products = ['FOCC(F)(F)C(F)F(2370)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(127)', '[CH2]C(F)(F)C(F)F(1420)'],
    products = ['FOCC(F)(F)C(F)F(2370)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]OF(222)', 'CHF2-CF2(69)'],
    products = ['FOCC(F)(F)C(F)F(2370)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF2(82)', 'FOC[C](F)F(363)'],
    products = ['FOCC(F)(F)C(F)F(2370)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'FO[CH]C(F)(F)C(F)F(2599)'],
    products = ['FOCC(F)(F)C(F)F(2370)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'FOCC(F)(F)[C](F)F(2600)'],
    products = ['FOCC(F)(F)C(F)F(2370)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F2(78)', 'FC=C(F)COF(1394)'],
    products = ['FOCC(F)(F)C(F)F(2370)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=CC(F)(F)C(F)F(1459)'],
    products = ['FOCC(F)(F)C(F)F(2370)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'FOCC(F)=C(F)F(2602)'],
    products = ['FOCC(F)(F)C(F)F(2370)'],
