...
"""),
    E0 = (-344.258,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([174,267,591,721,1107,1278,1348,3273,246,474,533,1155,190,488,555,1236,1407,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.422597,'amu*angstrom^2'), symmetry=1, barrier=(9.71633,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00756484,'amu*angstrom^2'), symmetry=1, barrier=(40.1204,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13928,0.0685428,-0.000101149,8.06725e-08,-2.59685e-11,-41306.9,25.6103], Tmin=(100,'K'), Tmax=(758.314,'K')), NASAPolynomial(coeffs=[9.66678,0.0235588,-1.21622e-05,2.43565e-09,-1.73966e-13,-42600.1,-13.1702], Tmin=(758.314,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-344.258,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCdH)(F1s)(F1s)) + radical(Cdj(Cd-CsF1s)(H))"""),
)

species(
    label = '[CH]C(F)=CC(F)(F)C(F)F(6899)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0633957,0.0967775,-0.000134226,1.05213e-07,-3.39099e-11,-83619.7,30.0475], Tmin=(100,'K'), Tmax=(753.257,'K')), NASAPolynomial(coeffs=[10.7655,0.0392726,-1.97131e-05,3.86309e-09,-2.72432e-13,-85251,-19.1273], Tmin=(753.257,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-696.413,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(CdCsCdF) + radical(AllylJ2_triplet)"""),
)
...
"""),
    E0 = (-271.045,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([171,205,598,1104,1143,1317,1411,3153,3010,987.5,1337.5,450,1655,323,467,575,827,1418,331.272,331.382,334.447,340.3],'cm^-1')),
        HinderedRotor(inertia=(0.655599,'amu*angstrom^2'), symmetry=1, barrier=(51.5663,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.646612,'amu*angstrom^2'), symmetry=1, barrier=(51.5051,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61307,0.0572901,-6.16884e-05,3.98012e-08,-1.11208e-11,-32517.4,20.9438], Tmin=(100,'K'), Tmax=(844.297,'K')), NASAPolynomial(coeffs=[7.15751,0.031023,-1.50227e-05,2.95427e-09,-2.1048e-13,-33453.6,-4.86663], Tmin=(844.297,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-271.045,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(AllylJ2_triplet)"""),
)
...
species(
    label = 'C=C(F)C(=C(F)F)C(F)F(6900)',
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.431066,0.0841982,-0.000101436,6.39795e-08,-1.63954e-11,-111194,26.6208], Tmin=(100,'K'), Tmax=(940.692,'K')), NASAPolynomial(coeffs=[13.0917,0.0303626,-1.55912e-05,3.14123e-09,-2.26851e-13,-113576,-33.6855], Tmin=(940.692,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-925.548,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + group(Cds-Cds(Cds-Cds)Cs) + group(CdCCF) + group(CdCFF) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH]=C(F)C(=C(F)F)C(F)F(6901)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-662.407,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,250,446,589,854,899,182,240,577,636,1210,1413,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.184269,'amu*angstrom^2'), symmetry=1, barrier=(4.23671,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.989139,'amu*angstrom^2'), symmetry=1, barrier=(22.7423,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (157.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.158108,0.09117,-0.000129419,9.49117e-08,-2.78037e-11,-79536.7,27.9015], Tmin=(100,'K'), Tmax=(833.698,'K')), NASAPolynomial(coeffs=[13.4897,0.0272059,-1.43331e-05,2.88219e-09,-2.06652e-13,-81759.6,-33.9907], Tmin=(833.698,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-662.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + group(Cds-Cds(Cds-Cds)Cs) + group(CdCCF) + group(CdCFF) + group(Cds-CdsHH) + radical(Cdj(Cd-CdF1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.58164,'amu*angstrom^2'), symmetry=1, barrier=(13.373,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.33888,'amu*angstrom^2'), symmetry=1, barrier=(30.7835,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.04891,'amu*angstrom^2'), symmetry=1, barrier=(70.1006,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (139.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.300225,0.086911,-0.000125011,9.19801e-08,-2.59606e-11,-60207.2,27.5654], Tmin=(100,'K'), Tmax=(717.019,'K')), NASAPolynomial(coeffs=[12.9461,0.0244853,-1.14062e-05,2.15026e-09,-1.47752e-13,-62229.5,-30.6928], Tmin=(717.019,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-501.657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(CsCsFFH) + group(CsCsFFH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CsCsF1sF1s)"""),
)
...
"""),
    E0 = (-366.536,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([522,611,926,1093,1137,1374,1416,3112,360,370,350,190,488,555,1236,1407,2175,525,750,770,3400,2100,180,180],'cm^-1')),
        HinderedRotor(inertia=(2.61323,'amu*angstrom^2'), symmetry=1, barrier=(60.0834,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.645405,'amu*angstrom^2'), symmetry=1, barrier=(14.8391,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.61022,'amu*angstrom^2'), symmetry=1, barrier=(60.0142,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (138.063,'amu'),
...
species(
    label = '[CH]C(F)=C(C(F)F)C(F)F(6903)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.647414,0.0862241,-8.73661e-05,9.60849e-09,3.57125e-11,-83445.1,28.6378], Tmin=(100,'K'), Tmax=(515.179,'K')), NASAPolynomial(coeffs=[8.98489,0.0425977,-2.18018e-05,4.29595e-09,-3.03303e-13,-84584.3,-8.7746], Tmin=(515.179,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-694.702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + group(CsCFFH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCsCdF) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH2]C(F)=C([C](F)F)C(F)F(3172)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'C=C(F)C([C](F)F)[C](F)F(6904)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00213291,0.0984526,-0.000141599,9.50101e-08,-1.88984e-11,-80779.7,31.2234], Tmin=(100,'K'), Tmax=(604.127,'K')), NASAPolynomial(coeffs=[12.786,0.0308309,-1.60338e-05,3.16309e-09,-2.22551e-13,-82636,-26.6022], Tmin=(604.127,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-672.756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(CsCsFFH) + group(CsCsFFH) + group(CdCsCdF) + group(Cds-CdsHH) + radical(CsCsF1sF1s) + radical(CsCsF1sF1s)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', '[CH]=C(F)C[C](F)F(477)'],
    products = ['[CH]=C(F)C([C](F)F)C(F)F(6692)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.33604e-10,'m^3/(mol*s)'), n=4.72997, Ea=(127.801,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', '[CH]=C(F)C(F)[C](F)F(1023)'],
    products = ['[CH]=C(F)C([C](F)F)C(F)F(6692)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(4.96165e-06,'m^3/(mol*s)'), n=3.30609, Ea=(133.36,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['[CH]=C(F)C([C](F)F)C(F)F(6692)'],
    products = ['[CH]C(F)=CC(F)(F)C(F)F(6899)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C]F(138)', '[CH]C(F)=CC(F)F(502)'],
    products = ['[CH]=C(F)C([C](F)F)C(F)F(6692)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=C(F)C([C](F)F)C(F)F(6692)'],
    products = ['C=C(F)C(=C(F)F)C(F)F(6900)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF2(82)', '[CH]=C(F)C=C(F)F(499)'],
    products = ['[CH]=C(F)C([C](F)F)C(F)F(6692)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(14.0071,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(2.58786,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(210.644,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'C#C[C]([C](F)F)C(F)F(3610)'],
    products = ['[CH]=C(F)C([C](F)F)C(F)F(6692)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(279.18,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction17',
    reactants = ['CF2(43)', '[CH]C(F)=CC(F)F(502)'],
    products = ['[CH]=C(F)C([C](F)F)C(F)F(6692)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(0.00976185,'m^3/(mol*s)'), n=2.64543, Ea=(11.9809,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.24524072153041726, var=3.368891203868511, Tref=1000.0, N=3, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s"""),
)

reaction(
    label = 'reaction18',
    reactants = ['[CH]=C(F)C([C](F)F)C(F)F(6692)'],
    products = ['[CH]C(F)=C(C(F)F)C(F)F(6903)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=C(F)C([C](F)F)C(F)F(6692)'],
    products = ['[CH2]C(F)=C([C](F)F)C(F)F(3172)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=C(F)C([C](F)F)C(F)F(6692)'],
    products = ['C=C(F)C([C](F)F)[C](F)F(6904)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=C(F)C([C](F)F)C(F)F(6692)'],
    products = ['F[CH]C([C](F)F)C(F)=CF(6906)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(5.12998e-06,'s^-1'), n=5.16802, Ea=(224.356,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.010618623676007603, var=1.2440368903510177, Tref=1000.0, N=3, data_mean=0.0, correlation='R4F',), comment="""Estimated from node R4F
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.0279241,'s^-1'), n=4.16824, Ea=(229.174,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
...
network(
    label = 'PDepNetwork #2012',
    isomers = [
        '[CH]=C(F)C([C](F)F)C(F)F(6692)',
    ],
    reactants = [
