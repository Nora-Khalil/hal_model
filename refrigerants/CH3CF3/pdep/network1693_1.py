...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.420343,'amu*angstrom^2'), symmetry=1, barrier=(9.66451,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.785282,'amu*angstrom^2'), symmetry=1, barrier=(18.0552,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.419437,'amu*angstrom^2'), symmetry=1, barrier=(9.64368,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0943694,0.095488,-0.000167267,1.48619e-07,-5.09764e-11,-82651.7,29.7533], Tmin=(100,'K'), Tmax=(833.445,'K')), NASAPolynomial(coeffs=[11.0025,0.0268245,-1.43327e-05,2.80551e-09,-1.94335e-13,-83903.4,-17.4861], Tmin=(833.445,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-688.298,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(CsCsFFH) + group(CsCsFFH) + radical(ROOJ) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.449578,'amu*angstrom^2'), symmetry=1, barrier=(10.3367,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.10594,'amu*angstrom^2'), symmetry=1, barrier=(48.4197,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.450196,'amu*angstrom^2'), symmetry=1, barrier=(10.3509,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.25828,0.0904892,-0.000151729,1.3265e-07,-4.55024e-11,-80363.8,28.946], Tmin=(100,'K'), Tmax=(807.85,'K')), NASAPolynomial(coeffs=[10.7928,0.027485,-1.46099e-05,2.87904e-09,-2.01255e-13,-81712,-17.439], Tmin=(807.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-669.237,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(ROOJ) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = '[O]O[CH]C(F)(F)C(F)F(5708)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-690.974,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,215,315,519,588,595,1205,1248,235,523,627,1123,1142,1372,1406,3097,3025,407.5,1350,352.5,180,1990.58],'cm^-1')),
        HinderedRotor(inertia=(0.540906,'amu*angstrom^2'), symmetry=1, barrier=(12.4365,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.541644,'amu*angstrom^2'), symmetry=1, barrier=(12.4535,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.1859,'amu*angstrom^2'), symmetry=1, barrier=(50.2581,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0332194,0.0993142,-0.00018175,1.66332e-07,-5.77692e-11,-82973.7,28.2135], Tmin=(100,'K'), Tmax=(857.005,'K')), NASAPolynomial(coeffs=[9.69404,0.0292623,-1.5451e-05,2.98256e-09,-2.03831e-13,-83712.9,-11.5558], Tmin=(857.005,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-690.974,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsOsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + radical(ROOJ) + radical(CCsJOOH)"""),
)
...
"""),
    E0 = (-662.394,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,182,240,577,636,1210,1413,4000],'cm^-1')),
        HinderedRotor(inertia=(0.150201,'amu*angstrom^2'), symmetry=1, barrier=(3.45342,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.830435,0.0873949,-0.000180508,1.8578e-07,-7.0242e-11,-79570.5,27.6932], Tmin=(100,'K'), Tmax=(854.359,'K')), NASAPolynomial(coeffs=[2.23301,0.0388485,-2.15708e-05,4.24759e-09,-2.9346e-13,-78278,30.1138], Tmin=(854.359,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-662.394,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cds-CdsCsOs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(ROOJ)"""),
)
...
"""),
    ...
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.227275,0.09477,-0.000172164,1.59342e-07,-5.62492e-11,-84459,27.8287], Tmin=(100,'K'), Tmax=(845.755,'K')), NASAPolynomial(coeffs=[8.679,0.0308957,-1.64879e-05,3.21476e-09,-2.21692e-13,-85033.8,-6.47635], Tmin=(845.755,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-703.267,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(CsCsFFH) + group(CsCsFFH) + radical(ROOJ) + radical(C2CsJOOH)"""),
)
...
"""),
    E0 = (-638.434,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,146,234,414,562,504,606,1176,1296,1354,1460,221.652,222.462],'cm^-1')),
        HinderedRotor(inertia=(0.919053,'amu*angstrom^2'), symmetry=1, barrier=(32.1584,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.919071,'amu*angstrom^2'), symmetry=1, barrier=(32.1566,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.255297,'amu*angstrom^2'), symmetry=1, barrier=(8.92303,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.254597,'amu*angstrom^2'), symmetry=1, barrier=(8.92477,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.178838,0.102496,-0.000183467,1.64587e-07,-5.69723e-11,-76645.5,30.3287], Tmin=(100,'K'), Tmax=(823.94,'K')), NASAPolynomial(coeffs=[11.6931,0.0275223,-1.54093e-05,3.06667e-09,-2.14334e-13,-78013.3,-21.0759], Tmin=(823.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-638.434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(CsCsFFH) + group(CsCsFFH) + radical(Csj(Cs-O2sCsH)(F1s)(F1s)) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)

species(
    label = 'F[CH]C(OOF)[C](F)F(5715)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.19218,'amu*angstrom^2'), symmetry=1, barrier=(27.4107,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19621,'amu*angstrom^2'), symmetry=1, barrier=(27.5033,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19329,'amu*angstrom^2'), symmetry=1, barrier=(27.4361,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.244136,0.106729,-0.000200093,1.85978e-07,-6.57681e-11,-39422.4,31.1282], Tmin=(100,'K'), Tmax=(839.054,'K')), NASAPolynomial(coeffs=[10.132,0.0309232,-1.74829e-05,3.47171e-09,-2.41482e-13,-40236.5,-11.5846], Tmin=(839.054,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-328.94,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sFO) + group(Cs-CsCsOsH) + group(CsCsFHH) + group(CsCsFFH) + radical(Csj(Cs-O2sCsH)(F1s)(H)) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)

species(
    label = '[O]OC([CH]F)C(F)(F)F(5716)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC([C](F)F)C(F)F(5583)'],
...
reaction(
    ...
    products = ['[O]OC([C](F)F)C(F)F(5583)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', '[O]OC(F)[C](F)F(975)'],
    products = ['[O]OC([C](F)F)C(F)F(5583)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OC(F)C(F)[C](F)F(5707)'],
    products = ['[O]OC([C](F)F)C(F)F(5583)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]O[CH]C(F)(F)C(F)F(5708)'],
    products = ['[O]OC([C](F)F)C(F)F(5583)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[O]C([C](F)F)C(F)F(1514)'],
    products = ['[O]OC([C](F)F)C(F)F(5583)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]OC([C](F)F)C(F)F(5583)'],
    products = ['O(6)', 'FC(F)C1OC1(F)F(1811)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]OC([C](F)F)C(F)F(5583)'],
    products = ['HO2(11)', 'F[C](F)C=C(F)F(1371)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]OC(=C(F)F)C(F)F(5711)'],
    products = ['[O]OC([C](F)F)C(F)F(5583)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O2(2)', 'F[C](F)[CH]C(F)F(1501)'],
    products = ['[O]OC([C](F)F)C(F)F(5583)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[O]OC([CH]F)=C(F)F(5712)'],
    products = ['[O]OC([C](F)F)C(F)F(5583)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]OC([C](F)F)C(F)F(5583)'],
    products = ['[O]O[C](C(F)F)C(F)F(5713)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]OC([C](F)F)C(F)F(5583)'],
    products = ['OH(7)', 'O=C([C](F)F)C(F)F(1269)'],
...
reaction(
    label = 'reaction20',
    reactants = ['OOC([C](F)F)[C](F)F(5714)'],
    products = ['[O]OC([C](F)F)C(F)F(5583)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[CH]C(OOF)[C](F)F(5715)'],
    products = ['[O]OC([C](F)F)C(F)F(5583)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]OC([C](F)F)C(F)F(5583)'],
    products = ['[O]OC([CH]F)C(F)(F)F(5716)'],
