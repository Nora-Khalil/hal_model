...
reaction(
    label = 'reaction4',
    reactants = ['FOF(328)', 'F[C]CC(F)F(341)'],
    products = ['FOC(F)(F)CC(F)F(257)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CF2(43)', 'CC(F)(F)OF(323)'],
    products = ['FOC(F)(F)CC(F)F(257)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['HF(38)', 'F[C]CC(F)(F)OF(342)'],
    products = ['FOC(F)(F)CC(F)F(257)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'FO[C](F)CC(F)F(345)'],
    products = ['FOC(F)(F)CC(F)F(257)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'F[CH]CC(F)(F)OF(346)'],
    products = ['FOC(F)(F)CC(F)F(257)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C(F)(F)CC(F)F(347)'],
    products = ['FOC(F)(F)CC(F)F(257)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(127)', 'F[C](F)CC(F)F(348)'],
    products = ['FOC(F)(F)CC(F)F(257)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FO[C](F)F(236)', 'CHF2-CH2(64)'],
    products = ['FOC(F)(F)CC(F)F(257)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF2(82)', '[CH2]C(F)(F)OF(349)'],
    products = ['FOC(F)(F)CC(F)F(257)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'FOC(F)(F)[CH]C(F)F(350)'],
    products = ['FOC(F)(F)CC(F)F(257)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'FOC(F)(F)C[C](F)F(351)'],
    products = ['FOC(F)(F)CC(F)F(257)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(78)', 'O=C(F)CC(F)F(352)'],
    products = ['FOC(F)(F)CC(F)F(257)'],
