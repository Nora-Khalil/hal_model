...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH2]OC[O](219)'],
    products = ['[CH2]OC(C)[O](8245)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'CC([O])[O](1998)'],
    products = ['[CH2]OC(C)[O](8245)'],
    transitionState = 'TS3',
