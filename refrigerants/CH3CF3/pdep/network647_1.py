...
reaction(
    label = 'reaction1',
    reactants = ['[O]OO[C]=O(460)'],
    products = ['O=O(161)', 'CO2(14)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[O](128)', '[C]=O(192)'],
    products = ['[O]OO[C]=O(460)'],
    transitionState = 'TS2',
