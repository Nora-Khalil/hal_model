...
reaction(
    label = 'reaction1',
    reactants = ['F[C]=CC(F)[C]=C(F)F(7248)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]=CC(F)[C]=C(F)F(7248)'],
    products = ['F[C]=CC([CH]F)=C(F)F(5741)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(F)F(1218)', 'F[C]C=CF(883)'],
    products = ['F[C]=CC(F)[C]=C(F)F(7248)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]=CC(F)[C]=C(F)F(7248)'],
    products = ['FC1=CC(F)C1=C(F)F(7449)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[C]=CC=C=C(F)F(7451)'],
    products = ['F[C]=CC(F)[C]=C(F)F(7248)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C]=CC(F)=C=C(F)F(7452)'],
    products = ['F[C]=CC(F)[C]=C(F)F(7248)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'FC#CC(F)[C]=C(F)F(7453)'],
    products = ['F[C]=CC(F)[C]=C(F)F(7248)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'F[C]=CC(F)C#CF(7454)'],
    products = ['F[C]=CC(F)[C]=C(F)F(7248)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'F[C]=C=C[C]=C(F)F(7455)'],
    products = ['F[C]=CC(F)[C]=C(F)F(7248)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[C]=CC(F)[C]=C(F)F(7248)'],
    products = ['F[C]C=C(F)C=C(F)F(7456)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[C]=CC(F)[C]=C(F)F(7248)'],
    products = ['FC=[C]C(F)[C]=C(F)F(7457)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C]=[C]C(F)C=C(F)F(7458)'],
    products = ['F[C]=CC(F)[C]=C(F)F(7248)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[C]=CC(F)[C]=C(F)F(7248)'],
    products = ['F[CH]C=C(F)[C]=C(F)F(7459)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C]=CC(F)[C]=C(F)F(7248)'],
    products = ['F[C]=C[CH]C(F)=C(F)F(7460)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C]=CC(F)[C]=C(F)F(7248)'],
    products = ['FC(F)=[C][CH]C=C(F)F(7342)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C]=CC(F)C(F)=[C]F(7461)'],
    products = ['F[C]=CC(F)[C]=C(F)F(7248)'],
