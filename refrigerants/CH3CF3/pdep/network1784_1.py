...
"""),
    ...
    molecularWeight = (91.0179,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.33409,-0.00643471,9.5841e-05,-1.25044e-07,4.7961e-11,-58095.1,14.4666], Tmin=(100,'K'), Tmax=(957.967,'K')), NASAPolynomial(coeffs=[14.5529,0.000616259,4.10557e-07,9.63504e-11,-2.30883e-14,-62717.5,-52.0834], Tmin=(957.967,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-483.389,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-Cs(Cds-O2d)) + group(CsFHOO) + group(Cds-OdOsOs) + ring(Cyclobutane) + radical(CsF1sO2sO2s)"""),
)
