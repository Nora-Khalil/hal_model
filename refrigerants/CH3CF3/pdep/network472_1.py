...
"""),
    E0 = (-395.751,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([161,297,490,584,780,1358,562,600,623,1070,1265,1685,370,180],'cm^-1')),
        HinderedRotor(inertia=(0.196274,'amu*angstrom^2'), symmetry=1, barrier=(4.51271,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.026,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66104,0.0587804,-0.000108803,1.01375e-07,-3.60043e-11,-47520.7,20.168], Tmin=(100,'K'), Tmax=(835.086,'K')), NASAPolynomial(coeffs=[7.23494,0.0178679,-9.78358e-06,1.94348e-09,-1.3561e-13,-47956,-2.75089], Tmin=(835.086,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-395.751,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cd-CdH)(F1s)(F1s)) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['F[C](F)C=C(F)F(1278)'],
    products = ['FC1(F)[CH]C1(F)F(6446)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(5)', 'FC(F)=C=C(F)F(6447)'],
    products = ['F[C](F)C=C(F)F(1278)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(306,'m^3/(mol*s)'), n=1.64, Ea=(8.7005,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_N-2CS-inRing_Ext-1COS-R_N-4R!H-inRing_4R!H-u0_Ext-2CS-R_Sp-2CS=1CCOSS_N-5R!H-inRing_Sp-5R!H-2CS_Ext-2CS-R_4R!H->C_N-Sp-4C-1COS',), comment="""Estimated from node Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_N-2CS-inRing_Ext-1COS-R_N-4R!H-inRing_4R!H-u0_Ext-2CS-R_Sp-2CS=1CCOSS_N-5R!H-inRing_Sp-5R!H-2CS_Ext-2CS-R_4R!H->C_N-Sp-4C-1COS"""),
)

reaction(
    label = 'reaction6',
    reactants = ['H(5)', 'F[C](F)[C]=C(F)F(6448)'],
    products = ['F[C](F)C=C(F)F(1278)'],
    transitionState = 'TS6',
...
reaction(
    ...
    products = ['F[C](F)C=C(F)F(1278)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.64483e+40,'m^3/(mol*s)'), n=-10.004, Ea=(281.249,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd"""),
)

reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'F[C]C=C(F)F-2(1319)'],
    products = ['F[C](F)C=C(F)F(1278)'],
    transitionState = 'TS8',
