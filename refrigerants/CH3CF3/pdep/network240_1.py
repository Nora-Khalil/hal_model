...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)C[C](F)F(802)'],
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'FC=CC[C](F)F(809)'],
    products = ['F[CH]C(F)C[C](F)F(802)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'FC=C(F)C[C](F)F(810)'],
    products = ['F[CH]C(F)C[C](F)F(802)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'F[CH]C(F)C=C(F)F(812)'],
    products = ['F[CH]C(F)C[C](F)F(802)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)[CH]C(F)F(813)'],
    products = ['F[CH]C(F)C[C](F)F(802)'],
