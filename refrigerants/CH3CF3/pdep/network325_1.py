...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)F(207)', 'CH2(S)(25)'],
    products = ['CC([O])(F)F(414)'],
    transitionState = 'TS2',
