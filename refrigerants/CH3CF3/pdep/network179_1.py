...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]OC[C](F)F(131)'],
    products = ['[O]OOC[C](F)F(638)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', '[CH2]OO[O](224)'],
    products = ['[O]OOC[C](F)F(638)'],
    transitionState = 'TS3',
