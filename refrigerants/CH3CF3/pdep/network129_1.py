...
reaction(
    label = 'reaction7',
    reactants = ['HF(38)', '[CH]=C=C=[C]F(535)'],
    products = ['[CH]=C(F)C=[C]F(484)'],
    transitionState = 'TS7',
