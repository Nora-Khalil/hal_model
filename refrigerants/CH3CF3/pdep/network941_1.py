...
"""),
    E0 = (1.93929,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,2950,3100,1380,975,1025,1650,180,1874.94,2778.69],'cm^-1')),
        HinderedRotor(inertia=(0.568967,'amu*angstrom^2'), symmetry=1, barrier=(13.0817,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.88345,0.0288256,-9.3844e-06,-2.85291e-08,3.06299e-11,269.131,17.4209], Tmin=(100,'K'), Tmax=(490.805,'K')), NASAPolynomial(coeffs=[4.65109,0.0216572,-9.59615e-06,1.80408e-09,-1.24991e-13,8.4435,9.26303], Tmin=(490.805,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1.93929,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCOJ) + radical(C=C(C)OJ)"""),
)
...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.46209,0.0380077,-5.12247e-05,4.36606e-08,-1.39667e-11,17196.6,16.954], Tmin=(100,'K'), Tmax=(1007.41,'K')), NASAPolynomial(coeffs=[3.07283,0.0219674,-7.06875e-06,1.02436e-09,-5.68183e-14,17764.5,17.4321], Tmin=(1007.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.552,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + radical(CCOJ) + radical(C2CsJO)"""),
)

species(
    label = '[O][C]1COC1(2606)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79904,0.0347504,-2.75233e-05,1.27745e-08,-2.24489e-12,16712.6,16.9687], Tmin=(100,'K'), Tmax=(1741.8,'K')), NASAPolynomial(coeffs=[6.72268,0.014393,-2.19792e-06,9.82187e-11,2.7042e-15,16370.3,-5.57623], Tmin=(1741.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.199,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Oxetane) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C1([O])CO1(2579)',
    structure = adjacencyList("""multiplicity 3
1 O u0 p2 c0 {3,S} {4,S}
2 O u1 p2 c0 {3,S}
...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.102851,0.0566826,-6.34937e-05,3.19561e-08,-5.66232e-12,-14328,23.2852], Tmin=(100,'K'), Tmax=(1743.91,'K')), NASAPolynomial(coeffs=[16.0454,-0.00117659,4.58712e-06,-1.07115e-09,7.60084e-14,-16650.8,-53.2116], Tmin=(1743.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-120.506,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=C(C)OJ) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH2]C(O)=C[O](2609)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64059,0.0363727,7.02701e-06,-5.55519e-08,3.02976e-11,-13954,17.6536], Tmin=(100,'K'), Tmax=(892.938,'K')), NASAPolynomial(coeffs=[20.6584,-0.00601626,6.33074e-06,-1.34918e-09,9.23622e-14,-19056.7,-81.4983], Tmin=(892.938,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-116.848,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH]=C(O)C[O](2610)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (111.231,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3120,650,792.5,1650,349.555],'cm^-1')),
        HinderedRotor(inertia=(0.0873231,'amu*angstrom^2'), symmetry=1, barrier=(7.581,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.087369,'amu*angstrom^2'), symmetry=1, barrier=(7.58008,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13195,0.0413022,-4.46388e-05,2.60775e-08,-6.14666e-12,13445.1,18.9499], Tmin=(100,'K'), Tmax=(1027.36,'K')), NASAPolynomial(coeffs=[8.89199,0.0149821,-6.21006e-06,1.14055e-09,-7.84346e-14,12056.1,-13.8459], Tmin=(1027.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(111.231,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C([O])CO(2611)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99748,0.041781,-4.62048e-05,2.69312e-08,-6.16146e-12,2880.04,20.0683], Tmin=(100,'K'), Tmax=(1074.95,'K')), NASAPolynomial(coeffs=[10.1728,0.0113594,-3.75339e-06,6.0303e-10,-3.82449e-14,1122.47,-19.9634], Tmin=(1074.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(23.3303,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.97513,0.00701251,6.36263e-05,-8.78544e-08,3.3759e-11,-20939.1,12.8076], Tmin=(100,'K'), Tmax=(966.597,'K')), NASAPolynomial(coeffs=[11.4899,0.0111327,-3.84173e-06,8.01757e-10,-6.57047e-14,-24423.7,-37.4921], Tmin=(966.597,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-174.521,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsCs) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05089,0.0318009,2.66346e-06,-3.70931e-08,1.99126e-11,-16512.2,16.9902], Tmin=(100,'K'), Tmax=(909.884,'K')), NASAPolynomial(coeffs=[15.2372,0.00330937,1.0379e-06,-2.96344e-10,1.92734e-14,-20132.1,-52.0861], Tmin=(909.884,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-137.96,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=C(C)OJ) + radical(C=COJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C(=C)[O](1709)'],
    products = ['C=C([O])C[O](2310)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2O(20)', '[CH2][C]=O(981)'],
    products = ['C=C([O])C[O](2310)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(520000,'m^3/(mol*s)'), n=-1.07934e-11, Ea=(77.864,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H_N-2R!H->C',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H_N-2R!H->C"""),
)

reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(=O)C=O(2607)'],
    products = ['C=C([O])C[O](2310)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(7.5,'m^3/(mol*s)'), n=2.16, Ea=(1.75651,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->H_N-2R!H->N_N-1R!H->N_2COS->O_Ext-1COS-R_4R!H-u0_4R!H->C_Sp-4C-1COS_Ext-4C-R_Sp-5R!H=4C',), comment="""Estimated from node Root_3R->H_N-2R!H->N_N-1R!H->N_2COS->O_Ext-1COS-R_4R!H-u0_4R!H->C_Sp-4C-1COS_Ext-4C-R_Sp-5R!H=4C"""),
)

reaction(
    label = 'reaction11',
    reactants = ['[CH2][O](194)', 'CH2CO(28)'],
    products = ['C=C([O])C[O](2310)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(13.9424,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)

reaction(
    label = 'reaction12',
    reactants = ['[CH2][O](194)', '[CH2][C]=O(981)'],
    products = ['C=C([O])C[O](2310)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(18)', '[O]C[C]=O(907)'],
    products = ['C=C([O])C[O](2310)'],
