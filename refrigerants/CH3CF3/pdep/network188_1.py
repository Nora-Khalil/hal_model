...
reaction(
    label = 'reaction2',
    reactants = ['OC(F)(F)OF(661)', 'CH2(S)(25)'],
    products = ['OCC(F)(F)OF(646)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', '[CH2]C(F)(F)OF(349)'],
    products = ['OCC(F)(F)OF(646)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(127)', 'OC[C](F)F(196)'],
    products = ['OCC(F)(F)OF(646)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FO[C](F)F(236)', 'CH2OH(33)'],
    products = ['OCC(F)(F)OF(646)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O[CH]C(F)(F)OF(703)'],
    products = ['OCC(F)(F)OF(646)'],
