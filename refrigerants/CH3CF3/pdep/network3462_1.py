...
"""),
    ...
    molecularWeight = (140.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01978,0.0668366,-6.20226e-05,2.97032e-08,-5.83444e-12,-79559.2,24.2052], Tmin=(100,'K'), Tmax=(1199.3,'K')), NASAPolynomial(coeffs=[12.7065,0.0278585,-1.32721e-05,2.60406e-09,-1.85552e-13,-82362.4,-34.3005], Tmin=(1199.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-662.375,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(CdCFH) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + ring(Cs-Cs(F)(F)-Cs)"""),
)
...
"""),
    E0 = (-492.037,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,346,659,817,1284,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,182,240,577,636,1210,1413,289.391,289.43,289.5],'cm^-1')),
        HinderedRotor(inertia=(0.0986461,'amu*angstrom^2'), symmetry=1, barrier=(5.86307,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0986446,'amu*angstrom^2'), symmetry=1, barrier=(5.86279,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.644411,'amu*angstrom^2'), symmetry=1, barrier=(38.2904,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.079,'amu'),
...
"""),
    E0 = (-218.779,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,1000,334,575,1197,1424,3202,407.667,407.701,407.982,408.021,408.366,408.699,408.862],'cm^-1')),
        HinderedRotor(inertia=(0.26473,'amu*angstrom^2'), symmetry=1, barrier=(31.2873,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.263638,'amu*angstrom^2'), symmetry=1, barrier=(31.291,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.983227,0.0607719,-5.36504e-05,2.33063e-08,-4.0174e-12,-26200,25.2083], Tmin=(100,'K'), Tmax=(1389.11,'K')), NASAPolynomial(coeffs=[15.5213,0.0189088,-8.4454e-06,1.61135e-09,-1.12938e-13,-30239,-49.7078], Tmin=(1389.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-218.779,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCCFF) + group(CsCsFHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cd-Cd-Cs(F)(F)) + radical(Csj(Cs-CdHH)(F1s)(H))"""),
)
...
"""),
    E0 = (-164.141,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,323,467,575,827,1418,2950,1000,334,575,1197,1424,3202,180,180,1934.56],'cm^-1')),
        HinderedRotor(inertia=(0.324715,'amu*angstrom^2'), symmetry=1, barrier=(7.46583,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07207,'amu*angstrom^2'), symmetry=1, barrier=(24.6489,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45347,0.066277,-6.4197e-05,-4.52321e-09,3.9205e-11,-19660.3,22.1523], Tmin=(100,'K'), Tmax=(500.408,'K')), NASAPolynomial(coeffs=[7.89261,0.0326155,-1.66798e-05,3.29429e-09,-2.32734e-13,-20527.7,-6.68278], Tmin=(500.408,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-164.141,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(Cs-CsCsHH) + group(CsCsFHH) + group(CdCsCdF) + group(Cds-CdsCsH) + ring(Cs-Cd(F)-Cd) + radical(Csj(Cs-CsHH)(F1s)(H)) + longDistanceInteraction_cyclic(Cs(F)-Cds(F))"""),
)
...
"""),
    E0 = (183.867,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,271,519,563,612,1379,2950,1000,334,575,1197,1424,3202,180,180,1136.71,1136.71,1136.82,1136.84],'cm^-1')),
        HinderedRotor(inertia=(0.157852,'amu*angstrom^2'), symmetry=1, barrier=(3.62933,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157855,'amu*angstrom^2'), symmetry=1, barrier=(3.6294,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66801,0.0553801,-6.59674e-05,4.84467e-08,-1.52139e-11,22194.3,18.8486], Tmin=(100,'K'), Tmax=(762.28,'K')), NASAPolynomial(coeffs=[6.74367,0.0287471,-1.35614e-05,2.6158e-09,-1.83672e-13,21420.4,-4.26095], Tmin=(762.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(183.867,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(CdCsCdF) + ring(Cs-Cd(F)-Cd) + radical(Allyl_T) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)
...
species(
    label = 'F[CH][CH]C1(F)CC1(F)F(11751)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (140.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.85113,0.0759479,-9.9239e-05,7.7625e-08,-2.57308e-11,-46835.7,29.0463], Tmin=(100,'K'), Tmax=(725.206,'K')), NASAPolynomial(coeffs=[7.89486,0.0370984,-1.88864e-05,3.7611e-09,-2.68588e-13,-47857.3,-2.67271], Tmin=(725.206,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-390.305,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCsFHH) + ring(Cs(F)(F)-Cs(C)-Cs) + radical(Cs_S) + radical(Csj(Cs-CsHH)(F1s)(H)) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
species(
    label = 'FC(F)C[C]1[CH]C1(F)F(11752)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (140.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18057,0.0715273,-7.33536e-05,1.94247e-08,1.70963e-11,-46027,27.2578], Tmin=(100,'K'), Tmax=(533.143,'K')), NASAPolynomial(coeffs=[7.77821,0.0370322,-1.85179e-05,3.6449e-09,-2.58066e-13,-46943.8,-2.42223], Tmin=(533.143,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-383.457,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCsFFH) + ring(Cs(F)(F)-Cs(C)-Cs) + radical(Tertalkyl) + radical(Csj(Cs-CsCsH)(Cs-CsF1sF1s)(H)_ring)"""),
)

species(
    label = 'F[CH]CC1(F)[C](F)C1F(11753)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-325.688,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([289,311,382,485,703,1397,259,529,569,1128,1321,1390,3140,2750,2850,1437.5,1250,1305,750,350,212,367,445,1450,334,575,1197,1424,3202,737.975,737.993],'cm^-1')),
        HinderedRotor(inertia=(0.0801723,'amu*angstrom^2'), symmetry=1, barrier=(1.84332,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0801614,'amu*angstrom^2'), symmetry=1, barrier=(1.84307,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.726615,0.0773252,-9.3848e-05,6.32141e-08,-1.75533e-11,-39058,28.8154], Tmin=(100,'K'), Tmax=(867.635,'K')), NASAPolynomial(coeffs=[10.5512,0.0320312,-1.55417e-05,3.04533e-09,-2.16184e-13,-40762.8,-17.1875], Tmin=(867.635,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-325.688,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(CsCsCsFH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(CsCsFHH) + ring(Cs(C)-Cs-Cs(F)) + radical(Csj(Cs-F1sCsCs)(Cs-CsF1sH)(F1s)_ring) + radical(Csj(Cs-CsHH)(F1s)(H)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'F[C]1[CH]C1(F)CC(F)F(11754)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-340.865,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([289,311,382,485,703,1397,2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,212,367,445,1450,2950,1000,411.298,411.333,411.357,411.374],'cm^-1')),
        HinderedRotor(inertia=(0.000996438,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000996421,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.706822,0.0787936,-9.50721e-05,6.32951e-08,-1.7479e-11,-40883.5,27.1663], Tmin=(100,'K'), Tmax=(868.762,'K')), NASAPolynomial(coeffs=[10.5253,0.0335877,-1.70216e-05,3.4023e-09,-2.4432e-13,-42589.5,-18.8212], Tmin=(868.762,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-340.865,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCsFFH) + ring(Cs(C)-Cs-Cs(F)) + radical(Csj(Cs-F1sCsCs)(Cs-CsHH)(F1s)_ring) + radical(Csj(Cs-F1sCsCs)(Cs-CsF1sH)(H)_ring) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]CC1(F)[CH]C1(F)F(11633)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(804)', '[CH2]C1(F)[CH]C1(F)F(11369)'],
    products = ['F[CH]CC1(F)[CH]C1(F)F(11633)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F[CH]CC1(F)[CH]C1(F)F(11633)'],
    products = ['FC=CC1(F)CC1(F)F(11746)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[CH]C[C](F)C=C(F)F(10513)'],
    products = ['F[CH]CC1(F)[CH]C1(F)F(11633)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'F[CH]CC1=CC1(F)F(11747)'],
    products = ['F[CH]CC1(F)[CH]C1(F)F(11633)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(57.9797,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    ...
    products = ['F[CH]CC1(F)[CH]C1(F)F(11633)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(11.7738,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'F[CH]CC1(F)C=C1F(11748)'],
    products = ['F[CH]CC1(F)[CH]C1(F)F(11633)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.000502707,'m^3/(mol*s)'), n=2.87982, Ea=(8.98277,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R-inRing_Ext-3R-R_Sp-4R!H-3R_N-4R!H->O_N-1R!H-inRing_Sp-2R!H=1R!H',), comment="""Estimated from node Root_3R-inRing_Ext-3R-R_Sp-4R!H-3R_N-4R!H->O_N-1R!H-inRing_Sp-2R!H=1R!H"""),
)

reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'FC=CC1(F)[CH]C1(F)F(11692)'],
    products = ['F[CH]CC1(F)[CH]C1(F)F(11633)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(78)', 'F[CH]C[C]1C=C1F(11749)'],
    products = ['F[CH]CC1(F)[CH]C1(F)F(11633)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'F[CH]C=C1[CH]C1(F)F(11694)'],
    products = ['F[CH]CC1(F)[CH]C1(F)F(11633)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(300.374,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', '[CH2]C1(F)[CH]C1(F)F(11369)'],
    products = ['F[CH]CC1(F)[CH]C1(F)F(11633)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]CC1(F)[CH]C1(F)F(11633)'],
    products = ['F[CH][CH]C1(F)CC1(F)F(11751)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH]CC1(F)[CH]C1(F)F(11633)'],
    products = ['FC(F)C[C]1[CH]C1(F)F(11752)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(210.986,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction21',
    reactants = ['F[CH]CC1(F)[C](F)C1F(11753)'],
    products = ['F[CH]CC1(F)[CH]C1(F)F(11633)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C]1[CH]C1(F)CC(F)F(11754)'],
    products = ['F[CH]CC1(F)[CH]C1(F)F(11633)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(0.00110172,'s^-1'), n=4.50663, Ea=(237.449,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R4F_Ext-4R!H-R',), comment="""Estimated from node R4F_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)
