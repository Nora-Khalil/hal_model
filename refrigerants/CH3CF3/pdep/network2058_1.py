...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C(=O)O(2028)'],
    products = ['C=C(O)O[O](7112)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH]=C(O)O[O](10037)'],
    products = ['C=C(O)O[O](7112)'],
    transitionState = 'TS9',
