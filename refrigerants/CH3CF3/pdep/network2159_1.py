species(
    label = '[CH2]C(F)(F)C(F)[C]=C(F)F(7227)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.262164,'amu*angstrom^2'), symmetry=1, barrier=(6.02767,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.50733,'amu*angstrom^2'), symmetry=1, barrier=(34.6565,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00197021,'amu*angstrom^2'), symmetry=1, barrier=(6.02069,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.297226,0.091568,-0.000127685,8.98542e-08,-2.15985e-11,-69930.8,31.4252], Tmin=(100,'K'), Tmax=(595.645,'K')), NASAPolynomial(coeffs=[10.3999,0.0361812,-1.95749e-05,3.96243e-09,-2.84334e-13,-71355.3,-13.9348], Tmin=(595.645,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-582.466,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCCFH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCFF) + radical(Csj(Cs-CsF1sF1s)(H)(H)) + radical(Cdj(Cs-F1sCsH)(Cd-F1sF1s))"""),
)
...
species(
    label = '[CH2]C(F)(F)C([CH]F)=C(F)F(5686)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.343854,'amu*angstrom^2'), symmetry=1, barrier=(7.90589,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.344054,'amu*angstrom^2'), symmetry=1, barrier=(7.91047,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0218767,'amu*angstrom^2'), symmetry=1, barrier=(44.8274,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.161517,0.0998425,-0.000156379,1.32926e-07,-4.55602e-11,-83366.4,31.5042], Tmin=(100,'K'), Tmax=(744.865,'K')), NASAPolynomial(coeffs=[11.4261,0.0344512,-1.83216e-05,3.65829e-09,-2.59495e-13,-85004.9,-20.3969], Tmin=(744.865,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-694.328,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cs-CsHHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(CdCFF) + radical(Csj(Cs-F1sF1sCd)(H)(H)) + radical(Csj(Cd-CsCd)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.225513,0.0913282,-0.000129735,9.6255e-08,-2.7084e-11,-101685,27.3253], Tmin=(100,'K'), Tmax=(646.881,'K')), NASAPolynomial(coeffs=[11.2778,0.032804,-1.6794e-05,3.32106e-09,-2.3512e-13,-103320,-22.7689], Tmin=(646.881,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-846.519,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(Cs-CsHHH) + group(CdCddCF) + group(CdCddFF) + group(Cdd-CdsCds)"""),
)
...
species(
    label = '[CH2]C(F)(F)C=C=C(F)F(7385)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.328007,'amu*angstrom^2'), symmetry=1, barrier=(7.54153,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.328071,'amu*angstrom^2'), symmetry=1, barrier=(7.543,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (139.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.418294,0.085812,-0.000131427,1.10502e-07,-3.76362e-11,-55300.9,27.5187], Tmin=(100,'K'), Tmax=(737.04,'K')), NASAPolynomial(coeffs=[10.2599,0.0307756,-1.61118e-05,3.2062e-09,-2.27299e-13,-56707.5,-16.6591], Tmin=(737.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-460.814,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCddFF) + group(Cdd-CdsCds) + radical(Csj(Cs-F1sF1sCd)(H)(H))"""),
)
...
species(
    label = '[CH2]C(F)(F)C(F)=C=C(F)F(7386)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.133643,'amu*angstrom^2'), symmetry=1, barrier=(3.07273,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (157.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.145542,0.100366,-0.00016875,1.47869e-07,-5.07867e-11,-76248.8,29.9244], Tmin=(100,'K'), Tmax=(809.502,'K')), NASAPolynomial(coeffs=[11.4623,0.0305259,-1.62063e-05,3.19307e-09,-2.23153e-13,-77719.1,-21.0972], Tmin=(809.502,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-635.136,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(Cs-CsHHH) + group(CdCddCF) + group(CdCddFF) + group(Cdd-CdsCds) + radical(Csj(Cs-F1sF1sCd)(H)(H))"""),
)

species(
    label = '[CH2]C(F)(F)C(F)C#CF(7387)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-386.536,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,233,378,609,1068,1270,1314,3037,3000,3100,440,815,1455,1000,2175,525,239,401,1367,223.927,1447.8],'cm^-1')),
        HinderedRotor(inertia=(0.224985,'amu*angstrom^2'), symmetry=1, barrier=(8.25529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.224273,'amu*angstrom^2'), symmetry=1, barrier=(8.2421,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.32097,'amu*angstrom^2'), symmetry=1, barrier=(47.1496,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (139.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.130136,0.0931361,-0.000152146,1.31167e-07,-4.44222e-11,-46357.8,27.5922], Tmin=(100,'K'), Tmax=(818.159,'K')), NASAPolynomial(coeffs=[10.9396,0.0292813,-1.48961e-05,2.88773e-09,-2.00107e-13,-47758.2,-20.1366], Tmin=(818.159,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-386.536,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCCFH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(CtCF) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)
...
species(
    label = '[CH2]C(F)=C(F)[C]=C(F)F(7389)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-368.894,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([271,519,563,612,1379,86,203,488,582,605,741,3000,3100,440,815,1455,1000,562,600,623,1070,1265,1685,370,429.458],'cm^-1')),
        HinderedRotor(inertia=(0.000904791,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000920632,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (138.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08051,0.0641252,-6.4469e-05,3.29543e-08,-6.78355e-12,-44262.5,27.6839], Tmin=(100,'K'), Tmax=(1163.85,'K')), NASAPolynomial(coeffs=[13.2578,0.0222727,-1.05276e-05,2.05552e-09,-1.46258e-13,-47097,-32.912], Tmin=(1163.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-368.894,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCCF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-Cds(Cds-Cds)H) + group(CdCFF) + radical(C=CC=CCJ) + radical(Cdj(Cd-F1sCd)(Cd-F1sF1s))"""),
)
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.363779,0.0881251,-0.000119455,8.95557e-08,-2.77476e-11,-78845.4,29.7059], Tmin=(100,'K'), Tmax=(779.44,'K')), NASAPolynomial(coeffs=[10.5003,0.0361055,-1.93455e-05,3.9302e-09,-2.83787e-13,-80425.6,-16.6711], Tmin=(779.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-656.585,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCCFH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCFF) + radical(CsCdCsF1s) + radical(Cdj(Cs-F1sCsH)(Cd-F1sF1s))"""),
)
...
species(
    label = '[CH2][C](F)C(F)C(F)=C(F)F(7393)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.515186,0.0828461,-0.000100329,6.48298e-08,-1.71568e-11,-78202.3,28.933], Tmin=(100,'K'), Tmax=(909.171,'K')), NASAPolynomial(coeffs=[12.0752,0.0319865,-1.6418e-05,3.30084e-09,-2.3792e-13,-80304.3,-25.7368], Tmin=(909.171,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-651.211,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(CdCFF) + radical(Allyl_S) + radical(Cdj(Cs-CsHH)(Cd-F1sF1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.286191,'amu*angstrom^2'), symmetry=1, barrier=(6.58008,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.286112,'amu*angstrom^2'), symmetry=1, barrier=(6.57828,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.18569,'amu*angstrom^2'), symmetry=1, barrier=(27.2614,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.285029,0.104157,-0.000173558,1.53881e-07,-5.38282e-11,-62633.1,31.6347], Tmin=(100,'K'), Tmax=(797.922,'K')), NASAPolynomial(coeffs=[10.8618,0.0350342,-1.87189e-05,3.71153e-09,-2.60829e-13,-63990.3,-16.984], Tmin=(797.922,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-521.964,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCCFH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cs-F1sCsH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[CH2]C(F)(F)C(F)C(F)=[C]F(7397)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-557.148,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([284,328,853,1146,1135,1297,3239,215,315,519,588,595,1205,1248,246,474,533,1155,3000,3100,440,815,1455,1000,167,640,1190,180,180,2493.94],'cm^-1')),
        HinderedRotor(inertia=(0.266678,'amu*angstrom^2'), symmetry=1, barrier=(6.13145,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.266683,'amu*angstrom^2'), symmetry=1, barrier=(6.13157,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.52598,'amu*angstrom^2'), symmetry=1, barrier=(35.0853,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.518426,0.108703,-0.000180604,1.55957e-07,-5.28814e-11,-66855.7,32.0397], Tmin=(100,'K'), Tmax=(807.042,'K')), NASAPolynomial(coeffs=[12.7249,0.0317983,-1.67257e-05,3.28558e-09,-2.29347e-13,-68626.3,-26.7392], Tmin=(807.042,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-557.148,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(Cs-CsHHH) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Csj(Cs-CsF1sF1s)(H)(H)) + radical(Cdj(Cd-CsF1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C(F)[C]=C(F)F(7227)'],
    products = ['CH2CF2(57)', 'FC=C=C(F)F(1375)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C(F)[C]=C(F)F(7227)'],
    products = ['F[C](F)CC(F)[C]=C(F)F(7229)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(F)(F)C(F)[C]=C(F)F(7227)'],
    products = ['[CH2]C(F)(F)C([CH]F)=C(F)F(5686)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'F[C](F)C(F)[C]=C(F)F(7382)'],
    products = ['[CH2]C(F)(F)C(F)[C]=C(F)F(7227)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=C(F)F(1218)', '[CH2]C(F)(F)[CH]F(817)'],
    products = ['[CH2]C(F)(F)C(F)[C]=C(F)F(7227)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)(F)C(F)[C]=C(F)F(7227)'],
    products = ['FC(F)=C1CC(F)(F)C1F(7353)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)C(F)[C]=C(F)F(7227)'],
    products = ['CC(F)(F)C(F)=C=C(F)F(7383)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=C(F)C(F)[C]=C(F)F(7384)'],
    products = ['[CH2]C(F)(F)C(F)[C]=C(F)F(7227)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2CF2(57)', 'F[CH][C]=C(F)F(2138)'],
    products = ['[CH2]C(F)(F)C(F)[C]=C(F)F(7227)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(F)(F)C=C=C(F)F(7385)'],
    products = ['[CH2]C(F)(F)C(F)[C]=C(F)F(7227)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C](F)F(141)', 'FC=C=C(F)F(1375)'],
    products = ['[CH2]C(F)(F)C(F)[C]=C(F)F(7227)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(F)(F)C(F)=C=C(F)F(7386)'],
    products = ['[CH2]C(F)(F)C(F)[C]=C(F)F(7227)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[CH2]C(F)(F)C(F)C#CF(7387)'],
    products = ['[CH2]C(F)(F)C(F)[C]=C(F)F(7227)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][C](F)F(141)', 'F[CH][C]=C(F)F(2138)'],
    products = ['[CH2]C(F)(F)C(F)[C]=C(F)F(7227)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F2(78)', '[CH2]C(F)=C[C]=C(F)F(7388)'],
    products = ['[CH2]C(F)(F)C(F)[C]=C(F)F(7227)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[CH2]C(F)=C(F)[C]=C(F)F(7389)'],
    products = ['[CH2]C(F)(F)C(F)[C]=C(F)F(7227)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(F)(F)C(F)[C]=C(F)F(7227)'],
    products = ['[CH2]C(F)(F)[C](F)C=C(F)F(7390)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(F)(F)C(F)[C]=C(F)F(7227)'],
    products = ['CC(F)(F)[C](F)[C]=C(F)F(7391)'],
...
reaction(
    label = 'reaction19',
    reactants = ['FC[C](F)C(F)[C]=C(F)F(7392)'],
    products = ['[CH2]C(F)(F)C(F)[C]=C(F)F(7227)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(F)(F)C(F)[C]=C(F)F(7227)'],
    products = ['[CH2][C](F)C(F)C(F)=C(F)F(7393)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(F)(F)C(F)[C]=C(F)F(7227)'],
    products = ['FCC(F)(F)[CH][C]=C(F)F(7394)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(F)(F)C(F)[C]=C(F)F(7227)'],
    products = ['[CH2]C(F)(F)[CH]C(F)=C(F)F(7395)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F[C]=[C]C(F)C(F)(F)CF(7396)'],
    products = ['[CH2]C(F)(F)C(F)[C]=C(F)F(7227)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(F)(F)C(F)C(F)=[C]F(7397)'],
    products = ['[CH2]C(F)(F)C(F)[C]=C(F)F(7227)'],
...
network(
    label = 'PDepNetwork #2159',
    isomers = [
        '[CH2]C(F)(F)C(F)[C]=C(F)F(7227)',
    ],
    reactants = [
        ('CH2CF2(57)', 'FC=C=C(F)F(1375)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
