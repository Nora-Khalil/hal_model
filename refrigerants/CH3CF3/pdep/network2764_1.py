...
reaction(
    label = 'reaction3',
    reactants = ['[O]OF(126)', 'F[C]C=CF-2(3685)'],
    products = ['[O]OC(F)(F)C=CF(2957)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[O]C(F)(F)C=CF(842)'],
    products = ['[O]OC(F)(F)C=CF(2957)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]OC(F)=C[CH]F(9476)'],
    products = ['[O]OC(F)(F)C=CF(2957)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH]=CC(F)(F)O[O](9477)'],
    products = ['[O]OC(F)(F)C=CF(2957)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]O[C](F)F(163)', 'CHFCH[Z](71)'],
    products = ['[O]OC(F)(F)C=CF(2957)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]OC(F)(F)[C]=CF(2996)'],
    products = ['[O]OC(F)(F)C=CF(2957)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]OC(F)(F)C=[C]F(3935)'],
    products = ['[O]OC(F)(F)C=CF(2957)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[O]OC(F)=C=CF(3932)'],
    products = ['[O]OC(F)(F)C=CF(2957)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'C#CC(F)(F)O[O](3933)'],
    products = ['[O]OC(F)(F)C=CF(2957)'],
