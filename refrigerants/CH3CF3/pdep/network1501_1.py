...
"""),
    E0 = (34.8968,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,250,446,589,854,899,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.854816,'amu*angstrom^2'), symmetry=1, barrier=(19.6539,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.854385,'amu*angstrom^2'), symmetry=1, barrier=(19.644,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.300227,0.0811456,-0.000114831,7.72416e-08,-1.98556e-11,4330.59,25.2203], Tmin=(100,'K'), Tmax=(966.101,'K')), NASAPolynomial(coeffs=[17.5555,0.00970122,-3.90216e-06,6.92474e-10,-4.64524e-14,996.588,-57.4311], Tmin=(966.101,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(34.8968,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2sCF) + group(Cds-Cds(Cds-Cds)O2s) + group(CdCCF) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Cdj(Cd-CdF1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.52483,'amu*angstrom^2'), symmetry=1, barrier=(35.0588,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81643,0.0521607,-6.45892e-05,4.44663e-08,-1.26853e-11,-14538.1,20.3896], Tmin=(100,'K'), Tmax=(843.14,'K')), NASAPolynomial(coeffs=[8.14803,0.0221238,-1.11539e-05,2.217e-09,-1.58519e-13,-15605.8,-9.07668], Tmin=(843.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-121.5,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-O2d(Cds-O2d)Cs) + group(CdCCF) + longDistanceInteraction_noncyclic(Cd(F)-CO) + group(Cds-O2d(Cds-O2d)H) + group(Cds-CdsHH) + radical(Cdj(Cd-F1sCO)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.64815,'amu*angstrom^2'), symmetry=1, barrier=(37.8942,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.65023,'amu*angstrom^2'), symmetry=1, barrier=(37.9421,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24791,0.0648687,-0.000102402,8.36453e-08,-2.65249e-11,-11189.1,20.6022], Tmin=(100,'K'), Tmax=(870.201,'K')), NASAPolynomial(coeffs=[9.95801,0.0174246,-7.8527e-06,1.42924e-09,-9.49831e-14,-12424.5,-18.5966], Tmin=(870.201,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-93.8209,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsH) + group(Ct-CtCs) + group(Ct-CtH) + radical(C=OCOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.58153,'amu*angstrom^2'), symmetry=1, barrier=(36.3626,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.0573,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.605966,0.0547461,-6.14819e-05,3.08793e-08,-5.58335e-12,15448.7,21.0975], Tmin=(100,'K'), Tmax=(1636.19,'K')), NASAPolynomial(coeffs=[17.7526,-0.00135816,2.95753e-06,-6.75446e-10,4.76701e-14,11736.5,-64.2648], Tmin=(1636.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(127.289,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsOsH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH) + radical(C=C(C)OJ) + radical(C=COJ)"""),
)
...
"""),
    E0 = (38.4605,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([244,384,691,1241,375,552.5,462.5,1710,3120,650,792.5,1650,1855,455,950,180],'cm^-1')),
        HinderedRotor(inertia=(0.53245,'amu*angstrom^2'), symmetry=1, barrier=(12.2421,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.181143,'amu*angstrom^2'), symmetry=1, barrier=(57.0123,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.5262,0.0818248,-0.000134016,1.0992e-07,-3.50478e-11,-33972.2,26.6806], Tmin=(100,'K'), Tmax=(830.518,'K')), NASAPolynomial(coeffs=[12.6566,0.017997,-8.97509e-06,1.71296e-09,-1.17218e-13,-35800.7,-28.4668], Tmin=(830.518,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-283.458,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCCJ=O) + radical(Cdj(Cd-CsF1s)(H))"""),
)

species(
    label = 'C=C(F)C([O])(F)[C]=O(5130)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u1 p2 c0 {5,S}
...
"""),
    ...
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.764587,0.076892,-0.00012522,1.04698e-07,-3.4128e-11,-35728.3,25.9805], Tmin=(100,'K'), Tmax=(836.001,'K')), NASAPolynomial(coeffs=[11.0104,0.0202601,-9.95607e-06,1.8939e-09,-1.29496e-13,-37175.5,-20.0241], Tmin=(836.001,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-297.985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(C=OCOJ) + radical(CCCJ=O)"""),
)

species(
    label = '[CH]C(F)=C(C=O)OF(5131)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {3,S}
...
"""),
    E0 = (22.8642,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,323,467,575,827,1418,2782.5,750,1395,475,1775,1000,381.131,381.231,384.939,384.99],'cm^-1')),
        HinderedRotor(inertia=(0.484623,'amu*angstrom^2'), symmetry=1, barrier=(50.8799,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.495101,'amu*angstrom^2'), symmetry=1, barrier=(50.9748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.495979,'amu*angstrom^2'), symmetry=1, barrier=(50.9751,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.716284,0.0822671,-0.000138658,1.31853e-07,-4.95367e-11,2858.4,24.9704], Tmin=(100,'K'), Tmax=(794.315,'K')), NASAPolynomial(coeffs=[5.90642,0.037986,-2.07715e-05,4.15316e-09,-2.93485e-13,2606.29,4.72938], Tmin=(794.315,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(22.8642,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-O2d)O2s) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-O2d(Cds-Cds)H) + radical(AllylJ2_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.26543,'amu*angstrom^2'), symmetry=1, barrier=(29.0948,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26677,'amu*angstrom^2'), symmetry=1, barrier=(29.1255,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2655,'amu*angstrom^2'), symmetry=1, barrier=(29.0963,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.5054,0.0847723,-0.000145873,1.28376e-07,-4.40529e-11,14062.8,25.9161], Tmin=(100,'K'), Tmax=(812.063,'K')), NASAPolynomial(coeffs=[10.6376,0.0238467,-1.29839e-05,2.57335e-09,-1.8009e-13,12780.5,-18.6197], Tmin=(812.063,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(115.942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[CH]=C(F)C([O])F(5120)'],
    products = ['[CH]=C(F)C([O])(F)C=O(5022)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[CH]C(F)=C(F)C=O(5122)'],
    products = ['[CH]=C(F)C([O])(F)C=O(5022)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=C(F)C([O])(F)C=O(5022)'],
    products = ['[CH]=C(F)C1(F)[CH]OO1(5123)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=C(F)C([O])(F)C=O(5022)'],
    products = ['[CH]=C(F)C1(F)OC1[O](5124)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH]=C(F)C(=O)C=O(5125)'],
    products = ['[CH]=C(F)C([O])(F)C=O(5022)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HCO(15)', '[CH]=C(F)C(=O)F(550)'],
    products = ['[CH]=C(F)C([O])(F)C=O(5022)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'C#CC([O])(F)C=O(5126)'],
    products = ['[CH]=C(F)C([O])(F)C=O(5022)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(78)', 'C#CC([O])=C[O](5127)'],
    products = ['[CH]=C(F)C([O])(F)C=O(5022)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', '[CH]=C(F)C(=O)[C]=O(5128)'],
    products = ['[CH]=C(F)C([O])(F)C=O(5022)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=C(F)C([O])(F)C=O(5022)'],
    products = ['[CH]=C(F)C(O)(F)[C]=O(5129)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]C(F)=C(C=O)OF(5131)'],
    products = ['[CH]=C(F)C([O])(F)C=O(5022)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]=[C]C(F)(C=O)OF(5132)'],
    products = ['[CH]=C(F)C([O])(F)C=O(5022)'],
...
network(
    label = 'PDepNetwork #1501',
    isomers = [
        '[CH]=C(F)C([O])(F)C=O(5022)',
    ],
    reactants = [
