...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.169349,'amu*angstrom^2'), symmetry=1, barrier=(3.89366,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167195,'amu*angstrom^2'), symmetry=1, barrier=(3.84415,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0438823,'amu*angstrom^2'), symmetry=1, barrier=(52.5305,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.375719,'amu*angstrom^2'), symmetry=1, barrier=(8.63851,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.377208,'amu*angstrom^2'), symmetry=1, barrier=(8.67275,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.56483,'amu*angstrom^2'), symmetry=1, barrier=(58.9705,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11477,0.0719561,-0.000128391,1.18119e-07,-4.17704e-11,-33168.8,28.2208], Tmin=(100,'K'), Tmax=(835.256,'K')), NASAPolynomial(coeffs=[7.74093,0.0239182,-1.28399e-05,2.51889e-09,-1.74736e-13,-33706.9,0.851086], Tmin=(835.256,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-276.576,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + missing(O2d-Cdd) + group(CsFFHO) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(C=CJO)"""),
)
...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.530774,0.091953,-0.00018131,1.79067e-07,-6.5891e-11,-78188.2,39.4201], Tmin=(100,'K'), Tmax=(854.119,'K')), NASAPolynomial(coeffs=[4.94004,0.0355741,-1.955e-05,3.83153e-09,-2.64072e-13,-77638.1,26.4725], Tmin=(854.119,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-651.007,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + group(CsFFHO) + group(COCFO) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C=C(F)OOC(F)F(3974)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'O=C=C(F)OO(4404)'],
    products = ['O=C=C(F)OOC(F)F(3974)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'O=C=C(F)OOF(4408)'],
    products = ['O=C=C(F)OOC(F)F(3974)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O=C=C(F)OOC(F)F(3974)'],
    products = ['O=C(F)C(=O)OC(F)F(4243)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O=[C]C(F)OO[C](F)F(4210)'],
    products = ['O=C=C(F)OOC(F)F(3974)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction5',
    reactants = ['O=C[C](F)OO[C](F)F(3971)'],
    products = ['O=C=C(F)OOC(F)F(3974)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O[C]=C(F)OO[C](F)F(4216)'],
    products = ['O=C=C(F)OOC(F)F(3974)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=C=C(F)OO[CH]F(4409)'],
    products = ['O=C=C(F)OOC(F)F(3974)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C=[C]OOC(F)F(4410)'],
    products = ['O=C=C(F)OOC(F)F(3974)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)F(207)', 'O=[C]C(=O)F(3886)'],
    products = ['O=C=C(F)OOC(F)F(3974)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF2(82)', '[O]OC(F)=C=O(1388)'],
    products = ['O=C=C(F)OOC(F)F(3974)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]OC(F)F(413)', 'O=C=[C]F(580)'],
    products = ['O=C=C(F)OOC(F)F(3974)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C=C(F)OO[C](F)F(4209)'],
    products = ['O=C=C(F)OOC(F)F(3974)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=C(F)[C-]=[O+]OC(F)F(4411)'],
    products = ['O=C=C(F)OOC(F)F(3974)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C=C(F)OOC(F)F(3974)'],
    products = ['CO(13)', 'F[C-]=[O+]OC(F)F(4412)'],
