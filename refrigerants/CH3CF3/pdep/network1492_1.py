...
species(
    label = '[O]C(F)(F)C1(F)[CH]OO1(4281)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    ...
    products = ['[O]C(F)(F)C([O])(F)C=O(3965)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(=COF)C([O])(F)F(4280)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(3965)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[O]C=C(F)C([O])(F)F(3679)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(3965)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[O]C(F)(C=O)[C](F)F(4072)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(3965)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1667.73,'m^3/(mol*s)'), n=1.126, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Y_rad;O_birad] for rate rule [C_ter_rad;O_birad]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)(F)C([O])(F)C=O(3965)'],
    products = ['O=CC1(F)OOC1(F)F(3973)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)(F)C([O])(F)C=O(3965)'],
    products = ['[O]C(F)(F)C1(F)[CH]OO1(4281)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)(F)C([O])(F)C=O(3965)'],
    products = ['[O]C1(F)[CH]OOC1(F)F(4221)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)(F)C([O])(F)C=O(3965)'],
    products = ['[O]C1OC1(F)C([O])(F)F(4282)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(F)(F)C([O])(F)C=O(3965)'],
    products = ['[O]C1OC(F)(F)C1([O])F(4247)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C(F)(F)C(=O)C=O(4283)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(3965)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[O]C(F)(C=O)C(=O)F(4284)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(3965)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F2(78)', '[O]C=C([O])C(=O)F(4285)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(3965)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(F)(F)C([O])(F)C=O(3965)'],
    products = ['[O]C(F)(F)C(O)(F)[C]=O(4287)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C(F)(F)C([O])(F)C=O(3965)'],
    products = ['[O]C(F)([C]=O)C(O)(F)F(4288)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C=C(OF)C([O])(F)F(4289)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(3965)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]C=C([O])C(F)(F)OF(4290)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(3965)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O][C](F)C(F)(C=O)OF(4291)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(3965)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C(F)(C=O)[C](F)OF(4292)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(3965)'],
...
network(
    label = 'PDepNetwork #1492',
    isomers = [
        '[O]C(F)(F)C([O])(F)C=O(3965)',
    ],
    reactants = [
