...
reaction(
    label = 'reaction1',
    reactants = ['CC[C]=O(10630)'],
    products = ['CH3(19)', 'CH2CO(28)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(2.977e+09,'s^-1'), n=1.37, Ea=(41.408,'kcal/mol'), T0=(1,'K'), comment="""Matched reaction 209 C3H5O-2 <=> C2H2O-2 + CH3 in R_Addition_MultipleBond/training
This reaction matched rate rule [Root_N-3R-inRing_3R->C_3C-u1_N-1R!H->S_N-2R!H->S_Ext-2CNO-R_N-Sp-4R!H-2CNO_N-4R!H->C]
family: R_Addition_MultipleBond"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'CH3CO(34)'],
    products = ['CC[C]=O(10630)'],
    transitionState = 'TS2',
