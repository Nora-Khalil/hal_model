...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH]C=C(2929)'],
    products = ['[CH]=CC[CH2](9126)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=[CH](977)', '[CH2][CH2](979)'],
    products = ['[CH]=CC[CH2](9126)'],
    transitionState = 'TS9',
