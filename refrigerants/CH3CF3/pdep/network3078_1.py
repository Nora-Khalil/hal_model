...
species(
    label = 'F[CH]C[C](F)C(F)(F)F(10373)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0816825,0.0963127,-0.000165558,1.5014e-07,-5.31744e-11,-95902.7,28.0683], Tmin=(100,'K'), Tmax=(808.483,'K')), NASAPolynomial(coeffs=[9.7545,0.0324479,-1.73679e-05,3.45322e-09,-2.42733e-13,-96943.6,-13.3055], Tmin=(808.483,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-798.472,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sF1sF1s)(F1s)) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]CC(F)(F)[C](F)F(9398)'],
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'FC=CC(F)(F)[C](F)F(2519)'],
    products = ['F[CH]CC(F)(F)[C](F)F(9398)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[CH]CC(F)=C(F)F(9392)'],
    products = ['F[CH]CC(F)(F)[C](F)F(9398)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction15',
    reactants = ['FC[CH]C(F)(F)[C](F)F(10372)'],
    products = ['F[CH]CC(F)(F)[C](F)F(9398)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]CC(F)(F)[C](F)F(9398)'],
    products = ['F[CH]C[C](F)C(F)(F)F(10373)'],
