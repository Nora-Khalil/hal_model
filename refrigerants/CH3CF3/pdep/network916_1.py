...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[O]C(F)(F)OOF(2252)'],
    products = ['OC(F)(F)OOF(2233)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['HF(38)', 'O=C(F)OOF(2253)'],
    products = ['OC(F)(F)OOF(2233)'],
    transitionState = 'TS8',
