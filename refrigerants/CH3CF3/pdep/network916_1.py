...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(790)', '[CH]C-2(978)'],
    products = ['C[CH]OC([O])=O(2290)'],
    transitionState = 'TS2',
