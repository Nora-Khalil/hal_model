...
reaction(
    label = 'reaction5',
    reactants = ['OF(195)', 'CC=C(F)F(3883)'],
    products = ['CCC(F)(F)OF(8940)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(127)', 'CC[C](F)F(970)'],
    products = ['CCC(F)(F)OF(8940)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['FO[C](F)F(236)', 'C2H5(32)'],
    products = ['CCC(F)(F)OF(8940)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', '[CH2]C(F)(F)OF(349)'],
    products = ['CCC(F)(F)OF(8940)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C[CH]C(F)(F)OF(8945)'],
    products = ['CCC(F)(F)OF(8940)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]CC(F)(F)OF(8946)'],
    products = ['CCC(F)(F)OF(8940)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'CC=C(F)OF(8948)'],
    products = ['CCC(F)(F)OF(8940)'],
