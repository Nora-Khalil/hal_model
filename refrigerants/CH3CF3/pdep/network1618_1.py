...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F(537)', '[C]=C(976)'],
    products = ['[CH]=C(F)O[C]=C(5737)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=C(F)OC#C(5896)'],
    products = ['[CH]=C(F)O[C]=C(5737)'],
    transitionState = 'TS7',
