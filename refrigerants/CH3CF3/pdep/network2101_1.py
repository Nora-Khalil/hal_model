...
reaction(
    label = 'reaction1',
    reactants = ['[OH+]=[C-]C(F)(F)C#CF(5995)'],
    products = ['CO(13)', 'FC=C=C(F)F(1375)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['FC#CC(F)=[C-][OH+]F(7966)'],
    products = ['[OH+]=[C-]C(F)(F)C#CF(5995)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['FC#C[OH+][C-]=C(F)F(7967)'],
    products = ['[OH+]=[C-]C(F)(F)C#CF(5995)'],
    transitionState = 'TS3',
...
network(
    ...
    isomers = [
        '[OH+]=[C-]C(F)(F)C#CF(5995)',
    ],
    reactants = [
        ('CO(13)', 'FC=C=C(F)F(1375)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
