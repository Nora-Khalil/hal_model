...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C(C)[O](1800)'],
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C(F)(F)[CH]C(1214)'],
    products = ['[CH2]C(F)(F)C(C)[O](1800)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'CC([O])[C](F)F(1841)'],
    products = ['[CH2]C(F)(F)C(C)[O](1800)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)(F)C(C)=O(1843)'],
    products = ['[CH2]C(F)(F)C(C)[O](1800)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(F)C(C)[O](1844)'],
    products = ['[CH2]C(F)(F)C(C)[O](1800)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2CF2(57)', 'C[CH][O](1817)'],
    products = ['[CH2]C(F)(F)C(C)[O](1800)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C](F)F(141)', 'C[CH][O](1817)'],
    products = ['[CH2]C(F)(F)C(C)[O](1800)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH2]C(F)=C(C)[O](1845)'],
    products = ['[CH2]C(F)(F)C(C)[O](1800)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(O)C([CH2])(F)F(1847)'],
    products = ['[CH2]C(F)(F)C(C)[O](1800)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C([O])C(C)(F)F(1849)'],
    products = ['[CH2]C(F)(F)C(C)[O](1800)'],
