...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'C#COO(2132)'],
    products = ['C#COOC(F)F(1780)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'C#COO[CH]F(2134)'],
    products = ['C#COOC(F)F(1780)'],
    transitionState = 'TS4',
