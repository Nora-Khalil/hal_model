...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(=O)C(F)(F)[CH]F(1334)'],
...
reaction(
    label = 'reaction3',
    reactants = ['O=C(OF)[C](F)[CH]F(1360)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(1334)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(804)', '[O]C(=O)[C](F)F(739)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(1334)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'O=[C]C(F)(F)[CH]F(1361)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(1334)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)C(F)(F)[CH]F(1334)'],
    products = ['F[CH]C(F)(F)[C]1OO1(1362)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)C(F)(F)[CH]F(1334)'],
    products = ['[O][C]1OC(F)C1(F)F(1363)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(=O)C(F)(F)[CH]F(1334)'],
    products = ['[O]C1([O])C(F)C1(F)F(1355)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(=O)C(F)=CF(1364)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(1334)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[O]C(=O)[C](F)F(739)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(1334)'],
