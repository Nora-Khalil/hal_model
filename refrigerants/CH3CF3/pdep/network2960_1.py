...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(976)', '[CH2]C[O](300)'],
    products = ['[CH2]CO[C]=C(9954)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[C]=C(1691)'],
    products = ['[CH2]CO[C]=C(9954)'],
    transitionState = 'TS3',
