...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)OC1O[C]1F(4006)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(138)', '[O]C1O[C]1F(4078)'],
    products = ['F[C](F)OC1O[C]1F(4006)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['O=C(F)[CH]O[C](F)F(4080)'],
    products = ['F[C](F)OC1O[C]1F(4006)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C](F)OC1=C(F)O1(4081)'],
    products = ['F[C](F)OC1O[C]1F(4006)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(43)', '[O]C1O[C]1F(4078)'],
    products = ['F[C](F)OC1O[C]1F(4006)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C](F)OC1O[C]1F(4006)'],
    products = ['F[C]1O[C]1OC(F)F(4083)'],
