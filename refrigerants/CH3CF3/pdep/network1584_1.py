...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(F)O[CH]F(5695)'],
    products = ['[O]C(F)(F)O[CH]F(5604)'],
    transitionState = 'TS6',
