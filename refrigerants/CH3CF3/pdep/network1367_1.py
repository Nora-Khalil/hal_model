...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)OC1(F)[CH]O1(3493)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(138)', '[O]C1(F)[CH]O1(3594)'],
    products = ['F[C](F)OC1(F)[CH]O1(3493)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O=C[C](F)O[C](F)F(3665)'],
    products = ['F[C](F)OC1(F)[CH]O1(3493)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[C](F)OC1=CO1(3666)'],
    products = ['F[C](F)OC1(F)[CH]O1(3493)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CF2(43)', '[O]C1(F)[CH]O1(3594)'],
    products = ['F[C](F)OC1(F)[CH]O1(3493)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F[C](F)OC1(F)[CH]O1(3493)'],
    products = ['FC(F)(F)O[C]1[CH]O1(3667)'],
