...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[CH2]C(=O)[C](F)F(1724)'],
    products = ['[CH2]C(F)(F)C(=C)[O](1634)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[CH2]C(F)(F)[C]=C(1725)'],
    products = ['[CH2]C(F)(F)C(=C)[O](1634)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)C(=C)[O](1634)'],
    products = ['[CH2]C(F)(F)[C]1CO1(1726)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C([O])C(=C)F(1728)'],
    products = ['[CH2]C(F)(F)C(=C)[O](1634)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(O)C([CH2])(F)F(1729)'],
    products = ['[CH2]C(F)(F)C(=C)[O](1634)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)=C([CH2])OF(1731)'],
    products = ['[CH2]C(F)(F)C(=C)[O](1634)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(18)', '[CH2]C(F)(F)[C]=O(740)'],
    products = ['[CH2]C(F)(F)C(=C)[O](1634)'],
