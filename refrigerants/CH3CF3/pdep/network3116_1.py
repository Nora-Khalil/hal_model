...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C#COCF(7771)'],
    products = ['C#COCCF(10408)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'C#COC[CH2](10009)'],
    products = ['C#COCCF(10408)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2F(46)', 'C#CO[CH2](561)'],
    products = ['C#COCCF(10408)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C#CO[CH]CF(12001)'],
    products = ['C#COCCF(10408)'],
    transitionState = 'TS9',
