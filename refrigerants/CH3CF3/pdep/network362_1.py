...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0663259,'amu*angstrom^2'), symmetry=1, barrier=(73.1902,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.046,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71945,0.055379,-8.95751e-05,7.93655e-08,-2.79223e-11,-5513.51,21.7272], Tmin=(100,'K'), Tmax=(791.671,'K')), NASAPolynomial(coeffs=[7.3424,0.0202888,-1.04324e-05,2.06154e-09,-1.45083e-13,-6194.49,-2.76465], Tmin=(791.671,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-46.4829,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCdF1sF1s) + radical(Cdj(Cdd-Cd)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99882,0.0541926,-4.03191e-05,-4.82844e-08,7.61128e-11,-51045.5,21.6239], Tmin=(100,'K'), Tmax=(458.234,'K')), NASAPolynomial(coeffs=[7.16853,0.0276906,-1.45347e-05,2.90288e-09,-2.05813e-13,-51714.8,-1.41624], Tmin=(458.234,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-424.927,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.136105,'amu*angstrom^2'), symmetry=1, barrier=(3.12932,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.320764,'amu*angstrom^2'), symmetry=1, barrier=(7.375,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05043,0.0719671,-0.000118545,1.06309e-07,-3.77504e-11,-36229.9,25.4344], Tmin=(100,'K'), Tmax=(791.643,'K')), NASAPolynomial(coeffs=[8.17968,0.0263175,-1.38066e-05,2.74425e-09,-1.93592e-13,-37057,-5.38905], Tmin=(791.643,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-302.058,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cdj(Cs-F1sCsH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.972219,0.0731232,-0.000117884,1.03078e-07,-3.60987e-11,-58954.9,21.6865], Tmin=(100,'K'), Tmax=(759.394,'K')), NASAPolynomial(coeffs=[9.10724,0.0252612,-1.34442e-05,2.69945e-09,-1.92006e-13,-60045.9,-14.3697], Tmin=(759.394,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-491.033,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', 'F[C]C=CF(869)'],
    products = ['F[C]=CC(F)[C](F)F(1025)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[C]=CC=C(F)F(490)'],
    products = ['F[C]=CC(F)[C](F)F(1025)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C]=CC(F)=C(F)F(1082)'],
    products = ['F[C]=CC(F)[C](F)F(1025)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'FC#CC(F)[C](F)F(1083)'],
    products = ['F[C]=CC(F)[C](F)F(1025)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'F[C]=C=C[C](F)F(1084)'],
    products = ['F[C]=CC(F)[C](F)F(1025)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C]=[C]C(F)C(F)F(1087)'],
    products = ['F[C]=CC(F)[C](F)F(1025)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[C]=CC(F)[C](F)F(1025)'],
    products = ['F[CH]C=C(F)[C](F)F(1088)'],
