...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.46829,'amu*angstrom^2'), symmetry=1, barrier=(33.7588,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]OC(F)(F)[CH]F(1284)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(192)', '[O]C(F)(F)[CH]F(841)'],
    products = ['O=[C]OC(F)(F)[CH]F(1284)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', 'O=[C]O[C](F)F(726)'],
    products = ['O=[C]OC(F)(F)[CH]F(1284)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(13)', '[O]C(F)(F)[CH]F(841)'],
    products = ['O=[C]OC(F)(F)[CH]F(1284)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC(F)=CF(1298)'],
    products = ['O=[C]OC(F)(F)[CH]F(1284)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF(40)', 'O=[C]O[C](F)F(726)'],
    products = ['O=[C]OC(F)(F)[CH]F(1284)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]O[C](F)C(F)F(1294)'],
    products = ['O=[C]OC(F)(F)[CH]F(1284)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=[C]OC(F)(F)[CH]F(1284)'],
    products = ['O=C(F)O[C](F)[CH]F(1299)'],
