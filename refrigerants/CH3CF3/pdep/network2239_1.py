...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])OOF(8097)'],
    products = ['O=C(O)OOF(7888)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]F(127)', '[O]C(=O)O(1583)'],
    products = ['O=C(O)OOF(7888)'],
    transitionState = 'TS4',
