species(
    label = '[CH2]C(F)(F)OOC=C(F)F(2350)',
...
species(
    label = '[CH2]C(F)(F)OC(F)(F)C=O(2729)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'FC1(F)[CH]OOC(F)(F)C1(2731)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = '[CH2]C(F)(F)OO[C]=C(F)F(2736)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)OOC=C(F)F(2350)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)OOC=C(F)F(2350)'],
    products = ['[CH2]C(F)(F)OC(F)(F)C=O(2729)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[C](F)OOC=C(F)F(1241)'],
    products = ['[CH2]C(F)(F)OOC=C(F)F(2350)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[CH]C(F)(F)OOC=C(F)F(2730)'],
    products = ['[CH2]C(F)(F)OOC=C(F)F(2350)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(F)(F)OOC=C(F)F(2350)'],
    products = ['FC1(F)[CH]OOC(F)(F)C1(2731)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)(F)OOC=C(F)F(2350)'],
    products = ['F[C](F)C1CC(F)(F)OO1(2732)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)OOC=C(F)F(2733)'],
    products = ['[CH2]C(F)(F)OOC=C(F)F(2350)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2][C](F)OOC=C(F)F(2734)'],
    products = ['[CH2]C(F)(F)OOC=C(F)F(2350)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(F)(F)OOC=[C]F(2735)'],
    products = ['[CH2]C(F)(F)OOC=C(F)F(2350)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=C[C](F)F(179)', '[CH2]C([O])(F)F(162)'],
    products = ['[CH2]C(F)(F)OOC=C(F)F(2350)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CF2CH(73)', '[CH2]C(F)(F)O[O](132)'],
    products = ['[CH2]C(F)(F)OOC=C(F)F(2350)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH2]C(F)(F)OO[C]=C(F)F(2736)'],
    products = ['[CH2]C(F)(F)OOC=C(F)F(2350)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[CH2]C(F)(F)OOC#CF(2737)'],
    products = ['[CH2]C(F)(F)OOC=C(F)F(2350)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CC(F)(F)OO[C]=C(F)F(2738)'],
    products = ['[CH2]C(F)(F)OOC=C(F)F(2350)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FC[C](F)OOC=C(F)F(2739)'],
    products = ['[CH2]C(F)(F)OOC=C(F)F(2350)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C]=COOC(F)(F)CF(2740)'],
    products = ['[CH2]C(F)(F)OOC=C(F)F(2350)'],
...
network(
    ...
    isomers = [
        '[CH2]C(F)(F)OOC=C(F)F(2350)',
    ],
    reactants = [
        ('O=C[C](F)F(179)', 'FC1(F)CO1(165)'),
        ('O=C[C](F)F(179)', '[CH2]C([O])(F)F(162)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
