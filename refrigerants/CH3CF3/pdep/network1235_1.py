...
"""),
    E0 = (-843.879,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,190,488,555,1236,1407,1855,455,950,180,180,343.503],'cm^-1')),
        HinderedRotor(inertia=(0.821955,'amu*angstrom^2'), symmetry=1, barrier=(18.8984,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.28518,'amu*angstrom^2'), symmetry=1, barrier=(52.5409,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.28784,'amu*angstrom^2'), symmetry=1, barrier=(52.6019,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.481104,0.0843599,-0.000143176,1.22824e-07,-4.13908e-11,-101375,25.4193], Tmin=(100,'K'), Tmax=(782.501,'K')), NASAPolynomial(coeffs=[11.8195,0.0211393,-1.19023e-05,2.39047e-09,-1.6883e-13,-102989,-25.472], Tmin=(782.501,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-843.879,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cds-OdOsH) + radical(Csj(Cs-F1sF1sO2s)(F1s)(F1s)) + radical((O)CJOC)"""),
)
...
"""),
    ...
    molecularWeight = (144.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.711186,0.0789139,-0.00013159,1.13017e-07,-3.83517e-11,-104741,25.2216], Tmin=(100,'K'), Tmax=(777.038,'K')), NASAPolynomial(coeffs=[10.8408,0.0218923,-1.21004e-05,2.42279e-09,-1.71153e-13,-106168,-20.1452], Tmin=(777.038,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-871.795,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + group(Cds-OdOsH) + radical(CsCsF1sO2s) + radical((O)CJOC)"""),
)

species(
    label = 'O=C(F)O[C](F)[C](F)F(3353)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {8,S}
3 F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]OC(F)(F)[C](F)F(3269)'],
...
reaction(
    ...
    products = ['O=[C]OC(F)(F)[C](F)F(3269)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O=[C]OC(F)(F)[C](F)F(3269)'],
    products = ['O=C1OC(F)(F)C1(F)F(3270)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CO2(14)', 'F[C](F)[C](F)F(1616)'],
    products = ['O=[C]OC(F)(F)[C](F)F(3269)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC(F)=C(F)F(1343)'],
    products = ['O=[C]OC(F)(F)[C](F)F(3269)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O][C]=O(722)', 'F[C](F)[C](F)F(1616)'],
    products = ['O=[C]OC(F)(F)[C](F)F(3269)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]OC(F)(F)[C](F)F(3269)'],
    products = ['O=[C]O[C](F)C(F)(F)F(3352)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=[C]OC(F)(F)[C](F)F(3269)'],
    products = ['O=C(F)O[C](F)[C](F)F(3353)'],
