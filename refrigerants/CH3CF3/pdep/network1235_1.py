species(
    label = 'FC=C(C(F)F)C(F)(F)OF(3080)',
...
species(
    label = 'F[C]C(=CF)C(F)(F)OF-2(3777)',
...
"""),
    E0 = (-547.536,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,275,321,533,585,746,850,1103,350,440,435,1725,194,682,905,1196,1383,3221,315,622,1128,180,592.649],'cm^-1')),
        HinderedRotor(inertia=(0.578874,'amu*angstrom^2'), symmetry=1, barrier=(13.3094,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.70493,'amu*angstrom^2'), symmetry=1, barrier=(39.1997,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.218876,'amu*angstrom^2'), symmetry=1, barrier=(5.03238,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0445632,0.0969781,-0.000153626,1.23506e-07,-3.93932e-11,-65715.2,28.1977], Tmin=(100,'K'), Tmax=(769.17,'K')), NASAPolynomial(coeffs=[13.66,0.0256975,-1.45964e-05,2.98545e-09,-2.14682e-13,-67823.1,-34.3203], Tmin=(769.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-547.536,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFO) + group(Cds-CdsCsCs) + group(CdCFH) + group(CJ2_singlet-FC)"""),
)
...
species(
    label = 'FOC(F)=C(C(F)F)C(F)F(3778)',
...
species(
    label = 'FOC(F)C(=C(F)F)C(F)F(3779)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {11,S}
...
"""),
    E0 = (-1070.75,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,236,527,855,1015,1182,1348,3236,171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,182,240,577,636,1210,1413,180,180,2525.77],'cm^-1')),
        HinderedRotor(inertia=(0.520424,'amu*angstrom^2'), symmetry=1, barrier=(11.9656,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.38144,'amu*angstrom^2'), symmetry=1, barrier=(31.7619,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.38169,'amu*angstrom^2'), symmetry=1, barrier=(31.7678,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.268684,0.104224,-0.000156313,1.18824e-07,-3.38365e-11,-128637,30.9479], Tmin=(100,'K'), Tmax=(631.151,'K')), NASAPolynomial(coeffs=[12.6765,0.0342534,-1.87082e-05,3.77943e-09,-2.70176e-13,-130512,-27.4525], Tmin=(631.151,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1070.75,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFHO) + group(CsCFFH) + group(Cds-CdsCsCs) + group(CdCFF)"""),
)
...
species(
    label = 'F[CH]C(=C(F)OF)C(F)F(3780)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = '[CH]=C(C(F)F)C(F)(F)OF(3782)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-665.536,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,275,321,533,585,746,850,1103,171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,3120,650,792.5,1650,194.775,255.831],'cm^-1')),
        HinderedRotor(inertia=(0.246882,'amu*angstrom^2'), symmetry=1, barrier=(7.89643,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.954251,'amu*angstrom^2'), symmetry=1, barrier=(29.139,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.255478,'amu*angstrom^2'), symmetry=1, barrier=(7.79891,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.354453,0.1045,-0.000174001,1.49496e-07,-5.07788e-11,-79897.1,29.9694], Tmin=(100,'K'), Tmax=(773.348,'K')), NASAPolynomial(coeffs=[13.0592,0.029085,-1.60169e-05,3.21247e-09,-2.27313e-13,-81791.3,-30.129], Tmin=(773.348,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-665.536,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFO) + group(CsCFFH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[O]C(F)(F)C(=CF)C(F)F(3783)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-990.918,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([526,555,698,907,1200,1145,1227,171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,194,682,905,1196,1383,3221,206.545,206.546,206.549],'cm^-1')),
        HinderedRotor(inertia=(0.182177,'amu*angstrom^2'), symmetry=1, barrier=(5.51531,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.828879,'amu*angstrom^2'), symmetry=1, barrier=(25.0955,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.513694,0.0820797,-0.000103005,6.6722e-08,-1.74085e-11,-119059,28.663], Tmin=(100,'K'), Tmax=(928.374,'K')), NASAPolynomial(coeffs=[13.2923,0.027021,-1.40443e-05,2.83811e-09,-2.05154e-13,-121431,-32.0366], Tmin=(928.374,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-990.918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + group(CsCFFH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(O2sj(Cs-F1sF1sCd))"""),
)
...
"""),
    E0 = (-848.346,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,161,297,490,584,780,1358,194,682,905,1196,1383,3221,180],'cm^-1')),
        HinderedRotor(inertia=(0.0249114,'amu*angstrom^2'), symmetry=1, barrier=(8.96938,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0176822,'amu*angstrom^2'), symmetry=1, barrier=(42.8668,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'F[CH]C(=C(F)F)C(F)(F)OF(3647)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-941.22,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,275,321,533,585,746,850,1103,350,440,435,1725,234,589,736,816,1240,3237,182,240,577,636,1210,1413,180,2365.02],'cm^-1')),
        HinderedRotor(inertia=(0.254905,'amu*angstrom^2'), symmetry=1, barrier=(5.86076,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.65298,'amu*angstrom^2'), symmetry=1, barrier=(38.0053,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.65196,'amu*angstrom^2'), symmetry=1, barrier=(37.9817,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (179.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.455609,0.106527,-0.000169589,1.38505e-07,-4.49247e-11,-113050,31.8379], Tmin=(100,'K'), Tmax=(756.571,'K')), NASAPolynomial(coeffs=[14.1875,0.0291086,-1.60963e-05,3.25205e-09,-2.31993e-13,-115266,-34.7218], Tmin=(756.571,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-941.22,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFO) + group(CsCFHH) + group(Cds-CdsCsCs) + group(CdCFF) + radical(Csj(Cd-CsCd)(F1s)(H))"""),
)

species(
    label = 'F[C]=C(C(F)F)C(F)(F)OF(3785)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.146341,'amu*angstrom^2'), symmetry=1, barrier=(3.36466,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146268,'amu*angstrom^2'), symmetry=1, barrier=(3.36298,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.986258,'amu*angstrom^2'), symmetry=1, barrier=(22.676,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (179.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.80051,0.116907,-0.000206921,1.83619e-07,-6.31723e-11,-102548,32.5087], Tmin=(100,'K'), Tmax=(814.163,'K')), NASAPolynomial(coeffs=[13.4975,0.0302587,-1.7064e-05,3.41244e-09,-2.39462e-13,-104332,-30.1927], Tmin=(814.163,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-853.976,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFO) + group(CsCFFH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(Cdj(Cd-CsCs)(F1s))"""),
)

species(
    label = '[CH]C(F)(C(F)F)C(F)(F)OF(3786)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-949.154,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,194,682,905,1196,1383,3221,255,533,799,832,1228,180,1487.4],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.952226,0.0732806,-0.000107749,8.93999e-08,-3.04711e-11,-114053,25.729], Tmin=(100,'K'), Tmax=(713.265,'K')), NASAPolynomial(coeffs=[8.78829,0.0293444,-1.53685e-05,3.07169e-09,-2.18846e-13,-115171,-9.42916], Tmin=(713.265,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-949.154,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + group(Cd-CdCs(CO)) + group(CdCFH) + group(COCFO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['FC=C(C(F)F)C(F)(F)OF(3080)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'FC=C(OF)C(F)F(3775)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(3080)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['FOF(328)', 'F[C]C(=CF)C(F)F(3776)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(3080)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['HF(38)', 'F[C]C(=CF)C(F)(F)OF-2(3777)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(3080)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF(40)', 'FC=C(F)C(F)(F)OF(1372)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(3080)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FOC(F)=C(C(F)F)C(F)F(3778)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(3080)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['FOC(F)C(=C(F)F)C(F)F(3779)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(3080)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'F[CH]C(=C(F)OF)C(F)F(3780)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(3080)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'F[CH]C(=CF)C(F)(F)OF(3781)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(3080)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH]=C(C(F)F)C(F)(F)OF(3782)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(3080)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)(F)C(=CF)C(F)F(3783)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(3080)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(127)', 'FC=C([C](F)F)C(F)F(3062)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(3080)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FO[C](F)F(236)', 'FC=[C]C(F)F(1592)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(3080)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF2(82)', 'FC=[C]C(F)(F)OF(3784)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(3080)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'F[CH]C(=C(F)F)C(F)(F)OF(3647)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(3080)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'F[C]=C(C(F)F)C(F)(F)OF(3785)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(3080)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]C(F)(C(F)F)C(F)(F)OF(3786)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(3080)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C]C(C(F)F)C(F)(F)OF(3787)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(3080)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(78)', 'O=C(F)C(=CF)C(F)F(3788)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(3080)'],
...
reaction(
    label = 'reaction22',
    reactants = ['FC=C(C(F)F)C(F)(F)OF(3080)'],
    products = ['F2(78)', 'CF2O(49)', 'FC=C=CF(3789)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CHF(40)', 'FOC(F)(F)[C]C(F)F(3790)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(3080)'],
