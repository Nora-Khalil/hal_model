...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00234344,'amu*angstrom^2'), symmetry=1, barrier=(8.02833,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.349956,'amu*angstrom^2'), symmetry=1, barrier=(8.04618,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.99061,'amu*angstrom^2'), symmetry=1, barrier=(45.7681,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.40313,0.0890365,-0.000160438,1.46546e-07,-5.15472e-11,-109305,29.1505], Tmin=(100,'K'), Tmax=(823.31,'K')), NASAPolynomial(coeffs=[9.80847,0.0261104,-1.43989e-05,2.87179e-09,-2.01256e-13,-110270,-10.8496], Tmin=(823.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-909.812,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sO2s)(F1s)(H)) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.264551,'amu*angstrom^2'), symmetry=1, barrier=(6.08254,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.26472,'amu*angstrom^2'), symmetry=1, barrier=(6.08643,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.265174,'amu*angstrom^2'), symmetry=1, barrier=(6.09688,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (148.031,'amu'),
...
"""),
    ...
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.24806,0.0903069,-0.000157416,1.35815e-07,-4.51593e-11,-112502,28.8636], Tmin=(100,'K'), Tmax=(832.707,'K')), NASAPolynomial(coeffs=[12.5372,0.0200407,-1.06057e-05,2.07767e-09,-1.43888e-13,-114160,-25.836], Tmin=(832.707,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-936.46,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)(F)O[C](F)F(1016)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(138)', '[O]C(F)(F)[CH]F(841)'],
    products = ['F[CH]C(F)(F)O[C](F)F(1016)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', 'F[C](F)O[C](F)F(280)'],
    products = ['F[CH]C(F)(F)O[C](F)F(1016)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[CH]C(F)(F)O[C](F)F(1016)'],
    products = ['FC1C(F)(F)OC1(F)F(1018)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CF2O(49)', 'F[CH][C](F)F(588)'],
    products = ['F[CH]C(F)(F)O[C](F)F(1016)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'FC=C(F)O[C](F)F(838)'],
    products = ['F[CH]C(F)(F)O[C](F)F(1016)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O][C](F)F(263)', 'CHFCF2(55)'],
    products = ['F[CH]C(F)(F)O[C](F)F(1016)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C](F)F(263)', 'F[CH][C](F)F(588)'],
    products = ['F[CH]C(F)(F)O[C](F)F(1016)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(40)', 'F[C](F)O[C](F)F(280)'],
    products = ['F[CH]C(F)(F)O[C](F)F(1016)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(43)', '[O]C(F)(F)[CH]F(841)'],
    products = ['F[CH]C(F)(F)O[C](F)F(1016)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F[C](F)O[C](F)C(F)F(1103)'],
    products = ['F[CH]C(F)(F)O[C](F)F(1016)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH]C(F)(F)O[C](F)F(1016)'],
    products = ['F[CH][C](F)OC(F)(F)F(1168)'],
