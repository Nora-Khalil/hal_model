...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(F)(F)CC(F)F(6629)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]OC(F)(F)C(F)F(2261)'],
    products = ['[O]OC(F)(F)CC(F)F(6629)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OF(126)', 'F[C]CC(F)F(341)'],
    products = ['[O]OC(F)(F)CC(F)F(6629)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CF2(43)', 'CC(F)(F)O[O](203)'],
    products = ['[O]OC(F)(F)CC(F)F(6629)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF(40)', '[O]OC(F)(F)CF(512)'],
    products = ['[O]OC(F)(F)CC(F)F(6629)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O(6)', '[O]C(F)(F)CC(F)F(347)'],
    products = ['[O]OC(F)(F)CC(F)F(6629)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]O[C](F)CC(F)F(7546)'],
    products = ['[O]OC(F)(F)CC(F)F(6629)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]OC(F)(F)C[CH]F(7547)'],
    products = ['[O]OC(F)(F)CC(F)F(6629)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(3.8422e+07,'m^3/(mol*s)'), n=-0.361029, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['O2(2)', 'F[C](F)CC(F)F(348)'],
    products = ['[O]OC(F)(F)CC(F)F(6629)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[C](F)F(163)', 'CHF2-CH2(64)'],
    products = ['[O]OC(F)(F)CC(F)F(6629)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHF2(82)', '[CH2]C(F)(F)O[O](132)'],
    products = ['[O]OC(F)(F)CC(F)F(6629)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]OC(F)(F)[CH]C(F)F(6669)'],
    products = ['[O]OC(F)(F)CC(F)F(6629)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]OC(F)(F)C[C](F)F(7044)'],
    products = ['[O]OC(F)(F)CC(F)F(6629)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[O]OC(F)=CC(F)F(7042)'],
    products = ['[O]OC(F)(F)CC(F)F(6629)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[O]OC(F)(F)C=CF(2957)'],
    products = ['[O]OC(F)(F)CC(F)F(6629)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OOC(F)(F)[CH]C(F)F(6631)'],
    products = ['[O]OC(F)(F)CC(F)F(6629)'],
...
reaction(
    label = 'reaction18',
    reactants = ['OOC(F)(F)C[C](F)F(7548)'],
    products = ['[O]OC(F)(F)CC(F)F(6629)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH]CC(F)(F)OOF(7550)'],
    products = ['[O]OC(F)(F)CC(F)F(6629)'],
...
network(
    ...
    isomers = [
        '[O]OC(F)(F)CC(F)F(6629)',
    ],
    reactants = [
        ('HO2(11)', 'FC(F)=CC(F)F(344)'),
        ('CF2(43)', 'CC(F)(F)O[O](203)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
