...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(192)', '[CH2]C([O])F(5619)'],
    products = ['[O]C(F)C[C]=O(6191)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['CO(13)', '[CH2]C([O])F(5619)'],
    products = ['[O]C(F)C[C]=O(6191)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]C(F)C=C=O(6206)'],
    products = ['[O]C(F)C[C]=O(6191)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[O]C=C[C]=O(6207)'],
    products = ['[O]C(F)C[C]=O(6191)'],
