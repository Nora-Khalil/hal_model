...
reaction(
    label = 'reaction1',
    reactants = ['[C-]=[O+]OC(=O)F(8756)'],
    products = ['CO(13)', 'O=C(O)F(635)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[C-]=[O+]OF(8878)'],
    products = ['[C-]=[O+]OC(=O)F(8756)'],
    transitionState = 'TS2',
