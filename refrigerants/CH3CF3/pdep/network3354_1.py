species(
    label = 'C=C(OF)C(C(F)F)C(F)F(12655)',
...
"""),
    E0 = (-925.708,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,1380,1390,370,380,2900,435,176,294,457,589,547,707,1086,1160,1127,1157,1302,1442,1365,1447,3042,3152,350,440,435,1725,2950,3100,1380,975,1025,1650,324.584,324.584,324.584,324.585],'cm^-1')),
        HinderedRotor(inertia=(0.0016001,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.335901,'amu*angstrom^2'), symmetry=1, barrier=(25.1126,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168869,'amu*angstrom^2'), symmetry=1, barrier=(12.6249,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168868,'amu*angstrom^2'), symmetry=1, barrier=(12.6249,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (176.084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.536156,0.106512,-0.000134622,8.96048e-08,-2.40795e-11,-111179,33.6635], Tmin=(100,'K'), Tmax=(902.398,'K')), NASAPolynomial(coeffs=[15.2605,0.0364918,-1.82344e-05,3.62192e-09,-2.59187e-13,-114030,-40.9243], Tmin=(902.398,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-925.708,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsCsH) + group(CsCsFFH) + group(CsCsFFH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)
...
species(
    label = 'C=C(OF)C([C]F)C(F)F(12680)',
...
"""),
    E0 = (-339.919,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,350,440,435,1725,2950,3100,1380,975,1025,1650,617,898,1187,265.95,266.083,2085.77],'cm^-1')),
        HinderedRotor(inertia=(0.235541,'amu*angstrom^2'), symmetry=1, barrier=(11.8494,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235578,'amu*angstrom^2'), symmetry=1, barrier=(11.8494,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235877,'amu*angstrom^2'), symmetry=1, barrier=(11.8484,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.741151,'amu*angstrom^2'), symmetry=1, barrier=(37.1021,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (156.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.167713,0.0988418,-0.000142786,1.10817e-07,-3.46152e-11,-40739.4,32.8438], Tmin=(100,'K'), Tmax=(781.985,'K')), NASAPolynomial(coeffs=[12.6872,0.0330834,-1.66421e-05,3.26978e-09,-2.30797e-13,-42749.7,-26.0116], Tmin=(781.985,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-339.919,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsCsH) + group(CsCsFFH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-644.113,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,284,328,853,1146,1135,1297,3239,235,523,627,1123,1142,1372,1406,3097,350,440,435,1725,2950,3100,1380,975,1025,1650,286.54,286.551,286.557],'cm^-1')),
        HinderedRotor(inertia=(0.0728299,'amu*angstrom^2'), symmetry=1, barrier=(4.2437,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.199845,'amu*angstrom^2'), symmetry=1, barrier=(11.6444,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.649893,'amu*angstrom^2'), symmetry=1, barrier=(37.8727,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.404322,0.0862642,-0.000120269,9.29049e-08,-2.94058e-11,-77346,26.8889], Tmin=(100,'K'), Tmax=(766.787,'K')), NASAPolynomial(coeffs=[10.4828,0.0336876,-1.74146e-05,3.47723e-09,-2.48259e-13,-78891.6,-19.0571], Tmin=(766.787,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-644.113,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)

species(
    label = 'O=C(CF)C(C(F)F)C(F)F(12682)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (176.084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.848946,0.116082,-0.000178177,1.50967e-07,-5.16307e-11,-152855,34.1174], Tmin=(100,'K'), Tmax=(763.329,'K')), NASAPolynomial(coeffs=[12.1143,0.0423043,-2.17079e-05,4.27661e-09,-3.01141e-13,-154663,-23.8059], Tmin=(763.329,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1272.28,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(CsCsFFH) + group(CsCsFFH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs)"""),
)

species(
    label = 'FOC(=CC(F)F)CC(F)F(12683)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-913.606,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,3010,987.5,1337.5,450,1655,351.689,351.69,351.691,351.692],'cm^-1')),
        HinderedRotor(inertia=(0.117202,'amu*angstrom^2'), symmetry=1, barrier=(10.287,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117206,'amu*angstrom^2'), symmetry=1, barrier=(10.287,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117203,'amu*angstrom^2'), symmetry=1, barrier=(10.2869,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00840584,'amu*angstrom^2'), symmetry=1, barrier=(22.6895,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (176.084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.463295,0.106943,-0.000147333,1.12366e-07,-3.51087e-11,-109729,34.9369], Tmin=(100,'K'), Tmax=(776.463,'K')), NASAPolynomial(coeffs=[12.1861,0.0417772,-2.14407e-05,4.27345e-09,-3.04967e-13,-111693,-22.8883], Tmin=(776.463,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-913.606,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(CsCFFH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH)"""),
)

species(
    label = '[CH2]C(OF)[C](C(F)F)C(F)F(12684)',
...
"""),
    ...
    molecularWeight = (176.084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.786554,0.112392,-0.000146605,9.97649e-08,-2.72666e-11,-80206.9,34.8879], Tmin=(100,'K'), Tmax=(889.842,'K')), NASAPolynomial(coeffs=[16.1457,0.0362787,-1.83014e-05,3.63981e-09,-2.60369e-13,-83220.3,-44.8242], Tmin=(889.842,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-668.26,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(CsCsFFH) + group(CsCsFFH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(OF)C([C](F)F)C(F)F(12685)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (176.084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.16998,0.122087,-0.000179816,1.38354e-07,-4.2395e-11,-74612.2,38.2139], Tmin=(100,'K'), Tmax=(799.518,'K')), NASAPolynomial(coeffs=[16.054,0.03592,-1.81642e-05,3.56978e-09,-2.51792e-13,-77366.5,-41.0288], Tmin=(799.518,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-621.845,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(CsCsFFH) + group(CsCsFFH) + group(Cs-CsHHH) + radical(Csj(Cs-CsCsH)(F1s)(F1s)) + radical(CJCO)"""),
)

species(
    label = 'C[C](OF)C([C](F)F)C(F)F(12686)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {11,S}
...
species(
    label = 'C=C(OF)C([CH]F)C(F)F(12687)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-508.957,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,350,440,435,1725,334,575,1197,1424,3202,2950,3100,1380,975,1025,1650,347.287,347.678,347.691,348.156],'cm^-1')),
        HinderedRotor(inertia=(0.00139457,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113941,'amu*angstrom^2'), symmetry=1, barrier=(9.7699,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11398,'amu*angstrom^2'), symmetry=1, barrier=(9.76321,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.311273,'amu*angstrom^2'), symmetry=1, barrier=(26.7557,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (157.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.41728,0.104583,-0.000147569,1.11425e-07,-3.386e-11,-61061,33.8145], Tmin=(100,'K'), Tmax=(803.026,'K')), NASAPolynomial(coeffs=[13.5646,0.0349407,-1.74889e-05,3.4395e-09,-2.4331e-13,-63306.7,-30.5736], Tmin=(803.026,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-508.957,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsCsH) + group(CsCsFFH) + group(CsCsFHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CsCsF1sH)"""),
)

species(
    label = 'C=C([O])C(C(F)F)C(F)F(12688)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-945.71,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,176,294,457,589,547,707,1086,1160,1127,1157,1302,1442,1365,1447,3042,3152,350,440,435,1725,2950,3100,1380,975,1025,1650,364.34,364.344,364.346,364.346],'cm^-1')),
        HinderedRotor(inertia=(0.141913,'amu*angstrom^2'), symmetry=1, barrier=(13.3681,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141907,'amu*angstrom^2'), symmetry=1, barrier=(13.3683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14191,'amu*angstrom^2'), symmetry=1, barrier=(13.3681,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (157.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.231503,0.0932408,-0.000106301,6.15198e-08,-1.41014e-11,-113590,31.5878], Tmin=(100,'K'), Tmax=(1062.23,'K')), NASAPolynomial(coeffs=[17.5152,0.0264128,-1.19313e-05,2.29274e-09,-1.6209e-13,-117360,-55.1011], Tmin=(1062.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-945.71,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(CsCsFFH) + group(CsCsFFH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ)"""),
)
...
"""),
    E0 = (-631.114,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,176,294,457,589,547,707,1086,1160,1127,1157,1302,1442,1365,1447,3042,3152,2950,3100,1380,975,1025,1650,1685,370,298.15,298.194,298.207],'cm^-1')),
        HinderedRotor(inertia=(0.195239,'amu*angstrom^2'), symmetry=1, barrier=(12.321,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1952,'amu*angstrom^2'), symmetry=1, barrier=(12.3206,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.333125,'amu*angstrom^2'), symmetry=1, barrier=(21.0192,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.546573,0.080856,-9.25485e-05,5.70916e-08,-1.44465e-11,-75785.2,27.7211], Tmin=(100,'K'), Tmax=(948.979,'K')), NASAPolynomial(coeffs=[12.0821,0.0322317,-1.56883e-05,3.09484e-09,-2.21071e-13,-77974.6,-27.3265], Tmin=(948.979,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-631.114,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(CsCsFFH) + group(CsCsFFH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
species(
    label = 'C=C(OF)[C](C(F)F)C(F)F(12690)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-773.135,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,463,581,545,677,848,1004,1037,1149,1097,1177,1301,1447,1377,1455,3039,3185,360,370,350,350,440,435,1725,2950,3100,1380,975,1025,1650,214.212,214.226,214.244,2892.55],'cm^-1')),
        HinderedRotor(inertia=(0.479552,'amu*angstrom^2'), symmetry=1, barrier=(15.6212,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09504,'amu*angstrom^2'), symmetry=1, barrier=(35.6883,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09569,'amu*angstrom^2'), symmetry=1, barrier=(35.6876,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.479492,'amu*angstrom^2'), symmetry=1, barrier=(15.6211,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (175.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.239287,0.0995795,-0.000122352,7.87662e-08,-2.05229e-11,-92839.3,33.4855], Tmin=(100,'K'), Tmax=(928.046,'K')), NASAPolynomial(coeffs=[14.7964,0.0347737,-1.76063e-05,3.52125e-09,-2.53156e-13,-95630,-37.9302], Tmin=(928.046,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-773.135,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsCsH) + group(CsCsFFH) + group(CsCsFFH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCJ(C)CO)"""),
)

species(
    label = 'C=C(OF)C([C](F)F)C(F)F(12691)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-723.359,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,350,440,435,1725,190,488,555,1236,1407,2950,3100,1380,975,1025,1650,396.666,397.156,397.596,398.066],'cm^-1')),
        HinderedRotor(inertia=(0.0796342,'amu*angstrom^2'), symmetry=1, barrier=(8.94964,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.079647,'amu*angstrom^2'), symmetry=1, barrier=(9.02289,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0800349,'amu*angstrom^2'), symmetry=1, barrier=(8.98677,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.223889,'amu*angstrom^2'), symmetry=1, barrier=(25.0142,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (175.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.775395,0.113331,-0.000167085,1.29738e-07,-4.02958e-11,-86835.7,36.1415], Tmin=(100,'K'), Tmax=(787.674,'K')), NASAPolynomial(coeffs=[14.6441,0.0350335,-1.79941e-05,3.56228e-09,-2.52366e-13,-89265,-34.5699], Tmin=(787.674,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-723.359,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsCsH) + group(CsCsFFH) + group(CsCsFFH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CsCsF1sF1s)"""),
)

species(
    label = '[CH]=C(OF)C(C(F)F)C(F)F(12692)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-678.612,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,1380,1390,370,380,2900,435,176,294,457,589,547,707,1086,1160,1127,1157,1302,1442,1365,1447,3042,3152,350,440,435,1725,3120,650,792.5,1650,263.813,263.823,263.832],'cm^-1')),
        HinderedRotor(inertia=(0.00242212,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.264836,'amu*angstrom^2'), symmetry=1, barrier=(13.0796,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.264827,'amu*angstrom^2'), symmetry=1, barrier=(13.0796,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.541173,'amu*angstrom^2'), symmetry=1, barrier=(26.7295,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (175.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.722737,0.111403,-0.000156256,1.13763e-07,-3.30563e-11,-81454.8,34.7335], Tmin=(100,'K'), Tmax=(840.886,'K')), NASAPolynomial(coeffs=[15.6875,0.0333452,-1.70215e-05,3.3813e-09,-2.40876e-13,-84214.8,-41.5933], Tmin=(840.886,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-678.612,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsCsH) + group(CsCsFFH) + group(CsCsFFH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(OF)C(C(F)F)C(F)F(12693)',
...
"""),
    ...
    molecularWeight = (176.084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.19297,0.123721,-0.000188396,1.52378e-07,-4.93943e-11,-70141.5,35.6459], Tmin=(100,'K'), Tmax=(754.976,'K')), NASAPolynomial(coeffs=[14.7767,0.0391308,-2.03692e-05,4.04054e-09,-2.85954e-13,-72553.4,-36.9138], Tmin=(754.976,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-584.671,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(CsCsFFH) + group(CsCsFFH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = 'C=C(OF)C(=CF)C(F)F(12694)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-585.513,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,171,205,598,1104,1143,1317,1411,3153,325,375,415,465,420,450,1700,1750,194,682,905,1196,1383,3221,2950,3100,1380,975,1025,1650,373.364,373.367,373.369],'cm^-1')),
        HinderedRotor(inertia=(0.0959451,'amu*angstrom^2'), symmetry=1, barrier=(9.49122,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0959459,'amu*angstrom^2'), symmetry=1, barrier=(9.49122,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.271218,'amu*angstrom^2'), symmetry=1, barrier=(26.8299,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (156.078,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['C=C(OF)C(C(F)F)C(F)F(12655)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'C=C(CC(F)F)OF(7131)'],
    products = ['C=C(OF)C(C(F)F)C(F)F(12655)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['HF(38)', 'C=C(OF)C([C]F)C(F)F(12680)'],
    products = ['C=C(OF)C(C(F)F)C(F)F(12655)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CHF(40)', 'C=C(OF)C(F)C(F)F(12681)'],
    products = ['C=C(OF)C(C(F)F)C(F)F(12655)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C=C(OF)C(C(F)F)C(F)F(12655)'],
    products = ['O=C(CF)C(C(F)F)C(F)F(12682)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['FOC(=CC(F)F)CC(F)F(12683)'],
    products = ['C=C(OF)C(C(F)F)C(F)F(12655)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(OF)[C](C(F)F)C(F)F(12684)'],
    products = ['C=C(OF)C(C(F)F)C(F)F(12655)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(OF)C([C](F)F)C(F)F(12685)'],
    products = ['C=C(OF)C(C(F)F)C(F)F(12655)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C[C](OF)C([C](F)F)C(F)F(12686)'],
    products = ['C=C(OF)C(C(F)F)C(F)F(12655)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(OF)C([CH]F)C(F)F(12687)'],
    products = ['C=C(OF)C(C(F)F)C(F)F(12655)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C([O])C(C(F)F)C(F)F(12688)'],
    products = ['C=C(OF)C(C(F)F)C(F)F(12655)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(127)', 'C=[C]C(C(F)F)C(F)F(12689)'],
    products = ['C=C(OF)C(C(F)F)C(F)F(12655)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF2(82)', '[CH2]C(=CC(F)F)OF(7159)'],
    products = ['C=C(OF)C(C(F)F)C(F)F(12655)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C=[C]OF(1651)', 'FC(F)[CH]C(F)F(1502)'],
    products = ['C=C(OF)C(C(F)F)C(F)F(12655)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C=C(OF)[C](C(F)F)C(F)F(12690)'],
    products = ['C=C(OF)C(C(F)F)C(F)F(12655)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C=C(OF)C([C](F)F)C(F)F(12691)'],
    products = ['C=C(OF)C(C(F)F)C(F)F(12655)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH]=C(OF)C(C(F)F)C(F)F(12692)'],
    products = ['C=C(OF)C(C(F)F)C(F)F(12655)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]C(OF)C(C(F)F)C(F)F(12693)'],
    products = ['C=C(OF)C(C(F)F)C(F)F(12655)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C=C(OF)C(=CF)C(F)F(12694)'],
    products = ['C=C(OF)C(C(F)F)C(F)F(12655)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C=C(OF)C(C(F)F)C(F)F(12655)'],
    products = ['F2(78)', 'CH2CO(28)', 'FC=CC(F)F(3067)'],
...
network(
    label = 'PDepNetwork #3354',
    isomers = [
        'C=C(OF)C(C(F)F)C(F)F(12655)',
    ],
    reactants = [
