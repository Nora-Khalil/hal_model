...
"""),
    ...
    molecularWeight = (140.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.71425,0.0787872,-0.000102069,7.45561e-08,-2.25703e-11,-87062.9,24.7278], Tmin=(100,'K'), Tmax=(796.936,'K')), NASAPolynomial(coeffs=[9.71996,0.0335844,-1.69856e-05,3.37906e-09,-2.41418e-13,-88498.3,-16.6752], Tmin=(796.936,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-724.817,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CdCFH) + group(CdCFH)"""),
)
...
"""),
    E0 = (-235.762,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,145,326,398,834,1303,334,575,1197,1424,3202,113,247,382,1207,3490,540,610,2055,180,965.987,966.637],'cm^-1')),
        HinderedRotor(inertia=(0.00409396,'amu*angstrom^2'), symmetry=1, barrier=(2.71341,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117944,'amu*angstrom^2'), symmetry=1, barrier=(2.71177,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16533,0.0674534,-8.14183e-05,5.53128e-08,-1.562e-11,-28258,25.2046], Tmin=(100,'K'), Tmax=(850.612,'K')), NASAPolynomial(coeffs=[9.23818,0.0294932,-1.44823e-05,2.8551e-09,-2.03385e-13,-29631.5,-12.4367], Tmin=(850.612,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-235.762,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(CdCddCF) + group(CdCddFH) + group(Cdd-CdsCds) + radical(Csj(Cs-CdHH)(F1s)(H))"""),
)
...
"""),
    E0 = (-298.663,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,154,355,414,641,686,1150,1196,334,575,1197,1424,3202,2175,525,750,770,3400,2100,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.794034,'amu*angstrom^2'), symmetry=1, barrier=(18.2564,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.60575,'amu*angstrom^2'), symmetry=1, barrier=(59.9112,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.252098,'amu*angstrom^2'), symmetry=1, barrier=(5.79624,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.433923,0.0846262,-0.00013104,1.08838e-07,-3.57014e-11,-35798.3,24.5896], Tmin=(100,'K'), Tmax=(828.254,'K')), NASAPolynomial(coeffs=[10.7179,0.027187,-1.29367e-05,2.44443e-09,-1.67214e-13,-37235.2,-21.477], Tmin=(828.254,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-298.663,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFF) + group(CsCsFHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)

species(
    label = 'FC#CC(F)(F)C[CH]F(10468)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-398.428,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,154,355,414,641,686,1150,1196,334,575,1197,1424,3202,2175,525,239,401,1367,249.128,249.128,249.129],'cm^-1')),
        HinderedRotor(inertia=(0.163728,'amu*angstrom^2'), symmetry=1, barrier=(7.21098,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00200977,'amu*angstrom^2'), symmetry=1, barrier=(7.21098,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.991668,'amu*angstrom^2'), symmetry=1, barrier=(43.675,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (139.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.201716,0.0937855,-0.000161165,1.45485e-07,-5.07586e-11,-47792.9,27.7427], Tmin=(100,'K'), Tmax=(839.434,'K')), NASAPolynomial(coeffs=[9.08907,0.0321295,-1.64909e-05,3.18835e-09,-2.19693e-13,-48604.7,-9.52647], Tmin=(839.434,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-398.428,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFF) + group(CsCsFHH) + group(Ct-CtCs) + group(CtCF) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (140.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34835,0.0719678,-5.06634e-05,-7.24521e-08,1.08306e-10,-47394.4,27.7421], Tmin=(100,'K'), Tmax=(455.916,'K')), NASAPolynomial(coeffs=[8.1852,0.0372703,-1.96986e-05,3.91835e-09,-2.76808e-13,-48280.6,-2.75387], Tmin=(455.916,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-394.735,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFF) + group(CsCsFHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cs_S) + radical(Cdj(Cs-F1sF1sCs)(Cd-F1sH))"""),
)

species(
    label = 'F[C]=CC(F)(F)C[CH]F(10470)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (140.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0615302,0.0955552,-0.000155416,1.36995e-07,-4.78042e-11,-48731.6,29.6522], Tmin=(100,'K'), Tmax=(801.991,'K')), NASAPolynomial(coeffs=[9.90572,0.0341978,-1.77291e-05,3.48134e-09,-2.43573e-13,-49916.4,-13.2103], Tmin=(801.991,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-406.285,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFF) + group(CsCsFHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Csj(Cs-CsHH)(F1s)(H)) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    E0 = (-339.159,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,136,307,446,511,682,757,1180,1185,528,1116,1182,1331,1402,1494,3075,3110,1685,370,167,640,1190,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.324387,'amu*angstrom^2'), symmetry=1, barrier=(7.4583,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.323701,'amu*angstrom^2'), symmetry=1, barrier=(7.44251,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.74647,'amu*angstrom^2'), symmetry=1, barrier=(17.1628,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.194712,0.0917257,-0.000143532,1.24604e-07,-4.35819e-11,-40662.1,29.58], Tmin=(100,'K'), Tmax=(769.165,'K')), NASAPolynomial(coeffs=[9.76906,0.0346657,-1.80795e-05,3.58192e-09,-2.52827e-13,-41919.9,-12.7001], Tmin=(769.165,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-339.159,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFF) + group(CsCsFHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cs-F1sF1sCs)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'F[CH][C]=C(F)CC(F)F(10472)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (140.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.546993,0.0823605,-0.000104689,7.21928e-08,-2.03966e-11,-55924.5,27.9579], Tmin=(100,'K'), Tmax=(854.674,'K')), NASAPolynomial(coeffs=[11.3055,0.0320094,-1.63201e-05,3.26305e-09,-2.34095e-13,-57763.5,-22.256], Tmin=(854.674,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-465.97,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(CsCFHH) + group(CdCsCdF) + group(Cds-CdsCsH) + radical(Csj(Cd-CdH)(F1s)(H)) + radical(Cdj(Cs-F1sHH)(Cd-CsF1s))"""),
)

species(
    label = 'F[CH]C[C](F)C(F)=CF(10473)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (140.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.451233,0.0873133,-0.00011699,7.55921e-08,-1.41076e-11,-55718.6,28.2683], Tmin=(100,'K'), Tmax=(599.678,'K')), NASAPolynomial(coeffs=[10.652,0.0332905,-1.69261e-05,3.33368e-09,-2.35352e-13,-57194.1,-17.8299], Tmin=(599.678,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-464.261,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CsCsFHH) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CsCdCsF1s) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)
...
species(
    label = '[CH]=C(F)C(F)(F)C[CH]F(10474)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-398.214,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([274,345,380,539,705,1166,1213,2750,2850,1437.5,1250,1305,750,350,246,474,533,1155,334,575,1197,1424,3202,3120,650,792.5,1650,206.586,206.904,2598.64],'cm^-1')),
        HinderedRotor(inertia=(0.241489,'amu*angstrom^2'), symmetry=1, barrier=(7.05933,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240316,'amu*angstrom^2'), symmetry=1, barrier=(7.00804,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03589,'amu*angstrom^2'), symmetry=1, barrier=(30.7364,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0572232,0.0977018,-0.000157725,1.36394e-07,-4.66464e-11,-47756.1,29.4877], Tmin=(100,'K'), Tmax=(805.089,'K')), NASAPolynomial(coeffs=[10.9129,0.0326007,-1.66874e-05,3.25676e-09,-2.27006e-13,-49179.1,-18.9255], Tmin=(805.089,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-398.214,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(CsCsFHH) + group(CdCsCdF) + group(Cds-CdsHH) + radical(Csj(Cs-CsHH)(F1s)(H)) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
reaction(
    ...
    products = ['F[CH]CC(F)(F)[C]=CF(10422)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(804)', '[CH2]C(F)(F)[C]=CF(508)'],
    products = ['F[CH]CC(F)(F)[C]=CF(10422)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=CF-2(1206)', 'F[CH]C[C](F)F(803)'],
    products = ['F[CH]CC(F)(F)[C]=CF(10422)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'F[CH]CC(F)=C=CF(10466)'],
    products = ['F[CH]CC(F)(F)[C]=CF(10422)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(49.69,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(9.77131,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'C#CC(F)(F)C[CH]F(10467)'],
    products = ['F[CH]CC(F)(F)[C]=CF(10422)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'FC#CC(F)(F)C[CH]F(10468)'],
    products = ['F[CH]CC(F)(F)[C]=CF(10422)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.63131e-11,'m^3/(mol*s)'), n=4.71246, Ea=(9.32597,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'F[CH]C=C(F)[C]=CF(3482)'],
    products = ['F[CH]CC(F)(F)[C]=CF(10422)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(239.49,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)

reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', '[CH2]C(F)(F)[C]=CF(508)'],
    products = ['F[CH]CC(F)(F)[C]=CF(10422)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]CC(F)(F)[C]=CF(10422)'],
    products = ['FC=[C]C(F)(F)[CH]CF(10469)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]CC(F)(F)[C]=CF(10422)'],
    products = ['F[C]=CC(F)(F)C[CH]F(10470)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C]=[C]C(F)(F)CCF(10471)'],
    products = ['F[CH]CC(F)(F)[C]=CF(10422)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[CH]CC(F)(F)[C]=CF(10422)'],
    products = ['F[CH][C]=C(F)CC(F)F(10472)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(194.366,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction22',
    reactants = ['F[CH]CC(F)(F)[C]=CF(10422)'],
    products = ['F[CH]C[C](F)C(F)=CF(10473)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(3.29706e+07,'s^-1'), n=1.15307, Ea=(193.903,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction24',
    reactants = ['[CH]=C(F)C(F)(F)C[CH]F(10474)'],
    products = ['F[CH]CC(F)(F)[C]=CF(10422)'],
