...
"""),
    E0 = (-761.232,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,435,565,619,662,854,1178,1396,298.728,298.738,298.746,298.829],'cm^-1')),
        HinderedRotor(inertia=(0.13522,'amu*angstrom^2'), symmetry=1, barrier=(8.50647,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133304,'amu*angstrom^2'), symmetry=1, barrier=(8.50599,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.17861,'amu*angstrom^2'), symmetry=1, barrier=(11.3169,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.582397,'amu*angstrom^2'), symmetry=1, barrier=(36.8528,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.805716,0.0758188,-9.04545e-05,5.89831e-08,-1.58637e-11,-91444.8,23.8983], Tmin=(100,'K'), Tmax=(893.259,'K')), NASAPolynomial(coeffs=[10.7643,0.031224,-1.55685e-05,3.09318e-09,-2.21495e-13,-93223.9,-23.0221], Tmin=(893.259,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-761.232,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsFFOO)"""),
)
...
"""),
    E0 = (-629.227,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,375,486,586,623,710,938,1161,1294,289.828,289.887,1143.73],'cm^-1')),
        HinderedRotor(inertia=(0.282718,'amu*angstrom^2'), symmetry=1, barrier=(6.50277,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.283559,'amu*angstrom^2'), symmetry=1, barrier=(6.57176,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.774192,'amu*angstrom^2'), symmetry=1, barrier=(17.8203,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45331,0.0559549,-4.98008e-05,2.30813e-08,-4.39254e-12,-75586.9,22.2827], Tmin=(100,'K'), Tmax=(1236.03,'K')), NASAPolynomial(coeffs=[11.362,0.0238889,-1.08868e-05,2.09278e-09,-1.47414e-13,-78036.4,-27.6208], Tmin=(1236.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-629.227,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s))"""),
)
...
"""),
    E0 = (-580.776,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,435,565,619,662,854,1178,1396,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,289.126,289.126,289.126,289.126],'cm^-1')),
        HinderedRotor(inertia=(0.201466,'amu*angstrom^2'), symmetry=1, barrier=(11.951,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.541168,'amu*angstrom^2'), symmetry=1, barrier=(32.1021,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.201466,'amu*angstrom^2'), symmetry=1, barrier=(11.951,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.201466,'amu*angstrom^2'), symmetry=1, barrier=(11.951,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.3727,0.0844683,-0.000115687,8.10399e-08,-2.25065e-11,-69724.7,24.8927], Tmin=(100,'K'), Tmax=(881.193,'K')), NASAPolynomial(coeffs=[13.8448,0.0233136,-1.15865e-05,2.28145e-09,-1.62011e-13,-72099,-38.3984], Tmin=(881.193,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-580.776,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsFFOO) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]COC(F)(F)OF(12940)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-549.643,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,435,565,619,662,854,1178,1396,3000,3100,440,815,1455,1000,244.642,244.652,244.653,244.654],'cm^-1')),
        HinderedRotor(inertia=(0.106393,'amu*angstrom^2'), symmetry=1, barrier=(4.51904,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.374029,'amu*angstrom^2'), symmetry=1, barrier=(15.8867,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.106394,'amu*angstrom^2'), symmetry=1, barrier=(4.51904,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.950608,'amu*angstrom^2'), symmetry=1, barrier=(40.3766,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.509658,0.0827771,-0.000116755,8.72244e-08,-2.61903e-11,-65986.5,25.5896], Tmin=(100,'K'), Tmax=(812.58,'K')), NASAPolynomial(coeffs=[11.8423,0.0269899,-1.37712e-05,2.73088e-09,-1.94172e-13,-67828.2,-26.7314], Tmin=(812.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-549.643,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsFFOO) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'CCO[C](F)OF(12937)'],
    products = ['CCOC(F)(F)OF(12931)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'CCOC([O])(F)F(12938)'],
    products = ['CCOC(F)(F)OF(12931)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['FO[C](F)F(236)', 'CC[O](1010)'],
    products = ['CCOC(F)(F)OF(12931)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(127)', 'CCO[C](F)F(11385)'],
    products = ['CCOC(F)(F)OF(12931)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C[CH]OC(F)(F)OF(12939)'],
    products = ['CCOC(F)(F)OF(12931)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]COC(F)(F)OF(12940)'],
    products = ['CCOC(F)(F)OF(12931)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(78)', 'CCOC(=O)F(12941)'],
    products = ['CCOC(F)(F)OF(12931)'],
