...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(192)', '[CH]C=C(2929)'],
    products = ['[CH]=CC[C]=O(9588)'],
    transitionState = 'TS3',
