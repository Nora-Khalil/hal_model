...
"""),
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3284.79,'J/mol'), sigma=(5.69206,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=513.08 K, Pc=40.41 bar (from Joback method)"""),
...
"""),
    E0 = (-723.563,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,253,522,585,610,849,1160,1215,1402,3025,407.5,1350,352.5,305.296],'cm^-1')),
        HinderedRotor(inertia=(0.110429,'amu*angstrom^2'), symmetry=1, barrier=(7.30365,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.358663,'amu*angstrom^2'), symmetry=1, barrier=(23.7251,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0318,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', '[O]CF(223)'],
    products = ['[O]CC(F)(F)F(513)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.33582e-06,'m^3/(mol*s)'), n=3.3552, Ea=(264.582,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R',), comment="""Estimated from node CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R"""),
)

reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C(F)(F)F(125)'],
    products = ['[O]CC(F)(F)F(513)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O][CH]C(F)(F)F(1227)'],
    products = ['[O]CC(F)(F)F(513)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['FOC[C](F)F(363)'],
    products = ['[O]CC(F)(F)F(513)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(96.7257,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
