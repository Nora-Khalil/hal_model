...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(790)', 'O=C[C]F(4375)'],
    products = ['[O]C(=O)O[C](F)C=O(4298)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)O[C](F)C=O(4298)'],
    products = ['[O]C(=O)OC1(F)[CH]O1(4958)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)O[C](F)C=O(4298)'],
    products = ['O=C[C](F)O[C]1OO1(4959)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)O[C](F)C=O(4298)'],
    products = ['[O][C]1OC(F)(C=O)O1(4960)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C([O])=O(790)', 'O=C[C]F-2(1215)'],
    products = ['[O]C(=O)O[C](F)C=O(4298)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(=O)C([O])C(=O)F(4295)'],
    products = ['[O]C(=O)O[C](F)C=O(4298)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O(6)', '[CH]=C(F)OC([O])=O(4965)'],
    products = ['[O]C(=O)O[C](F)C=O(4298)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(=O)O[C](F)C=O(4298)'],
    products = ['[O]C1([O])OC=C(F)O1(4966)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]C(=O)O[C](F)C=O(4298)'],
    products = ['[O]C(=O)O(1583)', 'O=C=[C]F(580)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', '[O]C(=O)O[C]=C=O(4967)'],
    products = ['[O]C(=O)O[C](F)C=O(4298)'],
