...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.12469,'amu*angstrom^2'), symmetry=1, barrier=(48.8509,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.473984,'amu*angstrom^2'), symmetry=1, barrier=(10.8978,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.12458,'amu*angstrom^2'), symmetry=1, barrier=(48.8482,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
