...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)[CH]OC=[C]F(4588)'],
...
reaction(
    label = 'reaction6',
    reactants = ['O=C(F)[CH]OC=[C]F(4588)'],
    products = ['[O]C1(F)[CH]OC=C1F(4620)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C(F)[CH]OC#CF(4621)'],
    products = ['O=C(F)[CH]OC=[C]F(4588)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=C=COC=[C]F(4622)'],
    products = ['O=C(F)[CH]OC=[C]F(4588)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O(6)', 'F[C]=COC=[C]F(4626)'],
    products = ['O=C(F)[CH]OC=[C]F(4588)'],
