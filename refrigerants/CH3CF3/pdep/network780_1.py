...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(276)', '[CH]C-2(978)'],
    products = ['C[CH]OC([O])(F)F(1804)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'C=COC([O])(F)F(1984)'],
    products = ['C[CH]OC([O])(F)F(1804)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C[CH]OC(=O)F(1985)'],
    products = ['C[CH]OC([O])(F)F(1804)'],
    transitionState = 'TS8',
