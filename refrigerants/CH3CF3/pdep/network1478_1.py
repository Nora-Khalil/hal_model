...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.09272,'amu*angstrom^2'), symmetry=1, barrier=(25.1238,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09093,'amu*angstrom^2'), symmetry=1, barrier=(25.0825,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09107,'amu*angstrom^2'), symmetry=1, barrier=(25.0859,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0252126,0.0950305,-0.000153421,1.30311e-07,-4.38556e-11,-67930.5,29.6694], Tmin=(100,'K'), Tmax=(788.07,'K')), NASAPolynomial(coeffs=[11.8571,0.0286254,-1.49408e-05,2.93968e-09,-2.05971e-13,-69598.2,-23.3439], Tmin=(788.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-565.936,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
"""),
    E0 = (-304.83,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,174,267,591,721,1107,1278,1348,3273,350,440,435,1725,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,298.988,298.988,298.989],'cm^-1')),
        HinderedRotor(inertia=(0.222518,'amu*angstrom^2'), symmetry=1, barrier=(14.1156,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.222518,'amu*angstrom^2'), symmetry=1, barrier=(14.1156,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.453842,'amu*angstrom^2'), symmetry=1, barrier=(28.7899,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.149308,0.0951982,-0.000138871,1.00551e-07,-2.83569e-11,-36516.7,30.2734], Tmin=(100,'K'), Tmax=(874.737,'K')), NASAPolynomial(coeffs=[16.3803,0.0196101,-9.24949e-06,1.76102e-09,-1.22067e-13,-39408.5,-47.2599], Tmin=(874.737,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-304.83,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2sCF) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=C(C)OJ) + radical(Csj(Cs-F1sCdH)(F1s)(H))"""),
)

species(
    label = 'O=C(F)[CH]OC(F)[CH]F(4354)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-435.978,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,234,347,1316,1464,334,575,1197,1424,3202,2782.5,750,1395,475,1775,1000,289.952,290.445],'cm^-1')),
        HinderedRotor(inertia=(0.153011,'amu*angstrom^2'), symmetry=1, barrier=(9.14662,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.333841,'amu*angstrom^2'), symmetry=1, barrier=(20.5289,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.870356,'amu*angstrom^2'), symmetry=1, barrier=(50.1095,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00625,0.0713575,-9.70139e-05,7.16959e-08,-2.15697e-11,-52333.2,25.4788], Tmin=(100,'K'), Tmax=(807.18,'K')), NASAPolynomial(coeffs=[10.0802,0.0263894,-1.34449e-05,2.67143e-09,-1.9042e-13,-53798,-16.3535], Tmin=(807.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-435.978,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsH) + radical(CsCOCsF1s) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.373058,0.0871281,-0.000127919,9.6751e-08,-2.80303e-11,-104339,26.579], Tmin=(100,'K'), Tmax=(667.695,'K')), NASAPolynomial(coeffs=[11.748,0.0277342,-1.41478e-05,2.78332e-09,-1.96129e-13,-106053,-25.1648], Tmin=(667.695,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-868.55,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-OdCsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F))"""),
)

species(
    label = 'F[CH]C(F)C1(F)[CH]OO1(4895)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.161542,'amu*angstrom^2'), symmetry=1, barrier=(3.71416,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.01559,'amu*angstrom^2'), symmetry=1, barrier=(23.3503,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01588,'amu*angstrom^2'), symmetry=1, barrier=(23.3572,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16914,0.0690885,-9.27041e-05,6.34053e-08,-1.48383e-11,-54214.8,24.1554], Tmin=(100,'K'), Tmax=(618.372,'K')), NASAPolynomial(coeffs=[9.09954,0.027151,-1.36826e-05,2.69301e-09,-1.90334e-13,-55374.6,-11.7395], Tmin=(618.372,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-451.562,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(CdCFH) + radical(C=OCOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.1973,'amu*angstrom^2'), symmetry=1, barrier=(27.5283,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.773462,'amu*angstrom^2'), symmetry=1, barrier=(17.7834,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (139.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.382577,0.0873126,-0.000144716,1.2564e-07,-4.27324e-11,-75025.3,27.3025], Tmin=(100,'K'), Tmax=(818.712,'K')), NASAPolynomial(coeffs=[10.5047,0.0268744,-1.38597e-05,2.6981e-09,-1.87254e-13,-76314.6,-17.2582], Tmin=(818.712,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-624.817,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-OdCsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(C=OCOJ)"""),
)
...
"""),
    E0 = (-241.288,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2995,3025,975,1000,1300,1375,400,500,1630,1680,194,682,905,1196,1383,3221,180,180,180],'cm^-1')),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.09873,'amu*angstrom^2'), symmetry=1, barrier=(25.262,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.250103,0.0736579,-8.94173e-05,5.05393e-08,-1.07706e-11,-49344.4,24.8082], Tmin=(100,'K'), Tmax=(1209.67,'K')), NASAPolynomial(coeffs=[20.4071,0.00461011,-8.27697e-07,7.95629e-11,-3.96924e-15,-54045.9,-75.55], Tmin=(1209.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-411.459,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(CdCCF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(C=C(C)OJ) + radical(C=COJ)"""),
)
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.159958,0.101902,-0.000177721,1.58782e-07,-5.4913e-11,-74332.2,31.5616], Tmin=(100,'K'), Tmax=(828.202,'K')), NASAPolynomial(coeffs=[11.0385,0.0302679,-1.62002e-05,3.18126e-09,-2.21062e-13,-75585.3,-16.7204], Tmin=(828.202,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-619.195,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsH) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = 'O=[C]C(O)(F)C(F)[CH]F(4903)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0638591,0.0977626,-0.00015063,1.12365e-07,-3.06073e-11,-78003.4,30.0565], Tmin=(100,'K'), Tmax=(660.547,'K')), NASAPolynomial(coeffs=[14.2311,0.0240675,-1.25042e-05,2.45337e-09,-1.71685e-13,-80172.6,-35.1056], Tmin=(660.547,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-649.709,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsH) + radical(Csj(Cs-F1sCsH)(F1s)(H)) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C(F)([C]=O)C(F)CF(4904)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-301.172,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,174,267,591,721,1107,1278,1348,3273,350,440,435,1725,334,575,1197,1424,3202,3010,987.5,1337.5,450,1655,300.095,300.095,300.101],'cm^-1')),
        HinderedRotor(inertia=(0.320313,'amu*angstrom^2'), symmetry=1, barrier=(20.4699,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.32028,'amu*angstrom^2'), symmetry=1, barrier=(20.47,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.437755,'amu*angstrom^2'), symmetry=1, barrier=(27.9753,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0409004,0.0904338,-0.000121477,8.08302e-08,-2.10784e-11,-36082.9,29.5038], Tmin=(100,'K'), Tmax=(941.205,'K')), NASAPolynomial(coeffs=[16.4685,0.0206178,-1.02099e-05,2.01708e-09,-1.43961e-13,-39175.2,-48.7541], Tmin=(941.205,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-301.172,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Csj(Cs-F1sCdH)(F1s)(H))"""),
)

species(
    label = '[O]C=C([O])C(F)C(F)F(4906)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-292.471,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,2782.5,750,1395,475,1775,1000,334,575,1197,1424,3202,286.998,287.007,287.011],'cm^-1')),
        HinderedRotor(inertia=(0.213983,'amu*angstrom^2'), symmetry=1, barrier=(12.5091,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.540002,'amu*angstrom^2'), symmetry=1, barrier=(31.5674,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.387567,'amu*angstrom^2'), symmetry=1, barrier=(22.6569,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.539996,'amu*angstrom^2'), symmetry=1, barrier=(31.5676,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.184523,0.0911051,-0.000137195,1.08473e-07,-3.43457e-11,-35045.4,30.9738], Tmin=(100,'K'), Tmax=(772.53,'K')), NASAPolynomial(coeffs=[12.341,0.0281609,-1.49775e-05,3.00236e-09,-2.1403e-13,-36923.6,-24.5368], Tmin=(772.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-292.471,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsCsHH) + group(CsCsFHH) + group(Cds-OdCsH) + radical(CCJCO) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)

species(
    label = '[O]C(F)([CH]C(F)F)C=O(4424)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(C=O)C(F)[CH]F(4353)'],
...
reaction(
    ...
    products = ['[O]C(F)(C=O)C(F)[CH]F(4353)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(=COF)C(F)[CH]F(4893)'],
    products = ['[O]C(F)(C=O)C(F)[CH]F(4353)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(F)(C=O)C(F)[CH]F(4353)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4354)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'O=C[C](F)C(F)[CH]F(4215)'],
    products = ['[O]C(F)(C=O)C(F)[CH]F(4353)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]F(804)', '[O]C(F)([CH]F)C=O(4546)'],
    products = ['[O]C(F)(C=O)C(F)[CH]F(4353)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)(C=O)C(F)[CH]F(4353)'],
    products = ['O=CC1(F)OC(F)C1F(4357)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)(C=O)C(F)[CH]F(4353)'],
    products = ['F[CH]C(F)C1(F)[CH]OO1(4895)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)(C=O)C(F)[CH]F(4353)'],
    products = ['[O]C1(F)[CH]OC(F)C1F(4865)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(F)(C=O)C(F)[CH]F(4353)'],
    products = ['[O]C1OC1(F)C(F)[CH]F(4896)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O=CC(=O)C(F)[CH]F(4898)'],
    products = ['[O]C(F)(C=O)C(F)[CH]F(4353)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HCO(15)', 'O=C(F)C(F)[CH]F(844)'],
    products = ['[O]C(F)(C=O)C(F)[CH]F(4353)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[O]C(F)(C=O)C=CF(4899)'],
    products = ['[O]C(F)(C=O)C(F)[CH]F(4353)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C(F)(C=O)C(F)=CF(4843)'],
    products = ['[O]C(F)(C=O)C(F)[CH]F(4353)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(78)', '[O]C=C([O])C=CF(4900)'],
    products = ['[O]C(F)(C=O)C(F)[CH]F(4353)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', '[O]C=C([O])C(F)=CF(4844)'],
    products = ['[O]C(F)(C=O)C(F)[CH]F(4353)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CHF(40)', '[O]C(F)([CH]F)C=O(4546)'],
    products = ['[O]C(F)(C=O)C(F)[CH]F(4353)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O]C(F)(C=O)C(F)[CH]F(4353)'],
    products = ['[O]C(F)(C=O)[C](F)CF(4486)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C(F)(C=O)C(F)[CH]F(4353)'],
    products = ['O=CC(O)(F)[C](F)[CH]F(4902)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[O]C(F)(C=O)C(F)[CH]F(4353)'],
    products = ['O=[C]C(O)(F)C(F)[CH]F(4903)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[O]C(F)(C=O)C(F)[CH]F(4353)'],
    products = ['[O]C(F)([C]=O)C(F)CF(4904)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[O]C=C(OF)C(F)[CH]F(4905)'],
    products = ['[O]C(F)(C=O)C(F)[CH]F(4353)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[O]C(F)(C=O)C(F)[CH]F(4353)'],
    products = ['[O]C=C([O])C(F)C(F)F(4906)'],
...
reaction(
    label = 'reaction30',
    reactants = ['O=CC(F)([CH][CH]F)OF(4907)'],
    products = ['[O]C(F)(C=O)C(F)[CH]F(4353)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[O]C(F)(C=O)C(F)[CH]F(4353)'],
    products = ['[O]C(F)([CH]C(F)F)C=O(4424)'],
