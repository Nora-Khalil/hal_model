...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(O)C([O])=O(8701)'],
    products = ['C=C(O)C(=O)OF(8632)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', 'C=[C]C(=O)OF(8702)'],
    products = ['C=C(O)C(=O)OF(8632)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(127)', 'C=C(O)[C]=O(8704)'],
    products = ['C=C(O)C(=O)OF(8632)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]OF(458)', 'C=[C]O(982)'],
    products = ['C=C(O)C(=O)OF(8632)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH]=C(O)C(=O)OF(8705)'],
    products = ['C=C(O)C(=O)OF(8632)'],
