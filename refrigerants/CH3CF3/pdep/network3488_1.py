...
reaction(
    label = 'reaction2',
    reactants = ['FOF(328)', 'CO(13)'],
    products = ['O=C(F)OF(11661)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(0.00148453,'m^3/(mol*s)'), n=2.83796, Ea=(102.59,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.2632766423807829, var=145.9379134136138, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-1COCbCdCsCtHNOSSidSis->Cs',), comment="""Estimated from node Root_N-1COCbCdCsCtHNOSSidSis->Cs
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'O=[C]OF(458)'],
    products = ['O=C(F)OF(11661)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F2(78)', 'CO2(14)'],
    products = ['O=C(F)OF(11661)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(0.000237309,'m^3/(mol*s)'), n=2.63647, Ea=(122.44,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
