...
"""),
    E0 = (-647.557,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,431,527,613,668,835,1199,1245,1322,90,150,250,247,323,377,431,433,1065,1274],'cm^-1')),
        HinderedRotor(inertia=(0.000886634,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000886665,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0598705,'amu*angstrom^2'), symmetry=1, barrier=(8.0775,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.302989,'amu*angstrom^2'), symmetry=1, barrier=(40.883,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.303033,'amu*angstrom^2'), symmetry=1, barrier=(40.8831,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.377684,0.0852923,-0.000109797,7.19924e-08,-1.89151e-11,-77757.4,31.7177], Tmin=(100,'K'), Tmax=(924.12,'K')), NASAPolynomial(coeffs=[14.0227,0.0262303,-1.3929e-05,2.83235e-09,-2.0529e-13,-80279.4,-33.0349], Tmin=(924.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-647.557,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CsFFFO) + radical(CsCCl_triplet)"""),
)
...
"""),
    E0 = (-597.601,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([431,527,613,668,835,1199,1245,1322,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (131.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2651,0.0581757,-5.97229e-05,3.00697e-08,-5.9858e-12,-71774.6,25.7253], Tmin=(100,'K'), Tmax=(1214.36,'K')), NASAPolynomial(coeffs=[14.0434,0.0160842,-7.72987e-06,1.52581e-09,-1.09367e-13,-74878.1,-38.4044], Tmin=(1214.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-597.601,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsFFFO) + group(Cs-OsHHH) + radical(CsJOO)"""),
)
...
"""),
    E0 = (-1043.77,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([431,527,613,668,835,1199,1245,1322,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.420158,0.0831564,-0.000100001,6.04761e-08,-1.46455e-11,-125412,34.2267], Tmin=(100,'K'), Tmax=(998.962,'K')), NASAPolynomial(coeffs=[14.8068,0.0255515,-1.35065e-05,2.75439e-09,-2.00381e-13,-128286,-35.1658], Tmin=(998.962,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1043.77,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(CsFFFO) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = 'F[C](F)COOO[C](F)F(11966)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = 'F[C](F)[CH]OOOC(F)(F)F(11967)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-849.723,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([431,527,613,668,835,1199,1245,1322,3025,407.5,1350,352.5,190,488,555,1236,1407,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (180.03,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.304362,0.102539,-0.000156115,1.20946e-07,-3.71841e-11,-102050,36.3932], Tmin=(100,'K'), Tmax=(797.361,'K')), NASAPolynomial(coeffs=[14.6308,0.0276078,-1.51373e-05,3.06261e-09,-2.19358e-13,-104432,-32.2768], Tmin=(797.361,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-849.723,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CsFFFO) + radical(CCsJOO) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = 'F[C]COOOC(F)(F)F-2(11968)',
    structure = adjacencyList("""1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.484008,0.0810957,-9.87633e-05,6.0921e-08,-1.50098e-11,-78251,33.024], Tmin=(100,'K'), Tmax=(984.812,'K')), NASAPolynomial(coeffs=[14.4338,0.024437,-1.24666e-05,2.50392e-09,-1.80662e-13,-80998.7,-34.0627], Tmin=(984.812,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-651.643,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(CsFFFO) + group(CJ2_singlet-FCs)"""),
)

species(
    label = 'FC(F)[CH]OOOC(F)(F)F(11969)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)COOOC(F)(F)F(9704)'],
    products = ['[O]OC(F)(F)F(511)', 'FC1(F)CO1(165)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'FOOOC[C](F)F(11963)'],
    products = ['F[C](F)COOOC(F)(F)F(9704)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'F[C]COOOC(F)(F)F(11964)'],
    products = ['F[C](F)COOOC(F)(F)F(9704)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(138)', '[CH2]OOOC(F)(F)F(8618)'],
    products = ['F[C](F)COOOC(F)(F)F(9704)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C](F)COOOC(F)(F)F(9704)'],
    products = ['CF3O(48)', 'FC1(F)COO1(164)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]OOC(F)(F)F(8865)', 'CH2CF2(57)'],
    products = ['F[C](F)COOOC(F)(F)F(9704)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'FC(F)=COOOC(F)(F)F(11965)'],
    products = ['F[C](F)COOOC(F)(F)F(9704)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'F[C](F)COOO[C](F)F(11966)'],
    products = ['F[C](F)COOOC(F)(F)F(9704)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]OC(F)(F)F(511)', '[O]C[C](F)F(174)'],
    products = ['F[C](F)COOOC(F)(F)F(9704)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]OOC(F)(F)F(8865)', '[CH2][C](F)F(141)'],
    products = ['F[C](F)COOOC(F)(F)F(9704)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CF3O(48)', '[O]OC[C](F)F(131)'],
    products = ['F[C](F)COOOC(F)(F)F(9704)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF3(45)', '[O]OOC[C](F)F(638)'],
    products = ['F[C](F)COOOC(F)(F)F(9704)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'F[C](F)[CH]OOOC(F)(F)F(11967)'],
    products = ['F[C](F)COOOC(F)(F)F(9704)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'F[C]COOOC(F)(F)F-2(11968)'],
    products = ['F[C](F)COOOC(F)(F)F(9704)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', '[CH2]OOOC(F)(F)F(8618)'],
    products = ['F[C](F)COOOC(F)(F)F(9704)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C](F)COOOC(F)(F)F(9704)'],
    products = ['FC(F)[CH]OOOC(F)(F)F(11969)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[C](F)OOOCC(F)(F)F(952)'],
    products = ['F[C](F)COOOC(F)(F)F(9704)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(4.94559e+07,'s^-1'), n=1.15307, Ea=(191.494,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF
...
network(
    ...
    isomers = [
        'F[C](F)COOOC(F)(F)F(9704)',
    ],
    reactants = [
        ('[O]OC(F)(F)F(511)', 'FC1(F)CO1(165)'),
        ('[O]OC(F)(F)F(511)', '[O]C[C](F)F(174)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
