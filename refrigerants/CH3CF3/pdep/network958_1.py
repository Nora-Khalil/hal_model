...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.445546,0.0761161,-9.39803e-05,5.60351e-08,-1.29003e-11,-80273.3,22.0493], Tmin=(100,'K'), Tmax=(1071.41,'K')), NASAPolynomial(coeffs=[17.3441,0.0130269,-5.65357e-06,1.07514e-09,-7.60266e-14,-83894.4,-60.6419], Tmin=(1071.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-668.51,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(CdCCF) + group(Cds-CdsHH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F))"""),
)

species(
    label = 'F[C](F)C(F)[C]1CO1(2654)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.856388,'amu*angstrom^2'), symmetry=1, barrier=(19.69,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.85664,'amu*angstrom^2'), symmetry=1, barrier=(19.6958,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.856532,'amu*angstrom^2'), symmetry=1, barrier=(19.6934,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.648198,0.0767402,-0.000100451,6.53666e-08,-1.67365e-11,-42159.6,25.7549], Tmin=(100,'K'), Tmax=(956.119,'K')), NASAPolynomial(coeffs=[14.5216,0.0186991,-9.39214e-06,1.87401e-09,-1.34658e-13,-44812.5,-40.5534], Tmin=(956.119,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-351.518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Csj(Cs-F1sCdH)(F1s)(F1s)) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C([O])C(F)C(F)F(2661)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.614719,'amu*angstrom^2'), symmetry=1, barrier=(14.1336,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.740381,'amu*angstrom^2'), symmetry=1, barrier=(17.0228,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.811418,0.0742435,-9.97297e-05,6.92963e-08,-1.91668e-11,-50044.5,24.8621], Tmin=(100,'K'), Tmax=(883.387,'K')), NASAPolynomial(coeffs=[12.3929,0.0218018,-1.06825e-05,2.09453e-09,-1.48488e-13,-52090.7,-29.5759], Tmin=(883.387,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-417.019,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C(=C[C](F)F)OF(2662)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.895206,0.066722,-7.89161e-05,4.71468e-08,-1.10083e-11,-70894.4,24.7338], Tmin=(100,'K'), Tmax=(1052.42,'K')), NASAPolynomial(coeffs=[14.3042,0.0157569,-6.27521e-06,1.13105e-09,-7.72029e-14,-73716.8,-40.6418], Tmin=(1052.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-590.391,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(CsCdFFF) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=C(C)OJ) + radical(C=C(O)CJ)"""),
)

species(
    label = 'O=[C]CC(F)[C](F)F(2329)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.862,0.052327,-5.18254e-05,3.01223e-08,-7.7456e-12,-81389.1,21.2089], Tmin=(100,'K'), Tmax=(898.543,'K')), NASAPolynomial(coeffs=[6.76655,0.0304939,-1.53781e-05,3.08079e-09,-2.21933e-13,-82270.5,-1.92807], Tmin=(898.543,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-677.31,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)HHH) + group(Cds-O2d(Cds-Cds)Cs) + group(CdCCF) + longDistanceInteraction_noncyclic(Cd(F)-CO) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F))"""),
)

species(
    label = '[CH2][C]1OC(F)(F)C1F(2665)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(138)', '[CH2]C(=O)[CH]F(2651)'],
    products = ['C=C([O])C(F)[C](F)F(2325)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'C=[C]C(F)[C](F)F(2652)'],
    products = ['C=C([O])C(F)[C](F)F(2325)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['C=C([O])C(F)[C](F)F(2325)'],
    products = ['F[C](F)C(F)[C]1CO1(2654)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C([O])C=C(F)F(1715)'],
    products = ['C=C([O])C(F)[C](F)F(2325)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C([O])C(F)=C(F)F(2657)'],
    products = ['C=C([O])C(F)[C](F)F(2325)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(43)', '[CH2]C(=O)[CH]F(2651)'],
    products = ['C=C([O])C(F)[C](F)F(2325)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=C([O])C(F)[C](F)F(2325)'],
    products = ['[CH2]C(O)=C(F)[C](F)F(2659)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=C(O)C(F)[C](F)F(2660)'],
    products = ['C=C([O])C(F)[C](F)F(2325)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=C([O])C(F)C(F)F(2661)'],
    products = ['C=C([O])C(F)[C](F)F(2325)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(=C[C](F)F)OF(2662)'],
    products = ['C=C([O])C(F)[C](F)F(2325)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C=C([O])C(F)[C](F)F(2325)'],
    products = ['[CH2]C([O])=CC(F)(F)F(2663)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(T)(18)', 'O=[C]C(F)[C](F)F(1302)'],
    products = ['C=C([O])C(F)[C](F)F(2325)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C=C([O])C(F)[C](F)F(2325)'],
    products = ['[CH2][C]1OC(F)(F)C1F(2665)'],
...
network(
    label = 'PDepNetwork #958',
    isomers = [
        'C=C([O])C(F)[C](F)F(2325)',
    ],
    reactants = [
        ('CHFCF2(55)', 'CH2CO(28)'),
    ],
