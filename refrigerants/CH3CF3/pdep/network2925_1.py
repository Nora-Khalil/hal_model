...
reaction(
    label = 'reaction3',
    reactants = ['FOF(328)', 'O=C=C(O)O(9864)'],
    products = ['O=C(OF)C(O)(O)F(9860)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=C(OF)[C](O)O(9869)'],
    products = ['O=C(OF)C(O)(O)F(9860)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(=O)C(O)(O)F(9870)'],
    products = ['O=C(OF)C(O)(O)F(9860)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', 'O=C(OF)[C](O)F(1846)'],
    products = ['O=C(OF)C(O)(O)F(9860)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(O)(F)C(=O)OF(9871)'],
    products = ['O=C(OF)C(O)(O)F(9860)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(127)', 'O=[C]C(O)(O)F(9872)'],
    products = ['O=C(OF)C(O)(O)F(9860)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]OF(458)', 'O[C](O)F(8763)'],
    products = ['O=C(OF)C(O)(O)F(9860)'],
