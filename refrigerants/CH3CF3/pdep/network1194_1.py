...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C=C=O(3261)'],
    products = ['[CH]=CC([O])=O(3137)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['[O][C]=O(722)', '[CH]=[CH](1000)'],
    products = ['[CH]=CC([O])=O(3137)'],
