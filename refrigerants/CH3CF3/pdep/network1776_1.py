...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(804)', '[O]C[C]=O(907)'],
    products = ['O=[C]CO[CH]F(6192)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(192)', '[CH2]O[CH]F(850)'],
    products = ['O=[C]CO[CH]F(6192)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[CH2]O[CH]F(850)'],
    products = ['O=[C]CO[CH]F(6192)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C=CO[CH]F(6199)'],
    products = ['O=[C]CO[CH]F(6192)'],
    transitionState = 'TS9',
