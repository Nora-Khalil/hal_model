...
"""),
    ...
    molecularWeight = (90.0713,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.94493,0.00320452,0.000108279,-1.92527e-07,1.06562e-10,-30104.2,10.1557], Tmin=(10,'K'), Tmax=(552.703,'K')), NASAPolynomial(coeffs=[0.0303735,0.0426315,-2.88392e-05,9.18907e-09,-1.10924e-12,-29841,25.1868], Tmin=(552.703,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-250.299,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), label="""FC1CDCC1F""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'C=CC(F)=CF(8542)',
    structure = adjacencyList("""1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (90.0713,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.88803,0.00675961,0.000129122,-2.65383e-07,1.63021e-10,-33039.4,10.7291], Tmin=(10,'K'), Tmax=(543.423,'K')), NASAPolynomial(coeffs=[2.82468,0.0389617,-2.70465e-05,8.74405e-09,-1.06274e-12,-33283.8,11.8992], Tmin=(543.423,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-274.748,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), label="""CDCC(F)DCF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (152.38,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,194,682,905,1196,1383,3221,3120,650,792.5,1650],'cm^-1')),
        HinderedRotor(inertia=(1.30524,'amu*angstrom^2'), symmetry=1, barrier=(30.01,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0728,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.90346,0.00565014,0.000105585,-2.09933e-07,1.23977e-10,18332.3,9.83837], Tmin=(10,'K'), Tmax=(571.491,'K')), NASAPolynomial(coeffs=[3.33942,0.0319167,-2.19375e-05,7.1634e-09,-8.86198e-13,18032.3,9.05521], Tmin=(571.491,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(152.38,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), label="""[CH]DCCDCF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    molecularWeight = (90.0713,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.37904,0.0399434,-2.31523e-05,6.47808e-09,-7.57212e-13,-4228.33,18.5239], Tmin=(100,'K'), Tmax=(1759.02,'K')), NASAPolynomial(coeffs=[8.19448,0.026719,-1.18752e-05,2.20402e-09,-1.49757e-13,-6274.21,-12.8165], Tmin=(1759.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-35.6023,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(AllylJ2_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.727185,'amu*angstrom^2'), symmetry=1, barrier=(16.7194,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.726547,'amu*angstrom^2'), symmetry=1, barrier=(16.7047,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0713,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47798,0.0617571,-9.90644e-05,8.87303e-08,-3.12792e-11,9801.13,17.3081], Tmin=(100,'K'), Tmax=(821.326,'K')), NASAPolynomial(coeffs=[6.85754,0.0248678,-1.21697e-05,2.35133e-09,-1.63126e-13,9278.01,-5.39138], Tmin=(821.326,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(80.7866,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cdj(Cs-F1sCsH)(Cd-HH)) + radical(Cds_P)"""),
)
...
"""),
    E0 = (-67.157,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([171,205,598,1104,1143,1317,1411,3153,2995,3025,975,1000,1300,1375,400,500,1630,1680,358.386,364.283,365.132,365.546],'cm^-1')),
        HinderedRotor(inertia=(0.581393,'amu*angstrom^2'), symmetry=1, barrier=(51.5727,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.539836,'amu*angstrom^2'), symmetry=1, barrier=(51.7381,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0713,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.30647,0.0418718,-2.81084e-05,1.06806e-08,-1.91517e-12,-8020.11,18.4604], Tmin=(100,'K'), Tmax=(1145.4,'K')), NASAPolynomial(coeffs=[5.26175,0.0315513,-1.45929e-05,2.81408e-09,-1.98195e-13,-8697.11,3.80171], Tmin=(1145.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-67.157,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(AllylJ2_triplet)"""),
)

species(
    label = 'F[CH]C=C[CH]F(890)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  C u0 p0 c0 {4,D} {5,S} {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC(F)[CH]F(8539)'],
    products = ['C2H2(23)', 'CHFCHF[Z](59)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(804)', '[CH]C=CF(6397)'],
    products = ['[CH]=CC(F)[CH]F(8539)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[CH]=C=C[CH]F(883)'],
    products = ['[CH]=CC(F)[CH]F(8539)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(295.851,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', '[CH]C=CF(6397)'],
    products = ['[CH]=CC(F)[CH]F(8539)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=CC(F)[CH]F(8539)'],
    products = ['[CH]C=CC(F)F(2933)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(1.00763e+12,'s^-1'), n=0.18834, Ea=(133.181,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C"""),
)

reaction(
    label = 'reaction18',
    reactants = ['[CH]=CC(F)[CH]F(8539)'],
    products = ['F[CH]C=C[CH]F(890)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(153.035,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
