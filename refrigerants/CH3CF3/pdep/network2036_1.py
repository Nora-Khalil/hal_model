...
reaction(
    label = 'reaction1',
    reactants = ['CF3(45)', 'CO2(14)'],
    products = ['O=[C]OC(F)(F)F(2050)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(122.376,'m^3/(mol*s)'), n=1.29312, Ea=(56.8998,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.28976280499384915, var=2.1569028208455543, Tref=1000.0, N=37, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-3C-R_2R!H->C',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-3C-R_2R!H->C
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'O=[C]OF(458)'],
    products = ['O=[C]OC(F)(F)F(2050)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(18.5533,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction3',
    reactants = ['[C]=O(192)', 'CF3O(48)'],
    products = ['O=[C]OC(F)(F)F(2050)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CO(13)', 'CF3O(48)'],
    products = ['O=[C]OC(F)(F)F(2050)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(34.1,'m^3/(mol*s)'), n=8.73864e-09, Ea=(8.37703,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->O',), comment="""Estimated from node Root_3R->O"""),
)

reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'O=[C]O[C](F)F(726)'],
    products = ['O=[C]OC(F)(F)F(2050)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['O=C(F)O[C](F)F(380)'],
    products = ['O=[C]OC(F)(F)F(2050)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(212.296,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
