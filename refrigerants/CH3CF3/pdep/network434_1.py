...
reaction(
    label = 'reaction1',
    reactants = ['CF2(43)', 'O=C[C](F)F(179)'],
    products = ['O=CC(F)(F)[C](F)F(1251)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['FO[CH]C(F)=C(F)F(1740)'],
    products = ['O=CC(F)(F)[C](F)F(1251)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O=CC(F)(F)[C]F(1741)'],
    products = ['O=CC(F)(F)[C](F)F(1251)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(138)', 'O=C[C](F)F(179)'],
    products = ['O=CC(F)(F)[C](F)F(1251)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O=CC(F)(F)[C](F)F(1251)'],
    products = ['FC1(F)[CH]OC1(F)F(1742)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O=CC(F)(F)[C](F)F(1251)'],
    products = ['[O]C1C(F)(F)C1(F)F(1252)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=CC(F)=C(F)F(987)'],
    products = ['O=CC(F)(F)[C](F)F(1251)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C=C(F)[C](F)F(1743)'],
    products = ['O=CC(F)(F)[C](F)F(1251)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HCO(15)', 'F[C](F)[C](F)F(1586)'],
    products = ['O=CC(F)(F)[C](F)F(1251)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=[C]C(F)(F)[C](F)F(1744)'],
    products = ['O=CC(F)(F)[C](F)F(1251)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'O=CC(F)(F)[C]F-2(1746)'],
    products = ['O=CC(F)(F)[C](F)F(1251)'],
