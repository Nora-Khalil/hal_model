...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', '[CH2]C([O])(F)F(162)'],
    products = ['[O]C(F)(F)C[C](F)F(243)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[C](F)C[C](F)F(146)'],
    products = ['[O]C(F)(F)C[C](F)F(243)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)(F)C=C(F)F(268)'],
    products = ['[O]C(F)(F)C[C](F)F(243)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C(F)C[C](F)F(269)'],
    products = ['[O]C(F)(F)C[C](F)F(243)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['CF2(43)', '[CH2]C([O])(F)F(162)'],
    products = ['[O]C(F)(F)C[C](F)F(243)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C(F)(F)[CH]C(F)F(271)'],
    products = ['[O]C(F)(F)C[C](F)F(243)'],
