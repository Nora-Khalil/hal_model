...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)O[C](F)F(10143)'],
...
reaction(
    ...
    products = ['[CH2]C(F)O[C](F)F(10143)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=CO[C](F)F(1925)'],
    products = ['[CH2]C(F)O[C](F)F(10143)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=C(F)O[C](F)F(281)'],
    products = ['[CH2]C(F)O[C](F)F(10143)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)O[C](F)F(10143)'],
    products = ['[CH2][CH]OC(F)(F)F(10183)'],
