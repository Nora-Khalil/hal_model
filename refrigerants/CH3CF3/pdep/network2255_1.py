...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'OCO(761)'],
    products = ['OCOC(F)F(7904)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)F(207)', 'CH2OH(33)'],
    products = ['OCOC(F)F(7904)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O[CH]OC(F)F(8149)'],
    products = ['OCOC(F)F(7904)'],
    transitionState = 'TS9',
