...
species(
    label = 'FC=[C]C(F)(F)C(F)[C](F)F(7263)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'FC=[C]C(F)(F)[CH]C(F)(F)C(F)F(7761)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1052.39,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,136,307,446,511,682,757,1180,1185,235,523,627,1123,1142,1372,1406,3097,3025,407.5,1350,352.5,615,860,1140,1343,3152,1685,370,180,180,180,1103.83],'cm^-1')),
        HinderedRotor(inertia=(0.246066,'amu*angstrom^2'), symmetry=1, barrier=(5.65755,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.246066,'amu*angstrom^2'), symmetry=1, barrier=(5.65755,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.246026,'amu*angstrom^2'), symmetry=1, barrier=(5.65663,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.246082,'amu*angstrom^2'), symmetry=1, barrier=(5.6579,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (208.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.74807,0.141494,-0.000246367,2.23787e-07,-7.92343e-11,-126381,42.1647], Tmin=(100,'K'), Tmax=(810.503,'K')), NASAPolynomial(coeffs=[12.5874,0.0464352,-2.54516e-05,5.06987e-09,-3.56115e-13,-127907,-19.0578], Tmin=(810.503,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1052.39,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCCFF) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cs_S) + radical(Cdj(Cs-F1sF1sCs)(Cd-F1sH))"""),
)
...
species(
    label = 'F[C](F)C([C](F)F)C(F)F(5681)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'FC=CC(F)(F)C(=C(F)F)C(F)F(7763)',
...
species(
    label = 'FC=[C]C(F)(F)C(=C(F)F)C(F)F(7764)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.997365,'amu*angstrom^2'), symmetry=1, barrier=(22.9314,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.9973,'amu*angstrom^2'), symmetry=1, barrier=(22.9299,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.997683,'amu*angstrom^2'), symmetry=1, barrier=(22.9387,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (207.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.51969,0.136437,-0.000241152,2.1977e-07,-7.75284e-11,-134644,38.4161], Tmin=(100,'K'), Tmax=(821.771,'K')), NASAPolynomial(coeffs=[12.2097,0.0434748,-2.37604e-05,4.71044e-09,-3.29306e-13,-136018,-19.756], Tmin=(821.771,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1121.03,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(CsCFFH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(CdCFF) + group(CdCFH) + radical(Cds_S)"""),
)
...
species(
    label = 'FC=C=C(F)C([C](F)F)C(F)F(7765)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-890.744,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,145,326,398,834,1303,190,488,555,1236,1407,113,247,382,1207,3490,540,610,2055,305.268,305.27,305.27,305.271],'cm^-1')),
        HinderedRotor(inertia=(0.00180902,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00180898,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00180898,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.772736,0.117169,-0.000169104,1.16367e-07,-2.54727e-11,-106971,36.3785], Tmin=(100,'K'), Tmax=(609.466,'K')), NASAPolynomial(coeffs=[14.262,0.037458,-1.95961e-05,3.88148e-09,-2.73982e-13,-109156,-31.6003], Tmin=(609.466,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-890.744,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cdd-Cd)CsCsH) + group(CsCsFFH) + group(CsCsFFH) + group(CdCddCF) + group(CdCddFH) + group(Cdd-CdsCds) + radical(CsCsF1sF1s)"""),
)
...
species(
    label = 'C#CC(F)(F)C([C](F)F)C(F)F(7766)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-956.448,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,154,355,414,641,686,1150,1196,235,523,627,1123,1142,1372,1406,3097,190,488,555,1236,1407,2175,525,750,770,3400,2100,208.786,213.713,215.511],'cm^-1')),
        HinderedRotor(inertia=(0.286847,'amu*angstrom^2'), symmetry=1, barrier=(9.28859,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.277392,'amu*angstrom^2'), symmetry=1, barrier=(9.27159,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.895483,'amu*angstrom^2'), symmetry=1, barrier=(29.034,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.7647,'amu*angstrom^2'), symmetry=1, barrier=(55.9857,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (189.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.4383,0.12906,-0.000208981,1.74246e-07,-5.70222e-11,-114847,36.1061], Tmin=(100,'K'), Tmax=(812.399,'K')), NASAPolynomial(coeffs=[15.9754,0.0343061,-1.73841e-05,3.36051e-09,-2.32473e-13,-117379,-42.4564], Tmin=(812.399,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-956.448,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCCFF) + group(CsCsFFH) + group(CsCsFFH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Csj(Cs-CsCsH)(F1s)(F1s))"""),
)

species(
    label = 'FC#CC(F)(F)C([C](F)F)C(F)F(7767)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-1056.21,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,154,355,414,641,686,1150,1196,235,523,627,1123,1142,1372,1406,3097,190,488,555,1236,1407,2175,525,239,401,1367,279.245,279.259,279.281,1600.89],'cm^-1')),
        HinderedRotor(inertia=(0.160094,'amu*angstrom^2'), symmetry=1, barrier=(8.86064,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160116,'amu*angstrom^2'), symmetry=1, barrier=(8.86071,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160147,'amu*angstrom^2'), symmetry=1, barrier=(8.86105,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.814165,'amu*angstrom^2'), symmetry=1, barrier=(45.0453,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (207.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.68111,0.138357,-0.000239643,2.11679e-07,-7.24567e-11,-126841,39.2964], Tmin=(100,'K'), Tmax=(828.186,'K')), NASAPolynomial(coeffs=[14.3752,0.0391972,-2.09074e-05,4.09693e-09,-2.84316e-13,-128760,-30.665], Tmin=(828.186,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1056.21,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCCFF) + group(CsCsFFH) + group(CsCsFFH) + group(Ct-CtCs) + group(CtCF) + radical(Csj(Cs-CsCsH)(F1s)(F1s))"""),
)
...
species(
    label = 'FC=[C]C(F)(F)[C](C(F)F)C(F)F(7769)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (208.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.77894,0.145472,-0.000264787,2.47581e-07,-8.86589e-11,-128323,41.0866], Tmin=(100,'K'), Tmax=(833.433,'K')), NASAPolynomial(coeffs=[10.661,0.0495841,-2.70857e-05,5.35068e-09,-3.72523e-13,-129140,-9.12299], Tmin=(833.433,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1068.52,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCCFF) + group(CsCsFFH) + group(CsCsFFH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Tertalkyl) + radical(Cdj(Cs-F1sF1sCs)(Cd-F1sH))"""),
)

species(
    label = 'F[C]=CC(F)(F)C([C](F)F)C(F)F(7770)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (208.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.81196,0.140008,-0.000233446,2.02567e-07,-6.92266e-11,-127781,41.173], Tmin=(100,'K'), Tmax=(795.345,'K')), NASAPolynomial(coeffs=[15.1572,0.0413278,-2.2183e-05,4.39899e-09,-3.08964e-13,-130058,-34.1556], Tmin=(795.345,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1064.07,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCCFF) + group(CsCsFFH) + group(CsCsFFH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Csj(Cs-CsCsH)(F1s)(F1s)) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
species(
    label = 'FC=CC(F)(F)C([C](F)F)[C](F)F(7772)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {11,S}
...
"""),
    ...
    molecularWeight = (208.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.7143,0.137827,-0.000229378,1.99606e-07,-6.84368e-11,-133933,41.0985], Tmin=(100,'K'), Tmax=(796.837,'K')), NASAPolynomial(coeffs=[14.6413,0.0417813,-2.2331e-05,4.42262e-09,-3.10443e-13,-136097,-31.316], Tmin=(796.837,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1115.2,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCCFF) + group(CsCsFFH) + group(CsCsFFH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Csj(Cs-CsCsH)(F1s)(F1s)) + radical(Csj(Cs-CsCsH)(F1s)(F1s))"""),
)

species(
    label = 'F[C]=[C]C(F)(F)C(C(F)F)C(F)F(7773)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-1003.83,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,136,307,446,511,682,757,1180,1185,176,294,457,589,547,707,1086,1160,1127,1157,1302,1442,1365,1447,3042,3152,1685,370,167,640,1190,240.815,240.815,240.815],'cm^-1')),
        HinderedRotor(inertia=(0.204016,'amu*angstrom^2'), symmetry=1, barrier=(8.39572,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204016,'amu*angstrom^2'), symmetry=1, barrier=(8.39572,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.669905,'amu*angstrom^2'), symmetry=1, barrier=(27.5682,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204015,'amu*angstrom^2'), symmetry=1, barrier=(8.39572,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (208.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.82532,0.140163,-0.000232088,2.00885e-07,-6.88111e-11,-120534,40.6132], Tmin=(100,'K'), Tmax=(781.466,'K')), NASAPolynomial(coeffs=[15.2504,0.0419241,-2.27236e-05,4.5334e-09,-3.19907e-13,-122872,-35.4398], Tmin=(781.466,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1003.83,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCCFF) + group(CsCsFFH) + group(CsCsFFH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cs-F1sF1sCs)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'F[CH][C]=C(F)C(C(F)F)C(F)(F)F(7774)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1054.35,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,136,307,446,511,682,757,1180,1185,235,523,627,1123,1142,1372,1406,3097,193,295,551,588,656,1146,1192,1350,1685,370,3120,650,792.5,1650,271.394,271.562],'cm^-1')),
        HinderedRotor(inertia=(0.19534,'amu*angstrom^2'), symmetry=1, barrier=(10.2287,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.196325,'amu*angstrom^2'), symmetry=1, barrier=(10.2292,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.195035,'amu*angstrom^2'), symmetry=1, barrier=(10.2324,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.501212,'amu*angstrom^2'), symmetry=1, barrier=(26.1774,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (208.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.46432,0.129673,-0.000188868,1.41397e-07,-4.21444e-11,-126621,39.3436], Tmin=(100,'K'), Tmax=(820.86,'K')), NASAPolynomial(coeffs=[17.5436,0.0370506,-1.96173e-05,3.94184e-09,-2.82091e-13,-129741,-48.6068], Tmin=(820.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1054.35,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCCFF) + group(CsCsFFH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-R-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)3-R-Cs(F)2) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cdj(Cs-F1sF1sCs)(Cd-HH)) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(F)C(F)(F)C([C](F)F)C(F)F(7779)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.130508,'amu*angstrom^2'), symmetry=1, barrier=(3.00063,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130577,'amu*angstrom^2'), symmetry=1, barrier=(3.00221,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130553,'amu*angstrom^2'), symmetry=1, barrier=(3.00167,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'FC=[C]C(F)(F)C[C](F)F(7230)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'FC=[C]C(F)(F)C(F)[C](F)F(7263)'],
    products = ['FC=[C]C(F)(F)C([C](F)F)C(F)F(7304)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['FC=[C]C(F)(F)[CH]C(F)(F)C(F)F(7761)'],
    products = ['FC=[C]C(F)(F)C([C](F)F)C(F)F(7304)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.33e+08,'s^-1'), n=1.36, Ea=(157.318,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [cCs(-R!HR!H)CJ;CsJ;C] for rate rule [cCs(-R!HR!H)CJ;CsJ-CsH;C]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction8',
    reactants = ['[C]=CF-2(1219)', 'F[C](F)C([C](F)F)C(F)F(5681)'],
    products = ['FC=[C]C(F)(F)C([C](F)F)C(F)F(7304)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['FC=[C]C(F)(F)C([C](F)F)C(F)F(7304)'],
    products = ['FC=CC(F)(F)C(=C(F)F)C(F)F(7763)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHF2(82)', 'FC=[C]C(F)(F)C=C(F)F(7267)'],
    products = ['FC=[C]C(F)(F)C([C](F)F)C(F)F(7304)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'FC=[C]C(F)(F)C(=C(F)F)C(F)F(7764)'],
    products = ['FC=[C]C(F)(F)C([C](F)F)C(F)F(7304)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'FC=C=C(F)C([C](F)F)C(F)F(7765)'],
    products = ['FC=[C]C(F)(F)C([C](F)F)C(F)F(7304)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'C#CC(F)(F)C([C](F)F)C(F)F(7766)'],
    products = ['FC=[C]C(F)(F)C([C](F)F)C(F)F(7304)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'FC#CC(F)(F)C([C](F)F)C(F)F(7767)'],
    products = ['FC=[C]C(F)(F)C([C](F)F)C(F)F(7304)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'F[CH][C]=C(F)C(=C(F)F)C(F)F(7768)'],
    products = ['FC=[C]C(F)(F)C([C](F)F)C(F)F(7304)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'F[CH]C(=C(F)F)C(F)(F)[C]=CF(7316)'],
    products = ['FC=[C]C(F)(F)C([C](F)F)C(F)F(7304)'],
...
reaction(
    label = 'reaction22',
    reactants = ['FC=[C]C(F)(F)C([C](F)F)C(F)F(7304)'],
    products = ['FC=[C]C(F)(F)[C](C(F)F)C(F)F(7769)'],
...
reaction(
    label = 'reaction23',
    reactants = ['FC=[C]C(F)(F)C([C](F)F)C(F)F(7304)'],
    products = ['F[C]=CC(F)(F)C([C](F)F)C(F)F(7770)'],
...
reaction(
    label = 'reaction24',
    reactants = ['FC=[C]C(F)(F)C([C](F)F)C(F)F(7304)'],
    products = ['FC=CC(F)(F)[C]([C](F)F)C(F)F(7771)'],
...
reaction(
    label = 'reaction25',
    reactants = ['FC=[C]C(F)(F)C([C](F)F)C(F)F(7304)'],
    products = ['FC=CC(F)(F)C([C](F)F)[C](F)F(7772)'],
...
reaction(
    label = 'reaction26',
    reactants = ['F[C]=[C]C(F)(F)C(C(F)F)C(F)F(7773)'],
    products = ['FC=[C]C(F)(F)C([C](F)F)C(F)F(7304)'],
...
reaction(
    label = 'reaction27',
    reactants = ['FC=[C]C(F)(F)C([C](F)F)C(F)F(7304)'],
    products = ['F[CH][C]=C(F)C(C(F)F)C(F)(F)F(7774)'],
...
reaction(
    label = 'reaction28',
    reactants = ['FC=[C]C(F)(F)C([C](F)F)C(F)F(7304)'],
    products = ['FC=C(F)[C](F)C([C](F)F)C(F)F(7775)'],
...
reaction(
    label = 'reaction29',
    reactants = ['FC=[C]C(F)(F)C([C](F)F)C(F)F(7304)'],
    products = ['F[CH]C(C(F)(F)F)C(F)(F)[C]=CF(7776)'],
...
reaction(
    label = 'reaction30',
    reactants = ['FC=[C]C(F)(F)C([C](F)F)C(F)F(7304)'],
    products = ['F[CH]C([C](F)F)C(F)(F)C(F)=CF(7777)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH]=[C]C(F)(F)C(C(F)F)C(F)(F)F(7778)'],
    products = ['FC=[C]C(F)(F)C([C](F)F)C(F)F(7304)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH]=C(F)C(F)(F)C([C](F)F)C(F)F(7779)'],
    products = ['FC=[C]C(F)(F)C([C](F)F)C(F)F(7304)'],
