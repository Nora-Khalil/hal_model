...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(192)', '[O]C([O])(O)F(8783)'],
    products = ['[O]C(O)(F)O[C]=O(8759)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'O=[C]O[C](O)F(5710)'],
    products = ['[O]C(O)(F)O[C]=O(8759)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(13)', '[O]C([O])(O)F(8783)'],
    products = ['[O]C(O)(F)O[C]=O(8759)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC(=O)O(2212)'],
    products = ['[O]C(O)(F)O[C]=O(8759)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[O]C(=O)O[C]=O(1618)'],
    products = ['[O]C(O)(F)O[C]=O(8759)'],
