...
"""),
    E0 = (-982.174,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,193,295,551,588,656,1146,1192,1350,3000,3100,440,815,1455,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.472753,'amu*angstrom^2'), symmetry=1, barrier=(10.8695,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00708467,'amu*angstrom^2'), symmetry=1, barrier=(29.1755,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (133.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.64767,0.0279029,0.000112099,-3.57319e-07,2.87888e-10,-118126,14.4597], Tmin=(10,'K'), Tmax=(460.743,'K')), NASAPolynomial(coeffs=[6.92505,0.0348254,-2.56068e-05,8.57498e-09,-1.06693e-12,-118803,-2.88682], Tmin=(460.743,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-982.174,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), label="""[CH2]C(F)(F)C(F)(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-597.202,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,90,150,250,247,323,377,431,433,1065,1274,783.625,1609.96],'cm^-1')),
        HinderedRotor(inertia=(0.000155604,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000273163,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97668,0.0465357,-4.84627e-05,2.61143e-08,-5.71651e-12,-71755.6,19.0395], Tmin=(100,'K'), Tmax=(1090.73,'K')), NASAPolynomial(coeffs=[9.89214,0.0175077,-8.54293e-06,1.71499e-09,-1.24124e-13,-73482.3,-19.8355], Tmin=(1090.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-597.202,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
"""),
    E0 = (-793.875,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,522,585,610,849,1160,1215,1402,3025,407.5,1350,352.5,190,488,555,1236,1407,180,2339.43],'cm^-1')),
        HinderedRotor(inertia=(0.07698,'amu*angstrom^2'), symmetry=1, barrier=(1.76992,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0800396,'amu*angstrom^2'), symmetry=1, barrier=(1.84027,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (132.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82622,0.0551996,-7.00321e-05,3.52916e-08,2.32596e-12,-95410.1,24.7863], Tmin=(100,'K'), Tmax=(541.895,'K')), NASAPolynomial(coeffs=[7.69444,0.0231109,-1.2287e-05,2.48513e-09,-1.78232e-13,-96210.9,-1.45013], Tmin=(541.895,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-793.875,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cs_S) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CF3(45)', 'CH2CF2(57)'],
    products = ['F[C](F)CC(F)(F)F(600)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.000105193,'m^3/(mol*s)'), n=3.55802, Ea=(21.4499,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-3C-R_2R!H->C_1R!H->C_N-4R!H->C',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-3C-R_2R!H->C_1R!H->C_N-4R!H->C"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'CH2F-CF2(68)'],
    products = ['F[C](F)CC(F)(F)F(600)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.33582e-06,'m^3/(mol*s)'), n=3.3552, Ea=(232.394,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R',), comment="""Estimated from node CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R"""),
)

reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(F)(F)C(F)(F)F(1271)'],
    products = ['F[C](F)CC(F)(F)F(600)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'F[C]CC(F)(F)F-2(8551)'],
    products = ['F[C](F)CC(F)(F)F(600)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(138)', '[CH2]C(F)(F)F(125)'],
    products = ['F[C](F)CC(F)(F)F(600)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[C](F)[CH]C(F)(F)F(8232)'],
    products = ['F[C](F)CC(F)(F)F(600)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(43)', '[CH2]C(F)(F)F(125)'],
    products = ['F[C](F)CC(F)(F)F(600)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FC(F)[CH]C(F)(F)F(6667)'],
    products = ['F[C](F)CC(F)(F)F(600)'],
