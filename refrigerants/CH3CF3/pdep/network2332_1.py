...
"""),
    E0 = (-175.066,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([548,1085,1183,1302,1466,1520,3060,3119,376.121,376.134,376.141,376.16,376.275],'cm^-1')),
        HinderedRotor(inertia=(0.152235,'amu*angstrom^2'), symmetry=1, barrier=(15.2687,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151953,'amu*angstrom^2'), symmetry=1, barrier=(15.2686,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.0334,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23517,0.0406438,-5.08346e-05,3.1077e-08,-7.46694e-12,-20993.4,14.1855], Tmin=(100,'K'), Tmax=(1015.18,'K')), NASAPolynomial(coeffs=[10.0811,0.00972956,-5.15718e-06,1.08107e-09,-8.01879e-14,-22586.5,-23.7851], Tmin=(1015.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-175.066,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CH2_triplet)"""),
)
...
species(
    label = 'F[C-]=[O+]CF(13250)',
    structure = adjacencyList("""1 F u0 p3 c0 {4,S}
2 F u0 p3 c0 {5,S}
3 O u0 p1 c+1 {4,S} {5,D}
4 C u0 p0 c0 {1,S} {3,S} {6,S} {7,S}
5 C u0 p1 c-1 {2,S} {3,D}
6 H u0 p0 c0 {4,S}
7 H u0 p0 c0 {4,S}
"""),
    E0 = (-415.218,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,481.009,481.583,481.795,482.143,482.182],'cm^-1')),
        HinderedRotor(inertia=(0.282123,'amu*angstrom^2'), symmetry=1, barrier=(46.4893,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (80.0334,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.8205,0.0246082,-1.57925e-05,4.6252e-09,-5.34224e-13,-49895.9,13.2657], Tmin=(100,'K'), Tmax=(1970.19,'K')), NASAPolynomial(coeffs=[9.9734,0.0100859,-4.73591e-06,8.839e-10,-5.94841e-14,-52714.4,-26.0935], Tmin=(1970.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-415.218,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsFHHO) + group(CJ2_singlet-FO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CF2O(49)', 'CH2F(46)'],
    products = ['FCO[C](F)F(757)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(8.90647e+06,'m^3/(mol*s)'), n=-0.198276, Ea=(66.5236,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3273107057168037, var=7.214547064829838, Tref=1000.0, N=427, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'O[C](F)F(206)'],
    products = ['FCO[C](F)F(757)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(4.67448e-06,'m^3/(mol*s)'), n=3.15288, Ea=(2.80168,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node OH_2Br1sCl1sF1sHI1s->H"""),
)

reaction(
    label = 'reaction3',
    reactants = ['FO[C](F)F(236)', 'CH2(S)(25)'],
    products = ['FCO[C](F)F(757)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(6.69029,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'F[C]OCF(13249)'],
    products = ['FCO[C](F)F(757)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2]O[C](F)F(261)'],
    products = ['FCO[C](F)F(757)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[CH]O[C](F)F(840)'],
    products = ['FCO[C](F)F(757)'],
    transitionState = 'TS8',
...
reaction(
    ...
    kinetics = Arrhenius(A=(128827,'m^3/(mol*s)'), n=0.469398, Ea=(7.42227,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['FCO[C](F)F(757)'],
    products = ['F[CH]OC(F)F(2963)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(5.73035e+08,'s^-1'), n=1.21371, Ea=(160.477,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3H_SS;C_rad_out_noH;Cs_H_out_1H] for rate rule [R3H_SS_O;C_rad_out_noH;Cs_H_out_1H]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction12',
    reactants = ['FCO[C](F)F(757)'],
    products = ['[CH2]OC(F)(F)F(751)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(202.554,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
