species(
    label = '[CH2]OC(F)(F)[CH]C(F)F(6657)',
...
species(
    label = '[CH2]O[C](F)C(F)C(F)F(6895)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = '[CH2]OC(F)(F)C(F)[CH]F(6897)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC(F)(F)[CH]C(F)F(6657)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[O]C(F)(F)[CH]C(F)F(271)'],
    products = ['[CH2]OC(F)(F)[CH]C(F)F(6657)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]C(F)F-2(957)', '[CH2]O[C](F)F(261)'],
    products = ['[CH2]OC(F)(F)[CH]C(F)F(6657)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]OC(F)=CC(F)F(6890)'],
    products = ['[CH2]OC(F)(F)[CH]C(F)F(6657)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]OC(F)(F)C=CF(6891)'],
    products = ['[CH2]OC(F)(F)[CH]C(F)F(6657)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]OC(F)(F)C=C(F)F(6892)'],
    products = ['[CH2]OC(F)(F)[CH]C(F)F(6657)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]OC(F)(F)[CH]C(F)F(6657)'],
    products = ['[CH2]OC(F)(F)C[C](F)F(6893)'],
...
reaction(
    label = 'reaction13',
    reactants = ['COC(F)(F)[CH][C](F)F(6894)'],
    products = ['[CH2]OC(F)(F)[CH]C(F)F(6657)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]O[C](F)C(F)C(F)F(6895)'],
    products = ['[CH2]OC(F)(F)[CH]C(F)F(6657)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FCO[C](F)[CH]C(F)F(6896)'],
    products = ['[CH2]OC(F)(F)[CH]C(F)F(6657)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]OC(F)(F)C(F)[CH]F(6897)'],
    products = ['[CH2]OC(F)(F)[CH]C(F)F(6657)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH][CH]C(F)(F)OCF(6898)'],
    products = ['[CH2]OC(F)(F)[CH]C(F)F(6657)'],
