...
reaction(
    label = 'reaction2',
    reactants = ['O=C([CH][CH]F)OF(1660)'],
    products = ['[O]C(=O)C(F)[CH]F(1622)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', '[O]C([O])=CF(1301)'],
    products = ['[O]C(=O)C(F)[CH]F(1622)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'O=[C]C(F)[CH]F(1661)'],
    products = ['[O]C(=O)C(F)[CH]F(1622)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C(=O)C=CF(1666)'],
    products = ['[O]C(=O)C(F)[CH]F(1622)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O][C]=O(722)', 'CHFCHF[Z](59)'],
    products = ['[O]C(=O)C(F)[CH]F(1622)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]C(=O)C(F)=CF(1314)'],
    products = ['[O]C(=O)C(F)[CH]F(1622)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CO2(14)', 'F[CH][CH]F(811)'],
    products = ['[O]C(=O)C(F)[CH]F(1622)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O][C]=O(722)', 'F[CH][CH]F(811)'],
    products = ['[O]C(=O)C(F)[CH]F(1622)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', '[O]C([O])=CF(1301)'],
    products = ['[O]C(=O)C(F)[CH]F(1622)'],
