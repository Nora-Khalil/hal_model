...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(F)(F)[C]=CF(547)'],
    products = ['[O]OC(F)(F)[C]=CF(2996)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[C](F)F(163)', '[C]=CF-2(1206)'],
    products = ['[O]OC(F)(F)[C]=CF(2996)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]OC(F)=C=CF(3932)'],
    products = ['[O]OC(F)(F)[C]=CF(2996)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C#CC(F)(F)O[O](3933)'],
    products = ['[O]OC(F)(F)[C]=CF(2996)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]OC(F)(F)C#CF(3934)'],
    products = ['[O]OC(F)(F)[C]=CF(2996)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction14',
    reactants = ['[O]OC(F)=C(F)[CH]F(3938)'],
    products = ['[O]OC(F)(F)[C]=CF(2996)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]OC(F)(F)[C]=CF(2996)'],
    products = ['[CH]=C(F)C(F)(F)O[O](3940)'],
