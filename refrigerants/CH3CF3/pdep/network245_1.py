...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C(F)[CH]F(831)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(804)', '[O]C(F)(F)[CH]F(841)'],
    products = ['[O]C(F)(F)C(F)[CH]F(831)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(F)(F)C=CF(842)'],
    products = ['[O]C(F)(F)C(F)[CH]F(831)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O][C](F)F(263)', 'CHFCHF[Z](59)'],
    products = ['[O]C(F)(F)C(F)[CH]F(831)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)(F)C(F)=CF(843)'],
    products = ['[O]C(F)(F)C(F)[CH]F(831)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C(F)C(F)[CH]F(844)'],
    products = ['[O]C(F)(F)C(F)[CH]F(831)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2O(49)', 'F[CH][CH]F(811)'],
    products = ['[O]C(F)(F)C(F)[CH]F(831)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O][C](F)F(263)', 'F[CH][CH]F(811)'],
    products = ['[O]C(F)(F)C(F)[CH]F(831)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(78)', 'O=C(F)[CH][CH]F(845)'],
    products = ['[O]C(F)(F)C(F)[CH]F(831)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[O]C(F)(F)[CH]F(841)'],
    products = ['[O]C(F)(F)C(F)[CH]F(831)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH][CH]C(F)(F)OF(847)'],
    products = ['[O]C(F)(F)C(F)[CH]F(831)'],
...
network(
    label = 'PDepNetwork #245',
    isomers = [
        '[O]C(F)(F)C(F)[CH]F(831)',
    ],
    reactants = [
        ('CF2O(49)', 'CHFCHF[Z](59)'),
    ],
