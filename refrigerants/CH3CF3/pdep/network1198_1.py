...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F(537)', '[C]=C(999)'],
    products = ['[CH]=C(F)O[C]=C(3141)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=C(F)OC#C(3231)'],
    products = ['[CH]=C(F)O[C]=C(3141)'],
    transitionState = 'TS7',
