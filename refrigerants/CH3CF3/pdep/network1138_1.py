...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC(F)[C]=C(F)F(2986)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[O]C(F)[C]=C(F)F(3188)'],
    products = ['[CH2]OC(F)[C]=C(F)F(2986)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(F)F(1205)', '[CH2]O[CH]F(850)'],
    products = ['[CH2]OC(F)[C]=C(F)F(2986)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]OC=C=C(F)F(3273)'],
    products = ['[CH2]OC(F)[C]=C(F)F(2986)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]OC(F)=C=C(F)F(3274)'],
    products = ['[CH2]OC(F)[C]=C(F)F(2986)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]OC(F)C#CF(3275)'],
    products = ['[CH2]OC(F)[C]=C(F)F(2986)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]OC(F)[C]=C(F)F(2986)'],
    products = ['[CH2]OC(F)=C[C](F)F(3276)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]OC(F)[C]=C(F)F(2986)'],
    products = ['[CH2]O[CH]C(F)=C(F)F(3279)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]OC(F)C(F)=[C]F(3281)'],
    products = ['[CH2]OC(F)[C]=C(F)F(2986)'],
