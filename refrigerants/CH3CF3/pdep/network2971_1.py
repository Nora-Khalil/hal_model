...
reaction(
    label = 'reaction2',
    reactants = ['HO2(11)', 'F[C]C(F)F(169)'],
    products = ['[O]OC(F)C(F)F(960)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]O[CH]C(F)F(178)'],
    products = ['[O]OC(F)C(F)F(960)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]OC(F)[CH]F(800)'],
    products = ['[O]OC(F)C(F)F(960)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF2(82)', '[O]O[CH]F(893)'],
    products = ['[O]OC(F)C(F)F(960)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]O[C](F)C(F)F(964)'],
    products = ['[O]OC(F)C(F)F(960)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]OC(F)[C](F)F(965)'],
    products = ['[O]OC(F)C(F)F(960)'],
