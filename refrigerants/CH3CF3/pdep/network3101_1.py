...
reaction(
    label = 'reaction2',
    reactants = ['HO2(11)', 'C[C]F(325)'],
    products = ['CC(F)O[O](10393)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)O[O](1328)'],
    products = ['CC(F)O[O](10393)'],
