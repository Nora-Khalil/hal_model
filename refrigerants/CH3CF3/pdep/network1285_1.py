...
"""),
    E0 = (-359.488,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,3000,3100,440,815,1455,1000,180,2407.26],'cm^-1')),
        HinderedRotor(inertia=(0.189164,'amu*angstrom^2'), symmetry=1, barrier=(4.34926,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188177,'amu*angstrom^2'), symmetry=1, barrier=(4.32656,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188482,'amu*angstrom^2'), symmetry=1, barrier=(4.33358,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04968,0.072323,-0.000113696,1.02064e-07,-3.62222e-11,-43137.3,25.268], Tmin=(100,'K'), Tmax=(821.061,'K')), NASAPolynomial(coeffs=[6.81591,0.0313171,-1.51886e-05,2.92421e-09,-2.02618e-13,-43648.9,1.23701], Tmin=(821.061,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-359.488,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsF1sF1s)(F1s)(H)) + radical(RCCJ)"""),
)
...
"""),
    ...
    molecularWeight = (110.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.4399,0.0477768,-4.0534e-05,1.95291e-08,-4.16193e-12,-74892.3,11.4916], Tmin=(10,'K'), Tmax=(973.153,'K')), NASAPolynomial(coeffs=[6.60436,0.0347699,-2.04855e-05,5.79484e-09,-6.33673e-13,-75508.2,-3.68898], Tmin=(973.153,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-622.719,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), label="""CDCC(F)(F)CF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-354.891,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,522,611,926,1093,1137,1374,1416,3112,212,367,445,1450,3000,3100,440,815,1455,1000,180,1745.19],'cm^-1')),
        HinderedRotor(inertia=(0.243826,'amu*angstrom^2'), symmetry=1, barrier=(5.60604,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.243867,'amu*angstrom^2'), symmetry=1, barrier=(5.60698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.243503,'amu*angstrom^2'), symmetry=1, barrier=(5.59862,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29687,0.0678481,-0.000107306,1.02352e-07,-3.87304e-11,-42594.3,24.8855], Tmin=(100,'K'), Tmax=(803.73,'K')), NASAPolynomial(coeffs=[4.40024,0.0362868,-1.83256e-05,3.59726e-09,-2.52398e-13,-42572.7,13.8299], Tmin=(803.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-354.891,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sF1sH)(F1s)) + radical(RCCJ)"""),
)

species(
    label = 'F[CH][C](F)CCF(3958)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-334.988,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,212,367,445,1450,334,575,1197,1424,3202,233.969,233.994,234.176],'cm^-1')),
        HinderedRotor(inertia=(0.464905,'amu*angstrom^2'), symmetry=1, barrier=(17.7844,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.456979,'amu*angstrom^2'), symmetry=1, barrier=(17.7835,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.452185,'amu*angstrom^2'), symmetry=1, barrier=(17.7618,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.078,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC(F)(F)[CH]F(3906)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC(F)[C](F)F(3907)'],
    products = ['[CH2]CC(F)(F)[CH]F(3906)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', '[CH2]C[C](F)F(137)'],
    products = ['[CH2]CC(F)(F)[CH]F(3906)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[CH2]C(F)(F)[CH]F(817)'],
    products = ['[CH2]CC(F)(F)[CH]F(3906)'],
    transitionState = 'TS4',
...
reaction(
    ...
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(241.081,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)

reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', '[CH2]C[C](F)F(137)'],
    products = ['[CH2]CC(F)(F)[CH]F(3906)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C[C](F)C(F)F(3946)'],
    products = ['[CH2]CC(F)(F)[CH]F(3906)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(8.71296e+12,'s^-1'), n=0.369741, Ea=(180.768,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_N-4R!H->C_Ext-2R!H-R_5R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_N-4R!H->C_Ext-2R!H-R_5R!H->C
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction17',
    reactants = ['F[CH][C](F)CCF(3958)'],
    products = ['[CH2]CC(F)(F)[CH]F(3906)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(215.016,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

network(
    label = 'PDepNetwork #1285',
    isomers = [
        '[CH2]CC(F)(F)[CH]F(3906)',
    ],
    reactants = [
        ('CHFCF2(55)', 'C2H4(30)'),
    ],
