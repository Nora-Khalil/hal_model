...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.611588,'amu*angstrom^2'), symmetry=1, barrier=(14.0616,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.611732,'amu*angstrom^2'), symmetry=1, barrier=(14.0649,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.611612,'amu*angstrom^2'), symmetry=1, barrier=(14.0622,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.2787,'amu*angstrom^2'), symmetry=1, barrier=(29.3998,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2807,'amu*angstrom^2'), symmetry=1, barrier=(29.4458,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.609971,'amu*angstrom^2'), symmetry=1, barrier=(14.0244,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17479,'amu*angstrom^2'), symmetry=1, barrier=(27.0107,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.610479,'amu*angstrom^2'), symmetry=1, barrier=(14.0361,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.039,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['OOC(F)(F)F(7106)', 'CH2(S)(25)'],
    products = ['OOCC(F)(F)F(605)'],
    transitionState = 'TS2',
