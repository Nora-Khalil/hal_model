...
"""),
    E0 = (-243.924,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,580,1155,1237,1373,3147,250.776,250.954,250.973,2520.93],'cm^-1')),
        HinderedRotor(inertia=(0.0897984,'amu*angstrom^2'), symmetry=1, barrier=(4.01265,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0896985,'amu*angstrom^2'), symmetry=1, barrier=(4.01372,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.858802,'amu*angstrom^2'), symmetry=1, barrier=(38.3894,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74155,0.0556303,-8.60565e-05,7.8979e-08,-2.90493e-11,-29261.7,22.6245], Tmin=(100,'K'), Tmax=(795.275,'K')), NASAPolynomial(coeffs=[5.50214,0.0269261,-1.34522e-05,2.6376e-09,-1.85201e-13,-29550.3,7.28956], Tmin=(795.275,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-243.924,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-O2sHH)(F1s)(H)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(804)', '[O]C[CH]F(856)'],
    products = ['F[CH]CO[CH]F(10233)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['F[CH]CO[CH]F(10233)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(75.6642,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
