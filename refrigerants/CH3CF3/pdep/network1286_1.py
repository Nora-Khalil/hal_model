...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC(F)(F)[C](F)F(3418)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(138)', '[CH2]C[C](F)F(137)'],
    products = ['[CH2]CC(F)(F)[C](F)F(3418)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2]CC(F)=C(F)F(2694)'],
    products = ['[CH2]CC(F)(F)[C](F)F(3418)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CF2CF2(61)', '[CH2][CH2](981)'],
    products = ['[CH2]CC(F)(F)[C](F)F(3418)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[C](F)[C](F)F(1616)', 'C2H4(30)'],
    products = ['[CH2]CC(F)(F)[C](F)F(3418)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=CC(F)(F)[C](F)F(3422)'],
    products = ['[CH2]CC(F)(F)[C](F)F(3418)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[C](F)[C](F)F(1616)', '[CH2][CH2](981)'],
    products = ['[CH2]CC(F)(F)[C](F)F(3418)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[CH2]C=C(F)[C](F)F(3423)'],
    products = ['[CH2]CC(F)(F)[C](F)F(3418)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(43)', '[CH2]C[C](F)F(137)'],
    products = ['[CH2]CC(F)(F)[C](F)F(3418)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]CC(F)(F)[C](F)F(3418)'],
    products = ['C[CH]C(F)(F)[C](F)F(3424)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CC(F)(F)[C](F)F(3418)'],
    products = ['[CH2][CH]C(F)(F)C(F)F(3425)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CC(F)(F)[C](F)F(3418)'],
    products = ['[CH2]C[C](F)C(F)(F)F(3426)'],
