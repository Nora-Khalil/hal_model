...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2]CC=C(F)F(1189)'],
    products = ['[CH2]CC(F)[C](F)F(3907)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]CC(F)=C(F)F(2874)'],
    products = ['[CH2]CC(F)[C](F)F(3907)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C=CC(F)[C](F)F(3945)'],
    products = ['[CH2]CC(F)[C](F)F(3907)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CC(F)[C](F)F(3907)'],
    products = ['[CH2]C[CH]C(F)(F)F(3950)'],
