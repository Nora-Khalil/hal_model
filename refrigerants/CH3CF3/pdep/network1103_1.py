...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH]C(=C)F(496)'],
    products = ['[CH]=C(F)C[CH2](2925)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=[C]F(489)', '[CH2][CH2](979)'],
    products = ['[CH]=C(F)C[CH2](2925)'],
    transitionState = 'TS9',
