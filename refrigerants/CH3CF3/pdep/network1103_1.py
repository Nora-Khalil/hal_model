...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(276)', '[CH]F(804)'],
    products = ['[O]C(F)(F)O[CH]F(2880)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'F[CH]O[C](F)F(840)'],
    products = ['[O]C(F)(F)O[CH]F(2880)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(F)O[CH]F(2918)'],
    products = ['[O]C(F)(F)O[CH]F(2880)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C([O])(F)F(276)', 'CHF(40)'],
    products = ['[O]C(F)(F)O[CH]F(2880)'],
    transitionState = 'TS9',
