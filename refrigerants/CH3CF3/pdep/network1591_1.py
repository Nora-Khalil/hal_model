...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(804)', '[CH]C(=O)F(537)'],
    products = ['[CH]=C(F)O[CH]F(5608)'],
    transitionState = 'TS2',
