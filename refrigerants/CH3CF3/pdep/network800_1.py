...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O=CO[C](F)OF(1837)'],
    products = ['O=COC(F)(F)OF(1817)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[O]C(F)(F)OC=O(1838)'],
    products = ['O=COC(F)(F)OF(1817)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OC(F)(F)OF(1839)'],
    products = ['O=COC(F)(F)OF(1817)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F2(78)', 'O=COC(=O)F(1840)'],
    products = ['O=COC(F)(F)OF(1817)'],
