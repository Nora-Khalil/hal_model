...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'O=C(F)OO(2238)'],
    products = ['O=COOC(=O)F(11145)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]1OO[CH]OO1(11346)'],
    products = ['O=COOC(=O)F(11145)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OOC=O(11137)'],
    products = ['O=COOC(=O)F(11145)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)F(459)', '[O]C=O(322)'],
    products = ['O=COOC(=O)F(11145)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=[C]OOC(=O)F(11183)'],
    products = ['O=COOC(=O)F(11145)'],
