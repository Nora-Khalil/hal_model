...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', '[CH2]C(=C)[O](1709)'],
    products = ['C=C([O])C[C](F)F(1635)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C=[C]C[C](F)F(1710)'],
    products = ['C=C([O])C[C](F)F(1635)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['C=C([O])C[C](F)F(1635)'],
    products = ['[CH2]C1([O])CC1(F)F(1714)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C=C([O])C=C(F)F(1715)'],
    products = ['C=C([O])C[C](F)F(1635)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(43)', '[CH2]C(=C)[O](1709)'],
    products = ['C=C([O])C[C](F)F(1635)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C=C([O])C[C](F)F(1635)'],
    products = ['[CH2][C]1CC(F)(F)O1(1721)'],
