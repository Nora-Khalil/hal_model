...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[CH2]C(=O)[C](F)F(1733)'],
    products = ['[CH2]C(F)(F)C(=C)[O](1643)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[CH2]C(F)(F)[C]=C(1734)'],
    products = ['[CH2]C(F)(F)C(=C)[O](1643)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)C(=C)[O](1643)'],
    products = ['[CH2]C(F)(F)[C]1CO1(1735)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C([O])C(=C)F(1737)'],
    products = ['[CH2]C(F)(F)C(=C)[O](1643)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(O)C([CH2])(F)F(1738)'],
    products = ['[CH2]C(F)(F)C(=C)[O](1643)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)=C([CH2])OF(1740)'],
    products = ['[CH2]C(F)(F)C(=C)[O](1643)'],
