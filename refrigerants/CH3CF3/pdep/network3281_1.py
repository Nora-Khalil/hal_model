...
"""),
    E0 = (-801.234,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2950,1000,261,493,600,1152,1365,1422,3097,223,363,546,575,694,1179,1410,492.75,492.761,492.761,492.763,492.763,492.764,492.782],'cm^-1')),
        HinderedRotor(inertia=(0.000694269,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000694279,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15632,0.0648034,-6.69753e-05,3.48627e-08,-7.34793e-12,-96265.7,23.6979], Tmin=(100,'K'), Tmax=(1131.18,'K')), NASAPolynomial(coeffs=[12.9015,0.0232704,-1.18997e-05,2.40316e-09,-1.74007e-13,-98922.8,-34.4132], Tmin=(1131.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-801.234,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCFFO) + ring(O2s-Cs(F)-Cs(C))"""),
)
...
"""),
    E0 = (-337.308,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2950,1000,261,493,600,1152,1365,1422,3097,605.041,605.041,605.053,605.062,605.083,605.147],'cm^-1')),
        HinderedRotor(inertia=(0.000460387,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-143.433,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,261,493,600,1152,1365,1422,3097,617,898,1187,180,929.64,929.678,929.789,1645.03],'cm^-1')),
        HinderedRotor(inertia=(0.25566,'amu*angstrom^2'), symmetry=1, barrier=(5.87812,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (92.0441,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.40562,0.028611,-9.90825e-06,-8.73718e-09,5.46051e-12,-17188,18.1299], Tmin=(100,'K'), Tmax=(1026.78,'K')), NASAPolynomial(coeffs=[10.4028,0.0112274,-4.62999e-06,8.97266e-10,-6.54668e-14,-19556.2,-24.1979], Tmin=(1026.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-143.433,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CJ2_singlet-FCs) + ring(Cs-Cs(F)-O2s)"""),
)

species(
    label = 'FOC1(F)OC(F)C1F(10959)',
...
"""),
    E0 = (-792.848,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,250,417,511,1155,1315,1456,3119,375,361,584,565,722,1474,261,493,600,1152,1365,1422,3097,483.836,483.837,483.838,483.84],'cm^-1')),
        HinderedRotor(inertia=(0.000720118,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
...
species(
    label = 'F[CH]O[CH]C(F)(F)OF(10960)',
...
"""),
    ...
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.384713,0.105962,-0.000187943,1.63226e-07,-5.44769e-11,-66813.5,29.4503], Tmin=(100,'K'), Tmax=(837.395,'K')), NASAPolynomial(coeffs=[13.9014,0.022893,-1.25809e-05,2.47014e-09,-1.7073e-13,-68686.2,-33.8322], Tmin=(837.395,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-556.756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCFFO) + group(CsFHHO) + radical(CCsJOCs) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1935,0.0596906,-6.12173e-05,3.04094e-08,-5.95679e-12,-48326,22.9344], Tmin=(100,'K'), Tmax=(1233.59,'K')), NASAPolynomial(coeffs=[14.7228,0.0158207,-7.87298e-06,1.58044e-09,-1.14284e-13,-51663.9,-45.1768], Tmin=(1233.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-402.659,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCFFO) + ring(Cs(C-FF)-Cs-O2s) + radical(CCsJO)"""),
)

species(
    label = 'FO[C](F)C1OC1F(10963)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-371.973,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2950,1000,261,493,600,1152,1365,1422,3097,395,473,707,1436,335.092,335.122,335.376,335.727,1382.5,2417.5,2418.05],'cm^-1')),
        HinderedRotor(inertia=(0.454627,'amu*angstrom^2'), symmetry=1, barrier=(36.2852,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.453915,'amu*angstrom^2'), symmetry=1, barrier=(36.2766,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52615,0.0595668,-7.28426e-05,4.90113e-08,-1.37009e-11,-44653.4,22.9775], Tmin=(100,'K'), Tmax=(857.741,'K')), NASAPolynomial(coeffs=[8.83847,0.0254667,-1.32094e-05,2.66261e-09,-1.92011e-13,-45907.9,-11.1782], Tmin=(857.741,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-371.973,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCFHO) + ring(O2s-Cs(F)-Cs(C)) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]C(F)(F)C1OC1F(10964)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-675.774,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,261,493,600,1152,1365,1422,3097,351,323,533,609,664,892,1120,1201,180,180,180,1250.92,1251.01,1251.01],'cm^-1')),
        HinderedRotor(inertia=(0.00421648,'amu*angstrom^2'), symmetry=1, barrier=(4.68248,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71978,0.0500285,-4.48734e-05,2.0203e-08,-3.69669e-12,-81194.8,22.0873], Tmin=(100,'K'), Tmax=(1286.1,'K')), NASAPolynomial(coeffs=[11.4694,0.0197059,-9.50828e-06,1.87136e-09,-1.33344e-13,-83702.7,-27.4025], Tmin=(1286.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-675.774,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCFFO) + ring(O2s-Cs(F)-Cs(C)) + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
"""),
    E0 = (-522.077,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,261,493,600,1152,1365,1422,3097,190,488,555,1236,1407,180,257.357,903.359,903.57,904.357,2113.27],'cm^-1')),
        HinderedRotor(inertia=(0.0795838,'amu*angstrom^2'), symmetry=1, barrier=(46.2866,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-621.13,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,487,638,688,1119,1325,1387,3149,253,525,597,667,842,1178,1324,180,180,180,180,845.892,847.783],'cm^-1')),
        HinderedRotor(inertia=(0.144144,'amu*angstrom^2'), symmetry=1, barrier=(3.31415,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142335,'amu*angstrom^2'), symmetry=1, barrier=(3.27255,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.962254,0.0731309,-0.000109587,8.91446e-08,-2.94571e-11,-74601.1,25.5106], Tmin=(100,'K'), Tmax=(737.584,'K')), NASAPolynomial(coeffs=[9.61524,0.026198,-1.4127e-05,2.85082e-09,-2.04099e-13,-75877.4,-13.6], Tmin=(737.584,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-621.13,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCFFO) + ring(O2s-Cs(F)-Cs(C)) + radical(C2CsJO)"""),
)

species(
    label = 'FOC(F)(F)C1O[C]1F(10967)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-578.139,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2950,1000,223,363,546,575,694,1179,1410,395,473,707,1436,467.574,467.578,467.578,467.579,467.58,467.58,467.58],'cm^-1')),
        HinderedRotor(inertia=(0.000771057,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000771066,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11229,0.0670634,-7.93469e-05,4.71008e-08,-1.12091e-11,-69433,24.6475], Tmin=(100,'K'), Tmax=(1014.82,'K')), NASAPolynomial(coeffs=[12.8252,0.0208962,-1.11075e-05,2.27241e-09,-1.6564e-13,-71810.3,-32.0328], Tmin=(1014.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-578.139,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCFFO) + ring(O2s-Cs(F)-Cs(C)) + radical(Csj(Cs-O2sCsH)(F1s)(O2s-Cs)_ring)"""),
)
...
"""),
    E0 = (-655.289,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,261,493,600,1152,1365,1422,3097,486,617,768,1157,1926,676.986,684.656,687.967,689.267,689.977,1662.09],'cm^-1')),
        HinderedRotor(inertia=(0.0107628,'amu*angstrom^2'), symmetry=1, barrier=(3.57489,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-377.794,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,236,527,855,1015,1182,1348,3236,326,540,652,719,1357,180.068,180.465,181.578,1220.12,1220.47,1221.11],'cm^-1')),
        HinderedRotor(inertia=(0.0677771,'amu*angstrom^2'), symmetry=1, barrier=(1.57972,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54298,0.0597844,-8.56084e-05,6.91506e-08,-2.31883e-11,-45355,20.5239], Tmin=(100,'K'), Tmax=(721.434,'K')), NASAPolynomial(coeffs=[7.76891,0.0252644,-1.38343e-05,2.82478e-09,-2.04123e-13,-46253.3,-7.47968], Tmin=(721.434,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-377.794,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(CsCFHO) + group(Cds-CdsCsOs) + group(CdCFO) + ring(Cd(Cd-F)-Cs-O2s)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['FOC(F)(F)C1OC1F(10929)'],
    products = ['HF(38)', 'CF2O(49)', 'FC1=CO1(577)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(129.396,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'O=CC(F)(F)OF(2446)'],
    products = ['FOC(F)(F)C1OC1F(10929)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O-2(620)', 'FC=CC(F)(F)OF(354)'],
    products = ['FOC(F)(F)C1OC1F(10929)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CF2(43)', 'FOC1OC1F(10957)'],
    products = ['FOC(F)(F)C1OC1F(10929)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(328)', 'F[C]C1OC1F(10958)'],
    products = ['FOC(F)(F)C1OC1F(10929)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['FOC1(F)OC(F)C1F(10959)'],
    products = ['FOC(F)(F)C1OC1F(10929)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OF(195)', 'FC(F)=C1OC1F(3910)'],
    products = ['FOC(F)(F)C1OC1F(10929)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[CH]O[CH]C(F)(F)OF(10960)'],
    products = ['FOC(F)(F)C1OC1F(10929)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C([CH]F)C(F)(F)OF(2449)'],
    products = ['FOC(F)(F)C1OC1F(10929)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)[CH]C(F)(F)OF(10961)'],
    products = ['FOC(F)(F)C1OC1F(10929)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FOC(F)(F)C1[CH]O1(10962)'],
    products = ['FOC(F)(F)C1OC1F(10929)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'FO[C](F)C1OC1F(10963)'],
    products = ['FOC(F)(F)C1OC1F(10929)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)(F)C1OC1F(10964)'],
    products = ['FOC(F)(F)C1OC1F(10929)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(127)', 'F[C](F)C1OC1F(10965)'],
    products = ['FOC(F)(F)C1OC1F(10929)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FO[C](F)F(236)', 'FC1[CH]O1(3971)'],
    products = ['FOC(F)(F)C1OC1F(10929)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'FOC(F)(F)[C]1OC1F(10966)'],
    products = ['FOC(F)(F)C1OC1F(10929)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'FOC(F)(F)C1O[C]1F(10967)'],
    products = ['FOC(F)(F)C1OC1F(10929)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F2(78)', 'O=C(F)C1OC1F(10968)'],
    products = ['FOC(F)(F)C1OC1F(10929)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'FOC(F)=C1OC1F(10969)'],
    products = ['FOC(F)(F)C1OC1F(10929)'],
...
reaction(
    label = 'reaction21',
    reactants = ['FOC(F)(F)C1OC1F(10929)'],
    products = ['F2(78)', 'CF2O(49)', 'C1=CO1(6577)'],
...
network(
    label = 'PDepNetwork #3281',
    isomers = [
        'FOC(F)(F)C1OC1F(10929)',
    ],
    reactants = [
