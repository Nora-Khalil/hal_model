...
reaction(
    label = 'reaction2',
    reactants = ['CH4(4)', 'F[C]COF(356)'],
    products = ['CC(F)COF(10450)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'CC(F)OF(5938)'],
    products = ['CC(F)COF(10450)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(127)', '[CH2]C(C)F(10215)'],
    products = ['CC(F)COF(10450)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]OF(222)', 'CH3-CHF(63)'],
    products = ['CC(F)COF(10450)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(19)', 'F[CH]COF(1400)'],
    products = ['CC(F)COF(10450)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'CC(F)[CH]OF(10479)'],
    products = ['CC(F)COF(10450)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH2]C(F)COF(2857)'],
    products = ['CC(F)COF(10450)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'CC(F)C=O(10281)'],
    products = ['CC(F)COF(10450)'],
