...
"""),
    E0 = (-43.0032,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,364,474,579,619,655,1345,2950,1000,180,950.236,959.357],'cm^-1')),
        HinderedRotor(inertia=(0.161865,'amu*angstrom^2'), symmetry=1, barrier=(3.72159,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.36254,0.0365174,-3.90287e-05,2.13894e-08,-4.71307e-12,-5113.52,16.9063], Tmin=(100,'K'), Tmax=(1092.99,'K')), NASAPolynomial(coeffs=[8.97322,0.0123245,-5.82704e-06,1.13818e-09,-8.10418e-14,-6558.61,-15.5743], Tmin=(1092.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-43.0032,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(CsCFOO) + group(Cs-CsOsHH) + ring(Cs(F)(O2)-O2s-Cs) + radical(ROOJ) + radical(Csj(Cs-F1sO2sO2s)(O2s-Cs)(H)_ring)"""),
)
...
"""),
    E0 = (379.023,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2950,1000,180,180,180,2591.87,2595.72,2599.9],'cm^-1')),
        HinderedRotor(inertia=(0.49547,'amu*angstrom^2'), symmetry=1, barrier=(11.3918,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (73.0274,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.38417,0.0496038,-0.000118836,1.27174e-07,-4.77885e-11,45630.8,16.0159], Tmin=(100,'K'), Tmax=(889.727,'K')), NASAPolynomial(coeffs=[0.843715,0.0212425,-1.15313e-05,2.19507e-09,-1.46292e-13,47301.6,31.1166], Tmin=(889.727,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(379.023,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(oxirene) + radical(ROOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.23774,'amu*angstrom^2'), symmetry=1, barrier=(51.45,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.23746,'amu*angstrom^2'), symmetry=1, barrier=(51.4437,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40839,0.050546,-6.56281e-05,4.01811e-08,-8.99948e-12,34801.8,21.0363], Tmin=(100,'K'), Tmax=(1294.27,'K')), NASAPolynomial(coeffs=[13.5121,0.00288537,1.4919e-06,-5.12849e-10,4.32667e-14,32527.6,-37.1613], Tmin=(1294.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(288.536,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2sFO) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + radical(Cs_P) + radical(CCsJO)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[O]C1(F)[CH]O1(4091)'],
    products = ['[O]OC1(F)[CH]O1(3995)'],
    transitionState = 'TS3',
