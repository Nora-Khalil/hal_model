...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(F)(F)[CH]F(846)'],
    products = ['[O]C(F)C([O])(F)F(2879)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[O]C(F)[C](F)F(1087)'],
    products = ['[O]C(F)C([O])(F)F(2879)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(F)(F)C=O(397)'],
    products = ['[O]C(F)C([O])(F)F(2879)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)(F)C(=O)F(383)'],
    products = ['[O]C(F)C([O])(F)F(2879)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(F)C(=O)F(2920)'],
    products = ['[O]C(F)C([O])(F)F(2879)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O][C](F)F(263)', '[O][CH]F(2623)'],
    products = ['[O]C(F)C([O])(F)F(2879)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(78)', '[O][CH]C(=O)F(398)'],
    products = ['[O]C(F)C([O])(F)F(2879)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[O][C](F)C(=O)F(384)'],
    products = ['[O]C(F)C([O])(F)F(2879)'],
