...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', '[CH]C=C(2929)'],
    products = ['[CH]=CC[C](F)F(2924)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=CC=C(F)F(2932)'],
    products = ['[CH]=CC[C](F)F(2924)'],
    transitionState = 'TS7',
