...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]OC(F)(F)[C]=CF(7185)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(192)', '[O]C(F)(F)[C]=CF(547)'],
    products = ['O=[C]OC(F)(F)[C]=CF(7185)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=[C]O[C](F)F(726)', '[C]=CF-2(1219)'],
    products = ['O=[C]OC(F)(F)[C]=CF(7185)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O=[C]OC(F)(F)[C]=CF(7185)'],
    products = ['O=C1OC(F)(F)C1=CF(7189)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(13)', '[O]C(F)(F)[C]=CF(547)'],
    products = ['O=[C]OC(F)(F)[C]=CF(7185)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC(F)=C=CF(7752)'],
    products = ['O=[C]OC(F)(F)[C]=CF(7185)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C#CC(F)(F)O[C]=O(7753)'],
    products = ['O=[C]OC(F)(F)[C]=CF(7185)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=[C]OC(F)(F)C#CF(7754)'],
    products = ['O=[C]OC(F)(F)[C]=CF(7185)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=[C]OC(F)(F)[C]=CF(7185)'],
    products = ['O=[C]OC(F)(F)C=[C]F(7755)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=COC(F)(F)[C]=[C]F(7756)'],
    products = ['O=[C]OC(F)(F)[C]=CF(7185)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=[C]OC(F)(F)[C]=CF(7185)'],
    products = ['O=[C]OC(F)=C(F)[CH]F(7757)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]OC(F)(F)[C]=CF(7185)'],
    products = ['O=C(F)OC(F)=[C][CH]F(7758)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OC(F)(F)[C]=CF(7185)'],
    products = ['[CH]=C(F)C(F)(F)O[C]=O(7759)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=[C]C(F)(F)OC(=O)F(7760)'],
    products = ['O=[C]OC(F)(F)[C]=CF(7185)'],
