...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.309887,'amu*angstrom^2'), symmetry=1, barrier=(7.12491,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.309729,'amu*angstrom^2'), symmetry=1, barrier=(7.12128,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.50473,'amu*angstrom^2'), symmetry=1, barrier=(34.5968,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.386934,0.0874277,-0.000150071,1.30346e-07,-4.37411e-11,-63056.4,29.6427], Tmin=(100,'K'), Tmax=(841.716,'K')), NASAPolynomial(coeffs=[11.1033,0.0232434,-1.20628e-05,2.32639e-09,-1.59662e-13,-64390.8,-17.4212], Tmin=(841.716,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-525.299,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-(Cds-O2d)OsHH) + group(CsFFHO) + group(Cds-OdCsOs) + radical(OCJC=O) + radical(Csj(F1s)(F1s)(O2s-CO))"""),
)

species(
    label = 'O=C(F)[CH]OO[C](F)F(4274)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18982,0.0687595,-0.000116652,1.04457e-07,-3.65884e-11,-83044.2,25.0025], Tmin=(100,'K'), Tmax=(814.68,'K')), NASAPolynomial(coeffs=[8.23145,0.0231372,-1.23085e-05,2.42391e-09,-1.69279e-13,-83824.9,-5.2758], Tmin=(814.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-691.254,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsFFHO) + group(Cds-O2d(Cds-O2d)O2s) + group(Cds-O2d(Cds-O2d)H) + radical(Csj(F1s)(F1s)(O2s-CO))"""),
)
...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.24007,0.0944963,-0.000177936,1.64566e-07,-5.77087e-11,-98477,30.1213], Tmin=(100,'K'), Tmax=(846.442,'K')), NASAPolynomial(coeffs=[9.73286,0.025975,-1.45766e-05,2.87721e-09,-1.99055e-13,-99236.4,-9.08634], Tmin=(846.442,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-819.816,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFFHO) + group(Cds-OdCsH) + radical(Csj(F1s)(F1s)(O2s-Cs)) + radical(CsCJ=O)"""),
)

species(
    label = '[O]C(F)([C]=O)OC(F)F(4666)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.401114,0.0900642,-0.000165966,1.5271e-07,-5.35135e-11,-94642.5,29.164], Tmin=(100,'K'), Tmax=(844.642,'K')), NASAPolynomial(coeffs=[9.30541,0.0263094,-1.44086e-05,2.82903e-09,-1.9555e-13,-95376.7,-7.73249], Tmin=(844.642,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-787.893,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFFHO) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CsCJ=O)"""),
)

species(
    label = '[O]C=C(OF)O[C](F)F(4667)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-446.997,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,3010,987.5,1337.5,450,1655,493,600,700,1144,1293,380.394,380.397,380.397,380.398,380.399],'cm^-1')),
        HinderedRotor(inertia=(0.195349,'amu*angstrom^2'), symmetry=1, barrier=(20.0589,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.195348,'amu*angstrom^2'), symmetry=1, barrier=(20.0589,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.195346,'amu*angstrom^2'), symmetry=1, barrier=(20.0588,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.159229,0.0806933,-0.000103663,6.1601e-08,-1.39366e-11,-53619.7,28.9967], Tmin=(100,'K'), Tmax=(1096.55,'K')), NASAPolynomial(coeffs=[20.2344,0.00746231,-3.48725e-06,6.97207e-10,-5.1186e-14,-58022.4,-69.7047], Tmin=(1096.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-446.997,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(O2s-(Cds-Cd)H) + group(CsFFHO) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Csj(F1s)(F1s)(O2s-Cd))"""),
)

species(
    label = '[O]C=C([O])OC(F)(F)F(4668)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.36851,0.0798902,-9.51027e-05,5.0581e-08,-9.92717e-12,-109408,28.195], Tmin=(100,'K'), Tmax=(1404.83,'K')), NASAPolynomial(coeffs=[24.7651,-0.00139293,2.06511e-06,-4.55306e-10,3.15491e-14,-115511,-98.1895], Tmin=(1404.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-911.094,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsFFFO) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=COJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(C=O)O[C](F)F(4346)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[O]C(F)O[C](F)F(4655)'],
    products = ['[O]C(F)(C=O)O[C](F)F(4346)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=C([CH]OF)O[C](F)F(4656)'],
    products = ['[O]C(F)(C=O)O[C](F)F(4346)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction15',
    reactants = ['O=C(F)[CH]OO[C](F)F(4274)'],
    products = ['[O]C(F)(C=O)O[C](F)F(4346)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(138)', '[O]C([O])(F)C=O(4657)'],
    products = ['[O]C(F)(C=O)O[C](F)F(4346)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)(C=O)O[C](F)F(4346)'],
    products = ['F[C](F)OC1(F)[CH]OO1(4659)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)(C=O)O[C](F)F(4346)'],
    products = ['[O]C1(F)[CH]OC(F)(F)O1(4660)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)(C=O)O[C](F)F(4346)'],
    products = ['[O]C1OC1(F)O[C](F)F(4661)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O=CC(=O)O[C](F)F(4663)'],
    products = ['[O]C(F)(C=O)O[C](F)F(4346)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HCO(15)', 'O=C(F)O[C](F)F(380)'],
    products = ['[O]C(F)(C=O)O[C](F)F(4346)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=[C]C(=O)O[C](F)F(4664)'],
    products = ['[O]C(F)(C=O)O[C](F)F(4346)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CF2(43)', '[O]C([O])(F)C=O(4657)'],
    products = ['[O]C(F)(C=O)O[C](F)F(4346)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)(C=O)O[C](F)F(4346)'],
    products = ['O=[C]C(O)(F)O[C](F)F(4665)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(F)(C=O)O[C](F)F(4346)'],
    products = ['[O]C(F)([C]=O)OC(F)F(4666)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C=C(OF)O[C](F)F(4667)'],
    products = ['[O]C(F)(C=O)O[C](F)F(4346)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(F)(C=O)O[C](F)F(4346)'],
    products = ['[O]C=C([O])OC(F)(F)F(4668)'],
...
network(
    label = 'PDepNetwork #1470',
    isomers = [
        '[O]C(F)(C=O)O[C](F)F(4346)',
    ],
    reactants = [
