...
species(
    label = 'F[CH]C(F)OC1(F)[CH]O1(4791)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=C[C](F)OC(F)[CH]F(4355)'],
...
reaction(
    label = 'reaction2',
    reactants = ['O=C[C]F(4375)', '[O]C(F)[CH]F(834)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', 'O=C[C](F)O[CH]F(4501)'],
    products = ['O=C[C](F)OC(F)[CH]F(4355)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['O=C[C](F)OC(F)[CH]F(4355)'],
    products = ['F[CH]C(F)OC1(F)[CH]O1(4791)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O=C[C](F)OC=CF(4794)'],
    products = ['O=C[C](F)OC(F)[CH]F(4355)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C[C](F)OC(F)=CF(4597)'],
    products = ['O=C[C](F)OC(F)[CH]F(4355)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C=C(F)OC(F)[CH]F(4795)'],
    products = ['O=C[C](F)OC(F)[CH]F(4355)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=C[C]F-2(1215)', '[O]C(F)[CH]F(834)'],
    products = ['O=C[C](F)OC(F)[CH]F(4355)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHF(40)', 'O=C[C](F)O[CH]F(4501)'],
    products = ['O=C[C](F)OC(F)[CH]F(4355)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=C[C](F)OC(F)[CH]F(4355)'],
    products = ['O=C[C](F)O[C](F)CF(4452)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=CC(F)O[C](F)[CH]F(4797)'],
    products = ['O=C[C](F)OC(F)[CH]F(4355)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O=CC(F)(F)O[CH][CH]F(4799)'],
    products = ['O=C[C](F)OC(F)[CH]F(4355)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O(6)', '[CH]=C(F)OC(F)[CH]F(4800)'],
    products = ['O=C[C](F)OC(F)[CH]F(4355)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O=C[C](F)OC(F)[CH]F(4355)'],
    products = ['[O][CH]C1(F)OC(F)C1F(4803)'],
...
reaction(
    label = 'reaction30',
    reactants = ['O[C]=C(F)OC(F)[CH]F(4805)'],
    products = ['O=C[C](F)OC(F)[CH]F(4355)'],
...
reaction(
    label = 'reaction31',
    reactants = ['OC=C(F)O[C](F)[CH]F(4806)'],
    products = ['O=C[C](F)OC(F)[CH]F(4355)'],
...
reaction(
    label = 'reaction32',
    reactants = ['FC=CO[C](F)[CH]OF(4807)'],
    products = ['O=C[C](F)OC(F)[CH]F(4355)'],
...
reaction(
    label = 'reaction33',
    reactants = ['F[CH]C(F)O[C]=COF(4808)'],
    products = ['O=C[C](F)OC(F)[CH]F(4355)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[O]C=[C]OC(F)C(F)F(4809)'],
    products = ['O=C[C](F)OC(F)[CH]F(4355)'],
