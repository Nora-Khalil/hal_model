...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.07756,'amu*angstrom^2'), symmetry=1, barrier=(24.7753,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07793,'amu*angstrom^2'), symmetry=1, barrier=(24.7836,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.42153,'amu*angstrom^2'), symmetry=1, barrier=(32.6838,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.41694,'amu*angstrom^2'), symmetry=1, barrier=(32.5783,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.42075,'amu*angstrom^2'), symmetry=1, barrier=(32.6657,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0432896,0.0821614,-0.000104446,6.06909e-08,-1.33223e-11,-48544.5,22.6006], Tmin=(100,'K'), Tmax=(1134.93,'K')), NASAPolynomial(coeffs=[22.02,0.00440025,-1.67097e-06,3.19937e-10,-2.3837e-14,-53552.5,-86.6343], Tmin=(1134.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-404.881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Csj(Cs-F1sF1sO2s)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.26494,'amu*angstrom^2'), symmetry=1, barrier=(29.0835,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26421,'amu*angstrom^2'), symmetry=1, barrier=(29.0668,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26313,'amu*angstrom^2'), symmetry=1, barrier=(29.0418,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.498196,0.0845043,-0.000100446,5.42307e-08,-1.09048e-11,-43979,27.1817], Tmin=(100,'K'), Tmax=(1339.65,'K')), NASAPolynomial(coeffs=[24.909,0.00135035,8.25714e-07,-2.29474e-10,1.6557e-14,-50132,-100.38], Tmin=(1339.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-367.111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Csj(Cs-F1sF1sO2s)(F1s)(H)) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]OC(F)(F)CF(2648)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.07619,'amu*angstrom^2'), symmetry=1, barrier=(24.7437,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07568,'amu*angstrom^2'), symmetry=1, barrier=(24.7319,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07494,'amu*angstrom^2'), symmetry=1, barrier=(24.715,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.930272,'amu*angstrom^2'), symmetry=1, barrier=(21.3888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.928925,'amu*angstrom^2'), symmetry=1, barrier=(21.3578,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.929526,'amu*angstrom^2'), symmetry=1, barrier=(21.3716,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['C=[C]OC(F)(F)[CH]F(2326)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)(F)[CH]F(841)', '[C]=C(976)'],
    products = ['C=[C]OC(F)(F)[CH]F(2326)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', 'C=[C]O[C](F)F(1702)'],
    products = ['C=[C]OC(F)(F)[CH]F(2326)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=[C]OC(F)=CF(2645)'],
    products = ['C=[C]OC(F)(F)[CH]F(2326)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#COC(F)(F)[CH]F(2646)'],
    products = ['C=[C]OC(F)(F)[CH]F(2326)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF(40)', 'C=[C]O[C](F)F(1702)'],
    products = ['C=[C]OC(F)(F)[CH]F(2326)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=COC(F)(F)[CH]F(2647)'],
    products = ['C=[C]OC(F)(F)[CH]F(2326)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C=[C]O[C](F)C(F)F(2639)'],
    products = ['C=[C]OC(F)(F)[CH]F(2326)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C=[C]OC(F)(F)[CH]F(2326)'],
    products = ['C=C(F)O[C](F)[CH]F(2649)'],
...
network(
    label = 'PDepNetwork #959',
    isomers = [
        'C=[C]OC(F)(F)[CH]F(2326)',
    ],
    reactants = [
        ('CHFCF2(55)', 'CH2CO(28)'),
    ],
