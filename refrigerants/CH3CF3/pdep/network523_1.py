...
"""),
    ...
    molecularWeight = (57.0281,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.42413,0.00697547,1.79194e-05,-2.83154e-08,1.1236e-11,-5411.34,9.61381], Tmin=(100,'K'), Tmax=(971.616,'K')), NASAPolynomial(coeffs=[7.22354,0.0055778,-1.91285e-06,3.80686e-10,-2.98308e-14,-6821.99,-12.0667], Tmin=(971.616,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-45.2073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(OCJC=O)"""),
)
...
"""),
    ...
    molecularWeight = (57.0281,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.52778,-0.000281289,4.61208e-05,-6.31241e-08,2.49193e-11,46170.1,13.1119], Tmin=(100,'K'), Tmax=(941.26,'K')), NASAPolynomial(coeffs=[9.63061,0.00104951,5.49347e-07,-7.23466e-11,-1.1986e-15,43813.4,-22.3773], Tmin=(941.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(383.657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(C=CJO)"""),
)
...
"""),
    ...
    molecularWeight = (57.0281,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.13918,0.0176283,-1.60884e-05,7.55195e-09,-1.4191e-12,1083.09,10.5973], Tmin=(100,'K'), Tmax=(1278.67,'K')), NASAPolynomial(coeffs=[6.84958,0.00602125,-2.47224e-06,4.52853e-10,-3.11141e-14,134.213,-8.21543], Tmin=(1278.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(8.73871,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(103.931,'J/(mol*K)'), label="""OCCOH""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['O=[C]C=O(1408)'],
    products = ['O=C1[CH]O1(10799)'],
    transitionState = 'TS3',
