...
"""),
    E0 = (-780.362,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([171,205,598,1104,1143,1317,1411,3153,361,769,965,1078,1132,1246,3247,3010,987.5,1337.5,450,1655,323,467,575,827,1418,180,180,683.831],'cm^-1')),
        HinderedRotor(inertia=(0.247211,'amu*angstrom^2'), symmetry=1, barrier=(5.68386,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.423113,'amu*angstrom^2'), symmetry=1, barrier=(9.72821,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.960537,0.0724724,-8.87459e-05,5.9366e-08,-1.6365e-11,-93751.2,26.8214], Tmin=(100,'K'), Tmax=(872.77,'K')), NASAPolynomial(coeffs=[10.3325,0.0295206,-1.49272e-05,2.98031e-09,-2.13856e-13,-95387.2,-17.1174], Tmin=(872.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-780.362,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CsCFFH) + group(CdCsCdF) + group(Cds-CdsCsH) + radical(O2sj(Cs-F1sCdH))"""),
)
...
"""),
    E0 = (-774.966,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([274,345,380,539,705,1166,1213,391,562,707,872,1109,1210,1289,3137,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.265175,'amu*angstrom^2'), symmetry=1, barrier=(6.0969,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.265005,'amu*angstrom^2'), symmetry=1, barrier=(6.09298,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.748226,0.0771567,-0.000100957,7.1041e-08,-2.03128e-11,-93094.7,26.6363], Tmin=(100,'K'), Tmax=(848.071,'K')), NASAPolynomial(coeffs=[11.1527,0.0280845,-1.41639e-05,2.81475e-09,-2.0108e-13,-94859.5,-21.8447], Tmin=(848.071,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-774.966,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + group(Cds-CdsCsH) + group(CdCFH) + radical(O2sj(Cs-CsF1sH))"""),
)

species(
    label = '[O]C(F)C(F)(F)C=C(F)F(7212)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-975.997,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([274,345,380,539,705,1166,1213,391,562,707,872,1109,1210,1289,3137,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.211578,'amu*angstrom^2'), symmetry=1, barrier=(4.86461,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (161.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.342965,0.0871913,-0.00012546,9.58742e-08,-2.94986e-11,-117260,29.0953], Tmin=(100,'K'), Tmax=(792.918,'K')), NASAPolynomial(coeffs=[11.9176,0.0287995,-1.4994e-05,2.99453e-09,-2.13578e-13,-119095,-24.0596], Tmin=(792.918,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-975.997,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + group(Cds-CdsCsH) + group(CdCFF) + radical(O2sj(Cs-CsF1sH))"""),
)
...
"""),
    E0 = (-534.785,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,271,519,563,612,1379,3010,987.5,1337.5,450,1655,180,180,383.252],'cm^-1')),
        HinderedRotor(inertia=(1.19213,'amu*angstrom^2'), symmetry=1, barrier=(27.4093,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0537971,'amu*angstrom^2'), symmetry=1, barrier=(27.4204,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04262,0.0620199,-6.04472e-05,2.89016e-08,-5.4737e-12,-64210.9,23.2876], Tmin=(100,'K'), Tmax=(1271.35,'K')), NASAPolynomial(coeffs=[15.0313,0.0180082,-8.52067e-06,1.67278e-09,-1.19445e-13,-67767.8,-47.5584], Tmin=(1271.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-534.785,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Allyl_S)"""),
)
...
species(
    label = 'O[C](F)C(F)(F)[CH]C(F)F(7213)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.573765,0.116447,-0.000218605,2.05121e-07,-7.26431e-11,-115685,34.7521], Tmin=(100,'K'), Tmax=(855.259,'K')), NASAPolynomial(coeffs=[9.15391,0.0370458,-1.98829e-05,3.86654e-09,-2.65354e-13,-116109,-3.40791], Tmin=(855.259,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-963.099,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsCsHH) + group(CsCFHO) + group(CsCsFFH) + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-F1sF1sCs)(F1s)(O2s-H))"""),
)

species(
    label = '[O]C(F)C(F)(F)C[C](F)F(7214)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.345508,0.105354,-0.000176171,1.54729e-07,-5.32834e-11,-112599,32.185], Tmin=(100,'K'), Tmax=(812.581,'K')), NASAPolynomial(coeffs=[11.4516,0.0333401,-1.74992e-05,3.43453e-09,-2.39563e-13,-114055,-19.4484], Tmin=(812.581,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-937.42,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsCsHH) + group(CsCFHO) + group(CsCsFFH) + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = '[O][C](F)C(F)(F)CC(F)F(7215)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.558851,0.116676,-0.000220138,2.07102e-07,-7.32162e-11,-113404,32.5053], Tmin=(100,'K'), Tmax=(862.781,'K')), NASAPolynomial(coeffs=[8.72029,0.0375559,-1.98192e-05,3.81955e-09,-2.60371e-13,-113662,-3.10494], Tmin=(862.781,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-944.131,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsCsHH) + group(CsCFHO) + group(CsCsFFH) + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sF1sCs)(F1s)(O2s-H))"""),
)

species(
    label = 'OC(F)C(F)(F)[CH][C](F)F(7216)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.345683,0.104945,-0.000173999,1.51947e-07,-5.24094e-11,-114880,34.3795], Tmin=(100,'K'), Tmax=(792.628,'K')), NASAPolynomial(coeffs=[11.8088,0.0329657,-1.76438e-05,3.50106e-09,-2.46194e-13,-116472,-19.3255], Tmin=(792.628,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-956.389,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsCsHH) + group(CsCFHO) + group(CsCsFFH) + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = 'FOC(F)[C](F)[CH]C(F)F(7217)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-607.463,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,487,638,688,1119,1325,1387,3149,522,611,926,1093,1137,1374,1416,3112,212,367,445,1450,3025,407.5,1350,352.5,180,180,203.404,1666.91],'cm^-1')),
        HinderedRotor(inertia=(0.263714,'amu*angstrom^2'), symmetry=1, barrier=(6.0633,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.263169,'amu*angstrom^2'), symmetry=1, barrier=(6.05078,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.45557,'amu*angstrom^2'), symmetry=1, barrier=(33.4665,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.45435,'amu*angstrom^2'), symmetry=1, barrier=(33.4383,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.152999,0.100928,-0.000164246,1.46409e-07,-5.24366e-11,-72920.6,34.8333], Tmin=(100,'K'), Tmax=(759.765,'K')), NASAPolynomial(coeffs=[10.1148,0.037517,-2.05889e-05,4.15217e-09,-2.95706e-13,-74210.8,-10.1053], Tmin=(759.765,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-607.463,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsCsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(Cs-F1sF1sH)(H))"""),
)

species(
    label = '[O]C(F)[C](F)C(F)C(F)F(7218)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-898.466,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,235,523,627,1123,1142,1372,1406,3097,391,562,707,872,1109,1210,1289,3137,212,367,445,1450,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.181485,'amu*angstrom^2'), symmetry=1, barrier=(4.1727,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.181764,'amu*angstrom^2'), symmetry=1, barrier=(4.17912,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.975196,'amu*angstrom^2'), symmetry=1, barrier=(22.4217,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.207871,0.0940551,-0.000129228,7.96167e-08,-1.0686e-11,-107934,31.7992], Tmin=(100,'K'), Tmax=(585.048,'K')), NASAPolynomial(coeffs=[11.8161,0.0324374,-1.67512e-05,3.30064e-09,-2.3229e-13,-109596,-20.5769], Tmin=(585.048,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-898.466,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(O2sj(Cs-CsF1sH)) + radical(CsCsCsF1s)"""),
)

species(
    label = 'FO[CH]C(F)(F)[CH]C(F)F(7219)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-632.882,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,522,611,926,1093,1137,1374,1416,3112,3000,3050,390,425,1340,1360,335,370,301.034,301.063,301.078,301.127],'cm^-1')),
        HinderedRotor(inertia=(0.0996377,'amu*angstrom^2'), symmetry=1, barrier=(6.40981,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.099659,'amu*angstrom^2'), symmetry=1, barrier=(6.40979,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.181828,'amu*angstrom^2'), symmetry=1, barrier=(11.6952,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.419439,'amu*angstrom^2'), symmetry=1, barrier=(26.9793,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.735468,0.113091,-0.000187255,1.58694e-07,-5.30101e-11,-75956.1,34.1553], Tmin=(100,'K'), Tmax=(779.575,'K')), NASAPolynomial(coeffs=[14.4468,0.0296574,-1.6072e-05,3.20036e-09,-2.25422e-13,-78155.1,-34.2314], Tmin=(779.575,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-632.882,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCsFFH) + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(H)) + radical(CCsJO)"""),
)

species(
    label = '[O][CH]C(F)(F)C(F)C(F)F(7220)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-928.011,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,215,315,519,588,595,1205,1248,235,523,627,1123,1142,1372,1406,3097,3025,407.5,1350,352.5,180,180,956.546,3162.22],'cm^-1')),
        HinderedRotor(inertia=(1.7806,'amu*angstrom^2'), symmetry=1, barrier=(40.9394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.78285,'amu*angstrom^2'), symmetry=1, barrier=(40.9913,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00580529,'amu*angstrom^2'), symmetry=1, barrier=(41.0197,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0260194,0.0982133,-0.000163485,1.50632e-07,-5.48589e-11,-111481,32.5842], Tmin=(100,'K'), Tmax=(798.251,'K')), NASAPolynomial(coeffs=[8.00536,0.0404752,-2.16269e-05,4.29587e-09,-3.02486e-13,-112190,-0.57039], Tmin=(798.251,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-928.011,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsCsFH) + group(Cs-CsOsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(CCOJ) + radical(Csj(Cs-F1sF1sCs)(O2s-H)(H))"""),
)

species(
    label = 'F[CH][CH]C(F)(F)C(F)OF(7221)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-614.032,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,261,493,600,1152,1365,1422,3097,3025,407.5,1350,352.5,334,575,1197,1424,3202,275.027,275.111,275.18,1837.29],'cm^-1')),
        HinderedRotor(inertia=(0.12616,'amu*angstrom^2'), symmetry=1, barrier=(6.77256,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126127,'amu*angstrom^2'), symmetry=1, barrier=(6.77304,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.612841,'amu*angstrom^2'), symmetry=1, barrier=(32.929,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.613081,'amu*angstrom^2'), symmetry=1, barrier=(32.929,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.594742,0.111858,-0.000190969,1.69857e-07,-5.9256e-11,-73696,33.7501], Tmin=(100,'K'), Tmax=(801.187,'K')), NASAPolynomial(coeffs=[11.8945,0.0347555,-1.90029e-05,3.78742e-09,-2.66444e-13,-75223.9,-20.781], Tmin=(801.187,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-614.032,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsCsHH) + group(CsCFHO) + group(CsCsFHH) + radical(Csj(Cs-F1sF1sCs)(Cs-F1sHH)(H)) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)

species(
    label = '[O]C(F)C(F)(F)C(F)[CH]F(7222)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-901.92,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,259,529,569,1128,1321,1390,3140,391,562,707,872,1109,1210,1289,3137,334,575,1197,1424,3202,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.343062,'amu*angstrom^2'), symmetry=1, barrier=(7.88767,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.343091,'amu*angstrom^2'), symmetry=1, barrier=(7.88834,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.536254,0.107648,-0.000172438,1.43039e-07,-4.69244e-11,-108320,31.9863], Tmin=(100,'K'), Tmax=(779.274,'K')), NASAPolynomial(coeffs=[14.0559,0.0293651,-1.52448e-05,2.99297e-09,-2.09503e-13,-110492,-34.1144], Tmin=(779.274,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-901.92,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)C(F)(F)[CH]C(F)F(6773)'],
    products = ['CHFO(47)', 'FC(F)=CC(F)F(344)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)C(F)(F)[CH]C(F)F(6773)'],
    products = ['[O]C(F)C([C](F)F)C(F)F(6774)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(F)[C](F)F(1072)', '[CH]C(F)F-2(957)'],
    products = ['[O]C(F)C(F)(F)[CH]C(F)F(6773)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[CH]C(F)(F)[CH]C(F)F(1054)'],
    products = ['[O]C(F)C(F)(F)[CH]C(F)F(6773)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)C(F)(F)[CH]C(F)F(6773)'],
    products = ['FC(F)C1OC(F)C1(F)F(6778)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)C(F)(F)[CH]C(F)F(6773)'],
    products = ['O=C(F)C(F)(F)CC(F)F(7109)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)C(F)(F)[CH]C(F)F(6773)'],
    products = ['OC(F)C(F)(F)C=C(F)F(6780)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(F)C(F)(F)C=C(F)F(7212)'],
    products = ['[O]C(F)C(F)(F)[CH]C(F)F(6773)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O][CH]F(2815)', 'F[C](F)[CH]C(F)F(1426)'],
    products = ['[O]C(F)C(F)(F)[CH]C(F)F(6773)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(78)', '[O]C=C(F)[CH]C(F)F(6920)'],
    products = ['[O]C(F)C(F)(F)[CH]C(F)F(6773)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(21.5427,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction17',
    reactants = ['HF(38)', '[O]C(F)=C(F)[CH]C(F)F(6997)'],
    products = ['[O]C(F)C(F)(F)[CH]C(F)F(6773)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(264.326,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction18',
    reactants = ['[O]C(F)C(F)(F)[CH]C(F)F(6773)'],
    products = ['O[C](F)C(F)(F)[CH]C(F)F(7213)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)C(F)(F)[CH]C(F)F(6773)'],
    products = ['[O]C(F)C(F)(F)C[C](F)F(7214)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(F)C(F)(F)[CH]C(F)F(6773)'],
    products = ['[O][C](F)C(F)(F)CC(F)F(7215)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C(F)C(F)(F)[CH]C(F)F(6773)'],
    products = ['OC(F)C(F)(F)[CH][C](F)F(7216)'],
...
reaction(
    label = 'reaction22',
    reactants = ['FOC(F)[C](F)[CH]C(F)F(7217)'],
    products = ['[O]C(F)C(F)(F)[CH]C(F)F(6773)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(98.3396,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction23',
    reactants = ['[O]C(F)[C](F)C(F)C(F)F(7218)'],
    products = ['[O]C(F)C(F)(F)[CH]C(F)F(6773)'],
...
reaction(
    label = 'reaction24',
    reactants = ['FO[CH]C(F)(F)[CH]C(F)F(7219)'],
    products = ['[O]C(F)C(F)(F)[CH]C(F)F(6773)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O][CH]C(F)(F)C(F)C(F)F(7220)'],
    products = ['[O]C(F)C(F)(F)[CH]C(F)F(6773)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(226.538,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction26',
    reactants = ['F[CH][CH]C(F)(F)C(F)OF(7221)'],
    products = ['[O]C(F)C(F)(F)[CH]C(F)F(6773)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(75.7534,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

reaction(
    label = 'reaction27',
    reactants = ['[O]C(F)C(F)(F)C(F)[CH]F(7222)'],
    products = ['[O]C(F)C(F)(F)[CH]C(F)F(6773)'],
...
network(
    label = 'PDepNetwork #2089',
    isomers = [
        '[O]C(F)C(F)(F)[CH]C(F)F(6773)',
    ],
    reactants = [
        ('CHFO(47)', 'FC(F)=CC(F)F(344)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
