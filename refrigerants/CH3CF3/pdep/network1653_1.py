...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.282878,'amu*angstrom^2'), symmetry=1, barrier=(6.50392,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.282458,'amu*angstrom^2'), symmetry=1, barrier=(6.49426,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.43077,'amu*angstrom^2'), symmetry=1, barrier=(32.8963,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (133.022,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'OC(F)OF(5774)'],
    products = ['FOC(F)OC(F)F(5763)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'FOC(F)OF(5775)'],
    products = ['FOC(F)OC(F)F(5763)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'FO[CH]OC(F)F(691)'],
    products = ['FOC(F)OC(F)F(5763)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[CH]OC(F)OF(5776)'],
    products = ['FOC(F)OC(F)F(5763)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(F)OC(F)F(5777)'],
    products = ['FOC(F)OC(F)F(5763)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[CH]OF(3905)', '[O]C(F)F(207)'],
    products = ['FOC(F)OC(F)F(5763)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CHF2(82)', '[O]C(F)OF(5778)'],
    products = ['FOC(F)OC(F)F(5763)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(127)', 'F[CH]OC(F)F(5750)'],
    products = ['FOC(F)OC(F)F(5763)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'FO[C](F)OC(F)F(663)'],
    products = ['FOC(F)OC(F)F(5763)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'FOC(F)O[C](F)F(5779)'],
    products = ['FOC(F)OC(F)F(5763)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=C(F)OC(F)F(669)'],
    products = ['FOC(F)OC(F)F(5763)'],
