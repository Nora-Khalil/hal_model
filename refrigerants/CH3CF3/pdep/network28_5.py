...
reaction(
    label = 'reaction4',
    reactants = ['[O]C[C](F)F(174)'],
    products = ['FC1(F)CO1(165)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction21',
    reactants = ['[O][C](F)F(263)', 'CH2(T)(18)'],
    products = ['[CH2]C([O])(F)F(162)'],
...
reaction(
    label = 'reaction37',
    reactants = ['HF(38)', 'O=C[C]F-2(1228)'],
    products = ['O=CC(F)F(423)'],
