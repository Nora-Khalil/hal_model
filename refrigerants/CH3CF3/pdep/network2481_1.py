...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(790)', 'O[C]F(2847)'],
    products = ['[O]C(=O)O[C](O)F(2211)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]C(=O)OC(=O)F(2213)'],
    products = ['[O]C(=O)O[C](O)F(2211)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C([O])=O(790)', '[OH+]=[C-]F(2848)'],
    products = ['[O]C(=O)O[C](O)F(2211)'],
