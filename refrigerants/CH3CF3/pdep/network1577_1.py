...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', '[CH2]C([O])F(5619)'],
    products = ['[O]C(F)C[C](F)F(4412)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)C=C(F)F(5621)'],
    products = ['[O]C(F)C[C](F)F(4412)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)C[C](F)F(269)'],
    products = ['[O]C(F)C[C](F)F(4412)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', '[CH2]C([O])F(5619)'],
    products = ['[O]C(F)C[C](F)F(4412)'],
