...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'O=C(O)O(2094)'],
    products = ['O=C(O)OCF(2053)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=C(O)OF(1860)', 'CH2(S)(25)'],
    products = ['O=C(O)OCF(2053)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]OC(=O)O(2098)'],
    products = ['O=C(O)OCF(2053)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)O(1583)', 'CH2F(46)'],
    products = ['O=C(O)OCF(2053)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(O)O[CH]F(2101)'],
    products = ['O=C(O)OCF(2053)'],
