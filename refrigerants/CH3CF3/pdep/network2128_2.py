...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'O[C]F(2847)'],
    products = ['O[C](F)F(206)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'CHF2(82)'],
    products = ['[O]C(F)F(207)'],
    transitionState = 'TS8',
