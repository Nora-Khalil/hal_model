...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(138)', 'C=[C]O[O](2005)'],
    products = ['C=[C]OO[C](F)F(1776)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[C](F)F(163)', '[C]=C(976)'],
    products = ['C=[C]OO[C](F)F(1776)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'C#COO[C](F)F(2006)'],
    products = ['C=[C]OO[C](F)F(1776)'],
    transitionState = 'TS7',
