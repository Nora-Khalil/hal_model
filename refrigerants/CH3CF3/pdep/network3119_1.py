...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C[CH]F(856)'],
    products = ['[O]OC[CH]F(421)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', '[CH2]O[O](175)'],
    products = ['[O]OC[CH]F(421)'],
    transitionState = 'TS3',
