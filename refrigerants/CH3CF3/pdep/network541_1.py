...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C]CC(F)F-2(1500)'],
    products = ['F[C](F)CC(F)F(348)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[C](F)[CH]C(F)F(1501)'],
    products = ['F[C](F)CC(F)F(348)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'F[CH]C=C(F)F(1369)'],
    products = ['F[C](F)CC(F)F(348)'],
