...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(192)', '[O]C(F)[CH]F(834)'],
    products = ['O=[C]OC(F)[CH]F(1623)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', 'O=[C]O[CH]F(1292)'],
    products = ['O=[C]OC(F)[CH]F(1623)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[O]C(F)[CH]F(834)'],
    products = ['O=[C]OC(F)[CH]F(1623)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=[C]OC(F)=CF(1298)'],
    products = ['O=[C]OC(F)[CH]F(1623)'],
