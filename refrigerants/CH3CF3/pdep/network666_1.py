...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(999)', '[O]C[C](F)F(174)'],
    products = ['C=[C]OC[C](F)F(1646)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', '[CH2]O[C]=C(1700)'],
    products = ['C=[C]OC[C](F)F(1646)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C=[C]OC=C(F)F(1702)'],
    products = ['C=[C]OC[C](F)F(1646)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[CH2]O[C]=C(1700)'],
    products = ['C=[C]OC[C](F)F(1646)'],
