species(
    label = 'O=C(F)[CH]OC(F)[C]=C(F)F(5255)',
...
species(
    label = 'O=C(F)COC(F)=C=C(F)F(5397)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
4  F u0 p3 c0 {10,S}
...
species(
    label = 'F[C]1OC1OC(F)[C]=C(F)F(5398)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = 'O=C(F)[CH]OC=C=C(F)F(5401)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'O=C(F)[CH]OC(F)=C=C(F)F(5402)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = 'O=C(F)[CH]OC(F)=C[C](F)F(5405)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = 'O=C(F)COC(F)=[C][C](F)F(5406)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = 'O=C(F)C(F)O[CH][C]=C(F)F(5407)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = 'O=C(F)[CH]O[CH]C(F)=C(F)F(5408)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = '[O][C]=COC(F)C(F)=C(F)F(5409)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'O=C(F)C(F)OC(F)[C]=[C]F(5410)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'O=C(F)[CH]OC(F)C(F)=[C]F(5411)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = 'OC(F)=[C]OC(F)[C]=C(F)F(5416)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = '[O]C(F)=[C]OC(F)C=C(F)F(5417)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'OC(F)=CO[C](F)[C]=C(F)F(5418)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = 'FOC(F)=CO[CH][C]=C(F)F(5419)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = 'F[C]=[C]C(F)OC=C(F)OF(5421)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {6,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)[CH]OC(F)[C]=C(F)F(5255)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F(537)', '[O]C(F)[C]=C(F)F(3188)'],
    products = ['O=C(F)[CH]OC(F)[C]=C(F)F(5255)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(F)F(1205)', 'O=C(F)[CH]O[CH]F(4523)'],
    products = ['O=C(F)[CH]OC(F)[C]=C(F)F(5255)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O=C(F)[CH]OC(F)[C]=C(F)F(5255)'],
    products = ['O=C(F)COC(F)=C=C(F)F(5397)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O=C(F)[CH]OC(F)[C]=C(F)F(5255)'],
    products = ['F[C]1OC1OC(F)[C]=C(F)F(5398)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=C(F)[CH]OC=C=C(F)F(5401)'],
    products = ['O=C(F)[CH]OC(F)[C]=C(F)F(5255)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)[CH]OC(F)=C=C(F)F(5402)'],
    products = ['O=C(F)[CH]OC(F)[C]=C(F)F(5255)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O=C=COC(F)[C]=C(F)F(5403)'],
    products = ['O=C(F)[CH]OC(F)[C]=C(F)F(5255)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'O=C(F)[CH]OC(F)C#CF(5404)'],
    products = ['O=C(F)[CH]OC(F)[C]=C(F)F(5255)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=C(F)[CH]OC(F)[C]=C(F)F(5255)'],
    products = ['O=C(F)[CH]OC(F)=C[C](F)F(5405)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=C(F)[CH]OC(F)[C]=C(F)F(5255)'],
    products = ['O=C(F)COC(F)=[C][C](F)F(5406)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=C(F)[CH]OC(F)[C]=C(F)F(5255)'],
    products = ['O=C(F)C(F)O[CH][C]=C(F)F(5407)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=C(F)[CH]OC(F)[C]=C(F)F(5255)'],
    products = ['O=C(F)[CH]O[CH]C(F)=C(F)F(5408)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O=C(F)[CH]OC(F)[C]=C(F)F(5255)'],
    products = ['[O][C]=COC(F)C(F)=C(F)F(5409)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O=C(F)C(F)OC(F)[C]=[C]F(5410)'],
    products = ['O=C(F)[CH]OC(F)[C]=C(F)F(5255)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O=C(F)[CH]OC(F)C(F)=[C]F(5411)'],
    products = ['O=C(F)[CH]OC(F)[C]=C(F)F(5255)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O(6)', 'F[C]=COC(F)[C]=C(F)F(5412)'],
    products = ['O=C(F)[CH]OC(F)[C]=C(F)F(5255)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O=C(F)[CH]OC(F)[C]=C(F)F(5255)'],
    products = ['OC(F)=COC(F)=C=C(F)F(5414)'],
...
reaction(
    label = 'reaction30',
    reactants = ['OC(F)=[C]OC(F)[C]=C(F)F(5416)'],
    products = ['O=C(F)[CH]OC(F)[C]=C(F)F(5255)'],
...
reaction(
    label = 'reaction31',
    reactants = ['O=C(F)[CH]OC(F)[C]=C(F)F(5255)'],
    products = ['[O]C(F)=[C]OC(F)C=C(F)F(5417)'],
...
reaction(
    label = 'reaction32',
    reactants = ['OC(F)=CO[C](F)[C]=C(F)F(5418)'],
    products = ['O=C(F)[CH]OC(F)[C]=C(F)F(5255)'],
...
reaction(
    label = 'reaction33',
    reactants = ['FOC(F)=CO[CH][C]=C(F)F(5419)'],
    products = ['O=C(F)[CH]OC(F)[C]=C(F)F(5255)'],
...
reaction(
    label = 'reaction34',
    reactants = ['FO[C]=COC(F)[C]=C(F)F(5420)'],
    products = ['O=C(F)[CH]OC(F)[C]=C(F)F(5255)'],
...
reaction(
    label = 'reaction35',
    reactants = ['F[C]=[C]C(F)OC=C(F)OF(5421)'],
    products = ['O=C(F)[CH]OC(F)[C]=C(F)F(5255)'],
...
network(
    label = 'PDepNetwork #1534',
    isomers = [
        'O=C(F)[CH]OC(F)[C]=C(F)F(5255)',
    ],
    reactants = [
