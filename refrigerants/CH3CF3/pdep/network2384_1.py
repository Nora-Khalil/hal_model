...
"""),
    ...
    molecularWeight = (75.0434,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.04175,0.00219273,7.91678e-05,-1.07875e-07,4.17851e-11,22165.8,16.4433], Tmin=(100,'K'), Tmax=(959.26,'K')), NASAPolynomial(coeffs=[13.712,0.00574221,-1.50799e-06,4.03374e-10,-4.12574e-14,17908.3,-46.1122], Tmin=(959.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(183.868,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Cs_P)"""),
)

species(
    label = 'CC1([O])OO1(9000)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    ...
    molecularWeight = (75.0434,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.85844,0.0202086,6.29537e-06,-2.44207e-08,1.20915e-11,-2030.61,15.344], Tmin=(100,'K'), Tmax=(880.136,'K')), NASAPolynomial(coeffs=[7.7499,0.0117957,-2.91581e-06,3.93847e-10,-2.3687e-14,-3426.82,-10.6703], Tmin=(880.136,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-17.2638,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsHHH) + ring(dioxirane) + radical(CCOJ)"""),
)

species(
    label = 'C=C(O)O[O](8534)',
    structure = adjacencyList("""multiplicity 2
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'CO[O](412)'],
    products = ['CC(=O)O[O](8535)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(0.000742267,'m^3/(mol*s)'), n=2.83796, Ea=(214.053,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.2632766423807829, var=145.9379134136138, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-1COCbCdCsCtHNOSSidSis->Cs',), comment="""Estimated from node Root_N-1COCbCdCsCtHNOSSidSis->Cs"""),
)

reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'CC([O])=O(1761)'],
    products = ['CC(=O)O[O](8535)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CC(=O)O[O](8535)'],
    products = ['C[C]1OOO1(8999)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.503e+11,'s^-1'), n=0.221, Ea=(357.329,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_CO;carbonyl_intra;radadd_intra_O] for rate rule [R4_S_CO;carbonyl_intra_Nd;radadd_intra_O]
Euclidian distance = 1.0
family: Intra_R_Add_Endocyclic
Ea raised from 353.6 to 357.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['CC(=O)O[O](8535)'],
    products = ['CC1([O])OO1(9000)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(7.785e+11,'s^-1'), n=0.342, Ea=(156.198,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_O] for rate rule [R4_S_CO;carbonylbond_intra_Nd;radadd_intra_O]
...
This reaction matched rate rule [Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Sp-4R!H-2C_Ext-2C-R_N-5R!H->C]
family: R_Recombination"""),
)

reaction(
    label = 'reaction8',
    reactants = ['[O]O[C]=O(785)', 'CH3(19)'],
    products = ['CC(=O)O[O](8535)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(=O)O[O](1575)'],
    products = ['CC(=O)O[O](8535)'],
    transitionState = 'TS9',
