...
"""),
    ...
    molecularWeight = (108.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8945,0.0498955,-3.99544e-05,1.72582e-08,-3.22646e-12,-37976.1,18.0452], Tmin=(100,'K'), Tmax=(1201.06,'K')), NASAPolynomial(coeffs=[8.21553,0.0288441,-1.36634e-05,2.66496e-09,-1.88897e-13,-39494.5,-13.6082], Tmin=(1201.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-316.356,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', '[CH]C=CF(4557)'],
    products = ['[CH]=CC(F)[C](F)F(3482)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=CC=C(F)F(1859)'],
    products = ['[CH]=CC(F)[C](F)F(3482)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=CC(F)=C(F)F(4560)'],
    products = ['[CH]=CC(F)[C](F)F(3482)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C#CC(F)[C](F)F(1124)'],
    products = ['[CH]=CC(F)[C](F)F(3482)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH]=C=C[C](F)F(501)'],
    products = ['[CH]=CC(F)[C](F)F(3482)'],
