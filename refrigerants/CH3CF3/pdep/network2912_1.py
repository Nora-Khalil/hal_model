...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', '[CH2]C(F)OF(3071)'],
    products = ['OCC(F)OF(6733)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(127)', 'OC[CH]F(11366)'],
    products = ['OCC(F)OF(6733)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]OF(2746)', 'CH2OH(33)'],
    products = ['OCC(F)OF(6733)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'O[CH]C(F)OF(11367)'],
    products = ['OCC(F)OF(6733)'],
