...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[O]OC(F)(F)F(511)'],
    products = ['[O]OOOC(F)(F)F(7745)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[O]OOC(F)(F)F(8865)'],
    products = ['[O]OOOC(F)(F)F(7745)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OOOC(F)(F)F(7745)'],
    products = ['[O-][O+]=O(1597)', 'CF3O(48)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[O]OOO[C](F)F(1594)'],
    products = ['[O]OOOC(F)(F)F(7745)'],
    transitionState = 'TS5',
