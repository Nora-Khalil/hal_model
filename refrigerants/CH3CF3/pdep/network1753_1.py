...
species(
    label = 'C=[C]O[C]1C(F)C1(F)F(6320)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
reaction(
    label = 'reaction1',
    reactants = ['C=[C]OC([CH]F)=C(F)F(6169)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(976)', 'O=C([CH]F)[C](F)F(3211)'],
    products = ['C=[C]OC([CH]F)=C(F)F(6169)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', 'C=[C]O[C]=C(F)F(6319)'],
    products = ['C=[C]OC([CH]F)=C(F)F(6169)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['C=[C]OC([CH]F)=C(F)F(6169)'],
    products = ['C=[C]O[C]1C(F)C1(F)F(6320)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C#COC([CH]F)=C(F)F(6323)'],
    products = ['C=[C]OC([CH]F)=C(F)F(6169)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', 'C=[C]O[C]=C(F)F(6319)'],
    products = ['C=[C]OC([CH]F)=C(F)F(6169)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=COC([CH]F)=C(F)F(6324)'],
    products = ['C=[C]OC([CH]F)=C(F)F(6169)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C=[C]OC(=[C]F)C(F)F(6326)'],
    products = ['C=[C]OC([CH]F)=C(F)F(6169)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[C]F(138)', 'C=[C]O[C]=CF(5890)'],
    products = ['C=[C]OC([CH]F)=C(F)F(6169)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CF2(43)', 'C=[C]O[C]=CF(5890)'],
    products = ['C=[C]OC([CH]F)=C(F)F(6169)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C=[C]OC([CH]F)=C(F)F(6169)'],
    products = ['C#CO[C]([CH]F)C(F)F(6330)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C=[C]OC([CH]F)=C(F)F(6169)'],
    products = ['[CH]=C(O[C]=C)C(F)(F)F(6331)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C=[C]OC([CH]F)=C(F)F(6169)'],
    products = ['[CH]C(OC(=C)F)=C(F)F(6332)'],
...
network(
    label = 'PDepNetwork #1753',
    isomers = [
        'C=[C]OC([CH]F)=C(F)F(6169)',
    ],
    reactants = [
