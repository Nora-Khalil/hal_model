...
"""),
    ...
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28903,0.0615959,-7.69707e-05,4.93868e-08,-1.25701e-11,-68317.4,23.9334], Tmin=(100,'K'), Tmax=(959.394,'K')), NASAPolynomial(coeffs=[11.8441,0.0175885,-8.16519e-06,1.57467e-09,-1.11074e-13,-70342.7,-26.551], Tmin=(959.394,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-568.821,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CsCdFFF) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ)"""),
)

species(
    label = '[O]OC(F)(F)C=CF(2957)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7194,0.0522802,-5.05687e-05,2.48903e-08,-5.01859e-12,-58059.4,22.257], Tmin=(100,'K'), Tmax=(1169.11,'K')), NASAPolynomial(coeffs=[10.8064,0.0211902,-1.06796e-05,2.14425e-09,-1.54661e-13,-60184.1,-23.0022], Tmin=(1169.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-483.401,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCsFFH) + ring(Cs-Cs(F)-O2s-O2s) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.221424,'amu*angstrom^2'), symmetry=1, barrier=(21.8863,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0391883,'amu*angstrom^2'), symmetry=1, barrier=(83.1958,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72272,0.0465523,-4.43954e-05,2.10584e-08,-3.9531e-12,-23852.8,23.0759], Tmin=(100,'K'), Tmax=(1286.42,'K')), NASAPolynomial(coeffs=[12.3343,0.013557,-5.92238e-06,1.12053e-09,-7.84683e-14,-26583,-30.7916], Tmin=(1286.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-199.029,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(CdCFF) + radical(ROOJ) + radical(C=CCJO)"""),
)

species(
    label = '[O]OC(F)C=[C]F(9483)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {7,S}
3 O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.587179,'amu*angstrom^2'), symmetry=1, barrier=(13.5004,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.585669,'amu*angstrom^2'), symmetry=1, barrier=(13.4657,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38686,0.0629542,-0.000101388,8.7751e-08,-3.00558e-11,-11646.9,22.2839], Tmin=(100,'K'), Tmax=(805.614,'K')), NASAPolynomial(coeffs=[8.36246,0.0213407,-1.09125e-05,2.12787e-09,-1.48247e-13,-12544.3,-8.45603], Tmin=(805.614,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-97.5762,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(CsCFHO) + group(Cds-CdsCsH) + group(CdCFH) + radical(ROOJ) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.960379,0.0715783,-9.66181e-05,6.65341e-08,-1.82764e-11,-52225.1,24.5102], Tmin=(100,'K'), Tmax=(887.508,'K')), NASAPolynomial(coeffs=[12.2008,0.0209182,-1.0997e-05,2.21893e-09,-1.59854e-13,-54220.3,-28.377], Tmin=(887.508,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-435.1,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(CsCFHO) + group(Cds-CdsCsH) + group(CdCFF) + radical(Cdj(Cs-F1sO2sH)(Cd-F1sF1s))"""),
)

species(
    label = 'FOO[CH]C=C(F)F(9484)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20463,0.0585439,-5.78481e-05,2.76731e-08,-5.2247e-12,-30654.6,25.5588], Tmin=(100,'K'), Tmax=(1277.09,'K')), NASAPolynomial(coeffs=[14.8058,0.0159436,-7.81246e-06,1.55365e-09,-1.11649e-13,-34128.6,-43.3857], Tmin=(1277.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-255.733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sFO) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(CdCFF) + radical(C=CCJO)"""),
)

species(
    label = 'F[C]=CC(F)OOF(9485)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'F[CH]C=C(F)F(1320)'],
    products = ['[O]OC(F)C=C(F)F(2956)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['HO2(11)', 'F[C]C=C(F)F-2(1319)'],
    products = ['[O]OC(F)C=C(F)F(2956)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', '[O]OC=C(F)F(177)'],
    products = ['[O]OC(F)C=C(F)F(2956)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OC(F)C=C(F)F(2956)'],
    products = ['[O]OC=CC(F)(F)F(9481)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[O]C(F)C=C(F)F(5621)'],
    products = ['[O]OC(F)C=C(F)F(2956)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]OC(F)C=C(F)F(2956)'],
    products = ['HO2(11)', 'FC=C=C(F)F(1325)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]OC(F)C=C(F)F(2956)'],
    products = ['FC1[CH]C(F)(F)OO1(9474)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]O[CH]C=C(F)F(9482)'],
    products = ['[O]OC(F)C=C(F)F(2956)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]OC(F)C=[C]F(9483)'],
    products = ['[O]OC(F)C=C(F)F(2956)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]O[CH]F(893)', 'CF2CH(73)'],
    products = ['[O]OC(F)C=C(F)F(2956)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]OC(F)=C[C](F)F(3915)'],
    products = ['[O]OC(F)C=C(F)F(2956)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]OC(F)[C]=C(F)F(2995)'],
    products = ['[O]OC(F)C=C(F)F(2956)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[O]OC=C=C(F)F(3912)'],
    products = ['[O]OC(F)C=C(F)F(2956)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[O]OC(F)C#CF(3914)'],
    products = ['[O]OC(F)C=C(F)F(2956)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]OC(F)C=C(F)F(2956)'],
    products = ['OH(7)', 'O=C(F)C=C(F)F(986)'],
...
network(
    label = 'PDepNetwork #2763',
    isomers = [
        '[O]OC(F)C=C(F)F(2956)',
    ],
    reactants = [
        ('O2(2)', 'F[CH]C=C(F)F(1320)'),
        ('HO2(11)', 'F[C]C=C(F)F-2(1319)'),
        ('HO2(11)', 'FC=C=C(F)F(1325)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
