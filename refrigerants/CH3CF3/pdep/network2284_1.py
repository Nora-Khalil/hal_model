...
"""),
    E0 = (3.24426,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,209.816,210.852,1893.71],'cm^-1')),
        HinderedRotor(inertia=(0.109779,'amu*angstrom^2'), symmetry=1, barrier=(3.25379,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0958794,'amu*angstrom^2'), symmetry=1, barrier=(3.27621,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.27005,0.0413379,-4.22396e-05,3.35686e-08,-1.25327e-11,449.385,19.3025], Tmin=(100,'K'), Tmax=(728.848,'K')), NASAPolynomial(coeffs=[3.76815,0.0303928,-1.41095e-05,2.71181e-09,-1.90208e-13,303.342,13.045], Tmin=(728.848,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(3.24426,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCOJ)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.063,0.0306914,-6.02102e-05,7.38363e-08,-3.15451e-11,4234.93,14.9105], Tmin=(100,'K'), Tmax=(854.479,'K')), NASAPolynomial(coeffs=[-2.91927,0.0321475,-1.6162e-05,3.10896e-09,-2.13695e-13,6226.46,48.5019], Tmin=(854.479,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.0118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCOJ)"""),
)
...
"""),
    E0 = (152.731,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,1352.64,2182.65],'cm^-1')),
        HinderedRotor(inertia=(0.00396491,'amu*angstrom^2'), symmetry=1, barrier=(5.16495,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.220644,'amu*angstrom^2'), symmetry=1, barrier=(5.07304,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (58.0791,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.10997,0.016427,1.17433e-05,-1.70303e-08,5.13351e-12,18403.8,17.5215], Tmin=(100,'K'), Tmax=(1242.45,'K')), NASAPolynomial(coeffs=[4.47927,0.0232158,-9.97091e-06,1.87455e-09,-1.29964e-13,17199.3,7.14024], Tmin=(1242.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(152.731,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CCOJ) + radical(CCJCO)"""),
)
...
"""),
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.38447,0.0300757,-3.76583e-06,-9.86608e-09,4.14111e-12,-6207.69,12.7849], Tmin=(100,'K'), Tmax=(1165.03,'K')), NASAPolynomial(coeffs=[7.46432,0.0237445,-9.91845e-06,1.83996e-09,-1.27316e-13,-8145.29,-15.7341], Tmin=(1165.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-52.1343,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxetane)"""),
)
...
"""),
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31585,0.0273731,1.25886e-05,-3.52393e-08,1.5134e-11,-44816.9,20.2503], Tmin=(100,'K'), Tmax=(987.558,'K')), NASAPolynomial(coeffs=[10.6723,0.0166463,-6.2357e-06,1.17476e-09,-8.55395e-14,-47594.9,-25.6683], Tmin=(987.558,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-373.205,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cds-OdCsH)"""),
)
...
"""),
    E0 = (-131.41,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2782.5,750,1395,475,1775,1000,661.985],'cm^-1')),
        HinderedRotor(inertia=(0.126519,'amu*angstrom^2'), symmetry=1, barrier=(10.9686,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.478807,'amu*angstrom^2'), symmetry=1, barrier=(11.0087,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11936,0.0370675,-2.64547e-05,9.60026e-09,-1.41472e-12,-15733.8,17.9995], Tmin=(100,'K'), Tmax=(1578.3,'K')), NASAPolynomial(coeffs=[10.4153,0.0160424,-6.47264e-06,1.15995e-09,-7.77924e-14,-18352.5,-25.8097], Tmin=(1578.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-131.41,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), label="""CH3CHOCHO""", comment="""Thermo library: DFT_QCI_thermo"""),
)

species(
    label = 'C[C](O)C[O](8269)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86133,0.0552048,-8.93877e-05,8.63858e-08,-3.2054e-11,-6003.24,20.3814], Tmin=(100,'K'), Tmax=(856.58,'K')), NASAPolynomial(coeffs=[2.93623,0.0314137,-1.4854e-05,2.79316e-09,-1.8994e-13,-5498.72,19.3819], Tmin=(856.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-50.4887,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJOH)"""),
)

species(
    label = 'CC([O])[CH]O(8270)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {5,S} {11,S}
2  O u1 p2 c0 {3,S}
...
"""),
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68986,0.0521771,-5.85792e-05,3.66864e-08,-9.35821e-12,-4989.01,20.0755], Tmin=(100,'K'), Tmax=(948.759,'K')), NASAPolynomial(coeffs=[9.18449,0.0205795,-8.62305e-06,1.58361e-09,-1.08566e-13,-6411.13,-15.6876], Tmin=(948.759,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-42.163,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C(O)C[O](8271)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (-15.5274,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,232.277,1788.77],'cm^-1')),
        HinderedRotor(inertia=(0.129365,'amu*angstrom^2'), symmetry=1, barrier=(4.84616,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127854,'amu*angstrom^2'), symmetry=1, barrier=(4.83965,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128337,'amu*angstrom^2'), symmetry=1, barrier=(4.84188,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87809,0.0514667,-7.13281e-05,6.22192e-08,-2.20891e-11,-1795.74,21.5317], Tmin=(100,'K'), Tmax=(823.38,'K')), NASAPolynomial(coeffs=[5.03929,0.0277103,-1.27483e-05,2.39972e-09,-1.64653e-13,-2031.6,8.62408], Tmin=(823.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-15.5274,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CJCO)"""),
)

species(
    label = 'CC(O)[CH][O](8272)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {11,S}
2  O u1 p2 c0 {5,S}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7865,0.0547166,-8.17183e-05,7.39183e-08,-2.64732e-11,-5557.1,20.7757], Tmin=(100,'K'), Tmax=(843.241,'K')), NASAPolynomial(coeffs=[4.72126,0.0285041,-1.32259e-05,2.48227e-09,-1.69318e-13,-5615.05,9.70872], Tmin=(843.241,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-46.8186,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOH)"""),
)
...
"""),
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71404,0.053296,-6.86428e-05,5.26132e-08,-1.66184e-11,-5432.98,19.8608], Tmin=(100,'K'), Tmax=(801.021,'K')), NASAPolynomial(coeffs=[7.41738,0.0234607,-1.02359e-05,1.8911e-09,-1.28921e-13,-6303.21,-6.11779], Tmin=(801.021,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-45.8331,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C([O])CO(8274)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (-10.8718,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,381.798,381.808],'cm^-1')),
        HinderedRotor(inertia=(0.00115657,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0805267,'amu*angstrom^2'), symmetry=1, barrier=(8.33024,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0805282,'amu*angstrom^2'), symmetry=1, barrier=(8.32978,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73893,0.0494775,-5.03168e-05,2.79753e-08,-6.32001e-12,-1225.91,20.9805], Tmin=(100,'K'), Tmax=(1066.61,'K')), NASAPolynomial(coeffs=[9.79202,0.0192767,-7.84461e-06,1.42871e-09,-9.78168e-14,-2943.81,-18.3903], Tmin=(1066.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-10.8718,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CC[O](218)'],
    products = ['CC([O])C[O](8243)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][O](194)', 'C[CH][O](1870)'],
    products = ['CC([O])C[O](8243)'],
