...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(192)', '[O]C([O])=O(790)'],
    products = ['[O]C(=O)O[C]=O(1618)'],
    transitionState = 'TS2',
