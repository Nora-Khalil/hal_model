...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(127)', '[CH2]C(=O)O(2073)'],
    products = ['O=C(O)COF(2055)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]O(457)', '[CH2]OF(222)'],
    products = ['O=C(O)COF(2055)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C(O)[CH]OF(2076)'],
    products = ['O=C(O)COF(2055)'],
