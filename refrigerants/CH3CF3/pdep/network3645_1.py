...
"""),
    E0 = (-491.033,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([219,296,586,564,718,793,1177,1228,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,180,180,2295.12],'cm^-1')),
        HinderedRotor(inertia=(1.23703,'amu*angstrom^2'), symmetry=1, barrier=(28.4418,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.507493,'amu*angstrom^2'), symmetry=1, barrier=(11.6683,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.115713,0.0846846,-9.75602e-05,5.61163e-08,-1.26955e-11,-116512,26.6202], Tmin=(100,'K'), Tmax=(1079.41,'K')), NASAPolynomial(coeffs=[17.1688,0.02149,-9.74101e-06,1.87669e-09,-1.33005e-13,-120193,-56.9538], Tmin=(1079.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-969.903,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCdFFF) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + group(CdCFH)"""),
)
...
"""),
    E0 = (-714.193,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([219,296,586,564,718,793,1177,1228,350,440,435,1725,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,167,640,1190,243.645,244.005],'cm^-1')),
        HinderedRotor(inertia=(0.2431,'amu*angstrom^2'), symmetry=1, barrier=(10.2975,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244275,'amu*angstrom^2'), symmetry=1, barrier=(10.3006,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (157.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0238346,0.0922107,-0.000131366,9.47031e-08,-2.68621e-11,-85758.6,26.8861], Tmin=(100,'K'), Tmax=(866.153,'K')), NASAPolynomial(coeffs=[15.0555,0.022791,-1.1142e-05,2.1662e-09,-1.52306e-13,-88362.4,-43.4725], Tmin=(866.153,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-714.193,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCdFFF) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + group(CdCFH) + radical(Cdj(Cd-CdH)(F1s))"""),
)
...
species(
    label = 'FC#CC([CH]F)C(F)(F)F(12178)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-633.975,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,193,295,551,588,656,1146,1192,1350,334,575,1197,1424,3202,2175,525,239,401,1367,340.488,340.59,1937.56],'cm^-1')),
        HinderedRotor(inertia=(0.0803857,'amu*angstrom^2'), symmetry=1, barrier=(6.66146,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0810091,'amu*angstrom^2'), symmetry=1, barrier=(6.6899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.701736,'amu*angstrom^2'), symmetry=1, barrier=(58.332,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (157.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0165519,0.0955681,-0.000156394,1.33548e-07,-4.45532e-11,-76113.8,30.4587], Tmin=(100,'K'), Tmax=(832.833,'K')), NASAPolynomial(coeffs=[11.5648,0.0283399,-1.41237e-05,2.7043e-09,-1.85713e-13,-77629.4,-20.6935], Tmin=(832.833,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-633.975,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(CsCsFFF) + group(CsCsFHH) + group(Ct-CtCs) + group(CtCF) + radical(CsCsF1sH)"""),
)
...
species(
    label = 'F[C]=C[C](CF)C(F)(F)F(12179)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.50536,0.0811244,-9.73136e-05,6.21436e-08,-1.60849e-11,-84561.2,27.5098], Tmin=(100,'K'), Tmax=(934.492,'K')), NASAPolynomial(coeffs=[12.6241,0.0292524,-1.4053e-05,2.74672e-09,-1.95014e-13,-86826.3,-30.1352], Tmin=(934.492,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-704.099,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(CsCsFFF) + group(CsCsFHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Allyl_T) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
species(
    label = 'F[C]=[C]C(CF)C(F)(F)F(12181)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-598.238,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,193,295,551,588,656,1146,1192,1350,528,1116,1182,1331,1402,1494,3075,3110,1685,370,167,640,1190,245.654,248.042,248.093],'cm^-1')),
        HinderedRotor(inertia=(0.00277622,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.182523,'amu*angstrom^2'), symmetry=1, barrier=(7.71624,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.403844,'amu*angstrom^2'), symmetry=1, barrier=(17.6186,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.102048,0.0922464,-0.000131717,1.00032e-07,-3.04956e-11,-71816.9,31.1758], Tmin=(100,'K'), Tmax=(801.322,'K')), NASAPolynomial(coeffs=[12.5883,0.0299166,-1.50388e-05,2.95812e-09,-2.09131e-13,-73818,-26.2972], Tmin=(801.322,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-598.238,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(CsCsFFF) + group(CsCsFHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cds_S) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'F[C]=CC(F)[CH]F(867)'],
    products = ['F[C]=CC([CH]F)C(F)(F)F(6872)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.33582e-06,'m^3/(mol*s)'), n=3.3552, Ea=(237.999,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R',), comment="""Estimated from node CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(804)', 'F[C]C=CC(F)(F)F(1089)'],
    products = ['F[C]=CC([CH]F)C(F)(F)F(6872)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F[C]=CC([CH]F)C(F)(F)F(6872)'],
    products = ['FC=CC(=CF)C(F)(F)F(12176)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CF3(45)', 'F[C]=CC=CF(872)'],
    products = ['F[C]=CC([CH]F)C(F)(F)F(6872)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(15.4847,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)
...
reaction(
    ...
    products = ['F[C]=CC([CH]F)C(F)(F)F(6872)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(8.01963,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[C]=CC(=CF)C(F)(F)F(12177)'],
    products = ['F[C]=CC([CH]F)C(F)(F)F(6872)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(2.95974,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)

reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'FC#CC([CH]F)C(F)(F)F(12178)'],
    products = ['F[C]=CC([CH]F)C(F)(F)F(6872)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C]=CC([CH]F)C(F)(F)F(6872)'],
    products = ['F[C]=C[C](CF)C(F)(F)F(12179)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C]=[C]C(CF)C(F)(F)F(12181)'],
    products = ['F[C]=CC([CH]F)C(F)(F)F(6872)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.00165257,'s^-1'), n=4.50663, Ea=(241.406,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R4F_Ext-4R!H-R',), comment="""Estimated from node R4F_Ext-4R!H-R
Multiplied by reaction path degeneracy 3.0"""),
)

network(
    label = 'PDepNetwork #3645',
    isomers = [
        'F[C]=CC([CH]F)C(F)(F)F(6872)',
    ],
    reactants = [
