...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.427153,'amu*angstrom^2'), symmetry=1, barrier=(9.8211,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27948,0.0645736,-9.74416e-05,8.05066e-08,-2.66501e-11,-20749.5,24.1316], Tmin=(100,'K'), Tmax=(778.616,'K')), NASAPolynomial(coeffs=[9.08609,0.0219828,-1.06018e-05,2.05232e-09,-1.43267e-13,-21889.8,-11.0934], Tmin=(778.616,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-173.298,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCd)(F1s)(H)) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (108.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81729,0.0523641,-5.04203e-05,2.97015e-08,-7.78697e-12,-30284.1,21.3098], Tmin=(100,'K'), Tmax=(883.548,'K')), NASAPolynomial(coeffs=[6.4373,0.0314488,-1.49133e-05,2.9109e-09,-2.06734e-13,-31100.5,-0.407233], Tmin=(883.548,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-252.419,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=CC(F)[C](F)F(3482)'],
    products = ['[CH]=CC(F)(F)[CH]F(3481)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', '[CH]C=C(F)F(1863)'],
    products = ['[CH]=CC(F)(F)[CH]F(3481)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH]=CC(F)=CF(4563)'],
    products = ['[CH]=CC(F)(F)[CH]F(3481)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHFCF2(55)', '[CH]=[CH](1000)'],
    products = ['[CH]=CC(F)(F)[CH]F(3481)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[CH][C](F)F(588)', 'C2H2(23)'],
    products = ['[CH]=CC(F)(F)[CH]F(3481)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#CC(F)(F)[CH]F(1129)'],
    products = ['[CH]=CC(F)(F)[CH]F(3481)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F[CH][C](F)F(588)', '[CH]=[CH](1000)'],
    products = ['[CH]=CC(F)(F)[CH]F(3481)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', '[CH]C=C(F)F(1863)'],
    products = ['[CH]=CC(F)(F)[CH]F(3481)'],
