...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10675,0.0610019,-7.18267e-05,4.00032e-08,-8.60031e-12,-19292.2,24.4636], Tmin=(100,'K'), Tmax=(1143.92,'K')), NASAPolynomial(coeffs=[15.7102,0.00993651,-4.86441e-06,9.77473e-10,-7.12053e-14,-22633.2,-47.9527], Tmin=(1143.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-161.29,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsCFFO) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)OOO(2224)'],
    products = ['HO2(11)', 'FC1(F)CO1(165)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['OOO[C](F)F(209)', 'CH2(T)(18)'],
    products = ['[CH2]C(F)(F)OOO(2224)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(5)', '[CH]C(F)(F)OOO(2225)'],
    products = ['[CH2]C(F)(F)OOO(2224)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2][C](F)OOO(2227)'],
    products = ['[CH2]C(F)(F)OOO(2224)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['HO2(11)', '[CH2]C([O])(F)F(162)'],
    products = ['[CH2]C(F)(F)OOO(2224)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(7)', '[CH2]C(F)(F)O[O](132)'],
    products = ['[CH2]C(F)(F)OOO(2224)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)OO[O](639)'],
    products = ['[CH2]C(F)(F)OOO(2224)'],
    transitionState = 'TS9',
...
network(
    label = 'PDepNetwork #876',
    isomers = [
        '[CH2]C(F)(F)OOO(2224)',
    ],
    reactants = [
        ('HO2(11)', 'FC1(F)CO1(165)'),
        ('OH(7)', 'FC1(F)COO1(164)'),
        ('HO2(11)', '[CH2]C([O])(F)F(162)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
