...
reaction(
    label = 'reaction3',
    reactants = ['F[C](F)CC1O[C]1F(4001)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(3999)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(138)', '[CH2]C1O[C]1F(4033)'],
    products = ['F[C](F)CC1O[C]1F(4001)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['O=C(F)[CH]C[C](F)F(4037)'],
    products = ['F[C](F)CC1O[C]1F(4001)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[C](F)CC1=C(F)O1(4038)'],
    products = ['F[C](F)CC1O[C]1F(4001)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'F[C]1OC1C=C(F)F(4039)'],
    products = ['F[C](F)CC1O[C]1F(4001)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(43)', '[CH2]C1O[C]1F(4033)'],
    products = ['F[C](F)CC1O[C]1F(4001)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C](F)CC1O[C]1F(4001)'],
    products = ['F[C]1O[C]1CC(F)F(4043)'],
...
network(
    label = 'PDepNetwork #1332',
    isomers = [
        'F[C](F)CC1O[C]1F(4001)',
    ],
    reactants = [
