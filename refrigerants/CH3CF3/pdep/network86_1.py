...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(138)', '[O]C([O])(F)F(276)'],
    products = ['[O]C(F)(F)O[C](F)F(250)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'F[C](F)O[C](F)F(280)'],
    products = ['[O]C(F)(F)O[C](F)F(250)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(F)O[C](F)F(380)'],
    products = ['[O]C(F)(F)O[C](F)F(250)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CF2(43)', '[O]C([O])(F)F(276)'],
    products = ['[O]C(F)(F)O[C](F)F(250)'],
    transitionState = 'TS8',
