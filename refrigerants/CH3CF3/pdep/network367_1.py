species(
    label = 'F[CH]C(F)C(F)(F)[CH]F(1044)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.3104,'amu*angstrom^2'), symmetry=1, barrier=(7.1367,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.310716,'amu*angstrom^2'), symmetry=1, barrier=(7.14397,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.32721,'amu*angstrom^2'), symmetry=1, barrier=(30.5152,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.390017,0.10992,-0.000202444,1.86529e-07,-6.53872e-11,-88350.3,28.8879], Tmin=(100,'K'), Tmax=(844.703,'K')), NASAPolynomial(coeffs=[10.4776,0.0320548,-1.72881e-05,3.39467e-09,-2.34849e-13,-89244.3,-16.1321], Tmin=(844.703,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-735.793,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsF1sF1s)(F1s)(H)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
"""),
    E0 = (-728.012,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([207,311,436,622,447,691,1074,1182,1276,1366,1311,1469,3045,3235,190,488,555,1236,1407,334,575,1197,1424,3202,275.754,275.859,276.465],'cm^-1')),
        HinderedRotor(inertia=(0.255178,'amu*angstrom^2'), symmetry=1, barrier=(13.9672,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191507,'amu*angstrom^2'), symmetry=1, barrier=(10.3282,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.683571,'amu*angstrom^2'), symmetry=1, barrier=(37.1037,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.084861,0.0935252,-0.000144687,1.17289e-07,-3.79161e-11,-87425.5,29.3475], Tmin=(100,'K'), Tmax=(758.293,'K')), NASAPolynomial(coeffs=[12.5448,0.0277893,-1.46337e-05,2.93369e-09,-2.08991e-13,-89314.9,-27.3151], Tmin=(758.293,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-728.012,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsF1sH)(F1s)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
"""),
    E0 = (-564.197,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([174,267,591,721,1107,1278,1348,3273,323,467,575,827,1418,334,575,1197,1424,3202,194,682,905,1196,1383,3221,180],'cm^-1')),
        HinderedRotor(inertia=(0.32292,'amu*angstrom^2'), symmetry=1, barrier=(7.42456,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.322729,'amu*angstrom^2'), symmetry=1, barrier=(7.42018,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.53538,0.0416735,0.000154342,-8.00614e-07,9.68176e-10,-67862.6,13.6207], Tmin=(10,'K'), Tmax=(321.816,'K')), NASAPolynomial(coeffs=[7.77397,0.0344619,-2.39909e-05,7.87878e-09,-9.77196e-13,-68370.9,-5.6808], Tmin=(321.816,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-564.197,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), label="""F[CH]C(F)C(F)DCF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-306.501,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([271,519,563,612,1379,3010,987.5,1337.5,450,1655,173,295,515,663,653,819,693,939,1188,1292,3205,3269],'cm^-1')),
        HinderedRotor(inertia=(0.0820048,'amu*angstrom^2'), symmetry=1, barrier=(1.88545,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.53265,'amu*angstrom^2'), symmetry=1, barrier=(58.2307,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.29818,'amu*angstrom^2'), symmetry=1, barrier=(52.8396,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0089469,'amu*angstrom^2'), symmetry=1, barrier=(52.8502,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.988641,0.0718188,-0.000104042,8.0137e-08,-2.47906e-11,-55993.4,22.1801], Tmin=(100,'K'), Tmax=(789.477,'K')), NASAPolynomial(coeffs=[10.5511,0.0233674,-1.19813e-05,2.39358e-09,-1.70885e-13,-57503.2,-21.6923], Tmin=(789.477,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-466.414,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cd-CdF1s)(F1s)(H)) + radical(Csj(Cd-CdF1s)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.656729,'amu*angstrom^2'), symmetry=1, barrier=(15.0995,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.237061,'amu*angstrom^2'), symmetry=1, barrier=(5.45049,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.5554,'amu*angstrom^2'), symmetry=1, barrier=(35.7617,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.142991,0.101958,-0.000178324,1.62021e-07,-5.72797e-11,-89356.3,29.0758], Tmin=(100,'K'), Tmax=(809.762,'K')), NASAPolynomial(coeffs=[10.4467,0.0324438,-1.76866e-05,3.53259e-09,-2.48619e-13,-90507.3,-16.2959], Tmin=(809.762,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-744.104,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = 'F[CH]C(F)[C](F)C(F)F(1138)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = 'F[CH][CH]C(F)(F)C(F)F(1148)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(1044)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[CH]C(F)C(F)[C](F)F(1045)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(1044)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(804)', 'F[CH]C(F)(F)[CH]F(1144)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(1044)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(1044)'],
    products = ['FC1C(F)C(F)(F)C1F(1132)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[CH]C(F)C(F)=CF(903)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(1044)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(46.8759,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    ...
    products = ['F[CH]C(F)C(F)(F)[CH]F(1044)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(8.08706e-06,'m^3/(mol*s)'), n=3.0961, Ea=(3.38639,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[CH]C(F)(F)C=CF(1146)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(1044)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(60.2685,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(8.08706e-06,'m^3/(mol*s)'), n=3.0961, Ea=(4.92436,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[CH]C(F)(F)C(F)=CF(1147)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(1044)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', 'F[CH]C=C(F)[CH]F(891)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(1044)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(17.1104,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'F[CH]C(F)=C(F)[CH]F(1130)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(1044)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(8.28222,'m^3/(mol*s)'), n=1.29695, Ea=(233.444,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', 'F[CH]C(F)(F)[CH]F(1144)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(1044)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(1044)'],
    products = ['F[CH]C(F)(F)[C](F)CF(1086)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(1044)'],
    products = ['F[CH][C](F)C(F)(F)CF(1084)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(1044)'],
    products = ['F[CH]C(F)[C](F)C(F)F(1138)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(2.01526e+12,'s^-1'), n=0.18834, Ea=(183.634,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(1044)'],
    products = ['F[CH][C](F)C(F)C(F)F(1139)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(225.37,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction21',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(1044)'],
    products = ['F[CH][CH]C(F)(F)C(F)F(1148)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(211.944,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction22',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(1044)'],
    products = ['F[CH]C(F)(F)[CH]C(F)F(1069)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(1.00763e+12,'s^-1'), n=0.18834, Ea=(167.64,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C"""),
)

network(
    label = 'PDepNetwork #367',
    isomers = [
        'F[CH]C(F)C(F)(F)[CH]F(1044)',
    ],
    reactants = [
