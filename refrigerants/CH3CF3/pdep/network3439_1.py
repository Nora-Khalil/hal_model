...
"""),
    E0 = (-342.911,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([280,518,736,852,873,3010,987.5,1337.5,450,1655,323,467,575,827,1418,182,240,577,636,1210,1413,274.564,276.491,277.178,278.088],'cm^-1')),
        HinderedRotor(inertia=(0.946467,'amu*angstrom^2'), symmetry=1, barrier=(51.2533,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.935214,'amu*angstrom^2'), symmetry=1, barrier=(51.24,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (138.063,'amu'),
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.900882,0.0624081,-6.58027e-05,3.30492e-08,-6.42415e-12,-5141.65,21.9244], Tmin=(100,'K'), Tmax=(1260.49,'K')), NASAPolynomial(coeffs=[16.9316,0.0115375,-5.26703e-06,1.03275e-09,-7.42536e-14,-9183.04,-59.1261], Tmin=(1260.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-43.7181,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(CdCCF) + group(Cds-CdsHH) + ring(Cd-Cd-Cs(F)(F)) + radical(Cdj(Cd-CdF1s)(H))"""),
)
...
"""),
    E0 = (8.99808,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,323,467,575,827,1418,2950,1000,246,474,533,1155,3120,650,792.5,1650,180,393.347],'cm^-1')),
        HinderedRotor(inertia=(0.147842,'amu*angstrom^2'), symmetry=1, barrier=(3.39918,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (119.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06372,0.0711721,-0.000114859,1.0131e-07,-3.56317e-11,1181.6,21.8693], Tmin=(100,'K'), Tmax=(785.469,'K')), NASAPolynomial(coeffs=[8.37046,0.0260905,-1.37338e-05,2.72085e-09,-1.91624e-13,276.598,-10.0713], Tmin=(785.469,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(8.99808,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(CdCsCdF) + group(Cds-CdsCsH) + group(CdCsCdF) + group(Cds-CdsHH) + ring(Cs-Cd(F)-Cd) + radical(Cdj(Cd-CsF1s)(H)) + longDistanceInteraction_cyclic(Cs(F)-Cds(F))"""),
)

species(
    label = 'C#CC1(F)[CH]C1(F)F(11683)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-78.7216,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,215,315,519,588,595,1205,1248,2950,1000,2175,525,750,770,3400,2100,307.906,308.36],'cm^-1')),
        HinderedRotor(inertia=(0.79206,'amu*angstrom^2'), symmetry=1, barrier=(52.1554,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (119.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37897,0.0612055,-7.95762e-05,5.66205e-08,-1.63222e-11,-9376.82,22.0321], Tmin=(100,'K'), Tmax=(843.819,'K')), NASAPolynomial(coeffs=[9.58354,0.0223132,-1.04404e-05,1.99962e-09,-1.39699e-13,-10761.5,-16.157], Tmin=(843.819,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-78.7216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(Ct-CtCs) + group(Ct-CtH) + ring(Cs-Cs(F)(F)-Cs) + radical(cyclopropane) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
"""),
    E0 = (347.154,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([280,518,736,852,873,2950,1000,323,467,575,827,1418,497.198,497.2,497.2,497.206,497.208,497.21,497.228,497.242],'cm^-1')),
        HinderedRotor(inertia=(0.000681959,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68108,0.0515368,-4.82067e-05,2.41789e-08,-5.0235e-12,41836.1,20.3587], Tmin=(100,'K'), Tmax=(1136.95,'K')), NASAPolynomial(coeffs=[9.84732,0.0228065,-1.03025e-05,1.95327e-09,-1.36409e-13,39979.1,-20.0868], Tmin=(1136.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(347.154,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)(Cds-Cds)) + group(CdCsCdF) + group(Cds-Cds(Cds-Cds)H) + group(CdCCF) + ring(Cd(F)-Cd-Cd(Cd)) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=C=C1[CH]C1(F)F(11685)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 F u0 p3 c0 {3,S}
...
species(
    label = '[CH]=C(F)C1(F)[C](F)C1F(11686)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (138.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.782485,0.0763806,-0.000108015,8.15748e-08,-2.48146e-11,-16204.1,26.5868], Tmin=(100,'K'), Tmax=(801.863,'K')), NASAPolynomial(coeffs=[10.9651,0.0255848,-1.29913e-05,2.57067e-09,-1.82501e-13,-17837.1,-20.2895], Tmin=(801.863,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-135.65,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(CsCsCsFF) + group(CsCsCsFH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cs-Cs(F)(F)-Cs) + radical(Cds_S) + radical(Cds_P) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]C(F)=C(F)C=C(F)F(3462)'],
    products = ['[CH]=C(F)C1(F)[CH]C1(F)F(11613)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH]=C(F)C1=CC1(F)F(11681)'],
    products = ['[CH]=C(F)C1(F)[CH]C1(F)F(11613)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(52.0337,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]=C(F)C1(F)C=C1F(11682)'],
    products = ['[CH]=C(F)C1(F)[CH]C1(F)F(11613)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C#CC1(F)[CH]C1(F)F(11683)'],
    products = ['[CH]=C(F)C1(F)[CH]C1(F)F(11613)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['F2(78)', '[CH]C(F)=C1C=C1F(11684)'],
    products = ['[CH]=C(F)C1(F)[CH]C1(F)F(11613)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(6.02434,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction12',
    reactants = ['F2(78)', '[CH]=C=C1[CH]C1(F)F(11685)'],
    products = ['[CH]=C(F)C1(F)[CH]C1(F)F(11613)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(31.8387,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(F)C1(F)[CH]C1(F)F(11613)'],
    products = ['F[CH]C(F)=C1[CH]C1(F)F(11512)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(167.39,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction15',
    reactants = ['[CH]=C(F)C1(F)[C](F)C1F(11686)'],
    products = ['[CH]=C(F)C1(F)[CH]C1(F)F(11613)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C(F)C1(F)[CH]C1(F)F(11613)'],
    products = ['FC=C(F)C1(F)[CH][C]1F(11687)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=[C]C1(F)C(F)C1(F)F(11688)'],
    products = ['[CH]=C(F)C1(F)[CH]C1(F)F(11613)'],
