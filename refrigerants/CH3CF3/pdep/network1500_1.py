...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3465.22,'J/mol'), sigma=(5.48324,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=541.26 K, Pc=47.69 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
reaction(
    ...
    products = ['[CH]=C(F)C([O])C(=O)F(5021)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH]C(F)=CC(=O)F(5133)'],
    products = ['[CH]=C(F)C([O])C(=O)F(5021)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=C(F)C([O])C(=O)F(5021)'],
    products = ['[CH]=C(F)C1OO[C]1F(5135)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=C(F)C([O])C(=O)F(5021)'],
    products = ['[CH]=C(F)C1OC1([O])F(5136)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=C(F)C(=O)[C](O)F(5137)'],
    products = ['[CH]=C(F)C([O])C(=O)F(5021)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CFO(51)', '[CH]=C(F)C=O(571)'],
    products = ['[CH]=C(F)C([O])C(=O)F(5021)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH]=C(F)C(=O)C(=O)F(5138)'],
    products = ['[CH]=C(F)C([O])C(=O)F(5021)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'C#CC([O])C(=O)F(5139)'],
    products = ['[CH]=C(F)C([O])C(=O)F(5021)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'C#CC([O])=C([O])F(5140)'],
    products = ['[CH]=C(F)C([O])C(=O)F(5021)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=C(F)C([O])C(=O)F(5021)'],
    products = ['[CH]C(F)=C(O)C(=O)F(5141)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=[C]C(OF)C(=O)F(5142)'],
    products = ['[CH]=C(F)C([O])C(=O)F(5021)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]=C(F)C([C]=O)OF(5143)'],
    products = ['[CH]=C(F)C([O])C(=O)F(5021)'],
...
network(
    label = 'PDepNetwork #1500',
    isomers = [
        '[CH]=C(F)C([O])C(=O)F(5021)',
    ],
    reactants = [
