...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C=CF(6397)'],
    products = ['[CH]=CC([O])F(8553)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][CH]F(2815)', '[CH]=[CH](977)'],
    products = ['[CH]=CC([O])F(8553)'],
