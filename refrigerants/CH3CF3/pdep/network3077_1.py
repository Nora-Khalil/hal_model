species(
    label = '[CH2]C(F)C(F)(F)[C](F)F(10229)',
...
"""),
    E0 = (-757.158,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,215,315,519,588,595,1205,1248,3000,3100,440,815,1455,1000,190,488,555,1236,1407,221.847,222],'cm^-1')),
        HinderedRotor(inertia=(0.265174,'amu*angstrom^2'), symmetry=1, barrier=(9.27386,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03588,'amu*angstrom^2'), symmetry=1, barrier=(36.2067,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.265269,'amu*angstrom^2'), symmetry=1, barrier=(9.27286,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0408292,0.0955154,-0.000146076,1.11706e-07,-3.21427e-11,-90930.4,28.129], Tmin=(100,'K'), Tmax=(659.888,'K')), NASAPolynomial(coeffs=[13.1742,0.0266281,-1.386e-05,2.75533e-09,-1.94997e-13,-92897.1,-31.5413], Tmin=(659.888,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-757.158,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(H)(H)) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-775.498,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,2750,2800,2850,1350,1500,750,1050,1375,1000,212,367,445,1450,190,488,555,1236,1407,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.196769,'amu*angstrom^2'), symmetry=1, barrier=(4.52411,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.196259,'amu*angstrom^2'), symmetry=1, barrier=(4.51239,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.629001,'amu*angstrom^2'), symmetry=1, barrier=(14.462,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0417818,0.0973551,-0.000168295,1.51892e-07,-5.31794e-11,-93138.3,28.3024], Tmin=(100,'K'), Tmax=(823.79,'K')), NASAPolynomial(coeffs=[9.97481,0.0315791,-1.65793e-05,3.25997e-09,-2.27257e-13,-94179.5,-14.0799], Tmin=(823.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-775.498,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-HHH)(F1s)) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s))"""),
)

species(
    label = '[CH2][C](F)C(F)(F)C(F)F(1070)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0841065,0.0947987,-0.000157136,1.37984e-07,-4.77277e-11,-92650,28.9837], Tmin=(100,'K'), Tmax=(799.475,'K')), NASAPolynomial(coeffs=[10.7606,0.0304599,-1.59312e-05,3.14924e-09,-2.21097e-13,-94008.1,-17.9523], Tmin=(799.475,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-771.439,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-HHH)(F1s)) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = 'FC[CH]C(F)(F)[C](F)F(10372)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-754.791,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,551,1088,1226,1380,1420,1481,3057,3119,3025,407.5,1350,352.5,190,488,555,1236,1407,180,180,1189.76],'cm^-1')),
        HinderedRotor(inertia=(0.251316,'amu*angstrom^2'), symmetry=1, barrier=(5.77824,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251594,'amu*angstrom^2'), symmetry=1, barrier=(5.78465,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.250953,'amu*angstrom^2'), symmetry=1, barrier=(5.7699,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.293416,0.0948269,-0.000173169,1.6615e-07,-6.07775e-11,-90659.8,30.3416], Tmin=(100,'K'), Tmax=(834.898,'K')), NASAPolynomial(coeffs=[6.51279,0.0372672,-1.9877e-05,3.91702e-09,-2.72753e-13,-90730.7,7.25367], Tmin=(834.898,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-754.791,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sHH)(H)) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s))"""),
)

species(
    label = '[CH2][CH]C(F)(F)C(F)(F)F(10376)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40178,0.0695154,-6.04124e-05,-3.6383e-08,7.41298e-11,-98327.8,26.2113], Tmin=(100,'K'), Tmax=(470.685,'K')), NASAPolynomial(coeffs=[8.18503,0.0340379,-1.79977e-05,3.60405e-09,-2.5603e-13,-99212,-4.01092], Tmin=(470.685,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-818.215,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-HHH)(H)) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]C(F)[C](F)C(F)(F)F(10377)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.785867,0.0778879,-0.000107865,8.40293e-08,-2.70576e-11,-93842.5,29.0285], Tmin=(100,'K'), Tmax=(751.471,'K')), NASAPolynomial(coeffs=[9.33081,0.0323986,-1.70535e-05,3.45626e-09,-2.49245e-13,-95126.6,-9.75342], Tmin=(751.471,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-781.158,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-F1sF1sF1s)(F1s)) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)C(F)(F)[C](F)F(10229)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)C(F)(F)[C](F)F(10229)'],
    products = ['F[CH]CC(F)(F)[C](F)F(9398)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[CH]C(F)(F)[C](F)F(1067)'],
    products = ['[CH2]C(F)C(F)(F)[C](F)F(10229)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(138)', '[CH2]C(F)[C](F)F(1037)'],
    products = ['[CH2]C(F)C(F)(F)[C](F)F(10229)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(F)C(F)(F)[C](F)F(10229)'],
    products = ['FC1CC(F)(F)C1(F)F(1038)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)C(F)(F)[C](F)F(10229)'],
    products = ['C=C(F)C(F)(F)C(F)F(10374)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', '[CH2]C=C(F)[C](F)F(2876)'],
    products = ['[CH2]C(F)C(F)(F)[C](F)F(10229)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(13.474,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH2]C(F)=C(F)[C](F)F(1061)'],
    products = ['[CH2]C(F)C(F)(F)[C](F)F(10229)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(231.447,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', '[CH2]C(F)[C](F)F(1037)'],
    products = ['[CH2]C(F)C(F)(F)[C](F)F(10229)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C[C](F)C(F)(F)[C](F)F(10375)'],
    products = ['[CH2]C(F)C(F)(F)[C](F)F(10229)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(F)C(F)(F)[C](F)F(10229)'],
    products = ['[CH2][C](F)C(F)(F)C(F)F(1070)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(F)C(F)(F)[C](F)F(10229)'],
    products = ['FC[CH]C(F)(F)[C](F)F(10372)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(1.00763e+12,'s^-1'), n=0.18834, Ea=(182.947,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C"""),
)

reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(F)C(F)(F)[C](F)F(10229)'],
    products = ['[CH2][CH]C(F)(F)C(F)(F)F(10376)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(197.172,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(211.009,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(F)C(F)(F)[C](F)F(10229)'],
    products = ['[CH2]C(F)[C](F)C(F)(F)F(10377)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(2.01526e+12,'s^-1'), n=0.18834, Ea=(169.271,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C
Multiplied by reaction path degeneracy 2.0"""),
)
