...
"""),
    E0 = (-862.993,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,493,600,700,1144,1293,180,180,180,2257.64],'cm^-1')),
        HinderedRotor(inertia=(0.181159,'amu*angstrom^2'), symmetry=1, barrier=(4.16521,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.22938,'amu*angstrom^2'), symmetry=1, barrier=(51.2579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.22682,'amu*angstrom^2'), symmetry=1, barrier=(51.199,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09923,0.0855012,-0.000193617,2.10205e-07,-8.20007e-11,-103711,25.587], Tmin=(100,'K'), Tmax=(853.187,'K')), NASAPolynomial(coeffs=[-1.24434,0.0430293,-2.4959e-05,4.97795e-09,-3.45799e-13,-101365,47.924], Tmin=(853.187,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-862.993,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(CsFOOO) + group(CsFFHO) + radical(OCOJ) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
"""),
    E0 = (-847.405,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,519,593,830,1115,1166,1389,1413,3114,180,180,180,180,1779.7],'cm^-1')),
        HinderedRotor(inertia=(0.174493,'amu*angstrom^2'), symmetry=1, barrier=(53.7303,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0243117,'amu*angstrom^2'), symmetry=1, barrier=(53.7861,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59998,0.0808794,-0.000201568,2.3899e-07,-9.84677e-11,-101860,22.408], Tmin=(100,'K'), Tmax=(849.243,'K')), NASAPolynomial(coeffs=[-9.1217,0.0587369,-3.41513e-05,6.84327e-09,-4.77587e-13,-97419.4,87.8047], Tmin=(849.243,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-847.405,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(CsFOOO) + group(CsFFHO) + radical(OCOJ) + radical(OCOJ)"""),
)

species(
    label = 'O[C](OF)O[C](F)F(2018)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {8,S}
2 F u0 p3 c0 {8,S}
3 F u0 p3 c0 {5,S}
...
"""),
    E0 = (-475.173,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,360,370,350,493,600,700,1144,1293,180,180,1860.62,1860.78],'cm^-1')),
        HinderedRotor(inertia=(0.244469,'amu*angstrom^2'), symmetry=1, barrier=(5.62083,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244428,'amu*angstrom^2'), symmetry=1, barrier=(5.61988,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244589,'amu*angstrom^2'), symmetry=1, barrier=(5.62357,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244479,'amu*angstrom^2'), symmetry=1, barrier=(5.62106,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.892641,0.0848028,-0.000179894,1.82238e-07,-6.77801e-11,-57054.1,28.7554], Tmin=(100,'K'), Tmax=(855.691,'K')), NASAPolynomial(coeffs=[4.22118,0.0308205,-1.79112e-05,3.56254e-09,-2.46596e-13,-56217.1,21.4353], Tmin=(855.691,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-475.173,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFFHO) + radical(Cs_P) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = '[O][C](O)OC(F)(F)F(11160)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {7,S}
...
"""),
    E0 = (-827.445,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,431,527,613,668,835,1199,1245,1322,360,370,350,180,2103.79,2104.09,2104.66],'cm^-1')),
        HinderedRotor(inertia=(0.141018,'amu*angstrom^2'), symmetry=1, barrier=(3.24227,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141313,'amu*angstrom^2'), symmetry=1, barrier=(3.24906,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141072,'amu*angstrom^2'), symmetry=1, barrier=(3.24352,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63521,0.0723546,-0.000166162,1.86698e-07,-7.47018e-11,-99453.1,25.8648], Tmin=(100,'K'), Tmax=(849.281,'K')), NASAPolynomial(coeffs=[-3.09929,0.0435314,-2.49631e-05,4.98272e-09,-3.47115e-13,-96805.3,58.7869], Tmin=(849.281,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-827.445,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFFFO) + radical(OCOJ) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(O)(F)O[C](F)F(11149)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(138)', '[O]C([O])(O)F(11156)'],
    products = ['[O]C(O)(F)O[C](F)F(11149)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(O)O[C](F)F(2049)'],
    products = ['[O]C(O)(F)O[C](F)F(11149)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[O]C([O])(O)F(11156)'],
    products = ['[O]C(O)(F)O[C](F)F(11149)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C([O])(F)OC(F)F(11158)'],
    products = ['[O]C(O)(F)O[C](F)F(11149)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O][C](O)OC(F)(F)F(11160)'],
    products = ['[O]C(O)(F)O[C](F)F(11149)'],
