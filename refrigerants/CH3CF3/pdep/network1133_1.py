...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'F[C]1OC1(F)F(11275)'],
    products = ['FC1OC1(F)F(1089)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'FC1=C(F)O1(11276)'],
    products = ['FC1OC1(F)F(1089)'],
