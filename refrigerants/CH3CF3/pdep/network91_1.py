...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'CC(F)(F)OF(323)'],
    products = ['CC(F)(F)COF(255)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(127)', '[CH2]C(C)(F)F(362)'],
    products = ['CC(F)(F)COF(255)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]OF(222)', 'CH3-CF2(65)'],
    products = ['CC(F)(F)COF(255)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(19)', 'FOC[C](F)F(363)'],
    products = ['CC(F)(F)COF(255)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'CC(F)(F)[CH]OF(364)'],
    products = ['CC(F)(F)COF(255)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(F)(F)COF(365)'],
    products = ['CC(F)(F)COF(255)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'CC(F)(F)C=O(309)'],
    products = ['CC(F)(F)COF(255)'],
