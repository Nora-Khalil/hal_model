...
reaction(
    label = 'reaction1',
    reactants = ['HO2(11)', '[O]OC(F)(F)F(511)'],
    products = ['OOOOC(F)(F)F(11936)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(2.49151e+08,'m^3/(mol*s)'), n=0.0472428, Ea=(0.775492,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_N-2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_N-2R->C"""),
)

reaction(
    label = 'reaction2',
    reactants = ['OOOOF(12022)', 'CF2(43)'],
    products = ['OOOOC(F)(F)F(11936)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'OOOO[C](F)F(12023)'],
    products = ['OOOOC(F)(F)F(11936)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['OH(7)', '[O]OOC(F)(F)F(8865)'],
    products = ['OOOOC(F)(F)F(11936)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', '[O]OOOC(F)(F)F(7745)'],
    products = ['OOOOC(F)(F)F(11936)'],
    transitionState = 'TS6',
