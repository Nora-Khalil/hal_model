...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)C([CH2])(F)F(475)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH]C(F)=C(F)F(516)'],
    products = ['[CH]=C(F)C([CH2])(F)F(475)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH]=C(F)C(=C)F(517)'],
    products = ['[CH]=C(F)C([CH2])(F)F(475)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C#CC([CH2])(F)F(518)'],
    products = ['[CH]=C(F)C([CH2])(F)F(475)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F2(78)', '[CH]=C=C([CH2])F(519)'],
    products = ['[CH]=C(F)C([CH2])(F)F(475)'],
