...
reaction(
    label = 'reaction2',
    reactants = ['O=C[C]F(4375)', '[C]=C(976)'],
    products = ['C=[C]OC=[C]F(5738)'],
    transitionState = 'TS2',
