...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)[C](F)F(1072)', '[C]=C(976)'],
    products = ['C=[C]OC(F)[C](F)F(2327)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', 'C=[C]O[CH]F(2635)'],
    products = ['C=[C]OC(F)[C](F)F(2327)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=[C]OC=C(F)F(1693)'],
    products = ['C=[C]OC(F)[C](F)F(2327)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=[C]OC(F)=C(F)F(2637)'],
    products = ['C=[C]OC(F)[C](F)F(2327)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C#COC(F)[C](F)F(2638)'],
    products = ['C=[C]OC(F)[C](F)F(2327)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(43)', 'C=[C]O[CH]F(2635)'],
    products = ['C=[C]OC(F)[C](F)F(2327)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=[C]OC(F)C(F)F(2642)'],
    products = ['C=[C]OC(F)[C](F)F(2327)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C=[C]OC(F)[C](F)F(2327)'],
    products = ['C=[C]O[CH]C(F)(F)F(2643)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=[C]OC(F)[C](F)F(2327)'],
    products = ['C=C(F)O[CH][C](F)F(2644)'],
