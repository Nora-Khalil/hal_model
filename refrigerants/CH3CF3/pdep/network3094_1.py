...
reaction(
    label = 'reaction2',
    reactants = ['O=C[C]F(3808)', '[CH]C-2(980)'],
    products = ['C[CH]OC=[C]F(11902)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C[CH]OC#CF(11907)'],
    products = ['C[CH]OC=[C]F(11902)'],
    transitionState = 'TS8',
