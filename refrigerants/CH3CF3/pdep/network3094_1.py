...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)C[CH]F(10242)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(804)', '[CH2]C([CH2])F(10156)'],
    products = ['[CH2]C(F)C[CH]F(10242)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'F[CH]C[CH]F(10247)'],
    products = ['[CH2]C(F)C[CH]F(10242)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)C=CF(10290)'],
    products = ['[CH2]C(F)C[CH]F(10242)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=CC[CH]F(10381)'],
    products = ['[CH2]C(F)C[CH]F(10242)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C=C(F)C[CH]F(10164)'],
    products = ['[CH2]C(F)C[CH]F(10242)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', '[CH2]C([CH2])F(10156)'],
    products = ['[CH2]C(F)C[CH]F(10242)'],
