...
"""),
    ...
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72581,0.0407947,-4.54209e-05,2.53054e-08,-5.15982e-12,12953,17.2205], Tmin=(100,'K'), Tmax=(1460.7,'K')), NASAPolynomial(coeffs=[10.797,0.00598151,5.69661e-07,-3.5866e-10,3.25536e-14,11366.8,-26.3384], Tmin=(1460.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(106.95,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(CsCFHO) + ring(123trioxolane) + radical(CCsJOO) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]C1(F)[CH]OO1(4233)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 O u0 p2 c0 {3,S} {5,S}
...
"""),
    ...
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.73899,0.0320632,-3.06468e-05,6.40332e-09,8.40305e-12,-59.6723,16.4428], Tmin=(100,'K'), Tmax=(526.107,'K')), NASAPolynomial(coeffs=[5.36479,0.018333,-9.2735e-06,1.84149e-09,-1.31328e-13,-422.234,4.64132], Tmin=(526.107,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-0.838444,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsOsHH) + ring(Cs-Cs(F)-O2s-O2s) + radical(O2sj(Cs-F1sO2sCs)) + radical(CCsJOO)"""),
)
...
"""),
    E0 = (136.801,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,3025,407.5,1350,352.5,1855,455,950,329.198,1933.05],'cm^-1')),
        HinderedRotor(inertia=(0.544224,'amu*angstrom^2'), symmetry=1, barrier=(41.4999,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104163,'amu*angstrom^2'), symmetry=1, barrier=(41.529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.533972,'amu*angstrom^2'), symmetry=1, barrier=(41.5311,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96707,0.0489024,-7.53218e-05,6.24137e-08,-2.09268e-11,16522.7,19.9076], Tmin=(100,'K'), Tmax=(728.201,'K')), NASAPolynomial(coeffs=[7.81059,0.0167989,-9.18236e-06,1.85353e-09,-1.3247e-13,15671.8,-6.42964], Tmin=(728.201,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(136.801,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sFO) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(OCJC=O) + radical(CsCJ=O)"""),
)

species(
    label = '[O]OC(F)[C]=O(4237)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 O u0 p2 c0 {3,S} {5,S}
3 O u1 p2 c0 {2,S}
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.52402,0.0398957,-8.09778e-05,7.94961e-08,-2.84141e-11,23248.2,17.2535], Tmin=(100,'K'), Tmax=(890.357,'K')), NASAPolynomial(coeffs=[4.33446,0.0137992,-6.74998e-06,1.25757e-09,-8.32984e-14,23637.8,12.7277], Tmin=(890.357,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(192.913,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(Cdj(Cd-O2sH)(F1s))"""),
)

species(
    label = 'FC1=COOO1(4074)',
    structure = adjacencyList("""1 F u0 p3 c0 {5,S}
2 O u0 p2 c0 {4,S} {5,S}
3 O u0 p2 c0 {4,S} {6,S}
4 O u0 p2 c0 {2,S} {3,S}
...
"""),
    ...
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.45642,-0.00296007,7.42302e-05,-9.36174e-08,3.4955e-11,-7551.03,17.4585], Tmin=(100,'K'), Tmax=(965.696,'K')), NASAPolynomial(coeffs=[9.8982,0.00855858,-2.99862e-06,6.60712e-10,-5.63582e-14,-10576.4,-22.6172], Tmin=(965.696,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-63.0576,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(CdCFO) + group(Cds-CdsOsH) + longDistanceInteraction_cyclic(Cd(F)=CdOs) + ring(Cyclopentane)"""),
)
...
"""),
    ...
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.61966,0.0326921,-4.08591e-05,3.05764e-08,-9.61594e-12,-1227.34,20.3602], Tmin=(100,'K'), Tmax=(766.098,'K')), NASAPolynomial(coeffs=[5.89726,0.0155782,-7.34886e-06,1.41418e-09,-9.90411e-14,-1729.51,5.42107], Tmin=(766.098,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-10.6001,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + ring(O2s-O2s-Cs(C-F)) + radical(O2sj(Cs-CsF1sH)) + radical(CsCsF1sO2s)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.187566,'amu*angstrom^2'), symmetry=1, barrier=(4.31252,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188609,'amu*angstrom^2'), symmetry=1, barrier=(4.3365,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94375,0.0528596,-0.000100999,9.48285e-08,-3.32245e-11,-2050.54,22.4045], Tmin=(100,'K'), Tmax=(874.883,'K')), NASAPolynomial(coeffs=[6.17276,0.0161811,-8.37789e-06,1.592e-09,-1.07203e-13,-2126.77,6.3606], Tmin=(874.883,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-17.6043,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(ROOJ) + radical(C=CJO)"""),
)

species(
    label = '[O]OC=[C]OF(4242)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.378552,'amu*angstrom^2'), symmetry=1, barrier=(8.70365,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.37869,'amu*angstrom^2'), symmetry=1, barrier=(8.70682,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87404,0.0502299,-8.3678e-05,6.86968e-08,-2.14979e-11,35988.2,23.106], Tmin=(100,'K'), Tmax=(897.156,'K')), NASAPolynomial(coeffs=[9.22411,0.0101651,-4.4962e-06,7.9534e-10,-5.12682e-14,34962.9,-9.92019], Tmin=(897.156,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(298.614,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2sCF) + group(O2s-OsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'FC1=CO1(577)'],
    products = ['[O]OC1O[C]1F(3994)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]OC1O[C]1F(3994)'],
    products = ['O=O(161)', 'FC1=CO1(577)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]OC1=C(F)O1(4229)'],
    products = ['[O]OC1O[C]1F(3994)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O2(2)', 'F[C]1[CH]O1(1550)'],
    products = ['[O]OC1O[C]1F(3994)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', '[O]O[C]=C=O(4239)'],
    products = ['[O]O[CH]C(=O)F(4228)'],
