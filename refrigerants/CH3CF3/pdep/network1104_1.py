...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(138)', '[O]C([O])F(2904)'],
    products = ['[O]C(F)O[C](F)F(2881)'],
    transitionState = 'TS2',
