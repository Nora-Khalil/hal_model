...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', 'C=C[C]F(486)'],
    products = ['[CH2]CC=[C]F(2926)'],
    transitionState = 'TS2',
