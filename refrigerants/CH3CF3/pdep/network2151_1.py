...
reaction(
    label = 'reaction1',
    reactants = ['CO(13)', 'O[C](F)F(206)'],
    products = ['O=[C]C(O)(F)F(1849)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'O=[C][C](O)F(10053)'],
    products = ['O=[C]C(O)(F)F(1849)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['HF(38)', 'O=[C]C(=O)F(4240)'],
    products = ['O=[C]C(O)(F)F(1849)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['O=[C]C(O)(F)F(1849)'],
    products = ['O=C(F)[C](O)F(10054)'],
