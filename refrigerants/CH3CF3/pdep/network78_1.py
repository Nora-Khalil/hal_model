...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', '[CH2]O[C](F)F(261)'],
    products = ['F[C](F)CO[C](F)F(244)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C](F)OC=C(F)F(264)'],
    products = ['F[C](F)CO[C](F)F(244)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(43)', '[CH2]O[C](F)F(261)'],
    products = ['F[C](F)CO[C](F)F(244)'],
