...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12146,0.0535584,-3.24749e-05,2.49976e-09,2.72038e-12,-61286.3,22.9608], Tmin=(100,'K'), Tmax=(1112.95,'K')), NASAPolynomial(coeffs=[15.2965,0.0192697,-8.71209e-06,1.71373e-09,-1.23899e-13,-65473.2,-51.5774], Tmin=(1112.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-510.493,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsOs)"""),
)
...
"""),
    ...
    molecularWeight = (108.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07416,0.0828142,-0.000167112,1.7961e-07,-7.07912e-11,-8950.26,25.4476], Tmin=(100,'K'), Tmax=(843.579,'K')), NASAPolynomial(coeffs=[-1.23988,0.0487651,-2.65136e-05,5.23174e-09,-3.63812e-13,-6957.92,45.7127], Tmin=(843.579,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.1439,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-OsOsOsH) + group(Cs-CsHHH) + radical(OCOJ) + radical(CCsJOCs)"""),
)

species(
    label = 'C[CH]O[C](O)OF(11108)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
...
"""),
    ...
    molecularWeight = (108.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.560123,0.0863114,-0.000152591,1.41424e-07,-5.02773e-11,-11588.3,27.5096], Tmin=(100,'K'), Tmax=(841.749,'K')), NASAPolynomial(coeffs=[7.63047,0.0312565,-1.62476e-05,3.15652e-09,-2.17886e-13,-12018.5,-0.867458], Tmin=(841.749,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-97.2955,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-OsOsOsH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(Cs_P)"""),
)

species(
    label = '[CH2]COC([O])OF(11109)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {5,S} {6,S}
3  O u0 p2 c0 {1,S} {6,S}
...
"""),
    ...
    molecularWeight = (108.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[5.91099,0.0309621,-1.12588e-05,-2.45006e-10,3.24429e-13,-5438.01,8.84282], Tmin=(100,'K'), Tmax=(2769.75,'K')), NASAPolynomial(coeffs=[69.896,-0.0332197,8.21488e-06,-1.25323e-09,8.33621e-14,-51708.5,-384.576], Tmin=(2769.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-44.0109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-OsOsOsH) + group(Cs-CsHHH) + radical(OCOJ) + radical(CJCO)"""),
)

species(
    label = '[CH2]CO[C](O)OF(11110)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {5,S} {6,S}
3  O u0 p2 c0 {1,S} {6,S}
...
"""),
    ...
    molecularWeight = (108.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.709121,0.0845035,-0.000153373,1.47399e-07,-5.39371e-11,-7850.71,28.1618], Tmin=(100,'K'), Tmax=(840.862,'K')), NASAPolynomial(coeffs=[5.69004,0.0348132,-1.83571e-05,3.58707e-09,-2.48408e-13,-7769.34,10.4598], Tmin=(840.862,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-66.1624,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-OsOsOsH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CJCO)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94278,0.0383887,-1.6836e-05,-3.00042e-09,3.01198e-12,-48179.8,20.3166], Tmin=(100,'K'), Tmax=(1130.42,'K')), NASAPolynomial(coeffs=[10.5877,0.0199612,-8.52297e-06,1.61508e-09,-1.13788e-13,-50911.4,-25.8871], Tmin=(1130.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-401.253,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsOs) + radical(OC=OOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0105035,'amu*angstrom^2'), symmetry=1, barrier=(5.9868,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.70036,'amu*angstrom^2'), symmetry=1, barrier=(16.1026,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0287716,'amu*angstrom^2'), symmetry=1, barrier=(16.075,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23009,0.0330729,-1.39883e-05,-4.15617e-09,3.53831e-12,-25180.8,17.5155], Tmin=(100,'K'), Tmax=(1061.29,'K')), NASAPolynomial(coeffs=[9.58312,0.0166206,-6.65164e-06,1.23344e-09,-8.65187e-14,-27375.7,-21.3838], Tmin=(1061.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-209.936,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOCC)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.665607,0.063943,-6.25434e-05,2.88994e-08,-5.15542e-12,-37946.2,24.0741], Tmin=(100,'K'), Tmax=(1372.39,'K')), NASAPolynomial(coeffs=[18.7064,0.0113612,-5.07262e-06,9.81924e-10,-6.98991e-14,-42898,-68.6734], Tmin=(1372.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-316.566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsOs) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH2]COC(=O)OF(11113)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {5,S} {7,S}
3  O u0 p2 c0 {1,S} {7,S}
...
"""),
    ...
    molecularWeight = (107.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.909276,0.0593711,-5.40123e-05,2.34201e-08,-3.95771e-12,-35831.5,24.3615], Tmin=(100,'K'), Tmax=(1434.91,'K')), NASAPolynomial(coeffs=[17.3347,0.0135831,-6.14735e-06,1.1818e-09,-8.32106e-14,-40545.3,-60.8129], Tmin=(1434.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-298.904,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsOs) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'COC(=O)OF(2052)'],
    products = ['CCOC(=O)OF(11071)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)OF(1866)', 'C2H5(32)'],
    products = ['CCOC(=O)OF(11071)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(127)', 'CCO[C]=O(10814)'],
    products = ['CCOC(=O)OF(11071)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(19)', '[CH2]OC(=O)OF(2061)'],
    products = ['CCOC(=O)OF(11071)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C[CH]OC(=O)OF(11112)'],
    products = ['CCOC(=O)OF(11071)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]COC(=O)OF(11113)'],
    products = ['CCOC(=O)OF(11071)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CCOC(=O)OF(11071)'],
    products = ['O=C(O)OF(1860)', 'C2H4(30)'],
