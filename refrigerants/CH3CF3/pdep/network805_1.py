...
reaction(
    label = 'reaction7',
    reactants = ['OH(7)', 'O=[C]OC(F)(F)F(1918)'],
    products = ['O=C(O)OC(F)(F)F(1822)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(=O)OC(F)(F)F(1919)'],
    products = ['O=C(O)OC(F)(F)F(1822)'],
    transitionState = 'TS8',
