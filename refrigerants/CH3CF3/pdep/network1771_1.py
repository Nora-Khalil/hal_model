...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C(=O)[CH]F(2651)'],
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(=O)C=O(2607)'],
    products = ['C=C([O])C([O])F(6187)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(=O)C(=O)F(2034)'],
    products = ['C=C([O])C([O])F(6187)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(T)(18)', '[O]C(F)[C]=O(4281)'],
    products = ['C=C([O])C([O])F(6187)'],
