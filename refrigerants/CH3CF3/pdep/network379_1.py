...
reaction(
    label = 'reaction3',
    reactants = ['[O]OC=C(F)F(177)'],
    products = ['FC1(F)[CH]OO1(186)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', '[O]O[C]=C(F)F(1209)'],
    products = ['[O]OC=C(F)F(177)'],
    transitionState = 'TS6',
