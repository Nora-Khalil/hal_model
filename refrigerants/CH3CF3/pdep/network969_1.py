...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.449246,'amu*angstrom^2'), symmetry=1, barrier=(10.3291,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.448333,'amu*angstrom^2'), symmetry=1, barrier=(10.3081,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.615495,0.0820807,-0.000139435,1.22638e-07,-4.21826e-11,-83986.1,26.9456], Tmin=(100,'K'), Tmax=(810.883,'K')), NASAPolynomial(coeffs=[10.1463,0.0244253,-1.3098e-05,2.58695e-09,-1.80902e-13,-85182,-14.8801], Tmin=(810.883,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-699.253,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d) + radical(Csj(Cs-F1sF1sCd)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.894334,'amu*angstrom^2'), symmetry=1, barrier=(20.5625,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.893858,'amu*angstrom^2'), symmetry=1, barrier=(20.5516,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.686808,0.0825113,-0.000151769,1.4073e-07,-5.03188e-11,-44240.5,25.591], Tmin=(100,'K'), Tmax=(812.977,'K')), NASAPolynomial(coeffs=[9.06926,0.0246518,-1.43556e-05,2.90576e-09,-2.05236e-13,-45054.3,-9.73676], Tmin=(812.977,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-368.751,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(CdCsCdF) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + radical(Csj(Cd-F1sCd)(F1s)(F1s)) + radical(C=CCJ=O)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.851209,'amu*angstrom^2'), symmetry=1, barrier=(19.571,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.850499,'amu*angstrom^2'), symmetry=1, barrier=(19.5546,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.498891,0.0780509,-9.73918e-05,5.94919e-08,-1.42127e-11,-82343.9,27.4142], Tmin=(100,'K'), Tmax=(1025.64,'K')), NASAPolynomial(coeffs=[16.092,0.0172372,-8.45108e-06,1.68007e-09,-1.2093e-13,-85542.5,-48.2084], Tmin=(1025.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-685.688,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Csj(Cs-F1sF1sCd)(F1s)(F1s))"""),
)

species(
    label = 'O=[C][CH]C(F)(F)C(F)F(2770)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.35314,0.0864509,-0.000138848,1.15386e-07,-3.75937e-11,-86750.7,27.5501], Tmin=(100,'K'), Tmax=(823.545,'K')), NASAPolynomial(coeffs=[11.8933,0.0234998,-1.16216e-05,2.22227e-09,-1.52714e-13,-88417.5,-24.4637], Tmin=(823.545,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-722.328,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cds-OdCsH) + radical(CCJCHO) + radical(CCCJ=O)"""),
)

species(
    label = 'O=[C]C[C](F)C(F)(F)F(2771)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.386869,0.0911153,-0.000166491,1.54116e-07,-5.41098e-11,-86287.5,29.6204], Tmin=(100,'K'), Tmax=(856.365,'K')), NASAPolynomial(coeffs=[8.33761,0.0294074,-1.5366e-05,2.96336e-09,-2.02674e-13,-86748.3,-2.2441], Tmin=(856.365,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-718.424,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + group(Cds-OdCsH) + radical(CsCsCsF1s) + radical(CCCJ=O)"""),
)

species(
    label = 'O=C(F)C[C](F)[C](F)F(2772)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.437117,0.0939118,-0.000182815,1.79339e-07,-6.56686e-11,-83112.8,30.7495], Tmin=(100,'K'), Tmax=(855.483,'K')), NASAPolynomial(coeffs=[5.23417,0.0361396,-1.95477e-05,3.81501e-09,-2.6242e-13,-82640.2,15.914], Tmin=(855.483,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-691.981,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(COCsFO) + radical(CsCsCsF1s) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]CC(F)(F)[C](F)F(2336)'],
...
reaction(
    label = 'reaction2',
    reactants = ['C=C([O])C(F)(F)[C](F)F(2334)'],
    products = ['O=[C]CC(F)(F)[C](F)F(2336)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', 'O=[C]C[C](F)F(731)'],
    products = ['O=[C]CC(F)(F)[C](F)F(2336)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(192)', '[CH2]C(F)(F)[C](F)F(156)'],
    products = ['O=[C]CC(F)(F)[C](F)F(2336)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O=[C]CC(F)(F)[C](F)F(2336)'],
    products = ['O=C1CC(F)(F)C1(F)F(2765)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O=[C]CC(F)(F)[C](F)F(2336)'],
    products = ['O=C=CC(F)(F)C(F)F(2766)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CO(13)', '[CH2]C(F)(F)[C](F)F(156)'],
    products = ['O=[C]CC(F)(F)[C](F)F(2336)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=[C]CC(F)=C(F)F(2618)'],
    products = ['O=[C]CC(F)(F)[C](F)F(2336)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CF2CF2(61)', '[CH2][C]=O(981)'],
    products = ['O=[C]CC(F)(F)[C](F)F(2336)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[C](F)[C](F)F(1586)', 'CH2CO(28)'],
    products = ['O=[C]CC(F)(F)[C](F)F(2336)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C=CC(F)(F)[C](F)F(2767)'],
    products = ['O=[C]CC(F)(F)[C](F)F(2336)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C](F)[C](F)F(1586)', '[CH2][C]=O(981)'],
    products = ['O=[C]CC(F)(F)[C](F)F(2336)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=[C]C=C(F)[C](F)F(2768)'],
    products = ['O=[C]CC(F)(F)[C](F)F(2336)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(43)', 'O=[C]C[C](F)F(731)'],
    products = ['O=[C]CC(F)(F)[C](F)F(2336)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C=CC(F)(F)[C](F)F(2769)'],
    products = ['O=[C]CC(F)(F)[C](F)F(2336)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]CC(F)(F)[C](F)F(2336)'],
    products = ['O=[C][CH]C(F)(F)C(F)F(2770)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=[C]CC(F)(F)[C](F)F(2336)'],
    products = ['O=[C]C[C](F)C(F)(F)F(2771)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=[C]CC(F)(F)[C](F)F(2336)'],
    products = ['O=C(F)C[C](F)[C](F)F(2772)'],
