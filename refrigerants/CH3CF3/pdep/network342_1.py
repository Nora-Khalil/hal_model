...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(F)[C](F)F(975)'],
    products = ['O=O(161)', 'CHFCF2(55)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', '[O]O[CH]F(877)'],
    products = ['[O]OC(F)[C](F)F(975)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]OC(F)=C(F)F(1091)'],
    products = ['[O]OC(F)[C](F)F(975)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['[O]OC(F)[C](F)F(975)'],
    products = ['OH(7)', 'O=C(F)[C](F)F(1092)'],
