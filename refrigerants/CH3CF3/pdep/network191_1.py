...
reaction(
    label = 'reaction6',
    reactants = ['OH(7)', '[CH2]OC(F)(F)F(751)'],
    products = ['OCOC(F)(F)F(649)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O[CH]OC(F)(F)F(753)'],
    products = ['OCOC(F)(F)F(649)'],
    transitionState = 'TS8',
