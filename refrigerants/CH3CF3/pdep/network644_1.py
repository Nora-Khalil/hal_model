...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(192)', '[O]O[C]=O(785)'],
    products = ['O=[C]OO[C]=O(1619)'],
    transitionState = 'TS2',
