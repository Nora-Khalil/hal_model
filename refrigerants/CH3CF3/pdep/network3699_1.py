...
"""),
    E0 = (-709.132,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,193,295,551,588,656,1146,1192,1350,334,575,1197,1424,3202,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.255988,'amu*angstrom^2'), symmetry=1, barrier=(5.88567,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.80112,'amu*angstrom^2'), symmetry=1, barrier=(18.4193,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.255653,'amu*angstrom^2'), symmetry=1, barrier=(5.87797,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.578505,0.0841413,-0.000142243,1.29485e-07,-4.63998e-11,-104433,27.0773], Tmin=(100,'K'), Tmax=(800.077,'K')), NASAPolynomial(coeffs=[8.43583,0.0310359,-1.67653e-05,3.33708e-09,-2.3496e-13,-105248,-6.31241], Tmin=(800.077,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-869.258,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CsCdFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CdOs) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)
...
"""),
    E0 = (-717.253,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,219,296,586,564,718,793,1177,1228,350,440,435,1725,194,682,905,1196,1383,3221,3162.15],'cm^-1')),
        HinderedRotor(inertia=(0.279977,'amu*angstrom^2'), symmetry=1, barrier=(6.43721,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.279379,'amu*angstrom^2'), symmetry=1, barrier=(6.42348,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.817309,0.0808334,-0.000147812,1.39541e-07,-5.02029e-11,-86161.5,26.9794], Tmin=(100,'K'), Tmax=(841.266,'K')), NASAPolynomial(coeffs=[6.95312,0.0291891,-1.5664e-05,3.0698e-09,-2.12598e-13,-86398.7,3.164], Tmin=(841.266,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-717.253,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CsCdFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CdOs) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(ROOJ)"""),
)
...
"""),
    ...
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.346137,0.0911488,-0.000161983,1.48817e-07,-5.25075e-11,-86088.6,27.1116], Tmin=(100,'K'), Tmax=(839.082,'K')), NASAPolynomial(coeffs=[8.6322,0.0306333,-1.62341e-05,3.16868e-09,-2.19142e-13,-86739.3,-7.00186], Tmin=(839.082,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-716.789,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(CsCsFHH) + radical(ROOJ) + radical(C2CsJOOH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC([CH]F)C(F)(F)F(6862)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', '[O]OC(F)[CH]F(800)'],
    products = ['[O]OC([CH]F)C(F)(F)F(6862)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.33582e-06,'m^3/(mol*s)'), n=3.3552, Ea=(246.683,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R',), comment="""Estimated from node CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[O]C([CH]F)C(F)(F)F(12086)'],
    products = ['[O]OC([CH]F)C(F)(F)F(6862)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]F(804)', '[O]O[CH]C(F)(F)F(514)'],
    products = ['[O]OC([CH]F)C(F)(F)F(6862)'],
    transitionState = 'TS6',
...
reaction(
    ...
    kinetics = Arrhenius(A=(10834.1,'m^3/(mol*s)'), n=0.762578, Ea=(131.11,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_N-3R->C_N-2R!H->O_N-4R!H-u0_Ext-1R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_N-3R->C_N-2R!H->O_N-4R!H-u0_Ext-1R!H-R
Multiplied by reaction path degeneracy 2.0
Ea raised from 130.0 to 131.1 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction11',
    reactants = ['CF3(45)', '[O]OC=CF(422)'],
    products = ['[O]OC([CH]F)C(F)(F)F(6862)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(11.5478,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)

reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]OC(=CF)C(F)(F)F(12635)'],
    products = ['[O]OC([CH]F)C(F)(F)F(6862)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(7.6844e+07,'m^3/(mol*s)'), n=-0.361029, Ea=(2.97916,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction16',
    reactants = ['[O]OC([CH]F)C(F)(F)F(6862)'],
    products = ['[O]O[C](CF)C(F)(F)F(12636)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]OC([CH]F)C(F)(F)F(6862)'],
    products = ['OH(7)', 'O=C([CH]F)C(F)(F)F(6590)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(59.6013,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)
...
network(
    label = 'PDepNetwork #3699',
    isomers = [
        '[O]OC([CH]F)C(F)(F)F(6862)',
    ],
    reactants = [
