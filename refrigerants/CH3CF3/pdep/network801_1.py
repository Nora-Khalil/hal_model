...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=[C]OC(O)(F)F(1887)'],
    products = ['O=C(F)OC(O)(F)F(1818)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)F(459)', 'O[C](F)F(206)'],
    products = ['O=C(F)OC(O)(F)F(1818)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CFO(51)', '[O]C(O)(F)F(445)'],
    products = ['O=C(F)OC(O)(F)F(1818)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'O=C(F)OC(=O)F(1889)'],
    products = ['O=C(F)OC(O)(F)F(1818)'],
