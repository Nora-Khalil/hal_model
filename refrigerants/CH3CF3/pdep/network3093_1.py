...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F(3804)', '[CH]C-2(980)'],
    products = ['[CH]=C(F)O[CH]C(11901)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', '[CH]=C(F)OC=C(11913)'],
    products = ['[CH]=C(F)O[CH]C(11901)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C#CO[CH]C(11914)'],
    products = ['[CH]=C(F)O[CH]C(11901)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=[C]F(489)', 'C[CH][O](1817)'],
    products = ['[CH]=C(F)O[CH]C(11901)'],
    transitionState = 'TS9',
