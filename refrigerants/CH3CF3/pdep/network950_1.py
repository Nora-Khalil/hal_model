...
"""),
    E0 = (526.436,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525],'cm^-1')),
        HinderedRotor(inertia=(2.43231,'amu*angstrom^2'), symmetry=1, barrier=(55.9237,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.88546,'amu*angstrom^2'), symmetry=1, barrier=(20.3585,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.42634,'amu*angstrom^2'), symmetry=1, barrier=(55.7864,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0546,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08121,0.0470461,-7.39013e-05,6.57932e-08,-2.30458e-11,63380,16.7546], Tmin=(100,'K'), Tmax=(839.912,'K')), NASAPolynomial(coeffs=[5.7465,0.0203747,-9.81034e-06,1.85834e-09,-1.27135e-13,63089.4,1.64624], Tmin=(839.912,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(526.436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-OsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Acetyl)"""),
)
...
"""),
    E0 = (343.732,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655],'cm^-1')),
        HinderedRotor(inertia=(0.359058,'amu*angstrom^2'), symmetry=1, barrier=(8.25545,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.22257,'amu*angstrom^2'), symmetry=1, barrier=(28.1092,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.360921,'amu*angstrom^2'), symmetry=1, barrier=(8.29829,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97816,0.0542817,-0.000100489,1.02241e-07,-3.89921e-11,41404.8,17.3204], Tmin=(100,'K'), Tmax=(846.811,'K')), NASAPolynomial(coeffs=[2.44403,0.0290767,-1.50929e-05,2.93155e-09,-2.02358e-13,42150.7,20.0205], Tmin=(846.811,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(343.732,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#COOC(2318)'],
    products = ['CH2O(20)', 'CH2CO(28)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1054.45,'s^-1'), n=2.72887, Ea=(21.362,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C#COO(2132)'],
    products = ['C#COOC(2318)'],
    transitionState = 'TS2',
