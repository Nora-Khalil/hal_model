...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(192)', '[CH]=C[O](623)'],
    products = ['[CH]=CO[C]=O(5921)'],
    transitionState = 'TS2',
