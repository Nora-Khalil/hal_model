...
species(
    label = '[O]C(F)(F)[CH]C(F)(F)C(F)F(6985)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1127.39,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,235,523,627,1123,1142,1372,1406,3097,253,525,597,667,842,1178,1324,3025,407.5,1350,352.5,297.969,297.97,297.972,1648.04],'cm^-1')),
        HinderedRotor(inertia=(0.144933,'amu*angstrom^2'), symmetry=1, barrier=(9.13155,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144935,'amu*angstrom^2'), symmetry=1, barrier=(9.13163,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144932,'amu*angstrom^2'), symmetry=1, barrier=(9.13154,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.566887,0.108656,-0.000170955,1.3849e-07,-4.44952e-11,-135437,34.4149], Tmin=(100,'K'), Tmax=(764.218,'K')), NASAPolynomial(coeffs=[14.5339,0.0296176,-1.58187e-05,3.15699e-09,-2.23714e-13,-137745,-34.3769], Tmin=(764.218,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1127.39,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + radical(O2sj(Cs-CsF1sF1s)) + radical(CCJCO)"""),
)
...
species(
    label = 'FC(F)C1C(F)(F)OC1(F)F(6685)',
...
species(
    label = 'OC(F)(F)C(=C(F)F)C(F)F(3083)',
...
species(
    label = '[O]C(F)(F)C(=C(F)F)C(F)F(6986)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1191.95,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([171,205,598,1104,1143,1317,1411,3153,526,555,698,907,1200,1145,1227,350,440,435,1725,182,240,577,636,1210,1413,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.066263,'amu*angstrom^2'), symmetry=1, barrier=(1.52352,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09361,'amu*angstrom^2'), symmetry=1, barrier=(25.1443,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (179.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.149135,0.091551,-0.000125129,8.78435e-08,-2.47092e-11,-143226,30.9812], Tmin=(100,'K'), Tmax=(865.527,'K')), NASAPolynomial(coeffs=[13.8929,0.0280358,-1.50562e-05,3.06239e-09,-2.21445e-13,-145605,-33.3401], Tmin=(865.527,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1191.95,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + group(CsCFFH) + group(Cds-CdsCsCs) + group(CdCFF) + radical(O2sj(Cs-F1sF1sCd))"""),
)
...
species(
    label = 'O=C(F)[C]([C](F)F)C(F)F(3256)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = '[O]C(F)(F)[C](C(F)F)C(F)F(6988)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.169736,0.0994417,-0.000139215,1.01163e-07,-2.95088e-11,-141986,30.9353], Tmin=(100,'K'), Tmax=(835.252,'K')), NASAPolynomial(coeffs=[14.0763,0.0312206,-1.6704e-05,3.38389e-09,-2.43799e-13,-144366,-35.2297], Tmin=(835.252,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1181.73,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(CsCFFO) + group(CsCsFFH) + group(CsCsFFH) + radical(O2sj(Cs-CsF1sF1s)) + radical(CCJ(C)CO)"""),
)

species(
    label = 'OC(F)(F)[C]([C](F)F)C(F)F(6989)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'OC(F)(F)C([C](F)F)[C](F)F(6990)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = 'FO[C](F)C([C](F)F)C(F)F(6992)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-831.513,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,395,473,707,1436,190,488,555,1236,1407,274.622,274.647,274.649,274.655],'cm^-1')),
        HinderedRotor(inertia=(0.163739,'amu*angstrom^2'), symmetry=1, barrier=(8.76423,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.163751,'amu*angstrom^2'), symmetry=1, barrier=(8.76455,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.163741,'amu*angstrom^2'), symmetry=1, barrier=(8.76408,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.685691,'amu*angstrom^2'), symmetry=1, barrier=(36.6974,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.01542,0.122343,-0.000215506,1.9127e-07,-6.56698e-11,-99838.9,36.0812], Tmin=(100,'K'), Tmax=(824.132,'K')), NASAPolynomial(coeffs=[13.5123,0.0328406,-1.80369e-05,3.56902e-09,-2.48837e-13,-101589,-27.2838], Tmin=(824.132,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-831.513,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsCsH) + group(CsCFHO) + group(CsCsFFH) + group(CsCsFFH) + radical(CsCsF1sO2s) + radical(Csj(Cs-CsCsH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', '[O]C(F)(F)C[C](F)F(243)'],
    products = ['[O]C(F)(F)C([C](F)F)C(F)F(6682)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.33604e-10,'m^3/(mol*s)'), n=4.72997, Ea=(132.701,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', '[O]C(F)(F)C(F)[C](F)F(1015)'],
    products = ['[O]C(F)(F)C([C](F)F)C(F)F(6682)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(4.96165e-06,'m^3/(mol*s)'), n=3.30609, Ea=(135.357,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['[O]C(F)(F)[CH]C(F)(F)C(F)F(6985)'],
    products = ['[O]C(F)(F)C([C](F)F)C(F)F(6682)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C]F(138)', '[O]C(F)(F)[CH]C(F)F(271)'],
    products = ['[O]C(F)(F)C([C](F)F)C(F)F(6682)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O(6)', 'F[C](F)C([C](F)F)C(F)F(6830)'],
    products = ['[O]C(F)(F)C([C](F)F)C(F)F(6682)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)(F)C([C](F)F)C(F)F(6682)'],
    products = ['FC(F)C1C(F)(F)OC1(F)F(6685)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)(F)C([C](F)F)C(F)F(6682)'],
    products = ['OC(F)(F)C(=C(F)F)C(F)F(3083)'],
    transitionState = 'TS9',
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(18.1952,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(66.9781,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(214.143,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=C(F)[C]([C](F)F)C(F)F(3256)'],
    products = ['[O]C(F)(F)C([C](F)F)C(F)F(6682)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(274.901,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction18',
    reactants = ['CF2(43)', '[O]C(F)(F)[CH]C(F)F(271)'],
    products = ['[O]C(F)(F)C([C](F)F)C(F)F(6682)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(0.00976185,'m^3/(mol*s)'), n=2.64543, Ea=(2.23823,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.24524072153041726, var=3.368891203868511, Tref=1000.0, N=3, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s"""),
)

reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)(F)C([C](F)F)C(F)F(6682)'],
    products = ['[O]C(F)(F)[C](C(F)F)C(F)F(6988)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(F)(F)C([C](F)F)C(F)F(6682)'],
    products = ['OC(F)(F)[C]([C](F)F)C(F)F(6989)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C(F)(F)C([C](F)F)C(F)F(6682)'],
    products = ['OC(F)(F)C([C](F)F)[C](F)F(6990)'],
...
reaction(
    label = 'reaction24',
    reactants = ['FO[C](F)C([C](F)F)C(F)F(6992)'],
    products = ['[O]C(F)(F)C([C](F)F)C(F)F(6682)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(208.998,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)
