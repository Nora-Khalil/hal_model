...
"""),
    E0 = (-676.057,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,190,488,555,1236,1407,2782.5,750,1395,475,1775,1000,218.21,218.261,218.314,985.726],'cm^-1')),
        HinderedRotor(inertia=(0.00354052,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01833,'amu*angstrom^2'), symmetry=1, barrier=(34.4399,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01793,'amu*angstrom^2'), symmetry=1, barrier=(34.4403,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00825403,'amu*angstrom^2'), symmetry=1, barrier=(34.4406,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.86724,0.076222,-0.000110609,9.01689e-08,-3.04533e-11,-81204.9,29.3488], Tmin=(100,'K'), Tmax=(716.947,'K')), NASAPolynomial(coeffs=[8.84609,0.0317077,-1.74792e-05,3.57298e-09,-2.58199e-13,-82349,-6.48983], Tmin=(716.947,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-676.057,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(Cds-OdOsH) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-291.603,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,90,150,250,247,323,377,431,433,1065,1274,1008.59,1009.23,1009.24,2298.13],'cm^-1')),
        HinderedRotor(inertia=(0.025251,'amu*angstrom^2'), symmetry=1, barrier=(18.2511,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0085208,'amu*angstrom^2'), symmetry=1, barrier=(31.9307,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0441618,'amu*angstrom^2'), symmetry=1, barrier=(31.9262,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00852634,'amu*angstrom^2'), symmetry=1, barrier=(31.9309,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50114,0.0613054,-7.22771e-05,4.52733e-08,-1.18279e-11,-34987.1,24.4037], Tmin=(100,'K'), Tmax=(909.914,'K')), NASAPolynomial(coeffs=[9.45621,0.0263343,-1.46261e-05,3.0335e-09,-2.22332e-13,-36434.7,-13.2238], Tmin=(909.914,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-291.603,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCsFHH) + group(Cds-OdOsH) + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.498036,0.0802622,-0.000103838,6.05779e-08,-1.25933e-11,-79583.8,25.1674], Tmin=(100,'K'), Tmax=(1439.79,'K')), NASAPolynomial(coeffs=[21.2568,-0.00302044,6.72661e-06,-1.63656e-09,1.22826e-13,-83480.5,-79.4944], Tmin=(1439.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-663.178,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCFFO) + group(Cs-OsOsHH) + ring(1,3-Dioxolane) + radical(OCJO)"""),
)

species(
    label = '[O]C1OC(OF)C1(F)F(8789)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79088,0.0547898,-4.62027e-05,1.91508e-08,-3.3393e-12,-67400.7,24.1275], Tmin=(100,'K'), Tmax=(1286.88,'K')), NASAPolynomial(coeffs=[10.326,0.0282603,-1.52795e-05,3.13113e-09,-2.27185e-13,-69597.4,-19.2021], Tmin=(1286.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-561.016,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(CsCsCsFF) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + ring(Cs-O2s-Cs-Cs(F)(F)) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-650.927,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,182,240,577,636,1210,1413,2782.5,750,1395,475,1775,1000,180,180,952.55],'cm^-1')),
        HinderedRotor(inertia=(0.212335,'amu*angstrom^2'), symmetry=1, barrier=(4.882,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.212119,'amu*angstrom^2'), symmetry=1, barrier=(4.87704,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0765585,'amu*angstrom^2'), symmetry=1, barrier=(49.2368,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.624819,0.0873769,-0.000165881,1.62734e-07,-6.07211e-11,-78179.6,26.027], Tmin=(100,'K'), Tmax=(824.853,'K')), NASAPolynomial(coeffs=[5.79051,0.0346679,-1.97313e-05,3.96061e-09,-2.7838e-13,-78090.9,7.80381], Tmin=(824.853,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-650.927,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2sCF) + group(Cds-CdsCsCs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + group(Cds-OdOsH)"""),
)

species(
    label = '[O]C(OC=O)[C](F)F(8791)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-286.167,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,190,488,555,1236,1407,180,180,946.726],'cm^-1')),
        HinderedRotor(inertia=(0.325962,'amu*angstrom^2'), symmetry=1, barrier=(7.49451,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.13846,'amu*angstrom^2'), symmetry=1, barrier=(49.1674,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19125,0.0739367,-0.000147776,1.46252e-07,-5.41551e-11,-34328.5,21.6825], Tmin=(100,'K'), Tmax=(839.19,'K')), NASAPolynomial(coeffs=[5.56661,0.0264162,-1.51728e-05,3.04573e-09,-2.13165e-13,-34123.9,6.93526], Tmin=(839.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-286.167,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'O=CO[CH][C](F)F(725)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {5,S} {7,S}
...
"""),
    E0 = (-420.814,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,190,488,555,1236,1407,2782.5,750,1395,475,1775,1000,438.761,440.275,441.546],'cm^-1')),
        HinderedRotor(inertia=(0.25482,'amu*angstrom^2'), symmetry=1, barrier=(35.005,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0469402,'amu*angstrom^2'), symmetry=1, barrier=(6.46955,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133887,'amu*angstrom^2'), symmetry=1, barrier=(18.4862,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48465,0.0590356,-7.69141e-05,5.10667e-08,-1.35481e-11,-50524.7,23.3735], Tmin=(100,'K'), Tmax=(916.977,'K')), NASAPolynomial(coeffs=[10.9678,0.0176684,-9.24478e-06,1.86895e-09,-1.35011e-13,-52263.9,-21.5551], Tmin=(916.977,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-420.814,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-OdOsH) + radical(CCsJOC(O)H) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = 'O=CO[C](OF)[C](F)F(8792)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-470.811,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,360,370,350,190,488,555,1236,1407,2782.5,750,1395,475,1775,1000,180,948.522,952.134,956.765],'cm^-1')),
        HinderedRotor(inertia=(0.168028,'amu*angstrom^2'), symmetry=1, barrier=(3.8633,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.169422,'amu*angstrom^2'), symmetry=1, barrier=(3.89534,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.87295,'amu*angstrom^2'), symmetry=1, barrier=(43.0628,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.87089,'amu*angstrom^2'), symmetry=1, barrier=(43.0154,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22163,0.0716106,-9.14091e-05,3.77213e-08,1.28881e-11,-56535.9,29.5421], Tmin=(100,'K'), Tmax=(520.636,'K')), NASAPolynomial(coeffs=[8.96638,0.0288367,-1.63694e-05,3.34821e-09,-2.40681e-13,-57569,-4.94418], Tmin=(520.636,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-470.811,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(Cds-OdOsH) + radical(Cs_P) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'O=[C]OC(OF)[C](F)F(8793)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-479.609,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,190,488,555,1236,1407,1855,455,950,318.06,318.185,325.64,2057.78],'cm^-1')),
        HinderedRotor(inertia=(0.508076,'amu*angstrom^2'), symmetry=1, barrier=(38.1606,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114718,'amu*angstrom^2'), symmetry=1, barrier=(8.49854,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.516119,'amu*angstrom^2'), symmetry=1, barrier=(38.1708,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.506519,'amu*angstrom^2'), symmetry=1, barrier=(38.2142,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.448537,0.0866912,-0.00014932,1.33863e-07,-4.71262e-11,-57564,29.4635], Tmin=(100,'K'), Tmax=(794.65,'K')), NASAPolynomial(coeffs=[9.97048,0.0272041,-1.52161e-05,3.05559e-09,-2.15869e-13,-58712.4,-11.9899], Tmin=(794.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-479.609,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(Cds-OdOsH) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s)) + radical((O)CJOC)"""),
)

species(
    label = 'O=COC(=O)[C](F)F(1620)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 O u0 p2 c0 {6,S} {8,S}
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28962,0.0644382,-9.63546e-05,7.42319e-08,-2.27548e-11,-87659.9,26.779], Tmin=(100,'K'), Tmax=(799.064,'K')), NASAPolynomial(coeffs=[10.5077,0.0182912,-9.72304e-06,1.95052e-09,-1.39199e-13,-89133,-15.6248], Tmin=(799.064,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-729.621,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsOs) + group(Cds-OdOsH) + radical(Csj(CO-O2sO2d)(F1s)(F1s))"""),
)

species(
    label = 'O=COC([C]F)OF-2(8794)',
...
"""),
    E0 = (-678.436,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,522,611,926,1093,1137,1374,1416,3112,360,370,350,2782.5,750,1395,475,1775,1000,334.83,334.831,334.837,2022.88],'cm^-1')),
        HinderedRotor(inertia=(0.114688,'amu*angstrom^2'), symmetry=1, barrier=(9.12432,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.404467,'amu*angstrom^2'), symmetry=1, barrier=(32.1781,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.404467,'amu*angstrom^2'), symmetry=1, barrier=(32.1781,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.404473,'amu*angstrom^2'), symmetry=1, barrier=(32.1782,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06276,0.0713302,-8.61028e-05,5.45244e-08,-1.42321e-11,-81496.9,27.8367], Tmin=(100,'K'), Tmax=(916.305,'K')), NASAPolynomial(coeffs=[10.9294,0.0282589,-1.55949e-05,3.22577e-09,-2.36068e-13,-83305,-18.9017], Tmin=(916.305,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-678.436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(Cds-OdOsH) + radical(Cs_P)"""),
)

species(
    label = 'O=[C]OC(OF)C(F)F(8796)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.65544,0.0802975,-0.000110732,7.99311e-08,-2.33272e-11,-82540.6,27.2349], Tmin=(100,'K'), Tmax=(832.255,'K')), NASAPolynomial(coeffs=[11.7428,0.0270091,-1.46888e-05,2.99639e-09,-2.16817e-13,-84386.1,-24.2192], Tmin=(832.255,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-687.234,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)

species(
    label = '[O]C(OC=O)C(F)(F)F(8797)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O=COC([C]F)OF(8787)'],
    products = ['O=COC(OF)[C](F)F(8705)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(138)', 'O=CO[CH]OF(1995)'],
    products = ['O=COC(OF)[C](F)F(8705)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O=COC(OF)[C](F)F(8705)'],
    products = ['FOC1O[CH]OC1(F)F(8788)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O=COC(OF)[C](F)F(8705)'],
    products = ['[O]C1OC(OF)C1(F)F(8789)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C=O(322)', 'FOC=C(F)F(707)'],
    products = ['O=COC(OF)[C](F)F(8705)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(127)', 'O=COC=C(F)F(626)'],
    products = ['O=COC(OF)[C](F)F(8705)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=COC(OF)=C(F)F(8790)'],
    products = ['O=COC(OF)[C](F)F(8705)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C(OC=O)[C](F)F(8791)'],
    products = ['O=COC(OF)[C](F)F(8705)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C=O(322)', 'FO[CH][C](F)F(1242)'],
    products = ['O=COC(OF)[C](F)F(8705)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HCO(15)', '[O]C(OF)[C](F)F(2431)'],
    products = ['O=COC(OF)[C](F)F(8705)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(127)', 'O=CO[CH][C](F)F(725)'],
    products = ['O=COC(OF)[C](F)F(8705)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'O=CO[C](OF)[C](F)F(8792)'],
    products = ['O=COC(OF)[C](F)F(8705)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'O=[C]OC(OF)[C](F)F(8793)'],
    products = ['O=COC(OF)[C](F)F(8705)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=COC(=O)[C](F)F(1620)'],
    products = ['O=COC(OF)[C](F)F(8705)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F(37)', 'O=COC([C]F)OF-2(8794)'],
    products = ['O=COC(OF)[C](F)F(8705)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CF2(43)', 'O=CO[CH]OF(1995)'],
    products = ['O=COC(OF)[C](F)F(8705)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=CO[C](OF)C(F)F(8795)'],
    products = ['O=COC(OF)[C](F)F(8705)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O=COC(OF)[C](F)F(8705)'],
    products = ['[O]C(OC=O)C(F)(F)F(8797)'],
