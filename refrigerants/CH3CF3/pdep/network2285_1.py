...
"""),
    E0 = (-19.9278,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,180,556.557,556.561,556.585],'cm^-1')),
        HinderedRotor(inertia=(0.129706,'amu*angstrom^2'), symmetry=1, barrier=(2.9822,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.085517,'amu*angstrom^2'), symmetry=1, barrier=(18.7974,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0855093,'amu*angstrom^2'), symmetry=1, barrier=(18.7974,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.49141,0.0261854,8.7779e-06,-2.29352e-08,8.50612e-12,-48965,16.9475], Tmin=(100,'K'), Tmax=(1107.16,'K')), NASAPolynomial(coeffs=[7.64054,0.0239689,-1.04197e-05,1.99229e-09,-1.41066e-13,-51109.5,-12.9539], Tmin=(1107.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-407.618,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH)"""),
)
...
"""),
    E0 = (11.2052,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,180,180,541.91,541.926],'cm^-1')),
        HinderedRotor(inertia=(0.0141534,'amu*angstrom^2'), symmetry=1, barrier=(2.94929,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0141459,'amu*angstrom^2'), symmetry=1, barrier=(2.94849,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150092,'amu*angstrom^2'), symmetry=1, barrier=(31.2743,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70059,0.0437292,-3.21688e-05,1.17765e-08,-1.72382e-12,1436.16,20.4439], Tmin=(100,'K'), Tmax=(1611.75,'K')), NASAPolynomial(coeffs=[12.8067,0.0161664,-6.51714e-06,1.16627e-09,-7.80491e-14,-2143.89,-38.4377], Tmin=(1611.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(11.2052,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(CJCO)"""),
)

species(
    label = 'C[CH]O[CH]O(8262)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16954,0.062401,-8.0762e-05,5.3888e-08,-1.4043e-11,-6917.97,20.4624], Tmin=(100,'K'), Tmax=(946.404,'K')), NASAPolynomial(coeffs=[12.3848,0.0149995,-5.63344e-06,9.66021e-10,-6.32764e-14,-9040.81,-33.0269], Tmin=(946.404,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-58.3656,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCsJOCs) + radical(OCJO)"""),
)
...
"""),
    E0 = (-11.4237,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180,180,957.232,957.574],'cm^-1')),
        HinderedRotor(inertia=(0.096665,'amu*angstrom^2'), symmetry=1, barrier=(2.22252,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0979889,'amu*angstrom^2'), symmetry=1, barrier=(2.25296,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0988045,'amu*angstrom^2'), symmetry=1, barrier=(2.27171,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.24718,0.0287734,-1.15344e-05,1.12071e-09,6.02934e-14,-1418.39,10.2438], Tmin=(100,'K'), Tmax=(2745.94,'K')), NASAPolynomial(coeffs=[38.9554,-0.00824229,1.28747e-06,-1.96037e-10,1.6643e-14,-25585.7,-201.56], Tmin=(2745.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-11.4237,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(OCJO)"""),
)

species(
    label = '[CH2][CH]OCO(8264)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {4,S}
2  O u0 p2 c0 {3,S} {11,S}
3  C u0 p0 c0 {1,S} {2,S} {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.24667,0.0664228,-7.19197e-05,3.54155e-08,-6.26886e-12,-4121.87,26.4102], Tmin=(100,'K'), Tmax=(1689.55,'K')), NASAPolynomial(coeffs=[19.7357,0.000435791,3.24745e-06,-7.87458e-10,5.62517e-14,-8208.12,-72.5837], Tmin=(1689.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-35.7367,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCsJOCs) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C[O](318)', '[CH]C-2(978)'],
    products = ['C[CH]OC[O](8244)'],
    transitionState = 'TS2',
