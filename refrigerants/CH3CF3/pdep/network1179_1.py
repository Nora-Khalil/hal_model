...
species(
    label = 'F[CH][C]1C=C(F)C1(F)F(3620)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[C]=CC([CH]F)=C(F)F(3024)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]=CC(F)[C]=C(F)F(3025)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', 'F[C]C=C=C(F)F(3618)'],
    products = ['F[C]=CC([CH]F)=C(F)F(3024)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]=CC([CH]F)=C(F)F(3024)'],
    products = ['FC1=CC(=C(F)F)C1F(3454)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C]=CC([CH]F)=C(F)F(3024)'],
    products = ['F[CH][C]1C=C(F)C1(F)F(3620)'],
    transitionState = 'TS6',
...
reaction(
    ...
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.69117e+12,'s^-1'), n=0.1675, Ea=(114.275,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_D_D;doublebond_intra;radadd_intra_cdsingle]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 112.7 to 114.3 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'FC#CC([CH]F)=C(F)F(3621)'],
    products = ['F[C]=CC([CH]F)=C(F)F(3024)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', 'F[C]C=C=C(F)F(3618)'],
    products = ['F[C]=CC([CH]F)=C(F)F(3024)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[C]=C=C(CF)[C](F)F(3622)'],
    products = ['F[C]=CC([CH]F)=C(F)F(3024)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[C]=CC(=[C]F)C(F)F(3623)'],
    products = ['F[C]=CC([CH]F)=C(F)F(3024)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C]=CC([CH]F)=C(F)F(3024)'],
    products = ['F[C]C(C=C(F)F)=CF(3624)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C]F(138)', 'F[C]C=C=CF(530)'],
    products = ['F[C]=CC([CH]F)=C(F)F(3024)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C]=CC([CH]F)=C(F)F(3024)'],
    products = ['F[C](F)[C]1C=C(F)C1F(3625)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CF2(43)', 'F[C]C=C=CF(530)'],
    products = ['F[C]=CC([CH]F)=C(F)F(3024)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C]=C=C([CH]F)C(F)F(3626)'],
    products = ['F[C]=CC([CH]F)=C(F)F(3024)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F[C]=CC([CH]F)=C(F)F(3024)'],
    products = ['F[C]C(C=CF)=C(F)F(3627)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]=C(C=[C]F)C(F)(F)F(3628)'],
    products = ['F[C]=CC([CH]F)=C(F)F(3024)'],
...
reaction(
    label = 'reaction25',
    reactants = ['F[C]=CC([CH]F)=C(F)F(3024)'],
    products = ['[CH]C(C=C(F)F)=C(F)F(3629)'],
