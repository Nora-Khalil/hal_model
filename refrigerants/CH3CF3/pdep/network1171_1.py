...
reaction(
    label = 'reaction1',
    reactants = ['FC#CC(F)(F)OC(F)F(3016)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'FC#COC(F)F(6388)'],
    products = ['FC#CC(F)(F)OC(F)F(3016)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['FOC(F)F(247)', 'F[C]C#CF(3631)'],
    products = ['FC#CC(F)(F)OC(F)F(3016)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CHF(40)', 'FC#CC(F)(F)OF(6389)'],
    products = ['FC#CC(F)(F)OC(F)F(3016)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[C]=C=C(F)OC(F)F(6390)'],
    products = ['FC#CC(F)(F)OC(F)F(3016)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'FC#CC(F)(F)O[CH]F(5792)'],
    products = ['FC#CC(F)(F)OC(F)F(3016)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[C]#CC(F)(F)OC(F)F(6391)'],
    products = ['FC#CC(F)(F)OC(F)F(3016)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)F(207)', 'F[C]=C=C(F)F(2804)'],
    products = ['FC#CC(F)(F)OC(F)F(3016)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF2(82)', '[O]C(F)(F)C#CF(545)'],
    products = ['FC#CC(F)(F)OC(F)F(3016)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[C]#CF(467)', 'F[C](F)OC(F)F(667)'],
    products = ['FC#CC(F)(F)OC(F)F(3016)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[C]=C(F)C(F)(F)OC(F)F(6392)'],
    products = ['FC#CC(F)(F)OC(F)F(3016)'],
