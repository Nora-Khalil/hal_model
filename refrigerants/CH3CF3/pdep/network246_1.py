...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C(F)[CH]F(836)'],
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(F)(F)C=CF(847)'],
    products = ['[O]C(F)(F)C(F)[CH]F(836)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)(F)C(F)=CF(848)'],
    products = ['[O]C(F)(F)C(F)[CH]F(836)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C(F)C(F)[CH]F(849)'],
    products = ['[O]C(F)(F)C(F)[CH]F(836)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['F2(78)', 'O=C(F)[CH][CH]F(850)'],
    products = ['[O]C(F)(F)C(F)[CH]F(836)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH][CH]C(F)(F)OF(852)'],
    products = ['[O]C(F)(F)C(F)[CH]F(836)'],
