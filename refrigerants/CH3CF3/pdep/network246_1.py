...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)O[C](F)F(832)'],
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'FC=CO[C](F)F(837)'],
    products = ['F[CH]C(F)O[C](F)F(832)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'FC=C(F)O[C](F)F(838)'],
    products = ['F[CH]C(F)O[C](F)F(832)'],
    transitionState = 'TS9',
