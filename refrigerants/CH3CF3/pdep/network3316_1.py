...
species(
    label = '[CH2]C(OF)[C](F)C(F)F(11050)',
...
species(
    label = '[CH2]C(OF)C(F)[C](F)F(11051)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['C=C(OF)C(F)C(F)F(10910)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]C(F)F(169)', 'C=COF(714)'],
    products = ['C=C(OF)C(F)C(F)F(10910)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['HF(38)', 'C=C(OF)C(F)[C]F(11046)'],
    products = ['C=C(OF)C(F)C(F)F(10910)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C=C(OF)C(F)C(F)F(10910)'],
    products = ['O=C(CF)C(F)C(F)F(11047)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(OF)[C](F)C(F)F(11050)'],
    products = ['C=C(OF)C(F)C(F)F(10910)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(OF)C(F)[C](F)F(11051)'],
    products = ['C=C(OF)C(F)C(F)F(10910)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[C](OF)C(F)[C](F)F(11052)'],
    products = ['C=C(OF)C(F)C(F)F(10910)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[CH2]C(=CC(F)F)OF(8666)'],
    products = ['C=C(OF)C(F)C(F)F(10910)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'C=C(OF)C(F)[CH]F(11053)'],
    products = ['C=C(OF)C(F)C(F)F(10910)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'C=C([O])C(F)C(F)F(11054)'],
    products = ['C=C(OF)C(F)C(F)F(10910)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(127)', 'C=[C]C(F)C(F)F(11055)'],
    products = ['C=C(OF)C(F)C(F)F(10910)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHF2(82)', 'C=C([CH]F)OF(11056)'],
    products = ['C=C(OF)C(F)C(F)F(10910)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CHF2-CHF(67)', 'C=[C]OF(1642)'],
    products = ['C=C(OF)C(F)C(F)F(10910)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'C=C(OF)[C](F)C(F)F(11057)'],
    products = ['C=C(OF)C(F)C(F)F(10910)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'C=C(OF)C(F)[C](F)F(11058)'],
    products = ['C=C(OF)C(F)C(F)F(10910)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', '[CH]=C(OF)C(F)C(F)F(11059)'],
    products = ['C=C(OF)C(F)C(F)F(10910)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]C(OF)C(F)C(F)F(11060)'],
    products = ['C=C(OF)C(F)C(F)F(10910)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F2(78)', 'C=C(C=CF)OF(8670)'],
    products = ['C=C(OF)C(F)C(F)F(10910)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'C=C(C=C(F)F)OF(11061)'],
    products = ['C=C(OF)C(F)C(F)F(10910)'],
...
network(
    label = 'PDepNetwork #3316',
    isomers = [
        'C=C(OF)C(F)C(F)F(10910)',
    ],
    reactants = [
