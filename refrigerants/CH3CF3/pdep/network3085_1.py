...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (160.085,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3083.31,'J/mol'), sigma=(5.55667,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=481.61 K, Pc=40.78 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = 'FC(F)C1CC(F)C1(F)F(10304)',
...
"""),
    ...
    molecularWeight = (160.085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0971221,0.0747878,-6.00851e-05,2.35293e-08,-3.64482e-12,-127103,28.525], Tmin=(100,'K'), Tmax=(1540.24,'K')), NASAPolynomial(coeffs=[19.8916,0.0233813,-1.00211e-05,1.85973e-09,-1.27545e-13,-133201,-75.5215], Tmin=(1540.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1058.04,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(CsCsCsFF) + group(CsCsCsFH) + group(CsCsFFH) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + ring(Cs-Cs-Cs(F)(F)-Cs)"""),
)

species(
    label = 'C=C(F)C(F)(F)CC(F)F(10351)',
...
"""),
    ...
    molecularWeight = (160.085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.13153,0.0985063,-0.000132413,9.76821e-08,-2.94316e-11,-128560,28.7978], Tmin=(100,'K'), Tmax=(805.092,'K')), NASAPolynomial(coeffs=[12.1197,0.0376363,-1.9001e-05,3.76797e-09,-2.6842e-13,-130532,-27.651], Tmin=(805.092,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1070.09,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(CsCsFFH) + group(CdCsCdF) + group(Cds-CdsHH)"""),
)

species(
    label = 'CC(F)C(F)(F)C=C(F)F(10240)',
...
"""),
    ...
    molecularWeight = (160.085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.168234,0.0914753,-0.000112352,7.61757e-08,-2.1348e-11,-126527,28.0981], Tmin=(100,'K'), Tmax=(858.266,'K')), NASAPolynomial(coeffs=[11.6045,0.0381776,-1.9206e-05,3.82571e-09,-2.741e-13,-128490,-25.3275], Tmin=(858.266,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1053.1,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCFF)"""),
)
...
species(
    label = '[CH2]C(F)C(F)=CC(F)F(10352)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-637.974,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([174,267,591,721,1107,1278,1348,3273,171,205,598,1104,1143,1317,1411,3153,323,467,575,827,1418,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.1228,'amu*angstrom^2'), symmetry=1, barrier=(2.82341,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122823,'amu*angstrom^2'), symmetry=1, barrier=(2.82395,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.571147,'amu*angstrom^2'), symmetry=1, barrier=(13.1318,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.499594,0.0842217,-0.000112513,8.73494e-08,-2.83396e-11,-76611.2,29.1304], Tmin=(100,'K'), Tmax=(743.785,'K')), NASAPolynomial(coeffs=[9.08922,0.0380282,-1.93554e-05,3.8515e-09,-2.74794e-13,-77889,-9.76715], Tmin=(743.785,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-637.974,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(Cs-CsHHH) + group(CsCFFH) + group(CdCsCdF) + group(Cds-CdsCsH) + radical(Csj(Cs-F1sCdH)(H)(H))"""),
)
...
species(
    label = '[CH2]C(F)C(F)(F)C=CF(10353)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-645.336,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([274,345,380,539,705,1166,1213,259,529,569,1128,1321,1390,3140,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.157895,'amu*angstrom^2'), symmetry=1, barrier=(3.63031,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156935,'amu*angstrom^2'), symmetry=1, barrier=(3.60824,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.833305,'amu*angstrom^2'), symmetry=1, barrier=(19.1593,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.327339,0.0876018,-0.000115012,8.3726e-08,-2.50279e-11,-77489.8,27.92], Tmin=(100,'K'), Tmax=(809.625,'K')), NASAPolynomial(coeffs=[10.9739,0.0350009,-1.75556e-05,3.47676e-09,-2.47683e-13,-79213.8,-21.195], Tmin=(809.625,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-645.336,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = '[CH2]C(F)C(F)(F)C=C(F)F(10354)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-846.367,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([274,345,380,539,705,1166,1213,259,529,569,1128,1321,1390,3140,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,182,240,577,636,1210,1413,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.0891921,'amu*angstrom^2'), symmetry=1, barrier=(2.0507,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0894703,'amu*angstrom^2'), symmetry=1, barrier=(2.0571,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.790827,'amu*angstrom^2'), symmetry=1, barrier=(18.1827,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (159.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0963939,0.0978992,-0.000140669,1.10447e-07,-3.52235e-11,-101654,30.4424], Tmin=(100,'K'), Tmax=(763.704,'K')), NASAPolynomial(coeffs=[11.7959,0.0356093,-1.83199e-05,3.64025e-09,-2.58782e-13,-103471,-23.7249], Tmin=(763.704,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-846.367,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCFF) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)
...
species(
    label = 'C[C](F)C(F)(F)[CH]C(F)F(10355)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-819.067,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,522,611,926,1093,1137,1374,1416,3112,2750,2800,2850,1350,1500,750,1050,1375,1000,212,367,445,1450,3025,407.5,1350,352.5,180,180,1044.02],'cm^-1')),
        HinderedRotor(inertia=(0.26381,'amu*angstrom^2'), symmetry=1, barrier=(6.06551,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.266314,'amu*angstrom^2'), symmetry=1, barrier=(6.12308,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.266519,'amu*angstrom^2'), symmetry=1, barrier=(6.12781,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.262106,'amu*angstrom^2'), symmetry=1, barrier=(6.02634,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (160.085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.389809,0.107996,-0.000177339,1.61046e-07,-5.76921e-11,-98364,34.0534], Tmin=(100,'K'), Tmax=(809.25,'K')), NASAPolynomial(coeffs=[8.77932,0.0435941,-2.25999e-05,4.43525e-09,-3.10068e-13,-99223.3,-4.38156], Tmin=(809.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-819.067,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(CsCsFFH) + group(Cs-CsHHH) + radical(Csj(Cs-F1sF1sCs)(Cs-HHH)(F1s)) + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(H))"""),
)

species(
    label = '[CH2]C(F)C(F)(F)C[C](F)F(10356)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (160.085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.770306,0.11588,-0.000190685,1.68285e-07,-5.85049e-11,-96993.6,33.4806], Tmin=(100,'K'), Tmax=(809.551,'K')), NASAPolynomial(coeffs=[11.3312,0.0401454,-2.08215e-05,4.07922e-09,-2.84668e-13,-98430.6,-19.1191], Tmin=(809.551,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-807.791,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(CsCsFFH) + group(Cs-CsHHH) + radical(Csj(Cs-CsHH)(F1s)(F1s)) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = '[CH2][C](F)C(F)(F)CC(F)F(10357)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (160.085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.706617,0.116298,-0.00019768,1.79948e-07,-6.38075e-11,-98459,33.499], Tmin=(100,'K'), Tmax=(823.992,'K')), NASAPolynomial(coeffs=[9.69647,0.0428947,-2.23648e-05,4.37421e-09,-3.04236e-13,-99395.9,-9.95805], Tmin=(823.992,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-819.941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(CsCsFFH) + group(Cs-CsHHH) + radical(Csj(Cs-F1sF1sCs)(Cs-HHH)(F1s)) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = 'CC(F)C(F)(F)[CH][C](F)F(10358)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (160.085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.443878,0.107455,-0.000169876,1.4873e-07,-5.20986e-11,-96899,34.0011], Tmin=(100,'K'), Tmax=(787.84,'K')), NASAPolynomial(coeffs=[10.3795,0.0409071,-2.10942e-05,4.14939e-09,-2.91274e-13,-98244.5,-13.3504], Tmin=(787.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-806.917,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsCsFFH) + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = '[CH2]C(F)[C](F)C(F)C(F)F(10359)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-768.836,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([207,311,436,622,447,691,1074,1182,1276,1366,1311,1469,3045,3235,235,523,627,1123,1142,1372,1406,3097,212,367,445,1450,3000,3100,440,815,1455,1000,201.613,201.796,2539.76],'cm^-1')),
        HinderedRotor(inertia=(1.19302,'amu*angstrom^2'), symmetry=1, barrier=(34.4632,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.340467,'amu*angstrom^2'), symmetry=1, barrier=(9.83332,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.340154,'amu*angstrom^2'), symmetry=1, barrier=(9.83324,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19133,'amu*angstrom^2'), symmetry=1, barrier=(34.4636,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (160.085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.613946,0.110505,-0.000172202,1.46621e-07,-5.00262e-11,-92312.1,34.4508], Tmin=(100,'K'), Tmax=(780.979,'K')), NASAPolynomial(coeffs=[11.8452,0.0389454,-1.98829e-05,3.89682e-09,-2.73147e-13,-94022,-21.065], Tmin=(780.979,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-768.836,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsHHH) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = 'FCC(F)[C](F)[CH]C(F)F(10360)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-766.661,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,528,1116,1182,1331,1402,1494,3075,3110,522,611,926,1093,1137,1374,1416,3112,212,367,445,1450,3025,407.5,1350,352.5,215.574,215.574,215.575,2185.34],'cm^-1')),
        HinderedRotor(inertia=(0.971773,'amu*angstrom^2'), symmetry=1, barrier=(32.047,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216932,'amu*angstrom^2'), symmetry=1, barrier=(7.15395,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.971774,'amu*angstrom^2'), symmetry=1, barrier=(32.047,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216931,'amu*angstrom^2'), symmetry=1, barrier=(7.15395,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (160.085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.606991,0.0885112,-8.71279e-05,-3.87538e-09,5.13915e-11,-92099.9,32.6872], Tmin=(100,'K'), Tmax=(497.388,'K')), NASAPolynomial(coeffs=[9.06173,0.0438803,-2.29866e-05,4.58658e-09,-3.26053e-13,-93229.9,-5.10238], Tmin=(497.388,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-766.661,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsCsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(Cs-F1sF1sH)(H))"""),
)

species(
    label = '[CH2][CH]C(F)(F)C(F)C(F)F(10361)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-795.529,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,215,315,519,588,595,1205,1248,235,523,627,1123,1142,1372,1406,3097,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,350.345,2198.35,2198.35],'cm^-1')),
        HinderedRotor(inertia=(0.11033,'amu*angstrom^2'), symmetry=1, barrier=(9.6101,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.357569,'amu*angstrom^2'), symmetry=1, barrier=(31.1468,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110327,'amu*angstrom^2'), symmetry=1, barrier=(9.6101,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.357538,'amu*angstrom^2'), symmetry=1, barrier=(31.1468,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (160.085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0150832,0.0951621,-0.000122286,8.63777e-08,-2.50723e-11,-95543.2,33.6786], Tmin=(100,'K'), Tmax=(832.125,'K')), NASAPolynomial(coeffs=[11.9061,0.038004,-1.92545e-05,3.83548e-09,-2.7441e-13,-97522.2,-21.5038], Tmin=(832.125,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-795.529,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsHHH) + radical(Csj(Cs-F1sF1sCs)(Cs-HHH)(H)) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]C(F)C(F)(F)C(F)[CH]F(10362)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-772.29,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,207,311,436,622,447,691,1074,1182,1276,1366,1311,1469,3045,3235,334,575,1197,1424,3202,3000,3100,440,815,1455,1000,243.658,245.409,246.707],'cm^-1')),
        HinderedRotor(inertia=(0.156373,'amu*angstrom^2'), symmetry=1, barrier=(6.74225,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156676,'amu*angstrom^2'), symmetry=1, barrier=(6.74461,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.459621,'amu*angstrom^2'), symmetry=1, barrier=(19.7274,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.855714,'amu*angstrom^2'), symmetry=1, barrier=(37.5008,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (160.085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.963416,0.118206,-0.000187087,1.56814e-07,-5.22637e-11,-92714.9,33.2901], Tmin=(100,'K'), Tmax=(782.096,'K')), NASAPolynomial(coeffs=[13.9379,0.036166,-1.85644e-05,3.63698e-09,-2.5455e-13,-94867.5,-33.7982], Tmin=(782.096,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-772.29,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsCsFH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(Csj(Cs-F1sCsH)(F1s)(H)) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = 'F[CH][CH]C(F)(F)C(F)CF(10363)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-773.231,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,215,315,519,588,595,1205,1248,528,1116,1182,1331,1402,1494,3075,3110,3025,407.5,1350,352.5,334,575,1197,1424,3202,263.269,263.361,264.966,2372.35],'cm^-1')),
        HinderedRotor(inertia=(0.164911,'amu*angstrom^2'), symmetry=1, barrier=(8.16041,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.164885,'amu*angstrom^2'), symmetry=1, barrier=(8.16806,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.637791,'amu*angstrom^2'), symmetry=1, barrier=(31.5747,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.636412,'amu*angstrom^2'), symmetry=1, barrier=(31.5662,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (160.085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.629913,0.112095,-0.000180202,1.58249e-07,-5.53127e-11,-92841.3,34.2833], Tmin=(100,'K'), Tmax=(792.855,'K')), NASAPolynomial(coeffs=[10.9298,0.0409337,-2.1278e-05,4.18997e-09,-2.93958e-13,-94270.8,-16.257], Tmin=(792.855,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-773.231,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsCsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + radical(Csj(Cs-F1sF1sCs)(Cs-F1sHH)(H)) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]C(F)F-2(957)', '[CH2]C(F)[C](F)F(1037)'],
    products = ['[CH2]C(F)C(F)(F)[CH]C(F)F(10235)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'F[CH]C(F)(F)[CH]C(F)F(1054)'],
    products = ['[CH2]C(F)C(F)(F)[CH]C(F)F(10235)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)C(F)(F)[CH]C(F)F(10235)'],
    products = ['FC(F)C1CC(F)C1(F)F(10304)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)C(F)(F)[CH]C(F)F(10235)'],
    products = ['C=C(F)C(F)(F)CC(F)F(10351)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)C(F)(F)[CH]C(F)F(10235)'],
    products = ['CC(F)C(F)(F)C=C(F)F(10240)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(F)C(F)=CC(F)F(10352)'],
    products = ['[CH2]C(F)C(F)(F)[CH]C(F)F(10235)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(49.3514,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(F)C(F)(F)C=C(F)F(10354)'],
    products = ['[CH2]C(F)C(F)(F)[CH]C(F)F(10235)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(78)', '[CH2]C=C(F)[CH]C(F)F(7713)'],
    products = ['[CH2]C(F)C(F)(F)[CH]C(F)F(10235)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(17.975,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction18',
    reactants = ['HF(38)', '[CH2]C(F)=C(F)[CH]C(F)F(6845)'],
    products = ['[CH2]C(F)C(F)(F)[CH]C(F)F(10235)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(251.488,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction19',
    reactants = ['C[C](F)C(F)(F)[CH]C(F)F(10355)'],
    products = ['[CH2]C(F)C(F)(F)[CH]C(F)F(10235)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(F)C(F)(F)[CH]C(F)F(10235)'],
    products = ['[CH2]C(F)C(F)(F)C[C](F)F(10356)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(F)C(F)(F)[CH]C(F)F(10235)'],
    products = ['[CH2][C](F)C(F)(F)CC(F)F(10357)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(F)C(F)(F)[CH]C(F)F(10235)'],
    products = ['CC(F)C(F)(F)[CH][C](F)F(10358)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(F)[C](F)C(F)C(F)F(10359)'],
    products = ['[CH2]C(F)C(F)(F)[CH]C(F)F(10235)'],
...
reaction(
    label = 'reaction24',
    reactants = ['FCC(F)[C](F)[CH]C(F)F(10360)'],
    products = ['[CH2]C(F)C(F)(F)[CH]C(F)F(10235)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(211.494,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction25',
    reactants = ['[CH2][CH]C(F)(F)C(F)C(F)F(10361)'],
    products = ['[CH2]C(F)C(F)(F)[CH]C(F)F(10235)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(225.676,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(F)C(F)(F)[CH]C(F)F(10235)'],
    products = ['FC[CH]C(F)(F)[CH]C(F)F(10343)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(1.00763e+12,'s^-1'), n=0.18834, Ea=(181.536,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C"""),
)

reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(F)C(F)(F)C(F)[CH]F(10362)'],
    products = ['[CH2]C(F)C(F)(F)[CH]C(F)F(10235)'],
...
reaction(
    label = 'reaction28',
    reactants = ['F[CH][CH]C(F)(F)C(F)CF(10363)'],
    products = ['[CH2]C(F)C(F)(F)[CH]C(F)F(10235)'],
    transitionState = 'TS28',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(184.578,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

network(
    label = 'PDepNetwork #3085',
    isomers = [
        '[CH2]C(F)C(F)(F)[CH]C(F)F(10235)',
    ],
    reactants = [
