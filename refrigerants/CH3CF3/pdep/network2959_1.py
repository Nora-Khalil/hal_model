...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH2]C(=C)[O](1709)'],
    products = ['[CH2]CC(=C)[O](9953)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['CH2CO(28)', '[CH2][CH2](979)'],
    products = ['[CH2]CC(=C)[O](9953)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C]=O(981)', '[CH2][CH2](979)'],
    products = ['[CH2]CC(=C)[O](9953)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(18)', '[CH2]C[C]=O(1667)'],
    products = ['[CH2]CC(=C)[O](9953)'],
