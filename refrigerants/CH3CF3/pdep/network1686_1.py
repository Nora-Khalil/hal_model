...
"""),
    E0 = (-859.793,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([230,274,587,678,790,1206,1241,1314,375,552.5,462.5,1710,235,1215,1347,1486,3221,193.365,198.011],'cm^-1')),
        HinderedRotor(inertia=(0.0043385,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0658489,'amu*angstrom^2'), symmetry=1, barrier=(44.8361,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.62777,0.0344685,1.64388e-07,-4.61031e-08,3.06779e-11,-103406,13.8111], Tmin=(10,'K'), Tmax=(681.756,'K')), NASAPolynomial(coeffs=[7.52437,0.0272543,-1.83914e-05,5.70857e-09,-6.66924e-13,-104301,-6.16205], Tmin=(681.756,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-859.793,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), label="""ODC([CH]F)C(F)(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00185691,'amu*angstrom^2'), symmetry=1, barrier=(19.4489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.22908,'amu*angstrom^2'), symmetry=1, barrier=(74.2428,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71606,0.0458915,-4.9566e-05,2.45556e-08,-4.19433e-12,-63228.8,20.7589], Tmin=(100,'K'), Tmax=(995.609,'K')), NASAPolynomial(coeffs=[13.3074,0.00684931,-2.08605e-06,3.57183e-10,-2.50149e-14,-65910,-36.9855], Tmin=(995.609,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-526.43,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCJCHO) + radical(CCCJ=O)"""),
)
...
"""),
    E0 = (-853.434,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,522,585,610,849,1160,1215,1402,234,347,1316,1464,2782.5,750,1395,475,1775,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.347102,'amu*angstrom^2'), symmetry=1, barrier=(7.98057,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    molecularWeight = (129.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.72507,0.0431097,-4.09171e-05,1.9401e-08,-3.74601e-12,-111269,12.9945], Tmin=(10,'K'), Tmax=(1136.31,'K')), NASAPolynomial(coeffs=[9.03166,0.0244296,-1.62584e-05,4.93391e-09,-5.63107e-13,-112475,-13.2849], Tmin=(1136.31,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-925.111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), label="""ODC(F)[CH]C(F)(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CO(13)', 'CF3-CHF(54)'],
    products = ['O=[C]C(F)C(F)(F)F(6098)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(86.1,'m^3/(mol*s)'), n=1.36, Ea=(25.2824,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R->O_N-3BrCClFHINPSSi-inRing_3BrCClFHINPSSi->C_Ext-3C-R_Sp-4R!H-3C_Ext-3C-R',), comment="""Estimated from node Root_N-3R->O_N-3BrCClFHINPSSi-inRing_3BrCClFHINPSSi->C_Ext-3C-R_Sp-4R!H-3C_Ext-3C-R"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'O=[C]C(F)F(1216)'],
    products = ['O=[C]C(F)C(F)(F)F(6098)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.67164e-06,'m^3/(mol*s)'), n=3.3552, Ea=(252.232,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R',), comment="""Estimated from node CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['O=C([CH]F)C(F)(F)F(6590)'],
    products = ['O=[C]C(F)C(F)(F)F(6098)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=[C][CH]C(F)(F)F(3824)'],
    products = ['O=[C]C(F)C(F)(F)F(6098)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=[C]C(F)[C](F)F(1302)'],
    products = ['O=[C]C(F)C(F)(F)F(6098)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CF3(45)', 'O=[C][CH]F(3967)'],
    products = ['O=[C]C(F)C(F)(F)F(6098)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]C(F)C(F)(F)F(6098)'],
    products = ['O=C(F)[CH]C(F)(F)F(6592)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(1.00763e+12,'s^-1'), n=0.18834, Ea=(152.653,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C"""),
)

reaction(
    label = 'reaction16',
    reactants = ['O=C(F)C(F)[C](F)F(1171)'],
    products = ['O=[C]C(F)C(F)(F)F(6098)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(213.811,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

network(
    label = 'PDepNetwork #1686',
    isomers = [
        'O=[C]C(F)C(F)(F)F(6098)',
    ],
    reactants = [
        ('CO(13)', 'CF3-CHF(54)'),
    ],
