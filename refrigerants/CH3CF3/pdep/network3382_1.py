...
"""),
    ...
    molecularWeight = (127.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69627,0.0387725,-2.02384e-06,-3.96355e-08,2.287e-11,-84525.1,22.602], Tmin=(100,'K'), Tmax=(889.16,'K')), NASAPolynomial(coeffs=[17.0458,0.00303135,2.07636e-06,-5.76597e-10,4.16932e-14,-88571.5,-57.0521], Tmin=(889.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-703.565,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFFOO) + ring(124trioxolane) + radical(Cs_P)"""),
)

species(
    label = '[O]C1(O)OC(F)(F)O1(11265)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {8,S}
2 F u0 p3 c0 {8,S}
3 O u0 p2 c0 {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (127.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.25789,0.0520442,-0.000104549,1.19689e-07,-4.9469e-11,-104398,20.6759], Tmin=(100,'K'), Tmax=(839.264,'K')), NASAPolynomial(coeffs=[-2.71303,0.0407466,-2.18216e-05,4.29911e-09,-2.99476e-13,-102331,51.1279], Tmin=(839.264,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-868.425,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsOs) + group(CsFFOO) + ring(Cs-O2s-Cs(F)(F)-O2s) + radical(OCOJ)"""),
)
...
"""),
    ...
    molecularWeight = (108.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99482,0.0338298,-7.32845e-06,-1.9748e-08,1.07338e-11,-68898.2,23.9655], Tmin=(100,'K'), Tmax=(1007.16,'K')), NASAPolynomial(coeffs=[14.3349,0.00810285,-3.68809e-06,7.95268e-10,-6.2924e-14,-72564.8,-41.5187], Tmin=(1007.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-573.528,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(CsFHOO) + group(Cds-OdOsOs) + radical(O2sj(Cs-F1sO2sH)) + radical(CsF1sO2sO2s)"""),
)
...
"""),
    E0 = (-567.024,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([375,486,586,623,710,938,1161,1294,1855,455,950,180,818.014],'cm^-1')),
        HinderedRotor(inertia=(0.456348,'amu*angstrom^2'), symmetry=1, barrier=(46.4697,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.02239,'amu*angstrom^2'), symmetry=1, barrier=(46.4986,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (-757.107,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([375,486,586,623,710,938,1161,1294,569.7,569.987,570.246,570.452,570.493,570.544,570.604,570.706],'cm^-1')),
        HinderedRotor(inertia=(0.0125413,'amu*angstrom^2'), symmetry=1, barrier=(2.88969,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0125336,'amu*angstrom^2'), symmetry=1, barrier=(2.8908,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48456,0.0490051,-4.97239e-05,2.33841e-08,-4.23246e-12,-90963.1,24.1171], Tmin=(100,'K'), Tmax=(1353.25,'K')), NASAPolynomial(coeffs=[15.4864,0.00761769,-3.84823e-06,7.83826e-10,-5.72629e-14,-94752.7,-47.6693], Tmin=(1353.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-757.107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(CsFFOO) + group(Cds-OdOsOs) + radical(O2sj(Cs-F1sF1sO2s)) + radical(OC=OOJ)"""),
)
...
"""),
    E0 = (-694.551,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,482,586,761,1411,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02691,0.0588134,-6.07956e-05,2.89439e-08,-5.30579e-12,-83422.7,26.0808], Tmin=(100,'K'), Tmax=(1334.87,'K')), NASAPolynomial(coeffs=[17.636,0.0090434,-4.86871e-06,1.01262e-09,-7.46845e-14,-87856.9,-58.8456], Tmin=(1334.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-694.551,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(O2s-(Cds-O2d)H) + group(CsFHOO) + group(Cds-OdOsOs) + radical(CsF1sO2sO2s)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(F)(F)OC(=O)O(10042)'],
    products = ['O[C]1OOC(F)(F)O1(11264)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.12332e+09,'s^-1'), n=0.5388, Ea=(297.291,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra] for rate rule [R5_SS_CO;carbonyl_intra_Nd;radadd_intra_O]
Euclidian distance = 2.449489742783178
family: Intra_R_Add_Endocyclic
Ea raised from 295.7 to 297.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['[O]C(F)(F)OC(=O)O(10042)'],
    products = ['[O]C1(O)OC(F)(F)O1(11265)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(2.724e+10,'s^-1'), n=0.478, Ea=(132.43,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_O] for rate rule [R5_SS_CO;carbonylbond_intra_Nd;radadd_intra_O]
Euclidian distance = 2.23606797749979
family: Intra_R_Add_Exocyclic
Ea raised from 131.6 to 132.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'O=C(O)OC(=O)F(2167)'],
    products = ['[O]C(F)(F)OC(=O)O(10042)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CF2O(49)', '[O]C(=O)O(1583)'],
    products = ['[O]C(F)(F)OC(=O)O(10042)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(57.7378,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O][C](F)OC(=O)O(8805)'],
    products = ['[O]C(F)(F)OC(=O)O(10042)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C](F)F(263)', '[O]C(=O)O(1583)'],
    products = ['[O]C(F)(F)OC(=O)O(10042)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C([O])(F)F(276)', 'O=[C]O(457)'],
    products = ['[O]C(F)(F)OC(=O)O(10042)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', '[O]C(F)(F)O[C]=O(780)'],
    products = ['[O]C(F)(F)OC(=O)O(10042)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(=O)OC([O])(F)F(11266)'],
    products = ['[O]C(F)(F)OC(=O)O(10042)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=C(O)O[C](F)OF(11267)'],
    products = ['[O]C(F)(F)OC(=O)O(10042)'],
...
network(
    ...
    isomers = [
        '[O]C(F)(F)OC(=O)O(10042)',
    ],
    reactants = [
        ('HF(38)', 'CO2(14)', '[O]C(=O)F(459)'),
        ('[O]C([O])(F)F(276)', 'O=[C]O(457)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
