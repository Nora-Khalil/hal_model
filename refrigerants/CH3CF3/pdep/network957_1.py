...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.177886,'amu*angstrom^2'), symmetry=1, barrier=(4.08996,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33495,0.063681,-9.69018e-05,8.19099e-08,-2.77888e-11,-21307,24.7853], Tmin=(100,'K'), Tmax=(783.58,'K')), NASAPolynomial(coeffs=[8.42804,0.0232291,-1.13421e-05,2.20517e-09,-1.54236e-13,-22288.4,-6.8736], Tmin=(783.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-177.914,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCd)(F1s)(H)) + radical(Cdj(Cs-F1sF1sCs)(Cd-HH))"""),
)

species(
    label = 'C=C1OC(F)C1(F)F(2331)',
...
species(
    label = '[CH2]C1([O])C(F)C1(F)F(2656)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.755672,'amu*angstrom^2'), symmetry=1, barrier=(17.3744,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.75689,'amu*angstrom^2'), symmetry=1, barrier=(17.4024,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.756638,'amu*angstrom^2'), symmetry=1, barrier=(17.3966,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.431718,0.082632,-0.000118578,8.49036e-08,-2.38205e-11,-42992.7,26.5619], Tmin=(100,'K'), Tmax=(876.628,'K')), NASAPolynomial(coeffs=[14.4212,0.0187972,-9.34716e-06,1.833e-09,-1.29574e-13,-45445.3,-39.087], Tmin=(876.628,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-358.5,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(CsCsFHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Csj(Cs-F1sF1sCd)(F1s)(H)) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C([O])C(F)(F)CF(2673)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.653855,'amu*angstrom^2'), symmetry=1, barrier=(15.0334,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.653599,'amu*angstrom^2'), symmetry=1, barrier=(15.0275,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.522877,0.0826699,-0.00013147,1.09949e-07,-3.63465e-11,-50611.7,24.6929], Tmin=(100,'K'), Tmax=(801.71,'K')), NASAPolynomial(coeffs=[11.1111,0.0244051,-1.22848e-05,2.38114e-09,-1.65383e-13,-52134.7,-22.9592], Tmin=(801.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-421.801,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(CsCsFHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C(OF)=C(F)[CH]F(2674)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-130.322,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,271,519,563,612,1379,3000,3100,440,815,1455,1000,234,589,736,816,1240,3237,2163.43],'cm^-1')),
        HinderedRotor(inertia=(0.0139829,'amu*angstrom^2'), symmetry=1, barrier=(46.5618,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.38449,'amu*angstrom^2'), symmetry=1, barrier=(8.84017,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.0227,'amu*angstrom^2'), symmetry=1, barrier=(46.5058,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.692451,0.0801401,-0.000129853,1.13702e-07,-3.92594e-11,-15562.2,26.1558], Tmin=(100,'K'), Tmax=(815.795,'K')), NASAPolynomial(coeffs=[8.99714,0.028391,-1.44214e-05,2.79914e-09,-1.94311e-13,-16550.1,-9.96931], Tmin=(815.795,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-130.322,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(Cds-CdsCsOs) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(C=C(O)CJ) + radical(Csj(Cd-CdF1s)(F1s)(H))"""),
)

species(
    label = 'C=C([O])[C](F)C(F)F(2658)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.240732,'amu*angstrom^2'), symmetry=1, barrier=(5.53491,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240976,'amu*angstrom^2'), symmetry=1, barrier=(5.54052,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240846,'amu*angstrom^2'), symmetry=1, barrier=(5.53752,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.512658,0.0889175,-0.000164636,1.54397e-07,-5.46243e-11,-57748,27.166], Tmin=(100,'K'), Tmax=(860.922,'K')), NASAPolynomial(coeffs=[7.42992,0.0300881,-1.56325e-05,3.00439e-09,-2.04872e-13,-57949.9,0.574726], Tmin=(860.922,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-481.091,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFHH) + group(Cds-OdCsH) + radical(Csj(Cs-CsF1sF1s)(F1s)(H)) + radical(CCCJ=O)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.433836,'amu*angstrom^2'), symmetry=1, barrier=(9.97473,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39334,0.0663426,-0.000124973,1.18113e-07,-4.22456e-11,-50241.3,22.4059], Tmin=(100,'K'), Tmax=(843.416,'K')), NASAPolynomial(coeffs=[7.00218,0.0211409,-1.15008e-05,2.2717e-09,-1.57738e-13,-50525.8,0.223786], Tmin=(843.416,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-418.438,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCO)(F1s)(H)) + radical(COj(Cs-F1sF1sCs)(O2d))"""),
)

species(
    label = 'O=C1CC(F)C1(F)F(2615)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
4  O u0 p2 c0 {8,D}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48067,0.0479342,-3.27597e-05,9.04978e-09,-4.44723e-13,-83929.7,22.2405], Tmin=(100,'K'), Tmax=(1224.85,'K')), NASAPolynomial(coeffs=[12.9842,0.019141,-8.24356e-06,1.55447e-09,-1.08586e-13,-87405.9,-38.2775], Tmin=(1224.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-698.637,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-O2d)CsHH) + group(CsCCFF) + group(Cds-OdCsCs) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)2-CO) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + ring(Cyclobutanone)"""),
)

species(
    label = '[CH2][C]1OC(F)C1(F)F(2675)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
reaction(
    label = 'reaction1',
    reactants = ['C=C([O])C(F)(F)[CH]F(2324)'],
...
reaction(
    label = 'reaction2',
    reactants = ['C=C([O])C(F)[C](F)F(2325)'],
    products = ['C=C([O])C(F)(F)[CH]F(2324)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(CF)=C(F)[CH]F(2667)'],
    products = ['C=C([O])C(F)(F)[CH]F(2324)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(804)', '[CH2]C(=O)[C](F)F(1724)'],
    products = ['C=C([O])C(F)(F)[CH]F(2324)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'C=[C]C(F)(F)[CH]F(2668)'],
    products = ['C=C([O])C(F)(F)[CH]F(2324)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['C=C([O])C(F)(F)[CH]F(2324)'],
    products = ['F[CH]C(F)(F)[C]1CO1(2669)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C=C([O])C(F)(F)[CH]F(2324)'],
    products = ['[O][C]1CC(F)C1(F)F(2670)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C=C([O])C(F)(F)[CH]F(2324)'],
    products = ['[CH2]C1([O])C(F)C1(F)F(2656)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C([O])C(F)=CF(2671)'],
    products = ['C=C([O])C(F)(F)[CH]F(2324)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHFCF2(55)', '[CH2][C]=O(981)'],
    products = ['C=C([O])C(F)(F)[CH]F(2324)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH][C](F)F(588)', 'CH2CO(28)'],
    products = ['C=C([O])C(F)(F)[CH]F(2324)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[CH][C](F)F(588)', '[CH2][C]=O(981)'],
    products = ['C=C([O])C(F)(F)[CH]F(2324)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[CH2]C(=O)[C](F)F(1724)'],
    products = ['C=C([O])C(F)(F)[CH]F(2324)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=C(O)C(F)(F)[CH]F(2672)'],
    products = ['C=C([O])C(F)(F)[CH]F(2324)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C([O])C(F)(F)CF(2673)'],
    products = ['C=C([O])C(F)(F)[CH]F(2324)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(OF)=C(F)[CH]F(2674)'],
    products = ['C=C([O])C(F)(F)[CH]F(2324)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(T)(18)', 'O=[C]C(F)(F)[CH]F(1311)'],
    products = ['C=C([O])C(F)(F)[CH]F(2324)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C=C([O])C(F)(F)[CH]F(2324)'],
    products = ['[CH2][C]1OC(F)C1(F)F(2675)'],
