...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.7237,'amu*angstrom^2'), symmetry=1, barrier=(39.6312,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.71806,'amu*angstrom^2'), symmetry=1, barrier=(39.5016,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.72146,'amu*angstrom^2'), symmetry=1, barrier=(39.5798,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.037,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37648,0.0472971,-3.11282e-05,-5.36714e-09,8.35084e-12,-12272.9,22.7627], Tmin=(100,'K'), Tmax=(960.849,'K')), NASAPolynomial(coeffs=[17.8642,0.00324149,-7.28173e-07,1.66898e-10,-1.69056e-14,-16576.1,-62.0274], Tmin=(960.849,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-102.907,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + missing(O2d-Cdd) + group(Cds-(Cdd-O2d)OsH) + group(Cds-OdOsH) + missing(Cdd-CdO2d) + radical((O)CJOC)"""),
)

species(
    label = 'O=[C]OOC(F)[C]=O(4883)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {3,S} {6,S}
3 O u0 p2 c0 {2,S} {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.80345,'amu*angstrom^2'), symmetry=1, barrier=(41.4649,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.80331,'amu*angstrom^2'), symmetry=1, barrier=(41.4617,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.80366,'amu*angstrom^2'), symmetry=1, barrier=(41.4697,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39321,0.0533257,-5.74107e-05,2.91525e-08,-5.73589e-12,2307.32,23.8664], Tmin=(100,'K'), Tmax=(1243.4,'K')), NASAPolynomial(coeffs=[14.9338,0.00976603,-4.8616e-06,9.77526e-10,-7.09898e-14,-1059.94,-44.4087], Tmin=(1243.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(18.3757,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-OdOsH) + radical(Cdj(Cd-O2sH)(F1s)) + radical((O)CJOC)"""),
)

species(
    label = 'O=C1OOC=C(F)O1(4914)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.65126,'amu*angstrom^2'), symmetry=1, barrier=(37.9656,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.6506,'amu*angstrom^2'), symmetry=1, barrier=(37.9505,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.65143,'amu*angstrom^2'), symmetry=1, barrier=(37.9695,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.65189,'amu*angstrom^2'), symmetry=1, barrier=(37.9802,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.872841,0.0569236,-4.29058e-05,4.67423e-09,4.10215e-12,-32897.7,26.4677], Tmin=(100,'K'), Tmax=(1042.86,'K')), NASAPolynomial(coeffs=[19.9835,0.00668103,-3.80543e-06,8.80839e-10,-7.12114e-14,-38137.5,-72.5438], Tmin=(1042.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-274.549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-(Cds-O2d)OsHH) + group(COCsFO) + group(Cds-OdOsH) + radical(CH2_triplet)"""),
)

species(
    label = 'O=[C]OOC=[C]OF(4918)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 O u0 p2 c0 {3,S} {6,S}
3 O u0 p2 c0 {2,S} {8,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C]=O(785)', '[CH]C(=O)F(537)'],
    products = ['O=[C]OO[CH]C(=O)F(4246)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(192)', '[O]O[CH]C(=O)F(4228)'],
    products = ['O=[C]OO[CH]C(=O)F(4246)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['O=[C]OO[CH]C(=O)F(4246)'],
    products = ['O=C1OO[CH][C](F)O1(4909)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O=[C]OO[CH]C(=O)F(4246)'],
    products = ['[O]C1(F)[CH]OOC1=O(4910)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CO(13)', '[O]O[CH]C(=O)F(4228)'],
    products = ['O=[C]OO[CH]C(=O)F(4246)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O=[C]OOC=C=O(4911)'],
    products = ['O=[C]OO[CH]C(=O)F(4246)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O(6)', 'O=[C]OOC=[C]F(4913)'],
    products = ['O=[C]OO[CH]C(=O)F(4246)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=[C]OO[C]=C=O(4888)'],
    products = ['O=[C]OO[CH]C(=O)F(4246)'],
...
network(
    ...
    isomers = [
        'O=[C]OO[CH]C(=O)F(4246)',
    ],
    reactants = [
        ('CO2(14)', 'O=CC(=O)F(4234)'),
        ('CO(13)', '[O]O[CH]C(=O)F(4228)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
