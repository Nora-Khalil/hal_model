...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', '[CH]=C(F)C#C(541)'],
    products = ['[CH]=C(F)C(=[CH])F(483)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]=[C]F(489)', '[CH]=[C]F(489)'],
    products = ['[CH]=C(F)C(=[CH])F(483)'],
    transitionState = 'TS5',
