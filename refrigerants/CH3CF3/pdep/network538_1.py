...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'CHF2(82)'],
    products = ['[O]OC(F)F(413)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]OC(F)F(413)'],
    products = ['OH(7)', 'CF2O(49)'],
    transitionState = 'TS7',
