...
"""),
    E0 = (-207.091,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,180,180,808.013,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.666622,'amu*angstrom^2'), symmetry=1, barrier=(15.3269,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.33726,'amu*angstrom^2'), symmetry=1, barrier=(30.7463,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.0334,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.40833,0.0380605,-5.07246e-05,3.5229e-08,-9.82347e-12,-24852.7,14.6305], Tmin=(100,'K'), Tmax=(871.82,'K')), NASAPolynomial(coeffs=[8.02837,0.012275,-6.3595e-06,1.30345e-09,-9.50519e-14,-25832.6,-11.712], Tmin=(871.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-207.091,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CH2_triplet)"""),
)
...
reaction(
    ...
    products = ['[CH2]OC(F)F(690)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.76395e-12,'m^3/(mol*s)'), n=5.02686, Ea=(71.1281,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', '[CH2]OF(222)'],
    products = ['[CH2]OC(F)F(690)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(10.4384,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction4',
    reactants = ['[O]C(F)F(207)', 'CH2(T)(18)'],
    products = ['[CH2]OC(F)F(690)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['F[CH]OCF(8596)'],
    products = ['[CH2]OC(F)F(690)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(210.228,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
