...
reaction(
    label = 'reaction1',
    reactants = ['OOC=[C]F(618)'],
    products = ['OH(7)', 'FC1=CO1(577)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[C]=COO(6944)'],
    products = ['OOC=[C]F(618)'],
    transitionState = 'TS2',
