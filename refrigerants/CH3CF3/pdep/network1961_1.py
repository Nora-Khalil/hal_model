species(
    label = '[O]C(=O)C([C](F)F)C(F)F(6646)',
...
"""),
    E0 = (-452.327,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,180,180,180,1376.64,1377.53,1378.6,1379.48],'cm^-1')),
        HinderedRotor(inertia=(2.4231,'amu*angstrom^2'), symmetry=1, barrier=(55.7119,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221765,'amu*angstrom^2'), symmetry=1, barrier=(5.09882,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70446,0.0618723,-0.000116277,1.19416e-07,-4.59782e-11,-54330.7,20.7413], Tmin=(100,'K'), Tmax=(840.052,'K')), NASAPolynomial(coeffs=[2.10068,0.0333442,-1.77665e-05,3.48499e-09,-2.41977e-13,-53457.3,24.4939], Tmin=(840.052,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-452.327,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(Csj(Cs-COHH)(F1s)(F1s))"""),
)
...
species(
    label = 'O=C([CH][C](F)F)OC(F)F(7080)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.307324,0.0908637,-0.000152113,1.37738e-07,-4.88875e-11,-108994,33.9752], Tmin=(100,'K'), Tmax=(816.55,'K')), NASAPolynomial(coeffs=[8.51393,0.0342296,-1.78896e-05,3.50648e-09,-2.44492e-13,-109786,-0.599176], Tmin=(816.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-907.256,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + group(CsFFHO) + group(Cds-OdCsOs) + radical(CCJCO) + radical(Csj(Cs-COHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-470.846,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([171,205,598,1104,1143,1317,1411,3153,3010,987.5,1337.5,450,1655,350,440,435,1725,449.76,449.855,449.943],'cm^-1')),
        HinderedRotor(inertia=(0.106926,'amu*angstrom^2'), symmetry=1, barrier=(15.3492,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
...
species(
    label = 'F[C](F)C([C]1OO1)C(F)F(7082)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0558113,0.0846663,-0.000101121,5.86123e-08,-1.30955e-11,-64272.6,32.8922], Tmin=(100,'K'), Tmax=(1105.52,'K')), NASAPolynomial(coeffs=[19.4014,0.0142663,-5.6002e-06,1.01023e-09,-6.95095e-14,-68574.6,-62.9295], Tmin=(1105.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-535.64,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsCsFFH) + ring(dioxirane) + radical(Cs_P) + radical(Csj(Cs-CsCsH)(F1s)(F1s))"""),
)

species(
    label = '[O][C]1OC(F)(F)C1C(F)F(7083)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30177,0.0663204,-6.86255e-05,3.8904e-08,-9.44933e-12,-95065.6,28.2841], Tmin=(100,'K'), Tmax=(959.736,'K')), NASAPolynomial(coeffs=[9.09323,0.0338467,-1.78709e-05,3.64761e-09,-2.65368e-13,-96561.1,-8.98487], Tmin=(959.736,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-791.18,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsOsOsH) + group(CsCFFO) + group(CsCsFFH) + ring(Cs-Cs(F)(F)-O2s-Cs) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[O]C1([O])C(C(F)F)C1(F)F(7084)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = 'O=C(O)[C]([C](F)F)C(F)F(7085)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.147746,0.0927177,-0.000146546,1.26475e-07,-4.3976e-11,-115849,31.9056], Tmin=(100,'K'), Tmax=(757.111,'K')), NASAPolynomial(coeffs=[10.4033,0.0331042,-1.76786e-05,3.52769e-09,-2.49927e-13,-117246,-13.6899], Tmin=(757.111,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-964.309,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(CsCsFFH) + group(CsCsFFH) + group(Cds-OdCsOs) + radical(CCJ(C)CO) + radical(CsCsF1sF1s)"""),
)
...
species(
    label = '[O]C(=O)C(=C(F)F)C(F)F(7086)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(4127.82,'J/mol'), sigma=(5.79649,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=644.76 K, Pc=48.09 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = '[O]C(=O)[C](C(F)F)C(F)F(7087)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'O=C(O)C([C](F)F)[C](F)F(7088)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(=O)C([C](F)F)C(F)F(6646)'],
...
reaction(
    ...
    products = ['[O]C(=O)C([C](F)F)C(F)F(6646)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', '[O]C(=O)C(F)[C](F)F(1283)'],
    products = ['[O]C(=O)C([C](F)F)C(F)F(6646)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C(=O)C([C](F)F)C(F)F(6646)'],
    products = ['[O]C([O])=CC(F)(F)C(F)F(7079)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(=O)C(F)(F)[CH]C(F)F(6645)'],
    products = ['[O]C(=O)C([C](F)F)C(F)F(6646)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)C([C](F)F)C(F)F(6646)'],
    products = ['O=C([CH][C](F)F)OC(F)F(7080)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['O(6)', 'O=[C]C([C](F)F)C(F)F(7081)'],
    products = ['[O]C(=O)C([C](F)F)C(F)F(6646)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(=O)C([C](F)F)C(F)F(6646)'],
    products = ['O=C(O)C(=C(F)F)C(F)F(5932)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(=O)C([C](F)F)C(F)F(6646)'],
    products = ['F[C](F)C([C]1OO1)C(F)F(7082)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(=O)C([C](F)F)C(F)F(6646)'],
    products = ['[O][C]1OC(F)(F)C1C(F)F(7083)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C(=O)C([C](F)F)C(F)F(6646)'],
    products = ['[O]C1([O])C(C(F)F)C1(F)F(7084)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=C(O)[C]([C](F)F)C(F)F(7085)'],
    products = ['[O]C(=O)C([C](F)F)C(F)F(6646)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[O]C(=O)C(=C(F)F)C(F)F(7086)'],
    products = ['[O]C(=O)C([C](F)F)C(F)F(6646)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', '[O]C(=O)C([CH]F)=C(F)F(2970)'],
    products = ['[O]C(=O)C([C](F)F)C(F)F(6646)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(=O)C([C](F)F)C(F)F(6646)'],
    products = ['[O]C(=O)[C](C(F)F)C(F)F(7087)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]C(=O)C([C](F)F)C(F)F(6646)'],
    products = ['O=C(O)C([C](F)F)[C](F)F(7088)'],
