...
"""),
    E0 = (-761.345,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,181,249,286,344,486,552,511,665,553,637,1169,1241,1190,1306,212,367,445,1450,334,575,1197,1424,3202,180,180,923.776,923.923,923.931,923.934],'cm^-1')),
        HinderedRotor(inertia=(0.157438,'amu*angstrom^2'), symmetry=1, barrier=(3.61981,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157435,'amu*angstrom^2'), symmetry=1, barrier=(3.61974,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (176.06,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3130.22,'J/mol'), sigma=(5.68412,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=488.93 K, Pc=38.67 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    E0 = (-889.365,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,346,659,817,1284,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,182,240,577,636,1210,1413,206.301,218.48,222.209],'cm^-1')),
        HinderedRotor(inertia=(0.192025,'amu*angstrom^2'), symmetry=1, barrier=(6.48952,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.186628,'amu*angstrom^2'), symmetry=1, barrier=(6.539,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27996,'amu*angstrom^2'), symmetry=1, barrier=(46.4787,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (176.06,'amu'),
...
species(
    label = 'F[CH]C(F)(F)C1=CC1(F)F(11508)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-619.095,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,248,333,466,604,684,796,1061,1199,2950,1000,334,575,1197,1424,3202,353.043,353.136,353.68,353.735,353.741,355.165],'cm^-1')),
        HinderedRotor(inertia=(0.320012,'amu*angstrom^2'), symmetry=1, barrier=(28.4758,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.321571,'amu*angstrom^2'), symmetry=1, barrier=(28.481,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (157.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.569308,0.0793271,-9.25525e-05,5.4376e-08,-1.28119e-11,-74339.5,28.6997], Tmin=(100,'K'), Tmax=(1024.63,'K')), NASAPolynomial(coeffs=[14.4762,0.0250352,-1.30704e-05,2.66049e-09,-1.93509e-13,-77189.3,-38.7313], Tmin=(1024.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-619.095,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCCFF) + group(CsCsFHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cd-Cd-Cs(F)(F)) + radical(Csj(Cs-F1sF1sCd)(F1s)(H))"""),
)
...
species(
    label = 'F[CH]C(F)(F)C1(F)C=C1F(11509)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-561.468,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,215,315,519,588,595,1205,1248,323,467,575,827,1418,2950,1000,334,575,1197,1424,3202,180,180,2151.38],'cm^-1')),
        HinderedRotor(inertia=(0.508148,'amu*angstrom^2'), symmetry=1, barrier=(11.6833,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.28044,'amu*angstrom^2'), symmetry=1, barrier=(29.4398,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (157.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.175174,0.102961,-0.000180416,1.63576e-07,-5.74619e-11,-67389.4,28.4498], Tmin=(100,'K'), Tmax=(823.486,'K')), NASAPolynomial(coeffs=[10.2746,0.0329403,-1.77857e-05,3.51141e-09,-2.44972e-13,-68457.4,-15.9692], Tmin=(823.486,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-561.468,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(CdCsCdF) + group(Cds-CdsCsH) + ring(Cs-Cd(F)-Cd) + radical(Csj(Cs-CsF1sF1s)(F1s)(H)) + longDistanceInteraction_cyclic(Cs(F)-Cds(F))"""),
)
...
species(
    label = 'F[CH]C(F)(F)[C]1C=C1F(11511)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-233.352,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,271,519,563,612,1379,2950,1000,334,575,1197,1424,3202,180,180,180,1311.6,1312.3,1312.36],'cm^-1')),
        HinderedRotor(inertia=(0.140967,'amu*angstrom^2'), symmetry=1, barrier=(3.24111,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141061,'amu*angstrom^2'), symmetry=1, barrier=(3.24328,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (138.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.493211,0.0866668,-0.000148468,1.34434e-07,-4.71353e-11,-27948.7,23.1708], Tmin=(100,'K'), Tmax=(836.201,'K')), NASAPolynomial(coeffs=[8.48383,0.0305625,-1.57509e-05,3.05231e-09,-2.1073e-13,-28659.9,-10.2119], Tmin=(836.201,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-233.352,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Cds-CdsCsH) + group(CdCsCdF) + ring(Cs-Cd(F)-Cd) + radical(Allyl_T) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)
...
species(
    label = 'F[CH]C(F)(F)[C]1C(F)C1(F)F(3421)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'FC(F)C(F)(F)[C]1[CH]C1(F)F(11513)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.361239,0.106557,-0.000178527,1.59487e-07,-5.59022e-11,-95569.6,33.2124], Tmin=(100,'K'), Tmax=(812.61,'K')), NASAPolynomial(coeffs=[10.3865,0.0370249,-1.94855e-05,3.82963e-09,-2.67418e-13,-96767.3,-13.0312], Tmin=(812.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-795.831,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + ring(Cs(F)(F)-Cs(C)-Cs) + radical(Tertalkyl) + radical(Csj(Cs-CsCsH)(Cs-CsF1sF1s)(H)_ring)"""),
)

species(
    label = 'F[CH]C(F)(F)C1(F)[C](F)C1F(11514)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-723.016,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([289,311,382,485,703,1397,259,529,569,1128,1321,1390,3140,215,315,519,588,595,1205,1248,212,367,445,1450,334,575,1197,1424,3202,704.839,705.223],'cm^-1')),
        HinderedRotor(inertia=(0.172606,'amu*angstrom^2'), symmetry=1, barrier=(3.96856,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172953,'amu*angstrom^2'), symmetry=1, barrier=(3.97653,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.492962,0.106973,-0.000170248,1.42762e-07,-4.74921e-11,-86804.7,33.7607], Tmin=(100,'K'), Tmax=(787.915,'K')), NASAPolynomial(coeffs=[13.1116,0.032053,-1.64738e-05,3.22166e-09,-2.25061e-13,-88766.8,-27.4775], Tmin=(787.915,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-723.016,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(CsCsCsFH) + group(CsCsCsFH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + ring(Cs(C)-Cs-Cs(F)) + radical(Csj(Cs-F1sCsCs)(Cs-CsF1sH)(F1s)_ring) + radical(Csj(Cs-CsF1sF1s)(F1s)(H)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'F[C]1[CH]C1(F)C(F)(F)C(F)F(11515)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-733.347,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([289,311,382,485,703,1397,222,329,445,522,589,1214,1475,235,523,627,1123,1142,1372,1406,3097,212,367,445,1450,2950,1000,298.975,301.032,301.562,1256.95],'cm^-1')),
        HinderedRotor(inertia=(0.123232,'amu*angstrom^2'), symmetry=1, barrier=(7.90397,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.043767,'amu*angstrom^2'), symmetry=1, barrier=(49.0851,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.390396,0.104664,-0.00015658,1.22987e-07,-3.86756e-11,-88050.7,32.0829], Tmin=(100,'K'), Tmax=(777.856,'K')), NASAPolynomial(coeffs=[13.6771,0.032321,-1.70682e-05,3.41148e-09,-2.42844e-13,-90239.1,-32.2501], Tmin=(777.856,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-733.347,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + ring(Cs(C)-Cs-Cs(F)) + radical(Csj(Cs-F1sCsCs)(Cs-CsHH)(F1s)_ring) + radical(Csj(Cs-F1sCsCs)(Cs-CsF1sH)(H)_ring) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'F[CH][C](F)C1(F)C(F)C1(F)F(11516)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-734.501,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([289,311,382,485,703,1397,222,329,445,522,589,1214,1475,250,417,511,1155,1315,1456,3119,212,367,445,1450,334,575,1197,1424,3202,180,889.151],'cm^-1')),
        HinderedRotor(inertia=(0.0062549,'amu*angstrom^2'), symmetry=1, barrier=(3.55163,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160298,'amu*angstrom^2'), symmetry=1, barrier=(3.68556,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.466576,0.108603,-0.000181644,1.60523e-07,-5.56398e-11,-88189.2,34.55], Tmin=(100,'K'), Tmax=(813.175,'K')), NASAPolynomial(coeffs=[11.2196,0.0357096,-1.87587e-05,3.6815e-09,-2.56792e-13,-89580.3,-16.2798], Tmin=(813.175,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-734.501,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(CsCsCsFF) + group(CsCsCsFH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + ring(Cs(F)(F)-Cs(C)-Cs) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(F1s)(H)) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(804)', 'F[C](F)C1(F)[CH]C1(F)F(11392)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]C1(F)F(11346)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F[CH]C(F)(F)[C](F)C=C(F)F(3412)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]C1(F)F(11346)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[CH]C(F)(F)C1=CC1(F)F(11508)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]C1(F)F(11346)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(58.9466,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    ...
    products = ['F[CH]C(F)(F)C1(F)[CH]C1(F)F(11346)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(5.64796,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)

reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[CH]C(F)(F)C1(F)C=C1F(11509)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]C1(F)F(11346)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'FC=C(F)C1(F)[CH]C1(F)F(11510)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]C1(F)F(11346)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(59.1675,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.000502707,'m^3/(mol*s)'), n=2.87982, Ea=(3.08065,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R-inRing_Ext-3R-R_Sp-4R!H-3R_N-4R!H->O_N-1R!H-inRing_Sp-2R!H=1R!H',), comment="""Estimated from node Root_3R-inRing_Ext-3R-R_Sp-4R!H-3R_N-4R!H->O_N-1R!H-inRing_Sp-2R!H=1R!H"""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', 'F[CH]C(F)(F)[C]1C=C1F(11511)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]C1(F)F(11346)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(78)', 'F[CH]C(F)=C1[CH]C1(F)F(11512)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]C1(F)F(11346)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(17.9535,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', 'F[C](F)C1(F)[CH]C1(F)F(11392)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]C1(F)F(11346)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)(F)C1(F)[CH]C1(F)F(11346)'],
    products = ['F[CH]C(F)(F)[C]1C(F)C1(F)F(3421)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]C(F)(F)C1(F)[CH]C1(F)F(11346)'],
    products = ['FC(F)C(F)(F)[C]1[CH]C1(F)F(11513)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(203.864,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)(F)C1(F)[C](F)C1F(11514)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]C1(F)F(11346)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C]1[CH]C1(F)C(F)(F)C(F)F(11515)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]C1(F)F(11346)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(0.00110172,'s^-1'), n=4.50663, Ea=(235.215,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R4F_Ext-4R!H-R',), comment="""Estimated from node R4F_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction20',
    reactants = ['F[CH][C](F)C1(F)C(F)C1(F)F(11516)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]C1(F)F(11346)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(221.393,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
...
network(
    ...
    isomers = [
        'F[CH]C(F)(F)C1(F)[CH]C1(F)F(11346)',
    ],
    reactants = [
