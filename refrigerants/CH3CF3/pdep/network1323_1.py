...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)OOO(3456)'],
    products = ['HO2(11)', 'FC1=CO1(577)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(5)', '[C]=C(F)OOO(3801)'],
    products = ['[CH]=C(F)OOO(3456)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['HO2(11)', '[CH]C(=O)F(3804)'],
    products = ['[CH]=C(F)OOO(3456)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(F)OO[O](3484)'],
    products = ['[CH]=C(F)OOO(3456)'],
    transitionState = 'TS8',
