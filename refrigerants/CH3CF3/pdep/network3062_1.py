...
"""),
    E0 = (-33.1918,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,3000,3100,440,815,1455,1000,188.223,1598.12,1599.55],'cm^-1')),
        HinderedRotor(inertia=(0.193755,'amu*angstrom^2'), symmetry=1, barrier=(5.45218,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.208788,'amu*angstrom^2'), symmetry=1, barrier=(5.43302,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.212408,'amu*angstrom^2'), symmetry=1, barrier=(5.41381,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0696,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05362,0.0483716,-7.30738e-05,6.69023e-08,-2.41157e-11,-3927.33,19.8805], Tmin=(100,'K'), Tmax=(842.772,'K')), NASAPolynomial(coeffs=[4.527,0.0252207,-1.15579e-05,2.17397e-09,-1.4863e-13,-3938.96,10.7753], Tmin=(842.772,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-33.1918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-O2sHH)(F1s)(H)) + radical(CsJOCC)"""),
)
...
"""),
    ...
    molecularWeight = (76.0696,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63584,0.0622945,-0.00011483,1.12057e-07,-4.07778e-11,-4761.75,19.1906], Tmin=(100,'K'), Tmax=(869.997,'K')), NASAPolynomial(coeffs=[3.9724,0.0274978,-1.33631e-05,2.52446e-09,-1.70817e-13,-4258,13.4752], Tmin=(869.997,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-40.2174,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sHH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', '[CH2]O[CH2](292)'],
    products = ['[CH2]OC[CH]F(10219)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH2]OC[CH]F(10219)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(43.3014,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['CHF(40)', '[CH2]O[CH2](292)'],
    products = ['[CH2]OC[CH]F(10219)'],
