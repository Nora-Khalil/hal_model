...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])F(5649)', 'CH2(T)(18)'],
    products = ['[CH2]OC([O])F(4696)'],
    transitionState = 'TS2',
