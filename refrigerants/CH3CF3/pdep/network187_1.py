...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'OC(O)(F)F(754)'],
    products = ['OC(F)(F)OCF(645)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH2]OC(O)(F)F(756)'],
    products = ['OC(F)(F)OCF(645)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O[C](F)F(206)', '[O]CF(223)'],
    products = ['OC(F)(F)OCF(645)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(O)(F)F(445)', 'CH2F(46)'],
    products = ['OC(F)(F)OCF(645)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'OC(F)(F)O[CH]F(759)'],
    products = ['OC(F)(F)OCF(645)'],
