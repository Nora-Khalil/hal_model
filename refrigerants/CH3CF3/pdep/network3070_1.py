...
"""),
    E0 = (-557.029,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,215,315,519,588,595,1205,1248,262,406,528,622,1148,1246,1368,1480,3164,3240,245.866,245.868,245.868],'cm^-1')),
        HinderedRotor(inertia=(0.199721,'amu*angstrom^2'), symmetry=1, barrier=(8.56763,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.199725,'amu*angstrom^2'), symmetry=1, barrier=(8.56763,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.41011,'amu*angstrom^2'), symmetry=1, barrier=(17.5928,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (-547.038,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,215,315,519,588,595,1205,1248,3000,3100,440,815,1455,1000,334,575,1197,1424,3202,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.68358,'amu*angstrom^2'), symmetry=1, barrier=(15.7168,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.29569,'amu*angstrom^2'), symmetry=1, barrier=(6.7985,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.295637,'amu*angstrom^2'), symmetry=1, barrier=(6.79727,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.068,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0814159,'amu*angstrom^2'), symmetry=1, barrier=(1.87191,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.5342,'amu*angstrom^2'), symmetry=1, barrier=(58.2662,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (-546.751,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,551,1088,1226,1380,1420,1481,3057,3119,3025,407.5,1350,352.5,334,575,1197,1424,3202,242.968,243.472,243.613],'cm^-1')),
        HinderedRotor(inertia=(0.594789,'amu*angstrom^2'), symmetry=1, barrier=(24.9938,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.169186,'amu*angstrom^2'), symmetry=1, barrier=(7.08907,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168606,'amu*angstrom^2'), symmetry=1, barrier=(7.09381,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.248989,0.0908547,-0.000150422,1.32128e-07,-4.56437e-11,-65632,27.2039], Tmin=(100,'K'), Tmax=(804.676,'K')), NASAPolynomial(coeffs=[10.3868,0.0293862,-1.51952e-05,2.99193e-09,-2.09555e-13,-66905,-17.2745], Tmin=(804.676,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-546.751,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sHH)(H)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = 'F[CH][CH]C(F)(F)CF(825)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-553.886,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,528,1116,1182,1331,1402,1494,3075,3110,3025,407.5,1350,352.5,334,575,1197,1424,3202,295.794,295.795,295.795],'cm^-1')),
        HinderedRotor(inertia=(0.16734,'amu*angstrom^2'), symmetry=1, barrier=(10.3898,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16734,'amu*angstrom^2'), symmetry=1, barrier=(10.3898,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.45671,'amu*angstrom^2'), symmetry=1, barrier=(28.3561,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.392734,0.0867263,-0.000130221,1.02258e-07,-3.14367e-11,-66494.1,26.7113], Tmin=(100,'K'), Tmax=(676.464,'K')), NASAPolynomial(coeffs=[11.5497,0.0275779,-1.41959e-05,2.82573e-09,-2.00672e-13,-68159.7,-23.9075], Tmin=(676.464,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-553.886,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sHH)(H)) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)

species(
    label = 'F[CH][C](F)CC(F)F(815)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.158698,0.0982641,-0.000182472,1.73566e-07,-6.2509e-11,-67888.9,28.2574], Tmin=(100,'K'), Tmax=(846.327,'K')), NASAPolynomial(coeffs=[7.34784,0.0350402,-1.85812e-05,3.63591e-09,-2.51394e-13,-68058.4,0.961349], Tmin=(846.327,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-565.5,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]CC(F)(F)[CH]F(10226)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)C(F)(F)[CH]F(10225)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(804)', '[CH2]C(F)(F)[CH]F(817)'],
    products = ['F[CH]CC(F)(F)[CH]F(10226)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(804)', 'F[CH]C[C](F)F(803)'],
    products = ['F[CH]CC(F)(F)[CH]F(10226)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[CH]C(F)(F)C=CF(1131)'],
    products = ['F[CH]CC(F)(F)[CH]F(10226)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'F[CH]CC(F)=CF(10272)'],
    products = ['F[CH]CC(F)(F)[CH]F(10226)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'F[CH]C=C(F)[CH]F(877)'],
    products = ['F[CH]CC(F)(F)[CH]F(10226)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[CH2]C(F)(F)[CH]F(817)'],
    products = ['F[CH]CC(F)(F)[CH]F(10226)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', 'F[CH]C[C](F)F(803)'],
    products = ['F[CH]CC(F)(F)[CH]F(10226)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)(F)[CH]CF(10295)'],
    products = ['F[CH]CC(F)(F)[CH]F(10226)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH][CH]C(F)(F)CF(825)'],
    products = ['F[CH]CC(F)(F)[CH]F(10226)'],
...
network(
    label = 'PDepNetwork #3070',
    isomers = [
        'F[CH]CC(F)(F)[CH]F(10226)',
    ],
    reactants = [
        ('CHFCF2(55)', 'CH2CHF(56)'),
    ],
