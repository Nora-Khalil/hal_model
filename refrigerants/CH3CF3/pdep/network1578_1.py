...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[CH]OC=C(F)F(5617)'],
    products = ['F[CH]OC[C](F)F(5602)'],
    transitionState = 'TS8',
