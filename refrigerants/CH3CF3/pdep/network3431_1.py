...
species(
    label = 'F[CH]C(F)(F)C1(F)[CH]C1(F)F(11346)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-747.669,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([289,311,382,485,703,1397,181,249,286,344,486,552,511,665,553,637,1169,1241,1190,1306,2950,1000,334,575,1197,1424,3202,180,180,1048.95,1052.61],'cm^-1')),
        HinderedRotor(inertia=(0.15421,'amu*angstrom^2'), symmetry=1, barrier=(3.54558,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151712,'amu*angstrom^2'), symmetry=1, barrier=(3.48815,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.648876,0.111925,-0.000185128,1.60292e-07,-5.47126e-11,-89765.6,32.8501], Tmin=(100,'K'), Tmax=(798.185,'K')), NASAPolynomial(coeffs=[12.7367,0.0339194,-1.80018e-05,3.55365e-09,-2.49004e-13,-91554.4,-26.53], Tmin=(798.185,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-747.669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + ring(Cs(F)(F)-Cs(C)-Cs) + radical(Csj(Cs-F1sCsCs)(Cs-CsF1sF1s)(H)_ring) + radical(Csj(Cs-CsF1sF1s)(F1s)(H)) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
species(
    label = 'FC1C(F)(F)C2C(F)(F)C12F(11485)',
...
"""),
    ...
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.41945,0.0853998,-9.89818e-05,5.94394e-08,-1.45942e-11,-132179,22.2789], Tmin=(100,'K'), Tmax=(974.916,'K')), NASAPolynomial(coeffs=[13.3706,0.0322622,-1.72242e-05,3.53163e-09,-2.57589e-13,-134704,-39.8736], Tmin=(974.916,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1100.02,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(Cs-CsCsCsH) + group(CsCsCsFF) + group(CsCsCsFH) + group(CsCsCsFF) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + polycyclic(s2_3_4_ane)"""),
)

species(
    label = 'FC(F)=C(F)C1(F)CC1(F)F(11486)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0418086,0.0945905,-0.000131029,9.64035e-08,-2.8684e-11,-124049,28.4569], Tmin=(100,'K'), Tmax=(817.34,'K')), NASAPolynomial(coeffs=[12.734,0.0324767,-1.7038e-05,3.42809e-09,-2.46077e-13,-126124,-30.2159], Tmin=(817.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1032.53,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(CdCsCdF) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F)) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + ring(Cs-Cs(F)(F)-Cs)"""),
)
...
"""),
    E0 = (-881.994,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,346,659,817,1284,3010,987.5,1337.5,450,1655,190,488,555,1236,1407,182,240,577,636,1210,1413,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.653213,'amu*angstrom^2'), symmetry=1, barrier=(15.0186,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117385,'amu*angstrom^2'), symmetry=1, barrier=(2.69892,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.158,'amu*angstrom^2'), symmetry=1, barrier=(49.6166,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (176.06,'amu'),
...
species(
    label = 'F[C](F)C(F)C1=CC1(F)F(11487)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-610.951,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,174,267,591,721,1107,1278,1348,3273,2950,1000,190,488,555,1236,1407,352.498,352.533,352.624,352.81,353.117,353.263],'cm^-1')),
        HinderedRotor(inertia=(0.349127,'amu*angstrom^2'), symmetry=1, barrier=(30.8489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.348256,'amu*angstrom^2'), symmetry=1, barrier=(30.8592,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (157.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.755964,0.0778071,-9.2653e-05,5.7564e-08,-1.46456e-11,-73368.9,27.5145], Tmin=(100,'K'), Tmax=(942.193,'K')), NASAPolynomial(coeffs=[12.1099,0.029605,-1.59137e-05,3.26564e-09,-2.38144e-13,-75508.5,-26.5855], Tmin=(942.193,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-610.951,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(CsCCFF) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cd-Cd-Cs(F)(F)) + radical(Csj(Cs-F1sCdH)(F1s)(F1s))"""),
)
...
species(
    label = 'F[C](F)C(F)C1(F)C=C1F(11488)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-561.434,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,259,529,569,1128,1321,1390,3140,2950,1000,323,467,575,827,1418,190,488,555,1236,1407,180,180,918.319],'cm^-1')),
        HinderedRotor(inertia=(0.328121,'amu*angstrom^2'), symmetry=1, barrier=(7.54414,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.885898,'amu*angstrom^2'), symmetry=1, barrier=(20.3685,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (157.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0114614,0.0976283,-0.000165756,1.49147e-07,-5.26888e-11,-67390.9,28.6952], Tmin=(100,'K'), Tmax=(803.478,'K')), NASAPolynomial(coeffs=[9.95941,0.0332851,-1.79696e-05,3.5708e-09,-2.50962e-13,-68511.1,-14.1446], Tmin=(803.478,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-561.434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsH) + group(CdCsCdF) + ring(Cs-Cd(F)-Cd) + radical(Csj(Cs-CsF1sH)(F1s)(F1s)) + longDistanceInteraction_cyclic(Cs(F)-Cds(F))"""),
)
...
species(
    label = 'F[C](F)C(F)[C]1C=C1F(11490)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-220.763,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,271,519,563,612,1379,2950,1000,190,488,555,1236,1407,180,180,180,1165.06,1169.03,1171.79],'cm^-1')),
        HinderedRotor(inertia=(0.117904,'amu*angstrom^2'), symmetry=1, barrier=(2.71085,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121062,'amu*angstrom^2'), symmetry=1, barrier=(2.78345,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (138.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.707275,0.0798818,-0.000128164,1.12666e-07,-3.92239e-11,-26440.3,23.601], Tmin=(100,'K'), Tmax=(810.321,'K')), NASAPolynomial(coeffs=[8.61468,0.0298459,-1.51753e-05,2.95206e-09,-2.05407e-13,-27360.6,-10.6557], Tmin=(810.321,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-220.763,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(CsCsCsFH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsH) + group(CdCsCdF) + ring(Cs-Cd(F)-Cd) + radical(Allyl_T) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)
...
species(
    label = 'F[C](C(F)F)C1(F)[CH]C1(F)F(11492)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.428132,0.106404,-0.000171207,1.47407e-07,-5.06435e-11,-91079.9,33.6807], Tmin=(100,'K'), Tmax=(773.684,'K')), NASAPolynomial(coeffs=[11.9711,0.034992,-1.85889e-05,3.69191e-09,-2.60409e-13,-92779.8,-21.5434], Tmin=(773.684,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-758.535,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + ring(Cs(F)(F)-Cs(C)-Cs) + radical(Csj(Cs-F1sCsCs)(Cs-CsF1sF1s)(H)_ring) + radical(CsCsCsF1s) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'F[C](F)[C](F)C1(F)CC1(F)F(11493)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.287984,0.105049,-0.000176104,1.58506e-07,-5.60799e-11,-95071.4,34.0721], Tmin=(100,'K'), Tmax=(807.773,'K')), NASAPolynomial(coeffs=[9.89543,0.0378167,-2.00499e-05,3.95739e-09,-2.77182e-13,-96168.4,-9.48943], Tmin=(807.773,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-791.666,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + ring(Cs(F)(F)-Cs(C)-Cs) + radical(CsCsCsF1s) + radical(Csj(Cs-CsF1sH)(F1s)(F1s)) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
species(
    label = 'FC([C]1[CH]C1(F)F)C(F)(F)F(11494)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.180119,0.100425,-0.000158764,1.3653e-07,-4.69538e-11,-97864,32.5087], Tmin=(100,'K'), Tmax=(782.003,'K')), NASAPolynomial(coeffs=[10.999,0.0352048,-1.82436e-05,3.59099e-09,-2.52135e-13,-99366.6,-17.1039], Tmin=(782.003,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-814.871,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + ring(Cs(F)(F)-Cs(C)-Cs) + radical(Tertalkyl) + radical(Csj(Cs-CsCsH)(Cs-CsF1sF1s)(H)_ring)"""),
)

species(
    label = 'F[C](F)C(F)C1(F)[C](F)C1F(11495)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-722.982,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([289,311,382,485,703,1397,207,311,436,622,447,691,1074,1182,1276,1366,1311,1469,3045,3235,212,367,445,1450,190,488,555,1236,1407,180,1959.07],'cm^-1')),
        HinderedRotor(inertia=(2.40135,'amu*angstrom^2'), symmetry=1, barrier=(55.2117,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0732563,'amu*angstrom^2'), symmetry=1, barrier=(1.68431,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.22726,0.100582,-0.000151226,1.21566e-07,-3.92483e-11,-86809.5,33.7301], Tmin=(100,'K'), Tmax=(757.786,'K')), NASAPolynomial(coeffs=[12.6307,0.0327023,-1.68432e-05,3.3266e-09,-2.34941e-13,-88758,-24.7343], Tmin=(757.786,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-722.982,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(CsCsCsFH) + group(CsCsCsFH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + ring(Cs(C)-Cs-Cs(F)) + radical(Csj(Cs-F1sCsCs)(Cs-CsF1sH)(F1s)_ring) + radical(Csj(Cs-CsF1sH)(F1s)(F1s)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'F[C]1[CH]C1(F)C(F)C(F)(F)F(11496)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.159704,0.0989894,-0.000138498,1.01352e-07,-2.97983e-11,-91858.2,30.9235], Tmin=(100,'K'), Tmax=(828.93,'K')), NASAPolynomial(coeffs=[13.7966,0.031644,-1.66335e-05,3.3438e-09,-2.39815e-13,-94172,-33.7893], Tmin=(828.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-764.943,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + ring(Cs(C)-Cs-Cs(F)) + radical(Csj(Cs-F1sCsCs)(Cs-CsHH)(F1s)_ring) + radical(Csj(Cs-F1sCsCs)(Cs-CsF1sH)(H)_ring) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'F[C](F)[CH]C1(F)C(F)C1(F)F(11497)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.063916,0.0991182,-0.00016111,1.44226e-07,-5.13731e-11,-90473.6,34.8195], Tmin=(100,'K'), Tmax=(791.563,'K')), NASAPolynomial(coeffs=[9.3109,0.0382479,-2.01853e-05,3.99667e-09,-2.81213e-13,-91534.9,-5.54637], Tmin=(791.563,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-753.379,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(CsCsCsFF) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(CsCsFFH) + ring(Cs(F)(F)-Cs(C)-Cs) + radical(Cs_S) + radical(Csj(Cs-CsHH)(F1s)(F1s)) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'FC(F)(F)[CH]C1(F)[CH]C1(F)F(11498)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0617492,0.0948254,-0.000138281,1.1082e-07,-3.62664e-11,-98052,32.5439], Tmin=(100,'K'), Tmax=(743.198,'K')), NASAPolynomial(coeffs=[11.0401,0.0357352,-1.90123e-05,3.82763e-09,-2.74045e-13,-99683.7,-17.1614], Tmin=(743.198,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-816.366,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCsFFF) + ring(Cs(F)(F)-Cs(C)-Cs) + radical(Csj(Cs-F1sCsCs)(Cs-CsF1sF1s)(H)_ring) + radical(Cs_S) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['F[CH]C(F)(F)C1(F)[CH]C1(F)F(11346)'],
    products = ['F[C](F)C(F)C1(F)[CH]C1(F)F(11348)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(138)', 'F[CH]C1(F)[CH]C1(F)F(11484)'],
    products = ['F[C](F)C(F)C1(F)[CH]C1(F)F(11348)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C](F)C(F)C1(F)[CH]C1(F)F(11348)'],
    products = ['FC1C(F)(F)C2C(F)(F)C12F(11485)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C](F)C(F)C1(F)[CH]C1(F)F(11348)'],
    products = ['FC(F)=C(F)C1(F)CC1(F)F(11486)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[C](F)C(F)[C](F)C=C(F)F(3364)'],
    products = ['F[C](F)C(F)C1(F)[CH]C1(F)F(11348)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'F[C](F)C(F)C1=CC1(F)F(11487)'],
    products = ['F[C](F)C(F)C1(F)[CH]C1(F)F(11348)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(56.4488,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    ...
    products = ['F[C](F)C(F)C1(F)[CH]C1(F)F(11348)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(5.55494,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)

reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'F[C](F)C(F)C1(F)C=C1F(11488)'],
    products = ['F[C](F)C(F)C1(F)[CH]C1(F)F(11348)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FC(F)=CC1(F)[CH]C1(F)F(11374)'],
    products = ['F[C](F)C(F)C1(F)[CH]C1(F)F(11348)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(64.5182,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    label = 'reaction15',
    reactants = ['F2(78)', 'F[C](F)C(F)[C]1C=C1F(11490)'],
    products = ['F[C](F)C(F)C1(F)[CH]C1(F)F(11348)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(78)', 'F[C](F)C=C1[CH]C1(F)F(11376)'],
    products = ['F[C](F)C(F)C1(F)[CH]C1(F)F(11348)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(18.7391,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'F[C](F)C(F)=C1[CH]C1(F)F(11491)'],
    products = ['F[C](F)C(F)C1(F)[CH]C1(F)F(11348)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(284.462,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction18',
    reactants = ['CF2(43)', 'F[CH]C1(F)[CH]C1(F)F(11484)'],
    products = ['F[C](F)C(F)C1(F)[CH]C1(F)F(11348)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C](F)C(F)C1(F)[CH]C1(F)F(11348)'],
    products = ['F[C](C(F)F)C1(F)[CH]C1(F)F(11492)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C](F)C(F)C1(F)[CH]C1(F)F(11348)'],
    products = ['F[C](F)[C](F)C1(F)CC1(F)F(11493)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C](F)C(F)C1(F)[CH]C1(F)F(11348)'],
    products = ['FC([C]1[CH]C1(F)F)C(F)(F)F(11494)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(195.007,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction23',
    reactants = ['F[C](F)C(F)C1(F)[C](F)C1F(11495)'],
    products = ['F[C](F)C(F)C1(F)[CH]C1(F)F(11348)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F[C](F)C(F)C1(F)[CH]C1(F)F(11348)'],
    products = ['F[C]1[CH]C1(F)C(F)C(F)(F)F(11496)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(0.00110172,'s^-1'), n=4.50663, Ea=(233.258,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R4F_Ext-4R!H-R',), comment="""Estimated from node R4F_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction25',
    reactants = ['F[C](F)C(F)C1(F)[CH]C1(F)F(11348)'],
    products = ['F[C](F)[CH]C1(F)C(F)C1(F)F(11497)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(224.156,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction26',
    reactants = ['F[C](F)C(F)C1(F)[CH]C1(F)F(11348)'],
    products = ['FC(F)(F)[CH]C1(F)[CH]C1(F)F(11498)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(5.38157e+14,'s^-1'), n=-0.447076, Ea=(155.168,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.08474952276158404, var=26.08378321593064, Tref=1000.0, N=4, data_mean=0.0, correlation='R2F_Ext-1R!H-R',), comment="""Estimated from node R2F_Ext-1R!H-R"""),
)

network(
    label = 'PDepNetwork #3431',
    isomers = [
        'F[C](F)C(F)C1(F)[CH]C1(F)F(11348)',
    ],
    reactants = [
