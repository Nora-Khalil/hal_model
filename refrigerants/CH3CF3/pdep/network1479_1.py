...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.265275,0.0750905,-7.85629e-05,3.9433e-08,-7.67285e-12,-103713,27.7652], Tmin=(100,'K'), Tmax=(1258.77,'K')), NASAPolynomial(coeffs=[19.3056,0.0145856,-6.46276e-06,1.24739e-09,-8.89072e-14,-108506,-68.4753], Tmin=(1258.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-863.485,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsOsH) + group(COCsFO) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = 'F[C](F)COC1O[C]1F(3996)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.929239,'amu*angstrom^2'), symmetry=1, barrier=(21.365,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.930506,'amu*angstrom^2'), symmetry=1, barrier=(21.3942,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.930212,'amu*angstrom^2'), symmetry=1, barrier=(21.3874,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.182429,0.0789923,-9.82951e-05,5.79301e-08,-1.30246e-11,-50456.5,25.6128], Tmin=(100,'K'), Tmax=(1104.06,'K')), NASAPolynomial(coeffs=[19.4738,0.0090994,-3.33636e-06,5.90594e-10,-4.06844e-14,-54716.2,-69.3663], Tmin=(1104.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-420.698,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0575094,0.0951027,-0.000157968,1.37241e-07,-4.68313e-11,-73930.6,31.4469], Tmin=(100,'K'), Tmax=(808.701,'K')), NASAPolynomial(coeffs=[11.2421,0.0289533,-1.51873e-05,2.98106e-09,-2.08022e-13,-75385.5,-17.9483], Tmin=(808.701,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-615.807,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(CsCsFFH) + group(COCsFO) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = 'O=[C]C(F)OC[C](F)F(3983)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0899479,0.0949598,-0.000138332,9.99335e-08,-2.82505e-11,-62499.9,30.9445], Tmin=(100,'K'), Tmax=(870.432,'K')), NASAPolynomial(coeffs=[16.041,0.0208304,-1.05841e-05,2.09005e-09,-1.48182e-13,-65308,-44.6394], Tmin=(870.432,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-520.842,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical(C=CJO)"""),
)

species(
    label = '[O]C(F)=[C]OCC(F)F(4009)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-581.846,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,293,496,537,1218,1685,370,372.887,372.89,372.949,372.954,373.113,1272.26],'cm^-1')),
        HinderedRotor(inertia=(0.150321,'amu*angstrom^2'), symmetry=1, barrier=(14.8354,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109635,'amu*angstrom^2'), symmetry=1, barrier=(10.827,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.334908,'amu*angstrom^2'), symmetry=1, barrier=(33.062,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.513857,0.0825446,-0.000108175,7.3807e-08,-2.02832e-11,-69859.4,29.3564], Tmin=(100,'K'), Tmax=(883.542,'K')), NASAPolynomial(coeffs=[12.7498,0.0271498,-1.41308e-05,2.84738e-09,-2.05142e-13,-72021.6,-28.1601], Tmin=(883.542,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-581.846,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(C=COJ) + radical(C=CJO)"""),
)

species(
    label = 'OC(F)=CO[CH][C](F)F(4010)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.924127,'amu*angstrom^2'), symmetry=1, barrier=(21.2475,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.924799,'amu*angstrom^2'), symmetry=1, barrier=(21.263,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.923359,'amu*angstrom^2'), symmetry=1, barrier=(21.2298,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.925184,'amu*angstrom^2'), symmetry=1, barrier=(21.2718,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.817933,0.104506,-0.000145562,9.3883e-08,-2.30324e-11,-67978.3,30.5865], Tmin=(100,'K'), Tmax=(1012.74,'K')), NASAPolynomial(coeffs=[23.3506,0.00904891,-4.18059e-06,8.15389e-10,-5.85321e-14,-72873.7,-86.3189], Tmin=(1012.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-566.658,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CCsJOC(O)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = 'FO[C]=COC[C](F)F(4011)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {5,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)[CH]OC[C](F)F(3955)'],
    products = ['O=CC(=O)F(2867)', 'CH2CF2(57)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F(3804)', '[O]C[C](F)F(174)'],
    products = ['O=C(F)[CH]OC[C](F)F(3955)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(138)', '[CH2]O[CH]C(=O)F(3590)'],
    products = ['O=C(F)[CH]OC[C](F)F(3955)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O=C(F)[CH]OC[C](F)F(3955)'],
    products = ['O=C(F)C1OCC1(F)F(3957)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['O=C(F)[CH]OC[C](F)F(3955)'],
    products = ['F[C](F)COC1O[C]1F(3996)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O=C(F)[CH]OC[C](F)F(3955)'],
    products = ['F[C]1[CH]OCC(F)(F)O1(3997)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O=C(F)[CH]OC[C](F)F(3955)'],
    products = ['[O]C1(F)[CH]OCC1(F)F(3998)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O=CC(=O)F(2867)', '[CH2][C](F)F(141)'],
    products = ['O=C(F)[CH]OC[C](F)F(3955)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C(F)[CH]OC=C(F)F(3999)'],
    products = ['O=C(F)[CH]OC[C](F)F(3955)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C=COC[C](F)F(4000)'],
    products = ['O=C(F)[CH]OC[C](F)F(3955)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(43)', '[CH2]O[CH]C(=O)F(3590)'],
    products = ['O=C(F)[CH]OC[C](F)F(3955)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C(F)[CH]OC[C](F)F(3955)'],
    products = ['O=C(F)[CH]O[CH]C(F)F(4001)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=C(F)CO[CH][C](F)F(4002)'],
    products = ['O=C(F)[CH]OC[C](F)F(3955)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=[C]C(F)OC[C](F)F(3983)'],
    products = ['O=C(F)[CH]OC[C](F)F(3955)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)(C=O)C[C](F)F(3954)'],
    products = ['O=C(F)[CH]OC[C](F)F(3955)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O(6)', 'F[C]=COC[C](F)F(4004)'],
    products = ['O=C(F)[CH]OC[C](F)F(3955)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O=C(F)[CH]OC[C](F)F(3955)'],
    products = ['[O][C](F)C1OCC1(F)F(4007)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'O=C=[C]OC[C](F)F(3990)'],
    products = ['O=C(F)[CH]OC[C](F)F(3955)'],
...
reaction(
    label = 'reaction25',
    reactants = ['OC(F)=[C]OC[C](F)F(4008)'],
    products = ['O=C(F)[CH]OC[C](F)F(3955)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[O]C(F)=[C]OCC(F)F(4009)'],
    products = ['O=C(F)[CH]OC[C](F)F(3955)'],
...
reaction(
    label = 'reaction27',
    reactants = ['OC(F)=CO[CH][C](F)F(4010)'],
    products = ['O=C(F)[CH]OC[C](F)F(3955)'],
...
network(
    ...
    isomers = [
        'O=C(F)[CH]OC[C](F)F(3955)',
    ],
    reactants = [
        ('O=CC(=O)F(2867)', 'CH2CF2(57)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
