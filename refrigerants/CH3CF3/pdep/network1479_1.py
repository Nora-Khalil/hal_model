...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.595431,0.0755826,-8.46105e-05,4.70734e-08,-1.03872e-11,-103091,26.225], Tmin=(100,'K'), Tmax=(1098.52,'K')), NASAPolynomial(coeffs=[15.5014,0.0213059,-1.04968e-05,2.09534e-09,-1.51146e-13,-106366,-47.0883], Tmin=(1098.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-858.165,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(COCsFO) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F))"""),
)

species(
    label = 'F[CH]C(F)OC1O[C]1F(4864)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.970688,'amu*angstrom^2'), symmetry=1, barrier=(22.318,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.973904,'amu*angstrom^2'), symmetry=1, barrier=(22.392,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.973661,'amu*angstrom^2'), symmetry=1, barrier=(22.3864,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.21483,0.0746049,-8.15311e-05,3.92599e-08,-6.49832e-12,-57245.1,26.339], Tmin=(100,'K'), Tmax=(1034.33,'K')), NASAPolynomial(coeffs=[20.8654,0.00756549,-2.90341e-06,5.65623e-10,-4.24561e-14,-62202.8,-77.3007], Tmin=(1034.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-477.159,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsOsH) + group(COCsFO) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CCsJOC(O))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.23411,'amu*angstrom^2'), symmetry=1, barrier=(28.3746,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23352,'amu*angstrom^2'), symmetry=1, barrier=(28.3611,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.24003,'amu*angstrom^2'), symmetry=1, barrier=(28.5107,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.177122,0.0803471,-9.49136e-05,5.18113e-08,-1.06387e-11,-49639.1,26.1717], Tmin=(100,'K'), Tmax=(1270.75,'K')), NASAPolynomial(coeffs=[22.8237,0.00422198,-6.59168e-07,5.68576e-11,-3.06204e-15,-55184.1,-89.1222], Tmin=(1270.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-414.055,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.118186,0.0990724,-0.0001662,1.43204e-07,-4.81278e-11,-72059.8,30.7061], Tmin=(100,'K'), Tmax=(822.564,'K')), NASAPolynomial(coeffs=[12.2013,0.027463,-1.42768e-05,2.77977e-09,-1.92624e-13,-73690.6,-23.9155], Tmin=(822.564,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-600.305,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-O2d)OsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(COCsFO) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = 'O=C(F)C(F)O[CH][CH]F(4869)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.310975,0.104822,-0.000181972,1.60178e-07,-5.45738e-11,-76443,31.1228], Tmin=(100,'K'), Tmax=(829.676,'K')), NASAPolynomial(coeffs=[12.1773,0.0286165,-1.52749e-05,2.99186e-09,-2.07462e-13,-77964.6,-23.4759], Tmin=(829.676,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-636.794,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFHH) + group(COCsFO) + radical(Csj(Cs-F1sHH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)

species(
    label = 'O=C(F)[CH]O[CH]C(F)F(4401)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.162392,0.0979773,-0.000154819,1.23981e-07,-3.9014e-11,-76567.9,30.8503], Tmin=(100,'K'), Tmax=(782.73,'K')), NASAPolynomial(coeffs=[14.4205,0.0234541,-1.20053e-05,2.34356e-09,-1.63598e-13,-78850.8,-35.9313], Tmin=(782.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-637.818,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(CsCsFFH) + group(COCsFO) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(CCsJOCs)"""),
)

species(
    label = 'O=[C]C(F)OC(F)[CH]F(4796)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.17487,'amu*angstrom^2'), symmetry=1, barrier=(27.0125,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17443,'amu*angstrom^2'), symmetry=1, barrier=(27.0025,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17602,'amu*angstrom^2'), symmetry=1, barrier=(27.0391,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.299039,0.080968,-0.000102419,6.23305e-08,-1.46924e-11,-35078.7,25.6277], Tmin=(100,'K'), Tmax=(1044.36,'K')), NASAPolynomial(coeffs=[17.6604,0.014472,-6.91182e-06,1.36307e-09,-9.79398e-14,-38705,-58.8845], Tmin=(1044.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-292.773,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(Cs-F1sO2sH)(F1s)(H)) + radical(Cdj(Cd-O2sH)(F1s))"""),
)

species(
    label = 'FC1=COC(F)C(F)O1(4801)',
...
"""),
    E0 = (-571.377,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,293,496,537,1218,1685,370,393.821,393.821,393.821,393.822,393.822,393.822],'cm^-1')),
        HinderedRotor(inertia=(0.247247,'amu*angstrom^2'), symmetry=1, barrier=(27.2118,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.247247,'amu*angstrom^2'), symmetry=1, barrier=(27.2118,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.247247,'amu*angstrom^2'), symmetry=1, barrier=(27.2118,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.614808,0.0763296,-8.35742e-05,4.53616e-08,-9.83463e-12,-68600.4,28.7353], Tmin=(100,'K'), Tmax=(1110.96,'K')), NASAPolynomial(coeffs=[15.3235,0.0233698,-1.20673e-05,2.45065e-09,-1.78161e-13,-71868.5,-43.7732], Tmin=(1110.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-571.377,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(C=COJ) + radical(C=CJO)"""),
)

species(
    label = 'OC(F)=CO[C](F)[CH]F(4876)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.0116,'amu*angstrom^2'), symmetry=1, barrier=(23.2588,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01075,'amu*angstrom^2'), symmetry=1, barrier=(23.2391,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01063,'amu*angstrom^2'), symmetry=1, barrier=(23.2364,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0103,'amu*angstrom^2'), symmetry=1, barrier=(23.2287,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.508803,0.0998364,-0.000137603,8.9817e-08,-2.25237e-11,-67117,29.3832], Tmin=(100,'K'), Tmax=(986.579,'K')), NASAPolynomial(coeffs=[20.7411,0.0136797,-6.60887e-06,1.29857e-09,-9.28103e-14,-71309.9,-72.848], Tmin=(986.579,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-559.389,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = 'FC=CO[CH][C](F)OF(4877)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {5,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)[CH]OC(F)[CH]F(4354)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F(537)', '[O]C(F)[CH]F(834)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', 'O=C(F)[CH]O[CH]F(4523)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4354)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['O=C(F)[CH]OC(F)[CH]F(4354)'],
    products = ['F[CH]C(F)OC1O[C]1F(4864)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O=C(F)[CH]OC(F)[CH]F(4354)'],
    products = ['F[C]1[CH]OC(F)C(F)O1(4792)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=C(F)[CH]OC=CF(4866)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4354)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)[CH]OC(F)=CF(4610)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4354)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O=C=COC(F)[CH]F(4867)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4354)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', 'O=C(F)[CH]O[CH]F(4523)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4354)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=C(F)[CH]OC(F)[CH]F(4354)'],
    products = ['O=C(F)[CH]O[C](F)CF(4464)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=C(F)CO[C](F)[CH]F(4868)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4354)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=C(F)[CH]OC(F)[CH]F(4354)'],
    products = ['O=C(F)C(F)O[CH][CH]F(4869)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=C(F)[CH]OC(F)[CH]F(4354)'],
    products = ['O=C(F)[CH]O[CH]C(F)F(4401)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]C(F)OC(F)[CH]F(4796)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4354)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O(6)', 'F[C]=COC(F)[CH]F(4871)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4354)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O=C(F)[CH]OC(F)[CH]F(4354)'],
    products = ['FC1=COC(F)C(F)O1(4801)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O=C(F)[CH]OC(F)[CH]F(4354)'],
    products = ['[O][C](F)C1OC(F)C1F(4873)'],
...
reaction(
    label = 'reaction27',
    reactants = ['HF(38)', 'O=C=[C]OC(F)[CH]F(4804)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4354)'],
...
reaction(
    label = 'reaction28',
    reactants = ['OC(F)=[C]OC(F)[CH]F(4874)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4354)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[O]C(F)=[C]OC(F)CF(4875)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4354)'],
...
reaction(
    label = 'reaction30',
    reactants = ['OC(F)=CO[C](F)[CH]F(4876)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4354)'],
...
reaction(
    label = 'reaction31',
    reactants = ['FC=CO[CH][C](F)OF(4877)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4354)'],
...
reaction(
    label = 'reaction32',
    reactants = ['F[CH]C(F)OC=[C]OF(4878)'],
    products = ['O=C(F)[CH]OC(F)[CH]F(4354)'],
