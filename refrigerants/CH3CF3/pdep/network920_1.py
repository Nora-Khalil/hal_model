...
"""),
    ...
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.444925,0.0580091,-5.76376e-05,2.86553e-08,-4.98612e-12,11471.9,24.2138], Tmin=(100,'K'), Tmax=(1854.99,'K')), NASAPolynomial(coeffs=[8.78181,0.0107828,2.65104e-06,-9.54454e-10,7.48551e-14,12751,-13.3266], Tmin=(1854.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(93.7614,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsOsHH) + ring(124trioxane) + radical(CCsJOOC) + radical(OCJO)"""),
)

species(
    label = 'C=[C]OOC[O](2832)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.77445,'amu*angstrom^2'), symmetry=1, barrier=(40.798,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.77467,'amu*angstrom^2'), symmetry=1, barrier=(40.8032,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.77495,'amu*angstrom^2'), symmetry=1, barrier=(40.8096,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.77511,'amu*angstrom^2'), symmetry=1, barrier=(40.8133,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40601,0.047066,-2.45428e-05,-7.47352e-09,7.37906e-12,-444.371,23.3079], Tmin=(100,'K'), Tmax=(1003.05,'K')), NASAPolynomial(coeffs=[15.5092,0.0124049,-4.98115e-06,9.74431e-10,-7.2594e-14,-4359.21,-50.1864], Tmin=(1003.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-4.5446,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CJCOOH) + radical((O)CJOC)"""),
)

species(
    label = 'C=[C]OO[CH]O(2833)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {2,S} {4,S}
2  O u0 p2 c0 {1,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.88984,'amu*angstrom^2'), symmetry=1, barrier=(43.4512,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.89076,'amu*angstrom^2'), symmetry=1, barrier=(43.4722,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.88988,'amu*angstrom^2'), symmetry=1, barrier=(43.452,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.89079,'amu*angstrom^2'), symmetry=1, barrier=(43.4729,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.062,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49467,0.0459845,-2.46716e-05,-4.13379e-09,5.36175e-12,-3758.58,21.2908], Tmin=(100,'K'), Tmax=(1034.17,'K')), NASAPolynomial(coeffs=[14.2662,0.0149656,-6.33884e-06,1.23316e-09,-8.99476e-14,-7383.01,-45.5055], Tmin=(1034.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-32.0665,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCsJOOC) + radical((O)CJOC)"""),
)

species(
    label = '[CH]=COOC[O](2834)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {2,S} {4,S}
...
"""),
    E0 = (240.313,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,214.07],'cm^-1')),
        HinderedRotor(inertia=(0.889115,'amu*angstrom^2'), symmetry=1, barrier=(29.0049,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.890745,'amu*angstrom^2'), symmetry=1, barrier=(29.0041,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.890441,'amu*angstrom^2'), symmetry=1, barrier=(29.0023,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4606,0.0470446,-3.06028e-05,1.39545e-09,3.66934e-12,29002.1,23.4226], Tmin=(100,'K'), Tmax=(1038.22,'K')), NASAPolynomial(coeffs=[14.9103,0.0123737,-5.28557e-06,1.04698e-09,-7.74462e-14,25285.2,-46.4197], Tmin=(1038.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(240.313,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(OCOJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=COO[CH]O(2835)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {2,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.69021,'amu*angstrom^2'), symmetry=1, barrier=(38.8613,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.69173,'amu*angstrom^2'), symmetry=1, barrier=(38.8962,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8837,0.0301549,2.29521e-05,-6.08724e-08,2.75558e-11,-2908.73,22.0545], Tmin=(100,'K'), Tmax=(956.896,'K')), NASAPolynomial(coeffs=[17.7009,0.00473429,-9.96253e-07,2.59511e-10,-2.79752e-14,-7799.07,-63.2932], Tmin=(956.896,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-24.942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cds_P)"""),
)

species(
    label = 'C=COO[C]=O(2686)',
    structure = adjacencyList("""multiplicity 2
1 O u0 p2 c0 {2,S} {4,S}
2 O u0 p2 c0 {1,S} {6,S}
3 O u0 p2 c0 {6,D}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.71663,'amu*angstrom^2'), symmetry=1, barrier=(39.4688,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.71592,'amu*angstrom^2'), symmetry=1, barrier=(39.4525,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.7172,'amu*angstrom^2'), symmetry=1, barrier=(39.4818,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75171,0.0343538,1.16524e-05,-5.01743e-08,2.42067e-11,-8996.61,20.7525], Tmin=(100,'K'), Tmax=(949.628,'K')), NASAPolynomial(coeffs=[17.7531,0.00454932,-6.54782e-07,1.5608e-10,-1.87134e-14,-13730.9,-64.5434], Tmin=(949.628,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.5896,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (-46.4323,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2782.5,750,1395,475,1775,1000,180,180,403.215,827.718,828.024,828.209],'cm^-1')),
        HinderedRotor(inertia=(2.28874,'amu*angstrom^2'), symmetry=1, barrier=(52.6225,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10805,'amu*angstrom^2'), symmetry=1, barrier=(52.6186,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.28884,'amu*angstrom^2'), symmetry=1, barrier=(52.6249,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.63994,0.0329699,-1.59903e-05,2.71412e-09,-1.31781e-13,-5597.43,23.8605], Tmin=(100,'K'), Tmax=(2739.26,'K')), NASAPolynomial(coeffs=[35.3616,-0.00434531,-4.88573e-07,1.41655e-10,-6.54631e-15,-26355.2,-167.311], Tmin=(2739.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-46.4323,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + group(Cs-CsHHH) + group(Cds-OdOsH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]COOC=O(2839)',
    structure = adjacencyList("""1  O u0 p2 c0 {2,S} {4,S}
2  O u0 p2 c0 {1,S} {5,S}
3  O u0 p2 c0 {5,D}
...
"""),
    E0 = (36.1442,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,514.695,514.698,514.7],'cm^-1')),
        HinderedRotor(inertia=(0.000636337,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.227448,'amu*angstrom^2'), symmetry=1, barrier=(42.7576,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.227448,'amu*angstrom^2'), symmetry=1, barrier=(42.7576,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.227438,'amu*angstrom^2'), symmetry=1, barrier=(42.7575,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (88.062,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'C=COO(2144)'],
    products = ['C=COOC=O(2294)'],
    transitionState = 'TS2',
