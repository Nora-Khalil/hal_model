...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(138)', '[CH]=C[O](623)'],
    products = ['[CH]=CO[C](F)F(2871)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['[O][C](F)F(263)', '[CH]=[CH](977)'],
    products = ['[CH]=CO[C](F)F(2871)'],
    transitionState = 'TS7',
