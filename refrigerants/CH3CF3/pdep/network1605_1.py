...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.187871,'amu*angstrom^2'), symmetry=1, barrier=(4.31951,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.185321,'amu*angstrom^2'), symmetry=1, barrier=(4.2609,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.564171,'amu*angstrom^2'), symmetry=1, barrier=(12.9714,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.281451,0.0951528,-0.000183301,1.74384e-07,-6.2574e-11,-107426,28.298], Tmin=(100,'K'), Tmax=(843.188,'K')), NASAPolynomial(coeffs=[8.32135,0.0291717,-1.63954e-05,3.26122e-09,-2.26927e-13,-107793,-3.24985], Tmin=(843.188,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-894.2,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sO2s)(F1s)(F1s)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    ...
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.200161,0.0946869,-0.000176131,1.60618e-07,-5.55499e-11,-109467,27.8521], Tmin=(100,'K'), Tmax=(849.829,'K')), NASAPolynomial(coeffs=[10.5505,0.0241642,-1.31662e-05,2.5844e-09,-1.78254e-13,-110439,-15.7655], Tmin=(849.829,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-911.207,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sF1s)(F1s)(O2s-Cs)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]OC(F)(F)[C](F)F(5615)'],
...
reaction(
    ...
    products = ['F[CH]OC(F)(F)[C](F)F(5615)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]OC(F)=C(F)F(5661)'],
    products = ['F[CH]OC(F)(F)[C](F)F(5615)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction11',
    reactants = ['F[CH]OC(F)(F)[C](F)F(5615)'],
    products = ['F[CH]O[C](F)C(F)(F)F(5722)'],
