...
"""),
    ...
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.87715,0.00439386,7.92651e-05,-1.11353e-07,4.36133e-11,-56897.4,14.9213], Tmin=(100,'K'), Tmax=(959.889,'K')), NASAPolynomial(coeffs=[15.2642,0.0042868,-1.06376e-06,3.43815e-10,-3.85479e-14,-61648.6,-56.6933], Tmin=(959.889,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-473.561,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(CsCFHO) + group(Cds-OdCsOs) + longDistanceInteraction_cyclic(Cs(F)-CO) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.99139,0.029866,-5.24779e-05,6.23685e-08,-2.70209e-11,-24119.9,16.5777], Tmin=(100,'K'), Tmax=(827.584,'K')), NASAPolynomial(coeffs=[-1.07986,0.0294266,-1.52191e-05,2.98181e-09,-2.08111e-13,-22757.1,39.6108], Tmin=(827.584,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-200.784,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(CsCFHO) + ring(Cs(O2)-O2s-Cs(F)) + radical(CCOJ) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(=O)C([O])F(4981)'],
    products = ['CO2(14)', 'CHFO(47)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C=C([O])OF(5716)'],
    products = ['[O]C(=O)C([O])F(4981)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction15',
    reactants = ['[O][C]=O(722)', '[O][CH]F(2815)'],
    products = ['[O]C(=O)C([O])F(4981)'],
