...
"""),
    E0 = (-339.454,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,486,617,768,1157,1926,3000,3100,440,815,1455,1000,398.348,398.349,1499.51,1499.51],'cm^-1')),
        HinderedRotor(inertia=(0.0598261,'amu*angstrom^2'), symmetry=1, barrier=(6.73661,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0598257,'amu*angstrom^2'), symmetry=1, barrier=(6.7366,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0598254,'amu*angstrom^2'), symmetry=1, barrier=(6.73657,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60019,0.0573841,-8.20901e-05,6.77143e-08,-2.30303e-11,-40744.8,26.3374], Tmin=(100,'K'), Tmax=(728.79,'K')), NASAPolynomial(coeffs=[7.54078,0.0240807,-1.21076e-05,2.38264e-09,-1.68339e-13,-41592.2,-0.315897], Tmin=(728.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-339.454,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-OsHHH) + group(COCsFO) + radical(C=OCOJ) + radical(CsJOCH3)"""),
)
...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95619,0.0495421,-5.58038e-05,3.63726e-08,-1.01465e-11,-4207.89,23.5303], Tmin=(100,'K'), Tmax=(848.568,'K')), NASAPolynomial(coeffs=[7.12157,0.0251934,-1.27627e-05,2.55782e-09,-1.84113e-13,-5084.53,-0.541433], Tmin=(848.568,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-35.5653,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cs-OsHHH) + ring(Cs-Cs(F)-O2s-O2s) + radical(CsCsF1sO2s) + radical(CsJOCH3)"""),
)
...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00741,0.0449842,-3.75394e-05,1.58392e-08,-2.76367e-12,-25959.4,21.6426], Tmin=(100,'K'), Tmax=(1320.73,'K')), NASAPolynomial(coeffs=[9.98737,0.0208159,-1.00906e-05,1.98388e-09,-1.40996e-13,-28067.3,-19.076], Tmin=(1320.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.425,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFOO) + group(Cs-OsHHH) + ring(Cs(F)(O2)-O2s-Cs) + radical(O2sj(Cs-F1sO2sCs)) + radical(CsJOCH3)"""),
)

species(
    label = '[O]C1OCC1([O])F(4726)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.53579,0.0346568,-1.85005e-05,3.84172e-09,-2.53371e-13,-28292.9,21.1605], Tmin=(100,'K'), Tmax=(2108.74,'K')), NASAPolynomial(coeffs=[17.0088,0.0124129,-6.38344e-06,1.18247e-09,-7.69903e-14,-35555.1,-62.2078], Tmin=(2108.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-235.66,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(Cs-O2s-Cs-Cs(F)) + radical(O2sj(Cs-F1sCsCs)) + radical(CCOJ)"""),
)

species(
    label = '[CH2]OC(=O)[C](O)F(4727)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {5,S} {7,S}
...
"""),
    E0 = (-458.912,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,280,501,1494,1531,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86474,0.0515888,-5.72267e-05,3.70458e-08,-1.03177e-11,-55121.5,21.6693], Tmin=(100,'K'), Tmax=(848.269,'K')), NASAPolynomial(coeffs=[7.10697,0.0268691,-1.35146e-05,2.69175e-09,-1.92995e-13,-56010.9,-2.75876], Tmin=(848.269,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-458.912,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-OsHHH) + group(Cds-OdCsOs) + radical(CsCOF1sO2s) + radical(CsJOC(O)C)"""),
)
...
"""),
    E0 = (-525.947,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([286,619,818,1246,1924,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.98524,0.0490197,-5.23454e-05,2.93261e-08,-6.87302e-12,-63188.2,20.0716], Tmin=(100,'K'), Tmax=(1003.96,'K')), NASAPolynomial(coeffs=[8.78674,0.0219212,-1.18582e-05,2.44127e-09,-1.78375e-13,-64553.9,-12.7687], Tmin=(1003.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-525.947,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-OsHHH) + group(Cds-O2d(Cds-O2d)O2s) + group(COCFO) + radical(CsJOC(O)C)"""),
)
...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50357,0.059657,-8.32401e-05,6.35668e-08,-1.97686e-11,-45370.2,26.5993], Tmin=(100,'K'), Tmax=(781.737,'K')), NASAPolynomial(coeffs=[8.82462,0.0221946,-1.1353e-05,2.25791e-09,-1.60858e-13,-46514.8,-6.91743], Tmin=(781.737,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-377.941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-OsHHH) + group(COCsFO) + radical(Cs_P) + radical(CsJOCH3)"""),
)

species(
    label = 'COC(=O)[C]([O])F(4730)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  O u0 p2 c0 {5,S} {6,S}
3  O u0 p2 c0 {6,D}
...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99957,0.0544345,-9.48603e-05,9.80888e-08,-3.79616e-11,-52140.7,22.0521], Tmin=(100,'K'), Tmax=(856.739,'K')), NASAPolynomial(coeffs=[0.604371,0.0355905,-1.74704e-05,3.32076e-09,-2.26714e-13,-50971,33.9987], Tmin=(856.739,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-434.038,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-OsHHH) + group(Cds-OdCsOs) + radical(O2sj(Cs-F1sCOH)) + radical(CsCOF1sO2s)"""),
)

species(
    label = '[CH2]OC([C]=O)OF(4731)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-40.0155,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,1855,455,950,342.11,342.11,1741.01],'cm^-1')),
        HinderedRotor(inertia=(0.319509,'amu*angstrom^2'), symmetry=1, barrier=(26.5364,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121323,'amu*angstrom^2'), symmetry=1, barrier=(10.0763,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00468463,'amu*angstrom^2'), symmetry=1, barrier=(10.0763,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.319509,'amu*angstrom^2'), symmetry=1, barrier=(26.5364,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48878,0.060444,-8.19422e-05,6.09097e-08,-1.85803e-11,-4727.01,25.8936], Tmin=(100,'K'), Tmax=(793.564,'K')), NASAPolynomial(coeffs=[8.7862,0.0236612,-1.24156e-05,2.50132e-09,-1.79768e-13,-5885.21,-7.62492], Tmin=(793.564,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-40.0155,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cs-OsHHH) + group(Cds-OdCsH) + radical(CsJOCH3) + radical(CsCJ=O)"""),
)

species(
    label = '[O]C([C]=O)OCF(4732)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {5,S} {6,S}
3  O u1 p2 c0 {5,S}
...
"""),
    E0 = (-333.003,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,548,1085,1183,1302,1466,1520,3060,3119,1855,455,950,340.297,340.345,1843.53,1843.55],'cm^-1')),
        HinderedRotor(inertia=(0.110162,'amu*angstrom^2'), symmetry=1, barrier=(9.05545,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.261474,'amu*angstrom^2'), symmetry=1, barrier=(21.4888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110192,'amu*angstrom^2'), symmetry=1, barrier=(9.05563,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74105,0.0547473,-7.98903e-05,7.04621e-08,-2.57031e-11,-39974.5,26.396], Tmin=(100,'K'), Tmax=(753.968,'K')), NASAPolynomial(coeffs=[6.05248,0.0266576,-1.36288e-05,2.69688e-09,-1.90906e-13,-40476.4,7.79666], Tmin=(753.968,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-333.003,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsFHHO) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CsCJ=O)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[O]C([O])C(=O)F(4669)'],
    products = ['[CH2]OC([O])C(=O)F(4310)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]OC([O])C(=O)F(4310)'],
    products = ['[O]C1OCC1([O])F(4726)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(1.46159e+06,'s^-1'), n=1.55572, Ea=(103.794,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_cs2H] for rate rule [R5_SS_CO;carbonylbond_intra;radadd_intra_cs2H]
Euclidian distance = 1.4142135623730951
family: Intra_R_Add_Exocyclic
Ea raised from 101.2 to 103.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction12',
    reactants = ['[CH2]OC(=O)[C](O)F(4727)'],
    products = ['[CH2]OC([O])C(=O)F(4310)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(205000,'s^-1'), n=2.37, Ea=(285.968,'kJ/mol'), T0=(1,'K'), Tmin=(600,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R!H->C_Ext-1R!H-R',), comment="""Estimated from node Root_3R!H->C_Ext-1R!H-R"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(9.07578e-06,'m^3/(mol*s)'), n=3.04336, Ea=(59.0468,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R"""),
)
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', '[CH2]OC(=O)[C]=O(4704)'],
    products = ['[CH2]OC([O])C(=O)F(4310)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(287.132,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction19',
    reactants = ['[CH2]OC([O])C(=O)F(4310)'],
    products = ['[CH2]O[C](O)C(=O)F(4729)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C([C]=O)OCF(4732)'],
    products = ['[CH2]OC([O])C(=O)F(4310)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(195.246,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

network(
    label = 'PDepNetwork #1435',
    isomers = [
        '[CH2]OC([O])C(=O)F(4310)',
    ],
    reactants = [
