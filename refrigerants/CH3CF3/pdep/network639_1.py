...
reaction(
    label = 'reaction1',
    reactants = ['[O]OOO[C](F)F(1594)'],
    products = ['O2(2)', 'FC1(F)OO1(181)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]OO[C](F)F(237)'],
    products = ['[O]OOO[C](F)F(1594)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OOO[C](F)F(1594)'],
    products = ['[O-][O+]=O(1597)', '[O][C](F)F(263)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]O[O](128)', '[O][C](F)F(263)'],
    products = ['[O]OOO[C](F)F(1594)'],
    transitionState = 'TS7',
