...
reaction(
    label = 'reaction3',
    reactants = ['OF(195)', 'F[C]C(F)OF(5785)'],
    products = ['OC(F)(F)C(F)OF(5764)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['OF(195)', 'OC(F)(F)[C]F(426)'],
    products = ['OC(F)(F)C(F)OF(5764)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['H2O(3)', 'FOC(F)=C(F)F(676)'],
    products = ['OC(F)(F)C(F)OF(5764)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OF(195)', 'FOC=C(F)F(707)'],
    products = ['OC(F)(F)C(F)OF(5764)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(328)', 'OC(F)=CF(5786)'],
    products = ['OC(F)(F)C(F)OF(5764)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O[C](F)C(F)OF(5787)'],
    products = ['OC(F)(F)C(F)OF(5764)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'OC(F)(F)[CH]OF(711)'],
    products = ['OC(F)(F)C(F)OF(5764)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)C(O)(F)F(2791)'],
    products = ['OC(F)(F)C(F)OF(5764)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(7)', 'FOC(F)[C](F)F(1506)'],
    products = ['OC(F)(F)C(F)OF(5764)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)(F)C(F)OF(5788)'],
    products = ['OC(F)(F)C(F)OF(5764)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(127)', 'OC(F)(F)[CH]F(1419)'],
    products = ['OC(F)(F)C(F)OF(5764)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]OF(3905)', 'O[C](F)F(206)'],
    products = ['OC(F)(F)C(F)OF(5764)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'OC(F)(F)[C](F)OF(679)'],
    products = ['OC(F)(F)C(F)OF(5764)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=C(F)C(F)OF(5789)'],
    products = ['OC(F)(F)C(F)OF(5764)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(78)', 'O=CC(O)(F)F(395)'],
    products = ['OC(F)(F)C(F)OF(5764)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'O=C(F)C(O)(F)F(683)'],
    products = ['OC(F)(F)C(F)OF(5764)'],
