...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.920684,'amu*angstrom^2'), symmetry=1, barrier=(21.1683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.921394,'amu*angstrom^2'), symmetry=1, barrier=(21.1847,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1479,0.0697675,-0.000108307,8.3146e-08,-2.36663e-11,-50388.4,27.9047], Tmin=(100,'K'), Tmax=(629.311,'K')), NASAPolynomial(coeffs=[10.2241,0.0206442,-1.1637e-05,2.36859e-09,-1.69651e-13,-51700.4,-13.027], Tmin=(629.311,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-419.752,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(Cs-CsOsOsH) + group(COCsFO) + radical(Cs_P)"""),
)
...
"""),
    ...
    molecularWeight = (127.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29312,0.0641165,-8.86096e-05,6.15463e-08,-1.69918e-11,-36882.5,24.5815], Tmin=(100,'K'), Tmax=(883.915,'K')), NASAPolynomial(coeffs=[11.5789,0.0175712,-9.62429e-06,1.97552e-09,-1.43619e-13,-38700.9,-23.7726], Tmin=(883.915,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-307.436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2sCF) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsOsOsH) + ring(Cs-Cs(F)-O2s-O2s) + radical(Cs_P)"""),
)

species(
    label = '[O]C1(O)OC1(F)OF(11248)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {4,S}
...
"""),
    E0 = (-538.483,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,180,180,180,180,733.814,735.807,736.184],'cm^-1')),
        HinderedRotor(inertia=(0.162389,'amu*angstrom^2'), symmetry=1, barrier=(3.73365,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138468,'amu*angstrom^2'), symmetry=1, barrier=(53.7883,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48424,0.061892,-0.000107913,9.65225e-08,-3.32169e-11,-64680.3,22.099], Tmin=(100,'K'), Tmax=(845.527,'K')), NASAPolynomial(coeffs=[7.95442,0.0189347,-9.79838e-06,1.89069e-09,-1.29802e-13,-65333,-5.41999], Tmin=(845.527,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-538.483,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs) + radical(C=OCOJ) + radical(C=OCOJ)"""),
)

species(
    label = '[O][C](F)C(=O)O(5719)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {5,S} {7,S}
3 O u0 p2 c0 {5,D}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.2281,'amu*angstrom^2'), symmetry=1, barrier=(28.2364,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.22631,'amu*angstrom^2'), symmetry=1, barrier=(28.1954,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28347,0.0676202,-0.000128189,1.16333e-07,-3.99025e-11,-27253.8,22.2743], Tmin=(100,'K'), Tmax=(854.564,'K')), NASAPolynomial(coeffs=[9.16922,0.0151077,-8.62985e-06,1.69888e-09,-1.16803e-13,-28031.9,-11.1975], Tmin=(854.564,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-227.351,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CsCJ=O)"""),
)
...
"""),
    E0 = (-422.004,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,180,180,180,180,899.804,900.765,900.836,901.294],'cm^-1')),
        HinderedRotor(inertia=(2.24849,'amu*angstrom^2'), symmetry=1, barrier=(51.6972,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.24907,'amu*angstrom^2'), symmetry=1, barrier=(51.7106,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12002,0.0745766,-0.00014382,1.39667e-07,-5.12398e-11,-50662.5,23.6553], Tmin=(100,'K'), Tmax=(837.206,'K')), NASAPolynomial(coeffs=[6.08523,0.0268412,-1.52711e-05,3.04421e-09,-2.12437e-13,-50652.3,5.60917], Tmin=(837.206,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-422.004,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs) + radical(C=OCOJ) + radical(CCOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.43749,'amu*angstrom^2'), symmetry=1, barrier=(33.0508,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.43977,'amu*angstrom^2'), symmetry=1, barrier=(33.1031,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.43706,'amu*angstrom^2'), symmetry=1, barrier=(33.0408,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.43922,'amu*angstrom^2'), symmetry=1, barrier=(33.0906,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.401379,0.0870768,-0.000154275,1.35285e-07,-4.60461e-11,-47936.3,25.4216], Tmin=(100,'K'), Tmax=(806.724,'K')), NASAPolynomial(coeffs=[11.8913,0.0202612,-1.17338e-05,2.36337e-09,-1.6642e-13,-49469.8,-25.5571], Tmin=(806.724,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-399.579,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sCF) + group(O2s-OsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsH) + radical(CsCJ=O)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['OF(195)', 'O=[C]C(=O)OF(2205)'],
    products = ['[O]C(F)(OF)C(=O)O(9882)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['O(6)', 'O=C(O)[C](F)OF(1855)'],
    products = ['[O]C(F)(OF)C(=O)O(9882)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)(OF)C(=O)O(9882)'],
    products = ['[O]C1(O)OC1(F)OF(11248)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(127)', 'O=C(O)C(=O)F(1859)'],
    products = ['[O]C(F)(OF)C(=O)O(9882)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=C(F)OF(9921)', 'O=[C]O(457)'],
    products = ['[O]C(F)(OF)C(=O)O(9882)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C([O])(F)C(=O)O(8813)'],
    products = ['[O]C(F)(OF)C(=O)O(9882)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(127)', '[O][C](F)C(=O)O(5719)'],
    products = ['[O]C(F)(OF)C(=O)O(9882)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(7)', '[O]C(F)([C]=O)OF(11249)'],
    products = ['[O]C(F)(OF)C(=O)O(9882)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[O]C(=O)C([O])(F)OF(11250)'],
    products = ['[O]C(F)(OF)C(=O)O(9882)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O][C](F)OF(1593)', 'O=[C]O(457)'],
    products = ['[O]C(F)(OF)C(=O)O(9882)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(78)', '[O]C(=O)C(=O)O(2204)'],
    products = ['[O]C(F)(OF)C(=O)O(9882)'],
