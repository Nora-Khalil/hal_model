...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(127)', '[CH2]C(O)(F)F(197)'],
    products = ['OC(F)(F)COF(647)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[C](F)F(206)', '[CH2]OF(222)'],
    products = ['OC(F)(F)COF(647)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'OC(F)(F)[CH]OF(711)'],
    products = ['OC(F)(F)COF(647)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=CC(O)(F)F(395)'],
    products = ['OC(F)(F)COF(647)'],
