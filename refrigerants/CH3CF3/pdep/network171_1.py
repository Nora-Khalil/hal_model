...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)O[C]=O(727)'],
    products = ['[CH2]C(F)(F)O[C]=O(630)'],
    transitionState = 'TS7',
