...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'F[C](F)C(F)(F)F(2339)'],
    products = ['[O]OC(F)(F)C(F)(F)F(9273)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[O]C(F)(F)C(F)(F)F(8485)'],
    products = ['[O]OC(F)(F)C(F)(F)F(9273)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[O]O[C](F)C(F)(F)F(2544)'],
    products = ['[O]OC(F)(F)C(F)(F)F(9273)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]OC(F)(F)[C](F)F(2340)'],
    products = ['[O]OC(F)(F)C(F)(F)F(9273)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(3.8422e+07,'m^3/(mol*s)'), n=-0.361029, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['F2(78)', '[O]OC(F)=C(F)F(1076)'],
    products = ['[O]OC(F)(F)C(F)(F)F(9273)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['FOO[C](F)C(F)(F)F(9284)'],
    products = ['[O]OC(F)(F)C(F)(F)F(9273)'],
    transitionState = 'TS9',
...
network(
    ...
    isomers = [
        '[O]OC(F)(F)C(F)(F)F(9273)',
    ],
    reactants = [
        ('O2(2)', 'F[C](F)C(F)(F)F(2339)'),
