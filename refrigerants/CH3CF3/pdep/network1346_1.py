...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC1(F)[CH]O1(3477)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[O]C1(F)[CH]O1(3594)'],
    products = ['[CH2]OC1(F)[CH]O1(3477)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2O(20)', 'F[C]1[CH]O1(1614)'],
    products = ['[CH2]OC1(F)[CH]O1(3477)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2]OC1=CO1(3596)'],
    products = ['[CH2]OC1(F)[CH]O1(3477)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][O](194)', 'F[C]1[CH]O1(1614)'],
    products = ['[CH2]OC1(F)[CH]O1(3477)'],
    transitionState = 'TS8',
