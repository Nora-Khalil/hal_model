...
"""),
    E0 = (-353.332,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3010,987.5,1337.5,450,1655,190,488,555,1236,1407,339.79,339.79,339.792,339.798],'cm^-1')),
        HinderedRotor(inertia=(0.00146004,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202985,'amu*angstrom^2'), symmetry=1, barrier=(16.6315,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202992,'amu*angstrom^2'), symmetry=1, barrier=(16.6315,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0911087,0.0831556,-0.000102155,6.08292e-08,-1.39764e-11,-42352.7,31.6532], Tmin=(100,'K'), Tmax=(1074.39,'K')), NASAPolynomial(coeffs=[18.612,0.0142012,-5.88425e-06,1.09258e-09,-7.62772e-14,-46332.5,-59.0283], Tmin=(1074.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-353.332,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2sCF) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=C(C)OJ) + radical(Csj(Cs-CdHH)(F1s)(F1s))"""),
)

species(
    label = 'O=C(F)[CH]OC[C](F)F(4331)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-474.627,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,323,467,575,827,1418,190,488,555,1236,1407,3010,987.5,1337.5,450,1655,180,535.671,536.869],'cm^-1')),
        HinderedRotor(inertia=(0.0893653,'amu*angstrom^2'), symmetry=1, barrier=(18.2652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.794634,'amu*angstrom^2'), symmetry=1, barrier=(18.2702,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03592,0.0630067,-6.38133e-05,3.17629e-08,-6.25632e-12,-56975.9,26.352], Tmin=(100,'K'), Tmax=(1225.77,'K')), NASAPolynomial(coeffs=[14.8874,0.0178052,-8.49854e-06,1.67812e-09,-1.20343e-13,-60371.6,-43.293], Tmin=(1225.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-474.627,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Csj(Cs-CdHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.03358,'amu*angstrom^2'), symmetry=1, barrier=(23.764,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03573,'amu*angstrom^2'), symmetry=1, barrier=(23.8135,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70613,0.0542026,-7.6133e-05,5.81299e-08,-1.79176e-11,-18087.9,19.9304], Tmin=(100,'K'), Tmax=(791.556,'K')), NASAPolynomial(coeffs=[8.68973,0.0189111,-9.25377e-06,1.80111e-09,-1.26596e-13,-19193.4,-12.1289], Tmin=(791.556,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-151.049,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CJCO)"""),
)
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.564139,0.081862,-0.000114746,8.6308e-08,-2.62535e-11,-107685,26.5355], Tmin=(100,'K'), Tmax=(800.503,'K')), NASAPolynomial(coeffs=[11.26,0.0284167,-1.46001e-05,2.90647e-09,-2.07166e-13,-109398,-22.6861], Tmin=(800.503,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-896.326,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(CdCFF)"""),
)

species(
    label = 'F[C](F)CC1(F)[CH]OO1(4416)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01836,0.0742553,-9.26623e-05,5.48759e-08,-6.93012e-12,-40697.3,26.5265], Tmin=(100,'K'), Tmax=(572.809,'K')), NASAPolynomial(coeffs=[8.51584,0.033733,-1.75355e-05,3.50484e-09,-2.50196e-13,-41750.3,-7.16142], Tmin=(572.809,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-339.2,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCCFO) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCsFFH) + ring(Cs-Cs(F)-O2s-O2s) + radical(CCsJOO) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = '[O]C1(F)[CH]OC(F)(F)C1(4417)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0402667,0.0729988,-7.6183e-05,3.96309e-08,-7.77711e-12,-79332,23.4465], Tmin=(100,'K'), Tmax=(1422.69,'K')), NASAPolynomial(coeffs=[18.29,0.0121164,-1.90027e-06,9.32339e-11,1.60141e-15,-83556.1,-67.6277], Tmin=(1422.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-660.889,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCCFO) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCFFO) + ring(Tetrahydrofuran) + radical(O2sj(Cs-F1sCsCs)) + radical(CCsJOCs)"""),
)

species(
    label = '[O]C1OC1(F)C[C](F)F(4418)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.850858,0.0773367,-0.000118374,1.09245e-07,-4.13611e-11,-64150.2,26.9991], Tmin=(100,'K'), Tmax=(754.039,'K')), NASAPolynomial(coeffs=[6.07515,0.0389461,-2.07642e-05,4.16725e-09,-2.96931e-13,-64634.5,5.28249], Tmin=(754.039,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-534.253,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCCFO) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(CsCsFFH) + ring(Cs(O2)-O2s-Cs(F)) + radical(CCOJ) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-520.337,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,375,552.5,462.5,1710,190,488,555,1236,1407,2782.5,750,1395,475,1775,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.203319,'amu*angstrom^2'), symmetry=1, barrier=(4.6747,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.999821,'amu*angstrom^2'), symmetry=1, barrier=(22.9878,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202717,'amu*angstrom^2'), symmetry=1, barrier=(4.66087,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.744147,0.0816388,-0.000142357,1.32296e-07,-4.74053e-11,-62474.6,25.1472], Tmin=(100,'K'), Tmax=(835.377,'K')), NASAPolynomial(coeffs=[7.07454,0.0313978,-1.63593e-05,3.18669e-09,-2.20657e-13,-62836.8,-0.0924747], Tmin=(835.377,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-520.337,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)H) + radical(Csj(Cs-COHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.268618,'amu*angstrom^2'), symmetry=1, barrier=(6.17605,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.268357,'amu*angstrom^2'), symmetry=1, barrier=(6.17006,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.557652,'amu*angstrom^2'), symmetry=1, barrier=(12.8215,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.657275,0.0847448,-0.000157719,1.46577e-07,-5.13842e-11,-43233.7,26.2788], Tmin=(100,'K'), Tmax=(861.92,'K')), NASAPolynomial(coeffs=[8.03335,0.0262851,-1.38158e-05,2.65897e-09,-1.81192e-13,-43605.2,-2.98966], Tmin=(861.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-360.377,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)H) + radical(Csj(Cs-COHH)(F1s)(F1s)) + radical(CCCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.505412,0.0857038,-0.000123222,8.65411e-08,-2.03881e-11,-76862.7,30.6887], Tmin=(100,'K'), Tmax=(612.712,'K')), NASAPolynomial(coeffs=[11.1892,0.0287527,-1.51251e-05,3.01052e-09,-2.13383e-13,-78412.1,-17.5807], Tmin=(612.712,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-640.049,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsCsHH) + group(CsCsFFH) + group(Cds-OdCsH) + radical(CCJCO) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = 'O=[C]C(O)(F)C[C](F)F(4426)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0669909,0.0982261,-0.000166513,1.44643e-07,-4.88749e-11,-81646,31.0224], Tmin=(100,'K'), Tmax=(826.166,'K')), NASAPolynomial(coeffs=[11.8884,0.0273615,-1.42814e-05,2.78277e-09,-1.92759e-13,-83178.4,-21.6913], Tmin=(826.166,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-679.991,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsCsHH) + group(CsCsFFH) + group(Cds-OdCsH) + radical(Csj(Cs-CsHH)(F1s)(F1s)) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C(F)([C]=O)CC(F)F(4427)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0991404,0.0927884,-0.000148727,1.24593e-07,-4.12193e-11,-76455.4,29.8466], Tmin=(100,'K'), Tmax=(798.34,'K')), NASAPolynomial(coeffs=[12.1427,0.0266517,-1.35765e-05,2.64316e-09,-1.83993e-13,-78193.8,-24.3876], Tmin=(798.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-636.799,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFFH) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C=C(C[C](F)F)OF(4428)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-349.674,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,190,488,555,1236,1407,3010,987.5,1337.5,450,1655,327.455,327.539,327.68,327.718],'cm^-1')),
        HinderedRotor(inertia=(0.00156736,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.292042,'amu*angstrom^2'), symmetry=1, barrier=(22.2672,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.291587,'amu*angstrom^2'), symmetry=1, barrier=(22.2657,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.12444,0.0802833,-9.15401e-05,5.0071e-08,-1.05795e-11,-41912.3,31.443], Tmin=(100,'K'), Tmax=(1164.57,'K')), NASAPolynomial(coeffs=[19.4274,0.0139818,-6.1408e-06,1.18304e-09,-8.44775e-14,-46408.1,-64.6233], Tmin=(1164.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-349.674,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Csj(Cs-CdHH)(F1s)(F1s))"""),
)

species(
    label = '[O]C=C([O])CC(F)(F)F(4429)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.263351,0.0800811,-8.92403e-05,4.67672e-08,-9.22919e-12,-98205.8,30.5483], Tmin=(100,'K'), Tmax=(1352.1,'K')), NASAPolynomial(coeffs=[22.5821,0.00659228,-1.16339e-06,1.10612e-10,-5.40845e-15,-103844,-84.5637], Tmin=(1352.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-817.902,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFF) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=C(C)OJ) + radical(C=COJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(C=O)C[C](F)F(4330)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[O]C(F)C[C](F)F(4412)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C(=COF)C[C](F)F(4413)'],
    products = ['[O]C(F)(C=O)C[C](F)F(4330)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)(C=O)C[C](F)F(4330)'],
    products = ['O=C(F)[CH]OC[C](F)F(4331)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[O]C=C(F)C[C](F)F(4047)'],
    products = ['[O]C(F)(C=O)C[C](F)F(4330)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[C]F(138)', '[CH2]C([O])(F)C=O(4414)'],
    products = ['[O]C(F)(C=O)C[C](F)F(4330)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)(C=O)C[C](F)F(4330)'],
    products = ['O=CC(O)(F)C=C(F)F(4415)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)(C=O)C[C](F)F(4330)'],
    products = ['F[C](F)CC1(F)[CH]OO1(4416)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(F)(C=O)C[C](F)F(4330)'],
    products = ['[O]C1(F)[CH]OC(F)(F)C1(4417)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(F)(C=O)C[C](F)F(4330)'],
    products = ['[O]C1OC1(F)C[C](F)F(4418)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'O=CC(=O)C[C](F)F(4420)'],
    products = ['[O]C(F)(C=O)C[C](F)F(4330)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HCO(15)', 'O=C(F)C[C](F)F(269)'],
    products = ['[O]C(F)(C=O)C[C](F)F(4330)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C(F)(C=O)C=C(F)F(4421)'],
    products = ['[O]C(F)(C=O)C[C](F)F(4330)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', '[O]C=C([O])C=C(F)F(4422)'],
    products = ['[O]C(F)(C=O)C[C](F)F(4330)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'O=[C]C(=O)C[C](F)F(4423)'],
    products = ['[O]C(F)(C=O)C[C](F)F(4330)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CF2(43)', '[CH2]C([O])(F)C=O(4414)'],
    products = ['[O]C(F)(C=O)C[C](F)F(4330)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O]C(F)(C=O)C[C](F)F(4330)'],
    products = ['O=CC(O)(F)[CH][C](F)F(4425)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C(F)(C=O)C[C](F)F(4330)'],
    products = ['O=[C]C(O)(F)C[C](F)F(4426)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[O]C(F)(C=O)C[C](F)F(4330)'],
    products = ['[O]C(F)([C]=O)CC(F)F(4427)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[O]C=C(C[C](F)F)OF(4428)'],
    products = ['[O]C(F)(C=O)C[C](F)F(4330)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[O]C(F)(C=O)C[C](F)F(4330)'],
    products = ['[O]C=C([O])CC(F)(F)F(4429)'],
...
network(
    label = 'PDepNetwork #1452',
    isomers = [
        '[O]C(F)(C=O)C[C](F)F(4330)',
    ],
    reactants = [
