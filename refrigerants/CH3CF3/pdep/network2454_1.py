...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'CC(=O)OF(1438)'],
    products = ['CC(=O)C(=O)OF(8701)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'CC(=O)C([O])=O(2731)'],
    products = ['CC(=O)C(=O)OF(8701)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(127)', 'CC(=O)[C]=O(9174)'],
    products = ['CC(=O)C(=O)OF(8701)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(19)', 'O=[C]C(=O)OF(2174)'],
    products = ['CC(=O)C(=O)OF(8701)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(=O)C(=O)OF(9175)'],
    products = ['CC(=O)C(=O)OF(8701)'],
