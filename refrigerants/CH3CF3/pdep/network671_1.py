...
reaction(
    label = 'reaction3',
    reactants = ['C#COF(6110)', 'C[C]F(325)'],
    products = ['C#COC(C)(F)F(1645)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'C#CO[C](C)F(10947)'],
    products = ['C#COC(C)(F)F(1645)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(19)', 'C#CO[C](F)F(539)'],
    products = ['C#COC(C)(F)F(1645)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C#COC([CH2])(F)F(1704)'],
    products = ['C#COC(C)(F)F(1645)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[C]#COC(C)(F)F(10948)'],
    products = ['C#COC(C)(F)F(1645)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'C#COC(=C)F(5742)'],
    products = ['C#COC(C)(F)F(1645)'],
