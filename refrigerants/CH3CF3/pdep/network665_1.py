...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[C]=C(1645)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(999)', '[CH2]C([O])(F)F(162)'],
    products = ['[CH2]C(F)(F)O[C]=C(1645)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=[C]O[C](F)F(1711)'],
    products = ['[CH2]C(F)(F)O[C]=C(1645)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=[C]OC(=C)F(1712)'],
    products = ['[CH2]C(F)(F)O[C]=C(1645)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#COC([CH2])(F)F(1713)'],
    products = ['[CH2]C(F)(F)O[C]=C(1645)'],
    transitionState = 'TS8',
