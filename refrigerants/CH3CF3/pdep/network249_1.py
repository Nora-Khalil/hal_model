...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(F)[CH]F(800)'],
    products = ['O=O(161)', 'CHFCHF[Z](59)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(F)[CH]F(839)'],
    products = ['[O]OC(F)[CH]F(800)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', '[O]O[CH]F(877)'],
    products = ['[O]OC(F)[CH]F(800)'],
    transitionState = 'TS3',
