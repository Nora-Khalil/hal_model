...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(138)', '[O]C([O])=O(790)'],
    products = ['[O]C(=O)O[C](F)F(779)'],
    transitionState = 'TS2',
