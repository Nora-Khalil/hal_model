...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(F)[C]=C(F)F(3188)'],
    products = ['[O]OC(F)[C]=C(F)F(2995)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[CH]F(893)', '[C]=C(F)F(1205)'],
    products = ['[O]OC(F)[C]=C(F)F(2995)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]OC=C=C(F)F(3912)'],
    products = ['[O]OC(F)[C]=C(F)F(2995)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]OC(F)=C=C(F)F(3913)'],
    products = ['[O]OC(F)[C]=C(F)F(2995)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]OC(F)C#CF(3914)'],
    products = ['[O]OC(F)[C]=C(F)F(2995)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]OC(F)[C]=C(F)F(2995)'],
    products = ['OH(7)', 'O=C(F)[C]=C(F)F(3916)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]OC(F)[C]=C(F)F(2995)'],
    products = ['[O]O[CH]C(F)=C(F)F(3918)'],
