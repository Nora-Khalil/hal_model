...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31328,0.0681404,-0.000116851,1.10535e-07,-4.03042e-11,-21875.2,22.7031], Tmin=(100,'K'), Tmax=(839.34,'K')), NASAPolynomial(coeffs=[5.1916,0.0305691,-1.55933e-05,3.01311e-09,-2.07857e-13,-21853.9,8.6772], Tmin=(839.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.613,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-OsHHH) + group(Cds-OdCsH) + radical(CsCOF1sO2s) + radical(COj(Cs-F1sO2sH)(O2d))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0230437,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.58671,'amu*angstrom^2'), symmetry=1, barrier=(36.4817,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31921,0.0456241,-2.91851e-05,-5.06907e-08,7.15383e-11,27547.8,18.9217], Tmin=(100,'K'), Tmax=(454.021,'K')), NASAPolynomial(coeffs=[6.47534,0.0248743,-1.30513e-05,2.59002e-09,-1.82933e-13,27006.9,0.35155], Tmin=(454.021,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(228.618,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-OsHHH) + group(CdCFO) + group(Cds-CdsHH) + radical(CsJOOC) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55348,0.0607005,-9.62607e-05,8.94341e-08,-3.30912e-11,-5558.35,22.1057], Tmin=(100,'K'), Tmax=(802.433,'K')), NASAPolynomial(coeffs=[5.32528,0.0296091,-1.51679e-05,2.97553e-09,-2.08464e-13,-5768.01,7.20448], Tmin=(802.433,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-46.8916,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(CsCCFO) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Cs-Cs(F)-O2s-O2s) + radical(CCOJ) + radical(CCsJOH)"""),
)
...
"""),
    E0 = (-84.1518,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,548,1085,1183,1302,1466,1520,3060,3119,3010,987.5,1337.5,450,1655,1685,370,195.07,195.342],'cm^-1')),
        HinderedRotor(inertia=(0.914405,'amu*angstrom^2'), symmetry=1, barrier=(24.8146,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.937489,'amu*angstrom^2'), symmetry=1, barrier=(24.8214,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.928379,'amu*angstrom^2'), symmetry=1, barrier=(24.8547,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30914,0.0557938,-5.7154e-05,2.87934e-08,-5.69875e-12,-10021.4,27.1798], Tmin=(100,'K'), Tmax=(1228.11,'K')), NASAPolynomial(coeffs=[14.0749,0.0142149,-6.36959e-06,1.22547e-09,-8.68444e-14,-13156.9,-37.0307], Tmin=(1228.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-84.1518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsFHHO) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]O[O](175)', 'O=C[C]F(4375)'],
    products = ['[CH2]OO[C](F)C=O(4313)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]O[C](F)C=O(1336)'],
    products = ['[CH2]OO[C](F)C=O(4313)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]OO[C](F)C=O(4313)'],
    products = ['[CH2]OOC1(F)[CH]O1(4583)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]O[O](175)', 'O=C[C]F-2(1215)'],
    products = ['[CH2]OO[C](F)C=O(4313)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O(6)', '[CH]=C(F)OO[CH2](4589)'],
    products = ['[CH2]OO[C](F)C=O(4313)'],
