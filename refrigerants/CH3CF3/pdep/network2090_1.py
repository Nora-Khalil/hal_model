...
species(
    label = '[O]C(F)[CH]C(F)(F)C(F)F(7167)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-926.08,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,235,523,627,1123,1142,1372,1406,3097,391,562,707,872,1109,1210,1289,3137,3025,407.5,1350,352.5,251.312,251.314,1449.83],'cm^-1')),
        HinderedRotor(inertia=(0.17511,'amu*angstrom^2'), symmetry=1, barrier=(7.84816,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175108,'amu*angstrom^2'), symmetry=1, barrier=(7.84818,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.17511,'amu*angstrom^2'), symmetry=1, barrier=(7.84817,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0122107,0.0945433,-0.000137203,1.05191e-07,-3.2307e-11,-111244,32.4479], Tmin=(100,'K'), Tmax=(796.029,'K')), NASAPolynomial(coeffs=[12.8977,0.0297927,-1.51875e-05,3.00197e-09,-2.12679e-13,-113296,-26.7776], Tmin=(796.029,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-926.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + radical(O2sj(Cs-CsF1sH)) + radical(CCJCO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.391426,'amu*angstrom^2'), symmetry=1, barrier=(8.99964,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.079983,'amu*angstrom^2'), symmetry=1, barrier=(33.0005,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63842,0.0497956,-4.44198e-05,1.94024e-08,-3.37793e-12,-57927.1,23.2144], Tmin=(100,'K'), Tmax=(1365.65,'K')), NASAPolynomial(coeffs=[12.9987,0.0165213,-7.87205e-06,1.56099e-09,-1.11824e-13,-61029.9,-35.1325], Tmin=(1365.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-482.353,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sO2sH)(Cs-F1sF1sH)(H))"""),
)
...
"""),
    ...
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0866529,0.0937178,-0.000138721,1.11178e-07,-3.60671e-11,-144825,29.4775], Tmin=(100,'K'), Tmax=(751.963,'K')), NASAPolynomial(coeffs=[11.5368,0.0328053,-1.72049e-05,3.43792e-09,-2.44854e-13,-146547,-22.4979], Tmin=(751.963,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1205.26,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFHO) + group(CsCFFH) + group(Cds-CdsCsCs) + group(CdCFF)"""),
)

species(
    label = 'O=C(F)C(C(F)F)C(F)F(7122)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {9,S}
...
species(
    label = '[O]C(F)C(=C(F)F)C(F)F(7169)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-978.038,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([361,769,965,1078,1132,1246,3247,171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,182,240,577,636,1210,1413,252.497,252.66,2612.71],'cm^-1')),
        HinderedRotor(inertia=(0.212397,'amu*angstrom^2'), symmetry=1, barrier=(9.68173,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.757511,'amu*angstrom^2'), symmetry=1, barrier=(34.3778,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.41865,0.0858551,-0.000122176,9.3495e-08,-2.90165e-11,-117508,29.1339], Tmin=(100,'K'), Tmax=(784.039,'K')), NASAPolynomial(coeffs=[11.2968,0.0303578,-1.60013e-05,3.21616e-09,-2.30363e-13,-119214,-20.7003], Tmin=(784.039,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-978.038,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFHO) + group(CsCFFH) + group(Cds-CdsCsCs) + group(CdCFF) + radical(O2sj(Cs-F1sCdH))"""),
)
...
species(
    label = 'O=C(F)C([C](F)F)C(F)F(6987)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = '[O]C(F)[C](C(F)F)C(F)F(7170)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
5  F u0 p3 c0 {9,S}
6  O u1 p2 c0 {8,S}
7  C u0 p0 c0 {1,S} {2,S} {10,S} {12,S}
...
"""),
    ...
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.37562,0.0858333,-0.000107773,7.17271e-08,-1.94024e-11,-117792,29.0827], Tmin=(100,'K'), Tmax=(893.763,'K')), NASAPolynomial(coeffs=[12.6099,0.0310786,-1.58774e-05,3.18044e-09,-2.28603e-13,-119978,-28.5663], Tmin=(893.763,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-980.417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(CsCFHO) + group(CsCsFFH) + group(CsCsFFH) + radical(O2sj(Cs-CsF1sH)) + radical(CCJ(C)CO)"""),
)

species(
    label = 'O[C](F)C([C](F)F)C(F)F(7171)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = '[O][C](F)C(C(F)F)C(F)F(7172)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.343236,0.105031,-0.000175241,1.52729e-07,-5.20451e-11,-112721,32.2482], Tmin=(100,'K'), Tmax=(821.048,'K')), NASAPolynomial(coeffs=[11.7505,0.03216,-1.6621e-05,3.23695e-09,-2.24592e-13,-114236,-20.8488], Tmin=(821.048,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-938.436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(CsCFHO) + group(CsCsFFH) + group(CsCsFFH) + radical(O2sj(Cs-CsF1sH)) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'OC(F)[C]([C](F)F)C(F)F(7173)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.184951,0.0906934,-0.000120876,8.45761e-08,-2.38905e-11,-121103,31.0181], Tmin=(100,'K'), Tmax=(859.764,'K')), NASAPolynomial(coeffs=[13.1127,0.0305478,-1.59418e-05,3.20961e-09,-2.30907e-13,-123326,-29.3974], Tmin=(859.764,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1008,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(CsCFHO) + group(CsCsFFH) + group(CsCsFFH) + radical(CCJ(C)CO) + radical(Csj(Cs-CsCsH)(F1s)(F1s))"""),
)

species(
    label = 'OC(F)C([C](F)F)[C](F)F(7174)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.146077,0.0996267,-0.000150517,1.16608e-07,-3.49453e-11,-115511,32.7776], Tmin=(100,'K'), Tmax=(673.322,'K')), NASAPolynomial(coeffs=[13.0845,0.0300778,-1.57391e-05,3.12387e-09,-2.21012e-13,-117497,-27.3424], Tmin=(673.322,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-961.586,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(CsCFHO) + group(CsCsFFH) + group(CsCsFFH) + radical(Csj(Cs-CsCsH)(F1s)(F1s)) + radical(Csj(Cs-CsCsH)(F1s)(F1s))"""),
)
...
species(
    label = 'FO[CH]C([C](F)F)C(F)F(7177)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-616.636,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,3025,407.5,1350,352.5,190,488,555,1236,1407,380.692,381.771,382.761,382.929],'cm^-1')),
        HinderedRotor(inertia=(0.114561,'amu*angstrom^2'), symmetry=1, barrier=(11.8655,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105002,'amu*angstrom^2'), symmetry=1, barrier=(10.8836,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10446,'amu*angstrom^2'), symmetry=1, barrier=(10.8793,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.30329,'amu*angstrom^2'), symmetry=1, barrier=(31.2354,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.563277,0.107825,-0.000166476,1.3049e-07,-4.03465e-11,-74006.7,33.7017], Tmin=(100,'K'), Tmax=(794.97,'K')), NASAPolynomial(coeffs=[15.4732,0.0271372,-1.42346e-05,2.82312e-09,-1.99551e-13,-76556.5,-39.9862], Tmin=(794.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-616.636,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CsCsFFH) + radical(CCsJO) + radical(Csj(Cs-CsCsH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', '[O]C(F)C[C](F)F(4412)'],
    products = ['[O]C(F)C([C](F)F)C(F)F(6774)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.33604e-10,'m^3/(mol*s)'), n=4.72997, Ea=(125.609,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', '[O]C(F)C(F)[C](F)F(4544)'],
    products = ['[O]C(F)C([C](F)F)C(F)F(6774)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(4.96165e-06,'m^3/(mol*s)'), n=3.30609, Ea=(136.218,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['[O]C(F)[CH]C(F)(F)C(F)F(7167)'],
    products = ['[O]C(F)C([C](F)F)C(F)F(6774)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C]F(138)', '[O]C(F)[CH]C(F)F(5622)'],
    products = ['[O]C(F)C([C](F)F)C(F)F(6774)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O(6)', 'F[CH]C([C](F)F)C(F)F(6947)'],
    products = ['[O]C(F)C([C](F)F)C(F)F(6774)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)C([C](F)F)C(F)F(6774)'],
    products = ['FC(F)C1C(F)OC1(F)F(6777)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)C([C](F)F)C(F)F(6774)'],
    products = ['OC(F)C(=C(F)F)C(F)F(7168)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)C([C](F)F)C(F)F(6774)'],
    products = ['O=C(F)C(C(F)F)C(F)F(7122)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF2(82)', '[O]C(F)C=C(F)F(5621)'],
    products = ['[O]C(F)C([C](F)F)C(F)F(6774)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(13.3537,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(53.2359,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)

reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'O=C(F)C([C](F)F)C(F)F(6987)'],
    products = ['[O]C(F)C([C](F)F)C(F)F(6774)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(15.9,'m^3/(mol*s)'), n=1.84, Ea=(33.5498,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->H_N-2R!H->N_N-1R!H->N_2COS->O_Ext-1COS-R_Ext-1COS-R_Ext-5R!H-R_N-Sp-6R!H=5R!H',), comment="""Estimated from node Root_3R->H_N-2R!H->N_N-1R!H->N_2COS->O_Ext-1COS-R_Ext-1COS-R_Ext-5R!H-R_N-Sp-6R!H=5R!H"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(207.798,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction19',
    reactants = ['HF(38)', '[O]C=C([C](F)F)C(F)F(5860)'],
    products = ['[O]C(F)C([C](F)F)C(F)F(6774)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(295.867,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction20',
    reactants = ['CF2(43)', '[O]C(F)[CH]C(F)F(5622)'],
    products = ['[O]C(F)C([C](F)F)C(F)F(6774)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C(F)C([C](F)F)C(F)F(6774)'],
    products = ['[O]C(F)[C](C(F)F)C(F)F(7170)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(F)C([C](F)F)C(F)F(6774)'],
    products = ['O[C](F)C([C](F)F)C(F)F(7171)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]C(F)C([C](F)F)C(F)F(6774)'],
    products = ['[O][C](F)C(C(F)F)C(F)F(7172)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O]C(F)C([C](F)F)C(F)F(6774)'],
    products = ['OC(F)[C]([C](F)F)C(F)F(7173)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C(F)C([C](F)F)C(F)F(6774)'],
    products = ['OC(F)C([C](F)F)[C](F)F(7174)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(74.2819,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)
...
reaction(
    label = 'reaction28',
    reactants = ['FO[CH]C([C](F)F)C(F)F(7177)'],
    products = ['[O]C(F)C([C](F)F)C(F)F(6774)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[O]C(F)C([C](F)F)C(F)F(6774)'],
    products = ['[O][CH]C(C(F)F)C(F)(F)F(7178)'],
    transitionState = 'TS29',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(213.903,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

network(
    label = 'PDepNetwork #2090',
    isomers = [
        '[O]C(F)C([C](F)F)C(F)F(6774)',
    ],
    reactants = [
