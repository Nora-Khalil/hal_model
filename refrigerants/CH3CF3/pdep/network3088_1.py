...
species(
    label = 'F[CH]C[CH]C(F)(F)C(F)F(10303)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (160.085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.506661,0.109989,-0.000179355,1.60154e-07,-5.65516e-11,-95222.4,34.9008], Tmin=(100,'K'), Tmax=(805.735,'K')), NASAPolynomial(coeffs=[9.92092,0.0417373,-2.16051e-05,4.23916e-09,-2.96418e-13,-96367.7,-9.83331], Tmin=(805.735,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-792.986,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsCsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFHH) + radical(Cs_S) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.179353,'amu*angstrom^2'), symmetry=1, barrier=(4.12369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.178265,'amu*angstrom^2'), symmetry=1, barrier=(4.09866,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.177548,'amu*angstrom^2'), symmetry=1, barrier=(4.08218,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.078,'amu'),
...
"""),
    ...
    molecularWeight = (160.085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.314687,0.0881094,-0.000104681,6.94809e-08,-1.92205e-11,-123898,29.65], Tmin=(100,'K'), Tmax=(865.839,'K')), NASAPolynomial(coeffs=[10.9613,0.0389248,-1.94736e-05,3.8743e-09,-2.77559e-13,-125742,-20.18], Tmin=(865.839,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1031.2,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(CsCFFH) + group(Cds-CdsCsCs) + group(CdCFF)"""),
)

species(
    label = 'FC=CC(C(F)F)C(F)F(10306)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (160.085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.187684,0.0873742,-9.45533e-05,5.36318e-08,-1.23765e-11,-127444,29.3853], Tmin=(100,'K'), Tmax=(1039.08,'K')), NASAPolynomial(coeffs=[14.3555,0.0328343,-1.58204e-05,3.11739e-09,-2.22889e-13,-130388,-39.5095], Tmin=(1039.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1060.75,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(CsCsFFH) + group(CsCsFFH) + group(Cds-CdsCsH) + group(CdCFH)"""),
)
...
species(
    label = 'F[CH]CC(=C(F)F)C(F)F(10307)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-837.468,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,334,575,1197,1424,3202,182,240,577,636,1210,1413,343.598,344.788,2232.57],'cm^-1')),
        HinderedRotor(inertia=(0.147215,'amu*angstrom^2'), symmetry=1, barrier=(12.3214,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00146677,'amu*angstrom^2'), symmetry=1, barrier=(0.121199,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.419355,'amu*angstrom^2'), symmetry=1, barrier=(35.2265,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (159.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.281175,0.0890429,-0.000115563,8.31052e-08,-2.46269e-11,-100597,31.0407], Tmin=(100,'K'), Tmax=(815.016,'K')), NASAPolynomial(coeffs=[11.0284,0.0362935,-1.84743e-05,3.68386e-09,-2.63579e-13,-102348,-18.6096], Tmin=(815.016,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-837.468,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(CsCFFH) + group(Cds-CdsCsCs) + group(CdCFF) + radical(Csj(Cs-CdHH)(F1s)(H))"""),
)
...
species(
    label = 'F[CH]C[C](C(F)F)C(F)F(10309)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (160.085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.543138,0.114041,-0.000198071,1.84395e-07,-6.61997e-11,-96761.5,33.8424], Tmin=(100,'K'), Tmax=(836.013,'K')), NASAPolynomial(coeffs=[8.00569,0.0448659,-2.32269e-05,4.51698e-09,-3.12571e-13,-97202.8,0.0394416], Tmin=(836.013,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-805.767,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(CsCsFFH) + group(CsCsFFH) + group(CsCsFHH) + radical(Tertalkyl) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)
...
species(
    label = 'F[CH][CH]C(C(F)F)C(F)F(10311)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (160.085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.341924,0.104201,-0.000158154,1.34703e-07,-4.66337e-11,-95666.6,34.5464], Tmin=(100,'K'), Tmax=(752.866,'K')), NASAPolynomial(coeffs=[10.7165,0.0403596,-2.08216e-05,4.1197e-09,-2.91112e-13,-97187.5,-14.7075], Tmin=(752.866,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-796.648,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(CsCsFFH) + group(CsCsFFH) + group(CsCsFHH) + radical(Cs_S) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)

species(
    label = 'FCC[C]([C](F)F)C(F)F(10312)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (160.085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.407201,0.110191,-0.000188052,1.74383e-07,-6.26948e-11,-95937.7,34.3674], Tmin=(100,'K'), Tmax=(831.398,'K')), NASAPolynomial(coeffs=[7.81715,0.044663,-2.29919e-05,4.47224e-09,-3.09956e-13,-96408.1,1.60387], Tmin=(831.398,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-798.884,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(CsCsFFH) + group(CsCsFFH) + group(CsCsFHH) + radical(Tertalkyl) + radical(Csj(Cs-CsCsH)(F1s)(F1s))"""),
)

species(
    label = 'FCCC([C](F)F)[C](F)F(10313)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
8  C u0 p0 c0 {1,S} {7,S} {14,S} {15,S}
...
"""),
    E0 = (-785.318,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,146,234,414,562,504,606,1176,1296,1354,1460,294.791,295.155,295.158,295.289],'cm^-1')),
        HinderedRotor(inertia=(0.130475,'amu*angstrom^2'), symmetry=1, barrier=(8.07379,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00193123,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130211,'amu*angstrom^2'), symmetry=1, barrier=(8.07391,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.364496,'amu*angstrom^2'), symmetry=1, barrier=(22.5203,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (160.085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.255705,0.101359,-0.000145751,1.16127e-07,-3.76389e-11,-94305.9,33.4697], Tmin=(100,'K'), Tmax=(751.806,'K')), NASAPolynomial(coeffs=[11.6826,0.0378389,-1.90108e-05,3.73581e-09,-2.63706e-13,-96100.9,-20.7193], Tmin=(751.806,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-785.318,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(CsCsFFH) + group(CsCsFFH) + group(CsCsFHH) + radical(Csj(Cs-CsCsH)(F1s)(F1s)) + radical(Csj(Cs-CsCsH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'F[CH]CC[C](F)F(10140)'],
    products = ['F[CH]CC([C](F)F)C(F)F(10238)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.33604e-10,'m^3/(mol*s)'), n=4.72997, Ea=(129.33,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'F[CH]CC(F)[C](F)F(10228)'],
    products = ['F[CH]CC([C](F)F)C(F)F(10238)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(4.96165e-06,'m^3/(mol*s)'), n=3.30609, Ea=(141.523,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['F[CH]CC([C](F)F)C(F)F(10238)'],
    products = ['F[CH]C[CH]C(F)(F)C(F)F(10303)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(6.55606e+10,'s^-1'), n=0.64, Ea=(159.935,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [cCs(-HC)CJ;CsJ;C]
Euclidian distance = 0
family: 1,2_shiftC"""),
...
reaction(
    label = 'reaction7',
    reactants = ['F[C]F(138)', 'F[CH]C[CH]C(F)F(10154)'],
    products = ['F[CH]CC([C](F)F)C(F)F(10238)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]F(804)', '[CH2]C([C](F)F)C(F)F(6803)'],
    products = ['F[CH]CC([C](F)F)C(F)F(10238)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F[CH]CC([C](F)F)C(F)F(10238)'],
    products = ['FCCC(=C(F)F)C(F)F(10305)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F[CH]CC([C](F)F)C(F)F(10238)'],
    products = ['FC=CC(C(F)F)C(F)F(10306)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(14.9721,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)

reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'FC=CC([C](F)F)C(F)F(6967)'],
    products = ['F[CH]CC([C](F)F)C(F)F(10238)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(208.694,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction19',
    reactants = ['CF2(43)', 'F[CH]C[CH]C(F)F(10154)'],
    products = ['F[CH]CC([C](F)F)C(F)F(10238)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(0.00976185,'m^3/(mol*s)'), n=2.64543, Ea=(2.36915,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.24524072153041726, var=3.368891203868511, Tref=1000.0, N=3, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s"""),
)

reaction(
    label = 'reaction20',
    reactants = ['CHF(40)', '[CH2]C([C](F)F)C(F)F(6803)'],
    products = ['F[CH]CC([C](F)F)C(F)F(10238)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[CH]CC([C](F)F)C(F)F(10238)'],
    products = ['F[CH]C[C](C(F)F)C(F)F(10309)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[CH]CC([C](F)F)C(F)F(10238)'],
    products = ['FC[CH]C([C](F)F)C(F)F(10310)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F[CH]CC([C](F)F)C(F)F(10238)'],
    products = ['F[CH][CH]C(C(F)F)C(F)F(10311)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F[CH]CC([C](F)F)C(F)F(10238)'],
    products = ['FCC[C]([C](F)F)C(F)F(10312)'],
...
reaction(
    label = 'reaction25',
    reactants = ['FCCC([C](F)F)[C](F)F(10313)'],
    products = ['F[CH]CC([C](F)F)C(F)F(10238)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.00726632,'s^-1'), n=4.43046, Ea=(242.06,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R4F_Ext-3R!H-R',), comment="""Estimated from node R4F_Ext-3R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)
