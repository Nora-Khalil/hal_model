...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)OF(1866)', 'CH3(19)'],
    products = ['COC(=O)OF(2052)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]OC(=O)OF(2061)'],
    products = ['COC(=O)OF(2052)'],
    transitionState = 'TS9',
