...
"""),
    E0 = (-511.724,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,3025,407.5,1350,352.5,334,575,1197,1424,3202,217.505,4000],'cm^-1')),
        HinderedRotor(inertia=(0.309851,'amu*angstrom^2'), symmetry=1, barrier=(10.4046,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11253,'amu*angstrom^2'), symmetry=1, barrier=(37.3512,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11232,'amu*angstrom^2'), symmetry=1, barrier=(37.3514,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.857773,0.074859,-0.000121338,1.0223e-07,-3.38968e-11,-61438.6,23.9265], Tmin=(100,'K'), Tmax=(797.251,'K')), NASAPolynomial(coeffs=[10.7174,0.0206535,-1.04385e-05,2.04196e-09,-1.42637e-13,-62860.1,-20.462], Tmin=(797.251,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-511.724,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(O2s-H)(H)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = '[O][CH]C(F)(F)CF(1166)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-157.399,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,212,367,445,1450,334,575,1197,1424,3202,267.96,277.221,278.412],'cm^-1')),
        HinderedRotor(inertia=(0.127857,'amu*angstrom^2'), symmetry=1, barrier=(6.65088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117256,'amu*angstrom^2'), symmetry=1, barrier=(6.65904,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.414904,'amu*angstrom^2'), symmetry=1, barrier=(22.9038,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.695109,0.0821332,-0.000147899,1.3579e-07,-4.79109e-11,-18820.8,23.3114], Tmin=(100,'K'), Tmax=(828.053,'K')), NASAPolynomial(coeffs=[8.94993,0.0251311,-1.36168e-05,2.70176e-09,-1.88804e-13,-19600.8,-11.4105], Tmin=(828.053,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-157.399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-O2sHH)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = '[O]C[C](F)C(F)F(1147)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-453.61,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,522,611,926,1093,1137,1374,1416,3112,212,367,445,1450,180,180,1617.62],'cm^-1')),
        HinderedRotor(inertia=(0.374715,'amu*angstrom^2'), symmetry=1, barrier=(8.61543,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.373012,'amu*angstrom^2'), symmetry=1, barrier=(8.57628,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28571,0.0732263,-0.000142192,1.45511e-07,-5.55146e-11,-54472.1,23.1719], Tmin=(100,'K'), Tmax=(841.545,'K')), NASAPolynomial(coeffs=[2.62209,0.0355335,-1.91434e-05,3.77892e-09,-2.62989e-13,-53587.2,23.5489], Tmin=(841.545,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-453.61,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-O2sHH)(Cs-F1sF1sH)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]CC(F)(F)[CH]F(994)'],
    products = ['CH2O(20)', 'CHFCF2(55)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]CC(F)[C](F)F(995)'],
    products = ['[O]CC(F)(F)[CH]F(994)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(804)', '[O]C[C](F)F(174)'],
    products = ['[O]CC(F)(F)[CH]F(994)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C(F)(F)[CH]F(817)'],
    products = ['[O]CC(F)(F)[CH]F(994)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2O(20)', 'F[CH][C](F)F(588)'],
    products = ['[O]CC(F)(F)[CH]F(994)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=CC(F)(F)[CH]F(1163)'],
    products = ['[O]CC(F)(F)[CH]F(994)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][O](194)', 'F[CH][C](F)F(588)'],
    products = ['[O]CC(F)(F)[CH]F(994)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[O]C=C(F)[CH]F(1164)'],
    products = ['[O]CC(F)(F)[CH]F(994)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', '[O]C[C](F)F(174)'],
    products = ['[O]CC(F)(F)[CH]F(994)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[CH]C(F)(F)[CH]F(1165)'],
    products = ['[O]CC(F)(F)[CH]F(994)'],
