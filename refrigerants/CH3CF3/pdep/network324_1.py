...
reaction(
    label = 'reaction2',
    reactants = ['O[C](F)F(206)', 'CH2(S)(25)'],
    products = ['CO[C](F)F(672)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['CO[C](F)F(672)'],
    products = ['[CH2]OC(F)F(690)'],
    transitionState = 'TS9',
