...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.961166,'amu*angstrom^2'), symmetry=1, barrier=(22.0991,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.961482,'amu*angstrom^2'), symmetry=1, barrier=(22.1064,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.961581,'amu*angstrom^2'), symmetry=1, barrier=(22.1086,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.1418,'amu*angstrom^2'), symmetry=1, barrier=(26.2521,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (69.0818,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94076,0.0331742,6.9762e-06,-4.18005e-08,2.10943e-11,26173.6,18.8341], Tmin=(100,'K'), Tmax=(926.552,'K')), NASAPolynomial(coeffs=[15.3008,0.00670174,-6.83355e-07,5.75507e-11,-6.82173e-15,22358.4,-51.8291], Tmin=(926.552,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(216.91,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C[O](623)', '[CH]C-2(978)'],
    products = ['[CH]=CO[CH]C(11064)'],
    transitionState = 'TS2',
