...
"""),
    E0 = (-1022.42,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,482,664,788,1296,1923,180,180,180,786.482],'cm^-1')),
        HinderedRotor(inertia=(1.92963,'amu*angstrom^2'), symmetry=1, barrier=(44.366,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.92885,'amu*angstrom^2'), symmetry=1, barrier=(44.348,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0213292,'amu*angstrom^2'), symmetry=1, barrier=(44.3449,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3764,0.0715672,-0.000142406,1.50481e-07,-5.95196e-11,-122888,23.9316], Tmin=(100,'K'), Tmax=(819.588,'K')), NASAPolynomial(coeffs=[1.63361,0.0380309,-2.19476e-05,4.44109e-09,-3.14002e-13,-121846,29.3562], Tmin=(819.588,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1022.42,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2s-CsH) + group(CsFOOO) + group(COFOO) + radical(OCOJ)"""),
)
...
"""),
    ...
    molecularWeight = (127.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46237,0.0408543,5.22904e-06,-5.49531e-08,3.0283e-11,-89613.3,21.5455], Tmin=(100,'K'), Tmax=(886.712,'K')), NASAPolynomial(coeffs=[19.893,-0.000439594,4.2923e-06,-1.02513e-09,7.26255e-14,-94527,-74.4325], Tmin=(886.712,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-745.965,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(CsFOOO) + group(CsFHOO) + ring(124trioxolane) + radical(CsF1sO2sO2s)"""),
)

species(
    label = '[O]C1(F)OC(O)(F)O1(11269)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {8,S}
3 O u0 p2 c0 {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (127.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01096,0.0645135,-0.000148237,1.78965e-07,-7.60354e-11,-114418,20.4527], Tmin=(100,'K'), Tmax=(831.405,'K')), NASAPolynomial(coeffs=[-7.08594,0.053894,-3.09557e-05,6.24234e-09,-4.39837e-13,-111026,73.9646], Tmin=(831.405,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-951.756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(CsFOOO) + group(CsFOOO) + ring(O2s-Cs-O2s-Cs(F)) + radical(OCOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.524498,'amu*angstrom^2'), symmetry=1, barrier=(12.0592,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.523445,'amu*angstrom^2'), symmetry=1, barrier=(12.035,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93424,0.0478336,-6.87281e-05,4.70907e-08,-1.25299e-11,-111768,21.2342], Tmin=(100,'K'), Tmax=(925.166,'K')), NASAPolynomial(coeffs=[11.0591,0.00838021,-4.75863e-06,9.93178e-10,-7.29084e-14,-113456,-22.0781], Tmin=(925.166,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-929.893,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(COFOO) + group(COFOO)"""),
)
...
"""),
    E0 = (-603.368,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,1855,455,950,180,180,720.355],'cm^-1')),
        HinderedRotor(inertia=(2.20768,'amu*angstrom^2'), symmetry=1, barrier=(50.7589,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137609,'amu*angstrom^2'), symmetry=1, barrier=(50.7625,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.20797,'amu*angstrom^2'), symmetry=1, barrier=(50.7656,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.025,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72447,0.0653673,-0.0001389,1.51485e-07,-6.02961e-11,-72501.3,20.6234], Tmin=(100,'K'), Tmax=(836.587,'K')), NASAPolynomial(coeffs=[-0.258887,0.0373523,-2.14347e-05,4.30033e-09,-3.01521e-13,-70857.2,37.6807], Tmin=(836.587,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-603.368,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2s-CsH) + group(CsFOOO) + group(Cds-OdOsH) + radical(OCOJ) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (-558.748,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([482,586,761,1411,482,664,788,1296,1923,424.392,424.4,424.414,424.414],'cm^-1')),
        HinderedRotor(inertia=(0.00093592,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000936018,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.016,'amu'),
...
"""),
    E0 = (-795.021,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,482,664,788,1296,1923,180,180,180,1017.19,1017.34],'cm^-1')),
        HinderedRotor(inertia=(0.0712254,'amu*angstrom^2'), symmetry=1, barrier=(52.3125,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0712666,'amu*angstrom^2'), symmetry=1, barrier=(52.3112,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91593,0.0689317,-0.000167746,2.012e-07,-8.44553e-11,-95566.4,21.7732], Tmin=(100,'K'), Tmax=(836.022,'K')), NASAPolynomial(coeffs=[-7.3437,0.0530713,-3.13429e-05,6.34912e-09,-4.47255e-13,-91915.6,77.3617], Tmin=(836.022,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-795.021,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2s-CsH) + group(CsFOOO) + group(COFOO) + radical(OCOJ) + radical(OCOJ)"""),
)

species(
    label = '[O]C(=O)OC(=O)F(2213)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {7,S}
2 O u0 p2 c0 {6,S} {7,S}
3 O u1 p2 c0 {6,S}
...
"""),
    E0 = (-634.599,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,360,370,350,482,664,788,1296,1923,180,1262.85,1265.01,1266.9],'cm^-1')),
        HinderedRotor(inertia=(0.273044,'amu*angstrom^2'), symmetry=1, barrier=(6.27782,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.273438,'amu*angstrom^2'), symmetry=1, barrier=(6.28687,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.275723,'amu*angstrom^2'), symmetry=1, barrier=(6.3394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34859,'amu*angstrom^2'), symmetry=1, barrier=(31.0067,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18476,0.0706815,-0.000127982,1.21559e-07,-4.48841e-11,-76231.8,27.0471], Tmin=(100,'K'), Tmax=(798.581,'K')), NASAPolynomial(coeffs=[7.04454,0.0259197,-1.49581e-05,3.0398e-09,-2.15994e-13,-76676.3,3.17177], Tmin=(798.581,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-634.599,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2sCF) + group(Cs-OsOsOsH) + group(COFOO) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'O=C(F)O[C](O)F(1886)'],
    products = ['[O]C(O)(F)OC(=O)F(9950)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C(O)(F)OC(=O)F(9950)'],
    products = ['OC1(F)OO[C](F)O1(11268)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(O)(F)OC(=O)F(9950)'],
    products = ['[O]C1(F)OC(O)(F)O1(11269)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(7)', 'O=C(F)OC(=O)F(1889)'],
    products = ['[O]C(O)(F)OC(=O)F(9950)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(O)(F)O[C]=O(8759)'],
    products = ['[O]C(O)(F)OC(=O)F(9950)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(=O)F(459)', '[O][C](O)F(8770)'],
    products = ['[O]C(O)(F)OC(=O)F(9950)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CFO(51)', '[O]C([O])(O)F(8783)'],
    products = ['[O]C(O)(F)OC(=O)F(9950)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C([O])(F)OC(=O)F(11270)'],
    products = ['[O]C(O)(F)OC(=O)F(9950)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[O]C(=O)OC(=O)F(2213)'],
    products = ['[O]C(O)(F)OC(=O)F(9950)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=C(F)O[C](O)OF(11272)'],
    products = ['[O]C(O)(F)OC(=O)F(9950)'],
