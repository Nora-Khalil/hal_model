species(
    label = '[O]C(C(=O)F)C(F)(F)[C](F)F(5165)',
...
"""),
    E0 = (-1027.29,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,215,315,519,588,595,1205,1248,190,488,555,1236,1407,486,617,768,1157,1926,292.519,292.556,292.558,4000],'cm^-1')),
        HinderedRotor(inertia=(0.12219,'amu*angstrom^2'), symmetry=1, barrier=(7.42152,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122211,'amu*angstrom^2'), symmetry=1, barrier=(7.4214,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.487553,'amu*angstrom^2'), symmetry=1, barrier=(29.6106,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (176.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.471596,0.107123,-0.000180717,1.54687e-07,-5.1827e-11,-123402,37.021], Tmin=(100,'K'), Tmax=(800.949,'K')), NASAPolynomial(coeffs=[13.7741,0.0272401,-1.47484e-05,2.92218e-09,-2.04713e-13,-125403,-26.7945], Tmin=(800.949,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1027.29,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(COCsFO) + radical(C=OCOJ) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s))"""),
)
...
species(
    label = 'O=C[C](F)OC(F)(F)[C](F)F(5168)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = 'O=C(F)[CH]C(F)(F)[C](F)F(5213)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'O=C(F)C1OC(F)(F)C1(F)F(5169)',
...
species(
    label = 'O=C(F)C(=O)C(F)(F)C(F)F(5214)',
...
species(
    label = 'F[C]1OOC1C(F)(F)[C](F)F(5215)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = '[O]C1[C](F)OC(F)(F)C1(F)F(5174)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = '[O]C1(F)OC1C(F)(F)[C](F)F(5216)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = 'O=C([C](O)F)C(F)(F)[C](F)F(5217)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {11,S}
...
species(
    label = 'O=C(F)C(=O)C(F)(F)[C](F)F(5218)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = 'O=C(F)C(=O)[C](F)[C](F)F(5219)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'O=C(F)[C](O)C(F)(F)[C](F)F(5220)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = '[O]C(F)=C([O])C(F)(F)C(F)F(5221)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'O=C(F)C(OF)[C](F)[C](F)F(5222)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {11,S}
...
species(
    label = '[O]C([C](F)C(F)(F)F)C(=O)F(5223)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'O=[C]C(OF)C(F)(F)[C](F)F(5224)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-722.56,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,215,315,519,588,595,1205,1248,190,488,555,1236,1407,1855,455,950,260.473,260.506,260.536],'cm^-1')),
        HinderedRotor(inertia=(0.308362,'amu*angstrom^2'), symmetry=1, barrier=(14.8508,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.267894,'amu*angstrom^2'), symmetry=1, barrier=(12.8986,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.267694,'amu*angstrom^2'), symmetry=1, barrier=(12.8953,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00248385,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (176.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.822321,0.114288,-0.000192037,1.59496e-07,-5.17138e-11,-86738,37.5673], Tmin=(100,'K'), Tmax=(782.725,'K')), NASAPolynomial(coeffs=[16.3901,0.0236051,-1.30392e-05,2.59788e-09,-1.82479e-13,-89349.2,-40.7238], Tmin=(782.725,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-722.56,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cds-OdCsH) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s)) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C([C]=O)C(F)(F)C(F)(F)F(5225)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(C(=O)F)C(F)(F)[C](F)F(5165)'],
...
reaction(
    ...
    products = ['[O]C(C(=O)F)C(F)(F)[C](F)F(5165)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(C(=O)F)C(F)(F)[C](F)F(5165)'],
    products = ['O=C[C](F)OC(F)(F)[C](F)F(5168)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'O=C(F)[CH]C(F)(F)[C](F)F(5213)'],
    products = ['[O]C(C(=O)F)C(F)(F)[C](F)F(5165)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(138)', '[O]C([C](F)F)C(=O)F(4487)'],
    products = ['[O]C(C(=O)F)C(F)(F)[C](F)F(5165)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(C(=O)F)C(F)(F)[C](F)F(5165)'],
    products = ['O=C(F)C1OC(F)(F)C1(F)F(5169)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(C(=O)F)C(F)(F)[C](F)F(5165)'],
    products = ['O=C(F)C(=O)C(F)(F)C(F)F(5214)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(C(=O)F)C(F)(F)[C](F)F(5165)'],
    products = ['F[C]1OOC1C(F)(F)[C](F)F(5215)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(C(=O)F)C(F)(F)[C](F)F(5165)'],
    products = ['[O]C1[C](F)OC(F)(F)C1(F)F(5174)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(C(=O)F)C(F)(F)[C](F)F(5165)'],
    products = ['[O]C1(F)OC1C(F)(F)[C](F)F(5216)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=C([C](O)F)C(F)(F)[C](F)F(5217)'],
    products = ['[O]C(C(=O)F)C(F)(F)[C](F)F(5165)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CFO(51)', 'O=CC(F)(F)[C](F)F(1251)'],
    products = ['[O]C(C(=O)F)C(F)(F)[C](F)F(5165)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'O=C(F)C(=O)C(F)(F)[C](F)F(5218)'],
    products = ['[O]C(C(=O)F)C(F)(F)[C](F)F(5165)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[O]C(C(=O)F)C(F)=C(F)F(4573)'],
    products = ['[O]C(C(=O)F)C(F)(F)[C](F)F(5165)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=C(F)C(=O)[C](F)[C](F)F(5219)'],
    products = ['[O]C(C(=O)F)C(F)(F)[C](F)F(5165)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CF2(43)', '[O]C([C](F)F)C(=O)F(4487)'],
    products = ['[O]C(C(=O)F)C(F)(F)[C](F)F(5165)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(C(=O)F)C(F)(F)[C](F)F(5165)'],
    products = ['O=C(F)[C](O)C(F)(F)[C](F)F(5220)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]C(C(=O)F)C(F)(F)[C](F)F(5165)'],
    products = ['[O]C(F)=C([O])C(F)(F)C(F)F(5221)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O=C(F)C(OF)[C](F)[C](F)F(5222)'],
    products = ['[O]C(C(=O)F)C(F)(F)[C](F)F(5165)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C(C(=O)F)C(F)(F)[C](F)F(5165)'],
    products = ['[O]C([C](F)C(F)(F)F)C(=O)F(5223)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O=[C]C(OF)C(F)(F)[C](F)F(5224)'],
    products = ['[O]C(C(=O)F)C(F)(F)[C](F)F(5165)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[O]C(C(=O)F)C(F)(F)[C](F)F(5165)'],
    products = ['[O]C([C]=O)C(F)(F)C(F)(F)F(5225)'],
...
network(
    label = 'PDepNetwork #1513',
    isomers = [
        '[O]C(C(=O)F)C(F)(F)[C](F)F(5165)',
    ],
    reactants = [
