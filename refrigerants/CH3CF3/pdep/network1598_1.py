...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)C(F)(F)[CH]F(4838)'],
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[CH]C(F)(F)[CH]F(1129)'],
    products = ['[O]C(F)C(F)(F)[CH]F(4838)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(F)C(F)=CF(5683)'],
    products = ['[O]C(F)C(F)(F)[CH]F(4838)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=CC(F)(F)[CH]F(1163)'],
    products = ['[O]C(F)C(F)(F)[CH]F(4838)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C(F)C(F)(F)[CH]F(1179)'],
    products = ['[O]C(F)C(F)(F)[CH]F(4838)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', '[O]C=C(F)[CH]F(1164)'],
    products = ['[O]C(F)C(F)(F)[CH]F(4838)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C(F)C(F)(F)[CH]F(4838)'],
    products = ['O[C](F)C(F)(F)[CH]F(5684)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH][C](F)C(F)OF(5685)'],
    products = ['[O]C(F)C(F)(F)[CH]F(4838)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)[C](F)C(F)F(5667)'],
    products = ['[O]C(F)C(F)(F)[CH]F(4838)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH]C(F)(F)[CH]OF(5686)'],
    products = ['[O]C(F)C(F)(F)[CH]F(4838)'],
