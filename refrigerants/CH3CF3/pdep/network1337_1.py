...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(192)', '[O]C1O[C]1F(3588)'],
    products = ['O=[C]OC1O[C]1F(3468)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[O]C1O[C]1F(3588)'],
    products = ['O=[C]OC1O[C]1F(3468)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CO2(14)', 'F[C]1[CH]O1(1614)'],
    products = ['O=[C]OC1O[C]1F(3468)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OC1=C(F)O1(3730)'],
    products = ['O=[C]OC1O[C]1F(3468)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][C]=O(722)', 'F[C]1[CH]O1(1614)'],
    products = ['O=[C]OC1O[C]1F(3468)'],
