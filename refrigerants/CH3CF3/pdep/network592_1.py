...
reaction(
    label = 'reaction3',
    reactants = ['CH3F(39)', 'O=C([C]F)OF(1478)'],
    products = ['CC(F)(F)C(=O)OF(1472)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'O=C(OF)C(F)F(1479)'],
    products = ['CC(F)(F)C(=O)OF(1472)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(328)', 'CC(F)=C=O(1480)'],
    products = ['CC(F)(F)C(=O)OF(1472)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)(F)C([O])OF(1483)'],
    products = ['CC(F)(F)C(=O)OF(1472)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)(F)[C](O)OF(1484)'],
    products = ['CC(F)(F)C(=O)OF(1472)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[C](F)C(=O)OF(1485)'],
    products = ['CC(F)(F)C(=O)OF(1472)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC(F)(F)C([O])=O(1486)'],
    products = ['CC(F)(F)C(=O)OF(1472)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(127)', 'CC(F)(F)[C]=O(1347)'],
    products = ['CC(F)(F)C(=O)OF(1472)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(19)', 'O=C(OF)[C](F)F(1487)'],
    products = ['CC(F)(F)C(=O)OF(1472)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=[C]OF(458)', 'CH3-CF2(65)'],
    products = ['CC(F)(F)C(=O)OF(1472)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(F)(F)C(=O)OF(1488)'],
    products = ['CC(F)(F)C(=O)OF(1472)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'C=C(F)C(=O)OF(1489)'],
    products = ['CC(F)(F)C(=O)OF(1472)'],
