...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(F)F(1205)', 'F[C]C=CF(869)'],
    products = ['F[C]=CC(F)[C]=C(F)F(3025)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[C]=CC=C=C(F)F(3433)'],
    products = ['F[C]=CC(F)[C]=C(F)F(3025)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C]=CC(F)=C=C(F)F(3434)'],
    products = ['F[C]=CC(F)[C]=C(F)F(3025)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'FC#CC(F)[C]=C(F)F(3435)'],
    products = ['F[C]=CC(F)[C]=C(F)F(3025)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'F[C]=CC(F)C#CF(3436)'],
    products = ['F[C]=CC(F)[C]=C(F)F(3025)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'F[C]=C=C[C]=C(F)F(3437)'],
    products = ['F[C]=CC(F)[C]=C(F)F(3025)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[C]=CC(F)[C]=C(F)F(3025)'],
    products = ['F[C]C=C(F)C=C(F)F(3438)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[C]=CC(F)[C]=C(F)F(3025)'],
    products = ['FC=[C]C(F)[C]=C(F)F(3439)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C]=[C]C(F)C=C(F)F(3440)'],
    products = ['F[C]=CC(F)[C]=C(F)F(3025)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[C]=CC(F)[C]=C(F)F(3025)'],
    products = ['F[CH]C=C(F)[C]=C(F)F(3441)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C]=CC(F)[C]=C(F)F(3025)'],
    products = ['F[C]=C[CH]C(F)=C(F)F(3442)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C]=CC(F)[C]=C(F)F(3025)'],
    products = ['FC(F)=[C][CH]C=C(F)F(3108)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C]=CC(F)C(F)=[C]F(3443)'],
    products = ['F[C]=CC(F)[C]=C(F)F(3025)'],
