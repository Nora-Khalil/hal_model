...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'F[C]C(F)(F)F-2(6093)'],
    products = ['F[C](F)C(F)(F)F(2339)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C](F)[C](F)F(1586)'],
    products = ['F[C](F)C(F)(F)F(2339)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[C]C(F)(F)F(767)'],
    products = ['F[C](F)C(F)(F)F(2339)'],
    transitionState = 'TS5',
