...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', '[CH]=CC#C(3896)'],
    products = ['[CH]=CC(=[CH])F(3888)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=[C]F(489)', '[CH]=[CH](977)'],
    products = ['[CH]=CC(=[CH])F(3888)'],
    transitionState = 'TS7',
