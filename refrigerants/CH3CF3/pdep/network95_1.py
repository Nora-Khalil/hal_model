...
reaction(
    label = 'reaction4',
    reactants = ['FOC(F)(F)F(326)', 'C[C]F(325)'],
    products = ['CC(F)(F)C(F)(F)OF(259)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(328)', 'CC(F)(F)[C]F(327)'],
    products = ['CC(F)(F)C(F)(F)OF(259)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['FOF(328)', 'CC(F)=C(F)F(331)'],
    products = ['CC(F)(F)C(F)(F)OF(259)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C[C](F)C(F)(F)OF(332)'],
    products = ['CC(F)(F)C(F)(F)OF(259)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'CC(F)(F)[C](F)OF(333)'],
    products = ['CC(F)(F)C(F)(F)OF(259)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC(F)(F)C([O])(F)F(334)'],
    products = ['CC(F)(F)C(F)(F)OF(259)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(127)', 'CC(F)(F)[C](F)F(335)'],
    products = ['CC(F)(F)C(F)(F)OF(259)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FO[C](F)F(236)', 'CH3-CF2(65)'],
    products = ['CC(F)(F)C(F)(F)OF(259)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(19)', 'FOC(F)(F)[C](F)F(336)'],
    products = ['CC(F)(F)C(F)(F)OF(259)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(F)(F)C(F)(F)OF(337)'],
    products = ['CC(F)(F)C(F)(F)OF(259)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(78)', 'CC(F)(F)C(=O)F(214)'],
    products = ['CC(F)(F)C(F)(F)OF(259)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(78)', 'CC(F)=C(F)OF(338)'],
    products = ['CC(F)(F)C(F)(F)OF(259)'],
