...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(192)', '[O]C([O])(F)F(276)'],
    products = ['[O]C(F)(F)O[C]=O(780)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['[O][C](F)F(263)', '[O][C]=O(722)'],
    products = ['[O]C(F)(F)O[C]=O(780)'],
    transitionState = 'TS9',
