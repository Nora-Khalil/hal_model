...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(125)', '[CH2]C[O](224)'],
    products = ['[CH2]CO[C]=O(819)'],
    transitionState = 'TS2',
