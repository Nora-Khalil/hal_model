...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CC([O])(F)F(2216)'],
    products = ['CC([O])C([O])(F)F(2674)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'C[CH]C([O])(F)F(2521)'],
    products = ['CC([O])C([O])(F)F(2674)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(19)', '[O]C(F)(F)C=O(2287)'],
    products = ['CC([O])C([O])(F)F(2674)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'CC(=O)C([O])(F)F(2707)'],
    products = ['CC([O])C([O])(F)F(2674)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'CC([O])C(=O)F(2708)'],
    products = ['CC([O])C([O])(F)F(2674)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'CC([O])=C([O])F(1285)'],
    products = ['CC([O])C([O])(F)F(2674)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(O)C([O])(F)F(2710)'],
    products = ['CC([O])C([O])(F)F(2674)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C([O])C(O)(F)F(2712)'],
    products = ['CC([O])C([O])(F)F(2674)'],
