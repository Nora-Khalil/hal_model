...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(222)', '[O]C[CH]F(353)'],
    products = ['C=[C]OC[CH]F(832)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(127)', '[CH2]O[C]=C(954)'],
    products = ['C=[C]OC[CH]F(832)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(39)', '[CH2]O[C]=C(954)'],
    products = ['C=[C]OC[CH]F(832)'],
