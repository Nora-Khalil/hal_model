...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(F)[CH]F(210)'],
    products = ['[O]C(F)C([O])F(197)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][CH]F(185)', '[O][CH]F(185)'],
    products = ['[O]C(F)C([O])F(197)'],
    transitionState = 'TS8',
