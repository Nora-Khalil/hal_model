...
"""),
    ...
    molecularWeight = (90.0348,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.654619,0.0444707,-4.51207e-05,2.19331e-08,-3.74845e-12,-5464.22,24.9902], Tmin=(100,'K'), Tmax=(1857.49,'K')), NASAPolynomial(coeffs=[9.8669,0.00524406,2.21346e-06,-6.74914e-10,5.06934e-14,-5541.78,-16.1547], Tmin=(1857.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-46.6465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cs-OsOsHH) + ring(124trioxolane) + radical(Cs_P) + radical(OCJO)"""),
)

species(
    label = '[O]C([O])OC=O(2993)',
    structure = adjacencyList("""multiplicity 3
1 O u0 p2 c0 {5,S} {6,S}
2 O u1 p2 c0 {5,S}
3 O u1 p2 c0 {5,S}
...
"""),
    E0 = (-296.955,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2782.5,750,1395,475,1775,1000,1233.16,1233.16,1233.16,1233.17],'cm^-1')),
        HinderedRotor(inertia=(0.00329158,'amu*angstrom^2'), symmetry=1, barrier=(3.55201,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00329161,'amu*angstrom^2'), symmetry=1, barrier=(3.55205,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0348,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[6.92091,-0.00339208,3.15107e-05,-2.1827e-08,4.00668e-12,-35875.9,5.04708], Tmin=(100,'K'), Tmax=(2057.34,'K')), NASAPolynomial(coeffs=[17.8558,0.0171222,-1.3904e-05,2.75898e-09,-1.80239e-13,-49216.1,-77.0824], Tmin=(2057.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-296.955,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cds-OdOsH) + radical(OCOJ) + radical(OCOJ)"""),
)

species(
    label = '[O]C(O)O[C]=O(2978)',
    structure = adjacencyList("""multiplicity 3
1 O u0 p2 c0 {5,S} {6,S}
2 O u0 p2 c0 {5,S} {8,S}
3 O u1 p2 c0 {5,S}
...
"""),
    E0 = (-327.904,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,1855,455,950,180,1727.46,1727.54],'cm^-1')),
        HinderedRotor(inertia=(0.0233603,'amu*angstrom^2'), symmetry=1, barrier=(49.4146,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.14864,'amu*angstrom^2'), symmetry=1, barrier=(49.4014,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00406782,'amu*angstrom^2'), symmetry=1, barrier=(8.61182,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0348,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.53165,0.0485175,-0.000111884,1.35221e-07,-5.71233e-11,-39400.7,19.766], Tmin=(100,'K'), Tmax=(839.768,'K')), NASAPolynomial(coeffs=[-4.87964,0.0413571,-2.32486e-05,4.64389e-09,-3.25141e-13,-36658.7,63.1415], Tmin=(839.768,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-327.904,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cds-OdOsH) + radical(OCOJ) + radical((O)CJOC)"""),
)

species(
    label = 'O=[C]O[C](O)O(2991)',
    structure = adjacencyList("""multiplicity 3
1 O u0 p2 c0 {5,S} {6,S}
2 O u0 p2 c0 {5,S} {8,S}
...
"""),
    E0 = (-350.056,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,360,370,350,1855,455,950,258.861,258.865],'cm^-1')),
        HinderedRotor(inertia=(0.00251529,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00251438,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00251564,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00251506,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0348,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01921,0.0519946,-9.72875e-05,9.69284e-08,-3.65613e-11,-42038.8,21.1293], Tmin=(100,'K'), Tmax=(833.393,'K')), NASAPolynomial(coeffs=[3.98538,0.023858,-1.29882e-05,2.57004e-09,-1.79331e-13,-41717.2,15.898], Tmin=(833.393,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-350.056,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(166.289,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cds-OdOsH) + radical(Cs_P) + radical((O)CJOC)"""),
)

species(
    label = '[O]COC([O])=O(2998)',
    structure = adjacencyList("""multiplicity 3
1 O u0 p2 c0 {5,S} {6,S}
2 O u1 p2 c0 {5,S}
3 O u1 p2 c0 {6,S}
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'O=C(O)O(524)'],
    products = ['O=COC(=O)O(2150)'],
    transitionState = 'TS2',
