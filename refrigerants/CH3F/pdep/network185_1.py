...
reaction(
    label = 'reaction8',
    reactants = ['F[CH]OF(188)', '[O]C=O(146)'],
    products = ['O=COC(F)OF(414)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(129)', 'O=CO[CH]F(204)'],
    products = ['O=COC(F)OF(414)'],
