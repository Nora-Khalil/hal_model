...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]OC[CH]F(632)'],
    products = ['[O]OOC[CH]F(1331)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(127)', '[CH2]OO[O](153)'],
    products = ['[O]OOC[CH]F(1331)'],
    transitionState = 'TS3',
