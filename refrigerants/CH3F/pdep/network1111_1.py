...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'C=CO[C](F)OF(2808)'],
    products = ['C=COC(F)(F)OF(2746)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'C=COC([O])(F)F(2687)'],
    products = ['C=COC(F)(F)OF(2746)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)(F)OF(2351)', 'C2H3(29)'],
    products = ['C=COC(F)(F)OF(2746)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]F(129)', 'C=CO[C](F)F(2332)'],
    products = ['C=COC(F)(F)OF(2746)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C=[C]OC(F)(F)OF(2809)'],
    products = ['C=COC(F)(F)OF(2746)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH]=COC(F)(F)OF(2810)'],
    products = ['C=COC(F)(F)OF(2746)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['F2(77)', 'C=COC(=O)F(1258)'],
    products = ['C=COC(F)(F)OF(2746)'],
