...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C([O])=C=O(256)'],
    products = ['[O]C(=O)C([O])=O(228)'],
    transitionState = 'TS2',
