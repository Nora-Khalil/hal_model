...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(250)', '[CH]O(175)'],
    products = ['[O]C(=O)O[CH]O(2977)'],
    transitionState = 'TS2',
