...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'COC(=O)OF(839)'],
    products = ['CCOC(=O)OF(2740)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)OF(453)', 'C2H5(32)'],
    products = ['CCOC(=O)OF(2740)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(129)', 'CCO[C]=O(1807)'],
    products = ['CCOC(=O)OF(2740)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(19)', '[CH2]OC(=O)OF(452)'],
    products = ['CCOC(=O)OF(2740)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C[CH]OC(=O)OF(2852)'],
    products = ['CCOC(=O)OF(2740)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]COC(=O)OF(2853)'],
    products = ['CCOC(=O)OF(2740)'],
