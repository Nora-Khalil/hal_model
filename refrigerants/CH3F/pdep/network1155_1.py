...
reaction(
    label = 'reaction3',
    reactants = ['OF(133)', 'O=C=C(O)O(2119)'],
    products = ['O=C(OF)C(O)O(3019)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(=O)C(O)O(3034)'],
    products = ['O=C(OF)C(O)O(3019)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', 'O=C([CH]O)OF(469)'],
    products = ['O=C(OF)C(O)O(3019)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(O)C(=O)OF(3035)'],
    products = ['O=C(OF)C(O)O(3019)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(129)', 'O=[C]C(O)O(3036)'],
    products = ['O=C(OF)C(O)O(3019)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]OF(147)', 'O[CH]O(2982)'],
    products = ['O=C(OF)C(O)O(3019)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C(OF)[C](O)O(2124)'],
    products = ['O=C(OF)C(O)O(3019)'],
