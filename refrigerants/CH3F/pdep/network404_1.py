...
reaction(
    label = 'reaction3',
    reactants = ['C2H2(23)', '[CH]=[CH](223)'],
    products = ['[CH]=CC=[CH](1213)'],
    transitionState = 'TS3',
