...
reaction(
    label = 'reaction1',
    reactants = ['OCC(F)OF(422)'],
    products = ['HF(38)', 'CHFO(46)', 'CH2O(20)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'OC(F)OF(364)'],
    products = ['OCC(F)OF(422)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]OF(188)', 'CH2OH(33)'],
    products = ['OCC(F)OF(422)'],
