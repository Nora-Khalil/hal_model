...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]C[C]=O(916)'],
    products = ['[CH2]CC[C]=O(1816)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(125)', '[CH2]C[CH2](1234)'],
    products = ['[CH2]CC[C]=O(1816)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['CO(13)', '[CH2]C[CH2](1234)'],
    products = ['[CH2]CC[C]=O(1816)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['CH2CO(28)', '[CH2][CH2](184)'],
    products = ['[CH2]CC[C]=O(1816)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C]=O(552)', '[CH2][CH2](184)'],
    products = ['[CH2]CC[C]=O(1816)'],
