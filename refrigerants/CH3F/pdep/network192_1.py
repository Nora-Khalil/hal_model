...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.639806,'amu*angstrom^2'), symmetry=1, barrier=(14.7104,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.63876,'amu*angstrom^2'), symmetry=1, barrier=(14.6863,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.640257,'amu*angstrom^2'), symmetry=1, barrier=(14.7208,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-421.898,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,548,1085,1183,1302,1466,1520,3060,3119,3025,407.5,1350,352.5,367.953,368.712,368.968],'cm^-1')),
        HinderedRotor(inertia=(0.360039,'amu*angstrom^2'), symmetry=1, barrier=(34.6623,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.360247,'amu*angstrom^2'), symmetry=1, barrier=(34.6632,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.360209,'amu*angstrom^2'), symmetry=1, barrier=(34.6656,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.303094,'amu*angstrom^2'), symmetry=1, barrier=(6.96872,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.303238,'amu*angstrom^2'), symmetry=1, barrier=(6.97203,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.792015,'amu*angstrom^2'), symmetry=1, barrier=(18.21,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.0504,'amu'),
...
"""),
    E0 = (-645.748,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,548,1085,1183,1302,1466,1520,3060,3119,482,586,761,1411,211.421,212.136,213.929],'cm^-1')),
        HinderedRotor(inertia=(0.998704,'amu*angstrom^2'), symmetry=1, barrier=(31.9242,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.9919,'amu*angstrom^2'), symmetry=1, barrier=(31.915,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00165,'amu*angstrom^2'), symmetry=1, barrier=(31.9088,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(39)', 'OC(O)F(393)'],
    products = ['OC(F)OCF(421)'],
    transitionState = 'TS2',
