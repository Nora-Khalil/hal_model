...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(125)', '[CH2]C(=C)[O](1063)'],
...
reaction(
    label = 'reaction10',
    reactants = ['CO(13)', '[CH2]C(=C)[O](1063)'],
    products = ['C=C([O])C[C]=O(1387)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C=C([O])C=C=O(1488)'],
    products = ['C=C([O])C[C]=O(1387)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(18)', 'O=[C]C[C]=O(1005)'],
    products = ['C=C([O])C[C]=O(1387)'],
