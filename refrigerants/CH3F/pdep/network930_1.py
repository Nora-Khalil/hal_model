...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(2043)', '[O]C([O])F(165)'],
    products = ['[O]C(F)O[C](F)F(2241)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'F[CH]O[C](F)F(2276)'],
    products = ['[O]C(F)O[C](F)F(2241)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=CO[C](F)F(2180)'],
    products = ['[O]C(F)O[C](F)F(2241)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C](F)F(2208)', 'CHFO(46)'],
    products = ['[O]C(F)O[C](F)F(2241)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C(F)O[C](F)F(2251)'],
    products = ['[O]C(F)O[C](F)F(2241)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][C](F)F(2208)', '[O][CH]F(185)'],
    products = ['[O]C(F)O[C](F)F(2241)'],
