...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'OCO(538)'],
    products = ['OCOC(F)F(425)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)F(189)', 'CH2OH(33)'],
    products = ['OCOC(F)F(425)'],
    transitionState = 'TS5',
