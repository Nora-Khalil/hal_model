...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]C[CH]F(353)'],
    products = ['[CH2]C(F)C[O](624)'],
    transitionState = 'TS3',
