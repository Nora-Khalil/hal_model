...
reaction(
    label = 'reaction1',
    reactants = ['OOC[CH]F(609)'],
    products = ['OH(7)', 'FC1CO1(564)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[CH]COO(1667)'],
    products = ['OOC[CH]F(609)'],
    transitionState = 'TS2',
