...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]OO[C](O)F(1949)'],
    products = ['CO2(14)', 'O=C(O)F(220)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C]=O(249)', 'O[C]F(1303)'],
    products = ['O=[C]OO[C](O)F(1949)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(125)', '[O]O[C](O)F(391)'],
    products = ['O=[C]OO[C](O)F(1949)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['[O][C]=O(163)', 'O=C(O)F(220)'],
    products = ['O=[C]OO[C](O)F(1949)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][C]=O(163)', '[O][C](O)F(221)'],
    products = ['O=[C]OO[C](O)F(1949)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[C]=O(249)', '[OH+]=[C-]F(1359)'],
    products = ['O=[C]OO[C](O)F(1949)'],
