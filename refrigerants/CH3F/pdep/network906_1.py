...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(2043)', '[O]C[O](158)'],
    products = ['[O]CO[C](F)F(2217)'],
    transitionState = 'TS2',
