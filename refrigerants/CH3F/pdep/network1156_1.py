...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)OF(453)', 'CH2OH(33)'],
    products = ['O=C(OF)OCO(3020)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['OH(7)', '[CH2]OC(=O)OF(452)'],
    products = ['O=C(OF)OCO(3020)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(OF)O[CH]O(2155)'],
    products = ['O=C(OF)OCO(3020)'],
