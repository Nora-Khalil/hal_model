...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(125)', '[O]C[CH]F(353)'],
    products = ['O=[C]OC[CH]F(621)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(127)', '[CH2]O[C]=O(426)'],
    products = ['O=[C]OC[CH]F(621)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(39)', '[CH2]O[C]=O(426)'],
    products = ['O=[C]OC[CH]F(621)'],
