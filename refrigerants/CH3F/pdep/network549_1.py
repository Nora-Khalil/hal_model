...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'O=C(O)CF(144)'],
    products = ['O=C(O)C(=O)CF(1559)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'O=C(O)C(=O)[C]F(1686)'],
    products = ['O=C(O)C(=O)CF(1559)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH2]C(=O)C(=O)O(1597)'],
    products = ['O=C(O)C(=O)CF(1559)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'O=[C]C(=O)CF(1696)'],
    products = ['O=C(O)C(=O)CF(1559)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(=O)C(=O)CF(1697)'],
    products = ['O=C(O)C(=O)CF(1559)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2F(45)', 'O=[C]C(=O)O(581)'],
    products = ['O=C(O)C(=O)CF(1559)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(O)C(=O)[CH]F(1698)'],
    products = ['O=C(O)C(=O)CF(1559)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=[C]O(145)', 'O=[C]CF(226)'],
    products = ['O=C(O)C(=O)CF(1559)'],
