...
reaction(
    label = 'reaction2',
    reactants = ['O=C(O)O(524)', 'C[C]F(606)'],
    products = ['CC(F)OC(=O)O(2741)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'O=C(O)OCF(840)'],
    products = ['CC(F)OC(=O)O(2741)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)O[C](O)O(2969)'],
    products = ['CC(F)OC(=O)O(2741)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[CH]OC(=O)O(2970)'],
    products = ['CC(F)OC(=O)O(2741)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(=O)O(309)', 'CH3-CHF(62)'],
    products = ['CC(F)OC(=O)O(2741)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=[C]O(145)', 'CC([O])F(563)'],
    products = ['CC(F)OC(=O)O(2741)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', 'CC(F)O[C]=O(1356)'],
    products = ['CC(F)OC(=O)O(2741)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'CC(F)OC([O])=O(2971)'],
    products = ['CC(F)OC(=O)O(2741)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(19)', 'O=C(O)O[CH]F(528)'],
    products = ['CC(F)OC(=O)O(2741)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C[C](F)OC(=O)O(2972)'],
    products = ['CC(F)OC(=O)O(2741)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH2]C(F)OC(=O)O(2973)'],
    products = ['CC(F)OC(=O)O(2741)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CC(F)OC(=O)O(2741)'],
    products = ['O=C(O)O(524)', 'CH2CHF(55)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C=COC(=O)O(1710)'],
    products = ['CC(F)OC(=O)O(2741)'],
...
network(
    label = 'PDepNetwork #1106',
    isomers = [
        'CC(F)OC(=O)O(2741)',
    ],
    reactants = [
        ('HF(38)', 'CO2(14)', 'CH3CHO(36)'),
        ('[O]C(=O)O(309)', 'CH3-CHF(62)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
