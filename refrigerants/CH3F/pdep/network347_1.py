...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(129)', '[CH2]C(=O)O(898)'],
    products = ['O=C(O)COF(842)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]O(145)', '[CH2]OF(152)'],
    products = ['O=C(O)COF(842)'],
