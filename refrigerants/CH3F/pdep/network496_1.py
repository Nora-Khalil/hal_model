...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'C=[C]C(=C)[O](1473)'],
    products = ['C=C([O])C(=C)[O](1385)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['CH2(T)(18)', '[CH2]C([O])=C=O(1016)'],
    products = ['C=C([O])C(=C)[O](1385)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C=C([O])C(=C)[O](1385)'],
    products = ['[CH2]C1=C([CH2])OO1(1511)'],
