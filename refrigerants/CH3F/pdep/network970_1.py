...
"""),
    E0 = (-384.479,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3615,1277.5,1000,482,586,761,1411,580,1155,1237,1373,3147,180],'cm^-1')),
        HinderedRotor(inertia=(0.706122,'amu*angstrom^2'), symmetry=1, barrier=(16.2351,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.19845,'amu*angstrom^2'), symmetry=1, barrier=(50.5468,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251088,'amu*angstrom^2'), symmetry=1, barrier=(5.773,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.2011,'amu*angstrom^2'), symmetry=1, barrier=(50.6076,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25239,0.066012,-0.000105454,9.03918e-08,-3.11064e-11,-46148.5,25.3212], Tmin=(100,'K'), Tmax=(751.984,'K')), NASAPolynomial(coeffs=[9.0011,0.0219432,-1.18609e-05,2.37522e-09,-1.68526e-13,-47233.2,-9.31708], Tmin=(751.984,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-384.479,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(CsFHOO) + group(CsFHHO) + radical(CsF1sO2sO2s) + radical(CsF1sHO2s)"""),
)
...
"""),
    ...
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55789,0.0420922,-1.45995e-05,-1.75865e-08,1.07801e-11,-97845.8,22.6028], Tmin=(100,'K'), Tmax=(1010,'K')), NASAPolynomial(coeffs=[16.3808,0.00924404,-4.21586e-06,9.06823e-10,-7.15623e-14,-102159,-55.5854], Tmin=(1010,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-814.352,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(CsFHHO) + group(COFOO)"""),
)
...
"""),
    E0 = (-335.134,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,451,553,637,1069,1180,1265,1301,3056,580,1155,1237,1373,3147,180],'cm^-1')),
        HinderedRotor(inertia=(0.444493,'amu*angstrom^2'), symmetry=1, barrier=(10.2198,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.41051,'amu*angstrom^2'), symmetry=1, barrier=(55.4223,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.6635,'amu*angstrom^2'), symmetry=1, barrier=(38.2471,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59606,0.0579134,-7.84267e-05,5.76973e-08,-1.7398e-11,-40225.3,23.4552], Tmin=(100,'K'), Tmax=(802.626,'K')), NASAPolynomial(coeffs=[8.74389,0.0222902,-1.18499e-05,2.3967e-09,-1.72615e-13,-41372.7,-9.45721], Tmin=(802.626,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-335.134,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(CsFHOO) + group(CsFHHO) + radical(O2sj(Cs-F1sO2sH)) + radical(CsF1sHO2s)"""),
)

species(
    label = '[O][C](F)OOCF(2482)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {7,S}
3 O u0 p2 c0 {4,S} {6,S}
...
"""),
    E0 = (-328.01,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,548,1085,1183,1302,1466,1520,3060,3119,482,586,761,1411,180,2309.51],'cm^-1')),
        HinderedRotor(inertia=(1.76929,'amu*angstrom^2'), symmetry=1, barrier=(40.6795,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.76934,'amu*angstrom^2'), symmetry=1, barrier=(40.6805,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.211991,'amu*angstrom^2'), symmetry=1, barrier=(40.6816,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.15837,0.0440248,-3.97209e-05,1.85009e-08,-3.63425e-12,-39387.2,23.3709], Tmin=(100,'K'), Tmax=(1169.43,'K')), NASAPolynomial(coeffs=[8.64985,0.0218209,-1.12407e-05,2.26502e-09,-1.63369e-13,-40905.5,-8.96281], Tmin=(1169.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-328.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(CsFHOO) + group(CsFHHO) + radical(O2sj(Cs-F1sO2sH)) + radical(CsF1sO2sO2s)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O[C]F(1303)', '[O]O[CH]F(168)'],
    products = ['O[C](F)OO[CH]F(2479)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(127)', '[O]O[C](O)F(391)'],
    products = ['O[C](F)OO[CH]F(2479)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    ...
    products = ['O[C](F)OO[CH]F(2479)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(260.848,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Ea raised from 258.3 to 260.8 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    products = ['O[C](F)OO[CH]F(2479)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(206.667,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O=C(F)OO[CH]F(301)'],
    products = ['O[C](F)OO[CH]F(2479)'],
    transitionState = 'TS8',
...
reaction(
    ...
    products = ['O[C](F)OO[CH]F(2479)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(15.0129,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)

reaction(
    label = 'reaction10',
    reactants = ['[OH+]=[C-]F(1359)', '[O]O[CH]F(168)'],
    products = ['O[C](F)OO[CH]F(2479)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(128827,'m^3/(mol*s)'), n=0.469398, Ea=(9.20635,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['CHF(39)', '[O]O[C](O)F(391)'],
    products = ['O[C](F)OO[CH]F(2479)'],
