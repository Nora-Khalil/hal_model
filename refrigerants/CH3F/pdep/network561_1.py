...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', 'OOO[CH]F(314)'],
    products = ['[CH2]C(F)OOO(1699)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2][CH]OOO(1715)'],
    products = ['[CH2]C(F)OOO(1699)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['HO2(11)', '[CH2]C([O])F(354)'],
    products = ['[CH2]C(F)OOO(1699)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OH(7)', '[CH2]C(F)O[O](633)'],
    products = ['[CH2]C(F)OOO(1699)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)OO[O](1330)'],
    products = ['[CH2]C(F)OOO(1699)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2][C](F)OOO(1337)'],
    products = ['[CH2]C(F)OOO(1699)'],
