...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C(=O)[CH]F(1077)'],
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(=O)C=O(1275)'],
    products = ['C=C([O])C([O])F(1216)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(=O)C(=O)F(1276)'],
    products = ['C=C([O])C([O])F(1216)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(T)(18)', '[O]C(F)[C]=O(272)'],
    products = ['C=C([O])C([O])F(1216)'],
