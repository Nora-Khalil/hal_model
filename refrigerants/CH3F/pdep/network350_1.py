...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'FCCOF(880)'],
    products = ['O=C(CCF)OF(845)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'O=C(C[C]F)OF(931)'],
    products = ['O=C(CCF)OF(845)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]CC(=O)OF(939)'],
    products = ['O=C(CCF)OF(845)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2F(45)', '[CH2]C(=O)OF(928)'],
    products = ['O=C(CCF)OF(845)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OF(147)', 'CH2F-CH2(61)'],
    products = ['O=C(CCF)OF(845)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'O=C([CH]CF)OF(942)'],
    products = ['O=C(CCF)OF(845)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(C[CH]F)OF(943)'],
    products = ['O=C(CCF)OF(845)'],
