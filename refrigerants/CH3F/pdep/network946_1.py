...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C([O])(F)F(2255)'],
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(F)(F)[C](F)F(2442)'],
    products = ['[O]C(F)(F)C([O])(F)F(2255)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', '[O]C(F)(F)C(=O)F(2252)'],
    products = ['[O]C(F)(F)C([O])(F)F(2255)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F2(77)', '[O][C](F)C(=O)F(2288)'],
    products = ['[O]C(F)(F)C([O])(F)F(2255)'],
    transitionState = 'TS7',
