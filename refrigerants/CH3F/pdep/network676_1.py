...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'OCCF(635)'],
    products = ['O=C(O)CCF(1833)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'O=C(O)C[C]F(1170)'],
    products = ['O=C(O)CCF(1833)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'O=C(O)CF(144)'],
    products = ['O=C(O)CCF(1833)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[CH2]CC(=O)O(1806)'],
    products = ['O=C(O)CCF(1833)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2F(45)', '[CH2]C(=O)O(898)'],
    products = ['O=C(O)CCF(1833)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=[C]O(145)', 'CH2F-CH2(61)'],
    products = ['O=C(O)CCF(1833)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O=C(O)[CH]CF(1126)'],
    products = ['O=C(O)CCF(1833)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C(O)C[CH]F(1178)'],
    products = ['O=C(O)CCF(1833)'],
