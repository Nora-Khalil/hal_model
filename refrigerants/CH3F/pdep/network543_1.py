...
reaction(
    label = 'reaction3',
    reactants = ['O[C]1OC[C](F)O1(1643)'],
    products = ['C=C(F)OC(=O)O(1553)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=[C]OC(=O)O(1649)'],
    products = ['C=C(F)OC(=O)O(1553)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(=O)O(309)', 'CH2CF(69)'],
    products = ['C=C(F)OC(=O)O(1553)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', 'C=C(F)O[C]=O(656)'],
    products = ['C=C(F)OC(=O)O(1553)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C(F)OC([O])=O(1650)'],
    products = ['C=C(F)OC(=O)O(1553)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH]=C(F)OC(=O)O(1651)'],
    products = ['C=C(F)OC(=O)O(1553)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(25)', 'O=C(O)[O+]=[C-]F(1654)'],
    products = ['C=C(F)OC(=O)O(1553)'],
