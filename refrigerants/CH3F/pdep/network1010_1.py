...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'FOOC(F)F(2071)'],
    products = ['O=C(F)OOC(F)F(2576)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', 'O=C(F)OO(1140)'],
    products = ['O=C(F)OOC(F)F(2576)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O=C(F)OOF(1841)', 'CHF(39)'],
    products = ['O=C(F)OOC(F)F(2576)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=C(F)OO[CH]F(301)'],
    products = ['O=C(F)OOC(F)F(2576)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=[C]OOC(F)F(2066)'],
    products = ['O=C(F)OOC(F)F(2576)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(=O)F(148)', '[O]C(F)F(189)'],
    products = ['O=C(F)OOC(F)F(2576)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]OC(=O)F(296)', 'CHF2(81)'],
    products = ['O=C(F)OOC(F)F(2576)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CFO(50)', '[O]OC(F)F(2051)'],
    products = ['O=C(F)OOC(F)F(2576)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)OO[C](F)F(2577)'],
    products = ['O=C(F)OOC(F)F(2576)'],
...
network(
    ...
    reactants = [
        ('CF2O(48)', 'O=C(O)F(220)'),
        ('[O]OC(=O)F(296)', 'CHF2(81)'),
        ('CFO(50)', '[O]OC(F)F(2051)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
