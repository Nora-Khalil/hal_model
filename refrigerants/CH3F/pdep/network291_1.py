...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(127)', '[O]C[CH]F(353)'],
    products = ['F[CH]CO[CH]F(641)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(127)', '[CH2]O[CH]F(343)'],
    products = ['F[CH]CO[CH]F(641)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF(39)', '[CH2]O[CH]F(343)'],
    products = ['F[CH]CO[CH]F(641)'],
