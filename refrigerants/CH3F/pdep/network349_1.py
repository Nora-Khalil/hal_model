...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'OCOF(499)'],
    products = ['O=C(F)OCO(844)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)F(148)', 'CH2OH(33)'],
    products = ['O=C(F)OCO(844)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)O[CH]O(492)'],
    products = ['O=C(F)OCO(844)'],
