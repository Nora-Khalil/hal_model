...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(250)', '[C]=C(222)'],
    products = ['C=[C]OC([O])=O(806)'],
    transitionState = 'TS2',
