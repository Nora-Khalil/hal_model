...
reaction(
    label = 'reaction3',
    reactants = ['FOF(377)', 'O=C=C(O)O(2119)'],
    products = ['O=C(OF)C(O)(O)F(2115)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=C(OF)[C](O)O(2124)'],
    products = ['O=C(OF)C(O)(O)F(2115)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(=O)C(O)(O)F(2125)'],
    products = ['O=C(OF)C(O)(O)F(2115)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', 'O=C(OF)[C](O)F(474)'],
    products = ['O=C(OF)C(O)(O)F(2115)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(O)(F)C(=O)OF(2126)'],
    products = ['O=C(OF)C(O)(O)F(2115)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(129)', 'O=[C]C(O)(O)F(2127)'],
    products = ['O=C(OF)C(O)(O)F(2115)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]OF(147)', 'O[C](O)F(1944)'],
    products = ['O=C(OF)C(O)(O)F(2115)'],
