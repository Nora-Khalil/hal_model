...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)F(148)', 'O=[C]O(145)'],
    products = ['O=C(O)OC(=O)F(566)'],
    transitionState = 'TS8',
