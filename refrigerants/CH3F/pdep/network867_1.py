...
"""),
    E0 = (9.12602,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,326,540,652,719,1357,180,180,1777.36,1777.36],'cm^-1')),
        HinderedRotor(inertia=(0.0691725,'amu*angstrom^2'), symmetry=1, barrier=(1.59041,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.0169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2236,0.0532929,-0.000123565,1.34503e-07,-5.22082e-11,1147.9,15.239], Tmin=(100,'K'), Tmax=(860.954,'K')), NASAPolynomial(coeffs=[0.422706,0.0263829,-1.52197e-05,3.01562e-09,-2.08153e-13,2765.43,31.2506], Tmin=(860.954,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(9.12602,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2sCF) + group(Cds-CdsCsCs) + group(CdCFO) + longDistanceInteraction_cyclic(Cd(F)=CdOs) + ring(Cyclopropene)"""),
)

species(
    label = 'FC(F)=C1OO1(2600)',
    structure = adjacencyList("""1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
...
reaction(
    label = 'reaction1',
    reactants = ['CF2(42)', 'CO2(14)'],
    products = ['O=C1OC1(F)F(2195)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=C1O[C]1F(2601)'],
    products = ['O=C1OC1(F)F(2195)'],
    transitionState = 'TS8',
