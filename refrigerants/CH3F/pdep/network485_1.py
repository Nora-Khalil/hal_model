...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', 'C=[C]O[O](994)'],
    products = ['[CH2]OO[C]=C(1375)'],
    transitionState = 'TS2',
