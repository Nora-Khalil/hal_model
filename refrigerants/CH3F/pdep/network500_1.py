...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(222)', '[O]C[C]=O(435)'],
    products = ['C=[C]OC[C]=O(1389)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(125)', '[CH2]O[C]=C(954)'],
    products = ['C=[C]OC[C]=O(1389)'],
    transitionState = 'TS3',
