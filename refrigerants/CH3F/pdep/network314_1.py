...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C]=O(249)', '[C]=C(222)'],
    products = ['C=[C]OO[C]=O(809)'],
    transitionState = 'TS2',
