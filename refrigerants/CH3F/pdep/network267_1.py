...
reaction(
    label = 'reaction3',
    reactants = ['[CH2][CH]C(=O)OF(686)'],
    products = ['[CH2]C(F)C([O])=O(618)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[O]C([O])=CF(271)'],
    products = ['[CH2]C(F)C([O])=O(618)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction16',
    reactants = ['[O][C]=O(163)', '[CH2][CH]F(648)'],
    products = ['[CH2]C(F)C([O])=O(618)'],
