...
reaction(
    label = 'reaction21',
    reactants = ['O(6)', '[CH2][CH]F(648)'],
    products = ['[CH2]C([O])F(354)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[OH+]=[C-]F(1359)', 'CH2(S)(25)'],
    products = ['C=C(O)F(516)'],
