...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(285)', '[CH]F(127)'],
    products = ['[O]C(F)(F)O[CH]F(2242)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(F)O[CH]F(205)'],
    products = ['[O]C(F)(F)O[CH]F(2242)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C([O])(F)F(285)', 'CHF(39)'],
    products = ['[O]C(F)(F)O[CH]F(2242)'],
    transitionState = 'TS9',
