...
reaction(
    label = 'reaction7',
    reactants = ['O=[C]OF(147)', '[O]C=O(146)'],
    products = ['O=COC(=O)OF(565)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(129)', 'O=[C]OC=O(262)'],
    products = ['O=COC(=O)OF(565)'],
    transitionState = 'TS9',
