...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(125)', '[O]C([O])O(1939)'],
    products = ['[O]C(O)O[C]=O(2978)'],
    transitionState = 'TS2',
