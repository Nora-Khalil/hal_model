...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)O[O](633)'],
    products = ['O=O(128)', 'CH2CHF(55)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C([O])F(354)'],
    products = ['[CH2]C(F)O[O](633)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[CH]F(168)', 'CH2(T)(18)'],
    products = ['[CH2]C(F)O[O](633)'],
    transitionState = 'TS3',
