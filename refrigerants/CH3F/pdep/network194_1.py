...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(129)', '[CH2]C(O)F(519)'],
    products = ['OC(F)COF(423)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[CH]F(187)', '[CH2]OF(152)'],
    products = ['OC(F)COF(423)'],
