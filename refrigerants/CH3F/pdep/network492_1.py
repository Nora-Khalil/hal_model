...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C=C=C(1300)'],
    products = ['[CH]=CC(=C)[O](1381)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=[CH](223)', '[CH2][C]=O(552)'],
    products = ['[CH]=CC(=C)[O](1381)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(T)(18)', '[CH]C=C=O(796)'],
    products = ['[CH]=CC(=C)[O](1381)'],
