...
reaction(
    label = 'reaction1',
    reactants = ['[C-]=[O+]OC(=O)F(1945)'],
    products = ['CO(13)', 'O=C(O)F(220)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[C-]=[O+]OF(1965)'],
    products = ['[C-]=[O+]OC(=O)F(1945)'],
    transitionState = 'TS2',
