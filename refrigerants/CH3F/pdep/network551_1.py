...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(=O)O[C](O)F(1636)'],
    products = ['C=C(O)OC(=O)F(1561)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(O)O[C]=O(1639)'],
    products = ['C=C(O)OC(=O)F(1561)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(=O)F(148)', 'C=[C]O(556)'],
    products = ['C=C(O)OC(=O)F(1561)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CFO(50)', '[CH2]C(=O)O(898)'],
    products = ['C=C(O)OC(=O)F(1561)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(7)', 'C=[C]OC(=O)F(1260)'],
    products = ['C=C(O)OC(=O)F(1561)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(=O)OC(=O)F(1640)'],
    products = ['C=C(O)OC(=O)F(1561)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH]=C(O)OC(=O)F(1641)'],
    products = ['C=C(O)OC(=O)F(1561)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=C(O)OC(=O)F(1561)'],
    products = ['O=C(O)F(220)', 'C#CO(1197)'],
