...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C(=O)[C](F)F(2433)'],
    products = ['C=C([O])C([O])(F)F(2223)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C=[C]C([O])(F)F(2434)'],
    products = ['C=C([O])C([O])(F)F(2223)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['C=C([O])C([O])(F)F(2223)'],
    products = ['[CH2]C1([O])OC1(F)F(2425)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(=O)C(=O)F(1276)'],
    products = ['C=C([O])C([O])(F)F(2223)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O][C](F)F(2208)', 'CH2CO(28)'],
    products = ['C=C([O])C([O])(F)F(2223)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O][C](F)F(2208)', '[CH2][C]=O(552)'],
    products = ['C=C([O])C([O])(F)F(2223)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(18)', '[O]C(F)(F)[C]=O(2306)'],
    products = ['C=C([O])C([O])(F)F(2223)'],
