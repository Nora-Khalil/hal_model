...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(125)', '[O]C([O])(O)F(1941)'],
    products = ['[O]C(O)(F)O[C]=O(1948)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(13)', '[O]C([O])(O)F(1941)'],
    products = ['[O]C(O)(F)O[C]=O(1948)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[O]C(=O)O[C]=O(229)'],
    products = ['[O]C(O)(F)O[C]=O(1948)'],
