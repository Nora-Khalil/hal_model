...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'CC(=O)C([O])=O(1587)'],
    products = ['CC(=O)C(=O)OF(1558)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(129)', 'CC(=O)[C]=O(1588)'],
    products = ['CC(=O)C(=O)OF(1558)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(19)', 'O=[C]C(=O)OF(579)'],
    products = ['CC(=O)C(=O)OF(1558)'],
