...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CO[O](596)'],
    products = ['O=O(128)', 'C2H2(23)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]=C[O](181)'],
    products = ['[CH]=CO[O](596)'],
    transitionState = 'TS2',
