...
reaction(
    label = 'reaction2',
    reactants = ['CHF(39)', 'O=C(O)O(524)'],
    products = ['O=C(O)OCF(840)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=C(O)OF(448)', 'CH2(S)(25)'],
    products = ['O=C(O)OCF(840)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]OC(=O)O(1026)'],
    products = ['O=C(O)OCF(840)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(O)O[CH]F(528)'],
    products = ['O=C(O)OCF(840)'],
