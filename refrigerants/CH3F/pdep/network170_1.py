...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'OC(O)F(393)'],
    products = ['OC(F)OC(F)F(342)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O[CH]OC(F)F(394)'],
    products = ['OC(F)OC(F)F(342)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'OC(F)O[CH]F(395)'],
    products = ['OC(F)OC(F)F(342)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)F(189)', 'O[CH]F(187)'],
    products = ['OC(F)OC(F)F(342)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(7)', 'F[CH]OC(F)F(396)'],
    products = ['OC(F)OC(F)F(342)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)OC(F)F(397)'],
    products = ['OC(F)OC(F)F(342)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O[C](F)OC(F)F(398)'],
    products = ['OC(F)OC(F)F(342)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'OC(F)O[C](F)F(399)'],
    products = ['OC(F)OC(F)F(342)'],
