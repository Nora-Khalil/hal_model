...
reaction(
    label = 'reaction1',
    reactants = ['CCC(F)(F)OF(2681)'],
    products = ['HF(38)', 'CF2O(48)', 'C2H4(30)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'CC(F)(F)OF(2539)'],
    products = ['CCC(F)(F)OF(2681)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(133)', 'CC=C(F)F(2543)'],
    products = ['CCC(F)(F)OF(2681)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(129)', 'CC[C](F)F(2718)'],
    products = ['CCC(F)(F)OF(2681)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['FO[C](F)F(2234)', 'C2H5(32)'],
    products = ['CCC(F)(F)OF(2681)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', '[CH2]C(F)(F)OF(2555)'],
    products = ['CCC(F)(F)OF(2681)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C[CH]C(F)(F)OF(2544)'],
    products = ['CCC(F)(F)OF(2681)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]CC(F)(F)OF(2553)'],
    products = ['CCC(F)(F)OF(2681)'],
