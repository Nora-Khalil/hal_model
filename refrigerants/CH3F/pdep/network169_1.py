...
reaction(
    label = 'reaction2',
    reactants = ['H2O(3)', 'F[C]C(F)OF(370)'],
    products = ['OC(F)C(F)OF(341)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O[CH]C(F)OF(378)'],
    products = ['OC(F)C(F)OF(341)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C(F)C(O)F(380)'],
    products = ['OC(F)C(F)OF(341)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', 'F[CH]C(F)OF(381)'],
    products = ['OC(F)C(F)OF(341)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(F)C(F)OF(382)'],
    products = ['OC(F)C(F)OF(341)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(129)', 'OC(F)[CH]F(383)'],
    products = ['OC(F)C(F)OF(341)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]OF(188)', 'O[CH]F(187)'],
    products = ['OC(F)C(F)OF(341)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'O[C](F)C(F)OF(384)'],
    products = ['OC(F)C(F)OF(341)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'O=C(F)C(O)F(211)'],
    products = ['OC(F)C(F)OF(341)'],
