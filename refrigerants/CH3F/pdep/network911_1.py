...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(2043)', '[CH]=C[O](181)'],
    products = ['[CH]=CO[C](F)F(2222)'],
    transitionState = 'TS2',
