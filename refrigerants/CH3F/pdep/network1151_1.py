...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=CO[C](O)F(2148)'],
    products = ['O=COC(O)(F)F(3015)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O[C](F)F(2111)', '[O]C=O(146)'],
    products = ['O=COC(O)(F)F(3015)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['HCO(15)', '[O]C(O)(F)F(290)'],
    products = ['O=COC(O)(F)F(3015)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=[C]OC(O)(F)F(2177)'],
    products = ['O=COC(O)(F)F(3015)'],
...
network(
    ...
    reactants = [
        ('CF2O(48)', 'O=CO(160)'),
        ('O[C](F)F(2111)', '[O]C=O(146)'),
        ('HCO(15)', '[O]C(O)(F)F(290)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
