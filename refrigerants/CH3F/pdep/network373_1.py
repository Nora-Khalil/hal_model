...
reaction(
    label = 'reaction1',
    reactants = ['[O]OO[CH]F(190)'],
    products = ['O=O(128)', 'CHFO(46)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[O](130)', '[CH]F(127)'],
    products = ['[O]OO[CH]F(190)'],
    transitionState = 'TS2',
