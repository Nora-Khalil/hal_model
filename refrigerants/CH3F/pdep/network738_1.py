...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'O[C-]=[O+]F(1958)'],
    products = ['O=C(F)[O+]=[C-]O(1946)'],
    transitionState = 'TS2',
