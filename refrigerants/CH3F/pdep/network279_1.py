...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC([O])F(630)'],
    products = ['CHFO(46)', 'C2H2(23)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C=CF(768)'],
    products = ['[CH]=CC([O])F(630)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][CH]F(185)', '[CH]=[CH](223)'],
    products = ['[CH]=CC([O])F(630)'],
