...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(125)', '[O]C([O])(F)F(285)'],
    products = ['[O]C(F)(F)O[C]=O(2213)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'O=[C]O[C](F)F(2179)'],
    products = ['[O]C(F)(F)O[C]=O(2213)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['[O][C](F)F(2208)', '[O][C]=O(163)'],
    products = ['[O]C(F)(F)O[C]=O(2213)'],
    transitionState = 'TS9',
