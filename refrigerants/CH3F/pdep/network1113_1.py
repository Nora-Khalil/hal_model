...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.275501,'amu*angstrom^2'), symmetry=1, barrier=(6.33431,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.275622,'amu*angstrom^2'), symmetry=1, barrier=(6.3371,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.829022,0.0760907,-0.000116878,9.92746e-08,-3.41965e-11,-82766.5,24.0265], Tmin=(100,'K'), Tmax=(744.179,'K')), NASAPolynomial(coeffs=[9.26295,0.0280833,-1.47212e-05,2.92873e-09,-2.07534e-13,-83947.7,-13.6727], Tmin=(744.179,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-689.059,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)CsHH) + group(CsCFFO) + group(Cds-OdCsH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.160771,'amu*angstrom^2'), symmetry=1, barrier=(3.69644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0926032,'amu*angstrom^2'), symmetry=1, barrier=(12.0675,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (74.0536,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.70086,0.0262286,-1.62552e-05,4.84162e-09,-5.79786e-13,-2823.56,17.1895], Tmin=(100,'K'), Tmax=(1888.29,'K')), NASAPolynomial(coeffs=[9.29594,0.0122579,-5.15725e-06,9.23407e-10,-6.10298e-14,-5314.22,-18.8202], Tmin=(1888.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-23.8802,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cds-OdCsH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-475.862,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2782.5,750,1395,475,1775,1000,182,240,577,636,1210,1413],'cm^-1')),
...
"""),
    E0 = (-340.48,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,253,525,597,667,842,1178,1324,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,180,180,897.995,899.266],'cm^-1')),
        HinderedRotor(inertia=(0.205988,'amu*angstrom^2'), symmetry=1, barrier=(4.73606,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.209869,'amu*angstrom^2'), symmetry=1, barrier=(4.82531,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.210786,'amu*angstrom^2'), symmetry=1, barrier=(4.84638,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.834307,0.077338,-0.000125977,1.13126e-07,-4.03541e-11,-40843.7,28.0323], Tmin=(100,'K'), Tmax=(795.04,'K')), NASAPolynomial(coeffs=[8.00628,0.0301065,-1.58326e-05,3.13026e-09,-2.20019e-13,-41631.8,-2.70754], Tmin=(795.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-340.48,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCFFO) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCJCO)"""),
)

species(
    label = 'OC=CC(F)(F)OF(2816)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {4,S}
4  O u0 p2 c0 {3,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.992857,'amu*angstrom^2'), symmetry=1, barrier=(22.8277,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.992833,'amu*angstrom^2'), symmetry=1, barrier=(22.8272,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.993918,'amu*angstrom^2'), symmetry=1, barrier=(22.8521,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0648005,0.0789016,-9.15577e-05,4.6928e-08,-8.31981e-12,-82647.4,24.4005], Tmin=(100,'K'), Tmax=(991.346,'K')), NASAPolynomial(coeffs=[21.4187,0.00619966,-1.91832e-06,3.42217e-10,-2.54437e-14,-87542.6,-81.7701], Tmin=(991.346,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-688.405,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(CsCFFO) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.252638,'amu*angstrom^2'), symmetry=1, barrier=(5.80865,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.252935,'amu*angstrom^2'), symmetry=1, barrier=(5.81547,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.72218,'amu*angstrom^2'), symmetry=1, barrier=(16.6043,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16767,0.0714355,-0.000125625,1.17963e-07,-4.26324e-11,-31153.3,23.4024], Tmin=(100,'K'), Tmax=(834.301,'K')), NASAPolynomial(coeffs=[6.3138,0.0282901,-1.48417e-05,2.89973e-09,-2.01129e-13,-31369.1,3.36053], Tmin=(834.301,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-259.798,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)CsHH) + group(CsCFHO) + group(Cds-OdCsH) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]C(F)(F)CC=O(2818)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u1 p2 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.223148,'amu*angstrom^2'), symmetry=1, barrier=(5.13062,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221238,'amu*angstrom^2'), symmetry=1, barrier=(5.08669,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51754,0.0597853,-8.91919e-05,7.70477e-08,-2.71494e-11,-67700.8,21.9716], Tmin=(100,'K'), Tmax=(767.927,'K')), NASAPolynomial(coeffs=[7.11616,0.0257001,-1.29972e-05,2.5522e-09,-1.79602e-13,-68415.6,-2.61501], Tmin=(767.927,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-563.599,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(CsCFFO) + group(Cds-OdCsH) + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
"""),
    E0 = (-529.098,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,223,363,546,575,694,1179,1410,1855,455,950,185.444,187.835],'cm^-1')),
        HinderedRotor(inertia=(0.311086,'amu*angstrom^2'), symmetry=1, barrier=(7.59393,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.303882,'amu*angstrom^2'), symmetry=1, barrier=(7.57616,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.662142,'amu*angstrom^2'), symmetry=1, barrier=(16.3445,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.689948,0.0798591,-0.000134757,1.17039e-07,-3.97118e-11,-63523.4,25.3421], Tmin=(100,'K'), Tmax=(815.194,'K')), NASAPolynomial(coeffs=[10.4268,0.0226021,-1.19566e-05,2.34724e-09,-1.63511e-13,-64795.9,-17.7108], Tmin=(815.194,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-529.098,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)CsHH) + group(CsCFFO) + group(Cds-OdCsH) + radical(CCCJ=O)"""),
)
...
"""),
    E0 = (-526.848,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,486,617,768,1157,1926,2782.5,750,1395,475,1775,1000,258.538],'cm^-1')),
        HinderedRotor(inertia=(0.109292,'amu*angstrom^2'), symmetry=1, barrier=(5.22676,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109798,'amu*angstrom^2'), symmetry=1, barrier=(5.22317,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.56659,0.0342428,-2.68709e-05,1.14579e-08,-2.13687e-12,-63315.9,18.4122], Tmin=(100,'K'), Tmax=(1192.99,'K')), NASAPolynomial(coeffs=[6.62179,0.020646,-9.77515e-06,1.90451e-09,-1.34888e-13,-64283.5,-1.86743], Tmin=(1192.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-526.848,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-O2d)HH) + group(COCsFO) + group(Cds-OdCsH)"""),
)

species(
    label = 'O=CC=C(F)OF(2822)',
    structure = adjacencyList("""1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {3,S}
3 O u0 p2 c0 {2,S} {6,S}
4 O u0 p2 c0 {7,D}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.197163,'amu*angstrom^2'), symmetry=1, barrier=(4.53318,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.614725,'amu*angstrom^2'), symmetry=1, barrier=(14.1337,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58716,0.0612434,-0.00010695,1.05461e-07,-4.09467e-11,-38111.2,20.8256], Tmin=(100,'K'), Tmax=(780.226,'K')), NASAPolynomial(coeffs=[4.80496,0.0295386,-1.67587e-05,3.41485e-09,-2.44088e-13,-38150.5,9.06655], Tmin=(780.226,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-317.531,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cd-Cd(CO)H) + group(CdCFO) + group(Cds-O2d(Cds-Cds)H)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'CC(F)(F)OF(2539)'],
    products = ['O=CCC(F)(F)OF(2748)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['FOF(377)', 'O=CC[C]F(2813)'],
    products = ['O=CCC(F)(F)OF(2748)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(133)', 'O=CC=C(F)F(2814)'],
    products = ['O=CCC(F)(F)OF(2748)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C[CH]C(F)(F)OF(2815)'],
    products = ['O=CCC(F)(F)OF(2748)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=CC[C](F)OF(2817)'],
    products = ['O=CCC(F)(F)OF(2748)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(F)(F)CC=O(2818)'],
    products = ['O=CCC(F)(F)OF(2748)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(129)', 'O=CC[C](F)F(2819)'],
    products = ['O=CCC(F)(F)OF(2748)'],
...
reaction(
    label = 'reaction12',
    reactants = ['FO[C](F)F(2234)', 'CH2CHO(35)'],
    products = ['O=CCC(F)(F)OF(2748)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HCO(15)', '[CH2]C(F)(F)OF(2555)'],
    products = ['O=CCC(F)(F)OF(2748)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C=CC(F)(F)OF(2820)'],
    products = ['O=CCC(F)(F)OF(2748)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'O=[C]CC(F)(F)OF(2821)'],
    products = ['O=CCC(F)(F)OF(2748)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(77)', 'O=CCC(=O)F(1244)'],
    products = ['O=CCC(F)(F)OF(2748)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=CC=C(F)OF(2822)'],
    products = ['O=CCC(F)(F)OF(2748)'],
