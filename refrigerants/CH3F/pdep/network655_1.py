...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(222)', '[CH2]C[O](224)'],
    products = ['[CH2]CO[C]=C(1815)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[C]=C(954)'],
    products = ['[CH2]CO[C]=C(1815)'],
    transitionState = 'TS3',
