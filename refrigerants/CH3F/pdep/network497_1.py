...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(222)', '[CH2]C([O])=O(434)'],
    products = ['[CH2]C(=O)O[C]=C(1386)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=[C]O[C]=O(794)'],
    products = ['[CH2]C(=O)O[C]=C(1386)'],
    transitionState = 'TS3',
