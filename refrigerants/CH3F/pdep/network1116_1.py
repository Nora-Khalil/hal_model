...
"""),
    E0 = (-561.161,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,791,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,182,240,577,636,1210,1413,180,1817.27],'cm^-1')),
        HinderedRotor(inertia=(0.12071,'amu*angstrom^2'), symmetry=1, barrier=(2.77536,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123578,'amu*angstrom^2'), symmetry=1, barrier=(2.84129,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122762,'amu*angstrom^2'), symmetry=1, barrier=(2.82255,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.98864,0.0759383,-0.000131066,1.23208e-07,-4.4732e-11,-67393,26.7889], Tmin=(100,'K'), Tmax=(833.319,'K')), NASAPolynomial(coeffs=[6.03249,0.0320242,-1.65523e-05,3.22241e-09,-2.23342e-13,-67549.6,7.47973], Tmin=(833.319,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-561.161,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = '[CH2]C(OF)C([O])(F)F(2775)',
...
"""),
    E0 = (-307.173,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,351,323,533,609,664,892,1120,1201,3000,3100,440,815,1455,1000,267.739,267.826],'cm^-1')),
        HinderedRotor(inertia=(0.125882,'amu*angstrom^2'), symmetry=1, barrier=(6.41239,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126008,'amu*angstrom^2'), symmetry=1, barrier=(6.41533,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.322594,'amu*angstrom^2'), symmetry=1, barrier=(16.4012,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.5013,0.0821708,-0.000121243,9.1116e-08,-2.70408e-11,-36823.1,26.7616], Tmin=(100,'K'), Tmax=(827.292,'K')), NASAPolynomial(coeffs=[13.0966,0.0212713,-1.0822e-05,2.13344e-09,-1.50828e-13,-38907.1,-31.6153], Tmin=(827.292,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-307.173,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(Cs-CsHHH) + radical(O2sj(Cs-CsF1sF1s)) + radical(CJCO)"""),
)

species(
    label = 'C[C](OF)C([O])(F)F(2776)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.203853,'amu*angstrom^2'), symmetry=1, barrier=(4.68697,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.20429,'amu*angstrom^2'), symmetry=1, barrier=(4.69702,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204433,'amu*angstrom^2'), symmetry=1, barrier=(4.70031,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.509323,0.0849281,-0.000143628,1.26534e-07,-4.33702e-11,-40613.2,26.5075], Tmin=(100,'K'), Tmax=(829.311,'K')), NASAPolynomial(coeffs=[9.88716,0.0263717,-1.36151e-05,2.64481e-09,-1.82985e-13,-41710.4,-14.2174], Tmin=(829.311,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-338.657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(Cs-CsHHH) + radical(O2sj(Cs-CsF1sF1s)) + radical(C2CsJO)"""),
)
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.240955,0.0897718,-0.000149057,1.26478e-07,-4.21678e-11,-39276.2,26.6032], Tmin=(100,'K'), Tmax=(793.005,'K')), NASAPolynomial(coeffs=[12.2591,0.0233643,-1.24984e-05,2.47263e-09,-1.73355e-13,-41000.3,-27.4427], Tmin=(793.005,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-327.63,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = 'C=C(OF)C(=O)F(2784)',
    structure = adjacencyList("""1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {3,S}
3 O u0 p2 c0 {2,S} {5,S}
4 O u0 p2 c0 {6,D}
...
"""),
    E0 = (-368.805,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,255,533,799,832,1228,2950,3100,1380,975,1025,1650,210.216,212.284],'cm^-1')),
        HinderedRotor(inertia=(0.464008,'amu*angstrom^2'), symmetry=1, barrier=(14.6502,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00481657,'amu*angstrom^2'), symmetry=1, barrier=(31.5629,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57052,0.0569986,-7.65959e-05,5.37949e-08,-1.51251e-11,-44272.7,19.6777], Tmin=(100,'K'), Tmax=(867.368,'K')), NASAPolynomial(coeffs=[10.0584,0.0178529,-8.89408e-06,1.75518e-09,-1.2483e-13,-45745,-20.0631], Tmin=(867.368,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-368.805,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cds-Cds(Cds-O2d)O2s) + group(COCFO) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['OF(133)', 'C=C([C]F)OF(1847)'],
    products = ['C=C(OF)C(O)(F)F(2751)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(OF)C([O])(F)F(2775)'],
    products = ['C=C(OF)C(O)(F)F(2751)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(OF)=C(O)F(2777)'],
    products = ['C=C(OF)C(O)(F)F(2751)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C([O])C(O)(F)F(2778)'],
    products = ['C=C(OF)C(O)(F)F(2751)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', 'C=C(OF)[C](F)F(2779)'],
    products = ['C=C(OF)C(O)(F)F(2751)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C=C(OF)C([O])(F)F(2780)'],
    products = ['C=C(OF)C(O)(F)F(2751)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(129)', 'C=[C]C(O)(F)F(2781)'],
    products = ['C=C(OF)C(O)(F)F(2751)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[C](F)F(2111)', 'C=[C]OF(600)'],
    products = ['C=C(OF)C(O)(F)F(2751)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH]=C(OF)C(O)(F)F(2782)'],
    products = ['C=C(OF)C(O)(F)F(2751)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]C(OF)C(O)(F)F(2783)'],
    products = ['C=C(OF)C(O)(F)F(2751)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'C=C(OF)C(=O)F(2784)'],
    products = ['C=C(OF)C(O)(F)F(2751)'],
