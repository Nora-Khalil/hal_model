...
reaction(
    label = 'reaction5',
    reactants = ['H2(8)', 'F[C]CC(F)OF(881)'],
    products = ['FCCC(F)OF(853)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]CC(F)OF(883)'],
    products = ['FCCC(F)OF(853)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(129)', 'F[CH]CCF(636)'],
    products = ['FCCC(F)OF(853)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH]OF(188)', 'CH2F-CH2(61)'],
    products = ['FCCC(F)OF(853)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH2F(45)', '[CH2]C(F)OF(511)'],
    products = ['FCCC(F)OF(853)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'FC[CH]C(F)OF(885)'],
    products = ['FCCC(F)OF(853)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'F[CH]CC(F)OF(887)'],
    products = ['FCCC(F)OF(853)'],
...
reaction(
    label = 'reaction21',
    reactants = ['FCCC(F)OF(853)'],
    products = ['F2(77)', 'CHFO(46)', 'C2H4(30)'],
