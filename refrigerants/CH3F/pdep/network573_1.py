...
"""),
    E0 = (-185.695,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,1855,455,950,289.403,289.454,1539.32],'cm^-1')),
        HinderedRotor(inertia=(0.00432699,'amu*angstrom^2'), symmetry=1, barrier=(7.276,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.74468,'amu*angstrom^2'), symmetry=1, barrier=(44.274,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.744883,'amu*angstrom^2'), symmetry=1, barrier=(44.2737,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.21215,0.0433795,-4.99336e-05,4.31125e-08,-1.71849e-11,-22273.4,20.593], Tmin=(100,'K'), Tmax=(689.268,'K')), NASAPolynomial(coeffs=[3.83047,0.0307808,-1.55367e-05,3.09303e-09,-2.21201e-13,-22420.3,13.9404], Tmin=(689.268,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-185.695,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCOJ) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (-138.18,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1855,455,950,555.553,556.347,556.556],'cm^-1')),
        HinderedRotor(inertia=(0.205854,'amu*angstrom^2'), symmetry=1, barrier=(45.136,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205898,'amu*angstrom^2'), symmetry=1, barrier=(45.1407,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.84977,0.00210847,0.000101038,-1.34651e-07,5.13792e-11,-60021.1,16.5835], Tmin=(100,'K'), Tmax=(965.86,'K')), NASAPolynomial(coeffs=[15.1153,0.0103729,-3.51921e-06,8.27021e-10,-7.42854e-14,-65145.2,-56.4256], Tmin=(965.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-499.562,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsOs) + ring(Cyclobutane)"""),
)

species(
    label = 'CC(=O)OC=O(1728)',
...
"""),
    E0 = (-344.109,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1855,455,950,211.543,462.385,462.389,462.39,2193.8,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0556865,'amu*angstrom^2'), symmetry=1, barrier=(8.44908,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0556868,'amu*angstrom^2'), symmetry=1, barrier=(8.44911,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.209124,'amu*angstrom^2'), symmetry=1, barrier=(31.7283,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28559,0.0406005,-4.6514e-05,3.12303e-08,-8.85018e-12,-41327.5,20.2311], Tmin=(100,'K'), Tmax=(843.504,'K')), NASAPolynomial(coeffs=[6.70114,0.019661,-9.27647e-06,1.79886e-09,-1.27015e-13,-42072.4,-0.319746], Tmin=(843.504,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-344.109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)

species(
    label = 'C[C](O)O[C]=O(1730)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02236,0.0452123,-4.17828e-05,2.05275e-08,-4.20294e-12,-24724.9,21.103], Tmin=(100,'K'), Tmax=(1143.69,'K')), NASAPolynomial(coeffs=[8.97877,0.0208822,-9.87221e-06,1.9262e-09,-1.36808e-13,-26316,-13.3915], Tmin=(1143.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-206.154,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(Cs_P) + radical((O)CJOC)"""),
)

species(
    label = 'CC(=O)O[CH][O](1731)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {5,S} {6,S}
2  O u0 p2 c0 {5,D}
3  O u1 p2 c0 {6,S}
...
"""),
    E0 = (-199.811,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,1855,455,950,180,900.106],'cm^-1')),
        HinderedRotor(inertia=(0.0270129,'amu*angstrom^2'), symmetry=1, barrier=(3.75182,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0503192,'amu*angstrom^2'), symmetry=1, barrier=(29.2372,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.17854,'amu*angstrom^2'), symmetry=1, barrier=(50.0889,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.552798,'amu*angstrom^2'), symmetry=1, barrier=(12.7099,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.062,'amu'),
...
"""),
    E0 = (-170.555,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2782.5,750,1395,475,1775,1000,433.658,433.798,434.099],'cm^-1')),
        HinderedRotor(inertia=(0.000894212,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000895372,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000893687,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.89681,0.0339437,-1.8885e-05,4.34285e-09,-3.75696e-13,-20483.8,20.0908], Tmin=(100,'K'), Tmax=(2644.36,'K')), NASAPolynomial(coeffs=[17.4876,0.011873,-6.36561e-06,1.18662e-09,-7.73052e-14,-28200.5,-64.4899], Tmin=(2644.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-170.555,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCOJ) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CO[C]=O(406)'],
    products = ['CC([O])O[C]=O(1706)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['[O][C]=O(163)', 'C[CH][O](1712)'],
    products = ['CC([O])O[C]=O(1706)'],
