...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.17376,'amu*angstrom^2'), symmetry=1, barrier=(26.987,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17253,'amu*angstrom^2'), symmetry=1, barrier=(26.9588,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07973,0.048402,-1.06532e-05,-3.79387e-08,2.26032e-11,-64991,21.3206], Tmin=(100,'K'), Tmax=(931.675,'K')), NASAPolynomial(coeffs=[21.765,5.75247e-05,2.03352e-06,-3.99655e-10,2.12714e-14,-70601.6,-86.4349], Tmin=(931.675,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-541.361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFFOO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(O2sj(Cs-F1sF1sO2s))"""),
)
...
"""),
    E0 = (-417.638,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,375,486,586,623,710,938,1161,1294,3000,3100,440,815,1455,1000,180,358.586,2717.89],'cm^-1')),
        HinderedRotor(inertia=(0.173417,'amu*angstrom^2'), symmetry=1, barrier=(3.98719,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.731951,'amu*angstrom^2'), symmetry=1, barrier=(16.829,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.31237,'amu*angstrom^2'), symmetry=1, barrier=(30.1739,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33587,0.0606444,-6.74866e-05,3.93023e-08,-9.25132e-12,-50136,23.3452], Tmin=(100,'K'), Tmax=(1024.05,'K')), NASAPolynomial(coeffs=[11.3552,0.0215089,-1.01632e-05,1.98496e-09,-1.41252e-13,-52188.1,-25.2306], Tmin=(1024.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-417.638,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s)) + radical(CJCO)"""),
)

species(
    label = '[CH2][CH]OC(O)(F)F(2690)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.578479,0.0787914,-0.000114458,8.348e-08,-2.3801e-11,-60460.4,24.61], Tmin=(100,'K'), Tmax=(864.246,'K')), NASAPolynomial(coeffs=[13.797,0.0176132,-8.27806e-06,1.57628e-09,-1.09285e-13,-62745.3,-37.2335], Tmin=(864.246,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-503.695,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsFFOO) + radical(CCsJOCs) + radical(CJCO)"""),
)

species(
    label = 'C[CH]O[C](F)OF(2691)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {6,S} {7,S}
...
"""),
    E0 = (-428.965,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,482,586,761,1411,180,180,180,798.263],'cm^-1')),
        HinderedRotor(inertia=(0.00693198,'amu*angstrom^2'), symmetry=1, barrier=(3.13373,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0665639,'amu*angstrom^2'), symmetry=1, barrier=(30.1021,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.3095,'amu*angstrom^2'), symmetry=1, barrier=(30.108,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38676,0.0493024,-3.36478e-05,7.28353e-09,6.78401e-13,-51491.6,24.5477], Tmin=(100,'K'), Tmax=(1140.77,'K')), NASAPolynomial(coeffs=[13.9759,0.0173605,-7.69019e-06,1.4893e-09,-1.06423e-13,-55157.7,-41.3251], Tmin=(1140.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-428.965,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(Cs-CsHHH) + group(CsFHOO) + radical(O2sj(Cs-F1sO2sH)) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(285)', '[CH]C-2(183)'],
    products = ['C[CH]OC([O])(F)F(2676)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C[CH]OC(=O)F(2688)'],
    products = ['C[CH]OC([O])(F)F(2676)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction14',
    reactants = ['CC(F)O[C]([O])F(2692)'],
    products = ['C[CH]OC([O])(F)F(2676)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(218.999,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
