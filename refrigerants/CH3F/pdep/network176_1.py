...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(250)', 'CH2(T)(18)'],
    products = ['[CH2]OC([O])=O(405)'],
    transitionState = 'TS2',
