...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O=CO[C](F)OF(458)'],
    products = ['O=COC(F)(F)OF(2259)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[O]C(F)(F)OC=O(2401)'],
    products = ['O=COC(F)(F)OF(2259)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['FO[C](F)F(2234)', '[O]C=O(146)'],
    products = ['O=COC(F)(F)OF(2259)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)(F)OF(2351)', 'HCO(15)'],
    products = ['O=COC(F)(F)OF(2259)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(129)', 'O=CO[C](F)F(2180)'],
    products = ['O=COC(F)(F)OF(2259)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OC(F)(F)OF(2402)'],
    products = ['O=COC(F)(F)OF(2259)'],
    transitionState = 'TS9',
