...
"""),
    E0 = (-628.454,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,519,593,830,1115,1166,1389,1413,3114,180,180,180,875.703],'cm^-1')),
        HinderedRotor(inertia=(0.0937216,'amu*angstrom^2'), symmetry=1, barrier=(2.15484,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0936346,'amu*angstrom^2'), symmetry=1, barrier=(2.15284,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
...
"""),
    E0 = (-510.106,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,493,600,700,1144,1293,180,180,1078.52,4000],'cm^-1')),
        HinderedRotor(inertia=(0.366813,'amu*angstrom^2'), symmetry=1, barrier=(8.43375,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.54825,'amu*angstrom^2'), symmetry=1, barrier=(35.5974,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.54867,'amu*angstrom^2'), symmetry=1, barrier=(35.607,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.031,'amu'),
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)F(189)', '[CH2]OF(152)'],
    products = ['FOCOC(F)F(2621)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(129)', '[CH2]OC(F)F(541)'],
    products = ['FOCOC(F)F(2621)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'FO[CH]OC(F)F(2353)'],
    products = ['FOCOC(F)F(2621)'],
    transitionState = 'TS9',
