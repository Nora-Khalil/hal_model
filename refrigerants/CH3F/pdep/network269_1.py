...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'O=[C]O[CH]F(259)'],
    products = ['[CH2]C(F)O[C]=O(620)'],
    transitionState = 'TS3',
