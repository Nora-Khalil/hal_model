...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(2043)', '[O]C([O])=O(250)'],
    products = ['[O]C(=O)O[C](F)F(2212)'],
    transitionState = 'TS2',
