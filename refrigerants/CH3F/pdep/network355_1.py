...
reaction(
    label = 'reaction2',
    reactants = ['CH4(4)', 'F[C]COF(515)'],
    products = ['CC(F)COF(850)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'CC(F)OF(857)'],
    products = ['CC(F)COF(850)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(129)', '[CH2]C(C)F(786)'],
    products = ['CC(F)COF(850)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]OF(152)', 'CH3-CHF(62)'],
    products = ['CC(F)COF(850)'],
