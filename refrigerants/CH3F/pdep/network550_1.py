...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH2]C(=O)OC=O(1578)'],
    products = ['C=C(OF)OC=O(1560)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C=O(146)', 'C=[C]OF(600)'],
    products = ['C=C(OF)OC=O(1560)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HCO(15)', '[CH2]C(=O)OF(928)'],
    products = ['C=C(OF)OC=O(1560)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(129)', 'C=[C]OC=O(1259)'],
    products = ['C=C(OF)OC=O(1560)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH]=C(OF)OC=O(1579)'],
    products = ['C=C(OF)OC=O(1560)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C=C(OF)O[C]=O(1580)'],
    products = ['C=C(OF)OC=O(1560)'],
