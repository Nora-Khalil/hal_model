...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(222)', '[CH2]C([O])F(354)'],
    products = ['[CH2]C(F)O[C]=C(831)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=[C]O[CH]F(766)'],
    products = ['[CH2]C(F)O[C]=C(831)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C#COC([CH2])F(1058)'],
    products = ['[CH2]C(F)O[C]=C(831)'],
