...
"""),
    E0 = (-615.724,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,1855,455,950,180,314.114],'cm^-1')),
        HinderedRotor(inertia=(0.0174061,'amu*angstrom^2'), symmetry=1, barrier=(26.2051,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14126,'amu*angstrom^2'), symmetry=1, barrier=(26.2399,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-810.484,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,335.211,336.413,344.122,347.09,403.016,1492.96,1496.63,1497.59],'cm^-1')),
        HinderedRotor(inertia=(0.405027,'amu*angstrom^2'), symmetry=1, barrier=(30.4856,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0015398,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19711,0.0388594,-3.53083e-05,1.56909e-08,-2.80011e-12,-97413.3,20.1259], Tmin=(100,'K'), Tmax=(1326.17,'K')), NASAPolynomial(coeffs=[10.5593,0.0136376,-6.78082e-06,1.3502e-09,-9.67356e-14,-99631.3,-22.5775], Tmin=(1326.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-810.484,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(CsFFHO) + group(Cds-OdOsOs) + radical(OC=OOJ)"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=C(O)O[CH]F(528)'],
    products = ['O=C(O)OC(F)F(419)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)F(189)', 'O=[C]O(145)'],
    products = ['O=C(O)OC(F)F(419)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(=O)OC(F)F(530)'],
    products = ['O=C(O)OC(F)F(419)'],
