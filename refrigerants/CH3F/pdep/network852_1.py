...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)(OF)O[CH]O(2143)'],
    products = ['O=COC(O)(F)OF(2112)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=CO[C](O)OF(2144)'],
    products = ['O=COC(O)(F)OF(2112)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(O)(F)OC=O(2145)'],
    products = ['O=COC(O)(F)OF(2112)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C=O(146)', 'O[C](F)OF(1952)'],
    products = ['O=COC(O)(F)OF(2112)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['HCO(15)', '[O]C(O)(F)OF(2146)'],
    products = ['O=COC(O)(F)OF(2112)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', 'O=CO[C](F)OF(458)'],
    products = ['O=COC(O)(F)OF(2112)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(F)(OF)OC=O(2147)'],
    products = ['O=COC(O)(F)OF(2112)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(129)', 'O=CO[C](O)F(2148)'],
    products = ['O=COC(O)(F)OF(2112)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=[C]OC(O)(F)OF(2149)'],
    products = ['O=COC(O)(F)OF(2112)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=COC(O)(F)OF(2112)'],
    products = ['O=C(F)OF(286)', 'O=CO(160)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(77)', 'O=COC(=O)O(2150)'],
    products = ['O=COC(O)(F)OF(2112)'],
