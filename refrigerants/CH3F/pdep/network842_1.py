...
"""),
    ...
    molecularWeight = (115.013,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50503,0.0487393,-5.10866e-05,2.274e-08,-3.15763e-12,631.327,27.1587], Tmin=(100,'K'), Tmax=(1027.26,'K')), NASAPolynomial(coeffs=[15.2654,0.00516468,-2.06997e-06,4.11381e-10,-3.11917e-14,-2723.72,-42.1668], Tmin=(1027.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(4.45752,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(166.289,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2sFO) + group(CsFHHO) + radical(CsF1sHO2s)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[O]OC(F)F(2051)'],
    products = ['[O]OOOC(F)F(2072)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]OOOC(F)F(2072)'],
    products = ['[O-][O+]=O(195)', '[O]C(F)F(189)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]O[O](130)', '[O]C(F)F(189)'],
    products = ['[O]OOOC(F)F(2072)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]OOO[C](F)F(2108)'],
    products = ['[O]OOOC(F)F(2072)'],
    transitionState = 'TS9',
