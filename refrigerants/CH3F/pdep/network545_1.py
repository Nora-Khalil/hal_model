...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'O=C=CC(=O)F(2185)'],
    products = ['O=C(O)CC(=O)F(1555)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'O=[C]CC(=O)O(2194)'],
    products = ['O=C(O)CC(=O)F(1555)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(7)', 'O=[C]CC(=O)F(1247)'],
    products = ['O=C(O)CC(=O)F(1555)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C(=O)CC(=O)F(1786)'],
    products = ['O=C(O)CC(=O)F(1555)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C(O)[CH]C(=O)F(1788)'],
    products = ['O=C(O)CC(=O)F(1555)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'O=C=CC(=O)O(804)'],
    products = ['O=C(O)CC(=O)F(1555)'],
