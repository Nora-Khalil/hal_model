...
"""),
    E0 = (121.543,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,326,540,652,719,1357,3010,987.5,1337.5,450,1655,401.783,401.786,401.801,401.802],'cm^-1')),
        HinderedRotor(inertia=(0.446793,'amu*angstrom^2'), symmetry=1, barrier=(51.1833,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.446761,'amu*angstrom^2'), symmetry=1, barrier=(51.1832,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0441,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06611,0.0417304,-3.31757e-05,1.35176e-08,-2.26923e-12,14688.3,19.1387], Tmin=(100,'K'), Tmax=(1378.11,'K')), NASAPolynomial(coeffs=[9.83827,0.0191712,-8.62066e-06,1.63879e-09,-1.14288e-13,12546.1,-20.85], Tmin=(1378.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(121.543,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC([O])(F)F(2221)'],
    products = ['CF2O(48)', 'C2H2(23)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C=C(F)F(2448)'],
    products = ['[CH]=CC([O])(F)F(2221)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[O][C](F)F(2208)', 'C2H2(23)'],
    products = ['[CH]=CC([O])(F)F(2221)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C](F)F(2208)', '[CH]=[CH](223)'],
    products = ['[CH]=CC([O])(F)F(2221)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['HF(38)', '[CH]=C=C([O])F(2450)'],
    products = ['[CH]=CC([O])(F)F(2221)'],
    transitionState = 'TS9',
