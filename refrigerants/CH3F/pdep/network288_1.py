...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]C(F)[CH]F(210)'],
    products = ['[CH2]C(F)C([O])F(638)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C(F)[CH]F(694)'],
    products = ['[CH2]C(F)C([O])F(638)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH2]C(F)C=O(699)'],
    products = ['[CH2]C(F)C([O])F(638)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(F)C(=O)F(700)'],
    products = ['[CH2]C(F)C([O])F(638)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[CH2]C(F)=C[O](702)'],
    products = ['[CH2]C(F)C([O])F(638)'],
