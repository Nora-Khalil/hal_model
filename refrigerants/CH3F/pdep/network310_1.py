...
"""),
    ...
    molecularWeight = (86.0461,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97497,0.0222969,5.23336e-05,-1.04483e-07,4.75688e-11,4134.86,18.0734], Tmin=(100,'K'), Tmax=(911.965,'K')), NASAPolynomial(coeffs=[22.35,-0.00872047,7.37663e-06,-1.45909e-09,9.34971e-14,-2007.84,-91.6501], Tmin=(911.965,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(33.6001,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cds-OdCsOs) + ring(cyclopropanone) + radical(C=OCOJ) + radical(CJC(O)2C)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]C([O])=C=O(256)'],
    products = ['[CH2]C(=O)C([O])=O(805)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C([O])=C=O(1016)'],
    products = ['[CH2]C(=O)C([O])=O(805)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction14',
    reactants = ['[O][C]=O(163)', '[CH2][C]=O(552)'],
    products = ['[CH2]C(=O)C([O])=O(805)'],
