...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)C([O])F(638)'],
    products = ['[O]C(F)C[CH]F(639)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)C[CH]F(678)'],
    products = ['[O]C(F)C[CH]F(639)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[O]C=C[CH]F(679)'],
    products = ['[O]C(F)C[CH]F(639)'],
