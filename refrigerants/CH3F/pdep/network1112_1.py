...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.892248,0.0744727,-0.000115382,9.82782e-08,-3.36865e-11,-129494,24.552], Tmin=(100,'K'), Tmax=(769.894,'K')), NASAPolynomial(coeffs=[9.19769,0.0268239,-1.3784e-05,2.71434e-09,-1.90956e-13,-130640,-12.4793], Tmin=(769.894,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1077.56,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(CsCFFO) + group(COCsFO)"""),
)

species(
    label = '[CH2]C(F)OC([O])(F)F(2903)',
...
"""),
    E0 = (-642.236,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,375,486,586,623,710,938,1161,1294,3000,3100,440,815,1455,1000,180,180,1448.67],'cm^-1')),
        HinderedRotor(inertia=(0.407158,'amu*angstrom^2'), symmetry=1, barrier=(9.36135,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.727477,'amu*angstrom^2'), symmetry=1, barrier=(16.7261,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.59807,'amu*angstrom^2'), symmetry=1, barrier=(36.7427,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07074,0.067933,-7.89169e-05,4.68733e-08,-1.12207e-11,-77140.6,25.535], Tmin=(100,'K'), Tmax=(1007.26,'K')), NASAPolynomial(coeffs=[12.447,0.0227571,-1.16431e-05,2.34846e-09,-1.69936e-13,-79432.4,-29.4313], Tmin=(1007.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-642.236,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(Cs-CsHHH) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)

species(
    label = 'C[C](F)OC([O])(F)F(2904)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-660.412,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,375,486,586,623,710,938,1161,1294,395,473,707,1436,199.584,200.421,200.747],'cm^-1')),
        HinderedRotor(inertia=(0.161614,'amu*angstrom^2'), symmetry=1, barrier=(4.61227,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.163254,'amu*angstrom^2'), symmetry=1, barrier=(4.61401,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.80554,'amu*angstrom^2'), symmetry=1, barrier=(23.0279,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13859,0.0678505,-8.33483e-05,5.40402e-08,-1.42661e-11,-79330.3,24.7133], Tmin=(100,'K'), Tmax=(913.661,'K')), NASAPolynomial(coeffs=[10.95,0.0248963,-1.28283e-05,2.58413e-09,-1.86464e-13,-81123.1,-21.7349], Tmin=(913.661,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-660.412,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(Cs-CsHHH) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s)) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs))"""),
)
...
"""),
    E0 = (-554.77,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,326,540,652,719,1357,482,586,761,1411,2950,3100,1380,975,1025,1650,184.814,186.066,1223.81],'cm^-1')),
        HinderedRotor(inertia=(1.11716,'amu*angstrom^2'), symmetry=1, barrier=(25.6857,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.565057,'amu*angstrom^2'), symmetry=1, barrier=(14.7246,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.958381,'amu*angstrom^2'), symmetry=1, barrier=(23.0187,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13823,0.0579512,-6.1194e-05,3.12926e-08,-6.21326e-12,-66616.2,23.1484], Tmin=(100,'K'), Tmax=(1233.94,'K')), NASAPolynomial(coeffs=[15.3858,0.011766,-5.05102e-06,9.60278e-10,-6.79171e-14,-70132.4,-48.5832], Tmin=(1233.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-554.77,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFHOO) + group(CdCFO) + group(Cds-CdsHH) + radical(CsF1sO2sO2s)"""),
)

species(
    label = 'C=[C]OC(O)(F)F(2906)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.861721,'amu*angstrom^2'), symmetry=1, barrier=(19.8127,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.862877,'amu*angstrom^2'), symmetry=1, barrier=(19.8393,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.862619,'amu*angstrom^2'), symmetry=1, barrier=(19.8333,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.70678,0.0627143,-6.99607e-05,3.67087e-08,-7.29321e-12,-68203.4,24.8923], Tmin=(100,'K'), Tmax=(1304.88,'K')), NASAPolynomial(coeffs=[18.469,0.00570518,-1.48372e-06,2.19942e-10,-1.42772e-14,-72620.9,-64.6918], Tmin=(1304.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-568.13,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFFOO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.7389,'amu*angstrom^2'), symmetry=1, barrier=(39.9808,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.73561,'amu*angstrom^2'), symmetry=1, barrier=(39.905,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.73586,'amu*angstrom^2'), symmetry=1, barrier=(39.9108,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.556468,0.0857177,-0.000147624,1.36271e-07,-4.88861e-11,-75495.5,35.9235], Tmin=(100,'K'), Tmax=(823.576,'K')), NASAPolynomial(coeffs=[7.63481,0.0327577,-1.73239e-05,3.40129e-09,-2.36961e-13,-76031.2,6.97425], Tmin=(823.576,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-628.656,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsFFOO) + group(CsCFHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)OC(O)(F)F(2909)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
4  O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.645718,0.0806192,-0.000122569,9.88674e-08,-3.21173e-11,-80509.9,24.6035], Tmin=(100,'K'), Tmax=(751.871,'K')), NASAPolynomial(coeffs=[10.8426,0.0263702,-1.43396e-05,2.90174e-09,-2.07956e-13,-82043.3,-21.6826], Tmin=(751.871,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-670.349,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsFFOO) + group(CsCFHO) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = 'C=C(F)OC(=O)F(2910)',
...
"""),
    E0 = (-860.791,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,201.542,201.589,201.604,201.647,201.652,201.661],'cm^-1')),
        HinderedRotor(inertia=(1.43307,'amu*angstrom^2'), symmetry=1, barrier=(41.353,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.43381,'amu*angstrom^2'), symmetry=1, barrier=(41.3516,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(F)OC([O])(F)F(2903)'],
    products = ['C=C(F)OC(O)(F)F(2747)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'C=C(F)O[C](O)F(2905)'],
    products = ['C=C(F)OC(O)(F)F(2747)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=[C]OC(O)(F)F(2906)'],
    products = ['C=C(F)OC(O)(F)F(2747)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O[C](F)F(2111)', 'CH2CFO(78)'],
    products = ['C=C(F)OC(O)(F)F(2747)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(O)(F)F(290)', 'CH2CF(69)'],
    products = ['C=C(F)OC(O)(F)F(2747)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OH(7)', 'C=C(F)O[C](F)F(2333)'],
    products = ['C=C(F)OC(O)(F)F(2747)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=C(F)OC([O])(F)F(2533)'],
    products = ['C=C(F)OC(O)(F)F(2747)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH]=C(F)OC(O)(F)F(2907)'],
    products = ['C=C(F)OC(O)(F)F(2747)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]C(F)OC(O)(F)F(2909)'],
    products = ['C=C(F)OC(O)(F)F(2747)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'C=C(F)OC(=O)F(2910)'],
    products = ['C=C(F)OC(O)(F)F(2747)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'C#COC(O)(F)F(2233)'],
    products = ['C=C(F)OC(O)(F)F(2747)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(S)(25)', 'OC(F)(F)[O+]=[C-]F(2911)'],
    products = ['C=C(F)OC(O)(F)F(2747)'],
...
network(
    ...
    reactants = [
        ...
        ('O[C](F)F(2111)', 'CH2CFO(78)'),
        ('[O]C(O)(F)F(290)', 'CH2CF(69)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
