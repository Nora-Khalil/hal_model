...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(O)=C([O])OF(1970)'],
    products = ['[O]C(=O)C([O])(O)F(1947)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[O]C(O)(F)[C]=O(1971)'],
    products = ['[O]C(=O)C([O])(O)F(1947)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[O]C(=O)C([O])=O(228)'],
    products = ['[O]C(=O)C([O])(O)F(1947)'],
