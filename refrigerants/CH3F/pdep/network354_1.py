...
reaction(
    label = 'reaction1',
    reactants = ['FCCCOF(849)'],
    products = ['HF(38)', 'CH2O(20)', 'CH2CHF(55)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]OF(152)', 'CH2F-CH2(61)'],
    products = ['FCCCOF(849)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction16',
    reactants = ['FCCCOF(849)'],
    products = ['F2(77)', 'CH2O(20)', 'C2H4(30)'],
