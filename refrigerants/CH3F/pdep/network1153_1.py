...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC(O)O(3058)'],
    products = ['O=C(F)OC(O)O(3017)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)F(148)', 'O[CH]O(2982)'],
    products = ['O=C(F)OC(O)O(3017)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', 'O=C(F)O[CH]O(492)'],
    products = ['O=C(F)OC(O)O(3017)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(O)OC(=O)F(3059)'],
    products = ['O=C(F)OC(O)O(3017)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)O[C](O)O(2169)'],
    products = ['O=C(F)OC(O)O(3017)'],
