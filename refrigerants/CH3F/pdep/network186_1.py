...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)F(148)', 'O[CH]F(187)'],
    products = ['O=C(F)OC(O)F(415)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', 'O=C(F)O[CH]F(205)'],
    products = ['O=C(F)OC(O)F(415)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(F)OC(=O)F(302)'],
    products = ['O=C(F)OC(O)F(415)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)O[C](O)F(494)'],
    products = ['O=C(F)OC(O)F(415)'],
