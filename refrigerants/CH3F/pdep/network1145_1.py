...
"""),
    E0 = (-591.372,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,351,323,533,609,664,892,1120,1201,180,2881.51],'cm^-1')),
        HinderedRotor(inertia=(0.261221,'amu*angstrom^2'), symmetry=1, barrier=(6.00598,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.261375,'amu*angstrom^2'), symmetry=1, barrier=(6.00952,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(4421.29,'J/mol'), sigma=(6.93662,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=690.60 K, Pc=30.06 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    ...
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76923,0.0519299,-6.08838e-05,3.72081e-08,-9.21083e-12,-125044,20.0843], Tmin=(100,'K'), Tmax=(974.007,'K')), NASAPolynomial(coeffs=[9.94103,0.0183711,-9.20336e-06,1.83568e-09,-1.31927e-13,-126636,-19.1249], Tmin=(974.007,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1040.32,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsOs)"""),
)
...
"""),
    ...
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25332,0.0661708,-0.000102949,7.69125e-08,-2.08449e-11,-73492.8,24.5209], Tmin=(100,'K'), Tmax=(657.703,'K')), NASAPolynomial(coeffs=[11.0395,0.0156343,-8.17468e-06,1.60816e-09,-1.12622e-13,-74974.3,-20.0681], Tmin=(657.703,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-611.831,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFFO) + radical(O2sj(Cs-CsF1sF1s)) + radical(Cs_P)"""),
)

species(
    label = '[O][C](O)C(O)(F)F(3065)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {6,S} {8,S}
...
"""),
    ...
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20787,0.0700741,-0.000127973,1.18882e-07,-4.22356e-11,-77615,25.6264], Tmin=(100,'K'), Tmax=(836.058,'K')), NASAPolynomial(coeffs=[7.60148,0.0225485,-1.23199e-05,2.43168e-09,-1.69066e-13,-78092.1,-0.534324], Tmin=(836.058,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-646.094,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFFO) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[O]C([O])C(O)(F)F(3066)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {6,S} {9,S}
...
"""),
    ...
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51295,0.0668579,-0.000130903,1.33429e-07,-5.08068e-11,-75168.7,24.0091], Tmin=(100,'K'), Tmax=(839.148,'K')), NASAPolynomial(coeffs=[3.10859,0.0312728,-1.72805e-05,3.4274e-09,-2.38955e-13,-74451.4,22.4605], Tmin=(839.148,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-625.635,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFFO) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[O][CH]C(F)(F)OO(3068)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {4,S} {6,S}
...
"""),
    E0 = (-286.703,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,1380,1390,370,380,2900,435,395,473,707,1436,257.549,257.55,2463.19],'cm^-1')),
        HinderedRotor(inertia=(0.213662,'amu*angstrom^2'), symmetry=1, barrier=(10.0571,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.213666,'amu*angstrom^2'), symmetry=1, barrier=(10.0571,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.213663,'amu*angstrom^2'), symmetry=1, barrier=(10.0571,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.988107,0.0749624,-0.000137897,1.24698e-07,-4.26761e-11,-34382.3,26.5373], Tmin=(100,'K'), Tmax=(863.135,'K')), NASAPolynomial(coeffs=[9.06782,0.0195237,-1.02806e-05,1.97547e-09,-1.34285e-13,-35106.8,-7.37045], Tmin=(863.135,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-286.703,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + radical(O2sj(Cs-CsF1sH)) + radical(CsCsF1sO2s)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[O]C(F)(F)[CH]O(2316)'],
    products = ['[O]C(O)C([O])(F)F(2490)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[O]C(O)[C](F)F(3061)'],
    products = ['[O]C(O)C([O])(F)F(2490)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(7)', '[O]C(F)(F)C=O(2287)'],
    products = ['[O]C(O)C([O])(F)F(2490)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)(F)C(=O)O(2415)'],
    products = ['[O]C(O)C([O])(F)F(2490)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(O)C(=O)F(3063)'],
    products = ['[O]C(O)C([O])(F)F(2490)'],
