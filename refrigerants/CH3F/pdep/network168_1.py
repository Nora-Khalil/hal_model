...
"""),
    E0 = (-699.524,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,509,613,660,1171,1360,1414,3084,548,1085,1183,1302,1466,1520,3060,3119,180,180,180,577.761],'cm^-1')),
        HinderedRotor(inertia=(0.672905,'amu*angstrom^2'), symmetry=1, barrier=(15.4714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.213796,'amu*angstrom^2'), symmetry=1, barrier=(4.91559,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.65391,'amu*angstrom^2'), symmetry=1, barrier=(38.0267,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-600.058,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([451,553,637,1069,1180,1265,1301,3056,548,1085,1183,1302,1466,1520,3060,3119,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.816753,'amu*angstrom^2'), symmetry=1, barrier=(18.7787,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.818593,'amu*angstrom^2'), symmetry=1, barrier=(18.8211,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
...
"""),
    E0 = (-435.618,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([548,1085,1183,1302,1466,1520,3060,3119,580,1155,1237,1373,3147,180,180,2482.13],'cm^-1')),
        HinderedRotor(inertia=(0.494443,'amu*angstrom^2'), symmetry=1, barrier=(11.3682,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14401,'amu*angstrom^2'), symmetry=1, barrier=(26.303,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-492.048,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,548,1085,1183,1302,1466,1520,3060,3119,482,586,761,1411,289.777,290.348,290.971,2476.09],'cm^-1')),
        HinderedRotor(inertia=(0.191518,'amu*angstrom^2'), symmetry=1, barrier=(11.4805,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.669129,'amu*angstrom^2'), symmetry=1, barrier=(39.9712,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.669359,'amu*angstrom^2'), symmetry=1, barrier=(39.9889,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86127,0.051643,-6.38305e-05,4.33328e-08,-1.21937e-11,-59106.6,22.1114], Tmin=(100,'K'), Tmax=(853.037,'K')), NASAPolynomial(coeffs=[8.22982,0.0217796,-1.13175e-05,2.29236e-09,-1.65847e-13,-60193.1,-7.60087], Tmin=(853.037,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-492.048,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsF1sO2sO2s)"""),
)

species(
    label = 'F[CH]OC(F)OF(369)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.241756,'amu*angstrom^2'), symmetry=1, barrier=(5.55845,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.241365,'amu*angstrom^2'), symmetry=1, barrier=(5.54946,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-576.141,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([548,1085,1183,1302,1466,1520,3060,3119,2782.5,750,1395,475,1775,1000,229.225,1748.21],'cm^-1')),
        HinderedRotor(inertia=(0.648943,'amu*angstrom^2'), symmetry=1, barrier=(24.2423,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11409,'amu*angstrom^2'), symmetry=1, barrier=(41.6092,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-812.152,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([548,1085,1183,1302,1466,1520,3060,3119,482,664,788,1296,1923,180,180,467.168],'cm^-1')),
        HinderedRotor(inertia=(1.26308,'amu*angstrom^2'), symmetry=1, barrier=(29.0408,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0193287,'amu*angstrom^2'), symmetry=1, barrier=(26.7699,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(39)', 'OC(F)OF(364)'],
    products = ['FCOC(F)OF(340)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['FOC(F)OF(365)', 'CH2(S)(25)'],
    products = ['FCOC(F)OF(340)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH2]OC(F)OF(367)'],
    products = ['FCOC(F)OF(340)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F[CH]OF(188)', '[O]CF(131)'],
    products = ['FCOC(F)OF(340)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)OF(289)', 'CH2F(45)'],
    products = ['FCOC(F)OF(340)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(129)', 'F[CH]OCF(244)'],
    products = ['FCOC(F)OF(340)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[CH]OC(F)OF(369)'],
    products = ['FCOC(F)OF(340)'],
...
reaction(
    label = 'reaction14',
    reactants = ['FCOC(F)OF(340)'],
    products = ['F2(77)', 'CHFO(46)', 'CH2O(20)'],
