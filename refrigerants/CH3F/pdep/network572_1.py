...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(250)', '[CH]C-2(183)'],
    products = ['C[CH]OC([O])=O(1705)'],
    transitionState = 'TS2',
