...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(285)', '[C]=C(222)'],
    products = ['C=[C]OC([O])(F)F(2225)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=[C]OC(=O)F(1260)'],
    products = ['C=[C]OC([O])(F)F(2225)'],
    transitionState = 'TS6',
