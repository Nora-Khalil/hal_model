...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(125)', '[CH2]O[CH2](441)'],
    products = ['[CH2]OC[C]=O(1376)'],
    transitionState = 'TS3',
