...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(127)', '[CH2]C[O](224)'],
    products = ['[O]CC[CH]F(625)'],
    transitionState = 'TS3',
