...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'CCOF(956)'],
    products = ['CCC(=O)OF(1832)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'CC(=O)OF(932)'],
    products = ['CCC(=O)OF(1832)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(19)', '[CH2]C(=O)OF(928)'],
    products = ['CCC(=O)OF(1832)'],
