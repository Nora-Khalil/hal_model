...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]C(O)OC=O(3037)'],
    products = ['O=COC(O)OF(3016)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C=O(146)', 'O[CH]OF(2983)'],
    products = ['O=COC(O)OF(3016)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HCO(15)', '[O]C(O)OF(1942)'],
    products = ['O=COC(O)OF(3016)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(OF)OC=O(3038)'],
    products = ['O=COC(O)OF(3016)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(129)', 'O=CO[CH]O(3039)'],
    products = ['O=COC(O)OF(3016)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=CO[C](O)OF(2144)'],
    products = ['O=COC(O)OF(3016)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'O=[C]OC(O)OF(3040)'],
    products = ['O=COC(O)OF(3016)'],
