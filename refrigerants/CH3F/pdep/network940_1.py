...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C([O])(F)F(285)'],
    products = ['[O]OC([O])(F)F(1840)'],
    transitionState = 'TS2',
