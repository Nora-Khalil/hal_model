...
"""),
    E0 = (-1035.25,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,509,613,660,1171,1360,1414,3084,200,800,960,1120,1280,1440,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17129,0.0535494,-4.50399e-05,1.35105e-08,-5.0616e-14,-124402,23.205], Tmin=(100,'K'), Tmax=(1066.74,'K')), NASAPolynomial(coeffs=[16.4931,0.0104848,-4.71615e-06,9.53964e-10,-7.11268e-14,-128489,-55.5407], Tmin=(1066.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1035.25,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(CsFHOO) + group(Cds-OdOsOs)"""),
)
...
"""),
    E0 = (-552.954,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,509,613,660,1171,1360,1414,3084,1380,1390,370,380,2900,435,180,1602.83,1603.05,1606.24,1607.36],'cm^-1')),
        HinderedRotor(inertia=(0.210222,'amu*angstrom^2'), symmetry=1, barrier=(4.83342,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.209676,'amu*angstrom^2'), symmetry=1, barrier=(4.82086,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.209056,'amu*angstrom^2'), symmetry=1, barrier=(4.8066,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94592,0.073306,-0.000186041,2.27351e-07,-9.52602e-11,-66458.3,23.0783], Tmin=(100,'K'), Tmax=(850.224,'K')), NASAPolynomial(coeffs=[-11.1899,0.0614067,-3.50258e-05,6.98808e-09,-4.86986e-13,-61560.9,99.9846], Tmin=(850.224,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-552.954,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFHOO) + radical(OCOJ) + radical(OCOJ)"""),
)

species(
    label = '[O]C(O)O[C](O)F(3057)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  O u0 p2 c0 {6,S} {7,S}
3  O u0 p2 c0 {6,S} {9,S}
...
"""),
    E0 = (-779.715,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,451,553,637,1069,1180,1265,1301,3056,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68213,0.0406254,-1.6782e-05,-1.30175e-08,8.86017e-12,-93685.5,22.9054], Tmin=(100,'K'), Tmax=(1011.28,'K')), NASAPolynomial(coeffs=[15.3352,0.00935568,-4.12093e-06,8.65489e-10,-6.72969e-14,-97609.3,-48.8636], Tmin=(1011.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-779.715,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(CsFHOO) + group(Cds-OdOsOs) + radical(O2sj(Cs-F1sO2sH))"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=C(O)O[CH]O(3071)'],
    products = ['O=C(O)OC(O)F(3021)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)O(309)', 'O[CH]F(187)'],
    products = ['O=C(O)OC(O)F(3021)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O=[C]O(145)', '[O]C(O)F(310)'],
    products = ['O=C(O)OC(O)F(3021)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', 'O=C(O)O[CH]F(528)'],
    products = ['O=C(O)OC(O)F(3021)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(F)OC(=O)O(3072)'],
    products = ['O=C(O)OC(O)F(3021)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]C(=O)OC(O)F(2156)'],
    products = ['O=C(O)OC(O)F(3021)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C(O)O[C](O)F(2175)'],
    products = ['O=C(O)OC(O)F(3021)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=COC(=O)O(2150)'],
    products = ['O=C(O)OC(O)F(3021)'],
