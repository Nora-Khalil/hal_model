...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C[O](181)', '[CH]C-2(183)'],
    products = ['[CH]=CO[CH]C(2727)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=[CH](223)', 'C[CH][O](1712)'],
    products = ['[CH]=CO[CH]C(2727)'],
    transitionState = 'TS9',
