...
"""),
    E0 = (-475.513,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,493,600,700,1144,1293,180,180,1136.95,1137.52],'cm^-1')),
        HinderedRotor(inertia=(0.264746,'amu*angstrom^2'), symmetry=1, barrier=(6.08704,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.265604,'amu*angstrom^2'), symmetry=1, barrier=(6.10676,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.264939,'amu*angstrom^2'), symmetry=1, barrier=(6.09147,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3921,0.064637,-0.000107092,9.94463e-08,-3.64577e-11,-57104.2,25.5352], Tmin=(100,'K'), Tmax=(797.884,'K')), NASAPolynomial(coeffs=[6.37268,0.027494,-1.43773e-05,2.85602e-09,-2.0142e-13,-57511.4,5.05967], Tmin=(797.884,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-475.513,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-O2sHH)(F1s)(H)) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
"""),
    ...
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.969244,0.073605,-0.000123775,1.09263e-07,-3.77284e-11,-60824.7,25.3957], Tmin=(100,'K'), Tmax=(811.454,'K')), NASAPolynomial(coeffs=[9.23749,0.0229657,-1.19003e-05,2.34325e-09,-1.63923e-13,-61841.2,-10.7617], Tmin=(811.454,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-506.577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sHH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(2043)', '[O]C[CH]F(353)'],
    products = ['F[CH]CO[C](F)F(2248)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(127)', '[CH2]O[C](F)F(2310)'],
    products = ['F[CH]CO[C](F)F(2248)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['F[CH]CO[C](F)F(2248)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(71.8898,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['CHF(39)', '[CH2]O[C](F)F(2310)'],
    products = ['F[CH]CO[C](F)F(2248)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(42)', '[O]C[CH]F(353)'],
    products = ['F[CH]CO[C](F)F(2248)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(128827,'m^3/(mol*s)'), n=0.469398, Ea=(5.06664,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R"""),
)

reaction(
    label = 'reaction12',
    reactants = ['F[CH]CO[C](F)F(2248)'],
    products = ['FC[CH]O[C](F)F(2322)'],
