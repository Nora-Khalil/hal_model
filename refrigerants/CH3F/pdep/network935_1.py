...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)O[C](F)F(2246)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(2043)', '[CH2]C([O])F(354)'],
    products = ['[CH2]C(F)O[C](F)F(2246)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[CH]O[C](F)F(2276)'],
    products = ['[CH2]C(F)O[C](F)F(2246)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=CO[C](F)F(2332)'],
    products = ['[CH2]C(F)O[C](F)F(2246)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=C(F)O[C](F)F(2333)'],
    products = ['[CH2]C(F)O[C](F)F(2246)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(42)', '[CH2]C([O])F(354)'],
    products = ['[CH2]C(F)O[C](F)F(2246)'],
...
network(
    label = 'PDepNetwork #935',
    isomers = [
        '[CH2]C(F)O[C](F)F(2246)',
    ],
    reactants = [
        ('CF2O(48)', 'CH2CHF(55)'),
    ],
