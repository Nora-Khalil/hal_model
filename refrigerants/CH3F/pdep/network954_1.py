...
"""),
    E0 = (-356.091,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([947,1033,1057,1169,295.185,295.236,295.239,295.244,295.246,295.25],'cm^-1')),
        HinderedRotor(inertia=(0.689655,'amu*angstrom^2'), symmetry=1, barrier=(42.6711,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.689827,'amu*angstrom^2'), symmetry=1, barrier=(42.6716,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94607,0.0370648,-2.83502e-05,3.06774e-09,2.66225e-12,-42746.9,15.0068], Tmin=(100,'K'), Tmax=(1056.01,'K')), NASAPolynomial(coeffs=[14.9885,0.00320464,-2.33079e-06,5.78812e-10,-4.80317e-14,-46368,-52.7292], Tmin=(1056.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-356.091,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(Cds-OdOsOs)"""),
)
...
"""),
    E0 = (-453.022,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,493,600,700,1144,1293,180,180,1748.05,1748.06,1748.17],'cm^-1')),
        HinderedRotor(inertia=(0.198359,'amu*angstrom^2'), symmetry=1, barrier=(4.56066,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.196888,'amu*angstrom^2'), symmetry=1, barrier=(4.52685,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.195658,'amu*angstrom^2'), symmetry=1, barrier=(4.49855,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41076,0.0812519,-0.000194199,2.20097e-07,-8.81286e-11,-54416.2,26.679], Tmin=(100,'K'), Tmax=(852.044,'K')), NASAPolynomial(coeffs=[-4.65563,0.0483409,-2.81843e-05,5.63949e-09,-3.92669e-13,-51154,68.0513], Tmin=(852.044,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-453.022,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFFHO) + radical(OCOJ) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = 'O[C](OF)O[C](F)F(2430)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {8,S}
2 F u0 p3 c0 {8,S}
3 F u0 p3 c0 {5,S}
...
"""),
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3148.49,'J/mol'), sigma=(5.03581,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=491.79 K, Pc=55.94 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'O=C(O)OF(448)'],
    products = ['O=C(OF)OC(F)F(2263)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=C(OF)OF(449)', 'CHF(39)'],
    products = ['O=C(OF)OC(F)F(2263)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(OF)O[CH]F(454)'],
    products = ['O=C(OF)OC(F)F(2263)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(=O)OC(F)F(530)'],
    products = ['O=C(OF)OC(F)F(2263)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)OF(453)', 'CHF2(81)'],
    products = ['O=C(OF)OC(F)F(2263)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O=[C]OF(147)', '[O]C(F)F(189)'],
    products = ['O=C(OF)OC(F)F(2263)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(129)', 'O=[C]OC(F)F(529)'],
    products = ['O=C(OF)OC(F)F(2263)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C(OF)O[C](F)F(2431)'],
    products = ['O=C(OF)OC(F)F(2263)'],
