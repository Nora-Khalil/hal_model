...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(O)(F)F(1843)'],
    products = ['HO2(11)', 'CF2O(48)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(O)(F)F(290)'],
    products = ['[O]OC(O)(F)F(1843)'],
    transitionState = 'TS2',
