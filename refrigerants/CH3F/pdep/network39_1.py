...
"""),
    ...
    molecularWeight = (77.0162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.392,-0.0130638,0.000122745,-1.65738e-07,6.6949e-11,20205.8,15.5163], Tmin=(100,'K'), Tmax=(917.311,'K')), NASAPolynomial(coeffs=[18.7242,-0.0116083,8.65963e-06,-1.64162e-09,1.01624e-13,14518.9,-72.7952], Tmin=(917.311,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(167.614,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(Cs-OsOsHH) + ring(Cyclopentane) + radical(OCJO)"""),
)
...
"""),
    ...
    molecularWeight = (77.0162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.01893,-0.000678159,3.41608e-05,-3.16527e-08,8.31058e-12,7470.14,12.7748], Tmin=(100,'K'), Tmax=(1326.63,'K')), NASAPolynomial(coeffs=[3.20499,0.0209823,-1.20465e-05,2.48073e-09,-1.78295e-13,5996,10.5618], Tmin=(1326.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(62.1176,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsOs) + group(Cs-OsOsOsH) + ring(Cyclobutane) + radical(OCOJ)"""),
)
...
"""),
    E0 = (-144.907,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,549.307,549.309,549.313,549.314,549.316,549.316],'cm^-1')),
        HinderedRotor(inertia=(0.213289,'amu*angstrom^2'), symmetry=1, barrier=(45.6696,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.213292,'amu*angstrom^2'), symmetry=1, barrier=(45.6698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000558687,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (77.0162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.51338,0.0172313,3.23951e-05,-6.79303e-08,3.08617e-11,-17360.4,17.3666], Tmin=(100,'K'), Tmax=(924.331,'K')), NASAPolynomial(coeffs=[16.9624,-0.00532849,4.14546e-06,-7.76018e-10,4.65524e-14,-21738.9,-60.4407], Tmin=(924.331,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-144.907,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(120.56,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-OsOs) + group(O2s-OsH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OOC=O(167)'],
    products = ['[CH]1OOOO1(171)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.12332e+09,'s^-1'), n=0.5388, Ea=(356.964,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra] for rate rule [R5_SS_CO;carbonyl_intra_H;radadd_intra_O]
Euclidian distance = 2.449489742783178
family: Intra_R_Add_Endocyclic
Ea raised from 354.7 to 357.0 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['[O]OOC=O(167)'],
    products = ['[O]C1OOO1(172)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(2.724e+10,'s^-1'), n=0.478, Ea=(251.468,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_O] for rate rule [R5_SS_CO;carbonylbond_intra_H;radadd_intra_O]
