...
"""),
    ...
    molecularWeight = (108.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67384,0.0469594,-5.2121e-05,2.80554e-08,-5.8273e-12,-24383.5,23.9171], Tmin=(100,'K'), Tmax=(1187.06,'K')), NASAPolynomial(coeffs=[13.1665,0.00823332,-3.18602e-06,5.73188e-10,-3.94632e-14,-27112,-33.4989], Tmin=(1187.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-203.462,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFHOO) + ring(dioxirane) + radical(Cs_P) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)

species(
    label = '[O][C]1OC(O)(F)O1(1968)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {6,S} {7,S}
3 O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (108.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.84987,0.0484491,-0.000131767,1.74882e-07,-7.71457e-11,-56635,20.8631], Tmin=(100,'K'), Tmax=(839.919,'K')), NASAPolynomial(coeffs=[-11.8418,0.0554805,-3.19283e-05,6.42586e-09,-4.51389e-13,-51947.1,102.394], Tmin=(839.919,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-471.047,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(CsFOOO) + group(Cs-OsOsOsH) + ring(O2s-Cs-O2s-Cs(F)) + radical(OCOJ) + radical(Cs_P)"""),
)

species(
    label = '[O]C1([O])OC1(O)F(1969)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {6,S} {7,S}
3 O u0 p2 c0 {6,S} {8,S}
...
"""),
    ...
    molecularWeight = (108.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.1664,0.0503378,-9.54311e-05,9.94898e-08,-3.85284e-11,-49578,21.7044], Tmin=(100,'K'), Tmax=(847.777,'K')), NASAPolynomial(coeffs=[1.59712,0.0290005,-1.51728e-05,2.95211e-09,-2.03864e-13,-48618.1,29.4485], Tmin=(847.777,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-412.683,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(CsCFOO) + ring(Cs(F)(O2)-O2s-Cs) + radical(CCOJ) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(250)', 'O[C]F(1303)'],
    products = ['[O]C(=O)O[C](O)F(585)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]C(=O)OC(=O)F(283)'],
    products = ['[O]C(=O)O[C](O)F(585)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C([O])=O(250)', '[OH+]=[C-]F(1359)'],
    products = ['[O]C(=O)O[C](O)F(585)'],
