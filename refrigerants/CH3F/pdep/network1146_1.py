...
"""),
    E0 = (-594.676,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,486,586,623,710,938,1161,1294,3025,407.5,1350,352.5,464.907,465.079,465.133],'cm^-1')),
        HinderedRotor(inertia=(0.0950289,'amu*angstrom^2'), symmetry=1, barrier=(2.1849,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.539087,'amu*angstrom^2'), symmetry=1, barrier=(12.3947,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.53907,'amu*angstrom^2'), symmetry=1, barrier=(12.3943,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11598,0.0647377,-8.98872e-05,6.03868e-08,-1.56859e-11,-71420.2,23.3681], Tmin=(100,'K'), Tmax=(950.756,'K')), NASAPolynomial(coeffs=[13.8736,0.0110624,-5.20161e-06,1.00391e-09,-7.07422e-14,-73846,-37.5356], Tmin=(950.756,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-594.676,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(CsFFOO) + group(Cs-OsOsHH) + radical(O2sj(Cs-F1sF1sO2s)) + radical(OCJO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.216148,'amu*angstrom^2'), symmetry=1, barrier=(4.96967,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.215845,'amu*angstrom^2'), symmetry=1, barrier=(4.96271,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216422,'amu*angstrom^2'), symmetry=1, barrier=(4.97597,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (-763.472,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([375,486,586,623,710,938,1161,1294,2782.5,750,1395,475,1775,1000,805.837,1505.13],'cm^-1')),
        HinderedRotor(inertia=(1.57507,'amu*angstrom^2'), symmetry=1, barrier=(36.2139,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57526,'amu*angstrom^2'), symmetry=1, barrier=(36.2184,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00685,0.0371,-2.51038e-05,4.68021e-09,7.59607e-13,-91747.1,20.8435], Tmin=(100,'K'), Tmax=(1171.65,'K')), NASAPolynomial(coeffs=[12.414,0.0118129,-5.84356e-06,1.18276e-09,-8.62513e-14,-94888.9,-34.0139], Tmin=(1171.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-763.472,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(CsFFOO) + group(Cds-OdOsH) + radical(O2sj(Cs-F1sF1sO2s))"""),
)
...
"""),
    E0 = (-556.238,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([375,486,586,623,710,938,1161,1294,2750,2850,1437.5,1250,1305,750,350,434.385,434.703,434.94,435.192],'cm^-1')),
        HinderedRotor(inertia=(0.0118534,'amu*angstrom^2'), symmetry=1, barrier=(1.59567,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244981,'amu*angstrom^2'), symmetry=1, barrier=(33.1211,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
...
"""),
    ...
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24563,0.0727616,-0.000141786,1.40644e-07,-5.22619e-11,-76140,22.4701], Tmin=(100,'K'), Tmax=(844.651,'K')), NASAPolynomial(coeffs=[4.59391,0.0295111,-1.6329e-05,3.22617e-09,-2.23975e-13,-75728.4,12.6665], Tmin=(844.651,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-633.791,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(CsFFOO) + group(Cs-OsOsHH) + radical(OCOJ) + radical(OCJO)"""),
)

species(
    label = 'O[CH]O[C](F)OF(456)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {4,S}
3 O u0 p2 c0 {6,S} {7,S}
...
"""),
    E0 = (-288.372,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,482,586,761,1411,3025,407.5,1350,352.5,373.141,375.934,381.419,381.655],'cm^-1')),
        HinderedRotor(inertia=(0.066926,'amu*angstrom^2'), symmetry=1, barrier=(7.05652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137512,'amu*angstrom^2'), symmetry=1, barrier=(14.22,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0675778,'amu*angstrom^2'), symmetry=1, barrier=(7.08326,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.382897,'amu*angstrom^2'), symmetry=1, barrier=(39.8689,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.853187,0.0735225,-0.000118351,9.37249e-08,-2.88567e-11,-34573.8,25.1062], Tmin=(100,'K'), Tmax=(802.605,'K')), NASAPolynomial(coeffs=[12.787,0.0140465,-7.1943e-06,1.39359e-09,-9.64972e-14,-36489.4,-29.8431], Tmin=(802.605,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-288.372,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(CsFHOO) + group(Cs-OsOsHH) + radical(CsF1sO2sO2s) + radical(OCJO)"""),
)

species(
    label = '[O][C](F)OC(O)F(2487)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {7,S}
3 O u0 p2 c0 {6,S} {7,S}
...
"""),
    E0 = (-593.5,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,509,613,660,1171,1360,1414,3084,482,586,761,1411,180,180,899.461,901.892],'cm^-1')),
        HinderedRotor(inertia=(0.154984,'amu*angstrom^2'), symmetry=1, barrier=(3.56338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.738944,'amu*angstrom^2'), symmetry=1, barrier=(16.9898,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.58591,'amu*angstrom^2'), symmetry=1, barrier=(36.4632,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49866,0.0520881,-5.60822e-05,2.93266e-08,-5.98401e-12,-71289,24.5693], Tmin=(100,'K'), Tmax=(1197.09,'K')), NASAPolynomial(coeffs=[13.6369,0.0115287,-5.25952e-06,1.02299e-09,-7.30639e-14,-74195.1,-36.1742], Tmin=(1197.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-593.5,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(CsFHOO) + group(CsFHOO) + radical(O2sj(Cs-F1sO2sH)) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(285)', '[CH]O(175)'],
    products = ['[O]C(F)(F)O[CH]O(3011)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'O[CH]O[C](F)F(2313)'],
    products = ['[O]C(F)(F)O[CH]O(3011)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[O][C](F)F(2208)', 'O=CO(160)'],
    products = ['[O]C(F)(F)O[CH]O(3011)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[O]C(F)(F)OC=O(2401)'],
    products = ['[O]C(F)(F)O[CH]O(3011)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=C(F)O[CH]O(492)'],
    products = ['[O]C(F)(F)O[CH]O(3011)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][C](F)F(2208)', '[O][CH]O(161)'],
    products = ['[O]C(F)(F)O[CH]O(3011)'],
