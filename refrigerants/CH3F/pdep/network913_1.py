...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=O)O[C](F)F(2224)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(2043)', '[CH2]C([O])=O(434)'],
    products = ['[CH2]C(=O)O[C](F)F(2224)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'O=[C]O[C](F)F(2179)'],
    products = ['[CH2]C(=O)O[C](F)F(2224)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=O)O[C](F)F(2224)'],
    products = ['[CH2][C]1OC(F)(F)O1(2424)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(42)', '[CH2]C([O])=O(434)'],
    products = ['[CH2]C(=O)O[C](F)F(2224)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O(6)', 'C=[C]O[C](F)F(2394)'],
    products = ['[CH2]C(=O)O[C](F)F(2224)'],
