...
reaction(
    label = 'reaction3',
    reactants = ['H2O(3)', 'F[C]CC(F)F(1148)'],
    products = ['OC(F)CC(F)F(855)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['HF(38)', 'OC(F)C[C]F(1150)'],
    products = ['OC(F)CC(F)F(855)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H2O(3)', 'FC=CC(F)F(1151)'],
    products = ['OC(F)CC(F)F(855)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OC(F)F(247)', 'CH2CHF(55)'],
    products = ['OC(F)CC(F)F(855)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O[CH]CC(F)F(1152)'],
    products = ['OC(F)CC(F)F(855)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'OC(F)C[CH]F(1153)'],
    products = ['OC(F)CC(F)F(855)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', 'F[CH]CC(F)F(1154)'],
    products = ['OC(F)CC(F)F(855)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]C(F)CC(F)F(1155)'],
    products = ['OC(F)CC(F)F(855)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[CH]F(187)', 'CHF2-CH2(63)'],
    products = ['OC(F)CC(F)F(855)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF2(81)', '[CH2]C(O)F(519)'],
    products = ['OC(F)CC(F)F(855)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'OC(F)[CH]C(F)F(1156)'],
    products = ['OC(F)CC(F)F(855)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'O[C](F)CC(F)F(1157)'],
    products = ['OC(F)CC(F)F(855)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'OC(F)C[C](F)F(1158)'],
    products = ['OC(F)CC(F)F(855)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=CCC(F)F(1159)'],
    products = ['OC(F)CC(F)F(855)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'OC=CC(F)F(1160)'],
    products = ['OC(F)CC(F)F(855)'],
