...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)F(148)', '[O]C=O(146)'],
    products = ['O=COOC(=O)F(1951)'],
    transitionState = 'TS8',
