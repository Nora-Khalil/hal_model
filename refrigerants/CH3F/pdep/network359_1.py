...
"""),
    E0 = (-574.335,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,250,417,511,1155,1315,1456,3119,261,493,600,1152,1365,1422,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,180,1803.15],'cm^-1')),
        HinderedRotor(inertia=(0.406269,'amu*angstrom^2'), symmetry=1, barrier=(9.34092,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14111,'amu*angstrom^2'), symmetry=1, barrier=(26.2364,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14128,'amu*angstrom^2'), symmetry=1, barrier=(26.2403,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-146.33,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([353,444,1253,3145,2750,2800,2850,1350,1500,750,1050,1375,1000,617,898,1187,180,902.487,1750.72],'cm^-1')),
        HinderedRotor(inertia=(0.311837,'amu*angstrom^2'), symmetry=1, barrier=(7.16975,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-188.516,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,487,638,688,1119,1325,1387,3149,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180,1532.96],'cm^-1')),
        HinderedRotor(inertia=(0.284464,'amu*angstrom^2'), symmetry=1, barrier=(6.54039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.282244,'amu*angstrom^2'), symmetry=1, barrier=(6.48934,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.77944,'amu*angstrom^2'), symmetry=1, barrier=(40.9128,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.41146,0.0423009,-1.56498e-05,-4.69664e-08,5.45313e-11,-22623.6,18.8068], Tmin=(100,'K'), Tmax=(453.168,'K')), NASAPolynomial(coeffs=[4.6608,0.0325073,-1.65342e-05,3.32514e-09,-2.39748e-13,-22930.8,8.59561], Tmin=(453.168,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-188.516,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(Cs-HHH)(H))"""),
)

species(
    label = 'CC(F)[CH]OF(864)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {3,S}
...
"""),
    E0 = (-485.349,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,2750,2800,2850,1350,1500,750,1050,1375,1000,391,562,707,872,1109,1210,1289,3137,180],'cm^-1')),
        HinderedRotor(inertia=(0.495852,'amu*angstrom^2'), symmetry=1, barrier=(11.4006,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.386444,'amu*angstrom^2'), symmetry=1, barrier=(8.8851,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.67443,0.0284733,3.45949e-05,-1.1502e-07,8.33824e-11,-58372.1,11.5637], Tmin=(10,'K'), Tmax=(489.442,'K')), NASAPolynomial(coeffs=[3.83211,0.0373836,-2.39693e-05,7.32411e-09,-8.5583e-13,-58509.7,9.66775], Tmin=(489.442,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-485.349,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), label="""CC(F)C([O])F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-312.451,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,2750,2800,2850,1350,1500,750,1050,1375,1000,334,575,1197,1424,3202,1765.88],'cm^-1')),
        HinderedRotor(inertia=(0.511255,'amu*angstrom^2'), symmetry=1, barrier=(11.7548,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14705,'amu*angstrom^2'), symmetry=1, barrier=(26.373,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.0686,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.85419,0.0142849,0.00011651,-4.34986e-07,5.32255e-10,-37579.6,10.5141], Tmin=(10,'K'), Tmax=(206.881,'K')), NASAPolynomial(coeffs=[2.87798,0.03316,-2.03466e-05,6.03443e-09,-6.90885e-13,-37539.3,13.6856], Tmin=(206.881,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-312.451,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), label="""CC(F)[CH]F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.259708,'amu*angstrom^2'), symmetry=1, barrier=(5.97119,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.257405,'amu*angstrom^2'), symmetry=1, barrier=(5.91826,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.702933,'amu*angstrom^2'), symmetry=1, barrier=(16.1618,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03072,0.0753585,-0.000131199,1.25135e-07,-4.60473e-11,-45869.1,23.0681], Tmin=(100,'K'), Tmax=(827.923,'K')), NASAPolynomial(coeffs=[5.55931,0.0329501,-1.71711e-05,3.36677e-09,-2.34506e-13,-45915.4,6.32449], Tmin=(827.923,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-382.186,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(Cs-HHH)(F1s))"""),
)

species(
    label = 'CC(F)[C](F)OF(868)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.180107,'amu*angstrom^2'), symmetry=1, barrier=(4.14101,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.181225,'amu*angstrom^2'), symmetry=1, barrier=(4.16671,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.880066,'amu*angstrom^2'), symmetry=1, barrier=(20.2345,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96806,0.0548404,-3.59096e-05,-5.53884e-08,7.96842e-11,-45456.3,20.3995], Tmin=(100,'K'), Tmax=(459.488,'K')), NASAPolynomial(coeffs=[6.98888,0.02981,-1.51711e-05,2.98806e-09,-2.10337e-13,-46114.8,-2.06423], Tmin=(459.488,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-378.465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s)"""),
)

species(
    label = '[CH2]C(F)C(F)OF(869)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.341388,'amu*angstrom^2'), symmetry=1, barrier=(10.0566,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.344005,'amu*angstrom^2'), symmetry=1, barrier=(10.0589,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-41.9143,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,185.434],'cm^-1')),
        HinderedRotor(inertia=(0.368404,'amu*angstrom^2'), symmetry=1, barrier=(9.4927,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.40615,'amu*angstrom^2'), symmetry=1, barrier=(9.48416,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (76.0696,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0691162,'amu*angstrom^2'), symmetry=1, barrier=(1.58912,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.717511,'amu*angstrom^2'), symmetry=1, barrier=(16.497,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-656.18,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([206,363,518,1175,1317,1481,3059,2750,2800,2850,1350,1500,750,1050,1375,1000,486,617,768,1157,1926,180],'cm^-1')),
        HinderedRotor(inertia=(0.252963,'amu*angstrom^2'), symmetry=1, barrier=(5.81611,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.252976,'amu*angstrom^2'), symmetry=1, barrier=(5.81641,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)C(F)OF(854)'],
    products = ['HF(38)', 'CHFO(46)', 'CH2CHF(55)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(42.5689,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH4(4)', 'F[C]C(F)OF(370)'],
    products = ['CC(F)C(F)OF(854)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.33549e-06,'m^3/(mol*s)'), n=3.38172, Ea=(56.4561,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_N-3Br1sCCl1sF1sHI1s->F1s_N-3Br1sCCl1sH->Cl1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_N-3Br1sCCl1sF1sHI1s->F1s_N-3Br1sCCl1sH->Cl1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 4.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['FCOF(246)', 'C[C]F(606)'],
    products = ['CC(F)C(F)OF(854)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(6.67744e-07,'m^3/(mol*s)'), n=3.38172, Ea=(51.1581,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_N-3Br1sCCl1sF1sHI1s->F1s_N-3Br1sCCl1sH->Cl1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_N-3Br1sCCl1sF1sHI1s->F1s_N-3Br1sCCl1sH->Cl1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CHF(39)', 'CC(F)OF(857)'],
    products = ['CC(F)C(F)OF(854)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(5.7066e-06,'m^3/(mol*s)'), n=3.19155, Ea=(226.246,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_2Br1sCl1sF1sHI1s->H_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CC_2Br1sCl1sF1sHI1s->H_3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction5',
    reactants = ['OF(133)', 'CC(F)[C]F(858)'],
    products = ['CC(F)C(F)OF(854)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.76395e-12,'m^3/(mol*s)'), n=5.02686, Ea=(46.7142,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s"""),
)

reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(25)', 'FCC(F)OF(859)'],
    products = ['CC(F)C(F)OF(854)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[CH]C(F)OF(863)'],
    products = ['CC(F)C(F)OF(854)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(129)', 'CC(F)[CH]F(866)'],
    products = ['CC(F)C(F)OF(854)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]OF(188)', 'CH3-CHF(62)'],
    products = ['CC(F)C(F)OF(854)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(19)', 'F[CH]C(F)OF(381)'],
    products = ['CC(F)C(F)OF(854)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH2]C(F)C(F)OF(869)'],
    products = ['CC(F)C(F)OF(854)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(77)', 'CC(F)C=O(731)'],
    products = ['CC(F)C(F)OF(854)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(71.5115,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction20',
    reactants = ['F2(77)', 'CC=COF(870)'],
    products = ['CC(F)C(F)OF(854)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(6.77019,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'CC(F)=COF(871)'],
    products = ['CC(F)C(F)OF(854)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(241.943,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'CC(F)C(=O)F(696)'],
    products = ['CC(F)C(F)OF(854)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(480.532,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'CC=C(F)OF(872)'],
    products = ['CC(F)C(F)OF(854)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(241.907,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'C=CC(F)OF(873)'],
    products = ['CC(F)C(F)OF(854)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(25.0352,'m^3/(mol*s)'), n=1.25316, Ea=(213.57,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_N-5R!H->F',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_N-5R!H->F"""),
)
