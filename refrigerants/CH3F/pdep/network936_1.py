...
"""),
    E0 = (-461.659,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,486,617,768,1157,1926,180,2379.54],'cm^-1')),
        HinderedRotor(inertia=(0.510714,'amu*angstrom^2'), symmetry=1, barrier=(11.7423,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.78998,'amu*angstrom^2'), symmetry=1, barrier=(41.1553,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-184.277,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,395,473,707,1436,334,575,1197,1424,3202,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.238791,'amu*angstrom^2'), symmetry=1, barrier=(5.49027,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.239364,'amu*angstrom^2'), symmetry=1, barrier=(5.50344,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17715,'amu*angstrom^2'), symmetry=1, barrier=(27.065,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.805951,0.0785719,-0.000137267,1.23366e-07,-4.27308e-11,-22056.4,24.6682], Tmin=(100,'K'), Tmax=(835.354,'K')), NASAPolynomial(coeffs=[9.13366,0.0238533,-1.23601e-05,2.41244e-09,-1.67123e-13,-22929.8,-10.9104], Tmin=(835.354,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-184.277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)

species(
    label = '[O][C](F)CC(F)F(2330)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56337,0.0513105,-4.69918e-05,2.11116e-08,-3.77197e-12,-60446.3,22.8653], Tmin=(100,'K'), Tmax=(1336.47,'K')), NASAPolynomial(coeffs=[13.2462,0.0163447,-7.7479e-06,1.53587e-09,-1.10157e-13,-63569.1,-36.8858], Tmin=(1336.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-503.323,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-CsHH)(F1s)(O2s-H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C[CH]F(2247)'],
    products = ['CF2O(48)', 'CH2CHF(55)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)C([O])(F)F(2245)'],
    products = ['[O]C(F)(F)C[CH]F(2247)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(127)', '[CH2]C([O])(F)F(1793)'],
    products = ['[O]C(F)(F)C[CH]F(2247)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[CH]C[C](F)F(2093)'],
    products = ['[O]C(F)(F)C[CH]F(2247)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C(F)C[CH]F(678)'],
    products = ['[O]C(F)(F)C[CH]F(2247)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(4.08261e+20,'m^3/(mol*s)'), n=-5.07836, Ea=(30.7146,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O"""),
)

reaction(
    label = 'reaction10',
    reactants = ['CF2O(48)', '[CH2][CH]F(648)'],
    products = ['[O]C(F)(F)C[CH]F(2247)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(60.8659,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['[O][C](F)F(2208)', '[CH2][CH]F(648)'],
    products = ['[O]C(F)(F)C[CH]F(2247)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'O=C(F)[CH][CH]F(2326)'],
    products = ['[O]C(F)(F)C[CH]F(2247)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(268.475,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)

reaction(
    label = 'reaction13',
    reactants = ['CHF(39)', '[CH2]C([O])(F)F(1793)'],
    products = ['[O]C(F)(F)C[CH]F(2247)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C[C](F)OF(2329)'],
    products = ['[O]C(F)(F)C[CH]F(2247)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(77.3866,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

reaction(
    label = 'reaction17',
    reactants = ['[O]C(F)(F)C[CH]F(2247)'],
    products = ['[O][C](F)CC(F)F(2330)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(223.461,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)
