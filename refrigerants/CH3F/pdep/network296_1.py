...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(127)', '[CH2]C[CH]F(721)'],
    products = ['F[CH]CC[CH]F(646)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(39)', '[CH2]C[CH]F(721)'],
    products = ['F[CH]CC[CH]F(646)'],
    transitionState = 'TS9',
