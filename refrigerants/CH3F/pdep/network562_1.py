...
reaction(
    label = 'reaction1',
    reactants = ['OOOC[CH]F(1700)'],
    products = ['HO2(11)', 'FC1CO1(564)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[CH]COOO(1719)'],
    products = ['OOOC[CH]F(1700)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(127)', '[CH2]OOO(402)'],
    products = ['OOOC[CH]F(1700)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'OOO[CH][CH]F(1342)'],
    products = ['OOOC[CH]F(1700)'],
