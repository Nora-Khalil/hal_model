...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC([CH2])F(823)'],
    products = ['C2H2(23)', 'CH2CHF(55)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=CC[CH]F(824)'],
    products = ['[CH]=CC([CH2])F(823)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH]C=CF(768)'],
    products = ['[CH]=CC([CH2])F(823)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['C2H2(23)', '[CH2][CH]F(648)'],
    products = ['[CH]=CC([CH2])F(823)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=[CH](223)', '[CH2][CH]F(648)'],
    products = ['[CH]=CC([CH2])F(823)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH]=C=C[CH2](973)'],
    products = ['[CH]=CC([CH2])F(823)'],
