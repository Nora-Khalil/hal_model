...
"""),
    E0 = (-942.538,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,557,1111,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,181.859,223.584],'cm^-1')),
        HinderedRotor(inertia=(0.0112358,'amu*angstrom^2'), symmetry=1, barrier=(2.63897,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.328347,'amu*angstrom^2'), symmetry=1, barrier=(13.4271,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.577292,'amu*angstrom^2'), symmetry=1, barrier=(13.4025,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.580775,'amu*angstrom^2'), symmetry=1, barrier=(13.4842,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.526963,0.0819248,-0.000121959,9.16834e-08,-2.71978e-11,-113241,26.7077], Tmin=(100,'K'), Tmax=(827.495,'K')), NASAPolynomial(coeffs=[13.207,0.0206315,-1.0853e-05,2.17143e-09,-1.54836e-13,-115340,-32.0649], Tmin=(827.495,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-942.538,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFFO)"""),
)
...
"""),
    E0 = (-144.642,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,1380,1390,370,380,2900,435,617,898,1187,240.196],'cm^-1')),
        HinderedRotor(inertia=(0.170657,'amu*angstrom^2'), symmetry=1, barrier=(6.99021,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170907,'amu*angstrom^2'), symmetry=1, barrier=(6.99474,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.508551,'amu*angstrom^2'), symmetry=1, barrier=(20.8249,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80156,0.0518135,-7.56228e-05,5.67907e-08,-1.69217e-11,-17320.3,21.2954], Tmin=(100,'K'), Tmax=(822.481,'K')), NASAPolynomial(coeffs=[9.5011,0.0143718,-7.34497e-06,1.45317e-09,-1.03023e-13,-18587,-14.3465], Tmin=(822.481,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-144.642,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsOsOsH) + group(CJ2_singlet-FCs)"""),
)

species(
    label = 'OC(O)(F)C(F)OF(3104)',
...
"""),
    E0 = (-495.133,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,3010,987.5,1337.5,450,1655,326,540,652,719,1357],'cm^-1')),
        HinderedRotor(inertia=(1.05774,'amu*angstrom^2'), symmetry=1, barrier=(24.3195,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05407,'amu*angstrom^2'), symmetry=1, barrier=(24.2351,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (78.0424,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.8849,0.0066002,9.96788e-05,-2.04021e-07,1.19772e-10,-59544.4,9.92899], Tmin=(10,'K'), Tmax=(597.174,'K')), NASAPolynomial(coeffs=[4.97902,0.0268038,-2.02257e-05,7.04027e-09,-9.0739e-13,-60166,1.10419], Tmin=(597.174,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-495.133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), label="""OCDC(O)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-523.371,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,791,350,440,435,1725,182,240,577,636,1210,1413,180],'cm^-1')),
        HinderedRotor(inertia=(0.0125496,'amu*angstrom^2'), symmetry=1, barrier=(7.55601,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.840166,'amu*angstrom^2'), symmetry=1, barrier=(19.3171,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-513.277,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,557,1111,1380,1390,370,380,2900,435,395,473,707,1436,300.223,300.223],'cm^-1')),
        HinderedRotor(inertia=(0.12424,'amu*angstrom^2'), symmetry=1, barrier=(7.94652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12424,'amu*angstrom^2'), symmetry=1, barrier=(7.94652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12424,'amu*angstrom^2'), symmetry=1, barrier=(7.94652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.228867,'amu*angstrom^2'), symmetry=1, barrier=(14.6386,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.755615,0.0787216,-0.000136623,1.19526e-07,-4.03619e-11,-61623.2,26.4689], Tmin=(100,'K'), Tmax=(836.906,'K')), NASAPolynomial(coeffs=[10.3975,0.0205848,-1.08205e-05,2.10511e-09,-1.45261e-13,-62814.9,-15.8092], Tmin=(836.906,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-513.277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]C(O)C(O)(F)F(3108)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {6,S} {9,S}
...
"""),
    E0 = (-851.34,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,295.448,1696.94],'cm^-1')),
        HinderedRotor(inertia=(0.128953,'amu*angstrom^2'), symmetry=1, barrier=(7.70567,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131042,'amu*angstrom^2'), symmetry=1, barrier=(7.64228,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134773,'amu*angstrom^2'), symmetry=1, barrier=(7.67934,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18903,0.0691234,-0.000116784,1.05768e-07,-3.75097e-11,-102298,25.0064], Tmin=(100,'K'), Tmax=(813.092,'K')), NASAPolynomial(coeffs=[7.70126,0.0250302,-1.3199e-05,2.60092e-09,-1.81915e-13,-102959,-2.61318], Tmin=(813.092,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-851.34,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFFO) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-716.832,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,193.154,216.084,224.313],'cm^-1')),
        HinderedRotor(inertia=(0.217305,'amu*angstrom^2'), symmetry=1, barrier=(6.58339,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00243128,'amu*angstrom^2'), symmetry=1, barrier=(6.51557,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.947201,'amu*angstrom^2'), symmetry=1, barrier=(27.0541,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.691444,0.0817504,-0.000144495,1.32108e-07,-4.69107e-11,-86104.6,26.9625], Tmin=(100,'K'), Tmax=(812.753,'K')), NASAPolynomial(coeffs=[8.91062,0.0263369,-1.46104e-05,2.91886e-09,-2.0516e-13,-86946.4,-7.94598], Tmin=(812.753,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-716.832,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFFO) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-706.965,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,253,525,597,667,842,1178,1324,3025,407.5,1350,352.5,180],'cm^-1')),
        HinderedRotor(inertia=(0.75727,'amu*angstrom^2'), symmetry=1, barrier=(17.4111,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.759526,'amu*angstrom^2'), symmetry=1, barrier=(17.463,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.53844,'amu*angstrom^2'), symmetry=1, barrier=(35.3718,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.75618,0.0167628,0.000150142,-4.30383e-07,3.37416e-10,-85024.9,11.183], Tmin=(10,'K'), Tmax=(465.179,'K')), NASAPolynomial(coeffs=[7.22338,0.0284608,-2.14369e-05,7.35027e-09,-9.31832e-13,-85796.6,-7.71829], Tmin=(465.179,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-706.965,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), label="""O[CH]C(O)(F)F""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'OC(OF)[C](F)F(3111)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {5,S}
...
"""),
    E0 = (-682.57,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,1380,1390,370,380,2900,435,351,323,533,609,664,892,1120,1201,295.967,295.97],'cm^-1')),
        HinderedRotor(inertia=(0.136806,'amu*angstrom^2'), symmetry=1, barrier=(8.50356,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136807,'amu*angstrom^2'), symmetry=1, barrier=(8.50352,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136809,'amu*angstrom^2'), symmetry=1, barrier=(8.50354,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.686704,0.0786453,-0.000123554,9.81699e-08,-3.07664e-11,-81980.2,26.7191], Tmin=(100,'K'), Tmax=(784.436,'K')), NASAPolynomial(coeffs=[12.2753,0.0195474,-1.05369e-05,2.11224e-09,-1.50114e-13,-83798.2,-26.3747], Tmin=(784.436,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-682.57,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFFO) + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
"""),
    E0 = (-737.291,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,557,1111,253,525,597,667,842,1178,1324,360,370,350,260.346,260.708],'cm^-1')),
        HinderedRotor(inertia=(0.296324,'amu*angstrom^2'), symmetry=1, barrier=(14.2775,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113396,'amu*angstrom^2'), symmetry=1, barrier=(5.47005,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113559,'amu*angstrom^2'), symmetry=1, barrier=(5.46952,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.296109,'amu*angstrom^2'), symmetry=1, barrier=(14.2774,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.443999,0.0842064,-0.000138489,1.12887e-07,-3.59935e-11,-88553.2,27.6849], Tmin=(100,'K'), Tmax=(773.53,'K')), NASAPolynomial(coeffs=[13.2759,0.017845,-9.79039e-06,1.95751e-09,-1.38198e-13,-90538.2,-30.925], Tmin=(773.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-737.291,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFFO) + radical(Cs_P)"""),
)

species(
    label = 'O=C(F)C(O)OF(3114)',
    structure = adjacencyList("""1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {4,S}
3 O u0 p2 c0 {6,S} {9,S}
4 O u0 p2 c0 {2,S} {6,S}
...
"""),
    E0 = (-1040.32,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,251,367,519,700,855,1175,1303,345.542,345.63,345.634,1711.49,1711.52],'cm^-1')),
        HinderedRotor(inertia=(0.460375,'amu*angstrom^2'), symmetry=1, barrier=(39.0135,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131599,'amu*angstrom^2'), symmetry=1, barrier=(11.153,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.41124,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['OC(OF)C(O)(F)F(3079)'],
    products = ['HF(38)', 'CF2O(48)', 'O=CO(160)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(22.0372,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'OC(O)OF(3028)'],
    products = ['OC(OF)C(O)(F)F(3079)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.81816e-07,'m^3/(mol*s)'), n=3.45227, Ea=(197.805,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['OF(133)', 'OC([C]F)OF(3103)'],
    products = ['OC(OF)C(O)(F)F(3079)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['FOF(377)', 'OC=C(O)F(3105)'],
    products = ['OC(OF)C(O)(F)F(3079)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H2O(3)', 'OC(OF)=C(F)F(3106)'],
    products = ['OC(OF)C(O)(F)F(3079)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O[C](F)C(O)OF(3107)'],
    products = ['OC(OF)C(O)(F)F(3079)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(O)C(O)(F)F(3108)'],
    products = ['OC(OF)C(O)(F)F(3079)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', 'OC(F)(F)[CH]OF(2372)'],
    products = ['OC(OF)C(O)(F)F(3079)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(OF)C(O)(F)F(3109)'],
    products = ['OC(OF)C(O)(F)F(3079)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(129)', 'O[CH]C(O)(F)F(3110)'],
    products = ['OC(OF)C(O)(F)F(3079)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(7)', 'OC(OF)[C](F)F(3111)'],
    products = ['OC(OF)C(O)(F)F(3079)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)(F)C(O)OF(3112)'],
    products = ['OC(OF)C(O)(F)F(3079)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O[C](F)F(2111)', 'O[CH]OF(2983)'],
    products = ['OC(OF)C(O)(F)F(3079)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'O[C](OF)C(O)(F)F(3113)'],
    products = ['OC(OF)C(O)(F)F(3079)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'O=C(F)C(O)OF(3114)'],
    products = ['OC(OF)C(O)(F)F(3079)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(167.159,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=C(O)C(O)(F)F(3062)'],
    products = ['OC(OF)C(O)(F)F(3079)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(492.759,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'OC(F)=C(O)OF(468)'],
    products = ['OC(OF)C(O)(F)F(3079)'],
