...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(222)', '[CH]=C[O](181)'],
    products = ['[CH]=CO[C]=C(1382)'],
    transitionState = 'TS2',
