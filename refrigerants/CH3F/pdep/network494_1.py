...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(125)', '[CH]C=C(944)'],
    products = ['[CH]=CC[C]=O(1383)'],
    transitionState = 'TS3',
