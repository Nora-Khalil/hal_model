...
reaction(
    label = 'reaction5',
    reactants = ['H2(8)', 'F[C]CC(F)(F)OF(2551)'],
    products = ['FCCC(F)(F)OF(2535)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['OF(133)', 'FCC=C(F)F(2552)'],
    products = ['FCCC(F)(F)OF(2535)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]CC(F)(F)OF(2553)'],
    products = ['FCCC(F)(F)OF(2535)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(F)(F)CCF(2554)'],
    products = ['FCCC(F)(F)OF(2535)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(129)', 'FCC[C](F)F(2096)'],
    products = ['FCCC(F)(F)OF(2535)'],
...
reaction(
    label = 'reaction12',
    reactants = ['FO[C](F)F(2234)', 'CH2F-CH2(61)'],
    products = ['FCCC(F)(F)OF(2535)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH2F(45)', '[CH2]C(F)(F)OF(2555)'],
    products = ['FCCC(F)(F)OF(2535)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'FC[CH]C(F)(F)OF(2556)'],
    products = ['FCCC(F)(F)OF(2535)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'F[CH]CC(F)(F)OF(2557)'],
    products = ['FCCC(F)(F)OF(2535)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'FCC=C(F)OF(2558)'],
    products = ['FCCC(F)(F)OF(2535)'],
...
reaction(
    label = 'reaction19',
    reactants = ['FCCC(F)(F)OF(2535)'],
    products = ['F2(77)', 'CF2O(48)', 'C2H4(30)'],
