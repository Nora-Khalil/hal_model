...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(O)C([O])=O(1607)'],
    products = ['C=C(O)C(=O)OF(1556)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', 'C=[C]C(=O)OF(1608)'],
    products = ['C=C(O)C(=O)OF(1556)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(=O)C(=O)OF(1589)'],
    products = ['C=C(O)C(=O)OF(1556)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(129)', 'C=C(O)[C]=O(1609)'],
    products = ['C=C(O)C(=O)OF(1556)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]OF(147)', 'C=[C]O(556)'],
    products = ['C=C(O)C(=O)OF(1556)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH]=C(O)C(=O)OF(1610)'],
    products = ['C=C(O)C(=O)OF(1556)'],
