...
reaction(
    label = 'reaction7',
    reactants = ['H2O(3)', 'FOC=C(F)F(2371)'],
    products = ['OC(F)(F)COF(2620)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]CC(O)(F)F(2629)'],
    products = ['OC(F)(F)COF(2620)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(129)', '[CH2]C(O)(F)F(1795)'],
    products = ['OC(F)(F)COF(2620)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(F)(F)COF(2631)'],
    products = ['OC(F)(F)COF(2620)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[C](F)F(2111)', '[CH2]OF(152)'],
    products = ['OC(F)(F)COF(2620)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'OC(F)(F)[CH]OF(2372)'],
    products = ['OC(F)(F)COF(2620)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'O=C(F)COF(2632)'],
    products = ['OC(F)(F)COF(2620)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=CC(O)(F)F(2315)'],
    products = ['OC(F)(F)COF(2620)'],
