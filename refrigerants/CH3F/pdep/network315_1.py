...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(125)', '[O]C[C]=O(435)'],
    products = ['O=[C]CO[C]=O(810)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(125)', '[CH2]O[C]=O(426)'],
    products = ['O=[C]CO[C]=O(810)'],
    transitionState = 'TS3',
