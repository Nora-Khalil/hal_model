...
"""),
    E0 = (-280.411,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,493,600,700,1144,1293,217.383,223.35,2009.93],'cm^-1')),
        HinderedRotor(inertia=(0.189761,'amu*angstrom^2'), symmetry=1, barrier=(5.96582,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.18618,'amu*angstrom^2'), symmetry=1, barrier=(5.97175,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.178907,'amu*angstrom^2'), symmetry=1, barrier=(5.9789,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61537,0.0588012,-9.45288e-05,8.62475e-08,-3.10488e-11,-33645.9,21.5345], Tmin=(100,'K'), Tmax=(813.228,'K')), NASAPolynomial(coeffs=[6.16216,0.0254219,-1.26431e-05,2.4635e-09,-1.71877e-13,-34021.2,2.77841], Tmin=(813.228,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-280.411,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CJCO) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(2043)', '[CH2]C[O](224)'],
    products = ['[CH2]CO[C](F)F(2515)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[C](F)F(2310)'],
    products = ['[CH2]CO[C](F)F(2515)'],
    transitionState = 'TS3',
