...
"""),
    E0 = (-75.4884,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([200.919,828.846,921.924,1037.16,1152.4,1272.19,1420.88,1521.29,1633.03],'cm^-1')),
        HinderedRotor(inertia=(0.150511,'amu*angstrom^2'), symmetry=1, barrier=(3.5439,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150511,'amu*angstrom^2'), symmetry=1, barrier=(3.5439,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150511,'amu*angstrom^2'), symmetry=1, barrier=(3.5439,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.96686,0.0109347,3.00662e-05,-5.79943e-08,2.6381e-11,-9030.89,16.4333], Tmin=(100,'K'), Tmax=(904.615,'K')), NASAPolynomial(coeffs=[13.5652,-0.00472627,4.29593e-06,-8.73152e-10,5.74523e-14,-12225.1,-40.6916], Tmin=(904.615,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.4884,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(120.56,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(O2s-OsH)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90148,0.0386571,-2.69931e-05,-1.01139e-09,5.29104e-12,-10843.6,24.3536], Tmin=(100,'K'), Tmax=(959.708,'K')), NASAPolynomial(coeffs=[14.3173,0.00453951,-1.2248e-06,2.30891e-10,-1.9071e-14,-14038.6,-39.2652], Tmin=(959.708,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-90.8431,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(166.289,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsFHHO) + radical(CsF1sHO2s)"""),
)
...
"""),
    E0 = (-406.316,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,371.072,371.073,371.078,371.085,1852.31],'cm^-1')),
        HinderedRotor(inertia=(0.00122433,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0886752,'amu*angstrom^2'), symmetry=1, barrier=(8.66494,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0136,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.30892,0.0364485,-4.19924e-05,2.4345e-08,-5.5386e-12,-48806.9,20.2522], Tmin=(100,'K'), Tmax=(1076.21,'K')), NASAPolynomial(coeffs=[9.67082,0.00908527,-3.85273e-06,7.18305e-10,-5.00061e-14,-50391.5,-15.8051], Tmin=(1076.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-406.316,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsFFHO) + radical(ROOJ)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51475,0.0450477,-4.82382e-05,2.42478e-08,-4.56694e-12,-44443.8,27.2206], Tmin=(100,'K'), Tmax=(1452.69,'K')), NASAPolynomial(coeffs=[14.7733,0.00366627,-4.76565e-07,1.95618e-11,5.5623e-17,-47781.7,-39.9254], Tmin=(1452.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-370.339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsFFHO) + radical(ROOJ)"""),
)

species(
    label = 'OOOO[C](F)F(2080)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 O u0 p2 c0 {4,S} {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['HO2(11)', '[O]OC(F)F(2051)'],
    products = ['OOOOC(F)F(2062)'],
    transitionState = 'TS1',
