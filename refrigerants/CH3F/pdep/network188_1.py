...
reaction(
    label = 'reaction3',
    reactants = ['H2O(3)', 'O=C([C]F)OF(460)'],
    products = ['O=C(OF)C(O)F(417)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(133)', 'O=C=C(O)F(462)'],
    products = ['O=C(OF)C(O)F(417)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C([CH]O)OF(469)'],
    products = ['O=C(OF)C(O)F(417)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(=O)C(O)F(470)'],
    products = ['O=C(OF)C(O)F(417)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(7)', 'O=C([CH]F)OF(471)'],
    products = ['O=C(OF)C(O)F(417)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)C(=O)OF(472)'],
    products = ['O=C(OF)C(O)F(417)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(129)', 'O=[C]C(O)F(473)'],
    products = ['O=C(OF)C(O)F(417)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=[C]OF(147)', 'O[CH]F(187)'],
    products = ['O=C(OF)C(O)F(417)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(OF)[C](O)F(474)'],
    products = ['O=C(OF)C(O)F(417)'],
