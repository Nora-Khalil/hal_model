...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(127)', '[CH]=C[O](181)'],
    products = ['[CH]=CO[CH]F(631)'],
    transitionState = 'TS2',
