...
"""),
    E0 = (-425.259,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,492.5,1135,1000,1380,1390,370,380,2900,435,180],'cm^-1')),
        HinderedRotor(inertia=(2.94689,'amu*angstrom^2'), symmetry=1, barrier=(67.7547,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.0034,0.0620757,-0.000147609,1.64487e-07,-6.47574e-11,-51092.5,18.8098], Tmin=(100,'K'), Tmax=(861.147,'K')), NASAPolynomial(coeffs=[-1.83353,0.0342597,-1.96612e-05,3.8928e-09,-2.68727e-13,-48739.4,46.5725], Tmin=(861.147,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-425.259,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(CsFOOO) + radical(OCOJ) + radical(ROOJ)"""),
)
...
"""),
    ...
    molecularWeight = (96.0146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.42603,0.0222186,1.79924e-05,-4.32602e-08,1.83945e-11,-52941.5,15.9484], Tmin=(100,'K'), Tmax=(1000.83,'K')), NASAPolynomial(coeffs=[13.8414,0.0065069,-3.28986e-06,7.77968e-10,-6.50924e-14,-56724.6,-46.6179], Tmin=(1000.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-440.744,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsOs) + group(CsFOOO) + ring(Cyclobutane)"""),
)

species(
    label = 'OC1(F)OO1(3127)',
...
"""),
    ...
    molecularWeight = (80.0152,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.0344,0.0227076,-1.77145e-05,6.60002e-09,-1.01072e-12,-57686,12.7935], Tmin=(100,'K'), Tmax=(1468.54,'K')), NASAPolynomial(coeffs=[7.35566,0.0109373,-5.69212e-06,1.14224e-09,-8.16048e-14,-58955.2,-9.71459], Tmin=(1468.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-479.905,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(CsFOOO) + ring(O2s-O2s-Cs(F))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.851666,'amu*angstrom^2'), symmetry=1, barrier=(19.5815,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.851078,'amu*angstrom^2'), symmetry=1, barrier=(19.5679,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78581,0.0412568,-5.57498e-05,3.29377e-08,-7.00885e-12,-42560.3,16.2277], Tmin=(100,'K'), Tmax=(1359.92,'K')), NASAPolynomial(coeffs=[13.9628,-0.00336334,3.17669e-06,-7.09639e-10,5.17725e-14,-45058.2,-43.2697], Tmin=(1359.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-354.583,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(O2s-(Os-CdOd)H) + group(Cds-OdOsOs) + radical(C(=O)OOJ)"""),
)
...
"""),
    E0 = (-349.866,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,180,1048.91],'cm^-1')),
        HinderedRotor(inertia=(2.29265,'amu*angstrom^2'), symmetry=1, barrier=(52.7125,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166879,'amu*angstrom^2'), symmetry=1, barrier=(52.5984,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28483,0.0629873,-0.000168261,2.06324e-07,-8.63838e-11,-42041.9,16.8177], Tmin=(100,'K'), Tmax=(849.547,'K')), NASAPolynomial(coeffs=[-9.24698,0.0510027,-3.0072e-05,6.04736e-09,-4.22591e-13,-37690.7,84.6489], Tmin=(849.547,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-349.866,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(CsFOOO) + radical(OCOJ) + radical(OCOJ)"""),
)

species(
    label = '[O]O[C](O)OF(1164)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (96.0146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79541,0.0613969,-0.000133973,1.36669e-07,-5.06202e-11,-4435.95,21.983], Tmin=(100,'K'), Tmax=(868.097,'K')), NASAPolynomial(coeffs=[3.62905,0.0220558,-1.26162e-05,2.47802e-09,-1.69576e-13,-3590.3,20.1004], Tmin=(868.097,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-37.4399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sCF) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-OsOsOsH) + radical(ROOJ) + radical(Cs_P)"""),
)

species(
    label = '[O][C](O)OOF(3132)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
...
"""),
    E0 = (-1.25383,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3615,1277.5,1000,277,555,632,360,370,350],'cm^-1')),
        HinderedRotor(inertia=(0.00238737,'amu*angstrom^2'), symmetry=1, barrier=(6.50869,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.21455,0.0593527,-0.000149701,1.74484e-07,-7.08346e-11,-105.909,21.4008], Tmin=(100,'K'), Tmax=(853.091,'K')), NASAPolynomial(coeffs=[-4.33439,0.0386026,-2.27384e-05,4.56036e-09,-3.17702e-13,2883.89,62.9295], Tmin=(853.091,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1.25383,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2sFO) + group(Cs-OsOsOsH) + radical(OCOJ) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC([O])(O)F(1954)'],
    products = ['O=O(128)', 'O=C(O)F(220)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C([O])(O)F(1941)'],
    products = ['[O]OC([O])(O)F(1954)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]OC([O])(O)F(1954)'],
    products = ['O(6)', 'OC1(F)OO1(3127)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.30161e+09,'s^-1'), n=1.08, Ea=(189.615,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R2OO_S;Y_rad_intra;OOJ]
Euclidian distance = 0
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[O]OC([O])=O(150)'],
    products = ['[O]OC([O])(O)F(1954)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(0.218312,'m^3/(mol*s)'), n=1.86531, Ea=(152.918,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction12',
    reactants = ['[O]C([O])(F)OO(3130)'],
    products = ['[O]OC([O])(O)F(1954)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O][C](O)OOF(3132)'],
    products = ['[O]OC([O])(O)F(1954)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(70.752,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
