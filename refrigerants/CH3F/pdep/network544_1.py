...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(=O)CC=O(1629)'],
    products = ['O=CCC(=O)OF(1554)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(129)', 'O=[C]CC=O(1246)'],
    products = ['O=CCC(=O)OF(1554)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C=CC(=O)OF(1630)'],
    products = ['O=CCC(=O)OF(1554)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'O=[C]CC(=O)OF(1631)'],
    products = ['O=CCC(=O)OF(1554)'],
