...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[O]C(=O)F(148)'],
    products = ['[O]OOC(=O)F(287)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OOC(=O)F(287)'],
    products = ['F[C]1OOOO1(297)'],
    transitionState = 'TS4',
