...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(127)', '[O]C([O])F(165)'],
    products = ['[O]C(F)O[CH]F(198)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O=C(F)O[CH]F(205)'],
    products = ['[O]C(F)O[CH]F(198)'],
    transitionState = 'TS8',
