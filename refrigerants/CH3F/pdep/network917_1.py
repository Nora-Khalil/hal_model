...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(2043)', '[O]C[C]=O(435)'],
    products = ['O=[C]CO[C](F)F(2228)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(125)', '[CH2]O[C](F)F(2310)'],
    products = ['O=[C]CO[C](F)F(2228)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[CH2]O[C](F)F(2310)'],
    products = ['O=[C]CO[C](F)F(2228)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C=CO[C](F)F(2380)'],
    products = ['O=[C]CO[C](F)F(2228)'],
    transitionState = 'TS9',
