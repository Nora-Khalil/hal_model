...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C(=C)[O](1063)'],
    products = ['C=C([O])C[O](1371)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(=O)C=O(1275)'],
    products = ['C=C([O])C[O](1371)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(18)', '[O]C[C]=O(435)'],
    products = ['C=C([O])C[O](1371)'],
