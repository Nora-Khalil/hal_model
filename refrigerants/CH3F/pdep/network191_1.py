...
"""),
    E0 = (-490.508,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,509,613,660,1171,1360,1414,3084,2750,2800,2850,1350,1500,750,1050,1375,1000,185.133,185.136,185.141],'cm^-1')),
        HinderedRotor(inertia=(0.26717,'amu*angstrom^2'), symmetry=1, barrier=(6.49762,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00260935,'amu*angstrom^2'), symmetry=1, barrier=(6.49761,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00662,'amu*angstrom^2'), symmetry=1, barrier=(24.4839,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-79.3708,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180,1555.44,1556.51],'cm^-1')),
        HinderedRotor(inertia=(0.276164,'amu*angstrom^2'), symmetry=1, barrier=(6.34956,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.276635,'amu*angstrom^2'), symmetry=1, barrier=(6.36038,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.276596,'amu*angstrom^2'), symmetry=1, barrier=(6.35948,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.0504,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16835,0.0551053,-0.00011754,1.30588e-07,-5.18362e-11,-9494.42,16.9823], Tmin=(100,'K'), Tmax=(859.383,'K')), NASAPolynomial(coeffs=[-1.69399,0.0358493,-1.89416e-05,3.68528e-09,-2.53457e-13,-7455.67,43.0299], Tmin=(859.383,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.3708,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(OCJO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.300781,'amu*angstrom^2'), symmetry=1, barrier=(6.91554,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-283.014,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2800,2850,1350,1500,750,1050,1375,1000,482,586,761,1411,180,180,2231.07],'cm^-1')),
        HinderedRotor(inertia=(0.0753762,'amu*angstrom^2'), symmetry=1, barrier=(1.73305,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0758959,'amu*angstrom^2'), symmetry=1, barrier=(1.745,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.02143,'amu*angstrom^2'), symmetry=1, barrier=(46.4766,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.4686,0.0377789,-3.60845e-05,2.08159e-08,-5.42978e-12,-33987.1,19.3424], Tmin=(100,'K'), Tmax=(876.648,'K')), NASAPolynomial(coeffs=[5.57454,0.0236075,-1.18371e-05,2.37703e-09,-1.71625e-13,-34531.7,4.76684], Tmin=(876.648,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-283.014,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsF1sO2sO2s)"""),
)

species(
    label = '[CH2]OC(F)OF(367)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {4,S}
3 O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-298.923,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,509,613,660,1171,1360,1414,3084,3000,3100,440,815,1455,1000,180,492.352,1802.78],'cm^-1')),
        HinderedRotor(inertia=(0.255281,'amu*angstrom^2'), symmetry=1, barrier=(5.86942,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.662001,'amu*angstrom^2'), symmetry=1, barrier=(15.2207,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.35701,'amu*angstrom^2'), symmetry=1, barrier=(31.2003,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0105566,'amu*angstrom^2'), symmetry=1, barrier=(5.31736,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0937553,'amu*angstrom^2'), symmetry=1, barrier=(47.7773,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.28123,0.0113181,1.84478e-05,-2.41945e-08,7.75136e-12,-44672.6,12.0364], Tmin=(100,'K'), Tmax=(1141.77,'K')), NASAPolynomial(coeffs=[4.90989,0.018753,-8.58329e-06,1.66847e-09,-1.18612e-13,-45901,0.212198], Tmin=(1141.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-371.674,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), label="""methyl_formate""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    E0 = (-613.82,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,482,664,788,1296,1923,180,1291.68],'cm^-1')),
        HinderedRotor(inertia=(0.0937696,'amu*angstrom^2'), symmetry=1, barrier=(2.15595,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.774202,'amu*angstrom^2'), symmetry=1, barrier=(33.2684,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
