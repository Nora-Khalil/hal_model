...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.180821,'amu*angstrom^2'), symmetry=1, barrier=(4.15743,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180872,'amu*angstrom^2'), symmetry=1, barrier=(4.15861,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.365447,'amu*angstrom^2'), symmetry=1, barrier=(8.40235,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(39)', 'OC(O)(F)F(1955)'],
    products = ['OC(F)(F)OCF(2618)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH2]OC(O)(F)F(2635)'],
    products = ['OC(F)(F)OCF(2618)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O[C](F)F(2111)', '[O]CF(131)'],
    products = ['OC(F)(F)OCF(2618)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(O)(F)F(290)', 'CH2F(45)'],
    products = ['OC(F)(F)OCF(2618)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)(F)OCF(2350)'],
    products = ['OC(F)(F)OCF(2618)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'OC(F)(F)O[CH]F(2462)'],
    products = ['OC(F)(F)OCF(2618)'],
