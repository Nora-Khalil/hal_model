...
reaction(
    label = 'reaction2',
    reactants = ['OF(133)', 'OC(F)(F)[C]F(2369)'],
    products = ['OC(F)(F)C(F)OF(2268)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(133)', 'F[C]C(F)OF(370)'],
    products = ['OC(F)(F)C(F)OF(2268)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['H2O(3)', 'FOC(F)=C(F)F(2370)'],
    products = ['OC(F)(F)C(F)OF(2268)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OF(133)', 'FOC=C(F)F(2371)'],
    products = ['OC(F)(F)C(F)OF(2268)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'OC(F)(F)[CH]OF(2372)'],
    products = ['OC(F)(F)C(F)OF(2268)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O[C](F)C(F)OF(384)'],
    products = ['OC(F)(F)C(F)OF(2268)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)C(O)(F)F(2373)'],
    products = ['OC(F)(F)C(F)OF(2268)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(129)', 'OC(F)(F)[CH]F(2374)'],
    products = ['OC(F)(F)C(F)OF(2268)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'FOC(F)[C](F)F(2375)'],
    products = ['OC(F)(F)C(F)OF(2268)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(F)(F)C(F)OF(2376)'],
    products = ['OC(F)(F)C(F)OF(2268)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]OF(188)', 'O[C](F)F(2111)'],
    products = ['OC(F)(F)C(F)OF(2268)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'OC(F)(F)[C](F)OF(2377)'],
    products = ['OC(F)(F)C(F)OF(2268)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(77)', 'O=CC(O)(F)F(2315)'],
    products = ['OC(F)(F)C(F)OF(2268)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C(F)C(F)OF(2378)'],
    products = ['OC(F)(F)C(F)OF(2268)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'O=C(F)C(O)(F)F(2286)'],
    products = ['OC(F)(F)C(F)OF(2268)'],
