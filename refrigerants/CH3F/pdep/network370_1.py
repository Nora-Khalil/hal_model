...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OO[O](153)'],
    products = ['O=O(128)', 'CH2O(20)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[O](130)', 'CH2(T)(18)'],
    products = ['[CH2]OO[O](153)'],
    transitionState = 'TS2',
