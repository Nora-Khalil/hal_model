...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(127)', '[CH]C=C(944)'],
    products = ['[CH]=CC[CH]F(824)'],
    transitionState = 'TS3',
