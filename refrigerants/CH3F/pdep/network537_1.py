...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC([O])F(1548)'],
    products = ['CHFO(46)', 'C2H4(30)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction12',
    reactants = ['[O][CH]F(185)', '[CH2][CH2](184)'],
    products = ['[CH2]CC([O])F(1548)'],
