...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'O[CH]OC(F)(F)F(2465)'],
    products = ['OC(F)OC(F)(F)F(2270)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'OC(F)O[C](F)F(399)'],
    products = ['OC(F)OC(F)(F)F(2270)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(7)', 'F[CH]OC(F)(F)F(2466)'],
    products = ['OC(F)OC(F)(F)F(2270)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)OC(F)(F)F(2467)'],
    products = ['OC(F)OC(F)(F)F(2270)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O[C](F)OC(F)(F)F(2468)'],
    products = ['OC(F)OC(F)(F)F(2270)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'O=COC(F)(F)F(2469)'],
    products = ['OC(F)OC(F)(F)F(2270)'],
