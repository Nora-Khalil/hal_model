...
reaction(
    label = 'reaction1',
    reactants = ['OCC(F)(F)OF(2619)'],
    products = ['HF(38)', 'CF2O(48)', 'CH2O(20)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['OC(F)(F)OF(2347)', 'CH2(S)(25)'],
    products = ['OCC(F)(F)OF(2619)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['OF(133)', 'OC=C(F)F(2360)'],
    products = ['OCC(F)(F)OF(2619)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(F)(F)CO(2626)'],
    products = ['OCC(F)(F)OF(2619)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', '[CH2]C(F)(F)OF(2555)'],
    products = ['OCC(F)(F)OF(2619)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]CC(F)(F)OF(2627)'],
    products = ['OCC(F)(F)OF(2619)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(129)', 'OC[C](F)F(2628)'],
    products = ['OCC(F)(F)OF(2619)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FO[C](F)F(2234)', 'CH2OH(33)'],
    products = ['OCC(F)(F)OF(2619)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O[CH]C(F)(F)OF(2361)'],
    products = ['OCC(F)(F)OF(2619)'],
