...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(125)', '[CH]=C[O](181)'],
    products = ['[CH]=CO[C]=O(784)'],
    transitionState = 'TS2',
