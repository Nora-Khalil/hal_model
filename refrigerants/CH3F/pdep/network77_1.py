...
"""),
    ...
    molecularWeight = (88.0189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.59627,0.0137887,3.71825e-05,-7.37373e-08,3.30719e-11,-67250.2,18.5304], Tmin=(100,'K'), Tmax=(932.576,'K')), NASAPolynomial(coeffs=[18.5642,-0.0108067,6.14154e-06,-1.07656e-09,6.35154e-14,-72137.2,-67.6249], Tmin=(932.576,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-559.702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(O2s-(Cds-O2d)(Cds-O2d)) + group(Cds-OdOsOs) + group(Cds-OdOsOs) + ring(Cyclobutane)"""),
)

species(
    label = 'O=[C]O[C]1OO1(253)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (88.0189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.05262,0.014773,1.11824e-05,-2.76147e-08,1.26085e-11,-8507.77,18.0044], Tmin=(100,'K'), Tmax=(919.287,'K')), NASAPolynomial(coeffs=[8.4672,0.00691093,-1.60341e-06,2.3293e-10,-1.62519e-14,-10166.6,-11.2699], Tmin=(919.287,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-71.068,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cds-OdCsOs) + ring(cyclopropanone) + radical(C=OCOJ) + radical(C=OCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(125)', '[O]C([O])=O(250)'],
    products = ['[O]C(=O)O[C]=O(229)'],
    transitionState = 'TS2',
