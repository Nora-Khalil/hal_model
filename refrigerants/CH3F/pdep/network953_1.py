...
"""),
    E0 = (-905.812,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,990,1113,251,367,519,700,855,1175,1303,279.302,279.303,279.341,279.343,1027.25,1027.27],'cm^-1')),
        HinderedRotor(inertia=(0.118808,'amu*angstrom^2'), symmetry=1, barrier=(6.57847,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.892996,'amu*angstrom^2'), symmetry=1, barrier=(49.4247,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.892891,'amu*angstrom^2'), symmetry=1, barrier=(49.4243,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.364159,'amu*angstrom^2'), symmetry=1, barrier=(8.37273,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00304679,'amu*angstrom^2'), symmetry=1, barrier=(8.37685,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.03314,'amu*angstrom^2'), symmetry=1, barrier=(46.7458,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.023,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.120696,'amu*angstrom^2'), symmetry=1, barrier=(2.77504,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.904409,0.0846571,-0.000177071,1.79713e-07,-6.69788e-11,-47878.1,25.1606], Tmin=(100,'K'), Tmax=(858.004,'K')), NASAPolynomial(coeffs=[3.60397,0.0330725,-1.87084e-05,3.68944e-09,-2.54396e-13,-46905.9,20.9156], Tmin=(858.004,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-398.876,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2sCF) + group(O2s-OsH) + group(Cds-CdsCsCs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = '[O]C(OF)C([O])(F)F(2405)',
...
"""),
    E0 = (-456.865,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,351,323,533,609,664,892,1120,1201,180,180,1676.07],'cm^-1')),
        HinderedRotor(inertia=(0.280658,'amu*angstrom^2'), symmetry=1, barrier=(6.45289,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.280279,'amu*angstrom^2'), symmetry=1, barrier=(6.44417,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.906923,0.0777497,-0.000143228,1.34299e-07,-4.83298e-11,-54846.2,26.7779], Tmin=(100,'K'), Tmax=(823.375,'K')), NASAPolynomial(coeffs=[7.90597,0.0253832,-1.43722e-05,2.8785e-09,-2.02027e-13,-55376.2,-1.848], Tmin=(823.375,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-456.865,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFFO) + radical(CCOJ) + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
"""),
    E0 = (-814.615,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,251,367,519,700,855,1175,1303,180,180,628.172,628.236,628.4,628.426],'cm^-1')),
        HinderedRotor(inertia=(0.0101397,'amu*angstrom^2'), symmetry=1, barrier=(2.83886,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0101178,'amu*angstrom^2'), symmetry=1, barrier=(2.83821,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89582,0.0521733,-8.47937e-05,7.94443e-08,-2.97974e-11,-97905.5,19.7841], Tmin=(100,'K'), Tmax=(780.608,'K')), NASAPolynomial(coeffs=[5.44562,0.0244463,-1.3188e-05,2.63928e-09,-1.87072e-13,-98169.1,5.39871], Tmin=(780.608,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-814.615,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['OF(133)', 'O=C([C]F)OF(460)'],
    products = ['O=C(OF)C(O)(F)F(2262)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FOF(377)', 'O=C=C(O)F(462)'],
    products = ['O=C(OF)C(O)(F)F(2262)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C(OF)[C](O)F(474)'],
    products = ['O=C(OF)C(O)(F)F(2262)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(=O)C(O)(F)F(2407)'],
    products = ['O=C(OF)C(O)(F)F(2262)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', 'O=C(OF)[C](F)F(2408)'],
    products = ['O=C(OF)C(O)(F)F(2262)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(F)(F)C(=O)OF(2409)'],
    products = ['O=C(OF)C(O)(F)F(2262)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(129)', 'O=[C]C(O)(F)F(2410)'],
    products = ['O=C(OF)C(O)(F)F(2262)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=[C]OF(147)', 'O[C](F)F(2111)'],
    products = ['O=C(OF)C(O)(F)F(2262)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'O=C(F)C(=O)OF(2411)'],
    products = ['O=C(OF)C(O)(F)F(2262)'],
