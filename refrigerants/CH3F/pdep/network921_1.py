...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.72151,'amu*angstrom^2'), symmetry=1, barrier=(39.5809,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.7212,'amu*angstrom^2'), symmetry=1, barrier=(39.5738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.72176,'amu*angstrom^2'), symmetry=1, barrier=(39.5867,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2422,0.0677178,-0.000119038,1.06079e-07,-3.63268e-11,9673,22.3232], Tmin=(100,'K'), Tmax=(845.984,'K')), NASAPolynomial(coeffs=[8.65665,0.019513,-1.02551e-05,1.98334e-09,-1.36162e-13,8888.99,-9.42644], Tmin=(845.984,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(79.6566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(CsFFHO) + group(Ct-CtOs) + group(Ct-CtH) + radical(Acetyl)"""),
)

species(
    label = '[C]=COOC(F)F(2461)',
    structure = adjacencyList("""1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {4,S} {5,S}
4 O u0 p2 c0 {3,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.481965,'amu*angstrom^2'), symmetry=1, barrier=(11.0813,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.84566,'amu*angstrom^2'), symmetry=1, barrier=(42.4354,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.484035,'amu*angstrom^2'), symmetry=1, barrier=(11.1289,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14093,0.0749307,-0.000145538,1.42399e-07,-5.22118e-11,-12302.4,22.8828], Tmin=(100,'K'), Tmax=(849.148,'K')), NASAPolynomial(coeffs=[5.34952,0.0282232,-1.55427e-05,3.05776e-09,-2.11487e-13,-12047.9,8.97371], Tmin=(849.148,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-103.047,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsFFHO) + group(Cds-CdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'C#COO(1110)'],
    products = ['C#COOC(F)F(2232)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'C#COO[CH]F(1254)'],
    products = ['C#COOC(F)F(2232)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]OC(F)F(2051)', 'C2H(22)'],
    products = ['C#COOC(F)F(2232)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#COO[C](F)F(2391)'],
    products = ['C#COOC(F)F(2232)'],
    transitionState = 'TS8',
