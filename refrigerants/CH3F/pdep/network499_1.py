...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(222)', 'C=[C]O[O](994)'],
    products = ['C=[C]OO[C]=C(1388)'],
    transitionState = 'TS2',
