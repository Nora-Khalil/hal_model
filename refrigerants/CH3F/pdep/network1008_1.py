...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C](F)F(2057)', 'O[C]F(1303)'],
    products = ['O[C](F)OO[C](F)F(2574)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(2043)', '[O]O[C](O)F(391)'],
    products = ['O[C](F)OO[C](F)F(2574)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['[O]O[C](F)F(2057)', '[OH+]=[C-]F(1359)'],
    products = ['O[C](F)OO[C](F)F(2574)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(42)', '[O]O[C](O)F(391)'],
    products = ['O[C](F)OO[C](F)F(2574)'],
