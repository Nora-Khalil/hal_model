...
reaction(
    label = 'reaction2',
    reactants = ['[O][C](F)C(=O)OF(2304)'],
    products = ['[O]C(=O)C([O])(F)F(2211)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[O]C(=O)[C](F)F(2305)'],
    products = ['[O]C(=O)C([O])(F)F(2211)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[O]C(F)(F)[C]=O(2306)'],
    products = ['[O]C(=O)C([O])(F)F(2211)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(=O)C(=O)F(278)'],
    products = ['[O]C(=O)C([O])(F)F(2211)'],
    transitionState = 'TS9',
