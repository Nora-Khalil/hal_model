...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(250)', '[CH]F(127)'],
    products = ['[O]C(=O)O[CH]F(238)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][C]=O(163)', '[O][CH]F(185)'],
    products = ['[O]C(=O)O[CH]F(238)'],
