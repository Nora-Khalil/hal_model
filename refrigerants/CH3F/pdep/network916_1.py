...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(125)', '[CH2]C([O])(F)F(1793)'],
    products = ['[O]C(F)(F)C[C]=O(2227)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'O=[C]C[C](F)F(2383)'],
    products = ['[O]C(F)(F)C[C]=O(2227)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['CO(13)', '[CH2]C([O])(F)F(1793)'],
    products = ['[O]C(F)(F)C[C]=O(2227)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)(F)C=C=O(2385)'],
    products = ['[O]C(F)(F)C[C]=O(2227)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=[C]CC(=O)F(1247)'],
    products = ['[O]C(F)(F)C[C]=O(2227)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=[C][CH]C(=O)F(2386)'],
    products = ['[O]C(F)(F)C[C]=O(2227)'],
