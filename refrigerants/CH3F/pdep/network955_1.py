...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O=C(O)O[C](F)F(531)'],
    products = ['O=C(O)OC(F)(F)F(2264)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(7)', 'O=[C]OC(F)(F)F(2458)'],
    products = ['O=C(O)OC(F)(F)F(2264)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(=O)OC(F)(F)F(2459)'],
    products = ['O=C(O)OC(F)(F)F(2264)'],
    transitionState = 'TS8',
