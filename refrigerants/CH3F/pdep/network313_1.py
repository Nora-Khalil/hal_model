...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'O=[C]O[C]=O(251)'],
    products = ['[CH2]C(=O)O[C]=O(808)'],
    transitionState = 'TS3',
